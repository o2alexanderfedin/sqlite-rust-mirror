...
extern "C" fn templatevtab_connect(db: *mut sqlite3, p_aux_1: *mut (),
    ...
    let mut p_new: *mut templatevtab_vtab = core::ptr::null_mut();
    let mut rc: i32 = 0;
    rc =
        unsafe {
            sqlite3_declare_vtab(db,
                c"CREATE TABLE x(a,b)".as_ptr() as *mut i8 as *const i8)
        };
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<templatevtab_vtab>()
                            as sqlite3_uint64)
                } as *mut templatevtab_vtab;
        unsafe { *pp_vtab_1 = p_new as *mut sqlite3_vtab };
        if p_new == core::ptr::null_mut() { return 7; }
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<templatevtab_vtab>() as u64)
        };
    }
    return rc;
}
extern "C" fn templatevtab_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p: *mut templatevtab_vtab = p_vtab_1 as *mut templatevtab_vtab;
    unsafe { sqlite3_free(p as *mut ()) };
    return 0;
}
extern "C" fn templatevtab_open(p: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut templatevtab_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<templatevtab_cursor>()
                        as sqlite3_uint64)
            } as *mut templatevtab_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<templatevtab_cursor>() as u64)
    };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn templatevtab_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut templatevtab_cursor = cur as *mut templatevtab_cursor;
    unsafe { sqlite3_free(p_cur as *mut ()) };
    return 0;
}
extern "C" fn templatevtab_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut templatevtab_cursor = cur as *mut templatevtab_cursor;
    {
...
extern "C" fn templatevtab_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *const templatevtab_cursor =
        cur as *mut templatevtab_cursor as *const templatevtab_cursor;
    '__s0:
        {
        match i {
            0 => {
                unsafe {
                    sqlite3_result_int(ctx,
                        (1000 as sqlite3_int64 + unsafe { (*p_cur).i_rowid }) as
                            i32)
                };
            }
            _ => {
                if !(i == 1) as i32 as i64 != 0 {
                    unsafe {
                        __assert_rtn(c"templatevtabColumn".as_ptr() as *const i8,
                            c"templatevtab.c".as_ptr() as *mut i8 as *const i8, 167,
                            c"i==TEMPLATEVTAB_B".as_ptr() as *mut i8 as *const i8)
                    }
                } else { { let _ = 0; } };
                unsafe {
                    sqlite3_result_int(ctx,
                        (2000 as sqlite3_int64 + unsafe { (*p_cur).i_rowid }) as
                            i32)
                };
            }
        }
...
extern "C" fn templatevtab_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn templatevtab_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const templatevtab_cursor =
        cur as *mut templatevtab_cursor as *const templatevtab_cursor;
    return (unsafe { (*p_cur).i_rowid } >= 10 as i64) as i32;
}
extern "C" fn templatevtab_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_cur: *mut templatevtab_cursor =
        p_vtab_cursor_1 as *mut templatevtab_cursor;
    unsafe { (*p_cur).i_rowid = 1 as sqlite3_int64 };
    return 0;
}
extern "C" fn templatevtab_best_index(tab: *mut sqlite3_vtab,
...
static mut templatevtab_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: None,
        x_connect: Some(templatevtab_connect),
        x_best_index: Some(templatevtab_best_index),
        x_disconnect: Some(templatevtab_disconnect),
        x_destroy: None,
        x_open: Some(templatevtab_open),
        x_close: Some(templatevtab_close),
        x_filter: Some(templatevtab_filter),
        x_next: Some(templatevtab_next),
        x_eof: Some(templatevtab_eof),
        x_column: Some(templatevtab_column),
        x_rowid: Some(templatevtab_rowid),
        x_update: None,
        x_begin: None,
        x_sync: None,
        x_commit: None,
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    c"templatevtab".as_ptr() as *mut i8 as *const i8,
                    &raw mut templatevtab_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
        return rc;
    }
