...
static mut az_json_atoms: [*mut i8; 84] =
    [c"0".as_ptr() as *mut i8, c"0".as_ptr() as *mut i8,
            ...
            c"-1".as_ptr() as *mut i8, c"-1".as_ptr() as *mut i8,
            c"2".as_ptr() as *mut i8, c"+2".as_ptr() as *mut i8,
            c"3DDDD".as_ptr() as *mut i8, c"3DDDD".as_ptr() as *mut i8,
            c"2.5DD".as_ptr() as *mut i8, c"2.5DD".as_ptr() as *mut i8,
            c"0.75".as_ptr() as *mut i8, c".75".as_ptr() as *mut i8,
            c"-4.0e2".as_ptr() as *mut i8, c"-4.e2".as_ptr() as *mut i8,
            c"5.0e-3".as_ptr() as *mut i8, c"+5e-3".as_ptr() as *mut i8,
            c"6.DDe+0DD".as_ptr() as *mut i8,
            c"6.DDe+0DD".as_ptr() as *mut i8, c"0".as_ptr() as *mut i8,
            c"0x0".as_ptr() as *mut i8, c"512".as_ptr() as *mut i8,
            c"0x200".as_ptr() as *mut i8, c"256".as_ptr() as *mut i8,
            c"+0x100".as_ptr() as *mut i8, c"-2748".as_ptr() as *mut i8,
            c"-0xabc".as_ptr() as *mut i8, c"true".as_ptr() as *mut i8,
            c"true".as_ptr() as *mut i8, c"false".as_ptr() as *mut i8,
            c"false".as_ptr() as *mut i8, c"null".as_ptr() as *mut i8,
            c"null".as_ptr() as *mut i8, c"9.0e999".as_ptr() as *mut i8,
            c"Infinity".as_ptr() as *mut i8, c"-9.0e999".as_ptr() as *mut i8,
            c"-Infinity".as_ptr() as *mut i8, c"9.0e999".as_ptr() as *mut i8,
            c"+Infinity".as_ptr() as *mut i8, c"null".as_ptr() as *mut i8,
            c"NaN".as_ptr() as *mut i8, c"-0.0005DD".as_ptr() as *mut i8,
            c"-0.0005DD".as_ptr() as *mut i8, c"4.35e-3".as_ptr() as *mut i8,
            c"+4.35e-3".as_ptr() as *mut i8,
            c"\"gem\\\"hay\"".as_ptr() as *mut i8,
            c"\"gem\\\"hay\"".as_ptr() as *mut i8,
            c"\"icy\'joy\"".as_ptr() as *mut i8,
            c"\'icy\\\'joy\'".as_ptr() as *mut i8,
            c"\"keylog\"".as_ptr() as *mut i8,
            c"\"key\\\nlog\"".as_ptr() as *mut i8,
            c"\"mix\\\\\\tnet\"".as_ptr() as *mut i8,
            c"\"mix\\\\\\tnet\"".as_ptr() as *mut i8,
            c"\"oat\\r\\n\"".as_ptr() as *mut i8,
            c"\"oat\\r\\n\"".as_ptr() as *mut i8,
            c"\"\\fpan\\b\"".as_ptr() as *mut i8,
            c"\"\\fpan\\b\"".as_ptr() as *mut i8, c"{}".as_ptr() as *mut i8,
            c"{}".as_ptr() as *mut i8, c"[]".as_ptr() as *mut i8,
            c"[]".as_ptr() as *mut i8, c"[]".as_ptr() as *mut i8,
            c"[/*empty*/]".as_ptr() as *mut i8, c"{}".as_ptr() as *mut i8,
            c"{//empty\n}".as_ptr() as *mut i8,
            c"\"ask\"".as_ptr() as *mut i8, c"\"ask\"".as_ptr() as *mut i8,
            c"\"bag\"".as_ptr() as *mut i8, c"\"bag\"".as_ptr() as *mut i8,
            c"\"can\"".as_ptr() as *mut i8, c"\"can\"".as_ptr() as *mut i8,
            c"\"day\"".as_ptr() as *mut i8, c"\"day\"".as_ptr() as *mut i8,
            c"\"end\"".as_ptr() as *mut i8, c"\'end\'".as_ptr() as *mut i8,
            c"\"fly\"".as_ptr() as *mut i8, c"\"fly\"".as_ptr() as *mut i8,
            c"\"\\u00XX\\u00XX\"".as_ptr() as *mut i8,
            c"\"\\xXX\\xXX\"".as_ptr() as *mut i8,
...
static mut az_json_template: [*mut i8; 28] =
    [c"{\"a\":%,\"b\":%,\"cDD\":%}".as_ptr() as *mut i8,
            c"{a:%,b:%,cDD:%}".as_ptr() as *mut i8,
            c"{\"a\":%,\"b\":%,\"c\":%,\"d\":%,\"e\":%}".as_ptr() as *mut i8,
            c"{a:%,b:%,c:%,d:%,e:%}".as_ptr() as *mut i8,
            c"{\"a\":%,\"b\":%,\"c\":%,\"d\":%,\"\":%}".as_ptr() as *mut i8,
            c"{a:%,b:%,c:%,d:%,\'\':%}".as_ptr() as *mut i8,
            c"{\"d\":%}".as_ptr() as *mut i8, c"{d:%}".as_ptr() as *mut i8,
            c"{\"eeee\":%, \"ffff\":%}".as_ptr() as *mut i8,
            c"{eeee:% /*and*/, ffff:%}".as_ptr() as *mut i8,
            c"{\"$g\":%,\"_h_\":%,\"a b c d\":%}".as_ptr() as *mut i8,
            c"{$g:%,_h_:%,\"a b c d\":%}".as_ptr() as *mut i8,
            c"{\"x\":%,\n  \"y\":%}".as_ptr() as *mut i8,
            c"{\"x\":%,\n  \"y\":%}".as_ptr() as *mut i8,
            c"{\"\\u00XX\":%,\"\\uXXXX\":%}".as_ptr() as *mut i8,
            c"{\"\\xXX\":%,\"\\uXXXX\":%}".as_ptr() as *mut i8,
            c"{\"Z\":%}".as_ptr() as *mut i8, c"{Z:%,}".as_ptr() as *mut i8,
            c"[%]".as_ptr() as *mut i8, c"[%,]".as_ptr() as *mut i8,
            c"[%,%]".as_ptr() as *mut i8, c"[%,%]".as_ptr() as *mut i8,
            c"[%,%,%]".as_ptr() as *mut i8, c"[%,%,%,]".as_ptr() as *mut i8,
            c"[%,%,%,%]".as_ptr() as *mut i8,
...
extern "C" fn json_expand(mut z_src_1: *const i8, z_dest_1: *mut i8,
    ...
    unsafe {
        ...
        let mut z_x: *mut i8 = core::ptr::null_mut();
        let mut n: u64 = 0 as u64;
        let mut z_buf: [i8; 200] = [0; 200];
        j = 0 as u32;
        if z_src_1 == core::ptr::null() {
            z_src_1 = c"%".as_ptr() as *mut i8 as *const i8;
        }
        if unsafe { strlen(z_src_1) } >= (10000 / 10) as u64 { r = 0 as u32; }
        {
            i = 0 as u32;
            '__b0: loop {
                if !(unsafe { *z_src_1.add(i as usize) } != 0) {
                    break '__b0;
                }
                '__c0: loop {
                    if unsafe { *z_src_1.add(i as usize) } as i32 != '%' as i32
                        {
                        if j < 10000 as u32 {
                            unsafe {
                                *z_dest_1.add({
                                                    ...
                                                    *__p += 1;
                                                    __t
                                                } as usize) = unsafe { *z_src_1.add(i as usize) } as i8
                            };
                        }
                        break '__c0;
                    }
                    ...
                    if {
                                z_x =
                                    unsafe {
                                        strstr(z as *const i8,
                                            c"XX".as_ptr() as *mut i8 as *const i8)
                                    };
                                z_x
                            } != core::ptr::null_mut() {
                        let mut y: u32 = prng_int(unsafe { &mut *p });
                        if y & 255 as u32 == y >> 8 & 255 as u32 {
                            y += 256 as u32;
                        }
                        while y & 255 as u32 == y >> 16 & 255 as u32 ||
                                y >> 8 & 255 as u32 == y >> 16 & 255 as u32 {
                            y += 65536 as u32;
                        }
                        unsafe {
                            memcpy(&raw mut z_buf[0 as usize] as *mut i8 as *mut (),
                                z as *const (), n + 1 as u64)
                        };
                        z = &raw mut z_buf[0 as usize] as *mut i8;
                        z_x =
                            unsafe {
                                strstr(z as *const i8,
                                    c"XX".as_ptr() as *mut i8 as *const i8)
                            };
                        while z_x != core::ptr::null_mut() {
                            unsafe {
                                *z_x.offset(0 as isize) =
                                    unsafe {
                                        *(c"0123456789abcdef".as_ptr() as
                                                    *mut i8).add((y % 16 as u32) as usize)
                                    }
                            };
                            y /= 16 as u32;
                            unsafe {
                                *z_x.offset(1 as isize) =
                                    unsafe {
                                        *(c"0123456789abcdef".as_ptr() as
                                                    *mut i8).add((y % 16 as u32) as usize)
                                    }
                            ...
                            z_x =
                                ...
                                z_x =
                                    unsafe {
                                        strstr(z as *const i8,
                                            c"DD".as_ptr() as *mut i8 as *const i8)
                                    };
                                z_x
                            } != core::ptr::null_mut() {
                        let mut y: u32 = prng_int(unsafe { &mut *p });
                        ...
                        while z_x != core::ptr::null_mut() {
                            unsafe {
                                *z_x.offset(0 as isize) =
                                    unsafe {
                                        *(c"0123456789".as_ptr() as
                                                    *mut i8).add((y % 10 as u32) as usize)
                                    }
                            };
                            y /= 10 as u32;
                            unsafe {
                    ...
                    if !(unsafe {
                        ...
                        unsafe {
                            __assert_rtn(c"jsonExpand".as_ptr() as *const i8,
                                c"randomjson.c".as_ptr() as *mut i8 as *const i8, 184,
                                c"strstr(z, \"XX\")==0".as_ptr() as *mut i8 as *const i8)
                        }
                    } else { { let _ = 0; } };
                    if !(unsafe {
                                                strstr(z as *const i8,
                        ...
                        unsafe {
                            __assert_rtn(c"jsonExpand".as_ptr() as *const i8,
                                c"randomjson.c".as_ptr() as *mut i8 as *const i8, 185,
                                c"strstr(z, \"DD\")==0".as_ptr() as *mut i8 as *const i8)
                        }
                    } else { { let _ = 0; } };
                    if j as u64 + n < 10000 as u64 {
                        unsafe {
                            memcpy(unsafe { &raw mut *z_dest_1.add(j as usize) } as
                                    *mut (), z as *const (), n)
                        };
                        j += n as i32 as u32;
                    }
        ...
        unsafe { *z_dest_1.offset((10000 - 1) as isize) = 0 as i8 };
        if j < 10000 as u32 {
            unsafe { *z_dest_1.add(j as usize) = 0 as i8 };
        }
    }
}
extern "C" fn rand_json_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut i_seed: u32 = 0 as u32;
    let e_type: i32 =
        unsafe { *(unsafe { sqlite3_user_data(context) } as *mut i32) };
    let mut prng: Prng = unsafe { core::mem::zeroed() };
    let mut z1: [i8; 10001] = [0; 10001];
    let mut z2: [i8; 10001] = [0; 10001];
    i_seed =
        unsafe { sqlite3_value_int(unsafe { *argv.offset(0 as isize) }) } as
            u32;
    prng_seed(&mut prng, i_seed);
    json_expand(core::ptr::null(), &raw mut z2[0 as usize] as *mut i8,
        &mut prng, e_type, 1000 as u32);
    json_expand(&raw mut z2[0 as usize] as *mut i8 as *const i8,
        &raw mut z1[0 as usize] as *mut i8, &mut prng, e_type, 1000 as u32);
    json_expand(&raw mut z1[0 as usize] as *mut i8 as *const i8,
        &raw mut z2[0 as usize] as *mut i8, &mut prng, e_type, 100 as u32);
    json_expand(&raw mut z2[0 as usize] as *mut i8 as *const i8,
        &raw mut z1[0 as usize] as *mut i8, &mut prng, e_type, 0 as u32);
    unsafe {
        sqlite3_result_text(context,
            &raw mut z1[0 as usize] as *mut i8 as *const i8, -1,
            Some(unsafe {
    ...
    unsafe {
        ...
        if rc == 0 {
            rc =
                unsafe {
                    sqlite3_create_function(db,
                        c"random_json5".as_ptr() as *mut i8 as *const i8, 1,
                        1 | 2097152 | 2048, &raw mut c_one as *mut (),
                        Some(rand_json_func), None, None)
                };
        }
        return rc;
