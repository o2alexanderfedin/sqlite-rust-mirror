...
struct closure_cursor {
    ...
    p_vtab: *mut closure_vtab,
    z_table_name: *mut i8,
    z_id_column: *mut i8,
    z_parent_column: *mut i8,
    p_current: *mut closure_avl,
    p_closure: *mut closure_avl,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct closure_avl {
    id: sqlite3_int64,
    i_generation: i32,
    p_list: *mut closure_avl,
    p_before: *mut closure_avl,
    p_after: *mut closure_avl,
    p_up: *mut closure_avl,
    height: i16,
    imbalance: i16,
}
#[repr(C)]
...
struct closure_queue {
    p_first: *mut closure_avl,
    p_last: *mut closure_avl,
}
extern "C" fn closure_avl_recompute_height(p: &mut closure_avl) -> () {
    let h_before: i16 =
...
extern "C" fn closure_avl_rotate_before(p_p_1: *mut closure_avl)
    -> *mut closure_avl {
    let p_b: *mut closure_avl = unsafe { (*p_p_1).p_before };
    let p_y: *mut closure_avl = unsafe { (*p_b).p_after };
...
extern "C" fn closure_avl_rotate_after(p_p_1: *mut closure_avl)
    -> *mut closure_avl {
    let p_a: *mut closure_avl = unsafe { (*p_p_1).p_after };
    let p_y: *mut closure_avl = unsafe { (*p_a).p_before };
...
extern "C" fn closure_avl_from_ptr(p: *mut closure_avl,
    pp: *mut *mut closure_avl) -> *mut *mut closure_avl {
    let p_up: *mut closure_avl = unsafe { (*p).p_up };
...
extern "C" fn closure_avl_balance(mut p: *mut closure_avl)
    -> *mut closure_avl {
    let mut p_top: *mut closure_avl = p;
    let mut pp: *mut *mut closure_avl = core::ptr::null_mut();
    while !(p).is_null() {
        closure_avl_recompute_height(unsafe { &mut *p });
        if unsafe { (*p).imbalance } as i32 >= 2 {
            let p_b: *mut closure_avl = unsafe { (*p).p_before };
            ...
            let p_a: *mut closure_avl = unsafe { (*p).p_after };
...
extern "C" fn closure_avl_search(mut p: *mut closure_avl, id: sqlite3_int64)
    -> *mut closure_avl {
...
extern "C" fn closure_avl_first(mut p: *mut closure_avl) -> *mut closure_avl {
    if !(p).is_null() {
...
#[unsafe(no_mangle)]
pub extern "C" fn closure_avl_next(mut p: *mut closure_avl)
    -> *mut closure_avl {
    let mut p_prev: *mut closure_avl = core::ptr::null_mut();
...
extern "C" fn closure_avl_insert(pp_head_1: &mut *mut closure_avl,
    p_new_1: *mut closure_avl) -> *mut closure_avl {
    let mut p: *mut closure_avl = *pp_head_1;
...
extern "C" fn closure_avl_destroy(p: *mut closure_avl,
    x_destroy_1: Option<unsafe extern "C" fn(*mut closure_avl) -> ()>) -> () {
    if !(p).is_null() {
...
extern "C" fn queue_push(p_queue_1: &mut closure_queue,
    p_node_1: *mut closure_avl) -> () {
...
extern "C" fn queue_pull(p_queue_1: &mut closure_queue) -> *mut closure_avl {
    let p: *mut closure_avl = (*p_queue_1).p_first;
    if !(p).is_null() {
    ...
    if !(z_out).is_null() {
        ...
        if q as i32 != '[' as i32 && q as i32 != '\'' as i32 &&
            ...
            if q as i32 == '[' as i32 { q = ']' as i32 as i8; }
            {
                i_in = 1;
                '__b5: loop {
                    if !((i_in as sqlite3_int64) < n_in) { break '__b5; }
                    '__c5: loop {
...
extern "C" fn closure_free(p: *mut closure_vtab) -> () {
    if !(p).is_null() {
        ...
        unsafe {
            memset(p as *mut (), 0,
                core::mem::size_of::<closure_vtab>() as u64)
        };
        unsafe { sqlite3_free(p as *mut ()) };
    }
}
extern "C" fn closure_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p: *mut closure_vtab = p_vtab_1 as *mut closure_vtab;
...
extern "C" fn closure_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut rc: i32 = 0;
    let mut p_new: *mut closure_vtab = core::ptr::null_mut();
        ...
        '__s9:
            ...
            match __state {
                ...
                9 => {
                    p_new =
                        unsafe {
                                sqlite3_malloc64(core::mem::size_of::<closure_vtab>() as
                                        sqlite3_uint64)
                            } as *mut closure_vtab;
                    __state = 10;
                }
...
extern "C" fn closure_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let p: *mut closure_vtab = p_v_tab_1 as *mut closure_vtab;
    let mut p_cur: *mut closure_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<closure_cursor>() as
                        sqlite3_uint64)
            } as *mut closure_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<closure_cursor>() as u64)
    };
...
extern "C" fn closure_mem_free(p: *mut closure_avl) -> () {
    unsafe { sqlite3_free(p as *mut ()) };
}
extern "C" fn closure_clear_cursor(p_cur_1: &mut closure_cursor) -> () {
...
extern "C" fn closure_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut closure_cursor = cur as *mut closure_cursor;
...
extern "C" fn closure_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut closure_cursor = cur as *mut closure_cursor;
    unsafe {
...
extern "C" fn closure_insert_node(p_queue_1: *mut closure_queue,
    p_cur_1: &mut closure_cursor, id: sqlite3_int64, i_generation_1: i32)
    -> i32 {
    let p_new: *mut closure_avl =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<closure_avl>() as
                        sqlite3_uint64)
            } as *mut closure_avl;
    if p_new == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_new as *mut (), 0,
            core::mem::size_of::<closure_avl>() as u64)
    };
    unsafe { (*p_new).id = id };
...
extern "C" fn closure_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_cur: *mut closure_cursor = p_vtab_cursor_1 as *mut closure_cursor;
    let p_vtab: *mut closure_vtab = unsafe { (*p_cur).p_vtab };
    let mut i_root: sqlite3_int64 = 0 as sqlite3_int64;
    let mut mx_gen: i32 = 999999999;
    let mut z_sql: *mut i8 = core::ptr::null_mut();
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut p_avl: *const closure_avl = core::ptr::null();
    let mut rc: i32 = 0;
    ...
    let mut s_queue: closure_queue = unsafe { core::mem::zeroed() };
    { let _ = idx_str_1; };
    { let _ = argc; };
    closure_clear_cursor(unsafe { &mut *p_cur });
    unsafe {
        memset(&raw mut s_queue as *mut (), 0,
            core::mem::size_of::<closure_queue>() as u64)
    };
    if idx_num_1 & 1 == 0 { return 0; }
    i_root =
...
extern "C" fn closure_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *const closure_cursor =
        cur as *mut closure_cursor as *const closure_cursor;
    '__s12:
        {
        match i {
            0 => {
...
extern "C" fn closure_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn closure_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const closure_cursor =
        cur as *mut closure_cursor as *const closure_cursor;
    return (unsafe { (*p_cur).p_current } == core::ptr::null_mut()) as i32;
}
extern "C" fn closure_best_index(p_tab_1: *mut sqlite3_vtab,
    ...
    let p_vtab: *const closure_vtab =
        p_tab_1 as *mut closure_vtab as *const closure_vtab;
...
static mut closure_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
