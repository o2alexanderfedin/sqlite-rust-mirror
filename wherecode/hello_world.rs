...
extern "C" fn explain_append_term(p_str_1: *mut StrAccum, p_idx_1: *mut Index,
    ...
    }
    {
        ...
        '__b0: loop {
            ...
            '__c0: loop {
                ...
                unsafe {
                    sqlite3_str_appendall(p_str_1 as *mut sqlite3_str,
    ...
    unsafe { sqlite3_str_append(p_str_1 as *mut sqlite3_str, z_op_1, 1) };
    if n_term_1 > 1 {
        unsafe {
            sqlite3_str_append(p_str_1 as *mut sqlite3_str,
                c"(".as_ptr() as *mut i8 as *const i8, 1)
...
pub extern "C" fn sqlite3_where_add_explain_text(p_parse: *mut Parse,
    ...
    unsafe {
        if unsafe {
            ...
            unsafe {
                sqlite3_str_appendf(&raw mut str as *mut sqlite3_str,
            ...
            if flags & (256 | 1024) as u32 == 0 as u32 {
                ...
                if !(z_fmt).is_null() {
                    unsafe {
                        sqlite3_str_append(&raw mut str as *mut sqlite3_str,
                            c" USING ".as_ptr() as *mut i8 as *const i8, 7)
                    };
                    unsafe {
                        sqlite3_str_appendf(&raw mut str as *mut sqlite3_str, z_fmt,
                            unsafe { (*p_idx).z_name })
                    };
                ...
                unsafe {
                    sqlite3_str_appendall(&raw mut str as *mut sqlite3_str,
                                    ...
                                    if unsafe {
                                        ...
                                        if unsafe {
                                                    (*(unsafe { (*p_orig_rhs).a.as_ptr() } as
                                                                    *mut ExprList_item).offset(i_field as isize)).p_expr
                                                } == core::ptr::null_mut() {
                                            break '__c8;
                                        }
                                        p_rhs =
                                        ...
                                        if !(p_rhs).is_null() {
                                            unsafe {
                                                (*(unsafe { (*p_rhs).a.as_ptr() } as
                                                                            *mut ExprList_item).offset((unsafe { (*p_rhs).n_expr } - 1)
                            ...
                            (*p_compare).p_left =
                                unsafe {
                                    (*(unsafe { (*unsafe { (*p_left).x.p_list }).a.as_ptr() } as
                                                    *mut ExprList_item).offset((i_fld - 1) as isize)).p_expr
                                }
                        };
                        __state = 112;
                    }
...
pub extern "C" fn sqlite3_where_right_join_loop(p_w_info: &mut WhereInfo,
    ...
    unsafe {
        ...
        let mut u_src:
                sqlite3_where_right_join_loop_u0_N32sqlite3_where_right_join_loop_u0 =
...
#[repr(C)]
#[derive(Copy, Clone)]
union sqlite3_where_right_join_loop_u0_N32sqlite3_where_right_join_loop_u0 {
    s_src: SrcList,
    from_space: [u8; 80],
}
