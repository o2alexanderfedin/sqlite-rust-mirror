...
struct amatch_vtab {
    ...
    z_vocab_word: *mut i8,
    z_vocab_lang: *mut i8,
    p_rule: *mut amatch_rule,
    r_ins: amatch_cost,
    r_del: amatch_cost,
    r_sub: amatch_cost,
    db: *mut sqlite3,
    p_v_check: *mut sqlite3_stmt,
    n_cursor: i32,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct amatch_rule {
    p_next: *mut amatch_rule,
    z_from: *mut i8,
    r_cost: amatch_cost,
    i_lang: amatch_langid,
    n_from: amatch_len,
    n_to: amatch_len,
    z_to: [i8; 4],
}
type amatch_cost = i32;
type amatch_langid = i32;
type amatch_len = i8;
#[repr(C)]
#[derive(Copy, Clone)]
struct amatch_cursor {
    ...
    z_buf: *mut i8,
    z_input: *mut i8,
    p_vtab: *mut amatch_vtab,
    p_all_words: *mut amatch_word,
    p_current: *mut amatch_word,
    p_cost: *mut amatch_avl,
    p_word: *mut amatch_avl,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct amatch_word {
    p_next: *mut amatch_word,
    s_cost: amatch_avl,
    s_word: amatch_avl,
    r_cost: amatch_cost,
    i_seq: i32,
...
#[derive(Copy, Clone)]
struct amatch_avl {
    p_word: *mut amatch_word,
    z_key: *mut i8,
    p_before: *mut amatch_avl,
    p_after: *mut amatch_avl,
    p_up: *mut amatch_avl,
    height: i32,
    imbalance: i32,
}
extern "C" fn amatch_avl_recompute_height(p: &mut amatch_avl) -> () {
    let h_before: i32 =
...
extern "C" fn amatch_avl_rotate_before(p_p_1: *mut amatch_avl)
    -> *mut amatch_avl {
    let p_b: *mut amatch_avl = unsafe { (*p_p_1).p_before };
    let p_y: *mut amatch_avl = unsafe { (*p_b).p_after };
...
extern "C" fn amatch_avl_rotate_after(p_p_1: *mut amatch_avl)
    -> *mut amatch_avl {
    let p_a: *mut amatch_avl = unsafe { (*p_p_1).p_after };
    let p_y: *mut amatch_avl = unsafe { (*p_a).p_before };
...
extern "C" fn amatch_avl_from_ptr(p: *mut amatch_avl,
    pp: *mut *mut amatch_avl) -> *mut *mut amatch_avl {
    let p_up: *mut amatch_avl = unsafe { (*p).p_up };
...
extern "C" fn amatch_avl_balance(mut p: *mut amatch_avl) -> *mut amatch_avl {
    let mut p_top: *mut amatch_avl = p;
    let mut pp: *mut *mut amatch_avl = core::ptr::null_mut();
    while !(p).is_null() {
        amatch_avl_recompute_height(unsafe { &mut *p });
        if unsafe { (*p).imbalance } >= 2 {
            let p_b: *mut amatch_avl = unsafe { (*p).p_before };
            ...
            let p_a: *mut amatch_avl = unsafe { (*p).p_after };
...
extern "C" fn amatch_avl_search(mut p: *mut amatch_avl, z_key_1: *const i8)
    -> *mut amatch_avl {
    let mut c: i32 = 0;
    while !(p).is_null() &&
            {
...
extern "C" fn amatch_avl_first(mut p: *mut amatch_avl) -> *mut amatch_avl {
    if !(p).is_null() {
...
extern "C" fn amatch_avl_insert(pp_head_1: &mut *mut amatch_avl,
    p_new_1: *mut amatch_avl) -> *mut amatch_avl {
    let mut c: i32 = 0;
    let mut p: *mut amatch_avl = *pp_head_1;
...
extern "C" fn amatch_avl_remove(pp_head_1: *mut *mut amatch_avl,
    p_old_1: *mut amatch_avl) -> () {
    let mut pp_parent: *mut *mut amatch_avl = core::ptr::null_mut();
    let mut p_balance: *mut amatch_avl = core::ptr::null_mut();
    ...
    if unsafe { (*p_old_1).p_before } == core::ptr::null_mut() &&
        ...
        let mut p_x: *mut amatch_avl = core::ptr::null_mut();
        let mut p_y: *mut amatch_avl = core::ptr::null_mut();
...
extern "C" fn amatch_merge_rules(mut p_a_1: *mut amatch_rule,
    mut p_b_1: *mut amatch_rule) -> *mut amatch_rule {
    let mut head: amatch_rule = unsafe { core::mem::zeroed() };
    let mut p_tail: *mut amatch_rule = core::ptr::null_mut();
    p_tail = &mut head;
...
extern "C" fn amatch_load_one_rule(p: &mut amatch_vtab,
    p_stmt_1: *mut sqlite3_stmt, pp_rule_1: &mut *mut amatch_rule,
    pz_err_1: &mut *mut i8) -> i32 {
    let i_lang: sqlite3_int64 = unsafe { sqlite3_column_int64(p_stmt_1, 0) };
    ...
    let r_cost: amatch_cost = unsafe { sqlite3_column_int(p_stmt_1, 3) };
    let mut rc: i32 = 0;
    let mut n_from: i32 = 0;
    let mut n_to: i32 = 0;
    let mut p_rule: *mut amatch_rule = core::ptr::null_mut();
    ...
    if r_cost <= 0 || r_cost > 1000 {
        ...
        *pz_err_1 =
        ...
        p_rule =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<amatch_rule>() as u64
        ...
        if p_rule == core::ptr::null_mut() {
            ...
            unsafe {
                memset(p_rule as *mut (), 0,
                    core::mem::size_of::<amatch_rule>() as u64)
            };
            unsafe {
                (*p_rule).z_from =
                    unsafe { &mut (*p_rule).z_to[(n_to + 1) as usize] }
            };
            unsafe { (*p_rule).n_from = n_from as amatch_len };
            unsafe {
            ...
            unsafe { (*p_rule).n_to = n_to as amatch_len };
...
extern "C" fn amatch_free_rules(p: &mut amatch_vtab) -> () {
    while !((*p).p_rule).is_null() {
        let p_rule: *mut amatch_rule = (*p).p_rule;
        (*p).p_rule = unsafe { (*p_rule).p_next };
        unsafe { sqlite3_free(p_rule as *mut ()) };
    }
    (*p).p_rule = core::ptr::null_mut();
}
extern "C" fn amatch_load_rules(db: *mut sqlite3, p: *mut amatch_vtab,
    pz_err_1: *mut *mut i8) -> i32 {
    let mut rc: i32 = 0;
    let mut z_sql: *mut i8 = core::ptr::null_mut();
    let mut p_head: *mut amatch_rule = core::ptr::null_mut();
    z_sql =
        unsafe {
    ...
    if rc == 0 {
        ...
        let mut p_x: *mut amatch_rule = core::ptr::null_mut();
        let mut a: [*mut amatch_rule; 15] = [core::ptr::null_mut(); 15];
        {
            i = 0 as u32;
            '__b7: loop {
                if !((i as u64) <
                                core::mem::size_of::<[*mut amatch_rule; 15]>() as u64 /
                                    core::mem::size_of::<*mut amatch_rule>() as u64) {
                    break '__b7;
                }
                '__c7: loop {
            ...
            unsafe { (*p_x).p_next = core::ptr::null_mut() };
            {
                ...
                '__b9: loop {
                    if !(!(a[i as usize]).is_null() &&
                                    (i as u64) <
                                        core::mem::size_of::<[*mut amatch_rule; 15]>() as u64 /
                                                core::mem::size_of::<*mut amatch_rule>() as u64 - 1 as u64)
                        {
                        break '__b9;
                    }
                    '__c9: loop {
    ...
    if !(z_out).is_null() {
        ...
        if q as i32 != '[' as i32 && q as i32 != '\'' as i32 &&
            ...
            if q as i32 == '[' as i32 { q = ']' as i32 as i8; }
            {
                i_in = 1;
                '__b11: loop {
                    if !((i_in as sqlite3_int64) < n_in) { break '__b11; }
                    '__c11: loop {
        ...
        if !(unsafe { strlen(z_out as *const i8) } as i32 as sqlite3_int64 <=
...
extern "C" fn amatch_v_check_clear(p: &mut amatch_vtab) -> () {
    if !((*p).p_v_check).is_null() {
        unsafe { sqlite3_finalize((*p).p_v_check) };
        (*p).p_v_check = core::ptr::null_mut();
    }
}
extern "C" fn amatch_free(p: *mut amatch_vtab) -> () {
    if !(p).is_null() {
        ...
        unsafe {
            memset(p as *mut (), 0,
                core::mem::size_of::<amatch_vtab>() as u64)
        };
        unsafe { sqlite3_free(p as *mut ()) };
    }
}
extern "C" fn amatch_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p: *mut amatch_vtab = p_vtab_1 as *mut amatch_vtab;
...
extern "C" fn amatch_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    pz_err_1: *mut *mut i8) -> i32 {
    let mut rc: i32 = 0;
    let mut p_new: *mut amatch_vtab = core::ptr::null_mut();
        ...
        '__s15:
            ...
            match __state {
                ...
                10 => {
                    p_new =
                        unsafe {
                                sqlite3_malloc64(core::mem::size_of::<amatch_vtab>() as
                                        sqlite3_uint64)
                            } as *mut amatch_vtab;
                    __state = 11;
                }
...
extern "C" fn amatch_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let p: *mut amatch_vtab = p_v_tab_1 as *mut amatch_vtab;
    let mut p_cur: *mut amatch_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<amatch_cursor>() as
                        sqlite3_uint64)
            } as *mut amatch_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<amatch_cursor>() as u64)
    };
...
extern "C" fn amatch_clear_cursor(p_cur_1: &mut amatch_cursor) -> () {
    let mut p_word: *mut amatch_word = core::ptr::null_mut();
    let mut p_next_word: *mut amatch_word = core::ptr::null_mut();
    {
    ...
    (*p_cur_1).n_buf = 0 as sqlite3_int64;
...
extern "C" fn amatch_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut amatch_cursor = cur as *mut amatch_cursor;
...
extern "C" fn amatch_write_cost(p_word_1: &mut amatch_word) -> () {
...
extern "C" fn amatch_add_word(p_cur_1: &mut amatch_cursor,
    r_cost_1: amatch_cost, n_match_1: i32, z_word_base_1: *const i8,
    z_word_tail_1: *const i8) -> () {
    let mut p_word: *mut amatch_word = core::ptr::null_mut();
    let mut p_node: *const amatch_avl = core::ptr::null();
    let mut p_other: *const amatch_avl = core::ptr::null();
    ...
    if (n_base + n_tail + 3) as sqlite3_int64 > (*p_cur_1).n_buf {
        (*p_cur_1).n_buf = (n_base + n_tail + 100) as sqlite3_int64;
        (*p_cur_1).z_buf =
            unsafe {
                    sqlite3_realloc64((*p_cur_1).z_buf as *mut (),
                        (*p_cur_1).n_buf as sqlite3_uint64)
                } as *mut i8;
...
extern "C" fn amatch_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut amatch_cursor = cur as *mut amatch_cursor;
    let mut p_word: *mut amatch_word = core::ptr::null_mut();
    let mut p_node: *const amatch_avl = core::ptr::null();
    let mut is_match: i32 = 0;
    let p: *mut amatch_vtab = unsafe { (*p_cur).p_vtab };
    let mut n_word: sqlite3_int64 = 0 as sqlite3_int64;
    let mut rc: i32 = 0;
    let mut i: i32 = 0;
    let mut z_w: *const i8 = core::ptr::null();
    let mut p_rule: *const amatch_rule = core::ptr::null();
    let mut z_buf: *mut i8 = core::ptr::null_mut();
    let mut n_buf: sqlite3_int64 = 0 as sqlite3_int64;
        ...
        '__c19: loop {
            ...
            n_word =
                unsafe {
                        ...
                        } as i32 as sqlite3_int64;
            if n_word + 20 as sqlite3_int64 > n_buf {
                n_buf = n_word + 100 as sqlite3_int64;
                z_buf =
                    unsafe {
                            sqlite3_realloc64(z_buf as *mut (), n_buf as sqlite3_uint64)
                        } as *mut i8;
            ...
            if z_next_in[0 as usize] != 0 &&
                ...
                unsafe {
                    sqlite3_bind_text(unsafe { (*p).p_v_check }, 1,
                        z_buf as *const i8,
                        (n_word + n_next_in as sqlite3_int64) as i32, None)
                };
                ...
                if rc == 100 {
                    ...
                    if unsafe {
                                strncmp(z_buf as *const i8, z_w,
                                    (n_word + n_next_in as sqlite3_int64) as u64)
                            } == 0 {
            ...
            loop {
                    ...
                    unsafe { *z_w.offset(n_word as isize) } as i8;
                {
                    ...
                    '__b22: loop {
                        if !(i <= 4 &&
                                        unsafe {
                                                        *z_w.offset((n_word + i as sqlite3_int64) as isize)
                                                    } as i32 & 192 == 128) {
                            break '__b22;
                        }
                        '__c22: loop {
...
extern "C" fn amatch_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_cur: *mut amatch_cursor = p_vtab_cursor_1 as *mut amatch_cursor;
...
extern "C" fn amatch_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *const amatch_cursor =
        cur as *mut amatch_cursor as *const amatch_cursor;
    '__s24:
        {
        match i {
            0 => {
...
extern "C" fn amatch_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn amatch_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const amatch_cursor =
        cur as *mut amatch_cursor as *const amatch_cursor;
    return (unsafe { (*p_cur).p_current } == core::ptr::null_mut()) as i32;
}
extern "C" fn amatch_best_index(tab: *mut sqlite3_vtab,
...
extern "C" fn amatch_update(p_v_tab_1: *mut sqlite3_vtab, argc: i32,
    argv: *mut *mut sqlite3_value, p_rowid_1: *mut sqlite_int64) -> i32 {
    let p: *const amatch_vtab =
        p_v_tab_1 as *mut amatch_vtab as *const amatch_vtab;
...
static mut amatch_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut amatch_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
        return rc;
    }
