...
extern "C" fn totype_atoi64(mut z_num_1: *const i8,
    p_num_1: &mut sqlite3_int64, length: i32) -> i32 {
    ...
    }
    {
        ...
        '__b3: loop {
            ...
            '__c3: loop {
                u =
                    u * 10 as sqlite3_uint64 + c as sqlite3_uint64 -
                        '0' as i32 as sqlite3_uint64;
                break '__c3;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
        }
    ...
    if u >
            (4294967295u32 as sqlite3_int64 |
                    (2147483647 as sqlite3_int64) << 32) as u64 {
        *p_num_1 =
            -1 as sqlite3_int64 -
                (4294967295u32 as sqlite3_int64 |
                    (2147483647 as sqlite3_int64) << 32);
    } else if neg != 0 {
        *p_num_1 = -(u as sqlite3_int64);
    } else { *p_num_1 = u as sqlite3_int64; }
    if c != 0 && unsafe { z_num_1.offset(i as isize) } < z_end ||
        ...
        if !(u <=
                                (4294967295u32 as sqlite3_int64 |
                                        (2147483647 as sqlite3_int64) << 32) as u64) as i32 as i64
                != 0 {
            unsafe {
        ...
        if c < 0 {
            ...
            if !(*p_num_1 ==
                                    -1 as sqlite3_int64 -
                                        (4294967295u32 as sqlite3_int64 |
                                            (2147483647 as sqlite3_int64) << 32)) as i32 as i64 != 0 {
                unsafe {
                    __assert_rtn(c"totypeAtoi64".as_ptr() as *const i8,
...
extern "C" fn totype_ato_f(mut z: *const i8, p_result_1: &mut f64,
    ...
    let mut sign: i32 = 0;
    let mut s: sqlite3_int64 = 0 as sqlite3_int64;
    let mut d: i32 = 0;
    let mut esign: i32 = 0;
    let mut e: i32 = 0;
    ...
    loop {
        ...
        '__s5:
            ...
            match __state {
                ...
                3 => { sign = 1; __state = 4; }
                4 => { s = 0 as sqlite3_int64; __state = 5; }
                5 => { d = 0; __state = 6; }
                6 => { esign = 1; __state = 7; }
                7 => { e = 0; __state = 8; }
                ...
                23 => {
                    if z < z_end && totype_isdigit(unsafe { *z } as u8) != 0 &&
                            s <
                                ((4294967295u32 as sqlite3_int64 |
                                            (2147483647 as sqlite3_int64) << 32) - 9 as sqlite3_int64) /
                                    10 as sqlite3_int64 {
                        __state = 26;
                    } else { __state = 25; }
                }
                ...
                26 => {
                    s =
                        s * 10 as sqlite3_int64 +
                            (unsafe { *z } as i32 - '0' as i32) as sqlite3_int64;
                    __state = 27;
                }
                27 => {
                    {
                ...
                67 => {
                    if s <
                                (4294967295u32 as sqlite3_int64 |
                                        (2147483647 as sqlite3_int64) << 32) / 10 as sqlite3_int64
                            && e > 0 {
                        __state = 69;
                    } else { __state = 66; }
                }
                68 => {
                    if (s % 10 as sqlite3_int64 == 0) as i32 != 0 && e > 0 {
                        __state = 70;
                    } else { __state = 66; }
                }
                69 => {
...
extern "C" fn totype_double_to_int(r: f64) -> sqlite3_int64 {
    if r < -9.223372036854775e18 { return 0 as sqlite3_int64; }
    if r > 9.223372036854775e18 { return 0 as sqlite3_int64; }
    return r as sqlite3_int64;
}
extern "C" fn tointeger_func(context: *mut sqlite3_context, argc: i32,
            ...
            2 => {
                {
                    ...
                    let i_val: sqlite3_int64 = totype_double_to_int(r_val);
                ...
                }
                {
                    ...
                    if !(z_blob).is_null() {
                        ...
                        if n_blob as u64 ==
                            ...
                            let mut i_val_1: sqlite3_int64 = 0 as sqlite3_int64;
                                    ...
                                    '__b7: loop {
                                        ...
                                        '__c7: loop {
                                            z_blob_rev[i as usize] =
                                                unsafe {
                                                        *z_blob.add((core::mem::size_of::<sqlite3_int64>() as u64 -
                    ...
                    if !(z_str).is_null() {
                        ...
                        if n_str != 0 &&
                                (totype_isspace(unsafe { *z_str.offset(0 as isize) }) == 0)
                                        as i32 != 0 {
                            let mut i_val_2: sqlite3_int64 = 0 as sqlite3_int64;
...
extern "C" fn toreal_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    if !(argc == 1) as i32 as i64 != 0 {
        unsafe {
