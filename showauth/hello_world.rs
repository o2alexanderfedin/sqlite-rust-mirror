...
extern "C" fn auth_callback(p_client_data_1: *mut (), op: i32,
    ...
    let mut z_op_space: [i8; 50] = [0; 50];
    '__s0:
        {
        match op {
            1 => { z_op = c"CREATE_INDEX".as_ptr() as *mut i8 as *const i8; }
            2 => { z_op = c"CREATE_TABLE".as_ptr() as *mut i8 as *const i8; }
            3 => {
                z_op = c"CREATE_TEMP_INDEX".as_ptr() as *mut i8 as *const i8;
            }
            4 => {
                z_op = c"CREATE_TEMP_TABLE".as_ptr() as *mut i8 as *const i8;
            }
            5 => {
                z_op =
                    c"CREATE_TEMP_TRIGGER".as_ptr() as *mut i8 as *const i8;
            }
            6 => {
                z_op = c"CREATE_TEMP_VIEW".as_ptr() as *mut i8 as *const i8;
            }
            7 => {
                z_op = c"CREATE_TRIGGER".as_ptr() as *mut i8 as *const i8;
            }
            8 => { z_op = c"CREATE_VIEW".as_ptr() as *mut i8 as *const i8; }
            9 => { z_op = c"DELETE".as_ptr() as *mut i8 as *const i8; }
            10 => { z_op = c"DROP_INDEX".as_ptr() as *mut i8 as *const i8; }
            11 => { z_op = c"DROP_TABLE".as_ptr() as *mut i8 as *const i8; }
            12 => {
                z_op = c"DROP_TEMP_INDEX".as_ptr() as *mut i8 as *const i8;
            }
            13 => {
                z_op = c"DROP_TEMP_TABLE".as_ptr() as *mut i8 as *const i8;
            }
            14 => {
                z_op = c"DROP_TEMP_TRIGGER".as_ptr() as *mut i8 as *const i8;
            }
            15 => {
                z_op = c"DROP_TEMP_VIEW".as_ptr() as *mut i8 as *const i8;
            }
            16 => { z_op = c"DROP_TRIGGER".as_ptr() as *mut i8 as *const i8; }
            17 => { z_op = c"DROP_VIEW".as_ptr() as *mut i8 as *const i8; }
            18 => { z_op = c"INSERT".as_ptr() as *mut i8 as *const i8; }
            19 => { z_op = c"PRAGMA".as_ptr() as *mut i8 as *const i8; }
            20 => { z_op = c"READ".as_ptr() as *mut i8 as *const i8; }
            21 => { z_op = c"SELECT".as_ptr() as *mut i8 as *const i8; }
            22 => { z_op = c"TRANSACTION".as_ptr() as *mut i8 as *const i8; }
            23 => { z_op = c"UPDATE".as_ptr() as *mut i8 as *const i8; }
            24 => { z_op = c"ATTACH".as_ptr() as *mut i8 as *const i8; }
            25 => { z_op = c"DETACH".as_ptr() as *mut i8 as *const i8; }
            26 => { z_op = c"ALTER_TABLE".as_ptr() as *mut i8 as *const i8; }
            27 => { z_op = c"REINDEX".as_ptr() as *mut i8 as *const i8; }
            28 => { z_op = c"ANALYZE".as_ptr() as *mut i8 as *const i8; }
            29 => {
                z_op = c"CREATE_VTABLE".as_ptr() as *mut i8 as *const i8;
            }
            30 => { z_op = c"DROP_VTABLE".as_ptr() as *mut i8 as *const i8; }
            31 => { z_op = c"FUNCTION".as_ptr() as *mut i8 as *const i8; }
            32 => { z_op = c"SAVEPOINT".as_ptr() as *mut i8 as *const i8; }
            0 => { z_op = c"COPY".as_ptr() as *mut i8 as *const i8; }
            33 => { z_op = c"RECURSIVE".as_ptr() as *mut i8 as *const i8; }
            _ => {
                {
                    unsafe {
                        sqlite3_snprintf(core::mem::size_of::<[i8; 50]>() as i32,
                            &raw mut z_op_space[0 as usize] as *mut i8,
                            c"%d".as_ptr() as *mut i8 as *const i8, op)
                    };
                    z_op =
                        &raw mut z_op_space[0 as usize] as *mut i8 as *const i8;
                    break '__s0;
                }
            }
        }
    ...
    if z1 == core::ptr::null() {
        z1 = c"NULL".as_ptr() as *mut i8 as *const i8;
    }
    if z2 == core::ptr::null() {
        z2 = c"NULL".as_ptr() as *mut i8 as *const i8;
    }
    if z3 == core::ptr::null() {
        z3 = c"NULL".as_ptr() as *mut i8 as *const i8;
    }
    if z4 == core::ptr::null() {
        z4 = c"NULL".as_ptr() as *mut i8 as *const i8;
    }
    unsafe {
        printf(c"AUTH: %s,%s,%s,%s,%s\n".as_ptr() as *mut i8 as *const i8,
            z_op, z1, z2, z3, z4)
    };
    return 0;
}
