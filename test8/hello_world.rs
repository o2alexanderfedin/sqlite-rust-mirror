...
struct Tcl_CmdInfo {
    ...
    objProc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
        *const *mut Tcl_Obj) -> i32>,
    objClientData: *mut (),
    proc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
        *mut *const i8) -> i32>,
    clientData: *mut (),
...
extern "C" fn simulate_vtab_error(p: &mut echo_vtab, z_method_1: *const i8)
    -> i32 {
...
extern "C" fn append_to_echo_module(interp: *mut Tcl_Interp,
    z_arg_1: *const i8) -> () {
    let flags: i32 = 4 | 8 | 1;
    unsafe {
...
extern "C" fn echo_declare_vtab(p_vtab_1: &mut echo_vtab, db: *mut sqlite3)
    -> i32 {
    let mut rc: i32 = 0;
...
extern "C" fn echo_destructor(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p: *mut echo_vtab = p_vtab_1 as *mut echo_vtab;
...
extern "C" fn echo_constructor(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut rc: i32 = 0;
    let mut i: i32 = 0;
    let mut p_vtab: *mut echo_vtab = core::ptr::null_mut();
    p_vtab =
        unsafe {
                sqlite3_malloc_zero(core::mem::size_of::<echo_vtab>() as u64)
            } as *mut echo_vtab;
    ...
    if (unsafe { (*p_vtab).z_this }).is_null() as i32 != 0 {
        echo_destructor(p_vtab as *mut sqlite3_vtab);
        return 7;
    }
    if argc > 3 {
        unsafe {
    ...
    if rc != 0 { echo_destructor(p_vtab as *mut sqlite3_vtab); return rc; }
...
extern "C" fn echo_create(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    if rc == 0 && argc == 5 {
        let mut z_sql: *mut i8 = core::ptr::null_mut();
        let p_vtab: *mut echo_vtab =
            unsafe { *(pp_vtab_1 as *mut *mut echo_vtab) };
        unsafe {
            (*p_vtab).z_log_name =
                unsafe {
                    sqlite3_mprintf(c"%s".as_ptr() as *mut i8 as *const i8,
    ...
    if rc == 0 {
        unsafe {
            (*unsafe { *(pp_vtab_1 as *mut *mut echo_vtab) }).in_transaction =
                1
        };
    }
    return rc;
...
extern "C" fn echo_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    append_to_echo_module(unsafe { (*(p_vtab_1 as *mut echo_vtab)).interp },
        c"xDisconnect".as_ptr() as *mut i8 as *const i8);
    return echo_destructor(p_vtab_1);
}
extern "C" fn echo_destroy(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let mut rc: i32 = 0;
    let p: *const echo_vtab = p_vtab_1 as *mut echo_vtab as *const echo_vtab;
    append_to_echo_module(unsafe { (*(p_vtab_1 as *mut echo_vtab)).interp },
...
extern "C" fn echo_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut echo_cursor = core::ptr::null_mut();
    if simulate_vtab_error(unsafe { &mut *(p_v_tab_1 as *mut echo_vtab) },
                c"xOpen".as_ptr() as *mut i8 as *const i8) != 0 {
        return 1;
    }
    p_cur =
        unsafe {
                sqlite3_malloc_zero(core::mem::size_of::<echo_cursor>() as
                        u64)
            } as *mut echo_cursor;
    unsafe { *pp_cursor_1 = p_cur as *mut sqlite3_vtab_cursor };
    return if !(p_cur).is_null() { 0 } else { 7 };
}
extern "C" fn echo_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let mut rc: i32 = 0;
    let p_cur: *mut echo_cursor = cur as *mut echo_cursor;
    let p_stmt: *mut sqlite3_stmt = unsafe { (*p_cur).p_stmt };
    unsafe { (*p_cur).p_stmt = core::ptr::null_mut() };
    unsafe { sqlite3_free(p_cur as *mut ()) };
    rc = unsafe { sqlite3_finalize(p_stmt) };
    return rc;
}
extern "C" fn echo_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    return if !(unsafe { (*(cur as *mut echo_cursor)).p_stmt }).is_null() {
            0
        } else { 1 };
}
extern "C" fn echo_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let p_cur: *mut echo_cursor = cur as *mut echo_cursor;
        if simulate_vtab_error(unsafe {
                        &mut *(unsafe { (*cur).p_vtab } as *mut echo_vtab)
...
extern "C" fn echo_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    unsafe {
        let i_col: i32 = i + 1;
        let p_stmt: *mut sqlite3_stmt =
            unsafe { (*(cur as *mut echo_cursor)).p_stmt };
        if simulate_vtab_error(unsafe {
                        &mut *(unsafe { (*cur).p_vtab } as *mut echo_vtab)
...
extern "C" fn echo_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn echo_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let mut i: i32 = 0;
        let p_cur: *mut echo_cursor = p_vtab_cursor_1 as *mut echo_cursor;
        let p_vtab: *mut echo_vtab =
            unsafe { (*p_vtab_cursor_1).p_vtab } as *mut echo_vtab;
                    ...
                    rc =
                        unsafe {
                            sqlite3_bind_value(unsafe { (*p_cur).p_stmt }, i + 1,
                                unsafe { *argv.offset(i as isize) } as *const sqlite3_value)
                        };
                    break '__c9;
                }
                { let __p = &mut i; let __t = *__p; *__p += 1; __t };
...
extern "C" fn echo_select_list(p_tab_1: &echo_vtab,
    p_idx_info_1: &sqlite3_index_info) -> *mut i8 {
            ...
            '__b10: loop {
                ...
                '__c10: loop {
                    if (*p_idx_info_1).col_used &
                                (1 as sqlite3_uint64) << if i >= 63 { 63 } else { i } != 0 {
                        z_ret =
                            unsafe {
...
extern "C" fn echo_best_index(tab: *mut sqlite3_vtab,
    ...
    let p_vtab: *mut echo_vtab = tab as *mut echo_vtab;
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
    let interp: *mut Tcl_Interp = unsafe { (*p_vtab).interp };
    let mut n_row: i32 = 0;
    ...
    if (z_query).is_null() as i32 != 0 { return 7; }
    {
        ...
        '__b11: loop {
            ...
            '__c11: loop {
                let mut p_constraint: *const sqlite3_index_constraint =
                    core::ptr::null();
...
#[unsafe(no_mangle)]
pub extern "C" fn echo_update(tab: *mut sqlite3_vtab, n_data_1: i32,
    ap_data_1: *mut *mut sqlite3_value, p_rowid_1: *mut sqlite_int64) -> i32 {
    let p_vtab: *mut echo_vtab = tab as *mut echo_vtab;
    let db: *mut sqlite3 = unsafe { (*p_vtab).db };
    let mut rc: i32 = 0;
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
...
extern "C" fn echo_transaction_call(tab: *mut sqlite3_vtab,
    z_call_1: *const i8) -> i32 {
    let mut z: *mut i8 = core::ptr::null_mut();
    let p_vtab: *const echo_vtab = tab as *mut echo_vtab as *const echo_vtab;
    z =
        unsafe {
...
extern "C" fn echo_begin(tab: *mut sqlite3_vtab) -> i32 {
    let mut rc: i32 = 0;
    let p_vtab: *mut echo_vtab = tab as *mut echo_vtab;
    let interp: *mut Tcl_Interp = unsafe { (*p_vtab).interp };
...
extern "C" fn echo_sync(tab: *mut sqlite3_vtab) -> i32 {
    let mut rc: i32 = 0;
    let p_vtab: *mut echo_vtab = tab as *mut echo_vtab;
    let interp: *mut Tcl_Interp = unsafe { (*p_vtab).interp };
    let mut z_val: *const i8 = core::ptr::null();
...
extern "C" fn echo_commit(tab: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut echo_vtab = tab as *mut echo_vtab;
    let mut rc: i32 = 0;
    { let _ = 0; };
    if simulate_vtab_error(unsafe { &mut *p_vtab },
...
extern "C" fn echo_rollback(tab: *mut sqlite3_vtab) -> i32 {
    let mut rc: i32 = 0;
    let p_vtab: *mut echo_vtab = tab as *mut echo_vtab;
    { let _ = 0; };
    rc =
...
extern "C" fn overloaded_glob_function(p_context_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
    let interp: *mut Tcl_Interp =
        unsafe { sqlite3_user_data(p_context_1) } as *mut Tcl_Interp;
...
extern "C" fn echo_find_function(vtab: *mut sqlite3_vtab, n_arg_1: i32,
    z_func_name_1: *const i8,
    px_func_1:
        *mut unsafe extern "C" fn(*mut sqlite3_context, i32,
            *mut *mut sqlite3_value) -> (), pp_arg_1: *mut *mut ()) -> i32 {
    let p_vtab: *const echo_vtab = vtab as *mut echo_vtab as *const echo_vtab;
    let interp: *mut Tcl_Interp = unsafe { (*p_vtab).interp };
    let mut info: Tcl_CmdInfo = unsafe { core::mem::zeroed() };
    if unsafe {
...
extern "C" fn echo_rename(vtab: *mut sqlite3_vtab, z_new_name_1: *const i8)
    -> i32 {
    let mut rc: i32 = 0;
    let p: *mut echo_vtab = vtab as *mut echo_vtab;
...
extern "C" fn echo_savepoint(p_v_tab_1: *mut sqlite3_vtab, i_savepoint_1: i32)
    -> i32 {
    { let _ = 0; };
    return 0;
}
extern "C" fn echo_release(p_v_tab_1: *mut sqlite3_vtab, i_savepoint_1: i32)
    -> i32 {
    { let _ = 0; };
    return 0;
}
extern "C" fn echo_rollback_to(p_v_tab_1: *mut sqlite3_vtab,
    i_savepoint_1: i32) -> i32 {
    { let _ = 0; };
    return 0;
}
static mut echo_module: sqlite3_module =
    sqlite3_module {
        i_version: 1,
...
static mut echo_module_v2: sqlite3_module =
    sqlite3_module {
        i_version: 2,
        x_create: Some(echo_create),
        x_connect: Some(echo_connect),
        ...
        rc =
            unsafe {
                sqlite3_create_module_v2(db,
                    ...
                    &raw mut echo_module as *const sqlite3_module,
            ...
            rc =
                unsafe {
                    sqlite3_create_module_v2(db,
                        ...
                        &raw mut echo_module_v2 as *const sqlite3_module,
                        p_mod as *mut (), Some(module_destroy))
                };
        }
        unsafe {
...
extern "C" fn declare_vtab(client_data_1: ClientData, interp: *mut Tcl_Interp,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlitetest8_init(interp: *mut Tcl_Interp) -> i32 {
    unsafe {
        let mut i: i32 = 0;
        {
            i = 0;
            '__b18: loop {
                if !((i as u64) <
                                core::mem::size_of::<[sqlitetest8_init_s0_N19sqlitetest8_init_s0; 2]>()
                                        as u64 / 24) {
                    break '__b18;
                }
                '__c18: loop {
...
#[repr(C)]
#[derive(Copy, Clone)]
struct sqlitetest8_init_s0_N19sqlitetest8_init_s0 {
    z_name: *mut i8,
    x_proc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
        *const *mut Tcl_Obj) -> i32>,
    client_data: *mut (),
}
static mut a_obj_cmd: [sqlitetest8_init_s0_N19sqlitetest8_init_s0; 2] =
    [sqlitetest8_init_s0_N19sqlitetest8_init_s0 {
...
extern "C" {
    ...
    -> *mut *const i8;
    fn Tcl_GetVar(interp: *mut Tcl_Interp, varName: *const i8, flags: i32)
    -> *const i8;
    ...
    -> ();
    fn Tcl_GetCommandInfo(interp: *mut Tcl_Interp, cmdName: *const i8,
