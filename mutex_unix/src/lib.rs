...
type DarwinPthreadMutexattrT = OpaquePthreadMutexattrT;
...
extern "C" fn pthread_mutex_alloc(i_type_1: i32) -> *mut Sqlite3Mutex {
    unsafe {
        unsafe {
            let mut p: *mut Sqlite3Mutex = core::ptr::null_mut();
            '__s0:
                {
                match i_type_1 {
                    1 => {
                        {
                            p =
                                unsafe {
                                        sqlite3_malloc_zero(core::mem::size_of::<Sqlite3Mutex>() as
                                                u64)
                                    } as *mut Sqlite3Mutex;
                            if !(p).is_null() {
                                ...
                                unsafe {
                                    pthread_mutex_init(unsafe { &mut (*p).mutex },
                                        &raw mut recursive_attr as *const PthreadMutexattrT)
                                };
...
extern "C" fn pthread_mutex_try(p: *mut Sqlite3Mutex) -> i32 {
    let mut rc: i32 = 0;
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_default_mutex() -> *const Sqlite3MutexMethods {
    return &s_mutex;
}
...
#[repr(C)]
#[derive(Copy, Clone)]
union StaticMutexN11staticMutex {
    m: Sqlite3Mutex,
    a_spacer: [i8; 128],
}

static mut a_mutex: [StaticMutexN11staticMutex; 12] =
    [StaticMutexN11staticMutex {
                m: Sqlite3Mutex {
                    mutex: OpaquePthreadMutexT {
...
extern "C" {
    ...
    -> i32;
    fn pthread_mutexattr_init(_: *mut PthreadMutexattrT)
    -> i32;
    fn pthread_mutexattr_settype(_: *mut PthreadMutexattrT, _: i32)
    -> i32;
    fn pthread_mutex_init(_: *mut PthreadMutexT, _: *const PthreadMutexattrT)
    -> i32;
    fn pthread_mutexattr_destroy(_: *mut PthreadMutexattrT)
    -> i32;
    fn pthread_mutex_destroy(_: *mut PthreadMutexT)
    -> i32;
    fn pthread_mutex_lock(_: *mut PthreadMutexT)
    -> i32;
    fn pthread_mutex_trylock(_: *mut PthreadMutexT)
    -> i32;
