...
extern "C" fn x_sql_callback(p_sql_arg_1: *mut (), z_sql_1: *const i8)
    ...
    let p: *const TestRecover =
        p_sql_arg_1 as *mut TestRecover as *const TestRecover;
    let mut p_eval: *mut Tcl_Obj = core::ptr::null_mut();
    let mut res: i32 = 0;
    p_eval = unsafe { Tcl_DuplicateObj(unsafe { (*p).p_script }) };
    { let __p = unsafe { &mut (*p_eval).refCount }; *__p += 1; *__p };
    res =
        unsafe {
            Tcl_ListObjAppendElement(unsafe { (*p).interp }, p_eval,
                unsafe { Tcl_NewStringObj(z_sql_1, -1) })
        };
    if res == 0 {
        res = unsafe { Tcl_EvalObjEx(unsafe { (*p).interp }, p_eval, 0) };
    }
    '__b0: loop {
        '__c0: loop {
            if {
                        let __p = unsafe { &mut (*p_eval).refCount };
                        *__p -= 1;
                        *__p
                    } <= 0 {
                unsafe { TclFreeObj(p_eval) };
            }
            break '__c0;
        }
        if !(0 != 0) { break '__b0; }
    ...
    if res != 0 {
        unsafe { Tcl_BackgroundError(unsafe { (*p).interp }) };
        return 1;
    } else {
        let p_obj: *mut Tcl_Obj =
            unsafe { Tcl_GetObjResult(unsafe { (*p).interp }) };
        if unsafe { Tcl_GetCharLength(p_obj) } == 0 {
            res = 0;
        } else if unsafe {
                    Tcl_GetIntFromObj(unsafe { (*p).interp }, p_obj, &mut res)
                } != 0 {
            unsafe { Tcl_BackgroundError(unsafe { (*p).interp }) };
            return 1;
        }
...
extern "C" fn get_db_pointer(interp: *mut Tcl_Interp, p_obj_1: *mut Tcl_Obj,
    p_db_1: &mut *mut sqlite3) -> i32 {
    let mut info: Tcl_CmdInfo = unsafe { core::mem::zeroed() };
    if 0 ==
            unsafe {
                Tcl_GetCommandInfo(interp,
                    unsafe { Tcl_GetString(p_obj_1) } as *const i8, &mut info)
            } {
        unsafe {
            Tcl_AppendResult(interp, c"no such handle: ".as_ptr() as *mut i8,
                unsafe { Tcl_GetString(p_obj_1) }, 0 as *mut ())
        };
        return 1;
    }
...
extern "C" fn test_recover_cmd(client_data_1: *mut (),
    interp: *mut Tcl_Interp, objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    unsafe {
        unsafe {
            let mut rc: i32 = 0;
            let mut i_sub: i32 = 0;
            let p_test: *const TestRecover =
                client_data_1 as *mut TestRecover as *const TestRecover;
            if objc < 2 {
                unsafe {
            ...
            rc =
                unsafe {
                    Tcl_GetIndexFromObjStruct(interp,
                        ...
                        &raw mut a_sub[0 as usize] as *mut RecoverSub_N10RecoverSub
                            as *const (),
                        core::mem::size_of::<RecoverSub_N10RecoverSub>() as i32,
                        c"sub-command".as_ptr() as *mut i8 as *const i8, 0,
                        &mut i_sub)
                };
            if rc != 0 { return rc; }
            if objc - 2 != a_sub[i_sub as usize].n_arg {
                unsafe {
                    Tcl_WrongNumArgs(interp, 2, objv,
                        a_sub[i_sub as usize].z_msg)
                };
                return 1;
            }
            '__s1:
                ...
                match i_sub {
                    0 => {
                        { let _ = 0; };
                        {
                            let mut a_op: [*const i8; 7] =
                                [c"testdb".as_ptr() as *const i8,
                                        c"lostandfound".as_ptr() as *const i8,
                                        c"freelistcorrupt".as_ptr() as *const i8,
                                        c"rowids".as_ptr() as *const i8,
                                        c"slowindexes".as_ptr() as *const i8,
                                        c"invalid".as_ptr() as *const i8, core::ptr::null()];
                            let mut i_op: i32 = 0;
                            let mut res: i32 = 0;
                            if unsafe {
                                        Tcl_GetIndexFromObj(interp,
                                            unsafe { *objv.offset(2 as isize) },
                                            &raw mut a_op[0 as usize] as *mut *const i8,
                                            c"option".as_ptr() as *mut i8 as *const i8, 0, &mut i_op)
                                    } != 0 {
                                return 1;
                            }
                            '__s2:
                                ...
                                match i_op {
                                    0 => {
                                        res =
                                            unsafe {
                                                sqlite3_recover_config(unsafe { (*p_test).p }, 789,
                                                    unsafe {
                                    ...
                                    1 => {
                                        {
                                            ...
                                            res =
                                                unsafe {
                                                    sqlite3_recover_config(unsafe { (*p_test).p }, 1,
                                                        if unsafe { *z_str.offset(0 as isize) } != 0 {
                                                                z_str
                                                            } else { core::ptr::null() } as *mut ())
                                                };
                                            break '__s2;
                                        }
                                        {
                                            ...
                                            if unsafe {
                                                        Tcl_GetBooleanFromObj(interp,
                                                            unsafe { *objv.offset(3 as isize) }, &mut i_val)
                                                    } != 0 {
                                                return 1;
                                            }
                                            res =
                                                unsafe {
                                                    sqlite3_recover_config(unsafe { (*p_test).p }, 2,
                                                        &raw mut i_val as *mut ())
                                                };
                                            break '__s2;
                                        }
                                        {
                                            let mut i_val_1: i32 = 0;
                                            if unsafe {
                                                        Tcl_GetBooleanFromObj(interp,
                                                            unsafe { *objv.offset(3 as isize) }, &mut i_val_1)
                                                    } != 0 {
                                                return 1;
                                            }
                                            res =
                                                unsafe {
                                                    sqlite3_recover_config(unsafe { (*p_test).p }, 3,
                                                        &raw mut i_val_1 as *mut ())
                                                };
                                            break '__s2;
                                        }
                                        {
                                            let mut i_val_2: i32 = 0;
                                            if unsafe {
                                                        Tcl_GetBooleanFromObj(interp,
                                                            unsafe { *objv.offset(3 as isize) }, &mut i_val_2)
                                                    } != 0 {
                                                return 1;
                                            }
                                            res =
                                                unsafe {
                                                    sqlite3_recover_config(unsafe { (*p_test).p }, 4,
                                                        &raw mut i_val_2 as *mut ())
                                                };
                                            break '__s2;
                                        }
                                        {
                                            res =
                                                unsafe {
                                                    sqlite3_recover_config(unsafe { (*p_test).p }, 12345,
                                                        core::ptr::null_mut())
                                                };
                                            break '__s2;
                                        }
                            ...
                            unsafe {
                                Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(res) })
                            };
                            break '__s1;
                        }
                        { let _ = 0; };
                        {
                            let mut res: i32 =
                                unsafe { sqlite3_recover_run(unsafe { (*p_test).p }) };
                            unsafe {
                                Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(res) })
                            };
                            break '__s1;
                        ...
                        {
                            let z_err: *const i8 =
                                unsafe { sqlite3_recover_errmsg(unsafe { (*p_test).p }) };
                            unsafe {
                                Tcl_SetObjResult(interp,
                                    unsafe { Tcl_NewStringObj(z_err, -1) })
                            };
                            break '__s1;
                        }
                        { let _ = 0; };
                        {
                            let err_code: i32 =
                                unsafe { sqlite3_recover_errcode(unsafe { (*p_test).p }) };
                            unsafe {
                                Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(err_code) })
                            };
                            break '__s1;
                        }
                        { let _ = 0; };
                        {
                            ...
                            let mut res2: i32 = 0;
                            if res != 0 {
                                let z_err_1: *const i8 =
                                    unsafe { sqlite3_recover_errmsg(unsafe { (*p_test).p }) };
                                unsafe {
                                    Tcl_SetObjResult(interp,
                                        unsafe { Tcl_NewStringObj(z_err_1, -1) })
                                };
                            }
                            res2 =
                                unsafe { sqlite3_recover_finish(unsafe { (*p_test).p }) };
                            { let _ = 0; };
                            if res != 0 { return 1; }
                            break '__s1;
                        }
                        ...
                        {
                            let mut res: i32 =
                                unsafe { sqlite3_recover_step(unsafe { (*p_test).p }) };
                            unsafe {
                                Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(res) })
                            };
                            break '__s1;
...
extern "C" fn test_sqlite3_dbdata_init(client_data_1: *mut (),
    ...
    if get_db_pointer(interp, unsafe { *objv.offset(1 as isize) }, &mut db) !=
            0 {
        return 1;
    }
    unsafe {
        sqlite3_dbdata_init(db, core::ptr::null_mut(), core::ptr::null())
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
struct RecoverSub_N10RecoverSub {
    z_sub: *const i8,
    n_arg: i32,
    z_msg: *const i8,
}
static mut a_sub: [RecoverSub_N10RecoverSub; 7] =
    [RecoverSub_N10RecoverSub {
                z_sub: c"config".as_ptr() as *const i8,
                n_arg: 2,
                z_msg: c"ARG".as_ptr() as *const i8,
            },
            RecoverSub_N10RecoverSub {
                z_sub: c"run".as_ptr() as *const i8,
                n_arg: 0,
                z_msg: c"".as_ptr() as *const i8,
            },
            RecoverSub_N10RecoverSub {
                z_sub: c"errmsg".as_ptr() as *const i8,
                n_arg: 0,
                z_msg: c"".as_ptr() as *const i8,
            },
            RecoverSub_N10RecoverSub {
                z_sub: c"errcode".as_ptr() as *const i8,
                n_arg: 0,
                z_msg: c"".as_ptr() as *const i8,
            },
            RecoverSub_N10RecoverSub {
                z_sub: c"finish".as_ptr() as *const i8,
                n_arg: 0,
                z_msg: c"".as_ptr() as *const i8,
            },
            RecoverSub_N10RecoverSub {
                z_sub: c"step".as_ptr() as *const i8,
                n_arg: 0,
                z_msg: c"".as_ptr() as *const i8,
            },
            RecoverSub_N10RecoverSub {
...
extern "C" {
    ...
    p_ctx_1: *mut ())
    -> *mut sqlite3_recover;
    fn sqlite3_recover_config(_: *mut sqlite3_recover, op: i32,
    p_arg_1: *mut ())
    -> i32;
    fn sqlite3_recover_step(_: *mut sqlite3_recover)
    -> i32;
    fn sqlite3_recover_run(_: *mut sqlite3_recover)
    -> i32;
    fn sqlite3_recover_errmsg(_: *mut sqlite3_recover)
    -> *const i8;
    fn sqlite3_recover_errcode(_: *mut sqlite3_recover)
    -> i32;
    fn sqlite3_recover_finish(_: *mut sqlite3_recover)
    -> i32;
    ...
    -> *mut Tcl_Obj;
    fn Tcl_GetCharLength(objPtr: *mut Tcl_Obj)
    -> i32;
