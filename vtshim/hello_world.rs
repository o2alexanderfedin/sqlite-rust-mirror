...
struct vtshim_aux {
    p_child_aux: *mut (),
    x_child_destroy: Option<unsafe extern "C" fn(*mut ()) -> ()>,
    p_mod: *mut sqlite3_module,
    db: *mut sqlite3,
    z_name: *mut i8,
    b_disposed: i32,
    p_all_vtab: *mut vtshim_vtab,
    s_self: sqlite3_module,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct vtshim_vtab {
    base: sqlite3_vtab,
    p_child: *mut sqlite3_vtab,
    p_aux: *mut vtshim_aux,
    p_all_cur: *mut vtshim_cursor,
    pp_prev: *mut *mut vtshim_vtab,
    p_next: *mut vtshim_vtab,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct vtshim_cursor {
    base: sqlite3_vtab_cursor,
    p_child: *mut sqlite3_vtab_cursor,
    pp_prev: *mut *mut vtshim_cursor,
    p_next: *mut vtshim_cursor,
}
extern "C" fn vtshim_create(db: *mut sqlite3, pp_aux_1: *mut (), argc: i32,
    argv: *const *const i8, pp_vtab_1: *mut *mut sqlite3_vtab,
    pz_err_1: *mut *mut i8) -> i32 {
    let p_aux: *mut vtshim_aux = pp_aux_1 as *mut vtshim_aux;
    let mut p_new: *mut vtshim_vtab = core::ptr::null_mut();
    let mut rc: i32 = 0;
    if !(db == unsafe { (*p_aux).db }) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"vtshimCreate".as_ptr() as *const i8,
                c"vtshim.c".as_ptr() as *mut i8 as *const i8, 81,
                c"db==pAux->db".as_ptr() as *mut i8 as *const i8)
        }
    } else { { let _ = 0; } };
    if unsafe { (*p_aux).b_disposed } != 0 {
        if !(pz_err_1).is_null() {
            unsafe {
                *pz_err_1 =
                    unsafe {
                        sqlite3_mprintf(c"virtual table was disposed: \"%s\"".as_ptr()
                                    as *mut i8 as *const i8, unsafe { (*p_aux).z_name })
                    }
            };
        }
        return 1;
    ...
    p_new =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<vtshim_vtab>() as
                        sqlite3_uint64)
            } as *mut vtshim_vtab;
    ...
    unsafe {
        memset(p_new as *mut (), 0,
            core::mem::size_of::<vtshim_vtab>() as u64)
    };
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_create.unwrap()
                })(db, unsafe { (*p_aux).p_child_aux }, argc, argv,
                unsafe { &mut (*p_new).p_child }, pz_err_1)
        };
    if rc != 0 {
    ...
    unsafe { (*p_new).p_aux = p_aux };
    unsafe { (*p_new).pp_prev = unsafe { &mut (*p_aux).p_all_vtab } };
    unsafe { (*p_new).p_next = unsafe { (*p_aux).p_all_vtab } };
    if !(unsafe { (*p_aux).p_all_vtab }).is_null() {
        unsafe {
            (*unsafe { (*p_aux).p_all_vtab }).pp_prev =
                unsafe { &mut (*p_new).p_next }
        };
    }
...
extern "C" fn vtshim_connect(db: *mut sqlite3, pp_aux_1: *mut (), argc: i32,
    ...
    if !(db == unsafe { (*p_aux).db }) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"vtshimConnect".as_ptr() as *const i8,
                c"vtshim.c".as_ptr() as *mut i8 as *const i8, 120,
                c"db==pAux->db".as_ptr() as *mut i8 as *const i8)
        }
    } else { { let _ = 0; } };
    if unsafe { (*p_aux).b_disposed } != 0 {
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_connect.unwrap()
                })(db, unsafe { (*p_aux).p_child_aux }, argc, argv,
                unsafe { &mut (*p_new).p_child }, pz_err_1)
        };
    if rc != 0 {
...
extern "C" fn vtshim_best_index(p_base_1: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    if unsafe { (*p_aux).b_disposed } != 0 { return 1; }
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_best_index.unwrap()
                })(unsafe { (*p_vtab).p_child }, p_idx_info_1)
        };
    if rc != 0 {
        '__b0: loop {
            '__c0: loop {
                    ...
                    (*p_vtab).base.z_err_msg =
                        unsafe {
                            sqlite3_mprintf(c"%s".as_ptr() as *mut i8 as *const i8,
                                unsafe { (*unsafe { (*p_vtab).p_child }).z_err_msg })
                        }
                };
                break '__c0;
            }
...
extern "C" fn vtshim_disconnect(p_base_1: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    if (unsafe { (*p_aux).b_disposed } == 0) as i32 != 0 {
        rc =
            unsafe {
                (unsafe {
                        (*unsafe { (*p_aux).p_mod }).x_disconnect.unwrap()
                    })(unsafe { (*p_vtab).p_child })
            };
    }
    if !(unsafe { (*p_vtab).p_next }).is_null() {
        unsafe {
            (*unsafe { (*p_vtab).p_next }).pp_prev =
                unsafe { (*p_vtab).pp_prev }
        };
    }
    unsafe { *unsafe { (*p_vtab).pp_prev } = unsafe { (*p_vtab).p_next } };
    unsafe { sqlite3_free(p_vtab as *mut ()) };
    return rc;
}
extern "C" fn vtshim_destroy(p_base_1: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    if (unsafe { (*p_aux).b_disposed } == 0) as i32 != 0 {
        rc =
            unsafe {
                (unsafe {
                        (*unsafe { (*p_aux).p_mod }).x_destroy.unwrap()
                    })(unsafe { (*p_vtab).p_child })
            };
    }
    if !(unsafe { (*p_vtab).p_next }).is_null() {
...
extern "C" fn vtshim_open(p_base_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut p_cur: *mut vtshim_cursor = core::ptr::null_mut();
    let mut rc: i32 = 0;
    unsafe { *pp_cursor_1 = core::ptr::null_mut() };
    if unsafe { (*p_aux).b_disposed } != 0 { return 1; }
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<vtshim_cursor>() as
                        sqlite3_uint64)
            } as *mut vtshim_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<vtshim_cursor>() as u64)
    };
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_open.unwrap()
                })(unsafe { (*p_vtab).p_child },
                unsafe { &mut (*p_cur).p_child })
        };
    if rc != 0 {
    ...
    unsafe {
        (*unsafe { (*p_cur).p_child }).p_vtab = unsafe { (*p_vtab).p_child }
    };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    unsafe { (*p_cur).pp_prev = unsafe { &mut (*p_vtab).p_all_cur } };
    if !(unsafe { (*p_vtab).p_all_cur }).is_null() {
        unsafe {
            (*unsafe { (*p_vtab).p_all_cur }).pp_prev =
                unsafe { &mut (*p_cur).p_next }
        };
    }
    unsafe { (*p_cur).p_next = unsafe { (*p_vtab).p_all_cur } };
    unsafe { (*p_vtab).p_all_cur = p_cur };
    return 0;
}
extern "C" fn vtshim_close(p_x_1: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut vtshim_cursor = p_x_1 as *mut vtshim_cursor;
    let p_vtab: *mut vtshim_vtab =
        unsafe { (*p_cur).base.p_vtab } as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    if (unsafe { (*p_aux).b_disposed } == 0) as i32 != 0 {
        rc =
            unsafe {
                (unsafe {
                        (*unsafe { (*p_aux).p_mod }).x_close.unwrap()
                    })(unsafe { (*p_cur).p_child })
            };
        if rc != 0 {
            '__b2: loop {
                '__c2: loop {
    ...
    if !(unsafe { (*p_cur).p_next }).is_null() {
        unsafe {
            (*unsafe { (*p_cur).p_next }).pp_prev =
                unsafe { (*p_cur).pp_prev }
        };
    }
    unsafe { *unsafe { (*p_cur).pp_prev } = unsafe { (*p_cur).p_next } };
    unsafe { sqlite3_free(p_cur as *mut ()) };
    return rc;
}
extern "C" fn vtshim_filter(p_x_1: *mut sqlite3_vtab_cursor, idx_num_1: i32,
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_filter.unwrap()
                })(unsafe { (*p_cur).p_child }, idx_num_1, idx_str_1, argc,
                argv)
        };
    if rc != 0 {
        '__b3: loop {
...
extern "C" fn vtshim_next(p_x_1: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut vtshim_cursor = p_x_1 as *mut vtshim_cursor;
    let p_vtab: *mut vtshim_vtab =
        unsafe { (*p_cur).base.p_vtab } as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_next.unwrap()
                })(unsafe { (*p_cur).p_child })
        };
    if rc != 0 {
        '__b4: loop {
...
extern "C" fn vtshim_eof(p_x_1: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut vtshim_cursor = p_x_1 as *mut vtshim_cursor;
    let p_vtab: *mut vtshim_vtab =
        unsafe { (*p_cur).base.p_vtab } as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_eof.unwrap()
                })(unsafe { (*p_cur).p_child })
        };
    '__b5: loop {
        '__c5: loop {
...
extern "C" fn vtshim_column(p_x_1: *mut sqlite3_vtab_cursor,
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_column.unwrap()
                })(unsafe { (*p_cur).p_child }, ctx, i)
        };
    if rc != 0 {
        '__b6: loop {
            '__c6: loop {
...
extern "C" fn vtshim_rowid(p_x_1: *mut sqlite3_vtab_cursor,
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_rowid.unwrap()
                })(unsafe { (*p_cur).p_child }, p_rowid_1)
        };
    if rc != 0 {
        '__b7: loop {
            '__c7: loop {
...
extern "C" fn vtshim_update(p_base_1: *mut sqlite3_vtab, argc: i32,
    argv: *mut *mut sqlite3_value, p_rowid_1: *mut sqlite3_int64) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_update.unwrap()
                })(unsafe { (*p_vtab).p_child }, argc, argv, p_rowid_1)
        };
    if rc != 0 {
        '__b8: loop {
            '__c8: loop {
...
extern "C" fn vtshim_begin(p_base_1: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_begin.unwrap()
                })(unsafe { (*p_vtab).p_child })
        };
    if rc != 0 {
        '__b9: loop {
...
extern "C" fn vtshim_sync(p_base_1: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_sync.unwrap()
                })(unsafe { (*p_vtab).p_child })
        };
    if rc != 0 {
        '__b10: loop {
...
extern "C" fn vtshim_commit(p_base_1: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_commit.unwrap()
                })(unsafe { (*p_vtab).p_child })
        };
    if rc != 0 {
        '__b11: loop {
...
extern "C" fn vtshim_rollback(p_base_1: *mut sqlite3_vtab) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_rollback.unwrap()
                })(unsafe { (*p_vtab).p_child })
        };
    if rc != 0 {
        '__b12: loop {
...
extern "C" fn vtshim_find_function(p_base_1: *mut sqlite3_vtab, n_arg_1: i32,
    z_name_1: *const i8,
    px_func_1:
        *mut unsafe extern "C" fn(*mut sqlite3_context, i32,
    ...
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    if unsafe { (*p_aux).b_disposed } != 0 { return 0; }
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_find_function.unwrap()
                })(unsafe { (*p_vtab).p_child }, n_arg_1, z_name_1, px_func_1,
                pp_arg_1)
        };
    '__b13: loop {
        '__c13: loop {
...
extern "C" fn vtshim_rename(p_base_1: *mut sqlite3_vtab,
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_rename.unwrap()
                })(unsafe { (*p_vtab).p_child }, z_new_name_1)
        };
    if rc != 0 {
        '__b14: loop {
            '__c14: loop {
...
extern "C" fn vtshim_savepoint(p_base_1: *mut sqlite3_vtab, n: i32) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_savepoint.unwrap()
                })(unsafe { (*p_vtab).p_child }, n)
        };
    if rc != 0 {
        '__b15: loop {
            '__c15: loop {
...
extern "C" fn vtshim_release(p_base_1: *mut sqlite3_vtab, n: i32) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_release.unwrap()
                })(unsafe { (*p_vtab).p_child }, n)
        };
    if rc != 0 {
        '__b16: loop {
...
extern "C" fn vtshim_rollback_to(p_base_1: *mut sqlite3_vtab, n: i32) -> i32 {
    let p_vtab: *mut vtshim_vtab = p_base_1 as *mut vtshim_vtab;
    let p_aux: *const vtshim_aux =
        unsafe { (*p_vtab).p_aux } as *const vtshim_aux;
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            (unsafe {
                    (*unsafe { (*p_aux).p_mod }).x_rollback_to.unwrap()
                })(unsafe { (*p_vtab).p_child }, n)
        };
    if rc != 0 {
        '__b17: loop {
...
extern "C" fn vtshim_aux_destructor(p_x_aux_1: *mut ()) -> () {
    let p_aux: *mut vtshim_aux = p_x_aux_1 as *mut vtshim_aux;
    if !(unsafe { (*p_aux).p_all_vtab } == core::ptr::null_mut()) as i32 as
                i64 != 0 {
        unsafe {
            __assert_rtn(c"vtshimAuxDestructor".as_ptr() as *const i8,
                c"vtshim.c".as_ptr() as *mut i8 as *const i8, 431,
                c"pAux->pAllVtab==0".as_ptr() as *mut i8 as *const i8)
        }
    } else { { let _ = 0; } };
    if (unsafe { (*p_aux).b_disposed } == 0) as i32 != 0 &&
            unsafe { (*p_aux).x_child_destroy.is_some() } {
        unsafe {
            (unsafe {
                    (*p_aux).x_child_destroy.unwrap()
                })(unsafe { (*p_aux).p_child_aux })
        };
        unsafe { (*p_aux).x_child_destroy = None };
    }
    unsafe { sqlite3_free(unsafe { (*p_aux).z_name } as *mut ()) };
    unsafe { sqlite3_free(unsafe { (*p_aux).p_mod } as *mut ()) };
    unsafe { sqlite3_free(p_aux as *mut ()) };
}
extern "C" fn vtshim_copy_module(p_mod_1: *const sqlite3_module,
    pp_mod_1: *mut *mut sqlite3_module) -> i32 {
    let mut p: *mut sqlite3_module = core::ptr::null_mut();
    if (p_mod_1).is_null() as i32 != 0 || (pp_mod_1).is_null() as i32 != 0 {
        return 1;
    }
    p =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<sqlite3_module>() as
                        sqlite3_uint64)
            } as *mut sqlite3_module;
    if p == core::ptr::null_mut() { return 7; }
    unsafe {
        memcpy(p as *mut (), p_mod_1 as *const (),
            core::mem::size_of::<sqlite3_module>() as u64)
    };
    unsafe { *pp_mod_1 = p };
    return 0;
}
...
pub extern "C" fn sqlite3_create_disposable_module(db: *mut sqlite3,
    z_name_1: *const i8, p: *const sqlite3_module, p_client_data_1: *mut (),
    x_destroy_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> *mut () {
    let mut p_aux: *mut vtshim_aux = core::ptr::null_mut();
    let mut p_mod: *mut sqlite3_module = core::ptr::null_mut();
    let mut rc: i32 = 0;
    p_aux =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<vtshim_aux>() as
                        sqlite3_uint64)
            } as *mut vtshim_aux;
    if p_aux == core::ptr::null_mut() {
        if x_destroy_1.is_some() {
            unsafe { x_destroy_1.unwrap()(p_client_data_1) };
        }
        return core::ptr::null_mut();
    }
    rc = vtshim_copy_module(p, &mut p_mod);
    if rc != 0 {
        unsafe { sqlite3_free(p_aux as *mut ()) };
        return core::ptr::null_mut();
    }
    unsafe { (*p_aux).p_child_aux = p_client_data_1 };
    unsafe { (*p_aux).x_child_destroy = x_destroy_1 };
    unsafe { (*p_aux).p_mod = p_mod };
    unsafe { (*p_aux).db = db };
    unsafe {
        (*p_aux).z_name =
            unsafe {
    ...
    unsafe { (*p_aux).b_disposed = 0 };
    unsafe { (*p_aux).p_all_vtab = core::ptr::null_mut() };
    unsafe {
        (*p_aux).s_self.i_version =
            if unsafe { (*p).i_version } as i32 <= 2 {
                unsafe { (*p).i_version }
            } else { 2 }
    };
    unsafe {
        (*p_aux).s_self.x_create =
            if unsafe { (*p).x_create.is_some() } {
                Some(vtshim_create)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_connect =
            if unsafe { (*p).x_connect.is_some() } {
                Some(vtshim_connect)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_best_index =
            if unsafe { (*p).x_best_index.is_some() } {
                Some(vtshim_best_index)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_disconnect =
            if unsafe { (*p).x_disconnect.is_some() } {
                Some(vtshim_disconnect)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_destroy =
            if unsafe { (*p).x_destroy.is_some() } {
                Some(vtshim_destroy)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_open =
            if unsafe { (*p).x_open.is_some() } {
                Some(vtshim_open)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_close =
            if unsafe { (*p).x_close.is_some() } {
                Some(vtshim_close)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_filter =
            if unsafe { (*p).x_filter.is_some() } {
                Some(vtshim_filter)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_next =
            if unsafe { (*p).x_next.is_some() } {
                Some(vtshim_next)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_eof =
            if unsafe { (*p).x_eof.is_some() } {
                Some(vtshim_eof)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_column =
            if unsafe { (*p).x_column.is_some() } {
                Some(vtshim_column)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_rowid =
            if unsafe { (*p).x_rowid.is_some() } {
                Some(vtshim_rowid)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_update =
            if unsafe { (*p).x_update.is_some() } {
                Some(vtshim_update)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_begin =
            if unsafe { (*p).x_begin.is_some() } {
                Some(vtshim_begin)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_sync =
            if unsafe { (*p).x_sync.is_some() } {
                Some(vtshim_sync)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_commit =
            if unsafe { (*p).x_commit.is_some() } {
                Some(vtshim_commit)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_rollback =
            if unsafe { (*p).x_rollback.is_some() } {
                Some(vtshim_rollback)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_find_function =
            if unsafe { (*p).x_find_function.is_some() } {
                Some(vtshim_find_function)
            } else { None }
    };
    unsafe {
        (*p_aux).s_self.x_rename =
            if unsafe { (*p).x_rename.is_some() } {
                Some(vtshim_rename)
            } else { None }
    };
    if unsafe { (*p).i_version } as i32 >= 2 {
        unsafe {
            (*p_aux).s_self.x_savepoint =
                if unsafe { (*p).x_savepoint.is_some() } {
                    Some(vtshim_savepoint)
                } else { None }
        };
        unsafe {
            (*p_aux).s_self.x_release =
                if unsafe { (*p).x_release.is_some() } {
                    Some(vtshim_release)
                } else { None }
        };
        unsafe {
            (*p_aux).s_self.x_rollback_to =
                if unsafe { (*p).x_rollback_to.is_some() } {
                    Some(vtshim_rollback_to)
                } else { None }
        };
    } else {
        unsafe { (*p_aux).s_self.x_savepoint = None };
        unsafe { (*p_aux).s_self.x_release = None };
        unsafe { (*p_aux).s_self.x_rollback_to = None };
    }
    rc =
        unsafe {
            sqlite3_create_module_v2(db, z_name_1,
                unsafe { &raw mut (*p_aux).s_self } as *const sqlite3_module,
                p_aux as *mut (), Some(vtshim_aux_destructor))
        };
    return if rc == 0 { p_aux as *mut () } else { core::ptr::null_mut() };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_dispose_module(p_x_1: *mut ()) -> () {
    let p_aux: *mut vtshim_aux = p_x_1 as *mut vtshim_aux;
    if (unsafe { (*p_aux).b_disposed } == 0) as i32 != 0 {
        let mut p_vtab: *const vtshim_vtab = core::ptr::null();
        let mut p_cur: *const vtshim_cursor = core::ptr::null();
        {
            p_vtab = unsafe { (*p_aux).p_all_vtab };
            '__b18: loop {
                if !(!(p_vtab).is_null()) { break '__b18; }
                '__c18: loop {
                    {
                        p_cur = unsafe { (*p_vtab).p_all_cur };
                        '__b19: loop {
                            if !(!(p_cur).is_null()) { break '__b19; }
                            '__c19: loop {
                                unsafe {
                                    (unsafe {
                                            (*unsafe { (*p_aux).p_mod }).x_close.unwrap()
        ...
        unsafe { (*p_aux).b_disposed = 1 };
        if unsafe { (*p_aux).x_child_destroy.is_some() } {
            unsafe {
                (unsafe {
                        (*p_aux).x_child_destroy.unwrap()
                    })(unsafe { (*p_aux).p_child_aux })
