...
pub extern "C" fn sqlite3_quote_value(p_str_1: *mut StrAccum,
    p_value_1: *mut sqlite3_value, b_escape_1: i32) -> () {
    { let _ = 0; };
    '__s7:
        {
        match unsafe { sqlite3_value_type(p_value_1) } {
            2 => {
                {
                    unsafe {
                        sqlite3_str_appendf(p_str_1 as *mut sqlite3_str,
                ...
                }
                {
                    { let _ = 0; };
                    unsafe {
                        sqlite3_str_append(p_str_1 as *mut sqlite3_str,
...
extern "C" fn version_func(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
...
extern "C" fn load_ext(context: *mut sqlite3_context, argc: i32,
...
extern "C" fn compileoptionused_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn compileoptionget_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut n: i32 = 0;
    { let _ = 0; };
    { let _ = argc; };
...
extern "C" fn context_malloc(context: *mut sqlite3_context, n_byte_1: i64)
    -> *mut () {
...
extern "C" fn trim_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
...
extern "C" fn sqlite3_get_func_coll_seq(context: &sqlite3_context)
    -> *mut CollSeq {
    unsafe {
...
extern "C" fn minmax_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut i: i32 = 0;
    let mut mask: i32 = 0;
...
extern "C" fn sqlite3_skip_accumulator_load(context: &mut sqlite3_context)
    -> () {
    { let _ = 0; };
    (*context).is_error = -1;
    (*context).skip_flag = 1 as u8;
}
extern "C" fn minmax_step(context: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    if unsafe { sqlite3_value_type(p_arg as *mut sqlite3_value) } == 5 {
...
extern "C" fn min_max_value_finalize(context: *mut sqlite3_context,
    b_value_1: i32) -> () {
    let mut p_res: *mut sqlite3_value = core::ptr::null_mut();
    p_res =
...
extern "C" fn min_max_finalize(context: *mut sqlite3_context) -> () {
    min_max_value_finalize(context, 0);
}
extern "C" fn min_max_value(context: *mut sqlite3_context) -> () {
    min_max_value_finalize(context, 1);
}
extern "C" fn typeof_func(context: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let i: i32 =
...
extern "C" fn subtype_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = argc; };
    unsafe {
        sqlite3_result_int(context,
...
extern "C" fn length_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = 0; };
    { let _ = argc; };
    '__s18:
...
extern "C" fn bytelength_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = 0; };
    { let _ = argc; };
    '__s21:
...
extern "C" fn instr_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    let mut p_c1: *mut sqlite3_value = core::ptr::null_mut();
    let mut p_c2: *mut sqlite3_value = core::ptr::null_mut();
...
extern "C" fn printf_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    if argc >= 1 &&
        ...
        unsafe {
            sqlite3_str_appendf(&raw mut str as *mut sqlite3_str, z_format,
                &raw mut x as *mut PrintfArguments)
        };
        unsafe {
            sqlite3_result_str(context, &raw mut str as *mut sqlite3_str, 1)
        };
    }
}
extern "C" fn unicode_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut z: *const u8 =
...
extern "C" fn char_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    z_out =
        {
            z =
                unsafe { sqlite3_malloc64((argc * 4 + 1) as sqlite3_uint64) }
                    as *mut u8;
            z
        };
        ...
        '__b24: loop {
            ...
            '__c24: loop {
                ...
                if x < 0 as i64 || x > 1114111 as i64 {
                    x = 65533 as sqlite3_int64;
                }
                c = (x & 2097151 as sqlite3_int64) as u32;
                if c < 128 as u32 {
                    unsafe {
                        *{
                                    let __p = &mut z_out;
    ...
    unsafe {
        sqlite3_result_text64(context, z as *mut i8 as *const i8,
            unsafe { z_out.offset_from(z) } as i64 as sqlite3_uint64,
            Some(sqlite3_free), 16 as u8)
    };
}
extern "C" fn abs_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = 0; };
    { let _ = argc; };
    '__s25:
...
extern "C" fn round_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    if r < -4503599627370496.0 || r > 4503599627370496.0
        {} else if n == 0 as i64 {
        r =
            (r + if r < 0 as f64 { -0.5 } else { 0.5 }) as sqlite_int64 as
                f64;
    } else {
        z_buf =
            unsafe {
...
extern "C" fn upper_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
...
extern "C" fn lower_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut z1: *mut i8 = core::ptr::null_mut();
        let mut z2: *const i8 = core::ptr::null();
...
extern "C" fn hex_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut i: i32 = 0;
    let mut n: i32 = 0;
...
extern "C" fn unhex_func(p_ctx_1: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
...
extern "C" fn concat_func_core(context: *mut sqlite3_context, argc: i32,
    argv: *const *mut sqlite3_value, n_sep_1: i32, z_sep_1: *const i8) -> () {
    ...
    z =
        unsafe { sqlite3_malloc64((n + 1 as i64) as sqlite3_uint64) } as
            *mut i8;
    if z == core::ptr::null_mut() {
        unsafe { sqlite3_result_error_nomem(context) };
        return;
    ...
    { let _ = 0; };
    unsafe {
        sqlite3_result_text64(context, z as *const i8, j as sqlite3_uint64,
            Some(sqlite3_free), 16 as u8)
    };
}
extern "C" fn concat_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    concat_func_core(context, argc, argv as *const *mut sqlite3_value, 0,
        c"".as_ptr() as *mut i8 as *const i8);
}
extern "C" fn concatws_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let n_sep: i32 =
    ...
    concat_func_core(context, argc - 1,
        unsafe { argv.offset(1 as isize) } as *const *mut sqlite3_value,
        n_sep, z_sep);
}
extern "C" fn random_func(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    let mut r: sqlite_int64 = 0 as sqlite_int64;
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    unsafe {
        sqlite3_randomness(core::mem::size_of::<sqlite_int64>() as i32,
            &raw mut r as *mut ())
    };
    if r < 0 as i64 {
...
extern "C" fn random_blob(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    if n < 1 as i64 { n = 1 as sqlite3_int64; }
...
extern "C" fn nullif_func(context: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let p_coll: *const CollSeq =
        sqlite3_get_func_coll_seq(unsafe { &*context }) as *const CollSeq;
    { let _ = not_used_1; };
...
extern "C" fn sourceid_func(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    unsafe {
...
extern "C" fn errlog_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = argc; };
    { let _ = context; };
    unsafe {
...
extern "C" fn unistr_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        ...
        loop {
            ...
            '__s36:
                ...
                match __state {
                    ...
                    13 => {
                        z_out =
                            unsafe { sqlite3_malloc64((n_in + 1) as sqlite3_uint64) } as
                                *mut i8;
                        __state = 14;
                    }
                    14 => {
                    ...
                    55 => {
                        unsafe {
                            sqlite3_result_text64(context, z_out as *const i8,
                                j as sqlite3_uint64, Some(sqlite3_free), 16 as u8)
                        };
                        __state = 56;
                    }
                    56 => { return; }
...
extern "C" fn quote_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut str: sqlite3_str = unsafe { core::mem::zeroed() };
    let db: *mut sqlite3 = unsafe { sqlite3_context_db_handle(context) };
    { let _ = 0; };
    { let _ = argc; };
    unsafe {
...
extern "C" fn last_insert_rowid(context: *mut sqlite3_context,
    not_used_1: i32, not_used2_1: *mut *mut sqlite3_value) -> () {
    let db: *mut sqlite3 = unsafe { sqlite3_context_db_handle(context) };
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    unsafe {
        sqlite3_result_int64(context,
...
extern "C" fn changes(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    let db: *mut sqlite3 = unsafe { sqlite3_context_db_handle(context) };
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    unsafe {
...
extern "C" fn total_changes(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    let db: *mut sqlite3 = unsafe { sqlite3_context_db_handle(context) };
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    unsafe {
...
extern "C" fn replace_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn zeroblob_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut n: i64 = 0 as i64;
    let mut rc: i32 = 0;
    { let _ = 0; };
    ...
    n = unsafe { sqlite3_value_int64(unsafe { *argv.offset(0 as isize) }) };
    if n < 0 as i64 { n = 0 as i64; }
    rc = unsafe { sqlite3_result_zeroblob64(context, n as sqlite3_uint64) };
    if rc != 0 { unsafe { sqlite3_result_error_code(context, rc) }; }
}
extern "C" fn substr_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut z: *const u8 = core::ptr::null();
    ...
    if p0type != 4 {
        ...
        unsafe {
            sqlite3_result_text64(context, z as *mut i8 as *const i8,
                unsafe { z2.offset_from(z) } as i64 as sqlite3_uint64,
                Some(unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn(*mut ())
                                    -> ()>(-1 as isize as *const ())
...
extern "C" fn sum_step(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn sum_finalize(context: *mut sqlite3_context) -> () {
...
extern "C" fn sum_inverse(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut p: *mut SumCtx = core::ptr::null_mut();
    let mut type_: i32 = 0;
    { let _ = 0; };
...
extern "C" fn total_finalize(context: *mut sqlite3_context) -> () {
    let mut p: *const SumCtx = core::ptr::null();
    let mut r: f64 = 0.0;
    p = unsafe { sqlite3_aggregate_context(context, 0) } as *mut SumCtx;
    if !(p).is_null() {
...
extern "C" fn avg_finalize(context: *mut sqlite3_context) -> () {
    let mut p: *const SumCtx = core::ptr::null();
    p = unsafe { sqlite3_aggregate_context(context, 0) } as *mut SumCtx;
    if !(p).is_null() && unsafe { (*p).cnt } > 0 as i64 {
        let mut r: f64 = 0.0;
...
extern "C" fn count_step(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
...
extern "C" fn count_finalize(context: *mut sqlite3_context) -> () {
    unsafe {
...
extern "C" fn count_inverse(ctx: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut p: *mut CountCtx = core::ptr::null_mut();
        p =
...
extern "C" fn group_concat_step(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    ...
    if !(p_gcc).is_null() {
            ...
            if (first_term == 0) as i32 != 0 {
                unsafe {
                    sqlite3_str_appendchar(unsafe { &raw mut (*p_gcc).str } as
                            *mut sqlite3_str, 1, ',' as i32 as i8)
                };
        ...
        if !(z_val).is_null() {
            unsafe {
                sqlite3_str_append(unsafe { &raw mut (*p_gcc).str } as
                        *mut sqlite3_str, z_val, n_val)
            };
        }
    }
}
extern "C" fn group_concat_finalize(context: *mut sqlite3_context) -> () {
    ...
    if !(p_gcc).is_null() {
        unsafe {
            sqlite3_result_str(context,
                unsafe { &raw mut (*p_gcc).str } as *mut sqlite3_str, 1)
        };
        unsafe {
...
extern "C" fn group_concat_value(context: *mut sqlite3_context) -> () {
    let p_gcc: *mut GroupConcatCtx =
        unsafe { sqlite3_aggregate_context(context, 0) } as
            *mut GroupConcatCtx;
    if !(p_gcc).is_null() && unsafe { (*p_gcc).n_accum } > 0 {
        unsafe {
            sqlite3_result_str(context,
                unsafe { &raw mut (*p_gcc).str } as *mut sqlite3_str, 0)
        };
    }
}
extern "C" fn group_concat_inverse(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut p_gcc: *mut GroupConcatCtx = core::ptr::null_mut();
    { let _ = 0; };
    { let _ = argc; };
...
unsafe extern "C" fn percent_error(p_ctx_1: *mut sqlite3_context,
        ...
        if !(z_msg1).is_null() {
            unsafe {
                sqlite3_mprintf(z_msg1 as *const i8,
                    unsafe {
                        sqlite3_vdbe_func_name(p_ctx_1 as *const sqlite3_context)
                    })
            }
...
extern "C" fn percent_is_infinity(mut r: f64) -> i32 {
    ...
    unsafe {
        memcpy(&raw mut u as *mut (), &raw mut r as *const (),
            core::mem::size_of::<sqlite3_uint64>() as u64)
    };
    return (u >> 52 & 2047 as sqlite3_uint64 == 2047 as u64) as i32;
}
...
extern "C" fn percent_step(p_ctx_1: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn percent_compute(p_ctx_1: *mut sqlite3_context,
    b_is_final_1: i32) -> () {
    let mut p: *mut Percentile = core::ptr::null_mut();
    let settings: i32 =
...
extern "C" fn percent_final(p_ctx_1: *mut sqlite3_context) -> () {
    percent_compute(p_ctx_1, 1);
}
extern "C" fn percent_value(p_ctx_1: *mut sqlite3_context) -> () {
    percent_compute(p_ctx_1, 0);
}
extern "C" fn percent_inverse(p_ctx_1: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut p: *mut Percentile = core::ptr::null_mut();
    let mut e_type: i32 = 0;
    let mut y: f64 = 0.0;
...
extern "C" fn like_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn ceiling_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = 0; };
    '__s49:
        {
...
extern "C" fn log_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut x: f64 = 0.0;
    let mut b: f64 = 0.0;
    let mut ans: f64 = 0.0;
...
extern "C" fn math1_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut type0: i32 = 0;
    let mut v0: f64 = 0.0;
    let mut ans: f64 = 0.0;
...
extern "C" fn math2_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut type0: i32 = 0;
    let mut type1: i32 = 0;
    let mut v0: f64 = 0.0;
...
extern "C" fn pi_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = 0; };
    { let _ = argv; };
    unsafe { sqlite3_result_double(context, 3.141592653589793) };
}
extern "C" fn sign_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut type0: i32 = 0;
    let mut x: f64 = 0.0;
    { let _ = argc; };
            ...
            let p_escape: *const Expr =
                unsafe {
                        (*(unsafe { (*(*p_expr_1).x.p_list).a.as_ptr() } as
                                        *mut ExprList_item).offset(2 as isize)).p_expr
                    } as *const Expr;
