...
static mut mem0: Mem0Global =
    Mem0Global {
        ...
        alarm_threshold: 0 as Sqlite3Int64,
...
extern "C" fn malloc_with_alarm(n: i32, pp: &mut *mut ()) -> () {
    unsafe {
        ...
        if mem0.alarm_threshold > 0 as i64 {
            ...
            if n_used >= mem0.alarm_threshold - n_full as Sqlite3Int64 {
                unsafe {
                ...
                if mem0.hard_limit != 0 {
                    ...
                    if n_used >= mem0.hard_limit - n_full as Sqlite3Int64 {
...
pub extern "C" fn sqlite3_soft_heap_limit64(mut n: Sqlite3Int64)
    -> Sqlite3Int64 {
    unsafe {
        let mut prior_limit: Sqlite3Int64 = 0 as Sqlite3Int64;
        let mut excess: Sqlite3Int64 = 0 as Sqlite3Int64;
        let mut n_used: Sqlite3Int64 = 0 as Sqlite3Int64;
        ...
        if excess > 0 as i64 {
            sqlite3_release_memory((excess & 2147483647 as Sqlite3Int64) as
                    i32);
        }
        return prior_limit;
    }
