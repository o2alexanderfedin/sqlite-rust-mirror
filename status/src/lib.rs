...
pub extern "C" fn sqlite3_status(op: i32, p_current: &mut i32,
    ...
    let mut i_cur: Sqlite3Int64 = 0 as Sqlite3Int64;
    let mut i_hwtr: Sqlite3Int64 = 0 as Sqlite3Int64;
    let mut rc: i32 = 0;
            ...
            '__s1:
                ...
                match op {
                    0 => {
                        ...
                        {
                            let mut total_used: Sqlite3Int64 = 0 as Sqlite3Int64;
                            let mut i: i32 = 0;
                                ...
                                '__b4: loop {
                                    ...
                                    '__c4: loop {
                                        ...
                                        if !(p_bt).is_null() {
                                            ...
                                            total_used += n_byte as Sqlite3Int64;
                                        }
                                        break '__c4;
                                    }
                        ...
                        }
                        {
                            ...
                            unsafe { sqlite3_btree_leave_all(db) };
                            *p_highwtr_1 = 0 as Sqlite3Int64;
                            *p_current_1 = n_byte_1 as Sqlite3Int64;
                            break '__s1;
                        }
                        {
                        ...
                        }
                        {
                            ...
                            *p_highwtr_1 = 0 as Sqlite3Int64;
                            *p_current_1 = n_ret_1 as Sqlite3Int64;
                            break '__s1;
                        }
                        {
                            *p_highwtr_1 = 0 as Sqlite3Int64;
...
pub extern "C" fn sqlite3_db_status(db: *mut Sqlite3, op: i32,
    ...
    let mut c: Sqlite3Int64 = 0 as Sqlite3Int64;
    let mut h: Sqlite3Int64 = 0 as Sqlite3Int64;
    let mut rc: i32 = 0;
    rc = sqlite3_db_status64(db, op, &mut c, &mut h, reset_flag_1);
    if rc == 0 {
        *p_current_1 = (c & 2147483647 as Sqlite3Int64) as i32;
        *p_highwtr_1 = (h & 2147483647 as Sqlite3Int64) as i32;
    }
    return rc;
}
#[unsafe(no_mangle)]
