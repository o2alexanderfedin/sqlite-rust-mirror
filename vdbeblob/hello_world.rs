...
extern "C" fn blob_seek_to_row(p: &mut Incrblob, i_row_1: sqlite3_int64,
    ...
    unsafe {
        ...
        if unsafe { (*v).pc } > 4 {
            unsafe { (*v).pc = 4 };
            { let _ = 0; };
            rc = unsafe { sqlite3_vdbe_exec(v) };
        } else { rc = unsafe { sqlite3_step((*p).p_stmt) }; }
        if rc == 100 {
            let p_c: *const VdbeCursor =
                unsafe { *unsafe { (*v).ap_csr.offset(0 as isize) } } as
                    *const VdbeCursor;
            let mut type_: u32 = 0 as u32;
            { let _ = 0; };
            { let _ = 0; };
            type_ =
                if unsafe { (*p_c).n_hdr_parsed } as i32 > (*p).i_col as i32 {
                    unsafe {
                        *(unsafe { (*p_c).a_type.as_ptr() } as
                                    *mut u32).add((*p).i_col as usize)
                    }
                } else { 0 as u32 };
            if type_ < 12 as u32 {
                z_err =
                    unsafe {
                        sqlite3_m_printf((*p).db,
                            c"cannot open value of type %s".as_ptr() as *mut i8 as
                                *const i8,
                            if type_ == 0 as u32 {
                                c"null".as_ptr() as *mut i8
                            } else {
                                if type_ == 7 as u32 {
                                    c"real".as_ptr() as *mut i8
                                } else { c"integer".as_ptr() as *mut i8 }
                            })
                    };
                rc = 1;
                unsafe { sqlite3_finalize((*p).p_stmt) };
                (*p).p_stmt = core::ptr::null_mut();
            } else {
                (*p).i_offset =
                    unsafe {
                            *(unsafe { (*p_c).a_type.as_ptr() } as
                                        *mut u32).offset(((*p).i_col as i32 +
                                            unsafe { (*p_c).n_field } as i32) as isize)
                        } as i32;
                (*p).n_byte =
                    unsafe { sqlite3_vdbe_serial_type_len(type_) } as i32;
                (*p).p_csr = unsafe { (*p_c).uc.p_cursor };
                unsafe { sqlite3_btree_incrblob_cursor((*p).p_csr) };
            }
        }
        if rc == 100 {
            rc = 0;
        } else if !((*p).p_stmt).is_null() {
            rc = unsafe { sqlite3_finalize((*p).p_stmt) };
            (*p).p_stmt = core::ptr::null_mut();
            if rc == 0 {
                z_err =
                    unsafe {
                        sqlite3_m_printf((*p).db,
                            c"no such rowid: %lld".as_ptr() as *mut i8 as *const i8,
                            i_row_1)
                    };
                rc = 1;
            } else {
...
pub extern "C" fn sqlite3_blob_open(db: *mut sqlite3, z_db_1: *const i8,
    z_table_1: *const i8, z_column_1: *const i8, i_row_1: sqlite_int64,
    mut wr_flag_1: i32, pp_blob_1: &mut *mut sqlite3_blob) -> i32 {
    unsafe {
        ...
        loop {
            ...
            '__s1:
                {
                match __state {
                    0 => { n_attempt = 0; __state = 3; }
                    2 => {
                        if rc == 0 && unsafe { (*db).malloc_failed } as i32 == 0 {
                            __state = 122;
                        } else { __state = 123; }
                    }
                    3 => { __state = 4; }
                    4 => { rc = 0; __state = 5; }
                    5 => { z_err = core::ptr::null_mut(); __state = 6; }
                    6 => { __state = 7; }
                    7 => { p_blob = core::ptr::null_mut(); __state = 8; }
                    8 => { __state = 9; }
                    9 => { __state = 10; }
                    10 => { *pp_blob_1 = core::ptr::null_mut(); __state = 11; }
                    11 => {
                        wr_flag_1 = ((wr_flag_1 == 0) as i32 == 0) as i32 as i32;
                        __state = 12;
                    }
                    12 => {
                        ...
                        p_blob =
                            unsafe {
                                    sqlite3_db_malloc_zero(db,
                                        core::mem::size_of::<Incrblob>() as u64)
                                } as *mut Incrblob;
                        __state = 14;
                    }
                    14 => { if 1 != 0 { __state = 16; } else { __state = 15; } }
                    15 => { __state = 2; }
                    16 => {
                    ...
                    19 => { __state = 2; }
                    20 => { z_err = core::ptr::null_mut(); __state = 21; }
                    21 => {
                    ...
                    22 => {
                        p_tab =
                            unsafe {
                                sqlite3_locate_table(&mut s_parse, 0 as u32, z_table_1,
                                    z_db_1)
                            };
                        __state = 23;
                    }
                    ...
                    25 => { p_tab = core::ptr::null_mut(); __state = 26; }
                    26 => {
                        unsafe {
                            sqlite3_error_msg(&mut s_parse,
                                c"cannot open virtual table: %s".as_ptr() as *mut i8 as
                                    *const i8, z_table_1)
                        };
                        __state = 24;
                    }
                    ...
                    28 => { p_tab = core::ptr::null_mut(); __state = 29; }
                    29 => {
                        unsafe {
                            sqlite3_error_msg(&mut s_parse,
                                c"cannot open table without rowid: %s".as_ptr() as *mut i8
                    ...
                    31 => { p_tab = core::ptr::null_mut(); __state = 32; }
                    32 => {
                        unsafe {
                            sqlite3_error_msg(&mut s_parse,
                                c"cannot open table with generated columns: %s".as_ptr() as
                        ...
                        if p_tab == core::ptr::null_mut() ||
                                {
                                    ...
                                    unsafe { sqlite3_open_temp_database(&mut s_parse) } != 0 {
                            __state = 37;
                        } else { __state = 36; }
                    }
                    34 => { p_tab = core::ptr::null_mut(); __state = 35; }
                    35 => {
                        unsafe {
                            sqlite3_error_msg(&mut s_parse,
                                c"cannot open view: %s".as_ptr() as *mut i8 as *const i8,
                                z_table_1)
                        };
                        __state = 33;
                    }
                    36 => { unsafe { (*p_blob).p_tab = p_tab }; __state = 44; }
                    37 => {
                    ...
                    40 => { z_err = s_parse.z_err_msg; __state = 41; }
                    41 => {
                        s_parse.z_err_msg = core::ptr::null_mut();
                        __state = 38;
                    }
                    42 => {
                    ...
                    45 => {
                        i_col = unsafe { sqlite3_column_index(p_tab, z_column_1) };
                        __state = 46;
                    }
                    46 => {
                        if i_col < 0 { __state = 48; } else { __state = 47; }
                    }
                    47 => {
                        if wr_flag_1 != 0 { __state = 54; } else { __state = 53; }
                    }
                    48 => {
                        unsafe { sqlite3_db_free(db, z_err as *mut ()) };
                        __state = 49;
                    ...
                    53 => {
                        unsafe {
                            (*p_blob).p_stmt =
                                unsafe { sqlite3_vdbe_create(&mut s_parse) } as
                                    *mut sqlite3_stmt
                        };
                        __state = 83;
                    }
                    54 => { z_fault = core::ptr::null(); __state = 55; }
                    55 => { __state = 56; }
                    56 => {
                    ...
                    57 => { p_idx = unsafe { (*p_tab).p_index }; __state = 70; }
                    58 => { __state = 59; }
                    ...
                    68 => {
                        z_fault = c"foreign key".as_ptr() as *mut i8 as *const i8;
                        __state = 67;
                    }
                    69 => {
                        if !(z_fault).is_null() {
                    ...
                    71 => { __state = 73; }
                    72 => { p_idx = unsafe { (*p_idx).p_next }; __state = 70; }
                    73 => { j__1 = 0; __state = 74; }
                    74 => {
                        if j__1 < unsafe { (*p_idx).n_key_col } as i32 {
                            __state = 75;
                        } else { __state = 72; }
                    }
                    75 => {
                        if unsafe {
                                            *unsafe { (*p_idx).ai_column.offset(j__1 as isize) }
                                        } as i32 == i_col ||
                                unsafe {
                                            *unsafe { (*p_idx).ai_column.offset(j__1 as isize) }
                                        } as i32 == -2 {
                    ...
                    77 => {
                        z_fault = c"indexed".as_ptr() as *mut i8 as *const i8;
                        __state = 76;
                    }
                    78 => {
                        unsafe { sqlite3_db_free(db, z_err as *mut ()) };
                    ...
                    79 => {
                        z_err =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"cannot open %s column for writing".as_ptr() as *mut i8 as
                                        *const i8, z_fault)
                            };
                        __state = 80;
                    }
                    ...
                    82 => { __state = 2; }
                    83 => { { let _ = 0; }; __state = 84; }
                    84 => {
                        if !(unsafe { (*p_blob).p_stmt }).is_null() {
                            __state = 86;
                        } else { __state = 85; }
                    }
                    85 => {
                        unsafe { (*p_blob).i_col = i_col as u16 };
                        __state = 113;
                    }
                    86 => { __state = 87; }
                    87 => { __state = 88; }
                    88 => {
                        v = unsafe { (*p_blob).p_stmt } as *mut Vdbe;
                        __state = 89;
                    }
                    89 => { __state = 90; }
                    90 => {
                        unsafe {
                            sqlite3_vdbe_add_op4_int(v, 2, i_db, wr_flag_1,
                                unsafe { (*unsafe { (*p_tab).p_schema }).schema_cookie },
                                unsafe { (*unsafe { (*p_tab).p_schema }).i_generation })
                        };
                        __state = 91;
                    }
                    91 => {
                    ...
                    92 => { { let _ = 0; }; __state = 93; }
                    93 => {
                        a_op =
                            unsafe {
                                sqlite3_vdbe_add_op_list(v,
                                    (core::mem::size_of::<[VdbeOpList; 6]>() as u64 /
                                            core::mem::size_of::<VdbeOpList>() as u64) as i32,
                                    &raw const open_blob[0 as usize] as *const VdbeOpList, i_ln)
                            };
                        __state = 94;
                    }
                    94 => {
                    ...
                    99 => {
                        unsafe {
                            (*a_op.offset(0 as isize)).p2 =
                                unsafe { (*p_tab).tnum } as i32
                        };
                        __state = 100;
                    }
                    100 => {
                        unsafe { (*a_op.offset(0 as isize)).p3 = wr_flag_1 };
                        __state = 101;
                    }
                    101 => {
                        unsafe {
                            sqlite3_vdbe_change_p4(v, 2,
                                unsafe { (*p_tab).z_name } as *const i8, 0)
                        };
                        __state = 96;
                    }
                    102 => {
                        if wr_flag_1 != 0 { __state = 104; } else { __state = 103; }
                    }
                    103 => {
                        unsafe {
                            (*a_op.offset(1 as isize)).p2 =
                                unsafe { (*p_tab).tnum } as i32
                        };
                        __state = 105;
                    }
                    104 => {
                        unsafe { (*a_op.offset(1 as isize)).opcode = 116 as u8 };
                        __state = 103;
                    }
                    105 => {
                        unsafe { (*a_op.offset(1 as isize)).p3 = i_db };
                        __state = 106;
                    }
                    106 => {
                        unsafe { (*a_op.offset(1 as isize)).p4type = -3 as i8 };
                        __state = 107;
                    }
                    107 => {
                        unsafe {
                            (*a_op.offset(1 as isize)).p4.i =
                    ...
                    108 => {
                        unsafe {
                            (*a_op.offset(3 as isize)).p2 =
                                unsafe { (*p_tab).n_col } as i32
                        };
                        __state = 109;
                    }
                    109 => { s_parse.n_var = 0 as ynVar; __state = 110; }
                    110 => { s_parse.n_mem = 1; __state = 111; }
                    111 => { s_parse.n_tab = 1; __state = 112; }
                    112 => {
                        unsafe { sqlite3_vdbe_make_ready(v, &mut s_parse) };
                        __state = 85;
                    }
                    113 => { unsafe { (*p_blob).db = db }; __state = 114; }
                    114 => {
                        unsafe { sqlite3_btree_leave_all(db) };
                        __state = 115;
                    }
                    ...
                    116 => {
                        rc =
                            blob_seek_to_row(unsafe { &mut *p_blob }, i_row_1,
                                &mut z_err);
                        __state = 118;
                    }
                    117 => { __state = 2; }
                    118 => {
                        if { let __p = &mut n_attempt; *__p += 1; *__p } >= 50 ||
                                rc != 17 {
                            __state = 120;
                        } else { __state = 119; }
                    }
                        ...
                        unsafe {
                            sqlite3_error_with_msg(db, rc,
                                if !(z_err).is_null() {
                                    ...
                                    } else { 0 as *mut i8 } as *const i8, z_err)
                        };
                        __state = 126;
                    }
                    122 => {
                        *pp_blob_1 = p_blob as *mut sqlite3_blob;
                        __state = 121;
                    }
                    123 => {
                        if !(p_blob).is_null() &&
                                !(unsafe { (*p_blob).p_stmt }).is_null() {
                            __state = 125;
                        } else { __state = 124; }
                    }
                    124 => {
                        unsafe { sqlite3_db_free(db, p_blob as *mut ()) };
                        __state = 121;
                    }
                    125 => {
                        unsafe {
                            sqlite3_vdbe_finalize(unsafe { (*p_blob).p_stmt } as
                                    *mut Vdbe)
                        };
                        __state = 124;
                    }
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_blob_reopen(p_blob: *mut sqlite3_blob,
    i_row: sqlite3_int64) -> i32 {
    let mut rc: i32 = 0;
    let p: *mut Incrblob = p_blob as *mut Incrblob;
    let mut db: *mut sqlite3 = core::ptr::null_mut();
    if p == core::ptr::null_mut() {
        return unsafe { sqlite3_misuse_error(508) };
    }
    db = unsafe { (*p).db };
    unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
    if unsafe { (*p).p_stmt } == core::ptr::null_mut() {
        ...
        rc = blob_seek_to_row(unsafe { &mut *p }, i_row, &mut z_err);
        if rc != 0 {
            unsafe {
                sqlite3_error_with_msg(db, rc,
                    if !(z_err).is_null() {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_blob_close(p_blob: *mut sqlite3_blob) -> i32 {
    let p: *mut Incrblob = p_blob as *mut Incrblob;
    let mut rc: i32 = 0;
    let mut db: *mut sqlite3 = core::ptr::null_mut();
    if !(p).is_null() {
        let p_stmt: *mut sqlite3_stmt = unsafe { (*p).p_stmt };
        db = unsafe { (*p).db };
        unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_blob_bytes(p_blob: *mut sqlite3_blob) -> i32 {
    let p: *const Incrblob = p_blob as *mut Incrblob as *const Incrblob;
    return if !(p).is_null() && !(unsafe { (*p).p_stmt }).is_null() {
            unsafe { (*p).n_byte }
        } else { 0 };
}
extern "C" fn blob_read_write(p_blob_1: *mut sqlite3_blob, z: &mut [u8],
    i_offset_1: i32,
    x_call_1:
        Option<unsafe extern "C" fn(*mut BtCursor, u32, u32, *mut ()) -> i32>)
    -> i32 {
    let mut rc: i32 = 0;
    let p: *mut Incrblob = p_blob_1 as *mut Incrblob;
    let mut v: *mut Vdbe = core::ptr::null_mut();
    let mut db: *mut sqlite3 = core::ptr::null_mut();
    if p == core::ptr::null_mut() {
        return unsafe { sqlite3_misuse_error(393) };
    }
    db = unsafe { (*p).db };
    unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
    v = unsafe { (*p).p_stmt } as *mut Vdbe;
    if (z.len() as i32) < 0 || i_offset_1 < 0 ||
            i_offset_1 as sqlite3_int64 + z.len() as i32 as sqlite3_int64 >
        ...
        rc =
            unsafe {
                x_call_1.unwrap()(unsafe { (*p).p_csr },
                    (i_offset_1 + unsafe { (*p).i_offset }) as u32,
                    z.len() as i32 as u32, z.as_ptr() as *mut ())
            };
        unsafe { sqlite3_btree_leave_cursor(unsafe { (*p).p_csr }) };
        if rc == 4 {
            unsafe { sqlite3_vdbe_finalize(v) };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_blob_read(p_blob: *mut sqlite3_blob, z: *mut (),
    n: i32, i_offset: i32) -> i32 {
    return blob_read_write(p_blob,
            unsafe {
                let __p = z as *mut u8 as *mut u8;
                if __p.is_null() {
                    &mut []
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_blob_write(p_blob: *mut sqlite3_blob, z: *const (),
    n: i32, i_offset: i32) -> i32 {
    return blob_read_write(p_blob,
            unsafe {
                let __p = z as *mut () as *mut u8 as *mut u8;
                if __p.is_null() {
                    &mut []
                } else { core::slice::from_raw_parts_mut(__p, n as usize) }
            }, i_offset, Some(sqlite3_btree_put_data));
}
#[repr(C)]
#[derive(Copy, Clone)]
...
static open_blob: [VdbeOpList; 6] =
    [VdbeOpList { opcode: 171 as u8, p1: 0 as i8, p2: 0 as i8, p3: 0 as i8 },
            VdbeOpList {
                opcode: 114 as u8,
                p1: 0 as i8,
                p2: 0 as i8,
