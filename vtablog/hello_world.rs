...
extern "C" fn vtablog_connect_create(db: *mut sqlite3, p_aux_1: *mut (),
    ...
    let mut p_new: *mut vtablog_vtab = core::ptr::null_mut();
    let mut i: i32 = 0;
    let mut rc: i32 = 0;
        ...
        '__s4:
            ...
            match __state {
                ...
                39 => {
                    p_new =
                        unsafe {
                                sqlite3_malloc64(core::mem::size_of::<vtablog_vtab>() as
                                        sqlite3_uint64)
                            } as *mut vtablog_vtab;
                    __state = 40;
                }
                40 => {
                    *pp_vtab_1 = p_new as *mut sqlite3_vtab;
                    __state = 41;
                }
                41 => {
                ...
                42 => {
                    unsafe {
                        memset(p_new as *mut (), 0,
                            core::mem::size_of::<vtablog_vtab>() as u64)
                    };
                    __state = 44;
                }
                43 => { return 7; }
...
extern "C" fn vtablog_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p_tab: *const vtablog_vtab =
        p_vtab_1 as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_destroy(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p_tab: *const vtablog_vtab =
        p_vtab_1 as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_open(p: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let p_tab: *mut vtablog_vtab = p as *mut vtablog_vtab;
    let mut p_cur: *mut vtablog_cursor = core::ptr::null_mut();
    unsafe {
    ...
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<vtablog_cursor>() as
                        sqlite3_uint64)
            } as *mut vtablog_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<vtablog_cursor>() as u64)
    };
    unsafe { (*p_cur).i_cursor = unsafe { (*p_tab).n_cursor } };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn vtablog_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const vtablog_cursor =
        cur as *mut vtablog_cursor as *const vtablog_cursor;
    let p_tab: *const vtablog_vtab =
        unsafe { (*cur).p_vtab } as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut vtablog_cursor = cur as *mut vtablog_cursor;
    let p_tab: *const vtablog_vtab =
        unsafe { (*cur).p_vtab } as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_column(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn vtablog_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn vtablog_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const vtablog_cursor =
        cur as *mut vtablog_cursor as *const vtablog_cursor;
    let p_tab: *const vtablog_vtab =
        unsafe { (*cur).p_vtab } as *mut vtablog_vtab as *const vtablog_vtab;
...
extern "C" fn vtablog_quote(p: *mut sqlite3_value) -> () {
...
extern "C" fn vtablog_filter(cur: *mut sqlite3_vtab_cursor, idx_num_1: i32,
...
extern "C" fn vtablog_best_index(tab: *mut sqlite3_vtab,
    p: *mut sqlite3_index_info) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    let mut i: i32 = 0;
    unsafe {
    ...
    unsafe { (*p).estimated_rows = 500 as sqlite3_int64 };
    unsafe {
        printf(c"  idxNum=%d\n".as_ptr() as *mut i8 as *const i8,
            unsafe { (*p).idx_num })
    };
...
extern "C" fn vtablog_update(tab: *mut sqlite3_vtab, argc: i32,
...
extern "C" fn vtablog_begin(tab: *mut sqlite3_vtab) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
        printf(c"%s.%s.xBegin()\n".as_ptr() as *mut i8 as *const i8,
...
extern "C" fn vtablog_sync(tab: *mut sqlite3_vtab) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
        printf(c"%s.%s.xSync()\n".as_ptr() as *mut i8 as *const i8,
...
extern "C" fn vtablog_commit(tab: *mut sqlite3_vtab) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_rollback(tab: *mut sqlite3_vtab) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_savepoint(tab: *mut sqlite3_vtab, n_1: i32) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_release(tab: *mut sqlite3_vtab, n_1: i32) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_rollback_to(tab: *mut sqlite3_vtab, n_1: i32) -> i32 {
    let p_tab: *const vtablog_vtab =
        tab as *mut vtablog_vtab as *const vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_find_method(tab: *mut sqlite3_vtab, n_arg_1: i32,
    z_name_1: *const i8,
    px_func_1:
        *mut unsafe extern "C" fn(*mut sqlite3_context, i32,
...
extern "C" fn vtablog_rename(tab: *mut sqlite3_vtab, z_new_1: *const i8)
    -> i32 {
    let p_tab: *mut vtablog_vtab = tab as *mut vtablog_vtab;
    unsafe {
...
extern "C" fn vtablog_integrity(tab: *mut sqlite3_vtab, z_schema_1: *const i8,
...
static mut vtablog_module: sqlite3_module =
    sqlite3_module {
        i_version: 4,
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut vtablog_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
        return rc;
    }
