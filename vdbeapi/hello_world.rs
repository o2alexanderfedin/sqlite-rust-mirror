...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_sql(p_stmt: *mut sqlite3_stmt) -> *const i8 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_expanded_sql(p_stmt: *mut sqlite3_stmt) -> *mut i8 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_stmt_readonly(p_stmt: *mut sqlite3_stmt) -> i32 {
    return if !(p_stmt).is_null() {
            (unsafe { (*(p_stmt as *mut Vdbe)).read_only() }) as i32
        } else { 1 };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_stmt_isexplain(p_stmt: *mut sqlite3_stmt) -> i32 {
    return if !(p_stmt).is_null() {
            (unsafe { (*(p_stmt as *mut Vdbe)).explain() }) as i32
        } else { 0 };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_stmt_explain(p_stmt: *mut sqlite3_stmt, e_mode: i32)
    -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_stmt_busy(p_stmt: *mut sqlite3_stmt) -> i32 {
...
extern "C" fn bind_text(p_stmt_1: *mut sqlite3_stmt, i: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_blob(p_stmt: *mut sqlite3_stmt, i: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_blob64(p_stmt: *mut sqlite3_stmt, i: i32,
    z_data: *const (), n_data: sqlite3_uint64,
    x_del: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> i32 {
    { let _ = 0; };
    return bind_text(p_stmt, i, z_data, n_data as i64, x_del, 0 as u8);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_double(p_stmt: *mut sqlite3_stmt, i: i32,
    r_value: f64) -> i32 {
    let mut rc: i32 = 0;
    let p: *mut Vdbe = p_stmt as *mut Vdbe;
    rc = vdbe_unbind(p, (i - 1) as u32);
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_int64(p_stmt: *mut sqlite3_stmt, i: i32,
    i_value: sqlite3_int64) -> i32 {
    let mut rc: i32 = 0;
    let p: *mut Vdbe = p_stmt as *mut Vdbe;
    rc = vdbe_unbind(p, (i - 1) as u32);
    if rc == 0 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_int(p: *mut sqlite3_stmt, i: i32, i_value: i32)
    -> i32 {
    return sqlite3_bind_int64(p, i, i_value as i64);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_null(p_stmt: *mut sqlite3_stmt, i: i32)
    -> i32 {
    let mut rc: i32 = 0;
    let p: *mut Vdbe = p_stmt as *mut Vdbe;
    rc = vdbe_unbind(p, (i - 1) as u32);
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_text(p_stmt: *mut sqlite3_stmt, i: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_text16(p_stmt: *mut sqlite3_stmt, i: i32,
    z_data: *const (), n: i32,
    x_del: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_text64(p_stmt: *mut sqlite3_stmt, i: i32,
    z_data: *const i8, mut n_data: sqlite3_uint64,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_type(p_val_1: &sqlite3_value) -> i32 {
    return a_type[((*p_val_1).flags as i32 & 63) as usize] as i32;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_zeroblob(p_stmt: *mut sqlite3_stmt, i: i32,
    n: i32) -> i32 {
    let mut rc: i32 = 0;
    let p: *mut Vdbe = p_stmt as *mut Vdbe;
    rc = vdbe_unbind(p, (i - 1) as u32);
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_value(p_stmt_1: *mut sqlite3_stmt, i: i32,
    p_value_1: *const sqlite3_value) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        '__s0:
            {
            match sqlite3_value_type(unsafe {
                        &*(p_value_1 as *mut sqlite3_value)
                    }) {
                1 => {
                    {
                        rc =
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_pointer(p_stmt: *mut sqlite3_stmt, i: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_zeroblob64(p_stmt: *mut sqlite3_stmt, i: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_parameter_count(p_stmt: *mut sqlite3_stmt)
    -> i32 {
    let p: *const Vdbe = p_stmt as *mut Vdbe as *const Vdbe;
    return if !(p).is_null() { (unsafe { (*p).n_var }) as i32 } else { 0 };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_parameter_name(p_stmt: *mut sqlite3_stmt,
    i: i32) -> *const i8 {
    let p: *const Vdbe = p_stmt as *mut Vdbe as *const Vdbe;
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_bind_parameter_index(p_stmt: *mut sqlite3_stmt,
    z_name: *const i8) -> i32 {
    return sqlite3_vdbe_parameter_index(p_stmt as *mut Vdbe as *const Vdbe,
            z_name, unsafe { sqlite3_strlen30(z_name) });
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_clear_bindings(p_stmt: *mut sqlite3_stmt) -> i32 {
    let mut i: i32 = 0;
    let rc: i32 = 0;
    let p: *mut Vdbe = p_stmt as *mut Vdbe;
    let mut mutex: *mut sqlite3_mutex = core::ptr::null_mut();
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_count(p_stmt: *mut sqlite3_stmt) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_text16(p_val_1: *mut sqlite3_value)
    -> *const () {
    return unsafe { sqlite3ValueText(p_val_1, 2 as u8) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_text(p_val_1: *mut sqlite3_value)
    -> *const u8 {
    return unsafe { sqlite3ValueText(p_val_1, 1 as u8) } as *const u8;
}
extern "C" fn column_name(p_stmt_1: *mut sqlite3_stmt, mut n_1: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_name(p_stmt: *mut sqlite3_stmt, n: i32)
    -> *const i8 {
    return column_name(p_stmt, n, 0, 0) as *const i8;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_name16(p_stmt: *mut sqlite3_stmt, n: i32)
    -> *const () {
    return column_name(p_stmt, n, 1, 0);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_decltype(p_stmt: *mut sqlite3_stmt, n: i32)
    -> *const i8 {
    return column_name(p_stmt, n, 0, 1) as *const i8;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_decltype16(p_stmt: *mut sqlite3_stmt, n: i32)
    -> *const () {
    return column_name(p_stmt, n, 1, 1);
}
extern "C" fn invoke_profile_callback(db: &sqlite3, p: *mut Vdbe) -> () {
    unsafe {
        let mut i_now: sqlite3_int64 = 0 as sqlite3_int64;
        let mut i_elapse: sqlite3_int64 = 0 as sqlite3_int64;
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        unsafe { sqlite3_os_current_time_int64((*db).p_vfs, &mut i_now) };
        i_elapse =
            (i_now - unsafe { (*p).start_time }) * 1000000 as sqlite_int64;
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_reset(p_stmt: *mut sqlite3_stmt) -> i32 {
    let mut rc: i32 = 0;
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_step(p_stmt: *mut sqlite3_stmt) -> i32 {
    let mut rc: i32 = 0;
    let v: *mut Vdbe = p_stmt as *mut Vdbe;
    let mut cnt: i32 = 0;
    let mut db: *mut sqlite3 = core::ptr::null_mut();
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_data_count(p_stmt: *mut sqlite3_stmt) -> i32 {
    let p_vm: *const Vdbe = p_stmt as *mut Vdbe as *const Vdbe;
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_blob(p_val_1: *mut sqlite3_value)
    -> *const () {
    unsafe {
...
extern "C" fn column_mem(p_stmt_1: *mut sqlite3_stmt, i: i32) -> *mut Mem {
...
extern "C" fn column_malloc_failure(p_stmt_1: *mut sqlite3_stmt) -> () {
    let p: *mut Vdbe = p_stmt_1 as *mut Vdbe;
    if !(p).is_null() {
        { let _ = 0; };
        { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_blob(p_stmt: *mut sqlite3_stmt, i: i32)
    -> *const () {
    let mut val: *const () = core::ptr::null();
    val = sqlite3_value_blob(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_double(p_val_1: *mut sqlite3_value) -> f64 {
    return unsafe { sqlite3_vdbe_real_value(p_val_1 as *mut Mem) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_double(p_stmt: *mut sqlite3_stmt, i: i32)
    -> f64 {
    let val: f64 =
        sqlite3_value_double(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_int(p_val_1: *mut sqlite3_value) -> i32 {
    return unsafe {
                sqlite3_vdbe_int_value(p_val_1 as *mut Mem as *const Mem)
            } as i32;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_int(p_stmt: *mut sqlite3_stmt, i: i32)
    -> i32 {
    let val: i32 =
        sqlite3_value_int(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_int64(p_val_1: *mut sqlite3_value)
    -> sqlite3_int64 {
    return unsafe {
            sqlite3_vdbe_int_value(p_val_1 as *mut Mem as *const Mem)
        };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_int64(p_stmt: *mut sqlite3_stmt, i: i32)
    -> sqlite3_int64 {
    let val: sqlite_int64 =
        sqlite3_value_int64(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_text(p_stmt: *mut sqlite3_stmt, i: i32)
    -> *const u8 {
    let val: *const u8 =
        sqlite3_value_text(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_text16(p_stmt: *mut sqlite3_stmt, i: i32)
    -> *const () {
    let val: *const () =
        sqlite3_value_text16(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_value(p_stmt_1: *mut sqlite3_stmt, i: i32)
    -> *mut sqlite3_value {
    ...
    return p_out as *mut sqlite3_value;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_bytes(p_val_1: *mut sqlite3_value) -> i32 {
    return unsafe { sqlite3ValueBytes(p_val_1, 1 as u8) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_bytes(p_stmt: *mut sqlite3_stmt, i: i32)
    -> i32 {
    let val: i32 =
        sqlite3_value_bytes(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_bytes16(p_val_1: *mut sqlite3_value) -> i32 {
    return unsafe { sqlite3ValueBytes(p_val_1, 2 as u8) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_bytes16(p_stmt: *mut sqlite3_stmt, i: i32)
    -> i32 {
    let val: i32 =
        sqlite3_value_bytes16(column_mem(p_stmt, i) as *mut sqlite3_value);
    column_malloc_failure(p_stmt);
    return val;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_column_type(p_stmt: *mut sqlite3_stmt, i: i32)
    -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_finalize(p_stmt: *mut sqlite3_stmt) -> i32 {
    let mut rc: i32 = 0;
    if p_stmt == core::ptr::null_mut() {
        rc = 0;
    } else {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_aggregate_count(p: &sqlite3_context) -> i32 {
    unsafe { { let _ = 0; }; return unsafe { (*(*p).p_mem).n }; }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_expired(p_stmt: *mut sqlite3_stmt) -> i32 {
    let mut i_ret: i32 = 1;
    if !(p_stmt).is_null() {
        let p: *const Vdbe = p_stmt as *mut Vdbe as *const Vdbe;
        unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3TransferBindings(p_from_stmt: *mut sqlite3_stmt,
    p_to_stmt: *mut sqlite3_stmt) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_transfer_bindings(p_from_stmt: *mut sqlite3_stmt,
    p_to_stmt: *mut sqlite3_stmt) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_pointer(p_val_1: *mut sqlite3_value,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_text16le(p_val_1: *mut sqlite3_value)
    -> *const () {
    return unsafe { sqlite3ValueText(p_val_1, 2 as u8) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_text16be(p_val_1: *mut sqlite3_value)
    -> *const () {
    return unsafe { sqlite3ValueText(p_val_1, 3 as u8) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_nochange(p_val_1: &sqlite3_value) -> i32 {
    return ((*p_val_1).flags as i32 & (1 | 1024) == 1 | 1024) as i32;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_frombind(p_val_1: &sqlite3_value) -> i32 {
    return ((*p_val_1).flags as i32 & 64 != 0) as i32;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_encoding(p_val_1: &sqlite3_value) -> i32 {
    return (*p_val_1).enc as i32;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_subtype(p_val_1: *mut sqlite3_value) -> u32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_dup(p_orig_1: *const sqlite3_value)
    -> *mut sqlite3_value {
    let mut p_new: *mut sqlite3_value = core::ptr::null_mut();
    if p_orig_1 == core::ptr::null() { return core::ptr::null_mut(); }
    p_new =
        unsafe {
                sqlite3_malloc(core::mem::size_of::<sqlite3_value>() as i32)
            } as *mut sqlite3_value;
    if p_new == core::ptr::null_mut() { return core::ptr::null_mut(); }
    unsafe {
        memset(p_new as *mut (), 0,
            core::mem::size_of::<sqlite3_value>() as u64)
    };
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_free(p_old_1: *mut sqlite3_value) -> () {
    unsafe { sqlite3ValueFree(p_old_1) };
}
extern "C" fn create_agg_context(p: &sqlite3_context, n_byte_1: i32)
    -> *mut () {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_aggregate_context(p: *mut sqlite3_context,
    n_byte_1: i32) -> *mut () {
    unsafe {
        { let _ = 0; };
        { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_user_data(p: &sqlite3_context) -> *mut () {
    unsafe { { let _ = 0; }; return unsafe { (*(*p).p_func).p_user_data }; }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_context_db_handle(p: &sqlite3_context)
    -> *mut sqlite3 {
    { let _ = 0; };
    return unsafe { (*(*p).p_out).db };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_get_auxdata(p_ctx_1: &sqlite3_context, i_arg_1: i32)
    -> *mut () {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_set_auxdata(p_ctx_1: &mut sqlite3_context,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_error_toobig(p_ctx_1: &mut sqlite3_context)
    -> () {
    { let _ = 0; };
    (*p_ctx_1).is_error = 18;
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_error_nomem(p_ctx_1: &mut sqlite3_context)
    -> () {
    { let _ = 0; };
...
extern "C" fn set_result_str_or_error(p_ctx_1: *mut sqlite3_context,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_blob(p_ctx_1: *mut sqlite3_context,
    z: *const (), n: i32,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    { let _ = 0; };
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_blob64(p_ctx_1: *mut sqlite3_context,
    z: *const (), n: sqlite3_uint64,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    { let _ = 0; };
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_double(p_ctx_1: &sqlite3_context,
    r_val_1: f64) -> () {
    { let _ = 0; };
    unsafe { sqlite3_vdbe_mem_set_double((*p_ctx_1).p_out, r_val_1) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_error(p_ctx_1: &mut sqlite3_context,
    z: *const i8, n: i32) -> () {
    { let _ = 0; };
    (*p_ctx_1).is_error = 1;
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_error16(p_ctx_1: &mut sqlite3_context,
    z: *const (), n: i32) -> () {
    { let _ = 0; };
    (*p_ctx_1).is_error = 1;
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_error_code(p_ctx_1: *mut sqlite3_context,
    err_code_1: i32) -> () {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_int(p_ctx_1: &sqlite3_context, i_val_1: i32)
    -> () {
    { let _ = 0; };
    unsafe { sqlite3_vdbe_mem_set_int64((*p_ctx_1).p_out, i_val_1 as i64) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_int64(p_ctx_1: &sqlite3_context,
    i_val_1: i64) -> () {
    { let _ = 0; };
    unsafe { sqlite3_vdbe_mem_set_int64((*p_ctx_1).p_out, i_val_1) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_null(p_ctx_1: &sqlite3_context) -> () {
    { let _ = 0; };
    unsafe { sqlite3_vdbe_mem_set_null((*p_ctx_1).p_out) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_text(p_ctx_1: *mut sqlite3_context,
    z: *const i8, n: i32,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_text64(p_ctx_1: *mut sqlite3_context,
    z: *const i8, mut n: sqlite3_uint64,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_text16(p_ctx_1: *mut sqlite3_context,
    z: *const (), n: i32,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_text16le(p_ctx_1: *mut sqlite3_context,
    z: *const (), n: i32,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    { let _ = 0; };
    set_result_str_or_error(p_ctx_1, z as *const i8,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_text16be(p_ctx_1: *mut sqlite3_context,
    z: *const (), n: i32,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    { let _ = 0; };
    set_result_str_or_error(p_ctx_1, z as *const i8,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_value(p_ctx_1: *mut sqlite3_context,
    p_value_1: *const sqlite3_value) -> () {
    let mut p_out: *mut Mem = core::ptr::null_mut();
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_pointer(p_ctx_1: &sqlite3_context,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_zeroblob64(p_ctx_1: *mut sqlite3_context,
    n: u64) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_zeroblob(p_ctx_1: *mut sqlite3_context,
    n: i32) -> () {
    unsafe {
        sqlite3_result_zeroblob64(p_ctx_1,
            if n > 0 { n } else { 0 } as sqlite3_uint64)
    };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_subtype(p_ctx_1: &sqlite3_context,
    e_subtype_1: u32) -> () {
    let mut p_out: *mut Mem = core::ptr::null_mut();
    p_out = (*p_ctx_1).p_out;
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_db_handle(p_stmt_1: *mut sqlite3_stmt)
    -> *mut sqlite3 {
...
pub extern "C" fn sqlite3_next_stmt(p_db_1: &mut sqlite3,
    p_stmt_1: *mut sqlite3_stmt) -> *mut sqlite3_stmt {
    let mut p_next: *mut sqlite3_stmt = core::ptr::null_mut();
    unsafe { sqlite3_mutex_enter((*p_db_1).mutex) };
    if p_stmt_1 == core::ptr::null_mut() {
        p_next = (*p_db_1).p_vdbe as *mut sqlite3_stmt;
    } else {
        p_next =
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_str(p_ctx_1: *mut sqlite3_context,
    p_str_1: *mut sqlite3_str, e_own_1: i32) -> () {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_stmt_status(p_stmt: *mut sqlite3_stmt, op: i32,
    reset_flag: i32) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_nochange(p: &sqlite3_context) -> i32 {
    { let _ = 0; };
...
extern "C" fn value_from_value_list(p_val_1: *mut sqlite3_value,
    pp_out_1: &mut *mut sqlite3_value, b_next_1: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        ...
        *pp_out_1 = core::ptr::null_mut();
        ...
        if rc == 0 {
            ...
            if rc == 0 {
                ...
                let p_out: *mut sqlite3_value = unsafe { (*p_rhs).p_out };
                let i_off: i32 =
                    1 +
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_in_first(p_val_1: *mut sqlite3_value,
    pp_out_1: *mut *mut sqlite3_value) -> i32 {
    return value_from_value_list(p_val_1, unsafe { &mut *pp_out_1 }, 0);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_in_next(p_val_1: *mut sqlite3_value,
    pp_out_1: *mut *mut sqlite3_value) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_result_int_real(p_ctx_1: &sqlite3_context) -> () {
    { let _ = 0; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_stmt_current_time(p: &sqlite3_context)
    -> sqlite3_int64 {
    let mut rc: i32 = 0;
    let pi_time: *mut sqlite3_int64 =
    ...
    if unsafe { *pi_time } == 0 as i64 {
        ...
        if rc != 0 { unsafe { *pi_time = 0 as sqlite3_int64 }; }
    }
