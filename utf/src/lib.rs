...
pub extern "C" fn sqlite3_append_one_utf8_character(z_out: *mut i8, v: u32)
    -> i32 {
    if v < 128 as u32 {
        unsafe { *z_out.offset(0 as isize) = (v & 255 as u32) as u8 as i8 };
        return 1;
    }
    if v < 2048 as u32 {
        unsafe {
            *z_out.offset(0 as isize) =
                (192 + (v >> 6 & 31 as u32) as u8 as i32) as i8
        };
        unsafe {
            *z_out.offset(1 as isize) =
                (128 + (v & 63 as u32) as u8 as i32) as i8
        };
        return 2;
    }
    if v < 65536 as u32 {
        unsafe {
            *z_out.offset(0 as isize) =
                (224 + (v >> 12 & 15 as u32) as u8 as i32) as i8
        };
        unsafe {
            *z_out.offset(1 as isize) =
                (128 + (v >> 6 & 63 as u32) as u8 as i32) as i8
        };
        unsafe {
            *z_out.offset(2 as isize) =
                (128 + (v & 63 as u32) as u8 as i32) as i8
        };
        return 3;
    }
    unsafe {
        *z_out.offset(0 as isize) =
            (240 + (v >> 18 & 7 as u32) as u8 as i32) as i8
    };
    unsafe {
        *z_out.offset(1 as isize) =
            (128 + (v >> 12 & 63 as u32) as u8 as i32) as i8
    };
    unsafe {
        *z_out.offset(2 as isize) =
            (128 + (v >> 6 & 63 as u32) as u8 as i32) as i8
    ...
    unsafe {
        *z_out.offset(3 as isize) = (128 + (v & 63 as u32) as u8 as i32) as i8
    };
    return 4;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_utf16_byte_len(z_in: *const (), n_byte: i32,
    ...
    let z_end: *const u8 = unsafe { &*z.offset((n_byte - 1) as isize) };
    let mut n: i32 = 0;
    if 2 == 2 {
        {
            let __p = &mut z;
    ...
    while n < n_char && z <= z_end {
        ...
        if c >= 216 && c < 220 && z <= z_end &&
                    unsafe { *z.offset(0 as isize) } as i32 >= 220 &&
                (unsafe { *z.offset(0 as isize) } as i32) < 224 {
            {
                let __n = 2;
                let __p = &mut z;
                *__p = unsafe { (*__p).offset(__n as isize) };
...
pub extern "C" fn sqlite3_utf8_char_len(z_in: *const i8, n_byte: i32) -> i32 {
    let mut r: i32 = 0;
    let mut z: *const u8 = z_in as *const u8;
    let mut z_term: *const u8 = core::ptr::null();
    if n_byte >= 0 {
        z_term = unsafe { z.offset(n_byte as isize) };
    } else { z_term = -1i32 as *const u8; }
    { let _ = 0; };
    while unsafe { *z } as i32 != 0 && z < z_term {
        {
            if unsafe {
                            *{
                                    let __p = &mut z;
...
pub extern "C" fn sqlite3_utf8_read(pz: &mut *const u8) -> u32 {
    ...
    if c >= 192 as u32 {
        ...
        if c < 128 as u32 || c & 4294965248u32 == 55296 as u32 ||
                c & 4294967294u32 == 65534 as u32 {
            c = 65533 as u32;
        }
    }
    return c;
...
pub extern "C" fn sqlite3_utf8_read_limited(z: *const u8, mut n: i32,
    ...
    let mut i: i32 = 1;
    { let _ = 0; };
    c = unsafe { *z.offset(0 as isize) } as u32;
    if c >= 192 as u32 {
        c = sqlite3_utf8_trans1[(c - 192 as u32) as usize] as u32;
        if n > 4 { n = 4; }
        while i < n && unsafe { *z.offset(i as isize) } as i32 & 192 == 128 {
            c =
                (c << 6) +
                    (63 & unsafe { *z.offset(i as isize) } as i32) as u32;
...
pub extern "C" fn sqlite3_utf16to8(db: *mut Sqlite3, z: *const (),
    ...
    unsafe {
        ...
        m.db = db;
        unsafe {
            sqlite3_vdbe_mem_set_str(&mut m, z as *const i8, n_byte_1 as i64,
                enc, None)
        };
        unsafe { sqlite3_vdbe_change_encoding(&mut m, 1) };
        if unsafe { (*db).malloc_failed } != 0 {
            unsafe { sqlite3_vdbe_mem_release(&mut m) };
            m.z = core::ptr::null_mut();
        }
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        ...
        loop {
            ...
            '__s6:
                ...
                match __state {
                    ...
                    13 => {
                        if unsafe { (*p_mem_1).enc } as i32 != 1 &&
                                desired_enc_1 as i32 != 1 {
                            __state = 15;
                        } else { __state = 14; }
                    }
                    14 => {
                        if desired_enc_1 as i32 == 1 {
                            __state = 31;
                        } else { __state = 32; }
                    }
                    15 => { __state = 16; }
                    16 => { __state = 17; }
                    17 => {
                        rc = unsafe { sqlite3_vdbe_mem_make_writeable(p_mem_1) };
                        __state = 18;
                    }
                    18 => {
                    ...
                    19 => {
                        z_in = unsafe { (*p_mem_1).z } as *mut u8;
                        __state = 22;
                    }
                    ...
                    22 => {
                        z_term =
                            unsafe {
                                z_in.offset((unsafe { (*p_mem_1).n } & !1) as isize)
                            };
                        __state = 23;
                    }
                    23 => {
                        if z_in < z_term { __state = 25; } else { __state = 24; }
                    }
                    24 => {
                        unsafe { (*p_mem_1).enc = desired_enc_1 };
                        __state = 29;
                    }
                    25 => { temp = unsafe { *z_in }; __state = 26; }
                    26 => {
                        unsafe {
                            *z_in = unsafe { *unsafe { z_in.offset(1 as isize) } }
                        };
                        __state = 27;
                    }
                    27 => {
                    ...
                    31 => { unsafe { (*p_mem_1).n &= !1 }; __state = 33; }
                    32 => {
                        len =
                            2 as Sqlite3Int64 * unsafe { (*p_mem_1).n } as Sqlite3Int64
                                + 2 as Sqlite3Int64;
                        __state = 30;
                    }
                    33 => {
                    ...
                    34 => {
                        z_term =
                            unsafe { z_in.offset(unsafe { (*p_mem_1).n } as isize) };
                        __state = 35;
                    }
                    35 => {
                        z_out =
                            unsafe {
                                    sqlite3_db_malloc_raw(unsafe { (*p_mem_1).db }, len as u64)
                                } as *mut u8;
                        __state = 36;
                    }
                    36 => {
                    ...
                    40 => { unsafe { *z = 0 as u8 }; __state = 126; }
                    41 => {
                        if desired_enc_1 as i32 == 2 {
                            __state = 44;
                        } else { __state = 45; }
                    }
                    42 => { { let _ = 0; }; __state = 80; }
                    43 => {
                        unsafe {
                            (*p_mem_1).n = unsafe { z.offset_from(z_out) } as i64 as i32
                        };
                        __state = 79;
                    }
                    44 => {
                        if z_in < z_term { __state = 46; } else { __state = 43; }
                    }
                    45 => { { let _ = 0; }; __state = 62; }
                    46 => {
                        c =
                            unsafe {
                                    *{
                    ...
                    47 => {
                        if c >= 192 as u32 { __state = 49; } else { __state = 48; }
                    }
                    48 => { __state = 54; }
                    49 => {
                        c = sqlite3_utf8_trans1[(c - 192 as u32) as usize] as u32;
                    ...
                    50 => {
                        if z_in < z_term && unsafe { *z_in } as i32 & 192 == 128 {
                            __state = 52;
                        } else { __state = 51; }
                    }
                    51 => {
                    ...
                    57 => {
                        unsafe {
                            *{
                                ...
                                ((c >> 10 & 63 as u32) +
                                        (c - 65536 as u32 >> 10 & 192 as u32)) as u8
                        };
                        __state = 59;
                    }
                    58 => {
                    ...
                    59 => {
                        unsafe {
                            *{
                                        ...
                                        *__p = unsafe { (*__p).offset(1) };
                                        __t
                                    } = (216 as u32 + (c - 65536 as u32 >> 18 & 3 as u32)) as u8
                        };
                        __state = 60;
                    }
                    60 => {
                    ...
                    61 => {
                        unsafe {
                            *{
                                        ...
                                        *__p = unsafe { (*__p).offset(1) };
                                        __t
                                    } = (220 as u32 + (c >> 8 & 3 as u32)) as u8
                        };
                        __state = 55;
                    }
                    62 => {
                        if z_in < z_term { __state = 63; } else { __state = 43; }
                    }
                    63 => {
                        c =
                            unsafe {
                    ...
                    64 => {
                        if c >= 192 as u32 { __state = 66; } else { __state = 65; }
                    }
                    65 => { __state = 71; }
                    66 => {
                        c = sqlite3_utf8_trans1[(c - 192 as u32) as usize] as u32;
                    ...
                    80 => {
                        if unsafe { (*p_mem_1).enc } as i32 == 2 {
                            __state = 82;
                        } else { __state = 83; }
                    }
                    81 => {
                    ...
                    82 => {
                        if z_in < z_term { __state = 84; } else { __state = 81; }
                    }
                    83 => {
                        if z_in < z_term { __state = 105; } else { __state = 81; }
                    }
                    84 => {
                        c =
                            unsafe {
                    ...
                    86 => {
                        if c >= 55296 as u32 && c < 57344 as u32 {
                            __state = 88;
                        } else { __state = 87; }
                    }
                    87 => {
                        if c < 128 as u32 { __state = 93; } else { __state = 94; }
                    }
                    88 => {
                        if z_in < z_term { __state = 89; } else { __state = 87; }
                    }
                    89 => {
                        c2 =
                            unsafe {
                    ...
                    91 => {
                        c =
                            (c2 & 1023) as u32 + ((c & 63 as u32) << 10) +
                                (((c & 960 as u32) + 64 as u32) << 10);
                        __state = 87;
                    }
                    92 => { __state = 82; }
                    93 => {
                    ...
                    94 => {
                        if c < 2048 as u32 { __state = 95; } else { __state = 96; }
                    }
                    95 => {
                        unsafe {
                            *{
                    ...
                    96 => {
                        if c < 65536 as u32 { __state = 98; } else { __state = 99; }
                    }
                    97 => {
                        unsafe {
                            *{
                    ...
                    108 => {
                        if c < 128 as u32 { __state = 114; } else { __state = 115; }
                    }
                    109 => {
                        if z_in < z_term { __state = 110; } else { __state = 108; }
                    }
                    110 => {
                        c2__1 =
                            (unsafe {
                    ...
                    112 => {
                        c =
                            (c2__1 & 1023) as u32 + ((c & 63 as u32) << 10) +
                                (((c & 960 as u32) + 64 as u32) << 10);
                        __state = 108;
                    }
                    113 => { __state = 83; }
                    ...
                    127 => {
                        c =
                            (2 | 512 | unsafe { (*p_mem_1).flags } as i32 & (63 | 2048))
                                as u32;
                        __state = 128;
                    }
                    128 => {
                        unsafe { sqlite3_vdbe_mem_release(p_mem_1) };
                        __state = 129;
                    }
                    129 => {
                        unsafe { (*p_mem_1).flags = c as u16 };
                        __state = 130;
                    }
                    130 => {
                        unsafe { (*p_mem_1).enc = desired_enc_1 };
                    ...
                    131 => {
                        unsafe { (*p_mem_1).z = z_out as *mut i8 };
                        __state = 132;
                    }
                    132 => {
...
pub extern "C" fn sqlite3_vdbe_mem_handle_bom(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let mut bom: u8 = 0 as u8;
        { let _ = 0; };
        if unsafe { (*p_mem_1).n } > 1 {
            let b1: u8 = unsafe { *(unsafe { (*p_mem_1).z } as *mut u8) };
            let b2: u8 =
                unsafe {
                    *unsafe {
                            (unsafe { (*p_mem_1).z } as *mut u8).offset(1 as isize)
                        }
                };
            if b1 as i32 == 254 && b2 as i32 == 255 { bom = 3 as u8; }
            if b1 as i32 == 255 && b2 as i32 == 254 { bom = 2 as u8; }
        }
        if bom != 0 {
            rc = unsafe { sqlite3_vdbe_mem_make_writeable(p_mem_1) };
            if rc == 0 {
                unsafe { (*p_mem_1).n -= 2 };
                unsafe {
                    memmove(unsafe { (*p_mem_1).z } as *mut (),
                        unsafe {
                                &raw mut *unsafe { (*p_mem_1).z.offset(2 as isize) }
                            } as *const (), unsafe { (*p_mem_1).n } as u64)
                };
                unsafe {
                    *unsafe {
