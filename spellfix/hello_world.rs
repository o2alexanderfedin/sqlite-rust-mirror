...
extern "C" fn phonetic_hash(mut z_in_1: *const u8, mut n_in_1: i32)
    ...
    let z_out: *mut u8 =
        unsafe {
                sqlite3_malloc64((n_in_1 as i64 + 1 as i64) as sqlite3_uint64)
            } as *mut u8;
    let mut i: i32 = 0;
    let mut n_out: i32 = 0;
...
extern "C" fn phonetic_hash_sql_func(context: *mut sqlite3_context, argc: i32,
...
extern "C" fn editdist_sql_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let res: i32 =
        editdist1(unsafe {
...
extern "C" fn edit_dist3_core(p_from_1: &EditDist3FromString, z2: *const i8,
    ...
    let mut p: *mut EditDist3Cost = core::ptr::null_mut();
    let mut res: i32 = 0;
    let mut n_byte: sqlite3_uint64 = 0 as sqlite3_uint64;
...
extern "C" fn edit_dist3_sql_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn transliterate_sql_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_in: *const u8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) };
    let n_in: i32 =
...
extern "C" fn script_code_sql_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
struct spellfix1_cursor {
    ...
    i_scope: i32,
    n_search: i32,
    p_full_scan: *mut sqlite3_stmt,
    a: *mut spellfix1_row,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct spellfix1_row {
    i_rowid: sqlite3_int64,
    z_word: *mut i8,
    i_rank: i32,
    i_distance: i32,
...
extern "C" fn spellfix1_uninit(is_destroy_1: i32,
    p_v_tab_1: *mut sqlite3_vtab) -> i32 {
    let p: *mut spellfix1_vtab = p_v_tab_1 as *mut spellfix1_vtab;
    let mut rc: i32 = 0;
    if is_destroy_1 != 0 {
...
extern "C" fn spellfix1_disconnect(p_v_tab_1: *mut sqlite3_vtab) -> i32 {
    return spellfix1_uninit(0, p_v_tab_1);
}
extern "C" fn spellfix1_destroy(p_v_tab_1: *mut sqlite3_vtab) -> i32 {
...
extern "C" fn spellfix1_init(is_create_1: i32, db: *mut sqlite3,
    ...
    pp_v_tab_1: &mut *mut sqlite3_vtab, pz_err_1: &mut *mut i8) -> i32 {
    let mut p_new: *mut spellfix1_vtab = core::ptr::null_mut();
    ...
    p_new =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<spellfix1_vtab>() as u64
    ...
    if p_new == core::ptr::null_mut() {
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<spellfix1_vtab>() as u64)
        };
        unsafe {
            (*p_new).z_db_name =
    ...
    } else { *pp_v_tab_1 = p_new as *mut sqlite3_vtab; }
    return rc;
}
...
extern "C" fn spellfix1_reset_cursor(p_cur_1: &mut spellfix1_cursor) -> () {
    let mut i: i32 = 0;
    {
        i = 0;
        '__b37: loop {
...
extern "C" fn spellfix1_resize_cursor(p_cur_1: *mut spellfix1_cursor,
    n_1: i32) -> () {
    let mut a_new: *mut spellfix1_row = core::ptr::null_mut();
    { let _ = 0; };
    a_new =
        unsafe {
                sqlite3_realloc64(unsafe { (*p_cur_1).a } as *mut (),
                    core::mem::size_of::<spellfix1_row>() as u64 * n_1 as u64)
...
extern "C" fn spellfix1_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut spellfix1_cursor = cur as *mut spellfix1_cursor;
...
extern "C" fn spellfix1_best_index(tab: *mut sqlite3_vtab,
...
extern "C" fn spellfix1_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let p: *mut spellfix1_vtab = p_v_tab_1 as *mut spellfix1_vtab;
    let mut p_cur: *mut spellfix1_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<spellfix1_cursor>() as
                        sqlite3_uint64)
            } as *mut spellfix1_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<spellfix1_cursor>() as u64)
    };
...
extern "C" fn spellfix1_row_compare(a_1: *const (), b_1: *const ()) -> i32 {
    let a: *const spellfix1_row = a_1 as *const spellfix1_row;
    let b: *const spellfix1_row = b_1 as *const spellfix1_row;
    return unsafe { (*a).i_score } - unsafe { (*b).i_score } as i32;
}
#[repr(C)]
#[derive(Copy, Clone)]
struct MatchQuery {
    p_cur: *mut spellfix1_cursor,
...
extern "C" fn spellfix1_run_query(p: &mut MatchQuery, z_query_1: *const i8,
    ...
    let p_cur: *mut spellfix1_cursor = (*p).p_cur;
    let p_stmt: *mut sqlite3_stmt = (*p).p_stmt;
...
extern "C" fn spellfix1_filter_for_match(p_cur_1: *mut spellfix1_cursor,
    argc: i32, argv: *const *mut sqlite3_value) -> i32 {
    ...
    '__b42: loop {
        '__c42: loop {
            ...
            let mut rc: i32 = 0;
            let mut idx: i32 = 1;
            let p: *mut spellfix1_vtab = unsafe { (*p_cur_1).p_v_tab };
            ...
            if !(unsafe { (*p_cur_1).a }).is_null() {
                unsafe {
                    qsort(unsafe { (*p_cur_1).a } as *mut (),
                        ...
                        core::mem::size_of::<spellfix1_row>() as u64,
...
extern "C" fn spellfix1_filter_for_full_scan(p_cur_1: *mut spellfix1_cursor,
    argc: i32, argv: *const *mut sqlite3_value) -> i32 {
    let mut rc: i32 = 0;
    let idx_num: i32 = unsafe { (*p_cur_1).idx_num };
    let mut z_sql: *mut i8 = core::ptr::null_mut();
    let p_v_tab: *const spellfix1_vtab =
        unsafe { (*p_cur_1).p_v_tab } as *const spellfix1_vtab;
    spellfix1_reset_cursor(unsafe { &mut *p_cur_1 });
    { let _ = 0; };
    z_sql =
        unsafe {
...
extern "C" fn spellfix1_filter(cur: *mut sqlite3_vtab_cursor, idx_num_1: i32,
    ...
    if idx_num_1 & 1 != 0 {
        rc =
            spellfix1_filter_for_match(p_cur, argc,
                argv as *const *mut sqlite3_value);
    } else {
        rc =
...
extern "C" fn spellfix1_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut spellfix1_cursor = cur as *mut spellfix1_cursor;
    let mut rc: i32 = 0;
...
extern "C" fn spellfix1_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const spellfix1_cursor =
        cur as *mut spellfix1_cursor as *const spellfix1_cursor;
    return (unsafe { (*p_cur).i_row } >= unsafe { (*p_cur).n_row }) as i32;
}
extern "C" fn spellfix1_column(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn spellfix1_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn spellfix1_update(p_v_tab_1: *mut sqlite3_vtab, argc: i32,
    argv: *mut *mut sqlite3_value, p_rowid_1: *mut sqlite_int64) -> i32 {
    let mut rc: i32 = 0;
    let mut rowid: sqlite3_int64 = 0 as sqlite3_int64;
    let mut new_rowid: sqlite3_int64 = 0 as sqlite3_int64;
    let p: *mut spellfix1_vtab = p_v_tab_1 as *mut spellfix1_vtab;
    let db: *mut sqlite3 = unsafe { (*p).db };
    if argc == 1 {
        rowid =
...
extern "C" fn spellfix1_rename(p_v_tab_1: *mut sqlite3_vtab,
...
static mut spellfix1_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
            ...
            rc =
                unsafe {
                    sqlite3_create_module(db,
                        ...
                        &raw mut spellfix1_module as *const sqlite3_module,
                        core::ptr::null_mut())
                };
        }
