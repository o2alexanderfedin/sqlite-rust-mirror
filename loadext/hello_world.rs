...
pub extern "C" fn sqlite3_auto_extension(x_init: unsafe extern "C" fn() -> ())
    ...
    unsafe {
        ...
        if rc != 0 {
            ...
            let mutex: *mut sqlite3_mutex = unsafe { sqlite3MutexAlloc(2) };
            unsafe { sqlite3_mutex_enter(mutex) };
            {
                i = 0 as u32;
                '__b0: loop {
                    if !(i < sqlite3_autoext.n_ext) { break '__b0; }
                    '__c0: loop {
                        if unsafe { *sqlite3_autoext.a_ext.add(i as usize) } ==
                                x_init {
                            break '__b0;
                        }
                        break '__c0;
            ...
            if i == sqlite3_autoext.n_ext {
                let n_byte: u64 =
                    ((sqlite3_autoext.n_ext + 1 as u32) as u64 *
                            core::mem::size_of::<unsafe extern "C" fn() -> ()>() as u64)
                        as u64;
                let mut a_new: *mut unsafe extern "C" fn() -> () =
                    core::ptr::null_mut();
                a_new =
                    unsafe {
                        core::mem::transmute::<*const (),
                                *mut unsafe extern "C" fn()
                                    ->
                                        ()>(unsafe {
                                    sqlite3_realloc64(sqlite3_autoext.a_ext as *mut (), n_byte)
                                } as *const ())
                    };
                if a_new == core::ptr::null_mut() {
                    rc = 7;
                } else {
                    sqlite3_autoext.a_ext = a_new;
                    unsafe {
                        *sqlite3_autoext.a_ext.add(sqlite3_autoext.n_ext as usize) =
                            x_init
                    };
                    {
                        let __p = &mut sqlite3_autoext.n_ext;
                        let __t = *__p;
                        *__p += 1;
                        __t
                    };
...
pub extern "C" fn sqlite3_cancel_auto_extension(x_init:
    ...
    unsafe {
        ...
        unsafe { sqlite3_mutex_enter(mutex) };
        {
            i = sqlite3_autoext.n_ext as i32 - 1;
            '__b1: loop {
                if !(i >= 0) { break '__b1; }
                '__c1: loop {
                    if unsafe { *sqlite3_autoext.a_ext.offset(i as isize) } ==
                            x_init {
                        {
                            let __p = &mut sqlite3_autoext.n_ext;
                            let __t = *__p;
                        ...
                        unsafe {
                            *sqlite3_autoext.a_ext.offset(i as isize) =
                                unsafe {
                                    *sqlite3_autoext.a_ext.add(sqlite3_autoext.n_ext as usize)
                                }
                        };
...
pub extern "C" fn sqlite3_reset_auto_extension() -> () {
    unsafe {
        if unsafe { sqlite3_initialize() } == 0 {
            let mutex: *mut sqlite3_mutex = unsafe { sqlite3MutexAlloc(2) };
            unsafe { sqlite3_mutex_enter(mutex) };
            unsafe { sqlite3_free(sqlite3_autoext.a_ext as *mut ()) };
            sqlite3_autoext.a_ext = core::ptr::null_mut();
            sqlite3_autoext.n_ext = 0 as u32;
            unsafe { sqlite3_mutex_leave(mutex) };
        }
    }
}
static sqlite3_apis: sqlite3_api_routines =
    sqlite3_api_routines {
        aggregate_context: Some(sqlite3_aggregate_context),
        aggregate_count: Some(sqlite3_aggregate_count),
        bind_blob: Some(sqlite3_bind_blob),
        bind_double: Some(sqlite3_bind_double),
        bind_int: Some(sqlite3_bind_int),
        bind_int64: Some(sqlite3_bind_int64),
        bind_null: Some(sqlite3_bind_null),
        bind_parameter_count: Some(sqlite3_bind_parameter_count),
        bind_parameter_index: Some(sqlite3_bind_parameter_index),
        bind_parameter_name: Some(sqlite3_bind_parameter_name),
        bind_text: Some(sqlite3_bind_text),
        bind_text16: Some(sqlite3_bind_text16),
        bind_value: Some(sqlite3_bind_value),
        busy_handler: Some(sqlite3_busy_handler),
        busy_timeout: Some(sqlite3_busy_timeout),
        changes: Some(sqlite3_changes),
        close: Some(sqlite3_close),
        collation_needed: Some(sqlite3_collation_needed),
        collation_needed16: Some(sqlite3_collation_needed16),
        column_blob: Some(sqlite3_column_blob),
        column_bytes: Some(sqlite3_column_bytes),
        column_bytes16: Some(sqlite3_column_bytes16),
        column_count: Some(sqlite3_column_count),
        column_database_name: None,
        column_database_name16: None,
        column_decltype: Some(sqlite3_column_decltype),
        column_decltype16: Some(sqlite3_column_decltype16),
        column_double: Some(sqlite3_column_double),
        column_int: Some(sqlite3_column_int),
        column_int64: Some(sqlite3_column_int64),
        column_name: Some(sqlite3_column_name),
        column_name16: Some(sqlite3_column_name16),
        column_origin_name: None,
        column_origin_name16: None,
        column_table_name: None,
        column_table_name16: None,
        column_text: Some(sqlite3_column_text),
        column_text16: Some(sqlite3_column_text16),
        column_type: Some(sqlite3_column_type),
        column_value: Some(sqlite3_column_value),
        commit_hook: Some(sqlite3_commit_hook),
        complete: Some(sqlite3_complete),
        complete16: Some(sqlite3_complete16),
        create_collation: Some(sqlite3_create_collation),
        create_collation16: Some(sqlite3_create_collation16),
        create_function: Some(sqlite3_create_function),
        create_function16: Some(sqlite3_create_function16),
        create_module: Some(sqlite3_create_module),
        data_count: Some(sqlite3_data_count),
        db_handle: Some(sqlite3_db_handle),
        declare_vtab: Some(sqlite3_declare_vtab),
        enable_shared_cache: Some(sqlite3_enable_shared_cache),
        errcode: Some(sqlite3_errcode),
        errmsg: Some(sqlite3_errmsg),
        errmsg16: Some(sqlite3_errmsg16),
        exec: Some(sqlite3_exec),
        expired: Some(sqlite3_expired),
        finalize: Some(sqlite3_finalize),
        free: Some(sqlite3_free),
        free_table: Some(sqlite3_free_table),
        get_autocommit: Some(sqlite3_get_autocommit),
        get_auxdata: Some(sqlite3_get_auxdata),
        get_table: Some(sqlite3_get_table),
        global_recover: None,
        interruptx: Some(sqlite3_interrupt),
        last_insert_rowid: Some(sqlite3_last_insert_rowid),
        libversion: Some(sqlite3_libversion),
        libversion_number: Some(sqlite3_libversion_number),
        malloc: Some(sqlite3_malloc),
        mprintf: Some(sqlite3_mprintf),
        open: Some(sqlite3_open),
        open16: Some(sqlite3_open16),
        prepare: Some(sqlite3_prepare),
        prepare16: Some(sqlite3_prepare16),
        profile: Some(sqlite3_profile),
        progress_handler: Some(sqlite3_progress_handler),
        realloc: Some(sqlite3_realloc),
        reset: Some(sqlite3_reset),
        result_blob: Some(sqlite3_result_blob),
        result_double: Some(sqlite3_result_double),
        result_error: Some(sqlite3_result_error),
        result_error16: Some(sqlite3_result_error16),
        result_int: Some(sqlite3_result_int),
        result_int64: Some(sqlite3_result_int64),
        result_null: Some(sqlite3_result_null),
        result_text: Some(sqlite3_result_text),
        result_text16: Some(sqlite3_result_text16),
        result_text16be: Some(sqlite3_result_text16be),
        result_text16le: Some(sqlite3_result_text16le),
        result_value: Some(sqlite3_result_value),
        rollback_hook: Some(sqlite3_rollback_hook),
        set_authorizer: Some(sqlite3_set_authorizer),
        set_auxdata: Some(sqlite3_set_auxdata),
        xsnprintf: Some(sqlite3_snprintf),
        step: Some(sqlite3_step),
        table_column_metadata: Some(sqlite3_table_column_metadata),
        thread_cleanup: Some(sqlite3_thread_cleanup),
        total_changes: Some(sqlite3_total_changes),
        trace: Some(sqlite3_trace),
        transfer_bindings: Some(sqlite3_transfer_bindings),
        update_hook: Some(sqlite3_update_hook),
        user_data: Some(sqlite3_user_data),
        value_blob: Some(sqlite3_value_blob),
        value_bytes: Some(sqlite3_value_bytes),
        value_bytes16: Some(sqlite3_value_bytes16),
        value_double: Some(sqlite3_value_double),
        value_int: Some(sqlite3_value_int),
        value_int64: Some(sqlite3_value_int64),
        value_numeric_type: Some(sqlite3_value_numeric_type),
        value_text: Some(sqlite3_value_text),
        value_text16: Some(sqlite3_value_text16),
        value_text16be: Some(sqlite3_value_text16be),
        value_text16le: Some(sqlite3_value_text16le),
        value_type: Some(sqlite3_value_type),
        vmprintf: Some(sqlite3_vmprintf),
        overload_function: Some(sqlite3_overload_function),
        prepare_v2: Some(sqlite3_prepare_v2),
        prepare16_v2: Some(sqlite3_prepare16_v2),
        clear_bindings: Some(sqlite3_clear_bindings),
        create_module_v2: Some(sqlite3_create_module_v2),
        bind_zeroblob: Some(sqlite3_bind_zeroblob),
        blob_bytes: Some(sqlite3_blob_bytes),
        blob_close: Some(sqlite3_blob_close),
        blob_open: Some(sqlite3_blob_open),
        blob_read: Some(sqlite3_blob_read),
        blob_write: Some(sqlite3_blob_write),
        create_collation_v2: Some(sqlite3_create_collation_v2),
        file_control: Some(sqlite3_file_control),
        memory_highwater: Some(sqlite3_memory_highwater),
        memory_used: Some(sqlite3_memory_used),
        mutex_alloc: Some(sqlite3_mutex_alloc),
        mutex_enter: Some(sqlite3_mutex_enter),
        mutex_free: Some(sqlite3_mutex_free),
        mutex_leave: Some(sqlite3_mutex_leave),
        mutex_try: Some(sqlite3_mutex_try),
        open_v2: Some(sqlite3_open_v2),
        release_memory: Some(sqlite3_release_memory),
        result_error_nomem: Some(sqlite3_result_error_nomem),
        result_error_toobig: Some(sqlite3_result_error_toobig),
        sleep: Some(sqlite3_sleep),
        soft_heap_limit: Some(sqlite3_soft_heap_limit),
        vfs_find: Some(sqlite3_vfs_find),
        vfs_register: Some(sqlite3_vfs_register),
        vfs_unregister: Some(sqlite3_vfs_unregister),
        xthreadsafe: Some(sqlite3_threadsafe),
        result_zeroblob: Some(sqlite3_result_zeroblob),
        result_error_code: Some(sqlite3_result_error_code),
        test_control: Some(sqlite3_test_control),
        randomness: Some(sqlite3_randomness),
        context_db_handle: Some(sqlite3_context_db_handle),
        extended_result_codes: Some(sqlite3_extended_result_codes),
        limit: Some(sqlite3_limit),
        next_stmt: Some(sqlite3_next_stmt),
        sql: Some(sqlite3_sql),
        status: Some(sqlite3_status),
        backup_finish: Some(sqlite3_backup_finish),
        backup_init: Some(sqlite3_backup_init),
        backup_pagecount: Some(sqlite3_backup_pagecount),
        backup_remaining: Some(sqlite3_backup_remaining),
        backup_step: Some(sqlite3_backup_step),
        compileoption_get: Some(sqlite3_compileoption_get),
        compileoption_used: Some(sqlite3_compileoption_used),
        create_function_v2: Some(sqlite3_create_function_v2),
        db_config: Some(sqlite3_db_config),
        db_mutex: Some(sqlite3_db_mutex),
        db_status: Some(sqlite3_db_status),
        extended_errcode: Some(sqlite3_extended_errcode),
        log: Some(sqlite3_log),
        soft_heap_limit64: Some(sqlite3_soft_heap_limit64),
        sourceid: Some(sqlite3_sourceid),
        stmt_status: Some(sqlite3_stmt_status),
        strnicmp: Some(sqlite3_strnicmp),
        unlock_notify: None,
        wal_autocheckpoint: Some(sqlite3_wal_autocheckpoint),
        wal_checkpoint: Some(sqlite3_wal_checkpoint),
        wal_hook: Some(sqlite3_wal_hook),
        blob_reopen: Some(sqlite3_blob_reopen),
        vtab_config: Some(sqlite3_vtab_config),
        vtab_on_conflict: Some(sqlite3_vtab_on_conflict),
        close_v2: Some(sqlite3_close_v2),
        db_filename: Some(sqlite3_db_filename),
        db_readonly: Some(sqlite3_db_readonly),
        db_release_memory: Some(sqlite3_db_release_memory),
        errstr: Some(sqlite3_errstr),
        stmt_busy: Some(sqlite3_stmt_busy),
        stmt_readonly: Some(sqlite3_stmt_readonly),
        stricmp: Some(sqlite3_stricmp),
        uri_boolean: Some(sqlite3_uri_boolean),
        uri_int64: Some(sqlite3_uri_int64),
        uri_parameter: Some(sqlite3_uri_parameter),
        xvsnprintf: Some(sqlite3_vsnprintf),
        wal_checkpoint_v2: Some(sqlite3_wal_checkpoint_v2),
        auto_extension: Some(sqlite3_auto_extension),
        bind_blob64: Some(sqlite3_bind_blob64),
        bind_text64: Some(sqlite3_bind_text64),
        cancel_auto_extension: Some(sqlite3_cancel_auto_extension),
        load_extension: Some(sqlite3_load_extension),
        malloc64: Some(sqlite3_malloc64),
        msize: Some(sqlite3_msize),
        realloc64: Some(sqlite3_realloc64),
        reset_auto_extension: Some(sqlite3_reset_auto_extension),
        result_blob64: Some(sqlite3_result_blob64),
        result_text64: Some(sqlite3_result_text64),
        strglob: Some(sqlite3_strglob),
        value_dup: Some(unsafe {
                core::mem::transmute::<*const (),
                        unsafe extern "C" fn(*const sqlite3_value)
                            -> *mut sqlite3_value>(sqlite3_value_dup as *const ())
            }),
        value_free: Some(sqlite3_value_free),
        result_zeroblob64: Some(sqlite3_result_zeroblob64),
        bind_zeroblob64: Some(sqlite3_bind_zeroblob64),
        value_subtype: Some(sqlite3_value_subtype),
        result_subtype: Some(sqlite3_result_subtype),
        status64: Some(sqlite3_status64),
        strlike: Some(sqlite3_strlike),
        db_cacheflush: Some(sqlite3_db_cacheflush),
        system_errno: Some(sqlite3_system_errno),
        trace_v2: Some(sqlite3_trace_v2),
        expanded_sql: Some(sqlite3_expanded_sql),
        set_last_insert_rowid: Some(sqlite3_set_last_insert_rowid),
        prepare_v3: Some(sqlite3_prepare_v3),
        prepare16_v3: Some(sqlite3_prepare16_v3),
        bind_pointer: Some(sqlite3_bind_pointer),
        result_pointer: Some(sqlite3_result_pointer),
        value_pointer: Some(sqlite3_value_pointer),
        vtab_nochange: Some(sqlite3_vtab_nochange),
        value_nochange: Some(sqlite3_value_nochange),
        vtab_collation: Some(sqlite3_vtab_collation),
        keyword_count: Some(sqlite3_keyword_count),
        keyword_name: Some(sqlite3_keyword_name),
        keyword_check: Some(sqlite3_keyword_check),
        str_new: Some(sqlite3_str_new),
        str_finish: Some(sqlite3_str_finish),
        str_appendf: Some(sqlite3_str_appendf),
        str_vappendf: Some(sqlite3_str_vappendf),
        str_append: Some(sqlite3_str_append),
        str_appendall: Some(sqlite3_str_appendall),
        str_appendchar: Some(sqlite3_str_appendchar),
        str_reset: Some(sqlite3_str_reset),
        str_errcode: Some(sqlite3_str_errcode),
        str_length: Some(sqlite3_str_length),
        str_value: Some(sqlite3_str_value),
        create_window_function: Some(sqlite3_create_window_function),
        normalized_sql: None,
        stmt_isexplain: Some(sqlite3_stmt_isexplain),
        value_frombind: Some(sqlite3_value_frombind),
        drop_modules: Some(sqlite3_drop_modules),
        hard_heap_limit64: Some(sqlite3_hard_heap_limit64),
        uri_key: Some(sqlite3_uri_key),
        filename_database: Some(sqlite3_filename_database),
        filename_journal: Some(sqlite3_filename_journal),
        filename_wal: Some(sqlite3_filename_wal),
        create_filename: Some(sqlite3_create_filename),
        free_filename: Some(sqlite3_free_filename),
        database_file_object: Some(sqlite3_database_file_object),
        txn_state: Some(sqlite3_txn_state),
        changes64: Some(sqlite3_changes64),
        total_changes64: Some(sqlite3_total_changes64),
        autovacuum_pages: Some(sqlite3_autovacuum_pages),
        error_offset: Some(sqlite3_error_offset),
        vtab_rhs_value: Some(sqlite3_vtab_rhs_value),
        vtab_distinct: Some(sqlite3_vtab_distinct),
        vtab_in: Some(sqlite3_vtab_in),
        vtab_in_first: Some(sqlite3_vtab_in_first),
        vtab_in_next: Some(sqlite3_vtab_in_next),
        deserialize: Some(sqlite3_deserialize),
        serialize: Some(sqlite3_serialize),
        db_name: Some(sqlite3_db_name),
        value_encoding: Some(sqlite3_value_encoding),
        is_interrupted: Some(sqlite3_is_interrupted),
        stmt_explain: Some(sqlite3_stmt_explain),
        get_clientdata: Some(sqlite3_get_clientdata),
        set_clientdata: Some(sqlite3_set_clientdata),
        setlk_timeout: Some(sqlite3_setlk_timeout),
        set_errmsg: Some(sqlite3_set_errmsg),
        db_status64: Some(sqlite3_db_status64),
        str_truncate: Some(sqlite3_str_truncate),
        str_free: Some(sqlite3_str_free),
        carray_bind: None,
        carray_bind_v2: None,
...
extern "C" fn sqlite3_load_extension_2(db: *mut sqlite3, z_file_1: *const i8,
    ...
    unsafe {
        let mut p_vfs: *mut sqlite3_vfs = core::ptr::null_mut();
        let mut handle: *mut () = core::ptr::null_mut();
        let mut x_init:
                Option<unsafe extern "C" fn(*mut sqlite3, *mut *mut i8,
                    *const sqlite3_api_routines) -> i32> = None;
        let mut z_errmsg: *mut i8 = core::ptr::null_mut();
        let mut z_entry: *const i8 = core::ptr::null();
        let mut z_alt_entry: *mut i8 = core::ptr::null_mut();
        let mut a_handle: *mut *mut () = core::ptr::null_mut();
        ...
        loop {
            ...
            '__s3:
                {
                match __state {
                    0 => { p_vfs = unsafe { (*db).p_vfs }; __state = 3; }
                    2 => {
                    ...
                    3 => { __state = 4; }
                    4 => { __state = 5; }
                    5 => { z_errmsg = core::ptr::null_mut(); __state = 6; }
                    6 => { __state = 7; }
                    7 => { z_alt_entry = core::ptr::null_mut(); __state = 8; }
                    8 => { __state = 9; }
                    9 => {
                        n_msg = unsafe { strlen(z_file_1) } as u64;
                        __state = 10;
                    }
                    10 => { __state = 11; }
                    11 => { __state = 12; }
                    ...
                    14 => {
                        if unsafe { (*db).flags } & 65536 as u64 == 0 as u64 {
                            __state = 17;
                        } else { __state = 16; }
                    }
                    15 => {
                        unsafe { *pz_err_msg_1 = core::ptr::null_mut() };
                        __state = 14;
                    }
                    16 => {
                        z_entry =
                            if !(z_proc_1).is_null() {
                                ...
                                c"sqlite3_extension_init".as_ptr() as *mut i8 as *const i8
                            };
                        __state = 20;
                    }
                    17 => {
                    ...
                    19 => {
                        unsafe {
                            *pz_err_msg_1 =
                                unsafe {
                                    sqlite3_mprintf(c"not authorized".as_ptr() as *mut i8 as
                                            *const i8)
                                }
                        };
                        __state = 18;
                    ...
                    22 => { __state = 2; }
                    23 => {
                        handle = unsafe { sqlite3_os_dl_open(p_vfs, z_file_1) };
                        __state = 25;
                    }
                    24 => { __state = 2; }
                    25 => { ii = 0; __state = 27; }
                        ...
                        z_alt_file =
                            unsafe {
                                sqlite3_mprintf(c"%s.%s".as_ptr() as *mut i8 as *const i8,
                                    z_file_1, az_endings[ii as usize])
                            };
                        __state = 30;
                    }
                    29 => {
                    ...
                    30 => {
                        if z_alt_file == core::ptr::null_mut() {
                            __state = 32;
                        } else { __state = 31; }
                    }
                    31 => {
                        if n_msg + unsafe { strlen(az_endings[ii as usize]) } as u64
                                    + 1 as u64 <= 1024 as u64 {
                            __state = 34;
                        } else { __state = 33; }
                    }
                    32 => { return 7; }
                    33 => {
                        unsafe { sqlite3_free(z_alt_file as *mut ()) };
                        __state = 29;
                    }
                    34 => {
                        handle =
                            unsafe {
                                sqlite3_os_dl_open(p_vfs, z_alt_file as *const i8)
                            };
                        __state = 33;
                    }
                    35 => {
                                    ...
                                    core::mem::transmute::<*const (),
                                            unsafe extern "C" fn(*mut sqlite3, *mut *mut i8,
                                                *const sqlite3_api_routines)
                                                ->
                                                    i32>(unsafe { sqlite3_os_dl_sym(p_vfs, handle, z_entry) } as
                                            *const ())
                                });
                        __state = 37;
                    }
                    36 => { __state = 2; }
                    37 => {
                        if !x_init.is_some() as i32 != 0 &&
                                z_proc_1 == core::ptr::null() {
                            __state = 39;
                        } else { __state = 38; }
                    }
                    38 => {
                    ...
                    39 => { __state = 40; }
                    40 => {
                        nc_file = unsafe { sqlite3_strlen30(z_file_1) };
                        __state = 41;
                    }
                    41 => { cnt = 0; __state = 42; }
                    42 => {
                        z_alt_entry =
                            unsafe {
                                    sqlite3_malloc64((nc_file + 30) as sqlite3_uint64)
                                } as *mut i8;
                        __state = 43;
                    }
                    43 => {
                        if z_alt_entry == core::ptr::null_mut() {
                            __state = 45;
                        } else { __state = 44; }
                    }
                    44 => {
                        unsafe {
                            memcpy(z_alt_entry as *mut (),
                                c"sqlite3_".as_ptr() as *mut i8 as *const (), 8 as u64)
                        };
                        __state = 48;
                    }
                    45 => {
                        unsafe { sqlite3_os_dl_close(p_vfs, handle) };
                        __state = 46;
                    }
                    46 => { return 7; }
                    47 => {
                        if !x_init.is_some() as i32 != 0 &&
                                { let __p = &mut cnt; *__p += 1; *__p } < 2 {
                            __state = 44;
                        } else { __state = 38; }
                    }
                    48 => { i_file = nc_file - 1; __state = 50; }
                    49 => {
                    ...
                    50 => {
                        if i_file >= 0 &&
                                !(unsafe { *z_file_1.offset(i_file as isize) } as i32 ==
                                                '/' as i32) as i32 != 0 {
                            __state = 51;
                        } else { __state = 49; }
                    }
                    ...
                    53 => {
                        if unsafe {
                                    sqlite3_strnicmp(unsafe {
                                            z_file_1.offset(i_file as isize)
                                        }, c"lib".as_ptr() as *mut i8 as *const i8, 3)
                                } == 0 {
                            __state = 55;
                        } else { __state = 54; }
                    }
                    54 => { i_entry = 8; __state = 57; }
                    55 => { i_file += 3; __state = 54; }
                    56 => {
                        unsafe {
                            memcpy(unsafe { z_alt_entry.offset(i_entry as isize) } as
                                    *mut (), c"_init".as_ptr() as *mut i8 as *const (),
                                6 as u64)
                        };
                        __state = 61;
                    }
                    57 => {
                        if {
                                        c = unsafe { *z_file_1.offset(i_file as isize) } as i32;
                                        c
                                    } != 0 && c != '.' as i32 {
                            __state = 58;
                        } else { __state = 56; }
                            ...
                            *z_alt_entry.offset({
                                ...
                                unsafe {
                                        *(sqlite3_upper_to_lower.as_ptr() as
                                                    *const u8).add(c as u32 as usize)
                                    } as i8
                        };
                        __state = 59;
                    }
                    61 => { z_entry = z_alt_entry as *const i8; __state = 62; }
                    62 => {
                        x_init =
                            Some(unsafe {
                                    core::mem::transmute::<*const (),
                    ...
                    63 => {
                        unsafe { sqlite3_free(z_alt_entry as *mut ()) };
                        __state = 74;
                    }
                    64 => {
                        if !(pz_err_msg_1).is_null() {
                    ...
                    66 => {
                        n_msg += (unsafe { strlen(z_entry) } + 300 as u64) as u64;
                        __state = 67;
                    }
                    67 => {
                        unsafe {
                            *pz_err_msg_1 =
                                {
                                    z_errmsg = unsafe { sqlite3_malloc64(n_msg) } as *mut i8;
                                    z_errmsg
                                }
                        };
                        __state = 68;
                    ...
                    70 => {
                        unsafe {
                            sqlite3_snprintf(n_msg as i32, z_errmsg,
                                c"no entry point [%s] in shared library [%s]".as_ptr() as
                                        *mut i8 as *const i8, z_entry, z_file_1)
                        };
                        __state = 71;
                    }
                    71 => {
                        unsafe {
                            sqlite3_os_dl_error(p_vfs, (n_msg - 1 as u64) as i32,
                                z_errmsg)
                        };
                        __state = 65;
                    }
                    ...
                    74 => {
                        rc =
                            unsafe {
                                x_init.unwrap()(db, &mut z_errmsg, &sqlite3_apis)
                            };
                        __state = 75;
                    }
                    75 => {
                        ...
                        a_handle =
                            unsafe {
                                    sqlite3_db_malloc_zero(db,
                                        core::mem::size_of::<*mut ()>() as u64 *
                                            (unsafe { (*db).n_extension } + 1) as u64)
                                } as *mut *mut ();
                        __state = 84;
                    }
                    77 => {
                        if rc == 0 | 1 << 8 { __state = 79; } else { __state = 78; }
                    }
                    78 => {
                        if !(pz_err_msg_1).is_null() {
                            __state = 81;
                    ...
                    79 => { return 0; }
                    80 => {
                        unsafe { sqlite3_free(z_errmsg as *mut ()) };
                        __state = 82;
                    }
                    81 => {
                        unsafe {
                            *pz_err_msg_1 =
                                unsafe {
                                    sqlite3_mprintf(c"error during initialization: %s".as_ptr()
                                                as *mut i8 as *const i8, z_errmsg)
                                }
                        };
                        __state = 80;
                    }
                    ...
                    83 => { return 1; }
                    84 => {
                        if a_handle == core::ptr::null_mut() {
                            __state = 86;
                        } else { __state = 85; }
                    }
                    85 => {
                        if unsafe { (*db).n_extension } > 0 {
                            __state = 88;
                        } else { __state = 87; }
                    }
                    86 => { return 7; }
                    87 => {
                        unsafe {
                            sqlite3_db_free(db, unsafe { (*db).a_extension } as *mut ())
                        };
                        __state = 89;
                    }
                    88 => {
                        unsafe {
                            memcpy(a_handle as *mut (),
                                unsafe { (*db).a_extension } as *const (),
                                core::mem::size_of::<*mut ()>() as u64 *
                                    unsafe { (*db).n_extension } as u64)
                        };
                        __state = 87;
                    }
                    89 => {
                        unsafe { (*db).a_extension = a_handle };
                        __state = 90;
                    }
                    90 => {
                        unsafe {
                            *unsafe {
                                        (*db).a_extension.offset({
                                                    let __p = unsafe { &mut (*db).n_extension };
                                                    let __t = *__p;
                                                    *__p += 1;
                                                    __t
                                                } as isize)
                    ...
                    92 => { __state = 2; }
                    93 => { return 1; }
                    94 => { n_msg += 300 as u64; __state = 95; }
                    95 => {
                        unsafe {
                            *pz_err_msg_1 =
                                {
                    ...
                    97 => { { let _ = 0; }; __state = 98; }
                    98 => {
                        unsafe {
                            sqlite3_snprintf(n_msg as i32, z_errmsg,
                                c"unable to open shared library [%.*s]".as_ptr() as *mut i8
                                    as *const i8, 1024, z_file_1)
                        };
                        __state = 99;
                    }
                    99 => {
...
pub extern "C" fn sqlite3_load_extension(db: *mut sqlite3,
    ...
    rc = sqlite3_load_extension_2(db, z_file_1, z_proc_1, pz_err_msg_1);
...
pub extern "C" fn sqlite3_enable_load_extension(db: &mut sqlite3, onoff: i32)
    ...
    if onoff != 0 {
        (*db).flags |= (65536 | 131072) as u64;
    } else { (*db).flags &= !((65536 | 131072) as u64); }
    ...
    unsafe {
        ...
        if sqlite3_autoext.n_ext == 0 as u32 { return; }
        {
            ...
            '__b4: loop {
                ...
                '__c4: loop {
                    let mut z_errmsg: *mut i8 = core::ptr::null_mut();
                    let mutex: *mut sqlite3_mutex =
                        unsafe { sqlite3MutexAlloc(2) };
                    let p_thunk: *const sqlite3_api_routines = &sqlite3_apis;
                    unsafe { sqlite3_mutex_enter(mutex) };
                    if i >= sqlite3_autoext.n_ext {
                        x_init = None;
                        go = 0;
                            ...
                            Some(unsafe {
                                    core::mem::transmute::<*const (),
                                            unsafe extern "C" fn(*mut sqlite3, *mut *mut i8,
                                                *const sqlite3_api_routines)
                                                ->
                                                    i32>(unsafe { *sqlite3_autoext.a_ext.add(i as usize) } as
                                            *const ())
                                });
                    }
                    unsafe { sqlite3_mutex_leave(mutex) };
                    z_errmsg = core::ptr::null_mut();
                    if x_init.is_some() &&
                            {
                                    rc = unsafe { x_init.unwrap()(db, &mut z_errmsg, p_thunk) };
                                    rc
                                } != 0 {
                        unsafe {
                            sqlite3_error_with_msg(db, rc,
                                c"automatic extension loading failed: %s".as_ptr() as
                                        *mut i8 as *const i8, z_errmsg)
                        };
                        go = 0;
                    }
                    unsafe { sqlite3_free(z_errmsg as *mut ()) };
...
pub extern "C" fn sqlite3_close_extensions(db: *mut sqlite3) -> () {
    ...
    { let _ = 0; };
    {
        i = 0;
        '__b5: loop {
            if !(i < unsafe { (*db).n_extension }) { break '__b5; }
            '__c5: loop {
                unsafe {
                    sqlite3_os_dl_close(unsafe { (*db).p_vfs },
                        unsafe { *unsafe { (*db).a_extension.offset(i as isize) } })
                };
                break '__c5;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
...
extern "C" {
    ...
    _: unsafe extern "C" fn(*mut (), i32) -> i32, _: *mut ())
    -> i32;
    ...
    x_auth_1:
        unsafe extern "C" fn(*mut (), i32, *const i8, *const i8, *const i8,
            *const i8) -> i32, p_user_data_1: *mut ())
    -> i32;
    fn sqlite3_trace(_: *mut sqlite3,
    x_trace_1: unsafe extern "C" fn(*mut (), *const i8) -> (), _: *mut ())
    -> *mut ();
    fn sqlite3_profile(_: *mut sqlite3,
    x_profile_1: unsafe extern "C" fn(*mut (), *const i8, u64) -> (),
    _: *mut ())
    -> *mut ();
    fn sqlite3_trace_v2(_: *mut sqlite3, u_mask_1: u32,
    x_callback_1: unsafe extern "C" fn(u32, *mut (), *mut (), *mut ()) -> i32,
    p_ctx_1: *mut ())
    -> i32;
    fn sqlite3_progress_handler(_: *mut sqlite3, _: i32,
    _: unsafe extern "C" fn(*mut ()) -> i32, _: *mut ())
    -> ();
    ...
    _: unsafe extern "C" fn(*mut ()) -> ())
    -> i32;
    fn sqlite3_bind_blob64(_: *mut sqlite3_stmt, _: i32, _: *const (),
    _: sqlite3_uint64, _: unsafe extern "C" fn(*mut ()) -> ())
    -> i32;
    ...
    x_step_1:
        unsafe extern "C" fn(*mut sqlite3_context, i32,
            *mut *mut sqlite3_value) -> (),
    x_final_1: unsafe extern "C" fn(*mut sqlite3_context) -> ())
    -> i32;
    ...
    x_step_1:
        unsafe extern "C" fn(*mut sqlite3_context, i32,
            *mut *mut sqlite3_value) -> (),
    x_final_1: unsafe extern "C" fn(*mut sqlite3_context) -> (),
    x_destroy_1: unsafe extern "C" fn(*mut ()) -> ())
    -> i32;
    ...
    x_step_1:
        unsafe extern "C" fn(*mut sqlite3_context, i32,
            *mut *mut sqlite3_value) -> (),
    x_final_1: unsafe extern "C" fn(*mut sqlite3_context) -> (),
    x_value_1: unsafe extern "C" fn(*mut sqlite3_context) -> (),
    x_inverse_1:
        unsafe extern "C" fn(*mut sqlite3_context, i32,
            *mut *mut sqlite3_value) -> (),
    x_destroy_1: unsafe extern "C" fn(*mut ()) -> ())
    ...
    n: sqlite3_uint64, _: unsafe extern "C" fn(*mut ()) -> (), encoding: u8)
    -> ();
    ...
    _: unsafe extern "C" fn(*mut (), *mut sqlite3, i32, *const i8) -> ())
    -> i32;
    fn sqlite3_collation_needed16(_: *mut sqlite3, _: *mut (),
    _: unsafe extern "C" fn(*mut (), *mut sqlite3, i32, *const ()) -> ())
    -> i32;
    ...
    _: unsafe extern "C" fn(*mut ()) -> (), _: *mut ())
    -> *mut ();
    fn sqlite3_autovacuum_pages(db: *mut sqlite3,
    _: unsafe extern "C" fn(*mut (), *const i8, u32, u32, u32) -> u32,
    _: *mut (), _: unsafe extern "C" fn(*mut ()) -> ())
    -> i32;
    fn sqlite3_update_hook(_: *mut sqlite3,
    _: unsafe extern "C" fn(*mut (), i32, *const i8, *const i8, i64) -> (),
    _: *mut ())
    -> *mut ();
    ...
    _: unsafe extern "C" fn(*mut (), *mut sqlite3, *const i8, i32) -> i32,
    _: *mut ())
    -> *mut ();
