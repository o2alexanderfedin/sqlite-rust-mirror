...
extern "C" fn templatevtab_connect(db: *mut Sqlite3, p_aux_1: *mut (),
    ...
    let mut p_new: *mut TemplatevtabVtab = core::ptr::null_mut();
    let mut rc: i32 = 0;
    rc =
        unsafe {
    ...
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<TemplatevtabVtab>() as
                            Sqlite3Uint64)
                } as *mut TemplatevtabVtab;
        unsafe { *pp_vtab_1 = p_new as *mut Sqlite3Vtab };
        if p_new == core::ptr::null_mut() { return 7; }
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<TemplatevtabVtab>() as u64)
        };
    }
    return rc;
}
...
extern "C" fn templatevtab_open(p: *mut Sqlite3Vtab,
    ...
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<TemplatevtabCursor>() as
                        Sqlite3Uint64)
            } as *mut TemplatevtabCursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<TemplatevtabCursor>() as u64)
    };
            ...
            0 => {
                unsafe {
                    sqlite3_result_int(ctx,
                        (1000 as Sqlite3Int64 + unsafe { (*p_cur).i_rowid }) as i32)
                };
            }
            _ => {
                ...
                unsafe {
                    sqlite3_result_int(ctx,
                        (2000 as Sqlite3Int64 + unsafe { (*p_cur).i_rowid }) as i32)
                };
            }
        }
    }
...
extern "C" fn templatevtab_filter(p_vtab_cursor_1: *mut Sqlite3VtabCursor,
    ...
    let p_cur: *mut TemplatevtabCursor =
        p_vtab_cursor_1 as *mut TemplatevtabCursor;
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut templatevtab_module as *const Sqlite3Module,
                    core::ptr::null_mut())
            };
        return rc;
    }
