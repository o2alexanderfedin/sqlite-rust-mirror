                    ...
                    '__b38: loop {
                        ...
                        '__c38: loop {
                            ...
                            if i >= n_pk &&
                                ...
                                a_delta =
                                    unsafe {
                                            sqlite3_malloc64((n_final + 60 as i64) as Sqlite3Uint64)
                                        } as *mut i8;
                                n_delta =
        ...
        loop {
            ...
            '__s41:
                ...
                match __state {
                    ...
                    82 => { __state = 2; }
                    83 => { n_update = 0 as Sqlite3Int64; __state = 84; }
                    84 => { n_insert = 0 as Sqlite3Int64; __state = 85; }
                    85 => { n_delete = 0 as Sqlite3Int64; __state = 86; }
                    86 => { n_unchanged = 0 as Sqlite3Int64; __state = 87; }
                    87 => {
                        if 100 == unsafe { sqlite3_step(p_stmt) } {
                            __state = 89;
                        } else { __state = 88; }
...
extern "C" fn puts_varint(out: *mut FILE, mut v: Sqlite3Uint64) -> () {
    ...
    if v & (4278190080u32 as Sqlite3Uint64) << 32 != 0 {
        ...
        v >>= 8 as Sqlite3Uint64;
        {
            ...
            '__b43: loop {
                ...
                '__c43: loop {
                    p[i as usize] =
                        (v & 127 as Sqlite3Uint64 | 128 as Sqlite3Uint64) as u8;
                    v >>= 7 as Sqlite3Uint64;
                    break '__c43;
                }
                { let __p = &mut i; let __t = *__p; *__p -= 1; __t };
            }
...
extern "C" fn put_value(out: *mut FILE, p_stmt_1: *mut Sqlite3Stmt, k: i32)
    ...
    let mut r_x: f64 = 0.0;
    let mut u_x: Sqlite3Uint64 = 0 as Sqlite3Uint64;
    let mut j: i32 = 0;
            ...
            1 => {
                ...
                };
                {
                    ...
                    '__b46: loop {
                        ...
                        '__c46: loop {
                            unsafe {
                                putc((u_x >> j & 255 as Sqlite3Uint64) as i32, out)
                            };
                            break '__c46;
                        }
                        j -= 8;
            ...
            3 => {
                i_x =
                    unsafe { sqlite3_column_bytes(p_stmt_1, k) } as
                        Sqlite3Int64;
                puts_varint(out, i_x as Sqlite3Uint64);
                unsafe {
        ...
        loop {
            ...
            '__s49:
                ...
                match __state {
                    ...
                    102 => { __state = 2; }
                    103 => {
                        puts_varint(out, n_col as Sqlite3Uint64);
                        __state = 104;
                    }
                    104 => { i = 0; __state = 106; }
                    105 => {
...
extern "C" fn __main_inner(argc: i32, argv: *const *mut i8)
    ...
    unsafe {
        ...
        let mut x_diff:
                Option<unsafe extern "C" fn(*const i8, *mut SFILE) -> ()> =
            Some(diff_one_table);
