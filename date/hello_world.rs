...
extern "C" fn set_date_time_to_current(context: *mut sqlite3_context,
    p: *mut DateTime) -> i32 {
...
extern "C" fn set_raw_date_number(p: &mut DateTime, r: f64) -> () {
    ...
    if r >= 0.0 && r < 5373484.5 {
        (*p).i_jd = (r * 86400000.0 + 0.5) as sqlite3_int64;
        (*p).valid_jd = 1 as i8;
    }
}
            ...
            unsafe {
                (*p).i_jd +=
                    (unsafe { (*p).h } * 3600000 + unsafe { (*p).m } * 60000) as
                            sqlite3_int64 +
                        (unsafe { (*p).s } * 1000 as f64 + 0.5) as sqlite3_int64
            };
            if unsafe { (*p).tz } != 0 {
                unsafe {
                    (*p).i_jd -= (unsafe { (*p).tz } * 60000) as sqlite3_int64
                };
...
extern "C" fn parse_date_or_time(context: *mut sqlite3_context,
...
extern "C" fn auto_adjust_date(p: *mut DateTime) -> () {
    if (unsafe { (*p).raw_s() } == 0) as i32 != 0 ||
        ...
        unsafe { (*p).i_jd = (r + 0.5) as sqlite3_int64 };
        unsafe { (*p).valid_jd = 1 as i8 };
        unsafe { (*p).set_raw_s(0 as u32 as u32) };
    }
}
extern "C" fn valid_julian_day(i_jd_1: sqlite3_int64) -> i32 {
...
extern "C" fn compute_ymd(p: *mut DateTime) -> () {
    unsafe {
        ...
        if (unsafe { (*p).valid_jd } == 0) as i32 != 0 {
            ...
            z =
                ((unsafe { (*p).i_jd } + 43200000 as sqlite3_int64) /
                        86400000 as sqlite3_int64) as i32;
...
extern "C" fn os_localtime(t: *const time_t, p_tm_1: *mut tm) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        ...
        rc =
            (unsafe { localtime_r(t as *const time_t, p_tm_1) } ==
                    core::ptr::null_mut()) as i32;
        return rc;
    }
}
extern "C" fn to_localtime(p: *mut DateTime, p_ctx_1: *mut sqlite3_context)
    -> i32 {
    unsafe {
        ...
        if unsafe { (*p).i_jd } < 2108667600 as i64 * 100000 as i64 ||
            ...
            compute_jd(&mut x);
            t =
                (x.i_jd / 1000 as sqlite3_int64 -
                        21086676 as i64 * 10000 as i64) as time_t;
        } else {
            i_year_diff = 0;
            t =
                (unsafe { (*p).i_jd } / 1000 as sqlite3_int64 -
                        21086676 as i64 * 10000 as i64) as time_t;
        }
        if os_localtime(&raw mut t as *const time_t, &mut s_local) != 0 {
            unsafe {
        ...
        unsafe {
            (*p).s =
                s_local.tm_sec as f64 +
                    (unsafe { (*p).i_jd } % 1000 as sqlite3_int64) as f64 *
                        0.001
        };
        unsafe { (*p).valid_ymd = 1 as i8 };
        unsafe { (*p).valid_hms = 1 as i8 };
...
extern "C" fn parse_modifier(p_ctx_1: *mut sqlite3_context, mut z: *const i8,
                    ...
                    97 => {
                        ...
                        }
                        {
                            if unsafe {
                                ...
                                unsafe {
                                    (*p).i_jd -=
                                        (unsafe { (*p).n_floor } as i32 * 86400000) as sqlite3_int64
                                };
                                clear_ymd_hms_tz(unsafe { &mut *p });
                                rc = 0;
                            }
                        ...
                        }
                        {
                            if unsafe {
                                ...
                                let mut z: sqlite3_int64 = 0 as sqlite3_int64;
                                compute_ymd_hms(p);
                                unsafe { (*p).tz = 0 };
                                unsafe { (*p).valid_jd = 0 as i8 };
                                compute_jd(p);
                                z =
                                    (unsafe { (*p).i_jd } + 129600000 as sqlite3_int64) /
                                            86400000 as sqlite3_int64 % 7 as sqlite3_int64;
                                if z > n as i64 { z -= 7 as sqlite3_int64; }
                                unsafe {
                                    (*p).i_jd +=
                                        (n as sqlite3_int64 - z) * 86400000 as sqlite3_int64
                                };
                                clear_ymd_hms_tz(unsafe { &mut *p });
                                rc = 0;
                            }
                        ...
                        }
                        {
                            ...
                            if unsafe { *z2.offset(n as isize) } as i32 == ':' as i32 {
                                ...
                                let mut day: sqlite3_int64 = 0 as sqlite3_int64;
                                if (unsafe {
                                                            *(sqlite3_ctype_map.as_ptr() as
                                ...
                                compute_jd(&mut tx);
                                tx.i_jd -= 43200000 as sqlite3_int64;
                                day = tx.i_jd / 86400000 as sqlite3_int64;
                                tx.i_jd -= day * 86400000 as sqlite3_int64;
                            ...
                            unsafe { (*p).n_floor = 0 as i8 };
                            {
                                ...
                                '__b10: loop {
                                    if !(i <
                                                    (core::mem::size_of::<[anon_s0; 6]>() as u64 / 16) as i32) {
                                        break '__b10;
                                    }
                                    '__c10: loop {
...
extern "C" fn is_date(context: *mut sqlite3_context, argc: i32,
    argv: *const *mut sqlite3_value, p: *mut DateTime) -> i32 {
    unsafe {
        let mut i: i32 = 0;
        let mut n: i32 = 0;
...
extern "C" fn julianday_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut x: DateTime = unsafe { core::mem::zeroed() };
    if is_date(context, argc, argv as *const *mut sqlite3_value, &mut x) == 0
        {
        compute_jd(&mut x);
        unsafe { sqlite3_result_double(context, x.i_jd as f64 / 86400000.0) };
    }
}
extern "C" fn unixepoch_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut x: DateTime = unsafe { core::mem::zeroed() };
    if is_date(context, argc, argv as *const *mut sqlite3_value, &mut x) == 0
        {
...
extern "C" fn date_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut x: DateTime = unsafe { core::mem::zeroed() };
        if is_date(context, argc, argv as *const *mut sqlite3_value, &mut x)
                == 0 {
            let mut y: i32 = 0;
...
extern "C" fn time_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut x: DateTime = unsafe { core::mem::zeroed() };
    if is_date(context, argc, argv as *const *mut sqlite3_value, &mut x) == 0
        {
...
extern "C" fn datetime_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut x: DateTime = unsafe { core::mem::zeroed() };
        if is_date(context, argc, argv as *const *mut sqlite3_value, &mut x)
...
extern "C" fn days_after_monday(p_date_1: &DateTime) -> i32 {
    { let _ = 0; };
    return (((*p_date_1).i_jd + 43200000 as sqlite3_int64) /
                    86400000 as sqlite3_int64) as i32 % 7;
}
extern "C" fn days_after_jan01(p_date_1: &DateTime) -> i32 {
    unsafe {
        ...
        return (((*p_date_1).i_jd - jan01.i_jd + 43200000 as sqlite3_int64) /
                    86400000 as sqlite3_int64) as i32;
    }
}
extern "C" fn days_after_sunday(p_date_1: &DateTime) -> i32 {
    { let _ = 0; };
    return (((*p_date_1).i_jd + 129600000 as sqlite3_int64) /
                    86400000 as sqlite3_int64) as i32 % 7;
}
extern "C" fn strftime_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut x: DateTime = unsafe { core::mem::zeroed() };
        ...
        let mut p_res: *mut sqlite3_str = core::ptr::null_mut();
        if argc == 0 { return; }
        z_fmt =
        ...
        if z_fmt == core::ptr::null() ||
                is_date(context, argc - 1,
                        unsafe { argv.offset(1 as isize) } as
                            *const *mut sqlite3_value, &mut x) != 0 {
            return;
        }
                        ...
                        match cf {
                            100 => {
                                ...
                                }
                                {
                                    ...
                                    { let _ = 0; };
                                    y.i_jd +=
                                        ((3 - days_after_monday(&x)) * 86400000) as sqlite3_int64;
                                    y.valid_ymd = 0 as i8;
                                    compute_ymd(&mut y);
...
extern "C" fn timediff_func(context: *mut sqlite3_context, not_used1_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        ...
        let mut s_res: sqlite3_str = unsafe { core::mem::zeroed() };
        { let _ = not_used1_1; };
        if is_date(context, 1,
                    unsafe { &raw mut *argv.offset(0 as isize) } as
                        *const *mut sqlite3_value, &mut d1) != 0 {
            return;
        }
        if is_date(context, 1,
                    unsafe { &raw mut *argv.offset(1 as isize) } as
                        *const *mut sqlite3_value, &mut d2) != 0 {
            return;
        }
        ...
        if d1.i_jd >= d2.i_jd {
            ...
            d1.i_jd -= d2.i_jd;
            d1.i_jd += (1486995408 as u64 * 100000 as u64) as sqlite3_int64;
        } else {
            sign = '-' as i32 as i8;
            y = d2.y - d1.y;
            if y != 0 {
...
extern "C" fn ctime_func(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    time_func(context, 0, core::ptr::null_mut());
}
extern "C" fn ctimestamp_func(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
    datetime_func(context, 0, core::ptr::null_mut());
}
extern "C" fn cdate_func(context: *mut sqlite3_context, not_used_1: i32,
    not_used2_1: *mut *mut sqlite3_value) -> () {
    { { let _ = not_used_1; }; { let _ = not_used2_1; } };
...
extern "C" {
    ...
    fn localtime_r(_: *const time_t, _: *mut tm)
    -> *mut tm;
