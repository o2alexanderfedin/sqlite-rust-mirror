...
pub extern "C" fn sqlite3_vtab_module_unref(db: *mut sqlite3,
    ...
    { let _ = 0; };
    {
        let __p = unsafe { &mut (*p_mod_1).n_ref_module };
        let __t = *__p;
        *__p -= 1;
        __t
    };
    if unsafe { (*p_mod_1).n_ref_module } == 0 {
        if unsafe { (*p_mod_1).x_destroy.is_some() } {
            unsafe {
                (unsafe {
                        (*p_mod_1).x_destroy.unwrap()
                    })(unsafe { (*p_mod_1).p_aux })
            };
        }
        { let _ = 0; };
        unsafe { sqlite3_db_free(db, p_mod_1 as *mut ()) };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_create_module(db: *mut sqlite3,
    z_name_1: *const i8, p_module_1: *const sqlite3_module, p_aux_1: *mut (),
    x_destroy_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> *mut Module {
    let mut p_mod: *mut Module = core::ptr::null_mut();
    let mut p_del: *mut Module = core::ptr::null_mut();
    let mut z_copy: *mut i8 = core::ptr::null_mut();
    if p_module_1 == core::ptr::null() {
        z_copy = z_name_1 as *mut i8;
        p_mod = core::ptr::null_mut();
    } else {
        let n_name: i32 = unsafe { sqlite3_strlen30(z_name_1) };
        p_mod =
            unsafe {
                    sqlite3Malloc(core::mem::size_of::<Module>() as u64 +
                                n_name as u64 + 1 as u64)
                } as *mut Module;
        if p_mod == core::ptr::null_mut() {
            unsafe { sqlite3_oom_fault(db) };
            return core::ptr::null_mut();
        }
        z_copy = unsafe { &raw mut *p_mod.offset(1 as isize) } as *mut i8;
        unsafe {
            memcpy(z_copy as *mut (), z_name_1 as *const (),
                (n_name + 1) as u64)
        };
        unsafe { (*p_mod).z_name = z_copy as *const i8 };
        unsafe { (*p_mod).p_module = p_module_1 };
        unsafe { (*p_mod).p_aux = p_aux_1 };
        unsafe { (*p_mod).x_destroy = x_destroy_1 };
        unsafe { (*p_mod).p_epo_tab = core::ptr::null_mut() };
        unsafe { (*p_mod).n_ref_module = 1 };
    }
    p_del =
        unsafe {
                sqlite3_hash_insert(unsafe { &mut (*db).a_module },
                    z_copy as *const i8, p_mod as *mut ())
            } as *mut Module;
    if !(p_del).is_null() {
        if p_del == p_mod {
            unsafe { sqlite3_oom_fault(db) };
            unsafe { sqlite3_db_free(db, p_del as *mut ()) };
            p_mod = core::ptr::null_mut();
        } else {
            unsafe {
                sqlite3_vtab_eponymous_table_clear(db, unsafe { &mut *p_del })
            };
            unsafe { sqlite3_vtab_module_unref(db, p_del) };
        }
    }
    return p_mod;
}
extern "C" fn create_module(db: *mut sqlite3, z_name_1: *const i8,
    p_module_1: *const sqlite3_module, p_aux_1: *mut (),
    x_destroy_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> i32 {
    let mut rc: i32 = 0;
    unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
    {
        let _ =
            sqlite3_vtab_create_module(db, z_name_1, p_module_1, p_aux_1,
                x_destroy_1);
    };
    rc = unsafe { sqlite3_api_exit(db, rc) };
    if rc != 0 && x_destroy_1.is_some() {
        unsafe { x_destroy_1.unwrap()(p_aux_1) };
    }
...
pub extern "C" fn sqlite3_create_module(db: *mut sqlite3, z_name_1: *const i8,
    p_module_1: *const sqlite3_module, p_aux_1: *mut ()) -> i32 {
...
pub extern "C" fn sqlite3_drop_modules(db: *mut sqlite3,
    ...
    let mut p_this: *mut HashElem = core::ptr::null_mut();
    let mut p_next: *mut HashElem = core::ptr::null_mut();
    unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
    {
        p_this = unsafe { (*unsafe { &mut (*db).a_module }).first };
        '__b0: loop {
            if !(!(p_this).is_null()) { break '__b0; }
            '__c0: loop {
                let p_mod: *const Module =
                    unsafe { (*p_this).data } as *mut Module as *const Module;
                p_next = unsafe { (*p_this).next };
                if !(az_names_1).is_null() {
                    let mut ii: i32 = 0;
                    {
                        ii = 0;
                        '__b1: loop {
                            if !(unsafe { *az_names_1.offset(ii as isize) } !=
                                                core::ptr::null() &&
                                            unsafe {
                                                    strcmp(unsafe { *az_names_1.offset(ii as isize) },
                                                        unsafe { (*p_mod).z_name })
                                                } != 0) {
                                break '__b1;
                            }
                ...
                create_module(db, unsafe { (*p_mod).z_name },
                    core::ptr::null(), core::ptr::null_mut(), None);
                break '__c0;
            }
            p_this = p_next;
        }
...
pub extern "C" fn sqlite3_declare_vtab(db: *mut sqlite3,
    ...
    unsafe {
        let mut p_ctx: *mut VtabCtx = core::ptr::null_mut();
        let mut rc: i32 = 0;
        ...
        z = z_create_table_1 as *const u8;
        {
            i = 0;
            '__b2: loop {
                if !(a_keyword[i as usize] != 0) { break '__b2; }
                '__c2: loop {
                    let mut token_type: i32 = 0;
                    '__b3: loop {
                        '__c3: loop {
                            {
                                let __n = unsafe { sqlite3_get_token(z, &mut token_type) };
                                let __p = &mut z;
                    ...
                    if token_type != a_keyword[i as usize] as i32 {
                        unsafe {
        ...
        unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
        p_ctx = unsafe { (*db).p_vtab_ctx };
        if (p_ctx).is_null() as i32 != 0 ||
                unsafe { (*p_ctx).b_declared } != 0 {
            unsafe {
                sqlite3_error(db, unsafe { sqlite3_misuse_error(850) })
            };
            unsafe { sqlite3_mutex_leave(unsafe { (*db).mutex }) };
            return unsafe { sqlite3_misuse_error(852) };
        }
        p_tab = unsafe { (*p_ctx).p_tab };
        { let _ = 0; };
        ...
        s_parse.n_query_loop = 1 as LogEst;
        if 0 == unsafe { sqlite3_run_parser(&mut s_parse, z_create_table_1) }
            {
            { let _ = 0; };
            { let _ = 0; };
            { let _ = 0; };
            { let _ = 0; };
            if (unsafe { (*p_tab).a_col }).is_null() as i32 != 0 {
                let p_new: *mut Table = s_parse.p_new_table;
                let mut p_idx: *mut Index = core::ptr::null_mut();
                unsafe { (*p_tab).a_col = unsafe { (*p_new).a_col } };
                { let _ = 0; };
                unsafe {
                    sqlite3_expr_list_delete(db,
                        unsafe { (*p_new).u.tab.p_dflt_list })
                };
                unsafe {
                    (*p_tab).n_nv_col =
                        {
                            unsafe { (*p_tab).n_col = unsafe { (*p_new).n_col } };
                            unsafe { (*p_tab).n_col }
                        }
                };
                unsafe {
                    (*p_tab).tab_flags |=
                        unsafe { (*p_new).tab_flags } & (128 | 512) as u32
                };
                unsafe { (*p_new).n_col = 0 as i16 };
                unsafe { (*p_new).a_col = core::ptr::null_mut() };
                { let _ = 0; };
                { let _ = 0; };
                if !(unsafe { (*p_new).tab_flags } & 128 as u32 == 0 as u32)
                                    as i32 != 0 &&
                            unsafe {
                                (*unsafe {
                                                    (*unsafe {
                                                                    (*unsafe { (*p_ctx).p_v_table }).p_mod
                                                                }).p_module
                                                }).x_update.is_some()
                            } &&
                        unsafe {
                ...
                if !(p_idx).is_null() {
                    { let _ = 0; };
                    unsafe { (*p_tab).p_index = p_idx };
                    unsafe { (*p_new).p_index = core::ptr::null_mut() };
                    unsafe { (*p_idx).p_table = p_tab };
                }
            }
            unsafe { (*p_ctx).b_declared = 1 };
        } else {
            unsafe {
                sqlite3_error_with_msg(db, 1,
            ...
            unsafe { sqlite3_db_free(db, s_parse.z_err_msg as *mut ()) };
            rc = 1;
        }
        s_parse.e_parse_mode = 0 as u8;
        if !(s_parse.p_vdbe).is_null() {
            unsafe { sqlite3_vdbe_finalize(s_parse.p_vdbe) };
        }
        unsafe { sqlite3_delete_table(db, s_parse.p_new_table) };
        unsafe { sqlite3_parse_object_reset(&mut s_parse) };
        unsafe { (*db).init.busy = init_busy as u8 };
        { let _ = 0; };
        rc = unsafe { sqlite3_api_exit(db, rc) };
        unsafe { sqlite3_mutex_leave(unsafe { (*db).mutex }) };
        return rc;
...
pub unsafe extern "C" fn sqlite3_vtab_config(db: *mut sqlite3, op: i32,
    ...
    let mut rc: i32 = 0;
    let mut p: *const VtabCtx = core::ptr::null();
    unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
    p = unsafe { (*db).p_vtab_ctx };
    if (p).is_null() as i32 != 0 {
        rc = unsafe { sqlite3_misuse_error(1350) };
    } else {
        { let _ = 0; };
        ...
        '__s4:
            ...
            match op {
                1 => {
                    {
                        unsafe {
                            (*unsafe { (*p).p_v_table }).b_constraint =
                                unsafe {
                                        let __ap = &mut ap;
                                        let __va_p = *__ap;
                    ...
                    {
                        unsafe {
                            (*unsafe { (*p).p_v_table }).e_vtab_risk = 0 as u8
                        };
                        break '__s4;
                    }
                    {
                        unsafe {
                            (*unsafe { (*p).p_v_table }).e_vtab_risk = 2 as u8
                        };
                        break '__s4;
                    }
                    {
                        unsafe {
                            (*unsafe { (*p).p_v_table }).b_all_schemas = 1 as u8
                        };
                        break '__s4;
                    }
                    { rc = unsafe { sqlite3_misuse_error(1372) }; break '__s4; }
                }
                2 => {
                    {
                        unsafe {
    ...
    if rc != 0 { unsafe { sqlite3_error(db, rc) }; }
    unsafe { sqlite3_mutex_leave(unsafe { (*db).mutex }) };
    return rc;
}
#[unsafe(no_mangle)]
...
extern "C" fn vtab_disconnect_all(db: *mut sqlite3, p: &mut Table)
    -> *mut VTable {
    unsafe {
        let mut p_ret: *mut VTable = core::ptr::null_mut();
        let mut p_v_table: *mut VTable = core::ptr::null_mut();
        { let _ = 0; };
        ...
        while !(p_v_table).is_null() {
            ...
            let p_next: *mut VTable = unsafe { (*p_v_table).p_next };
            { let _ = 0; };
            if db2 == db {
                p_ret = p_v_table;
                (*p).u.vtab.p = p_ret;
                unsafe { (*p_ret).p_next = core::ptr::null_mut() };
            } else {
                unsafe {
                    (*p_v_table).p_next = unsafe { (*db2).p_disconnect }
                };
                unsafe { (*db2).p_disconnect = p_v_table };
            }
            p_v_table = p_next;
        }
        { let _ = 0; };
...
pub extern "C" fn sqlite3_vtab_clear(db: *mut sqlite3, p: *mut Table) -> () {
    unsafe {
        ...
        if unsafe { (*db).pn_bytes_freed } == core::ptr::null_mut() {
            vtab_disconnect_all(core::ptr::null_mut(), unsafe { &mut *p });
        }
        if !(unsafe { (*p).u.vtab.az_arg }).is_null() {
            let mut i: i32 = 0;
            {
                i = 0;
                '__b6: loop {
                    if !(i < unsafe { (*p).u.vtab.n_arg }) { break '__b6; }
                    '__c6: loop {
                        if i != 1 {
                            unsafe {
                                sqlite3_db_free(db,
                                    unsafe { *unsafe { (*p).u.vtab.az_arg.offset(i as isize) } }
                                        as *mut ())
                            };
                        }
                        break '__c6;
            ...
            unsafe {
                sqlite3_db_free(db, unsafe { (*p).u.vtab.az_arg } as *mut ())
            };
        }
    }
}
...
pub extern "C" fn sqlite3_vtab_unlock(p_v_tab_1: *mut VTable) -> () {
    unsafe {
        let db: *mut sqlite3 = unsafe { (*p_v_tab_1).db };
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        {
            let __p = unsafe { &mut (*p_v_tab_1).n_ref };
            let __t = *__p;
            *__p -= 1;
            __t
        };
        if unsafe { (*p_v_tab_1).n_ref } == 0 {
            let p: *mut sqlite3_vtab = unsafe { (*p_v_tab_1).p_vtab };
            if !(p).is_null() {
                unsafe {
                    (unsafe {
                            (*unsafe { (*p).p_module }).x_disconnect.unwrap()
                        })(p)
                };
            }
            sqlite3_vtab_module_unref(unsafe { (*p_v_tab_1).db },
                unsafe { (*p_v_tab_1).p_mod });
            unsafe { sqlite3_db_free(db, p_v_tab_1 as *mut ()) };
        }
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_disconnect(db: *mut sqlite3, p: &mut Table)
    -> () {
    unsafe {
        let mut pp_v_tab: *mut *mut VTable = core::ptr::null_mut();
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        {
            pp_v_tab = &mut (*p).u.vtab.p;
            '__b7: loop {
                if !(!(unsafe { *pp_v_tab }).is_null()) { break '__b7; }
                '__c7: loop {
                    if unsafe { (*unsafe { *pp_v_tab }).db } == db {
                        let p_v_tab: *mut VTable = unsafe { *pp_v_tab };
                        unsafe { *pp_v_tab = unsafe { (*p_v_tab).p_next } };
                        sqlite3_vtab_unlock(p_v_tab);
                        break '__b7;
                    }
                    break '__c7;
                }
                pp_v_tab = unsafe { &mut (*unsafe { *pp_v_tab }).p_next };
            }
        }
    }
}
...
pub extern "C" fn sqlite3_vtab_sync(db: &mut sqlite3, p: *mut Vdbe) -> i32 {
    unsafe {
        let mut i: i32 = 0;
        let mut rc: i32 = 0;
        let a_v_trans: *mut *mut VTable = (*db).a_v_trans;
        (*db).a_v_trans = core::ptr::null_mut();
        {
            i = 0;
            '__b8: loop {
                if !(rc == 0 && i < (*db).n_v_trans) { break '__b8; }
                '__c8: loop {
                    let mut x:
                            Option<unsafe extern "C" fn(*mut sqlite3_vtab) -> i32> =
                        None;
                    let p_vtab: *mut sqlite3_vtab =
                        unsafe {
                            (*unsafe { *a_v_trans.offset(i as isize) }).p_vtab
                        };
                    if !(p_vtab).is_null() &&
                            {
                                    x = unsafe { (*unsafe { (*p_vtab).p_module }).x_sync };
                                    x
                                }.is_some() {
                        rc = unsafe { x.unwrap()(p_vtab) };
...
extern "C" fn call_finaliser(db: *mut sqlite3, offset: i32) -> () {
    unsafe {
        let mut i: i32 = 0;
        if !(unsafe { (*db).a_v_trans }).is_null() {
            let a_v_trans: *mut *mut VTable = unsafe { (*db).a_v_trans };
            unsafe { (*db).a_v_trans = core::ptr::null_mut() };
            {
                i = 0;
                '__b9: loop {
                    if !(i < unsafe { (*db).n_v_trans }) { break '__b9; }
                    '__c9: loop {
                        let p_v_tab: *mut VTable =
                            unsafe { *a_v_trans.offset(i as isize) };
                        let p: *mut sqlite3_vtab = unsafe { (*p_v_tab).p_vtab };
                        if !(p).is_null() {
                            let mut x:
                                    Option<unsafe extern "C" fn(*mut sqlite3_vtab) -> i32> =
                                None;
                                ...
                                Some(unsafe {
                                        *unsafe {
                                                core::mem::transmute::<*const (),
                                                        *mut unsafe extern "C" fn(*mut sqlite3_vtab)
                                                            ->
                                                                i32>(unsafe {
                                                            (unsafe { (*p).p_module } as
                                                                    *mut i8).offset(offset as isize)
                                                        } as *const ())
                                            }
                                    });
                            if x.is_some() { unsafe { x.unwrap()(p) }; }
                        }
                        unsafe { (*p_v_tab).i_savepoint = 0 };
                        sqlite3_vtab_unlock(p_v_tab);
                        break '__c9;
                    }
                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
            ...
            unsafe { sqlite3_db_free(db, a_v_trans as *mut ()) };
            unsafe { (*db).n_v_trans = 0 };
        }
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_rollback(db: *mut sqlite3) -> i32 {
    call_finaliser(db,
        core::mem::offset_of!(sqlite3_module, x_rollback) as i32);
    return 0;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_commit(db: *mut sqlite3) -> i32 {
    call_finaliser(db,
        core::mem::offset_of!(sqlite3_module, x_commit) as i32);
    return 0;
}
#[unsafe(no_mangle)]
...
pub extern "C" fn sqlite3_vtab_unlock_list(db: &mut sqlite3) -> () {
    ...
    { let _ = 0; };
    if !(p).is_null() {
        (*db).p_disconnect = core::ptr::null_mut();
        '__b10: loop {
            '__c10: loop {
                let p_next: *mut VTable = unsafe { (*p).p_next };
...
pub extern "C" fn sqlite3_vtab_savepoint(db: &mut sqlite3, op: i32,
    ...
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        if !((*db).a_v_trans).is_null() {
            let mut i: i32 = 0;
            {
                i = 0;
                '__b11: loop {
                    if !(rc == 0 && i < (*db).n_v_trans) { break '__b11; }
                    '__c11: loop {
                        let p_v_tab: *mut VTable =
                            unsafe { *(*db).a_v_trans.offset(i as isize) };
                        let p_mod: *const sqlite3_module =
                            unsafe { (*unsafe { (*p_v_tab).p_mod }).p_module };
                        if !(unsafe { (*p_v_tab).p_vtab }).is_null() &&
                                unsafe { (*p_mod).i_version } as i32 >= 2 {
                            let mut x_method:
                                    Option<unsafe extern "C" fn(*mut sqlite3_vtab, i32)
                                        -> i32> = None;
                            sqlite3_vtab_lock(unsafe { &mut *p_v_tab });
                            '__s12:
                                {
                                match op {
                                    0 => {
                                        x_method = unsafe { (*p_mod).x_savepoint };
                                        unsafe { (*p_v_tab).i_savepoint = i_savepoint_1 + 1 };
                                    }
                                    2 => { x_method = unsafe { (*p_mod).x_rollback_to }; }
                                    _ => { x_method = unsafe { (*p_mod).x_release }; }
                                }
                            }
                            if x_method.is_some() &&
                                    unsafe { (*p_v_tab).i_savepoint } > i_savepoint_1 {
                                let saved_flags: u64 = (*db).flags & 268435456 as u64;
                                (*db).flags &= !(268435456 as u64);
                                rc =
                                    unsafe {
                                        x_method.unwrap()(unsafe { (*p_v_tab).p_vtab },
                                            i_savepoint_1)
                                    };
...
pub extern "C" fn sqlite3_get_v_table(db: *mut sqlite3, p_tab_1: &Table)
    -> *mut VTable {
    unsafe {
        let mut p_vtab: *mut VTable = core::ptr::null_mut();
        { let _ = 0; };
        {
            p_vtab = (*p_tab_1).u.vtab.p;
            '__b13: loop {
                if !(!(p_vtab).is_null() && unsafe { (*p_vtab).db } != db) {
                    break '__b13;
                }
                '__c13: loop { break '__c13; }
                p_vtab = unsafe { (*p_vtab).p_next };
            }
        }
        return p_vtab;
    }
...
extern "C" fn add_module_argument(p_parse_1: *mut Parse,
    ...
    unsafe {
        let mut n_bytes: sqlite3_int64 = 0 as sqlite3_int64;
        let mut az_module_arg: *mut *mut i8 = core::ptr::null_mut();
        let db: *mut sqlite3 = unsafe { (*p_parse_1).db };
        { let _ = 0; };
        n_bytes =
            (core::mem::size_of::<*mut i8>() as u64 *
                    (2 + (*p_table_1).u.vtab.n_arg) as u64) as sqlite3_int64;
        if (*p_table_1).u.vtab.n_arg + 3 >=
        ...
        az_module_arg =
            unsafe {
                    sqlite3_db_realloc(db,
                        (*p_table_1).u.vtab.az_arg as *mut (), n_bytes as u64)
                } as *mut *mut i8;
        if az_module_arg == core::ptr::null_mut() {
            unsafe { sqlite3_db_free(db, z_arg_1 as *mut ()) };
        } else {
            let i: i32 =
                {
                    let __p = &mut (*p_table_1).u.vtab.n_arg;
                    let __t = *__p;
                    *__p += 1;
                    __t
                };
            unsafe { *az_module_arg.offset(i as isize) = z_arg_1 };
            unsafe {
                *az_module_arg.offset((i + 1) as isize) =
                    core::ptr::null_mut()
            };
            (*p_table_1).u.vtab.az_arg = az_module_arg;
        }
    }
}
extern "C" fn vtab_call_constructor(db: *mut sqlite3, p_tab_1: *mut Table,
    p_mod_1: *mut Module,
    x_construct_1:
        Option<unsafe extern "C" fn(*mut sqlite3, *mut (), i32,
            *const *const i8, *mut *mut sqlite3_vtab, *mut *mut i8) -> i32>,
    pz_err_1: &mut *mut i8) -> i32 {
    unsafe {
        let mut s_ctx: VtabCtx = unsafe { core::mem::zeroed() };
        let mut p_v_table: *mut VTable = core::ptr::null_mut();
        let mut rc: i32 = 0;
        let mut az_arg: *const *const i8 = core::ptr::null();
        let n_arg: i32 = unsafe { (*p_tab_1).u.vtab.n_arg };
        let mut z_err: *mut i8 = core::ptr::null_mut();
        let mut z_module_name: *mut i8 = core::ptr::null_mut();
        let mut i_db: i32 = 0;
        let mut p_ctx: *const VtabCtx = core::ptr::null();
        { let _ = 0; };
        az_arg = unsafe { (*p_tab_1).u.vtab.az_arg } as *const *const i8;
        {
            p_ctx = unsafe { (*db).p_vtab_ctx };
            '__b14: loop {
                if !(!(p_ctx).is_null()) { break '__b14; }
                '__c14: loop {
                    if unsafe { (*p_ctx).p_tab } == p_tab_1 {
                        *pz_err_1 =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"vtable constructor called recursively: %s".as_ptr() as
                                            *mut i8 as *const i8, unsafe { (*p_tab_1).z_name })
                            };
                        return 6;
                    }
                    break '__c14;
                }
                p_ctx = unsafe { (*p_ctx).p_prior };
            }
        }
        z_module_name =
            unsafe {
        ...
        if (z_module_name).is_null() as i32 != 0 { return 7; }
        p_v_table =
            unsafe {
                    sqlite3_malloc_zero(core::mem::size_of::<VTable>() as u64)
                } as *mut VTable;
        if (p_v_table).is_null() as i32 != 0 {
            unsafe { sqlite3_oom_fault(db) };
            unsafe { sqlite3_db_free(db, z_module_name as *mut ()) };
            return 7;
        }
        unsafe { (*p_v_table).db = db };
        unsafe { (*p_v_table).p_mod = p_mod_1 };
        unsafe { (*p_v_table).e_vtab_risk = 1 as u8 };
        i_db =
            unsafe {
                sqlite3_schema_to_index(db, unsafe { (*p_tab_1).p_schema })
            };
        unsafe {
            *unsafe { (*p_tab_1).u.vtab.az_arg.offset(1 as isize) } =
                unsafe {
        ...
        { let _ = 0; };
        s_ctx.p_tab = p_tab_1;
        s_ctx.p_v_table = p_v_table;
        s_ctx.p_prior = unsafe { (*db).p_vtab_ctx };
        s_ctx.b_declared = 0;
        unsafe { (*db).p_vtab_ctx = &mut s_ctx };
        {
            let __p = unsafe { &mut (*p_tab_1).n_tab_ref };
            let __t = *__p;
            *__p += 1;
            __t
        };
        rc =
            unsafe {
                x_construct_1.unwrap()(db, unsafe { (*p_mod_1).p_aux }, n_arg,
                    az_arg, unsafe { &mut (*p_v_table).p_vtab }, &mut z_err)
            };
        { let _ = 0; };
        { let _ = 0; };
        unsafe { sqlite3_delete_table(db, p_tab_1) };
        unsafe { (*db).p_vtab_ctx = s_ctx.p_prior };
        ...
        if 0 != rc {
            if z_err == core::ptr::null_mut() {
                *pz_err_1 =
                    unsafe {
                        sqlite3_m_printf(db,
                            c"vtable constructor failed: %s".as_ptr() as *mut i8 as
                                *const i8, z_module_name)
                    };
            } else {
                *pz_err_1 =
                    unsafe {
            ...
            unsafe {
                (*unsafe { (*p_v_table).p_vtab }).p_module =
                    unsafe { (*p_mod_1).p_module }
            };
            {
                let __p = unsafe { &mut (*p_mod_1).n_ref_module };
                let __t = *__p;
            ...
            unsafe { (*p_v_table).n_ref = 1 };
            if s_ctx.b_declared == 0 {
                let z_format: *const i8 =
                    c"vtable constructor did not declare schema: %s".as_ptr() as
                            *mut i8 as *const i8;
                *pz_err_1 =
                    unsafe { sqlite3_m_printf(db, z_format, z_module_name) };
                sqlite3_vtab_unlock(p_v_table);
                rc = 1;
            } else {
                let mut i_col: i32 = 0;
                ...
                unsafe { (*p_tab_1).u.vtab.p = p_v_table };
                {
                    i_col = 0;
                    '__b15: loop {
                        if !(i_col < unsafe { (*p_tab_1).n_col } as i32) {
                            break '__b15;
                        }
                        '__c15: loop {
                            let z_type: *mut i8 =
                                unsafe {
                                    sqlite3ColumnType(unsafe {
                                            &mut *unsafe { (*p_tab_1).a_col.offset(i_col as isize) }
                                        }, c"".as_ptr() as *mut i8)
                                };
                            let mut n_type: i32 = 0;
                            let mut i: i32 = 0;
                            n_type = unsafe { sqlite3_strlen30(z_type as *const i8) };
                            {
                                i = 0;
                                '__b16: loop {
                                    if !(i < n_type) { break '__b16; }
                                    '__c16: loop {
                                        if 0 ==
                                                        unsafe {
                                                            sqlite3_strnicmp(c"hidden".as_ptr() as *mut i8 as *const i8,
                                                                unsafe { &raw mut *z_type.offset(i as isize) } as *const i8,
                                                                6)
                                                        } &&
                                                    (i == 0 ||
                                                        unsafe { *z_type.offset((i - 1) as isize) } as i32 ==
                                                            ' ' as i32) &&
                                                (unsafe { *z_type.offset((i + 6) as isize) } as i32 ==
                                                        '\u{0}' as i32 ||
                                                    unsafe { *z_type.offset((i + 6) as isize) } as i32 ==
                                                        ' ' as i32) {
                                            break '__b16;
                            ...
                            if i < n_type {
                                ...
                                let n_del: i32 =
                                    6 +
                                        if unsafe { *z_type.offset((i + 6) as isize) } != 0 {
                                            1
                                        } else { 0 };
                                {
                                    j = i;
                                    '__b17: loop {
                                        if !(j + n_del <= n_type) { break '__b17; }
                                        '__c17: loop {
                                            unsafe {
                                                *z_type.offset(j as isize) =
                                                    unsafe { *z_type.offset((j + n_del) as isize) }
                                            };
                                            break '__c17;
                                        }
                                ...
                                if unsafe { *z_type.offset(i as isize) } as i32 ==
                                            '\u{0}' as i32 && i > 0 {
                                    { let _ = 0; };
                                    unsafe {
                                        *z_type.offset((i - 1) as isize) = '\u{0}' as i32 as i8
                                    };
                                }
                                unsafe {
                                    (*unsafe {
                                ...
                                unsafe { (*p_tab_1).tab_flags |= 2 as u32 };
                                ooo_hidden = 1024 as u16;
                            } else {
                                unsafe { (*p_tab_1).tab_flags |= ooo_hidden as u32 };
                            }
                            break '__c15;
                        }
...
pub extern "C" fn sqlite3_vtab_eponymous_table_init(p_parse_1: *mut Parse,
    ...
    unsafe {
        let p_module: *const sqlite3_module = unsafe { (*p_mod_1).p_module };
        let mut p_tab: *mut Table = core::ptr::null_mut();
        let mut z_err: *mut i8 = core::ptr::null_mut();
        let mut rc: i32 = 0;
        let db: *mut sqlite3 = unsafe { (*p_parse_1).db };
        if !(unsafe { (*p_mod_1).p_epo_tab }).is_null() { return 1; }
        if unsafe { (*p_module).x_create.is_some() } &&
                unsafe { (*p_module).x_create } !=
                    unsafe { (*p_module).x_connect } {
            return 0;
        }
        p_tab =
            unsafe {
        ...
        unsafe {
            (*p_tab).z_name =
                unsafe {
                    sqlite3_db_str_dup(db, unsafe { (*p_mod_1).z_name })
                }
        };
        if unsafe { (*p_tab).z_name } == core::ptr::null_mut() {
            unsafe { sqlite3_db_free(db, p_tab as *mut ()) };
            return 0;
        }
        unsafe { (*p_mod_1).p_epo_tab = p_tab };
        unsafe { (*p_tab).n_tab_ref = 1 as u32 };
        unsafe { (*p_tab).e_tab_type = 1 as u8 };
        unsafe {
            (*p_tab).p_schema =
                unsafe {
        ...
        unsafe { (*p_tab).tab_flags |= 32768 as u32 };
        add_module_argument(p_parse_1, unsafe { &mut *p_tab },
            unsafe {
                sqlite3_db_str_dup(db,
        ...
        rc =
            vtab_call_constructor(db, p_tab, p_mod_1,
                unsafe { (*p_module).x_connect }, &mut z_err);
        {
            let __p = unsafe { &mut (*db).n_schema_lock };
            let __t = *__p;
            *__p -= 1;
        ...
        if rc != 0 {
            ...
            unsafe { (*p_parse_1).rc = rc };
            unsafe { sqlite3_db_free(db, z_err as *mut ()) };
            unsafe {
                sqlite3_vtab_eponymous_table_clear(db,
                    unsafe { &mut *p_mod_1 })
            };
        }
        return 1;
...
pub extern "C" fn sqlite3_vtab_make_writable(p_parse_1: *mut Parse,
    ...
    let mut i: i32 = 0;
    let mut n: i32 = 0;
    let mut ap_vtab_lock: *mut *mut Table = core::ptr::null_mut();
    { let _ = 0; };
    {
        i = 0;
        '__b18: loop {
            if !(i < unsafe { (*p_toplevel).n_vtab_lock }) { break '__b18; }
            '__c18: loop {
                if p_tab_1 ==
                        unsafe {
                            *unsafe { (*p_toplevel).ap_vtab_lock.offset(i as isize) }
                        } {
                    return;
                }
                break '__c18;
    ...
    n =
        ((unsafe { (*p_toplevel).n_vtab_lock } + 1) as u64 *
                core::mem::size_of::<*mut Table>() as u64) as i32;
    ap_vtab_lock =
        unsafe {
                sqlite3Realloc(unsafe { (*p_toplevel).ap_vtab_lock } as
                        *mut (), n as u64)
            } as *mut *mut Table;
    if !(ap_vtab_lock).is_null() {
        unsafe { (*p_toplevel).ap_vtab_lock = ap_vtab_lock };
        unsafe {
            *unsafe {
                        (*p_toplevel).ap_vtab_lock.offset({
                                    let __p = unsafe { &mut (*p_toplevel).n_vtab_lock };
                                    let __t = *__p;
                                    *__p += 1;
                                    __t
                                } as isize)
...
pub extern "C" fn sqlite3_vtab_begin_parse(p_parse_1: *mut Parse,
    ...
    unsafe {
        ...
        p_table = unsafe { (*p_parse_1).p_new_table };
        if p_table == core::ptr::null_mut() { return; }
        { let _ = 0; };
        unsafe { (*p_table).e_tab_type = 1 as u8 };
        db = unsafe { (*p_parse_1).db };
        { let _ = 0; };
        add_module_argument(p_parse_1, unsafe { &mut *p_table },
            unsafe {
                sqlite3_name_from_token(db, p_module_name_1 as *const Token)
            });
        add_module_argument(p_parse_1, unsafe { &mut *p_table },
            core::ptr::null_mut());
        add_module_argument(p_parse_1, unsafe { &mut *p_table },
        ...
        { let _ = 0; };
        unsafe {
            (*p_parse_1).s_name_token.n =
                unsafe {
                                unsafe {
                                    unsafe {
                                        (*p_module_name_1).z.add(unsafe { (*p_module_name_1).n } as
                                                    usize).offset_from(unsafe { (*p_parse_1).s_name_token.z })
                                    }
                                }
                            } as i64 as i32 as u32
        };
        if !(unsafe { (*p_table).u.vtab.az_arg }).is_null() {
            let i_db: i32 =
                unsafe {
            ...
            unsafe {
                sqlite3_auth_check(p_parse_1, 29,
                    unsafe { (*p_table).z_name } as *const i8,
                    unsafe {
                            *unsafe { (*p_table).u.vtab.az_arg.offset(0 as isize) }
                        } as *const i8,
                    unsafe {
                            (*unsafe {
                                        (*unsafe { (*p_parse_1).db }).a_db.offset(i_db as isize)
                                    }).z_db_s_name
                        } as *const i8)
            };
        }
...
extern "C" fn add_argument_to_vtab(p_parse_1: *mut Parse) -> () {
    unsafe {
        if !(unsafe { (*p_parse_1).s_arg.z }).is_null() &&
                !(unsafe { (*p_parse_1).p_new_table }).is_null() {
            let z: *const i8 = unsafe { (*p_parse_1).s_arg.z } as *const i8;
            let n: i32 = unsafe { (*p_parse_1).s_arg.n } as i32;
            let db: *mut sqlite3 = unsafe { (*p_parse_1).db };
            add_module_argument(p_parse_1,
                unsafe { &mut *unsafe { (*p_parse_1).p_new_table } },
                unsafe { sqlite3_db_str_n_dup(db, z, n as u64) });
        }
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_finish_parse(p_parse_1: *mut Parse,
    ...
    unsafe {
        ...
        { let _ = 0; };
        add_argument_to_vtab(p_parse_1);
        unsafe { (*p_parse_1).s_arg.z = core::ptr::null() };
        if unsafe { (*p_tab).u.vtab.n_arg } < 1 { return; }
        if (unsafe { (*db).init.busy } == 0) as i32 != 0 {
            ...
            if !(p_end_1).is_null() {
                unsafe {
                    (*p_parse_1).s_name_token.n =
                        unsafe {
                                            unsafe {
                                                (*p_end_1).z.offset_from(unsafe {
                                                        (*p_parse_1).s_name_token.z
                                                    })
                                            }
                                        } as i64 as i32 as u32 + unsafe { (*p_end_1).n }
                };
            }
            z_stmt =
                unsafe {
            ...
            unsafe {
                sqlite3_nested_parse(p_parse_1,
                    c"UPDATE %Q.sqlite_master SET type=\'table\', name=%Q, tbl_name=%Q, rootpage=0, sql=%Q WHERE rowid=#%d".as_ptr()
                            as *mut i8 as *const i8,
                    unsafe {
                        (*unsafe { (*db).a_db.offset(i_db as isize) }).z_db_s_name
                    }, unsafe { (*p_tab).z_name }, unsafe { (*p_tab).z_name },
                    z_stmt, unsafe { (*p_parse_1).u1.cr.reg_rowid })
            };
            v = unsafe { sqlite3_get_vdbe(p_parse_1) };
            unsafe { sqlite3_change_cookie(p_parse_1, i_db) };
            unsafe { sqlite3_vdbe_add_op0(v, 168) };
            z_where =
                unsafe {
                    sqlite3_m_printf(db,
                        c"name=%Q AND sql=%Q".as_ptr() as *mut i8 as *const i8,
                        unsafe { (*p_tab).z_name }, z_stmt)
                };
            unsafe {
                sqlite3_vdbe_add_parse_schema_op(v, i_db, z_where, 0 as u16)
            };
            ...
            unsafe {
                sqlite3_vdbe_load_string(v, i_reg,
                    unsafe { (*p_tab).z_name } as *const i8)
            };
            ...
            { let _ = 0; };
            unsafe { sqlite3_mark_all_shadow_tables_of(db, p_tab) };
            p_old =
                unsafe {
...
pub extern "C" fn sqlite3_vtab_arg_init(p_parse_1: *mut Parse) -> () {
    unsafe {
        add_argument_to_vtab(p_parse_1);
        unsafe { (*p_parse_1).s_arg.z = core::ptr::null() };
        unsafe { (*p_parse_1).s_arg.n = 0 as u32 };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vtab_arg_extend(p_parse_1: &mut Parse, p: &Token)
    -> () {
    unsafe {
        let p_arg: *mut Token = &mut (*p_parse_1).s_arg;
        if unsafe { (*p_arg).z } == core::ptr::null() {
            unsafe { (*p_arg).z = (*p).z };
            unsafe { (*p_arg).n = (*p).n };
        } else {
            { let _ = 0; };
            unsafe {
                (*p_arg).n =
                    unsafe {
                                    unsafe {
                                        (*p).z.add((*p).n as
                                                    usize).offset_from(unsafe { (*p_arg).z })
                                    }
                                } as i64 as i32 as u32
            };
        }
...
extern "C" fn grow_v_trans(db: *mut sqlite3) -> i32 {
    ...
    if unsafe { (*db).n_v_trans } % array_incr as i32 == 0 {
        let mut a_v_trans: *mut *mut VTable = core::ptr::null_mut();
        let n_bytes: sqlite3_int64 =
            (core::mem::size_of::<*mut sqlite3_vtab>() as u64 *
                    (unsafe { (*db).n_v_trans } as sqlite3_int64 +
                            array_incr as sqlite3_int64) as u64) as sqlite3_int64;
        a_v_trans =
            unsafe {
                    sqlite3_db_realloc(db,
                        unsafe { (*db).a_v_trans } as *mut (), n_bytes as u64)
                } as *mut *mut VTable;
        if (a_v_trans).is_null() as i32 != 0 { return 7; }
        unsafe {
            memset(unsafe {
                        &raw mut *a_v_trans.offset(unsafe { (*db).n_v_trans } as
                                        isize)
                    } as *mut (), 0,
                core::mem::size_of::<*mut sqlite3_vtab>() as u64 *
                    array_incr as u64)
        };
        unsafe { (*db).a_v_trans = a_v_trans };
    }
    return 0;
}
...
pub extern "C" fn sqlite3_vtab_call_create(db: *mut sqlite3, i_db_1: i32,
    ...
    unsafe {
        ...
        if p_mod == core::ptr::null_mut() ||
                    !unsafe {
                                    (*unsafe { (*p_mod).p_module }).x_create.is_some()
                                } as i32 != 0 ||
                !unsafe {
                                (*unsafe { (*p_mod).p_module }).x_destroy.is_some()
                            } as i32 != 0 {
            unsafe {
                *pz_err_1 =
                    unsafe {
                        sqlite3_m_printf(db,
                            c"no such module: %s".as_ptr() as *mut i8 as *const i8,
                            z_mod)
                    }
            };
            rc = 1;
            ...
            rc =
                vtab_call_constructor(db, p_tab, p_mod,
                    unsafe { (*unsafe { (*p_mod).p_module }).x_create },
                    unsafe { &mut *pz_err_1 });
        }
        if rc == 0 && !(sqlite3_get_v_table(db, unsafe { &*p_tab })).is_null()
            {
            rc = grow_v_trans(db);
            if rc == 0 {
                add_to_v_trans(unsafe { &mut *db },
                    sqlite3_get_v_table(db, unsafe { &*p_tab }));
            }
        }
        return rc;
    }
...
pub extern "C" fn sqlite3_vtab_call_connect(p_parse_1: *mut Parse,
    ...
    unsafe {
        ...
        if (p_mod).is_null() as i32 != 0 {
            let z_module: *const i8 =
                unsafe {
                        *unsafe { (*p_tab_1).u.vtab.az_arg.offset(0 as isize) }
                    } as *const i8;
            unsafe {
                sqlite3_error_msg(p_parse_1,
                    c"no such module: %s".as_ptr() as *mut i8 as *const i8,
            ...
            let mut z_err: *mut i8 = core::ptr::null_mut();
            rc =
                vtab_call_constructor(db, p_tab_1, p_mod,
                    unsafe { (*unsafe { (*p_mod).p_module }).x_connect },
                    &mut z_err);
            if rc != 0 {
                unsafe {
                    sqlite3_error_msg(p_parse_1,
                ...
                unsafe { sqlite3_mark_all_shadow_tables_of(db, p_tab_1) };
            }
            unsafe { sqlite3_db_free(db, z_err as *mut ()) };
        }
        return rc;
...
pub extern "C" fn sqlite3_vtab_call_destroy(db: *mut sqlite3, i_db_1: i32,
    ...
    unsafe {
        ...
        if p_tab != core::ptr::null_mut() &&
                    unsafe { (*p_tab).e_tab_type } as i32 == 1 &&
                unsafe { (*p_tab).u.vtab.p } != core::ptr::null_mut() {
            let mut p: *mut VTable = core::ptr::null_mut();
            let mut x_destroy:
                    Option<unsafe extern "C" fn(*mut sqlite3_vtab) -> i32> =
                None;
            {
                p = unsafe { (*p_tab).u.vtab.p };
                '__b19: loop {
                    if !(!(p).is_null()) { break '__b19; }
                    '__c19: loop {
                        { let _ = 0; };
                        if unsafe { (*unsafe { (*p).p_vtab }).n_ref } > 0 {
                            return 6;
                        }
                        break '__c19;
                    }
            ...
            p = vtab_disconnect_all(db, unsafe { &mut *p_tab });
            x_destroy =
                unsafe {
                    (*unsafe { (*unsafe { (*p).p_mod }).p_module }).x_destroy
                };
            if !x_destroy.is_some() as i32 != 0 {
                x_destroy =
                    unsafe {
                        (*unsafe { (*unsafe { (*p).p_mod }).p_module }).x_disconnect
                    };
            }
            { let _ = 0; };
            {
            ...
            rc = unsafe { x_destroy.unwrap()(unsafe { (*p).p_vtab }) };
            if rc == 0 {
                { let _ = 0; };
                unsafe { (*p).p_vtab = core::ptr::null_mut() };
                unsafe { (*p_tab).u.vtab.p = core::ptr::null_mut() };
                sqlite3_vtab_unlock(p);
            }
            unsafe { sqlite3_delete_table(db, p_tab) };
...
pub extern "C" fn sqlite3_vtab_begin(db: *mut sqlite3, p_v_tab_1: *mut VTable)
    ...
    unsafe {
        ...
        if (p_v_tab_1).is_null() as i32 != 0 { return 0; }
        p_module = unsafe { (*unsafe { (*p_v_tab_1).p_vtab }).p_module };
        if unsafe { (*p_module).x_begin.is_some() } {
            let mut i: i32 = 0;
            {
                i = 0;
                '__b20: loop {
                    if !(i < unsafe { (*db).n_v_trans }) { break '__b20; }
                    '__c20: loop {
                        if unsafe { *unsafe { (*db).a_v_trans.offset(i as isize) } }
                                == p_v_tab_1 {
                            return 0;
                        }
                        break '__c20;
            ...
            if rc == 0 {
                rc =
                    unsafe {
                        (unsafe {
                                (*p_module).x_begin.unwrap()
                            })(unsafe { (*p_v_tab_1).p_vtab })
                    };
                if rc == 0 {
                    let i_svpt: i32 =
                        unsafe { (*db).n_statement } + unsafe { (*db).n_savepoint };
                    add_to_v_trans(unsafe { &mut *db }, p_v_tab_1);
                    if i_svpt != 0 &&
                            unsafe { (*p_module).x_savepoint.is_some() } {
                        unsafe { (*p_v_tab_1).i_savepoint = i_svpt };
                        rc =
                            unsafe {
                                (unsafe {
                                        (*p_module).x_savepoint.unwrap()
                                    })(unsafe { (*p_v_tab_1).p_vtab }, i_svpt - 1)
                            };
                    }
                }
            }
...
pub extern "C" fn sqlite3_vtab_overload_function(db: *mut sqlite3,
    ...
    unsafe {
        ...
        let mut p_arg: *mut () = core::ptr::null_mut();
        let mut p_new: *mut FuncDef = core::ptr::null_mut();
        let mut rc: i32 = 0;
        if p_expr_1 == core::ptr::null_mut() { return p_def_1; }
        if unsafe { (*p_expr_1).op } as i32 != 168 { return p_def_1; }
        { let _ = 0; };
        p_tab = unsafe { (*p_expr_1).y.p_tab };
        if p_tab == core::ptr::null_mut() { return p_def_1; }
        if !(unsafe { (*p_tab).e_tab_type } as i32 == 1) as i32 != 0 {
            return p_def_1;
        }
        p_vtab =
            unsafe { (*sqlite3_get_v_table(db, unsafe { &*p_tab })).p_vtab };
        { let _ = 0; };
        { let _ = 0; };
        ...
        unsafe {
            memcpy(unsafe { &raw mut *p_new.offset(1 as isize) } as *mut i8 as
                    *mut (), unsafe { (*p_def_1).z_name } as *const (),
                (unsafe { sqlite3_strlen30(unsafe { (*p_def_1).z_name }) } +
                        1) as u64)
        };
        unsafe { (*p_new).x_s_func = Some(x_s_func) };
        unsafe { (*p_new).p_user_data = p_arg };
        unsafe { (*p_new).func_flags |= 16 as u32 };
        return p_new;
    }
}
static a_keyword: [u8; 3] = [17 as u8, 16 as u8, 0 as u8];
static a_map: [u8; 5] = [1 as u8, 4 as u8, 3 as u8, 2 as u8, 5 as u8];
extern "C" {
