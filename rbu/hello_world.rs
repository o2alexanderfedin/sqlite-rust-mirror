    ...
    unsafe {
        ...
        unsafe {
            fprintf(__stdoutp,
                ...
                if !(p_vfs).is_null() {
                    unsafe { (*p_vfs).z_name }
                } else { c"NULL".as_ptr() as *mut i8 as *const i8 })
        };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn report_rbu_vfs(p_rbu_1: *mut sqlite3rbu) -> () {
    unsafe {
        let db: *mut sqlite3 = unsafe { sqlite3rbu_db(p_rbu_1, 0) };
        if !(db).is_null() {
            let mut z_name: *mut i8 = core::ptr::null_mut();
            unsafe {
                sqlite3_file_control(db,
                    c"main".as_ptr() as *mut i8 as *const i8, 12,
                    &raw mut z_name as *mut ())
            };
            if !(z_name).is_null() {
                unsafe {
                    fprintf(__stdoutp,
...
extern "C" fn __main_inner(argc: i32, argv: *const *mut i8)
    ...
    unsafe {
        ...
        let mut rc: i32 = 0;
        let mut n_progress: sqlite3_int64 = 0 as sqlite3_int64;
        let n_argc: i32 = argc - 2;
        if argc < 3 {
        ...
        }
        {
            i = 1;
            '__b0: loop {
                if !(i < n_argc) { break '__b0; }
                '__c0: loop {
                    let z_arg: *const i8 =
                        unsafe { *argv.offset(i as isize) } as *const i8;
                    let n_arg: i32 = unsafe { strlen(z_arg) } as i32;
                    if n_arg > 1 && n_arg <= 8 &&
                            0 ==
                                unsafe {
                                    memcmp(z_arg as *const (),
                                        c"-vacuum".as_ptr() as *mut i8 as *const (), n_arg as u64)
                                } {
                        b_vacuum = 1;
                    } else if n_arg > 1 && n_arg <= 7 &&
                                0 ==
                                    unsafe {
                                        memcmp(z_arg as *const (),
                                            c"-presql".as_ptr() as *mut i8 as *const (), n_arg as u64)
                                    } && i < n_arg - 1 {
                        { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                        z_pre_sql =
                            unsafe { *argv.offset(i as isize) } as *const i8;
                    } else if n_arg > 1 && n_arg <= 5 &&
                                0 ==
                                    unsafe {
                                        memcmp(z_arg as *const (),
                                            c"-step".as_ptr() as *mut i8 as *const (), n_arg as u64)
                                    } && i < n_arg - 1 {
                        { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                        n_step =
                            unsafe {
                    ...
                    } else if n_arg > 1 && n_arg <= 9 &&
                                0 ==
                                    unsafe {
                                        memcmp(z_arg as *const (),
                                            c"-statstep".as_ptr() as *mut i8 as *const (), n_arg as u64)
                                    } && i < n_arg - 1 {
                        { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                        n_stat_step =
                            unsafe {
        ...
        z_target = unsafe { *argv.offset((argc - 2) as isize) } as *const i8;
        z_rbu = unsafe { *argv.offset((argc - 1) as isize) } as *const i8;
        report_default_vfs();
        if b_vacuum != 0 {
            p_rbu = unsafe { sqlite3rbu_vacuum(z_target, z_rbu) };
        } else {
            p_rbu =
                unsafe {
                    sqlite3rbu_open(z_target, z_rbu, core::ptr::null())
                };
        }
        report_rbu_vfs(p_rbu);
        if !(z_pre_sql).is_null() && !(p_rbu).is_null() {
            let db_main: *mut sqlite3 = unsafe { sqlite3rbu_db(p_rbu, 0) };
            rc =
                unsafe {
                    sqlite3_exec(db_main, z_pre_sql, None,
                        core::ptr::null_mut(), core::ptr::null_mut())
                };
            if rc == 0 {
                let db_rbu: *mut sqlite3 = unsafe { sqlite3rbu_db(p_rbu, 1) };
                rc =
                    unsafe {
                        sqlite3_exec(db_rbu, z_pre_sql, None, core::ptr::null_mut(),
                            core::ptr::null_mut())
                    };
            }
        }
        if rc == 0 {
            {
                i = 0;
                '__b1: loop {
                    if !((n_step <= 0 || i < n_step) &&
                                    unsafe { sqlite3rbu_step(p_rbu) } == 0) {
                        break '__b1;
                    }
                    '__c1: loop {
                        if n_stat_step > 0 && i % n_stat_step == 0 {
                            let mut n_used: sqlite3_int64 = 0 as sqlite3_int64;
                            let mut n_highwater: sqlite3_int64 = 0 as sqlite3_int64;
                            unsafe {
                                sqlite3_status64(0, &mut n_used, &mut n_highwater, 0)
                            };
                            unsafe {
                                fprintf(__stdoutp,
                                    c"memory used=%lld highwater=%lld".as_ptr() as *mut i8 as
                                        *const i8, n_used, n_highwater)
                            };
                            if b_vacuum == 0 {
                                let mut one: i32 = 0;
                                let mut two: i32 = 0;
                                unsafe {
                                    sqlite3rbu_bp_progress(p_rbu, &mut one, &mut two)
                                };
                                unsafe {
                                    fprintf(__stdoutp,
                                        c"  progress=%d/%d\n".as_ptr() as *mut i8 as *const i8, one,
                                        two)
                                };
                            } else {
                                unsafe {
            ...
            n_progress = unsafe { sqlite3rbu_progress(p_rbu) };
            rc = unsafe { sqlite3rbu_close(p_rbu, &mut z_errmsg) };
        }
        '__s2:
            {
            match rc {
                0 => {
                    unsafe {
                        sqlite3_snprintf(core::mem::size_of::<[i8; 200]>() as i32,
                            ...
                            c"SQLITE_OK: rbu update incomplete (%lld operations so far)\n".as_ptr()
                                    as *mut i8 as *const i8, n_progress)
                    };
                    unsafe {
                ...
                101 => {
                    unsafe {
                        sqlite3_snprintf(core::mem::size_of::<[i8; 200]>() as i32,
                            &raw mut z_buf[0 as usize] as *mut i8,
                            c"SQLITE_DONE: rbu update completed (%lld operations)\n".as_ptr()
                                    as *mut i8 as *const i8, n_progress)
                    };
                    unsafe {
                        fprintf(__stdoutp, c"%s".as_ptr() as *mut i8 as *const i8,
                ...
                _ => {
                    unsafe {
                        fprintf(__stderrp,
                            c"error=%d: %s\n".as_ptr() as *mut i8 as *const i8, rc,
                            z_errmsg)
                    };
                }
            }
        ...
        if n_stat_step > 0 {
            let mut n_used_1: sqlite3_int64 = 0 as sqlite3_int64;
            let mut n_highwater_1: sqlite3_int64 = 0 as sqlite3_int64;
            unsafe {
                sqlite3_status64(0, &mut n_used_1, &mut n_highwater_1, 0)
            };
            unsafe {
                fprintf(__stdoutp,
                    c"memory used=%lld highwater=%lld\n".as_ptr() as *mut i8 as
                        *const i8, n_used_1, n_highwater_1)
            };
        }
...
extern "C" {
    ...
    -> i32;
    fn sqlite3rbu_open(z_target_1: *const i8, z_rbu_1: *const i8,
    z_state_1: *const i8)
    -> *mut sqlite3rbu;
    fn sqlite3rbu_vacuum(z_target_1: *const i8, z_state_1: *const i8)
    -> *mut sqlite3rbu;
    fn sqlite3rbu_temp_size_limit(_: *mut sqlite3rbu, _: sqlite3_int64)
    -> sqlite3_int64;
    fn sqlite3rbu_temp_size(_: *mut sqlite3rbu)
    -> sqlite3_int64;
    fn sqlite3rbu_db(_: *mut sqlite3rbu, b_rbu_1: i32)
    -> *mut sqlite3;
    fn sqlite3rbu_step(p_rbu_1: *mut sqlite3rbu)
    -> i32;
    fn sqlite3rbu_savestate(p_rbu_1: *mut sqlite3rbu)
    -> i32;
    fn sqlite3rbu_close(p_rbu_1: *mut sqlite3rbu, pz_errmsg_1: *mut *mut i8)
    -> i32;
    fn sqlite3rbu_progress(p_rbu_1: *mut sqlite3rbu)
    -> sqlite3_int64;
    fn sqlite3rbu_bp_progress(p_rbu_1: *mut sqlite3rbu, pn_one_1: *mut i32,
    pn_two_1: *mut i32)
    -> ();
    fn sqlite3rbu_state(p_rbu_1: *mut sqlite3rbu)
    -> i32;
    fn sqlite3rbu_rename_handler(p_rbu_1: *mut sqlite3rbu, p_arg_1: *mut (),
    x_rename_1:
        Option<unsafe extern "C" fn(*mut (), *const i8, *const i8) -> i32>)
    -> ();
    fn sqlite3rbu_create_vfs(z_name_1: *const i8, z_parent_1: *const i8)
    -> i32;
    fn sqlite3rbu_destroy_vfs(z_name_1: *const i8)
    -> ();
