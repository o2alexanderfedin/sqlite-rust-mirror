...
pub extern "C" fn sqlite3_bitvec_create(i_size: u32) -> *mut Bitvec {
    ...
    { let _ = 0; };
    p =
        unsafe { sqlite3_malloc_zero(core::mem::size_of::<Bitvec>() as u64) }
            as *mut Bitvec;
...
pub extern "C" fn sqlite3_bitvec_test_not_null(mut p: *mut Bitvec, mut i: u32)
    ...
    unsafe {
        ...
        if i >= unsafe { (*p).i_size } { return 0; }
        while unsafe { (*p).i_divisor } != 0 {
            let bin: u32 = i / unsafe { (*p).i_divisor };
            i = i % unsafe { (*p).i_divisor };
            p = unsafe { (*p).u.ap_sub[bin as usize] };
            if (p).is_null() as i32 != 0 { return 0; }
        }
        if unsafe { (*p).i_size } as u64 <=
                (512 as u64 - 3 as u64 * core::mem::size_of::<u32>() as u64) /
                                core::mem::size_of::<*mut Bitvec>() as u64 *
                            core::mem::size_of::<*mut Bitvec>() as u64 /
                        core::mem::size_of::<u8>() as u64 * 8 as u64 {
            return (unsafe { (*p).u.a_bitmap[(i / 8 as u32) as usize] } as i32
                            & 1 << (i & (8 - 1) as u32) != 0) as i32;
        } else {
            let mut h: u32 =
                (({ let __p = &mut i; let __t = *__p; *__p += 1; __t } *
                                1 as u32) as u64 %
                        ((512 as u64 -
                                        3 as u64 * core::mem::size_of::<u32>() as u64) /
                                    core::mem::size_of::<*mut Bitvec>() as u64 *
                                core::mem::size_of::<*mut Bitvec>() as u64 /
                            core::mem::size_of::<u32>() as u64)) as u32;
            while unsafe { (*p).u.a_hash[h as usize] } != 0 {
                if unsafe { (*p).u.a_hash[h as usize] } == i { return 1; }
                h =
                    ((h + 1 as u32) as u64 %
                            ((512 as u64 -
                                            3 as u64 * core::mem::size_of::<u32>() as u64) /
        ...
        loop {
            ...
            '__s3:
                ...
                match __state {
                    0 => { __state = 4; }
                    2 => {
                        if unsafe { (*p).n_set } as u64 >=
                                (512 as u64 - 3 as u64 * core::mem::size_of::<u32>() as u64)
                                                / core::mem::size_of::<*mut Bitvec>() as u64 *
                                            core::mem::size_of::<*mut Bitvec>() as u64 /
                                        core::mem::size_of::<u32>() as u64 / 2 as u64 {
                            __state = 33;
                        } else { __state = 32; }
                    }
                    3 => {
                        {
                            let __p = unsafe { &mut (*p).n_set };
                            let __t = *__p;
                            *__p += 1;
                            __t
                        };
                    ...
                    11 => { bin = i / unsafe { (*p).i_divisor }; __state = 12; }
                    12 => { i = i % unsafe { (*p).i_divisor }; __state = 13; }
                    13 => {
                        if unsafe { (*p).u.ap_sub[bin as usize] } ==
                                core::ptr::null_mut() {
                            __state = 15;
                        } else { __state = 14; }
                    }
                    ...
                    15 => {
                        unsafe {
                            (*p).u.ap_sub[bin as usize] =
                                sqlite3_bitvec_create(unsafe { (*p).i_divisor })
                        };
                        __state = 16;
                    }
                    16 => {
                    ...
                    19 => {
                        unsafe {
                            (*p).u.a_bitmap[(i / 8 as u32) as usize] |=
                                (1 << (i & (8 - 1) as u32)) as u8
                        };
                        __state = 20;
                    }
                    20 => { return 0; }
                    21 => {
                        if (unsafe { (*p).u.a_hash[h as usize] } == 0) as i32 != 0 {
                            __state = 23;
                        } else { __state = 22; }
                    }
                    22 => {
                        if unsafe { (*p).u.a_hash[h as usize] } == i {
                            __state = 29;
                        } else { __state = 28; }
                    }
                    23 => {
                    ...
                    26 => { __state = 2; }
                    27 => {
                        if unsafe { (*p).u.a_hash[h as usize] } != 0 {
                            __state = 22;
                        } else { __state = 26; }
                    }
                    28 => {
                        ...
                        ai_values =
                            unsafe {
                                    sqlite3_db_malloc_raw(core::ptr::null_mut(),
                                        core::mem::size_of::<[u32; 124]>() as u64)
                                } as *mut u32;
                        __state = 36;
                    }
                    36 => {
                        if ai_values == core::ptr::null_mut() {
                            __state = 37;
                        } else { __state = 38; }
                    }
                    37 => { return 7; }
                    38 => {
                        unsafe {
                            memcpy(ai_values as *mut (),
                                unsafe { &raw mut (*p).u.a_hash[0 as usize] } as *mut u32 as
                                    *const (), core::mem::size_of::<[u32; 124]>() as u64)
                        };
                        __state = 39;
                    }
                    39 => {
                        unsafe {
                            memset(unsafe { &raw mut (*p).u.ap_sub[0 as usize] } as
                                        *mut *mut Bitvec as *mut (), 0,
                                core::mem::size_of::<[*mut Bitvec; 62]>() as u64)
                        };
                        __state = 40;
                    }
                    40 => {
                            ...
                            (*p).i_divisor =
                                unsafe { (*p).i_size } /
                                    ((512 as u64 -
                                                    ...
                                                    core::mem::size_of::<*mut Bitvec>() as u64 *
                                                core::mem::size_of::<*mut Bitvec>() as u64 /
                                            core::mem::size_of::<*mut Bitvec>() as u64) as u32
                        };
                        __state = 41;
                    }
                    41 => {
                    ...
                    43 => {
                        {
                            let __p = unsafe { &mut (*p).i_divisor };
                            let __t = *__p;
                            *__p += 1;
                            __t
                        };
                    ...
                    44 => { rc = sqlite3_bitvec_set(p, i); __state = 46; }
                    45 => {
                        unsafe {
                            (*p).i_divisor =
                                ((512 as u64 -
                                                    ...
                                                    core::mem::size_of::<*mut Bitvec>() as u64 *
                                                core::mem::size_of::<*mut Bitvec>() as u64 /
                                            core::mem::size_of::<u8>() as u64 * 8 as u64) as u32
                        };
                        __state = 44;
                    }
                    46 => { j = 0 as u32; __state = 48; }
                    47 => {
                        unsafe {
                            sqlite3_db_free(core::ptr::null_mut(), ai_values as *mut ())
                        };
                        __state = 52;
                    }
                    48 => {
                    ...
                    49 => {
                        if unsafe { *ai_values.add(j as usize) } != 0 {
                            __state = 51;
                        } else { __state = 50; }
                    }
                    50 => {
                    ...
                    51 => {
                        rc |=
                            sqlite3_bitvec_set(p,
                                unsafe { *ai_values.add(j as usize) });
                        __state = 50;
                    }
                    52 => { return rc; }
                    53 => {
                        unsafe { (*p).u.a_hash[h as usize] = i };
                        __state = 54;
                    }
                    54 => { return 0; }
                    _ => {}
...
pub extern "C" fn sqlite3_bitvec_clear(mut p: *mut Bitvec, mut i: u32,
    ...
    unsafe {
        ...
        if unsafe { (*p).i_size } as u64 <=
            ...
            unsafe {
                (*p).u.a_bitmap[(i / 8 as u32) as usize] &=
                    !((1 << (i & (8 - 1) as u32)) as u8) as u8
            };
        } else {
            let mut j: u32 = 0 as u32;
            let ai_values: *mut u32 = p_buf as *mut u32;
            unsafe {
                memcpy(ai_values as *mut (),
                    unsafe { &raw mut (*p).u.a_hash[0 as usize] } as *mut u32 as
                        *const (), core::mem::size_of::<[u32; 124]>() as u64)
            ...
            unsafe {
                memset(unsafe { &raw mut (*p).u.a_hash[0 as usize] } as
                            *mut u32 as *mut (), 0,
                    core::mem::size_of::<[u32; 124]>() as u64)
            };
            unsafe { (*p).n_set = 0 as u32 };
            {
                j = 0 as u32;
                '__b5: loop {
                    if !((j as u64) <
                    ...
                    '__c5: loop {
                        if unsafe { *ai_values.add(j as usize) } != 0 &&
                                unsafe { *ai_values.add(j as usize) } != i + 1 as u32 {
                            let mut h: u32 =
                                (((unsafe { *ai_values.add(j as usize) } - 1 as u32) *
                                                1 as u32) as u64 %
                                        ((512 as u64 -
                                                        3 as u64 * core::mem::size_of::<u32>() as u64) /
                                                    core::mem::size_of::<*mut Bitvec>() as u64 *
...
pub extern "C" fn sqlite3_bitvec_builtin_test(sz: i32, a_op: *mut i32)
    ...
    let mut p_v: *mut u8 = core::ptr::null_mut();
    let mut rc: i32 = 0;
    let mut i: i32 = 0;
    let mut nx: i32 = 0;
    let mut pc: i32 = 0;
    let mut op: i32 = 0;
    let mut p_tmp_space: *mut () = core::ptr::null_mut();
    let mut __state: i32 = 0;
    loop {
        if __state == 1 { break; }
        '__s9:
            {
            match __state {
                0 => { p_bitvec = core::ptr::null_mut(); __state = 3; }
                2 => { unsafe { sqlite3_free(p_tmp_space) }; __state = 60; }
                3 => { p_v = core::ptr::null_mut(); __state = 4; }
                4 => { rc = -1; __state = 5; }
                5 => { __state = 6; }
                6 => { __state = 7; }
                7 => { if sz <= 0 { __state = 9; } else { __state = 10; } }
                8 => {
                    p_tmp_space =
                        unsafe { sqlite3_malloc64(512 as sqlite3_uint64) };
                    __state = 13;
                }
                9 => {
                    p_bitvec = sqlite3_bitvec_create(2 as u32 * -sz as u32);
                    __state = 11;
                }
                10 => {
                    p_bitvec = sqlite3_bitvec_create(sz as u32);
                    __state = 12;
                }
                11 => { p_v = core::ptr::null_mut(); __state = 8; }
                12 => {
                    p_v =
                        unsafe {
                                sqlite3_malloc_zero(((7 as i64 + sz as i64) / 8 as i64 +
                                            1 as i64) as u64)
                            } as *mut u8;
                    __state = 8;
                }
                13 => {
                    if p_bitvec == core::ptr::null_mut() ||
                                p_tmp_space == core::ptr::null_mut() ||
                            p_v == core::ptr::null_mut() && sz > 0 {
                        __state = 15;
                    } else { __state = 14; }
                }
                14 => {
                    sqlite3_bitvec_set(core::ptr::null_mut(), 1 as u32);
                    __state = 16;
                }
                15 => { __state = 2; }
                16 => {
                    sqlite3_bitvec_clear(core::ptr::null_mut(), 1 as u32,
                        p_tmp_space);
                    __state = 17;
                }
                17 => { pc = { i = 0; i }; __state = 18; }
                18 => {
                    if { op = unsafe { *a_op.offset(pc as isize) }; op } != 0 {
                        __state = 20;
                    } else { __state = 19; }
                }
                19 => {
                    if !(p_v).is_null() { __state = 52; } else { __state = 53; }
                }
                20 => { if op >= 6 { __state = 22; } else { __state = 21; } }
                21 => {
                    '__s10:
                        {
                        match op {
                ...
                22 => {
                    { let __p = &mut pc; let __t = *__p; *__p += 1; __t };
                    __state = 23;
                }
                23 => { __state = 18; }
                24 => {
                    if {
                                let __p = unsafe { &mut *a_op.offset((pc + 1) as isize) };
                                *__p -= 1;
                                *__p
                            } > 0 {
                        __state = 40;
                ...
                32 => { __state = 36; }
                33 => {
                    i = unsafe { *a_op.offset((pc + 2) as isize) } - 1;
                    __state = 34;
                }
                34 => {
                    unsafe {
                        *a_op.offset((pc + 2) as isize) +=
                            unsafe { *a_op.offset((pc + 3) as isize) }
                    };
                    __state = 35;
                }
                35 => { __state = 24; }
                ...
                39 => { pc += nx; __state = 41; }
                40 => { nx = 0; __state = 39; }
                41 => { i = (i & 2147483647) % sz; __state = 42; }
                42 => {
                    if op & 1 != 0 { __state = 43; } else { __state = 44; }
                }
                43 => {
                    if !(p_v).is_null() { __state = 46; } else { __state = 45; }
                }
                44 => {
                    if !(p_v).is_null() { __state = 50; } else { __state = 49; }
                }
                45 => { if op != 5 { __state = 47; } else { __state = 18; } }
                46 => {
                    unsafe {
                        *p_v.offset((i + 1 >> 3) as isize) |=
                            (1 << (i + 1 & 7)) as u8
                    };
                    __state = 45;
                }
                47 => {
                    if sqlite3_bitvec_set(p_bitvec, (i + 1) as u32) != 0 {
                        __state = 48;
                    } else { __state = 18; }
                }
                48 => { __state = 2; }
                49 => {
                    sqlite3_bitvec_clear(p_bitvec, (i + 1) as u32, p_tmp_space);
                    __state = 18;
                }
                50 => {
                    unsafe {
                ...
                52 => {
                    rc =
                        ((sqlite3_bitvec_test(core::ptr::null_mut(), 0 as u32) +
                                            sqlite3_bitvec_test(p_bitvec, (sz + 1) as u32) +
                                        sqlite3_bitvec_test(p_bitvec, 0 as u32)) as u32 +
                                (sqlite3_bitvec_size(unsafe { &*p_bitvec }) - sz as u32)) as
                            i32;
                    __state = 54;
                }
                53 => { rc = 0; __state = 51; }
                54 => { i = 1; __state = 55; }
                55 => { if i <= sz { __state = 56; } else { __state = 51; } }
                56 => {
                    if (unsafe { *p_v.offset((i >> 3) as isize) } as i32 &
                                        1 << (i & 7) != 0) as i32 !=
                            sqlite3_bitvec_test(p_bitvec, i as u32) {
                        __state = 58;
                    } else { __state = 57; }
                }
                57 => {
                ...
                59 => { __state = 51; }
                60 => {
                    unsafe { sqlite3_free(p_v as *mut ()) };
                    __state = 61;
                }
                61 => { sqlite3_bitvec_destroy(p_bitvec); __state = 62; }
                62 => { return rc; }
                _ => {}
            }
        }
