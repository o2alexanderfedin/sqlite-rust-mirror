...
extern "C" fn expr_list_delete_nn(db: *mut sqlite3, p_list_1: *mut ExprList)
    ...
    let mut p_item: *const ExprList_item =
        unsafe { (*p_list_1).a.as_ptr() } as *const ExprList_item;
    { let _ = 0; };
    { let _ = 0; };
    '__b0: loop {
        '__c0: loop {
                ...
                '__c2: loop {
                    height_of_expr(unsafe {
                                (*(unsafe { (*p).a.as_ptr() } as
                                                *const ExprList_item).offset(i as isize)).p_expr
...
static mut zero_item: ExprList_item =
    ExprList_item {
            ...
            unsafe {
                    sqlite3_db_malloc_raw_nn(db,
                        core::mem::offset_of!(ExprList, a) as u64 +
                            4 as u64 * core::mem::size_of::<ExprList_item>() as u64)
                } as *mut ExprList;
        ...
        p_item =
            unsafe {
                &mut *(unsafe { (*p_list).a.as_ptr() } as
                                *mut ExprList_item).offset(0 as isize)
            };
                    ...
                    sqlite3_db_realloc(db, p_list_1 as *mut (),
                        core::mem::offset_of!(ExprList, a) as u64 +
                            unsafe { (*p_list_1).n_alloc } as u64 *
                                core::mem::size_of::<ExprList_item>() as u64)
                } as *mut ExprList;
        if p_new == core::ptr::null_mut() {
...
pub extern "C" fn sqlite3_expr_list_dup(db: *mut sqlite3, p: *const ExprList,
    ...
    let mut p_new: *mut ExprList = core::ptr::null_mut();
    let mut p_item: *mut ExprList_item = core::ptr::null_mut();
    let mut p_old_item: *const ExprList_item = core::ptr::null();
    let mut i: i32 = 0;
    ...
    p_item = unsafe { (*p_new).a.as_ptr() } as *mut ExprList_item;
    p_old_item = unsafe { (*p).a.as_ptr() } as *const ExprList_item;
    {
        i = 0;
        '__b5: loop {
...
pub extern "C" fn sqlite3_id_list_dup(db: *mut sqlite3, p: *const IdList)
    ...
    unsafe { (*p_new).n_id = unsafe { (*p).n_id } as i32 };
    {
        ...
        '__b6: loop {
            ...
            '__c6: loop {
                let p_new_item: *mut IdList_item =
                    unsafe {
                        &mut *(unsafe { (*p_new).a.as_ptr() } as
                                        *mut IdList_item).offset(i as isize)
                    };
                let p_old_item: *const IdList_item =
                    unsafe {
                        &*(unsafe { (*p).a.as_ptr() } as
                                        *const IdList_item).offset(i as isize)
                    };
                unsafe {
                    (*p_new_item).z_name =
                        unsafe {
            ...
            let n_byte: sqlite3_int64 =
                (core::mem::offset_of!(With, a) as u64 +
                        unsafe { (*p).n_cte } as u64 *
                            core::mem::size_of::<Cte>() as u64) as sqlite3_int64;
            p_ret =
            ...
            match __state {
                ...
                24 => {
                    unsafe {
                        (*(unsafe { (*p_list).a.as_ptr() } as
                                            *mut ExprList_item).offset((unsafe { (*p_list).n_expr } - 1)
                                            as isize)).z_e_name =
                            unsafe {
                ...
                27 => {
                    p_first =
                        unsafe {
                            (*(unsafe { (*p_list).a.as_ptr() } as
                                            *mut ExprList_item).offset(i_first as isize)).p_expr
                        };
                    __state = 28;
                }
    ...
    p_item =
        unsafe {
            &mut *(unsafe { (*p).a.as_ptr() } as
                            *mut ExprList_item).offset((unsafe { (*p).n_expr } - 1) as
                            isize)
        };
    { let _ = 0; };
...
extern "C" fn expr_compare_variable(p_parse_1: &Parse, p_var_1: &Expr,
    ...
    let mut res: i32 = 2;
    let mut i_var: i32 = 0;
    let mut p_l: *mut sqlite3_value = core::ptr::null_mut();
    let mut p_r: *mut sqlite3_value = core::ptr::null_mut();
    ...
    }
    {
        ...
        '__b13: loop {
            ...
            '__c13: loop {
                ...
                if unsafe {
                                (*(unsafe { (*p_a).a.as_ptr() } as
                                                    *const ExprList_item).offset(i as isize)).fg.sort_flags
                            } as i32 !=
                        unsafe {
                                (*(unsafe { (*p_b).a.as_ptr() } as
                                                    *const ExprList_item).offset(i as isize)).fg.sort_flags
            ...
            if op == 178 {
                ...
                return sqlite3_expr_affinity(unsafe {
                                (*(unsafe {
                                                ...
                                                *mut ExprList_item).offset(unsafe { (*p_expr).i_column } as
                                                isize)).p_expr
                            } as *const Expr);
            }
            if op == 177 ||
...
pub extern "C" fn sqlite3_expr_code_run_just_once(p_parse: *mut Parse,
    ...
    unsafe {
        ...
        if reg_dest < 0 && !(p).is_null() {
            ...
            {
                {
                    p_item = unsafe { (*p).a.as_ptr() } as *mut ExprList_item;
                    i = unsafe { (*p).n_expr }
                };
                '__b19: loop {
                    if !(i > 0) { break '__b19; }
        ...
        if p_expr != core::ptr::null_mut() &&
            ...
            if !(p).is_null() {
                let p_item_1: *mut ExprList_item =
                    unsafe {
                        &mut *(unsafe { (*p).a.as_ptr() } as
                                        *mut ExprList_item).offset((unsafe { (*p).n_expr } - 1) as
                                        isize)
            ...
            *pp_expr_1 =
                unsafe {
                    (*(unsafe {
                                    ...
                                    } as *mut ExprList_item).offset(i_field_1 as isize)).p_expr
                };
                    ...
                    }
                    {
                        ...
                        if !(p_val).is_null() {
                            if unsafe { sqlite3_value_type(p_val) } == 1 {
                                let vv: sqlite3_int64 =
                                    unsafe { sqlite3_value_int64(p_val) };
                                if vv == vv & 2147483647 as sqlite3_int64 {
...
pub extern "C" fn sqlite3_expr_code_expr_list(p_parse: *mut Parse,
    ...
    unsafe {
        ...
        {
            { p_item = (*p_list).a.as_ptr() as *mut ExprList_item; i = 0 };
            '__b31: loop {
                if !(i < n) { break '__b31; }
                '__c31: loop {
...
pub extern "C" fn sqlite3_expr_code_target(p_parse: *mut Parse,
    ...
    unsafe {
        ...
        let mut a_listelem: *const ExprList_item = core::ptr::null();
                ...
                match __state {
                    ...
                    524 => {
                        sqlite3_expr_code(p_parse,
                            unsafe {
                                (*(unsafe { (*p_e_list).a.as_ptr() } as
                                                *mut ExprList_item).offset((n_expr - 1) as isize)).p_expr
                            }, target);
                        __state = 523;
                    }
                    525 => {
        ...
        sqlite3_expr_code_copy(p_parse,
            unsafe {
                (*(unsafe { (*(*p_idx).a_col_expr).a.as_ptr() } as
                                *mut ExprList_item).offset(i_idx_col as isize)).p_expr
            }, reg_out);
        unsafe { (*p_parse).i_self_tab = 0 };
    } else {
    ...
    (*p_info_1).a_col =
        unsafe {
                sqlite3_array_allocate(db, (*p_info_1).a_col as *mut (),
                    core::mem::size_of::<AggInfo_col>() as i32,
...
extern "C" fn find_or_create_agg_info_column(p_parse_1: *mut Parse,
    ...
    unsafe {
        let mut p_col: *mut AggInfo_col = core::ptr::null_mut();
        let mut k: i32 = 0;
        let mut mx_term: i32 = 0;
        let mut j: i32 = 0;
        let mut n: i32 = 0;
        let mut p_gb: *mut ExprList = core::ptr::null_mut();
        let mut p_term: *const ExprList_item = core::ptr::null();
        ...
        loop {
            ...
            '__s58:
                ...
                match __state {
                    ...
                    33 => {
                        p_term =
                            unsafe { (*p_gb).a.as_ptr() } as *mut ExprList_item as
                                *const ExprList_item;
                        __state = 34;
                    }
    ...
    (*p_info_1).a_func =
        unsafe {
                sqlite3_array_allocate(db, (*p_info_1).a_func as *mut (),
                    core::mem::size_of::<AggInfo_func>() as i32,
                ...
                179 => {
                    ...
                    }
                    {
                        if unsafe { (*p_nc).nc_flags } & 131072 == 0 &&
                                ...
                                unsafe { (*p_expr_1).p_agg_info } == core::ptr::null_mut() {
                            let mut p_item_1: *mut AggInfo_func =
