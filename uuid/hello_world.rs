...
extern "C" fn sqlite3_uuid_hex_to_int(mut h: i32) -> u8 {
    if !(h >= '0' as i32 && h <= '9' as i32 ||
                            ...
                            h >= 'A' as i32 && h <= 'F' as i32) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"sqlite3UuidHexToInt".as_ptr() as *const i8,
                c"uuid.c".as_ptr() as *mut i8 as *const i8, 77,
                c"(h>=\'0\' && h<=\'9\') || (h>=\'a\' && h<=\'f\') || (h>=\'A\' && h<=\'F\')".as_ptr()
...
extern "C" fn sqlite3_uuid_blob_to_str(a_blob_1: *const u8,
    ...
    k = 0;
    {
        ...
        '__b0: loop {
            ...
            '__c0: loop {
                if k & 1 != 0 {
                    unsafe { *z_str_1.offset(0 as isize) = '-' as i32 as u8 };
                    {
                        let __p = &mut z_str_1;
                        let __t = *__p;
                ...
                x = unsafe { *a_blob_1.offset(i as isize) } as u8;
                unsafe {
                    *z_str_1.offset(0 as isize) =
                        z_digits[(x as i32 >> 4) as usize] as u8
                };
                unsafe {
                    *z_str_1.offset(1 as isize) =
                        z_digits[(x as i32 & 15) as usize] as u8
                };
                {
                    let __n = 2;
                    let __p = &mut z_str_1;
...
extern "C" fn sqlite3_uuid_str_to_blob(mut z_str_1: *const u8,
    a_blob_1: *mut u8) -> i32 {
    let mut i: i32 = 0;
    if z_str_1 == core::ptr::null() { return 1; }
    ...
    }
    {
        ...
        '__b1: loop {
            ...
            '__c1: loop {
                ...
                if unsafe {
                                isxdigit(unsafe { *z_str_1.offset(0 as isize) } as i32)
                            } != 0 &&
                        unsafe {
                                isxdigit(unsafe { *z_str_1.offset(1 as isize) } as i32)
                            } != 0 {
                    unsafe {
                        *a_blob_1.offset(i as isize) =
                            (((sqlite3_uuid_hex_to_int(unsafe {
                                                            *z_str_1.offset(0 as isize)
                                                        } as i32) as i32) << 4) +
                                    sqlite3_uuid_hex_to_int(unsafe {
                                                    *z_str_1.offset(1 as isize)
...
extern "C" fn sqlite3_uuid_input_to_blob(p_in_1: *mut sqlite3_value,
    p_buf_1: *mut u8) -> *const u8 {
    '__s2:
        {
        match unsafe { sqlite3_value_type(p_in_1) } {
            3 => {
                {
                    let z: *const u8 = unsafe { sqlite3_value_text(p_in_1) };
                    if sqlite3_uuid_str_to_blob(z, p_buf_1) != 0 {
                        return core::ptr::null();
                    }
                    return p_buf_1 as *const u8;
                }
                {
                    let n: i32 = unsafe { sqlite3_value_bytes(p_in_1) };
                    return if n == 16 {
                                unsafe { sqlite3_value_blob(p_in_1) }
                            } else { core::ptr::null() } as *const u8;
                }
                { return core::ptr::null(); }
            }
            4 => {
...
extern "C" fn sqlite3_uuid_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut a_blob: [u8; 16] = [0; 16];
    let mut z_str: [u8; 37] = [0; 37];
    { let _ = argc; };
    { let _ = argv; };
    unsafe {
        sqlite3_randomness(16,
            &raw mut a_blob[0 as usize] as *mut u8 as *mut ())
    };
    a_blob[6 as usize] = ((a_blob[6 as usize] as i32 & 15) + 64) as u8;
    a_blob[8 as usize] = ((a_blob[8 as usize] as i32 & 63) + 128) as u8;
    sqlite3_uuid_blob_to_str(&raw mut a_blob[0 as usize] as *mut u8 as
            *const u8, &raw mut z_str[0 as usize] as *mut u8);
    unsafe {
        sqlite3_result_text(context,
            &raw mut z_str[0 as usize] as *mut i8 as *const i8, 36,
            Some(unsafe {
...
extern "C" fn sqlite3_uuid_str_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut a_blob: [u8; 16] = [0; 16];
    let mut z_str: [u8; 37] = [0; 37];
    ...
    { let _ = argc; };
    p_blob =
        sqlite3_uuid_input_to_blob(unsafe { *argv.offset(0 as isize) },
            &raw mut a_blob[0 as usize] as *mut u8);
    if p_blob == core::ptr::null() { return; }
    sqlite3_uuid_blob_to_str(p_blob, &raw mut z_str[0 as usize] as *mut u8);
    unsafe {
        sqlite3_result_text(context,
            &raw mut z_str[0 as usize] as *mut i8 as *const i8, 36,
            Some(unsafe {
...
extern "C" fn sqlite3_uuid_blob_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut a_blob: [u8; 16] = [0; 16];
    let mut p_blob: *const u8 = core::ptr::null();
    { let _ = argc; };
    ...
    if p_blob == core::ptr::null() { return; }
    unsafe {
        sqlite3_result_blob(context, p_blob as *const (), 16,
            Some(unsafe {
                    core::mem::transmute::<*const (),
                            unsafe extern "C" fn(*mut ())
                                -> ()>(-1 as isize as *const ())
...
pub extern "C" fn sqlite3_uuid_init(db: *mut sqlite3,
    ...
    if rc == 0 {
        rc =
            unsafe {
                sqlite3_create_function(db,
                    c"uuid_str".as_ptr() as *mut i8 as *const i8, 1,
                    1 | 2097152 | 2048, core::ptr::null_mut(),
                    Some(sqlite3_uuid_str_func), None, None)
            };
    }
    if rc == 0 {
        rc =
            unsafe {
                sqlite3_create_function(db,
                    c"uuid_blob".as_ptr() as *mut i8 as *const i8, 1,
                    1 | 2097152 | 2048, core::ptr::null_mut(),
                    Some(sqlite3_uuid_blob_func), None, None)
            };
    }
    return rc;
}
