    ...
    let mut i: i32 = 0;
    {
        ...
        '__b0: loop {
            ...
            '__c0: loop {
                ...
                if unsafe { *a_change_1.offset(i_child_key as isize) } >= 0 {
                    return 1;
                }
                if i_child_key == (*p_tab_1).i_p_key as i32 &&
                        b_chng_rowid_1 != 0 {
                    return 1;
                }
                break '__c0;
...
pub extern "C" fn sqlite3_fk_locate_index(p_parse: *mut Parse,
    ...
    unsafe {
        ...
        { let _ = 0; };
        if n_col == 1 {
            if (*p_parent).i_p_key as i32 >= 0 {
                if (z_key).is_null() as i32 != 0 { return 0; }
                if (unsafe {
                                    sqlite3_str_i_cmp(unsafe {
                                                (*(*p_parent).a_col.offset((*p_parent).i_p_key as
                                                                isize)).z_cn_name
                                            } as *const i8, z_key as *const i8)
                                } == 0) as i32 != 0 {
                    return 0;
                }
            }
        } else if !(pai_col).is_null() {
            { let _ = 0; };
            ai_col =
                unsafe {
                        sqlite3_db_malloc_raw_nn(unsafe { (*p_parse).db },
                            n_col as u64 * core::mem::size_of::<i32>() as u64)
                    } as *mut i32;
            if (ai_col).is_null() as i32 != 0 { return 1; }
            unsafe { *pai_col = ai_col };
        }
        {
            p_idx = (*p_parent).p_index;
            '__b1: loop {
                if !(!(p_idx).is_null()) { break '__b1; }
                '__c1: loop {
                    if unsafe { (*p_idx).n_key_col } as i32 == n_col &&
                                unsafe { (*p_idx).on_error } as i32 != 0 &&
                            unsafe { (*p_idx).p_part_idx_where } ==
                                core::ptr::null_mut() {
                        if z_key == core::ptr::null_mut() {
                            if unsafe { (*p_idx).idx_type() } as i32 == 2 {
                                if !(ai_col).is_null() {
                                    let mut i: i32 = 0;
                                    {
                                        i = 0;
                                        '__b2: loop {
                                            if !(i < n_col) { break '__b2; }
                                            '__c2: loop {
                                                unsafe {
                                                    *ai_col.offset(i as isize) =
                                                        unsafe {
                                                            (*((*p_f_key).a_col.as_ptr() as
                                                                            *mut sColMap).offset(i as isize)).i_from
                                                        }
                            ...
                            let mut j: i32 = 0;
                            {
                                ...
                                '__b3: loop {
                                    ...
                                    '__c3: loop {
                                        ...
                                        z_idx_col =
                                            unsafe {
                                                (*(*p_parent).a_col.offset(i_col as isize)).z_cn_name
                                            };
                                        {
                                            j = 0;
                                            '__b4: loop {
                                                if !(j < n_col) { break '__b4; }
                                                '__c4: loop {
                                                    if unsafe {
                                                                sqlite3_str_i_cmp(unsafe {
                                                                            (*((*p_f_key).a_col.as_ptr() as
                                                                                            *mut sColMap).offset(j as isize)).z_col
                                                                        } as *const i8, z_idx_col as *const i8)
                                                            } == 0 {
                                                        if !(ai_col).is_null() {
                                                            unsafe {
                                                                *ai_col.offset(i as isize) =
                                                                    unsafe {
                                                                        (*((*p_f_key).a_col.as_ptr() as
                                                                                        *mut sColMap).offset(j as isize)).i_from
                                                                    }
                                                            };
                                                        }
                                                        break '__b4;
                                        ...
                                        if j == n_col { break '__b3; }
                                        break '__c3;
                                    }
                                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                                }
                            }
                            if i == n_col { break '__b1; }
                        }
                    }
                    break '__c1;
                }
        ...
        if (p_idx).is_null() as i32 != 0 {
            if (unsafe { (*p_parse).disable_triggers() } == 0) as i32 != 0 {
                unsafe {
                    sqlite3_error_msg(p_parse,
                        c"foreign key mismatch - \"%w\" referencing \"%w\"".as_ptr()
                                as *mut i8 as *const i8,
                        unsafe { (*(*p_f_key).p_from).z_name }, (*p_f_key).z_to)
                };
            }
            unsafe {
                sqlite3_db_free(unsafe { (*p_parse).db }, ai_col as *mut ())
            };
            return 1;
        }
        *pp_idx = p_idx;
...
extern "C" fn fk_lookup_parent(p_parse_1: *mut Parse, i_db_1: i32,
    ...
    if n_incr_1 < 0 {
        unsafe {
            sqlite3_vdbe_add_op2(v, 60, (*p_f_key_1).is_deferred as i32, i_ok)
        };
    }
    {
        i = 0;
        '__b5: loop {
            if !(i < (*p_f_key_1).n_col) { break '__b5; }
            '__c5: loop {
                let i_reg: i32 =
                    unsafe {
                                    sqlite3_table_column_to_storage((*p_f_key_1).p_from,
                                        unsafe { *ai_col_1.offset(i as isize) } as i16)
                                } as i32 + reg_data_1 + 1;
                unsafe { sqlite3_vdbe_add_op2(v, 51, i_reg, i_ok) };
                break '__c5;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
        }
        ...
        if p_idx_1 == core::ptr::null_mut() {
            ...
            unsafe {
                sqlite3_vdbe_add_op2(v, 83,
                    unsafe {
                                    sqlite3_table_column_to_storage((*p_f_key_1).p_from,
                                        unsafe { *ai_col_1.offset(0 as isize) } as i16)
                                } as i32 + 1 + reg_data_1, reg_temp)
            };
            i_must_be_int =
                unsafe { sqlite3_vdbe_add_op2(v, 13, reg_temp, 0) };
            if p_tab_1 == (*p_f_key_1).p_from && n_incr_1 == 1 {
                unsafe {
                    sqlite3_vdbe_add_op3(v, 54, reg_data_1, i_ok, reg_temp)
                };
                unsafe { sqlite3_vdbe_change_p5(v, 144 as u16) };
            }
            unsafe {
                sqlite3_open_table(p_parse_1, i_cur, i_db_1, p_tab_1, 114)
            };
            unsafe { sqlite3_vdbe_add_op3(v, 31, i_cur, 0, reg_temp) };
            unsafe { sqlite3_vdbe_goto(v, i_ok) };
            unsafe {
                sqlite3_vdbe_jump_here(v,
                    unsafe { sqlite3_vdbe_current_addr(v) } - 2)
            };
            unsafe { sqlite3_vdbe_jump_here(v, i_must_be_int) };
            unsafe { sqlite3_release_temp_reg(p_parse_1, reg_temp) };
        } else {
            let n_col: i32 = (*p_f_key_1).n_col;
            let reg_temp_1: i32 =
                unsafe { sqlite3_get_temp_range(p_parse_1, n_col) };
            unsafe {
                sqlite3_vdbe_add_op3(v, 114, i_cur,
                    unsafe { (*p_idx_1).tnum } as i32, i_db_1)
            };
            unsafe { sqlite3_vdbe_set_p4_key_info(p_parse_1, p_idx_1) };
            {
                i = 0;
                '__b6: loop {
                        ...
                        unsafe {
                            sqlite3_vdbe_add_op2(v, 82,
                                unsafe {
                                                sqlite3_table_column_to_storage((*p_f_key_1).p_from,
                                                    unsafe { *ai_col_1.offset(i as isize) } as i16)
                                            } as i32 + 1 + reg_data_1, reg_temp_1 + i)
                        };
                        break '__c6;
                    }
                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
            ...
            if p_tab_1 == (*p_f_key_1).p_from && n_incr_1 == 1 {
                let i_jump: i32 =
                    unsafe { sqlite3_vdbe_current_addr(v) } + n_col + 1;
                {
                    i = 0;
                    '__b7: loop {
                        ...
                        '__c7: loop {
                            ...
                            let mut i_parent: i32 = 1 + reg_data_1;
                            i_parent +=
                                unsafe {
                                        sqlite3_table_column_to_storage(unsafe {
                                                (*p_idx_1).p_table
                                            },
                                            unsafe {
            ...
            unsafe {
                sqlite3_vdbe_add_op4(v, 98, reg_temp_1, n_col, 0,
                    unsafe {
            ...
            unsafe {
                sqlite3_vdbe_add_op4_int(v, 29, i_cur, i_ok, reg_temp_1,
                    n_col)
            };
            unsafe {
                sqlite3_release_temp_range(p_parse_1, reg_temp_1, n_col)
            };
        }
    }
    if ((*p_f_key_1).is_deferred == 0) as i32 != 0 &&
                    (unsafe { (*unsafe { (*p_parse_1).db }).flags } &
        ...
        unsafe {
            sqlite3_halt_constraint(p_parse_1, 19 | 3 << 8, 2,
                core::ptr::null_mut(), -1 as i8, 4 as u8)
        };
    } else {
        if n_incr_1 > 0 && (*p_f_key_1).is_deferred as i32 == 0 {
            unsafe { sqlite3_may_abort(p_parse_1) };
        }
        unsafe {
            sqlite3_vdbe_add_op2(v, 160, (*p_f_key_1).is_deferred as i32,
                n_incr_1)
        };
    }
...
extern "C" fn is_set_null_action(p_parse_1: *mut Parse, p_f_key_1: &FKey)
    ...
    if !(unsafe { (*p_top).p_trigger_prg }).is_null() {
        let p: *mut Trigger =
            unsafe { (*unsafe { (*p_top).p_trigger_prg }).p_trigger };
        if p == (*p_f_key_1).ap_trigger[0 as usize] &&
                    (*p_f_key_1).a_action[0 as usize] as i32 == 8 ||
                p == (*p_f_key_1).ap_trigger[1 as usize] &&
                    (*p_f_key_1).a_action[1 as usize] as i32 == 8 {
            { let _ = 0; };
            return 1;
        }
    }
    ...
    unsafe {
        return unsafe {
                    sqlite3_hash_find(unsafe {
                                &raw mut (*(*p_tab).p_schema).fkey_hash
                            } as *const Hash, (*p_tab).z_name as *const i8)
                } as *mut FKey;
    }
}
        ...
        '__b8: loop {
            ...
            '__c8: loop {
                ...
                let mut i_key: i32 = 0;
                {
                    i_key = 0;
                    '__b9: loop {
                        if !(i_key < (*p_tab_1).n_col as i32) { break '__b9; }
                        '__c9: loop {
                            if unsafe { *a_change_1.offset(i_key as isize) } >= 0 ||
                                    i_key == (*p_tab_1).i_p_key as i32 && b_chng_rowid_1 != 0 {
                                let p_col: *const Column =
                                    unsafe { &raw mut *(*p_tab_1).a_col.offset(i_key as isize) }
                                        as *const Column;
                                if !(z_key).is_null() {
                                    if 0 ==
                                            unsafe {
                                                sqlite3_str_i_cmp(unsafe { (*p_col).z_cn_name } as
                                                        *const i8, z_key as *const i8)
                                            } {
                                        return 1;
                                    }
                                } else if unsafe { (*p_col).col_flags } as i32 & 1 != 0 {
                                    return 1;
                                }
                            }
                            break '__c9;
...
extern "C" fn expr_table_register(p_parse_1: *const Parse,
    ...
    p_expr = unsafe { sqlite3_expr(db, 176, core::ptr::null()) };
    if !(p_expr).is_null() {
        if i_col_1 as i32 >= 0 &&
                i_col_1 as i32 != unsafe { (*p_tab_1).i_p_key } as i32 {
            p_col =
                unsafe {
                    unsafe { (*p_tab_1).a_col.offset(i_col_1 as isize) }
                };
            unsafe {
                (*p_expr).i_table =
                    reg_base_1 +
                            unsafe { sqlite3_table_column_to_storage(p_tab_1, i_col_1) }
                                as i32 + 1
            };
            unsafe { (*p_expr).aff_expr = unsafe { (*p_col).affinity } };
            z_coll = unsafe { sqlite3_column_coll(p_col) };
            if z_coll == core::ptr::null() {
                z_coll =
                    unsafe { (*unsafe { (*db).p_dflt_coll }).z_name } as
                        *const i8;
            }
            p_expr =
                unsafe {
            ...
            unsafe { (*p_expr).i_table = reg_base_1 };
            unsafe { (*p_expr).aff_expr = 68 as i8 };
        }
    }
    return p_expr;
}
extern "C" fn expr_table_column(db: *mut sqlite3, p_tab_1: *mut Table,
    ...
    unsafe {
        let p_expr: *mut Expr =
            unsafe { sqlite3_expr(db, 168, core::ptr::null()) };
        if !(p_expr).is_null() {
            { let _ = 0; };
            unsafe { (*p_expr).y.p_tab = p_tab_1 };
            unsafe { (*p_expr).i_table = i_cursor_1 };
            unsafe { (*p_expr).i_column = i_col_1 };
        }
        return p_expr;
    }
}
extern "C" fn fk_scan_children(p_parse_1: *mut Parse, p_src_1: *mut SrcList,
    ...
    unsafe {
        ...
        if n_incr_1 < 0 {
            i_fk_if_zero =
                unsafe {
                    sqlite3_vdbe_add_op2(v, 60, (*p_f_key_1).is_deferred as i32,
                        0)
                };
        }
        {
            ...
            '__b10: loop {
                ...
                '__c10: loop {
                    ...
                    i_col =
                        if !(ai_col_1).is_null() {
                                unsafe { *ai_col_1.offset(i as isize) }
                            } else {
                                unsafe {
                                    (*((*p_f_key_1).a_col.as_ptr() as
                    ...
                    z_col =
                        unsafe {
                                (*unsafe {
                                            (*(*p_f_key_1).p_from).a_col.offset(i_col as isize)
                                        }).z_cn_name
                            } as *const i8;
                    p_right = unsafe { sqlite3_expr(db, 60, z_col) };
                    p_eq =
                        unsafe { sqlite3_p_expr(p_parse_1, 54, p_left, p_right) };
                    p_where =
            ...
            if unsafe { (*p_tab_1).tab_flags } & 128 as u32 == 0 as u32 {
                p_left_1 =
                    expr_table_register(p_parse_1 as *const Parse, p_tab_1,
                        reg_data_1, -1 as i16);
                p_right_1 =
                    expr_table_column(db, p_tab_1,
                        unsafe {
                            (*(unsafe { (*p_src_1).a.as_ptr() } as
                                            *mut SrcItem).offset(0 as isize)).i_cursor
                        }, -1 as i16);
                p_ne =
                    unsafe {
                        sqlite3_p_expr(p_parse_1, 53, p_left_1, p_right_1)
                    };
            } else {
                let mut p_eq_1: *mut Expr = core::ptr::null_mut();
                let mut p_all: *mut Expr = core::ptr::null_mut();
                { let _ = 0; };
                {
                    i = 0;
                    '__b11: loop {
                        if !(i < unsafe { (*p_idx_1).n_key_col } as i32) {
                            break '__b11;
                        }
                        '__c11: loop {
                            let i_col_1: i16 =
                            ...
                            p_right_1 =
                                unsafe {
                                    sqlite3_expr(db, 60,
                                        unsafe {
                                                (*unsafe {
                                                            (*p_tab_1).a_col.offset(i_col_1 as isize)
                                                        }).z_cn_name
                                            } as *const i8)
                                };
                            p_eq_1 =
                                unsafe {
                                    sqlite3_p_expr(p_parse_1, 45, p_left_1, p_right_1)
                                };
                            p_all =
                                unsafe { sqlite3_expr_and(p_parse_1, p_all, p_eq_1) };
                            break '__c11;
                        }
                        { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                    }
                ...
                p_ne =
                    unsafe {
                        sqlite3_p_expr(p_parse_1, 19, p_all, core::ptr::null_mut())
                    };
            }
        ...
        s_name_context.p_src_list = p_src_1;
        s_name_context.p_parse = p_parse_1;
        unsafe { sqlite3_resolve_expr_names(&mut s_name_context, p_where) };
        if unsafe { (*p_parse_1).n_err } == 0 {
            p_w_info =
                unsafe {
                    sqlite3_where_begin(p_parse_1, p_src_1, p_where,
                        core::ptr::null_mut(), core::ptr::null_mut(),
                        core::ptr::null_mut(), 0 as u16, 0)
                };
            unsafe {
                sqlite3_vdbe_add_op2(v, 160, (*p_f_key_1).is_deferred as i32,
                    n_incr_1)
...
pub extern "C" fn sqlite3_fk_check(p_parse: *mut Parse, p_tab: *mut Table,
    ...
    unsafe {
                ...
                } as *const i8;
        {
            ...
            '__b12: loop {
                ...
                '__c12: loop {
                    ...
                    if !(a_change).is_null() &&
                                unsafe {
                                        sqlite3_stricmp(unsafe { (*p_tab).z_name } as *const i8,
                                            unsafe { (*p_f_key).z_to } as *const i8)
                                    } != 0 &&
                            fk_child_is_modified(unsafe { &*p_tab },
                                    unsafe { &*p_f_key }, a_change as *const i32, b_chng_rowid)
                                == 0 {
                        break '__c12;
                    }
                    if unsafe { (*p_parse).disable_triggers() } != 0 {
                        p_to =
                            unsafe {
                                sqlite3_find_table(db,
                                    unsafe { (*p_f_key).z_to } as *const i8, z_db)
                            };
                    } else {
                        p_to =
                            unsafe {
                    ...
                    if (p_to).is_null() as i32 != 0 ||
                            sqlite3_fk_locate_index(p_parse, unsafe { &*p_to },
                                    unsafe { &*p_f_key }, &mut p_idx, &mut ai_free) != 0 {
                        { let _ = 0; };
                        if (is_ignore_errors == 0) as i32 != 0 ||
                        ...
                        if p_to == core::ptr::null_mut() {
                            ...
                            let i_jump: i32 =
                                unsafe { sqlite3_vdbe_current_addr(v) } +
                                        unsafe { (*p_f_key).n_col } + 1;
                            {
                                i = 0;
                                '__b13: loop {
                                    if !(i < unsafe { (*p_f_key).n_col }) { break '__b13; }
                                    '__c13: loop {
                                        ...
                                        unsafe { sqlite3_vdbe_add_op2(v, 51, i_reg, i_jump) };
                                        break '__c13;
                                    }
                                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                                }
                            ...
                            unsafe {
                                sqlite3_vdbe_add_op2(v, 160,
                                    unsafe { (*p_f_key).is_deferred } as i32, -1)
                            };
                        }
                        break '__c12;
                    }
                    ...
                    }
                    {
                        i = 0;
                        '__b14: loop {
                            if !(i < unsafe { (*p_f_key).n_col }) { break '__b14; }
                            '__c14: loop {
                                if unsafe { *ai_col.offset(i as isize) } ==
                                        unsafe { (*p_tab).i_p_key } as i32 {
                                    unsafe { *ai_col.offset(i as isize) = -1 };
                                }
                                { let _ = 0; };
                                if unsafe { (*db).x_auth.is_some() } {
                                    ...
                                    let z_col: *const i8 =
                                        unsafe {
                                                (*unsafe {
                                                            (*p_to).a_col.offset(if !(p_idx).is_null() {
                                                                        (unsafe {
                                                                                *unsafe { (*p_idx).ai_column.offset(i as isize) }
                                                                            }) as i32
                                                                    } else { (unsafe { (*p_to).i_p_key }) as i32 } as isize)
                                                        }).z_cn_name
                                            } as *const i8;
                                    rcauth =
                                        unsafe {
                                            sqlite3_auth_read_col(p_parse,
                                                unsafe { (*p_to).z_name } as *const i8, z_col as *const i8,
                                                i_db)
                                        };
                                    b_ignore = (rcauth == 2) as i32;
                                }
                                break '__c14;
                            }
                            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                    ...
                    unsafe { sqlite3_db_free(db, ai_free as *mut ()) };
                    break '__c12;
                }
        ...
        {
            p_f_key = sqlite3_fk_references(unsafe { &*p_tab });
            '__b15: loop {
                ...
                '__c15: loop {
                    ...
                    if !(a_change).is_null() &&
                            fk_parent_is_modified(unsafe { &*p_tab },
                                    unsafe { &*p_f_key }, a_change as *const i32, b_chng_rowid)
                                == 0 {
                        break '__c15;
                    }
                    if (unsafe { (*p_f_key).is_deferred } == 0) as i32 != 0 &&
                                    (unsafe { (*db).flags } & 524288 as u64 == 0) as i32 != 0 &&
                    ...
                    if sqlite3_fk_locate_index(p_parse, unsafe { &*p_tab },
                                unsafe { &*p_f_key }, &mut p_idx_1, &mut ai_col_1) != 0 {
                        if (is_ignore_errors == 0) as i32 != 0 ||
                                unsafe { (*db).malloc_failed } != 0 {
                            return;
                        }
                    ...
                    if !(p_src).is_null() {
                        ...
                        unsafe { (*p_item).p_s_tab = unsafe { (*p_f_key).p_from } };
                        unsafe {
                            (*p_item).z_name =
                                unsafe { (*unsafe { (*p_f_key).p_from }).z_name }
                        };
                        {
                            let __p =
                                unsafe { &mut (*unsafe { (*p_item).p_s_tab }).n_tab_ref };
                            let __t = *__p;
                            *__p += 1;
                            __t
                        };
                        ...
                        if reg_new != 0 {
                            fk_scan_children(p_parse, p_src, p_tab,
                                p_idx_1 as *const Index, unsafe { &*p_f_key },
                                ai_col_1 as *const i32, reg_new, -1);
                        }
                        if reg_old != 0 {
                            let mut e_action: i32 =
                                unsafe {
                                        (*p_f_key).a_action[(a_change != core::ptr::null_mut()) as
                                                usize]
                                    } as i32;
                            if unsafe { (*db).flags } & (8 as u64) << 32 != 0 {
                                e_action = 0;
                            }
                            fk_scan_children(p_parse, p_src, p_tab,
                                p_idx_1 as *const Index, unsafe { &*p_f_key },
                                ai_col_1 as *const i32, reg_old, 1);
                            if (unsafe { (*p_f_key).is_deferred } == 0) as i32 != 0 &&
                                        e_action != 10 && e_action != 8 {
                                unsafe { sqlite3_may_abort(p_parse) };
                            }
                        }
                        unsafe { (*p_item).z_name = core::ptr::null_mut() };
                        unsafe { sqlite3_src_list_delete(db, p_src) };
                    }
                    unsafe { sqlite3_db_free(db, ai_col_1 as *mut ()) };
                    break '__c15;
                }
                p_f_key = unsafe { (*p_f_key).p_next_to };
            }
        }
    }
}
            ...
            if sqlite3_fk_references(unsafe { &*p_tab }) ==
                ...
                let mut p: *const FKey = core::ptr::null();
                {
                    ...
                    '__b16: loop {
                        ...
                        '__c16: loop {
                            if unsafe { (*p).is_deferred } != 0 ||
                                    unsafe { (*db).flags } & 524288 as u64 != 0 {
                                break '__b16;
                            }
                            break '__c16;
                        }
                        p = unsafe { (*p).p_next_from };
                    }
                }
                if (p).is_null() as i32 != 0 { return; }
                i_skip = unsafe { sqlite3_vdbe_make_label(p_parse) };
                unsafe { sqlite3_vdbe_add_op2(v, 60, 1, i_skip) };
            }
            unsafe { (*p_parse).set_disable_triggers(1 as bft as u32) };
            unsafe {
                sqlite3_delete_from(p_parse,
                    unsafe {
                        sqlite3_src_list_dup(db, p_name as *const SrcList, 0)
                    }, core::ptr::null_mut(), core::ptr::null_mut(),
                    core::ptr::null_mut())
            };
            unsafe { (*p_parse).set_disable_triggers(0 as bft as u32) };
            if unsafe { (*db).flags } & 524288 as u64 == 0 as u64 {
                unsafe {
                    sqlite3_vdbe_add_op2(v, 60, 0,
                        unsafe { sqlite3_vdbe_current_addr(v) } + 2)
                };
                unsafe {
                    sqlite3_halt_constraint(p_parse, 19 | 3 << 8, 2,
                        core::ptr::null_mut(), -1 as i8, 4 as u8)
                };
            }
            if i_skip != 0 {
                unsafe { sqlite3_vdbe_resolve_label(v, i_skip) };
            }
        }
    }
}
extern "C" fn fk_trigger_delete(db_mem_1: *mut sqlite3, p: *mut Trigger)
    ...
    unsafe {
        if !(p).is_null() {
            let p_step: *const TriggerStep =
                unsafe { (*p).step_list } as *const TriggerStep;
            unsafe {
                sqlite3_src_list_delete(db_mem_1, unsafe { (*p_step).p_src })
            };
            unsafe {
                sqlite3_expr_delete(db_mem_1, unsafe { (*p_step).p_where })
            };
            unsafe {
                sqlite3_expr_list_delete(db_mem_1,
                    unsafe { (*p_step).p_expr_list })
            };
            unsafe {
                sqlite3_select_delete(db_mem_1, unsafe { (*p_step).p_select })
            };
            unsafe { sqlite3_expr_delete(db_mem_1, unsafe { (*p).p_when }) };
            unsafe { sqlite3_db_free(db_mem_1, p as *mut ()) };
        }
    }
}
    ...
    unsafe {
        ...
        if action != 0 && (p_trigger).is_null() as i32 != 0 {
            ...
            { let _ = 0; };
            {
                i = 0;
                '__b17: loop {
                    if !(i < unsafe { (*p_f_key_1).n_col }) { break '__b17; }
                    '__c17: loop {
                        let mut t_old: Token =
                        ...
                        { let _ = 0; };
                        unsafe {
                            sqlite3_token_init(&mut t_to_col,
                                unsafe {
                                    (*unsafe {
                                                (*p_tab_1).a_col.offset(if !(p_idx).is_null() {
                                                            (unsafe {
                                                                    *unsafe { (*p_idx).ai_column.offset(i as isize) }
                                                                }) as i32
                                                        } else { (unsafe { (*p_tab_1).i_p_key }) as i32 } as isize)
                                            }).z_cn_name
                                })
                        };
                        unsafe {
                            sqlite3_token_init(&mut t_from_col,
                                unsafe {
                                    (*unsafe {
                                                (*unsafe {
                                                                    (*p_f_key_1).p_from
                                                                }).a_col.offset(i_from_col as isize)
                                            }).z_cn_name
                                })
                        };
                        p_eq =
                            unsafe {
                                sqlite3_p_expr(p_parse_1, 54,
                                    unsafe {
                                        sqlite3_p_expr(p_parse_1, 142,
                                            unsafe {
                                                sqlite3_expr_alloc(db, 60, &raw mut t_old as *const Token,
                                                    0)
                                            },
                                            unsafe {
                                                sqlite3_expr_alloc(db, 60,
                                                    &raw mut t_to_col as *const Token, 0)
                                            })
                                    },
                                    unsafe {
                                        sqlite3_expr_alloc(db, 60,
                        ...
                        if !(p_changes_1).is_null() {
                                ...
                                unsafe {
                                    sqlite3_p_expr(p_parse_1, 45,
                                        ...
                                        unsafe {
                                            sqlite3_p_expr(p_parse_1, 142,
                                                unsafe {
                                                    sqlite3_expr_alloc(db, 60, &raw mut t_new as *const Token,
                                                        0)
                                                },
                                                unsafe {
                                                    sqlite3_expr_alloc(db, 60,
                            ...
                            p_when =
                                unsafe { sqlite3_expr_and(p_parse_1, p_when, p_eq) };
                        }
                        if action != 7 && (action != 10 || !(p_changes_1).is_null())
                            {
                            ...
                            if action == 10 {
                                ...
                                if unsafe { (*p_col).col_flags } as i32 & 96 != 0 {
                                    ...
                                    p_dflt =
                                        unsafe {
                                            sqlite3_column_expr(unsafe { (*p_f_key_1).p_from }, p_col)
                                        };
                                }
                                if !(p_dflt).is_null() {
                                    p_new =
                                        unsafe { sqlite3_expr_dup(db, p_dflt as *const Expr, 0) };
                                } else {
                                    p_new =
                                        unsafe {
                            ...
                            unsafe {
                                sqlite3_expr_list_set_name(p_parse_1, p_list,
                                    &raw mut t_from_col as *const Token, 0)
                            };
                        }
                        break '__c17;
            ...
            unsafe { sqlite3_db_free(db, ai_col as *mut ()) };
            z_from =
                unsafe { (*unsafe { (*p_f_key_1).p_from }).z_name } as
                    *const i8;
            n_from = unsafe { sqlite3_strlen30(z_from) };
            if action == 7 {
                let mut p_src: *mut SrcList = core::ptr::null_mut();
                let mut p_raise: *mut Expr = core::ptr::null_mut();
                {
                    p_raise =
                        unsafe {
                            sqlite3_expr(db, 118,
                                c"FOREIGN KEY constraint failed".as_ptr() as *mut i8 as
                                    *const i8)
                        };
                    p_raise =
                        unsafe {
                            sqlite3_p_expr(p_parse_1, 72, p_raise,
                                core::ptr::null_mut())
                        }
                };
                if !(p_raise).is_null() {
                    unsafe { (*p_raise).aff_expr = 2 as i8 };
                }
                p_src =
                    unsafe {
                ...
                if !(p_src).is_null() {
                    ...
                    unsafe {
                        (*p_item).z_name = unsafe { sqlite3_db_str_dup(db, z_from) }
                    };
                    unsafe { (*p_item).fg.set_fixed_schema(1 as u32 as u32) };
                    unsafe {
                        (*p_item).u4.p_schema = unsafe { (*p_tab_1).p_schema }
                    };
                }
                p_select =
                    unsafe {
                        sqlite3_select_new(p_parse_1,
                            unsafe {
                                sqlite3_expr_list_append(p_parse_1, core::ptr::null_mut(),
                                    p_raise)
                            }, p_src, p_where, core::ptr::null_mut(),
            ...
            if !(p_trigger).is_null() {
                p_step =
                    {
                        unsafe {
                            (*p_trigger).step_list =
                                unsafe { &raw mut *p_trigger.offset(1 as isize) } as
                                    *mut TriggerStep
                        };
                        unsafe { (*p_trigger).step_list }
                    };
                unsafe {
                    (*p_step).p_src =
                        unsafe {
                ...
                if !(unsafe { (*p_step).p_src }).is_null() {
                    ...
                    unsafe {
                        (*p_item_1).z_name =
                            unsafe { sqlite3_db_str_n_dup(db, z_from, n_from as u64) }
                    };
                    unsafe {
                        (*p_item_1).u4.p_schema = unsafe { (*p_tab_1).p_schema }
                    };
                    unsafe { (*p_item_1).fg.set_fixed_schema(1 as u32 as u32) };
                }
                unsafe {
                    (*p_step).p_where =
                ...
                unsafe {
                    (*p_step).p_expr_list =
                        unsafe {
                            sqlite3_expr_list_dup(db, p_list as *const ExprList, 1)
                        }
                };
                unsafe {
                    (*p_step).p_select =
                ...
                if !(p_when).is_null() {
                    p_when =
                        unsafe {
                            sqlite3_p_expr(p_parse_1, 19, p_when, core::ptr::null_mut())
                        };
                    unsafe {
                        (*p_trigger).p_when =
            ...
            if unsafe { (*db).malloc_failed } as i32 == 1 {
            ...
            '__s18:
                {
                match action {
                    7 => { unsafe { (*p_step).op = 139 as u8 }; }
                    10 => {
                        if (p_changes_1).is_null() as i32 != 0 {
                            unsafe { (*p_step).op = 129 as u8 };
                            break '__s18;
                        }
                        unsafe { (*p_step).op = 130 as u8 };
                    }
                    _ => { unsafe { (*p_step).op = 130 as u8 }; }
                }
            }
            unsafe { (*p_step).p_trig = p_trigger };
            unsafe { (*p_trigger).p_schema = unsafe { (*p_tab_1).p_schema } };
            unsafe {
                (*p_trigger).p_tab_schema = unsafe { (*p_tab_1).p_schema }
            };
            unsafe { (*p_f_key_1).ap_trigger[i_action as usize] = p_trigger };
            unsafe {
                (*p_trigger).op =
                    if !(p_changes_1).is_null() { 130 } else { 129 } as u8
            };
        }
        return p_trigger;
    }
...
pub extern "C" fn sqlite3_fk_actions(p_parse: *mut Parse, p_tab: *mut Table,
    ...
    b_chng_rowid: i32) -> () {
    if unsafe { (*unsafe { (*p_parse).db }).flags } & 16384 as u64 != 0 {
        let mut p_f_key: *mut FKey = core::ptr::null_mut();
        {
            p_f_key = sqlite3_fk_references(unsafe { &*p_tab });
            '__b19: loop {
                ...
                '__c19: loop {
                    if a_change == core::ptr::null_mut() ||
                            fk_parent_is_modified(unsafe { &*p_tab },
                                    unsafe { &*p_f_key }, a_change as *const i32, b_chng_rowid)
                                != 0 {
                        let p_act: *mut Trigger =
                            fk_action_trigger(p_parse, p_tab, p_f_key,
                                p_changes as *const ExprList);
                        if !(p_act).is_null() {
                            unsafe {
                                sqlite3_code_row_trigger_direct(p_parse, p_act, p_tab,
                                    reg_old, 2, 0)
                            };
                        }
                    }
            ...
            if (a_change).is_null() as i32 != 0 {
                ...
                let mut p: *mut FKey = core::ptr::null_mut();
                {
                    ...
                    '__b20: loop {
                        ...
                        '__c20: loop {
                            if fk_child_is_modified(unsafe { &*p_tab }, unsafe { &*p },
                                        a_change as *const i32, chng_rowid) != 0 {
                                if 0 ==
                                        unsafe {
                                            sqlite3_stricmp(unsafe { (*p_tab).z_name } as *const i8,
                                                unsafe { (*p).z_to } as *const i8)
                                        } {
                                    e_ret = 2;
                                }
                                b_have_fk = 1;
                ...
                {
                    p = sqlite3_fk_references(unsafe { &*p_tab });
                    '__b21: loop {
                        if !(!(p).is_null()) { break '__b21; }
                        '__c21: loop {
                            if fk_parent_is_modified(unsafe { &*p_tab }, unsafe { &*p },
                                        a_change as *const i32, chng_rowid) != 0 {
                                if unsafe { (*(*p_parse).db).flags } & (8 as u64) << 32 ==
                                            0 as u64 && unsafe { (*p).a_action[1 as usize] } as i32 != 0
                                    {
                                    return 2;
                                }
                                b_have_fk = 1;
    ...
    unsafe {
        ...
        if unsafe { (*unsafe { (*p_parse).db }).flags } & 16384 as u64 != 0 &&
                    ...
                    '__c22: loop {
                        {
                            i = 0;
                            '__b23: loop {
                                if !(i < unsafe { (*p).n_col }) { break '__b23; }
                                '__c23: loop {
                                    mask |=
                                        if unsafe {
                                                    (*(unsafe { (*p).a_col.as_ptr() } as
                                                                    *mut sColMap).offset(i as isize)).i_from
                                                } > 31 {
                                            4294967295u32
                                        } else {
            ...
            }
            {
                p = sqlite3_fk_references(unsafe { &*p_tab });
                '__b24: loop {
                    if !(!(p).is_null()) { break '__b24; }
                    '__c24: loop {
                        let mut p_idx: *mut Index = core::ptr::null_mut();
                        sqlite3_fk_locate_index(p_parse, unsafe { &*p_tab },
                            unsafe { &*p }, &mut p_idx, core::ptr::null_mut());
                        if !(p_idx).is_null() {
                            {
                                i = 0;
                                '__b25: loop {
...
pub extern "C" fn sqlite3_fk_clear_trigger_cache(db: *mut sqlite3, i_db: i32)
    ...
    unsafe {
        ...
        {
            k = unsafe { (*p_hash).first };
            '__b26: loop {
                if !(!(k).is_null()) { break '__b26; }
                '__c26: loop {
                    let p_tab: *const Table =
                        unsafe { (*k).data } as *const Table;
                    let mut p_f_key: *mut FKey = core::ptr::null_mut();
                    if !(unsafe { (*p_tab).e_tab_type } as i32 == 0) as i32 != 0
                        {
                        break '__c26;
                    }
                    {
                        p_f_key = unsafe { (*p_tab).u.tab.p_f_key };
                        '__b27: loop {
                            if !(!(p_f_key).is_null()) { break '__b27; }
                            '__c27: loop {
                                fk_trigger_delete(db,
                                    unsafe { (*p_f_key).ap_trigger[0 as usize] });
                                unsafe {
                                    (*p_f_key).ap_trigger[0 as usize] = core::ptr::null_mut()
                                };
                                fk_trigger_delete(db,
                                    unsafe { (*p_f_key).ap_trigger[1 as usize] });
                                unsafe {
                                    (*p_f_key).ap_trigger[1 as usize] = core::ptr::null_mut()
                                };
                                break '__c27;
                            }
                            p_f_key = unsafe { (*p_f_key).p_next_from };
...
pub extern "C" fn sqlite3_fk_delete(db: *mut sqlite3, p_tab: &Table) -> () {
    unsafe {
        ...
        { let _ = 0; };
        {
            p_f_key = (*p_tab).u.tab.p_f_key;
            '__b28: loop {
                if !(!(p_f_key).is_null()) { break '__b28; }
                '__c28: loop {
                    { let _ = 0; };
                    if unsafe { (*db).pn_bytes_freed } == core::ptr::null_mut()
                        {
                        if !(unsafe { (*p_f_key).p_prev_to }).is_null() {
                            unsafe {
                                (*unsafe { (*p_f_key).p_prev_to }).p_next_to =
                                    unsafe { (*p_f_key).p_next_to }
                            };
                        } else {
                            let z: *const i8 =
                                if !(unsafe { (*p_f_key).p_next_to }).is_null() {
                                        unsafe { (*unsafe { (*p_f_key).p_next_to }).z_to }
                                    } else { unsafe { (*p_f_key).z_to } } as *const i8;
                            unsafe {
                                sqlite3_hash_insert(unsafe {
                                        &mut (*(*p_tab).p_schema).fkey_hash
                                    }, z, unsafe { (*p_f_key).p_next_to } as *mut ())
                            };
                        }
                        if !(unsafe { (*p_f_key).p_next_to }).is_null() {
                            unsafe {
                                (*unsafe { (*p_f_key).p_next_to }).p_prev_to =
                                    unsafe { (*p_f_key).p_prev_to }
                            };
                        }
                    }
                    { let _ = 0; };
                    ...
                    fk_trigger_delete(db,
                        unsafe { (*p_f_key).ap_trigger[1 as usize] });
                    p_next = unsafe { (*p_f_key).p_next_from };
