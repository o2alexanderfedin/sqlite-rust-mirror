...
type Tcl_ThreadId = *mut Tcl_ThreadId_;
type Tcl_WideInt = i64;
type ClientData = *mut ();
type __darwin_size_t = u64;
type Tcl_Command = *mut Tcl_Command_;
type __darwin_intptr_t = i64;
type Tcl_QueuePosition = u32;
#[repr(C)]
#[derive(Copy, Clone)]
struct Tcl_Event {
    proc: Option<unsafe extern "C" fn(*mut Tcl_Event, i32) -> i32>,
    nextPtr: *mut Tcl_Event,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct Tcl_Time {
...
extern "C" fn tcl_script_event(ev_ptr_1: *mut Tcl_Event, flags: i32) -> i32 {
    let mut rc: i32 = 0;
    let p: *const EvalEvent = ev_ptr_1 as *mut EvalEvent as *const EvalEvent;
    rc =
        unsafe {
            Tcl_Eval(unsafe { (*p).interp },
                unsafe { (*p).z_script } as *const i8)
        };
    if rc != 0 { unsafe { Tcl_BackgroundError(unsafe { (*p).interp }) }; }
    { let _ = flags; };
    return 1;
}
extern "C" fn sqlthread_parent(client_data_1: ClientData,
    ...
    let mut n_msg: i32 = 0;
    let p: *const SqlThread =
        client_data_1 as *mut SqlThread as *const SqlThread;
    { let _ = 0; };
    { let _ = objc; };
    if p == core::ptr::null_mut() {
        unsafe {
            Tcl_AppendResult(interp, c"no parent thread".as_ptr() as *mut i8,
                0 as *mut ())
        };
        return 1;
    }
    ...
    p_event =
        unsafe {
                Tcl_Alloc((core::mem::size_of::<EvalEvent>() as u64 +
                                n_msg as u64 + 1 as u64) as u32)
            } as *mut EvalEvent;
    unsafe { (*p_event).base.nextPtr = core::ptr::null_mut() };
    unsafe { (*p_event).base.proc = Some(tcl_script_event) };
    unsafe {
        (*p_event).z_script =
            unsafe { &raw mut *p_event.offset(1 as isize) } as *mut i8
    };
    unsafe {
        memcpy(unsafe { (*p_event).z_script } as *mut (), z_msg as *const (),
            (n_msg + 1) as u64)
    };
    unsafe { (*p_event).interp = unsafe { (*p).interp } };
    unsafe {
        Tcl_ThreadQueueEvent(unsafe { (*p).parent },
            p_event as *mut Tcl_Event, TCL_QUEUE_TAIL)
    };
...
extern "C" fn clock_seconds_proc(client_data_1: ClientData,
    interp: *mut Tcl_Interp, objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut now: Tcl_Time = unsafe { core::mem::zeroed() };
    unsafe { Tcl_GetTime(&mut now) };
    unsafe {
        Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(now.sec as i32) })
    };
    { let _ = client_data_1; };
    { let _ = objc; };
    { let _ = objv; };
...
extern "C" fn post_to_parent(p: &SqlThread, p_script_1: *mut Tcl_Obj) -> () {
    let mut p_event: *mut EvalEvent = core::ptr::null_mut();
    let mut z_msg: *const i8 = core::ptr::null();
    let mut n_msg: i32 = 0;
    z_msg = unsafe { Tcl_GetStringFromObj(p_script_1, &mut n_msg) };
    p_event =
        unsafe {
                Tcl_Alloc((core::mem::size_of::<EvalEvent>() as u64 +
                                n_msg as u64 + 1 as u64) as u32)
    ...
    unsafe { (*p_event).interp = (*p).interp };
    unsafe {
        Tcl_ThreadQueueEvent((*p).parent, p_event as *mut Tcl_Event,
            TCL_QUEUE_TAIL)
    };
    unsafe { Tcl_ThreadAlert((*p).parent) };
}
extern "C" fn tcl_script_thread(p_sql_thread_1: ClientData) -> () {
    let mut interp: *mut Tcl_Interp = core::ptr::null_mut();
    let mut p_res: *mut Tcl_Obj = core::ptr::null_mut();
    let mut p_list: *mut Tcl_Obj = core::ptr::null_mut();
    let mut rc: i32 = 0;
    let p: *mut SqlThread = p_sql_thread_1 as *mut SqlThread;
    interp = unsafe { Tcl_CreateInterp() };
    unsafe {
        Tcl_CreateObjCommand(interp,
            c"clock_seconds".as_ptr() as *mut i8 as *const i8,
            clock_seconds_proc, core::ptr::null_mut(),
            unsafe {
    ...
    unsafe {
        Tcl_CreateObjCommand(interp,
            c"sqlthread".as_ptr() as *mut i8 as *const i8, sqlthread_proc,
            p_sql_thread_1,
            unsafe {
                core::mem::transmute::<*const (),
                        unsafe extern "C" fn(*mut ()) -> ()>(0 as *const ())
    ...
    unsafe { sqlitetest1_init(interp) };
    unsafe { sqlitetest_mutex_init(interp) };
    unsafe { Sqlite3_Init(interp) };
    rc = unsafe { Tcl_Eval(interp, unsafe { (*p).z_script } as *const i8) };
    p_res = unsafe { Tcl_GetObjResult(interp) };
    p_list = unsafe { Tcl_NewObj() };
    { let __p = unsafe { &mut (*p_list).refCount }; *__p += 1; *__p };
    { let __p = unsafe { &mut (*p_res).refCount }; *__p += 1; *__p };
    if rc != 0 {
        unsafe {
            Tcl_ListObjAppendElement(interp, p_list,
                unsafe {
                    Tcl_NewStringObj(c"error".as_ptr() as *mut i8 as *const i8,
                        -1)
                })
        };
        unsafe { Tcl_ListObjAppendElement(interp, p_list, p_res) };
        post_to_parent(unsafe { &*p }, p_list);
        '__b0: loop {
            '__c0: loop {
                if {
                            let __p = unsafe { &mut (*p_list).refCount };
                            *__p -= 1;
                            *__p
                        } <= 0 {
                    unsafe { TclFreeObj(p_list) };
                }
                break '__c0;
            }
            if !(0 != 0) { break '__b0; }
    ...
    unsafe {
        Tcl_ListObjAppendElement(interp, p_list,
            unsafe {
                Tcl_NewStringObj(c"set".as_ptr() as *mut i8 as *const i8, -1)
            })
    };
    unsafe {
        Tcl_ListObjAppendElement(interp, p_list,
            unsafe {
                Tcl_NewStringObj(unsafe { (*p).z_varname } as *const i8, -1)
            })
    };
    unsafe { Tcl_ListObjAppendElement(interp, p_list, p_res) };
    post_to_parent(unsafe { &*p }, p_list);
    unsafe { Tcl_Free(p as *mut () as *mut i8) };
    '__b1: loop {
        '__c1: loop {
            if {
                        let __p = unsafe { &mut (*p_list).refCount };
    ...
    '__b2: loop {
        '__c2: loop {
            if {
                        let __p = unsafe { &mut (*p_res).refCount };
                        *__p -= 1;
                        *__p
                    } <= 0 {
                unsafe { TclFreeObj(p_res) };
            }
            break '__c2;
        }
        if !(0 != 0) { break '__b2; }
    }
    unsafe { Tcl_DeleteInterp(interp) };
    while unsafe { Tcl_DoOneEvent(!(1 << 1) | 1 << 1) } != 0 {}
    unsafe { Tcl_ExitThread(0) };
}
extern "C" fn sqlthread_spawn(client_data_1: ClientData,
    interp: *mut Tcl_Interp, objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut x: Tcl_ThreadId = core::ptr::null_mut();
    let mut p_new: *mut SqlThread = core::ptr::null_mut();
    let mut rc: i32 = 0;
    ...
    p_new =
        unsafe {
                Tcl_Alloc((core::mem::size_of::<SqlThread>() as u64 +
                                    n_varname as u64 + n_script as u64 + 2 as u64) as u32)
            } as *mut SqlThread;
    unsafe {
        (*p_new).z_varname =
    ...
    unsafe {
        (*p_new).z_script =
            unsafe {
                    &raw mut *unsafe {
                                (*p_new).z_varname.offset((n_varname + 1) as isize)
                            }
                } as *mut i8
    };
    unsafe {
        memcpy(unsafe { (*p_new).z_varname } as *mut (),
            z_varname as *const (), (n_varname + 1) as u64)
    };
    unsafe {
        memcpy(unsafe { (*p_new).z_script } as *mut (), z_script as *const (),
            (n_script + 1) as u64)
    };
    unsafe { (*p_new).parent = unsafe { Tcl_GetCurrentThread() } };
    unsafe { (*p_new).interp = interp };
    rc =
        unsafe {
            Tcl_CreateThread(&mut x, tcl_script_thread, p_new as *mut (),
                n_stack, flags)
        };
    if rc != 0 {
        unsafe {
            Tcl_AppendResult(interp,
                c"Error in Tcl_CreateThread()".as_ptr() as *mut i8,
                0 as *mut ())
        };
...
extern "C" fn sqlthread_open(client_data_1: ClientData,
    ...
    { let _ = objc; };
    z_filename =
        unsafe { Tcl_GetString(unsafe { *objv.offset(2 as isize) }) } as
            *const i8;
    unsafe { sqlite3_open(z_filename, &mut db) };
    unsafe { md5_register(db, core::ptr::null_mut(), core::ptr::null()) };
    unsafe { sqlite3_busy_handler(db, Some(x_busy), core::ptr::null_mut()) };
    if unsafe {
                sqlite3_test_make_pointer_str(interp,
                    &raw mut z_buf[0 as usize] as *mut i8, db as *mut ())
            } != 0 {
        return 1;
    }
    unsafe {
...
extern "C" fn sqlthread_id(client_data_1: ClientData, interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let id: *const Tcl_ThreadId_ =
        unsafe { Tcl_GetCurrentThread() } as *const Tcl_ThreadId_;
    unsafe {
        Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(id as i64 as i32) })
    };
    { let _ = client_data_1; };
    { let _ = objc; };
    { let _ = objv; };
...
extern "C" fn sqlthread_proc(client_data_1: ClientData,
    interp: *mut Tcl_Interp, objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut a_sub: [SubCommand_N10SubCommand; 5] =
        [SubCommand_N10SubCommand {
                    z_name: c"parent".as_ptr() as *mut i8,
                    x_proc: Some(sqlthread_parent),
                    n_arg: 1,
                    z_usage: c"SCRIPT".as_ptr() as *mut i8,
                },
                SubCommand_N10SubCommand {
                    z_name: c"spawn".as_ptr() as *mut i8,
                    x_proc: Some(sqlthread_spawn),
                    n_arg: 2,
                    z_usage: c"VARNAME SCRIPT".as_ptr() as *mut i8,
                },
                SubCommand_N10SubCommand {
                    z_name: c"open".as_ptr() as *mut i8,
                    x_proc: Some(sqlthread_open),
                    n_arg: 1,
                    z_usage: c"DBNAME".as_ptr() as *mut i8,
                },
                SubCommand_N10SubCommand {
                    z_name: c"id".as_ptr() as *mut i8,
                    x_proc: Some(sqlthread_id),
                    n_arg: 0,
                    z_usage: c"".as_ptr() as *mut i8,
                },
                SubCommand_N10SubCommand {
                    z_name: core::ptr::null_mut(),
                    x_proc: None,
                    n_arg: 0,
                    z_usage: core::ptr::null_mut(),
                }];
    let mut p_sub: *const SubCommand_N10SubCommand = core::ptr::null();
    let mut rc: i32 = 0;
    let mut i_index: i32 = 0;
    if objc < 2 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"SUB-COMMAND".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    rc =
        unsafe {
            Tcl_GetIndexFromObjStruct(interp,
                ...
                &raw mut a_sub[0 as usize] as *mut SubCommand_N10SubCommand as
                    *const (),
                core::mem::size_of::<SubCommand_N10SubCommand>() as i32,
                c"sub-command".as_ptr() as *mut i8 as *const i8, 0,
                &mut i_index)
        };
    if rc != 0 { return rc; }
    p_sub = &mut a_sub[i_index as usize];
    if objc < unsafe { (*p_sub).n_arg } + 2 {
        unsafe {
            Tcl_WrongNumArgs(interp, 2, objv,
                unsafe { (*p_sub).z_usage } as *const i8)
        };
        return 1;
    }
    return unsafe {
...
extern "C" fn clock_milliseconds_proc(client_data_1: ClientData,
    ...
    unsafe {
        Tcl_SetObjResult(interp,
            unsafe {
                Tcl_NewWideIntObj(now.sec as Tcl_WideInt * 1000 as Tcl_WideInt
                        + now.usec / 1000 as i64)
            })
    };
    { let _ = client_data_1; };
    { let _ = objc; };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlitetest_thread_init(interp: *mut Tcl_Interp) -> i32 {
    let a_cmd: [TclCmd_N6TclCmd; 3] =
        [TclCmd_N6TclCmd {
                    x_proc: Some(sqlthread_proc),
                    z_name: c"sqlthread".as_ptr() as *const i8,
                    i_ctx: 0,
                },
                TclCmd_N6TclCmd {
                    x_proc: Some(clock_seconds_proc),
                    z_name: c"clock_second".as_ptr() as *const i8,
                    i_ctx: 0,
                },
                TclCmd_N6TclCmd {
                    x_proc: Some(clock_milliseconds_proc),
                    z_name: c"clock_milliseconds".as_ptr() as *const i8,
                    i_ctx: 0,
                }];
    let mut ii: i32 = 0;
    {
        ...
        '__b4: loop {
            if !((ii as u64) <
                            core::mem::size_of::<[TclCmd_N6TclCmd; 3]>() as u64 /
                                core::mem::size_of::<TclCmd_N6TclCmd>() as u64) {
                break '__b4;
            }
            '__c4: loop {
                let p: *mut () = a_cmd[ii as usize].i_ctx as i64 as *mut ();
                unsafe {
                    Tcl_CreateObjCommand(interp, a_cmd[ii as usize].z_name,
                        a_cmd[ii as
                                        usize].x_proc.unwrap_or(unsafe {
                                core::mem::transmute::<*const (),
                                        unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
                                            *const *mut Tcl_Obj) -> i32>(0 as *const ())
                            }), p,
                        unsafe {
                            core::mem::transmute::<*const (),
                                    unsafe extern "C" fn(*mut ()) -> ()>(0 as *const ())
...
#[repr(C)]
#[derive(Copy, Clone)]
struct SubCommand_N10SubCommand {
    z_name: *mut i8,
    x_proc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
        *const *mut Tcl_Obj) -> i32>,
    n_arg: i32,
    z_usage: *mut i8,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct TclCmd_N6TclCmd {
    x_proc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
        *const *mut Tcl_Obj) -> i32>,
    z_name: *const i8,
    i_ctx: i32,
...
extern "C" {
    ...
    -> i32;
    fn sqlite3Init(_: *mut sqlite3, _: *mut *mut i8)
    -> i32;
    ...
    -> *mut ();
    fn Tcl_ThreadQueueEvent(threadId: Tcl_ThreadId, evPtr: *mut Tcl_Event,
    ...
    -> ();
    fn sqlitetest1_init(_: *mut Tcl_Interp)
    -> i32;
    fn Sqlite3_Init(_: *mut Tcl_Interp)
    -> i32;
    fn Tcl_CreateInterp()
    -> *mut Tcl_Interp;
    fn Tcl_CreateObjCommand(interp: *mut Tcl_Interp, cmdName: *const i8,
    proc:
        unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32,
            *const *mut Tcl_Obj) -> i32, clientData: ClientData,
    deleteProc: unsafe extern "C" fn(*mut ()) -> ())
    -> Tcl_Command;
    fn sqlitetest_mutex_init(_: *mut Tcl_Interp)
    -> i32;
    ...
    -> ();
    fn Tcl_DoOneEvent(flags: i32)
    -> i32;
    fn Tcl_ExitThread(status: i32)
    -> ();
    fn Tcl_GetCurrentThread()
    -> Tcl_ThreadId;
    fn Tcl_CreateThread(idPtr: *mut Tcl_ThreadId,
    proc: unsafe extern "C" fn(*mut ()) -> (), clientData: ClientData,
    stackSize: i32, flags: i32)
    -> i32;
    fn sqlite3_test_make_pointer_str(_: *mut Tcl_Interp, _: *mut i8,
    _: *mut ())
    -> i32;
    fn Tcl_GetString(objPtr: *mut Tcl_Obj)
    -> *mut i8;
    fn md5_register(_: *mut sqlite3, _: *mut *mut i8,
    _: *const sqlite3_api_routines)
    -> i32;
    fn Tcl_WrongNumArgs(interp: *mut Tcl_Interp, objc: i32,
    objv: *const *mut Tcl_Obj, message: *const i8)
    -> ();
    fn Tcl_GetIndexFromObjStruct(interp: *mut Tcl_Interp,
    objPtr: *mut Tcl_Obj, tablePtr: *const (), offset: i32, msg: *const i8,
    flags: i32, indexPtr: *mut i32)
    -> i32;
    fn sqlite3_err_name(_: i32)
    -> *const i8;
    fn sqlite3_test_text_to_ptr(_: *const i8)
    -> *mut ();
    fn get_db_pointer(_: *mut Tcl_Interp, _: *const i8, _: *mut *mut sqlite3)
    -> i32;
    fn sqlite3_test_err_code(_: *mut Tcl_Interp, _: *mut sqlite3, _: i32)
    -> i32;
