...
pub extern "C" fn sqlite3_db_is_named(db: &sqlite3, i_db: i32,
    ...
    return (unsafe {
                        sqlite3_str_i_cmp(unsafe {
                                    (*(*db).a_db.offset(i_db as isize)).z_db_s_name
                                } as *const i8, z_name)
                    } == 0 ||
                i_db == 0 &&
                    unsafe {
...
extern "C" fn attach_func(context: *mut sqlite3_context, not_used_1: i32,
    ...
    unsafe {
        ...
        let mut z_path: *mut i8 = core::ptr::null_mut();
        ...
        loop {
            ...
            '__s1:
                ...
                match __state {
                    ...
                    5 => { __state = 6; }
                    6 => { __state = 7; }
                    7 => { z_path = core::ptr::null_mut(); __state = 8; }
                    8 => { z_err = core::ptr::null_mut(); __state = 9; }
                    9 => { __state = 10; }
                    10 => { __state = 11; }
                    11 => { p_new = core::ptr::null_mut(); __state = 12; }
                    12 => { z_err_dyn = core::ptr::null_mut(); __state = 13; }
                    13 => { __state = 14; }
                    14 => { { let _ = not_used_1; }; __state = 15; }
                    15 => {
                        z_file =
                            unsafe {
                    ...
                    19 => {
                        z_file = c"".as_ptr() as *mut i8 as *const i8;
                        __state = 18;
                    }
                    20 => {
                        if unsafe { (*db).init.reopen_memdb() } != 0 {
                            __state = 23;
                        } else { __state = 24; }
                    }
                    21 => {
                        z_name = c"".as_ptr() as *mut i8 as *const i8;
                        __state = 20;
                    }
                    22 => {
                        unsafe { (*db).no_shared_cache = 0 as u8 };
                        __state = 82;
                    }
                    23 => { p_new_bt = core::ptr::null_mut(); __state = 25; }
                    24 => {
                        if unsafe { (*db).n_db } >=
                                unsafe { (*db).a_limit[7 as usize] } + 2 {
                            __state = 45;
                        } else { __state = 44; }
                    }
                    25 => {
                    ...
                    27 => {
                        if unsafe {
                                        sqlite3_btree_txn_state(unsafe { (*p_new).p_bt })
                                    } != 0 ||
                                unsafe {
                                        sqlite3_btree_is_in_backup(unsafe { (*p_new).p_bt })
                                    } != 0 {
                            __state = 29;
                        } else { __state = 28; }
                    }
                    28 => {
                        p_vfs =
                            unsafe {
                                sqlite3_vfs_find(c"memdb".as_ptr() as *mut i8 as *const i8)
                            };
                        __state = 31;
                    }
                    29 => { rc = 5; __state = 30; }
                    ...
                    32 => {
                        rc =
                            unsafe {
                                sqlite3_btree_open(p_vfs,
                                    b"x\x00\x00".as_ptr() as *mut i8 as *const i8, db,
                                    &mut p_new_bt, 0, 256)
                            };
                        __state = 34;
                    }
                    33 => { return; }
                    34 => {
                        if rc == 0 { __state = 36; } else { __state = 35; }
                    }
                    35 => {
                        if rc != 0 { __state = 43; } else { __state = 22; }
                    }
                    36 => {
                        p_new_schema = unsafe { sqlite3_schema_get(db, p_new_bt) };
                        __state = 37;
                    }
                    37 => {
                        if !(p_new_schema).is_null() {
                            __state = 38;
                        } else { __state = 39; }
                    }
                    38 => {
                        unsafe { sqlite3_btree_close(unsafe { (*p_new).p_bt }) };
                        __state = 40;
                    }
                    39 => {
                        unsafe { sqlite3_btree_close(p_new_bt) };
                        __state = 42;
                    }
                    40 => { unsafe { (*p_new).p_bt = p_new_bt }; __state = 41; }
                    41 => {
                        unsafe { (*p_new).p_schema = p_new_schema };
                        __state = 35;
                    }
                    42 => { rc = 7; __state = 35; }
                    43 => { __state = 2; }
                    ...
                    45 => {
                        z_err_dyn =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"too many attached databases - max %d".as_ptr() as *mut i8
                                        as *const i8, unsafe { (*db).a_limit[7 as usize] })
                            };
                        __state = 46;
                    }
                    46 => { __state = 2; }
                    ...
                    49 => { { let _ = 0; }; __state = 51; }
                    50 => {
                        { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                        __state = 48;
                    }
                    51 => {
                        if sqlite3_db_is_named(unsafe { &*db }, i, z_name) != 0 {
                            __state = 52;
                        } else { __state = 50; }
                    }
                    52 => {
                        z_err_dyn =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"database %s is already in use".as_ptr() as *mut i8 as
                                        *const i8, z_name)
                            };
                        __state = 53;
                    }
                    53 => { __state = 2; }
                    54 => { unsafe { (*db).a_db = a_new }; __state = 62; }
                    55 => {
                        a_new =
                            unsafe {
                                    sqlite3_db_malloc_raw_nn(db,
                                        core::mem::size_of::<Db>() as u64 * 3 as u64)
                                } as *mut Db;
                        __state = 57;
                    }
                    56 => {
                        a_new =
                            unsafe {
                                    sqlite3_db_realloc(db, unsafe { (*db).a_db } as *mut (),
                                        core::mem::size_of::<Db>() as u64 *
                                            (1 as i64 + unsafe { (*db).n_db } as i64) as u64)
                                } as *mut Db;
                        __state = 60;
                    }
                    57 => {
                    ...
                    58 => {
                        unsafe {
                            memcpy(a_new as *mut (), unsafe { (*db).a_db } as *const (),
                                core::mem::size_of::<Db>() as u64 * 2 as u64)
                        };
                        __state = 54;
                    }
                    59 => { return; }
                    ...
                    62 => {
                        p_new =
                            unsafe {
                                unsafe { (*db).a_db.offset(unsafe { (*db).n_db } as isize) }
                            };
                        __state = 63;
                    }
                    63 => {
                    ...
                    64 => { flags = unsafe { (*db).open_flags }; __state = 65; }
                    65 => {
                        rc =
                            unsafe {
                                sqlite3_parse_uri(unsafe {
                                        (*unsafe { (*db).p_vfs }).z_name
                                    }, z_file, &mut flags, &mut p_vfs, &mut z_path, &mut z_err)
                            };
                        __state = 66;
                    }
                    66 => {
                        if rc != 0 { __state = 68; } else { __state = 67; }
                    }
                    67 => {
                        if unsafe { (*db).flags } & (32 as u64) << 32 == 0 as u64 {
                            __state = 74;
                        } else { __state = 75; }
                    }
                    68 => {
                        if rc == 7 { __state = 70; } else { __state = 69; }
                    }
                    69 => {
                        unsafe {
                            sqlite3_result_error(context, z_err as *const i8, -1)
                        };
                        __state = 71;
                    }
                    70 => { unsafe { sqlite3_oom_fault(db) }; __state = 69; }
                    71 => {
                        unsafe { sqlite3_free(z_err as *mut ()) };
                        __state = 72;
                    }
                    72 => { return; }
                    73 => { { let _ = 0; }; __state = 78; }
                    74 => { flags &= !(4 | 2) as u32; __state = 76; }
                    75 => {
                        if unsafe { (*db).flags } & (16 as u64) << 32 == 0 as u64 {
                            __state = 77;
                        } else { __state = 73; }
                    }
                    76 => { flags |= 1 as u32; __state = 73; }
                    77 => { flags &= !4 as u32; __state = 73; }
                    78 => { flags |= 256 as u32; __state = 79; }
                    79 => {
                        rc =
                            unsafe {
                                sqlite3_btree_open(p_vfs, z_path as *const i8, db,
                                    unsafe { &mut (*p_new).p_bt }, 0, flags as i32)
                            };
                        __state = 80;
                    }
                    80 => {
                        {
                            let __p = unsafe { &mut (*db).n_db };
                            let __t = *__p;
                            *__p += 1;
                            __t
                        };
                    ...
                    82 => {
                        if rc == 19 { __state = 84; } else { __state = 85; }
                    }
                    83 => {
                        unsafe { (*p_new).safety_level = (2 + 1) as u8 };
                        __state = 100;
                    }
                    84 => { rc = 1; __state = 86; }
                    85 => {
                        if rc == 0 { __state = 87; } else { __state = 83; }
                    }
                    86 => {
                        z_err_dyn =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"database is already attached".as_ptr() as *mut i8 as
                                        *const i8)
                            };
                        __state = 83;
                    }
                    ...
                    88 => {
                        unsafe {
                            (*p_new).p_schema =
                                unsafe { sqlite3_schema_get(db, unsafe { (*p_new).p_bt }) }
                        };
                        __state = 89;
                    }
                    89 => {
                        if (unsafe { (*p_new).p_schema }).is_null() as i32 != 0 {
                            __state = 91;
                        } else { __state = 92; }
                    }
                    90 => {
                        unsafe { sqlite3_btree_enter(unsafe { (*p_new).p_bt }) };
                        __state = 95;
                    }
                    91 => { rc = 7; __state = 90; }
                    92 => {
                        if unsafe { (*unsafe { (*p_new).p_schema }).file_format } !=
                                    0 &&
                                unsafe { (*unsafe { (*p_new).p_schema }).enc } as i32 !=
                    ...
                    95 => {
                        p_pager =
                            unsafe { sqlite3_btree_pager(unsafe { (*p_new).p_bt }) };
                        __state = 96;
                    }
                    96 => {
                        unsafe {
                            sqlite3_pager_locking_mode(p_pager,
                                unsafe { (*db).dflt_lock_mode } as i32)
                        };
                        __state = 97;
                    }
                    97 => {
                        unsafe {
                            sqlite3_btree_secure_delete(unsafe { (*p_new).p_bt },
                                unsafe {
                    ...
                    98 => {
                        unsafe {
                            sqlite3_btree_set_pager_flags(unsafe { (*p_new).p_bt },
                                (3 as u64 | unsafe { (*db).flags } & 56 as u64) as u32)
                        };
                        __state = 99;
                    }
                    99 => {
                        unsafe { sqlite3_btree_leave(unsafe { (*p_new).p_bt }) };
                        __state = 83;
                    }
                    100 => {
                        if rc == 0 &&
                                unsafe { (*p_new).z_db_s_name } == core::ptr::null_mut() {
                            __state = 102;
                        } else { __state = 101; }
                    }
                    101 => {
                        unsafe {
                            sqlite3_free_filename(z_path as sqlite3_filename)
                        };
                        __state = 103;
                    }
                    102 => { rc = 7; __state = 101; }
                    103 => {
                        if rc == 0 { __state = 105; } else { __state = 104; }
                    }
                    104 => {
                    ...
                    108 => {
                        if (unsafe { (*db).init.reopen_memdb() } == 0) as i32 != 0 {
                            __state = 110;
                        } else { __state = 109; }
                    }
                    109 => {
                    ...
                    110 => {
                        rc = unsafe { sqlite3_init(db, &mut z_err_dyn) };
                        __state = 109;
                    }
                    111 => { { let _ = 0; }; __state = 104; }
                    112 => { return; }
                    113 => {
                        if (unsafe { (*db).init.reopen_memdb() } == 0) as i32 != 0 {
                            __state = 115;
                    ...
                    114 => { __state = 2; }
                    115 => { i_db = unsafe { (*db).n_db } - 1; __state = 116; }
                    ...
                    122 => { unsafe { (*db).n_db = i_db }; __state = 123; }
                    123 => {
                        if rc == 7 || rc == 10 | 12 << 8 {
                            __state = 124;
                        } else { __state = 125; }
                    }
                    124 => { unsafe { sqlite3_oom_fault(db) }; __state = 126; }
                    125 => {
                        if z_err_dyn == core::ptr::null_mut() {
                            __state = 128;
                        } else { __state = 114; }
                    }
                    126 => {
                        unsafe { sqlite3_db_free(db, z_err_dyn as *mut ()) };
                        __state = 127;
                    }
                    127 => {
                        z_err_dyn =
                    ...
                    128 => {
                        z_err_dyn =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"unable to open database: %s".as_ptr() as *mut i8 as
                                        *const i8, z_file)
                            };
                        __state = 114;
                    }
                    129 => { __state = 2; }
                    130 => {
                        if rc != 0 { __state = 133; } else { __state = 1; }
                    }
                    131 => {
                        unsafe {
                            sqlite3_result_error(context, z_err_dyn as *const i8, -1)
                        };
                        __state = 132;
                    }
                    132 => {
...
extern "C" fn resolve_attach_expr(p_name_1: *mut NameContext,
    ...
    if !(p_expr_1).is_null() {
        if unsafe { (*p_expr_1).op } as i32 != 60 {
            rc = unsafe { sqlite3_resolve_expr_names(p_name_1, p_expr_1) };
        } else { unsafe { (*p_expr_1).op = 118 as u8 }; }
    }
    return rc;
}
extern "C" fn code_attach(p_parse_1: *mut Parse, type__1: i32,
    ...
    unsafe {
        ...
        '__b2: loop {
            '__c2: loop {
                let mut rc: i32 = 0;
                let mut s_name: NameContext = unsafe { core::mem::zeroed() };
                let mut v: *mut Vdbe = core::ptr::null_mut();
                let mut reg_args: i32 = 0;
                if 0 != unsafe { sqlite3_read_schema(p_parse_1) } {
                    break '__b2;
                }
                if unsafe { (*p_parse_1).n_err } != 0 { break '__b2; }
                unsafe {
                    memset(&raw mut s_name as *mut (), 0,
                        core::mem::size_of::<NameContext>() as u64)
                };
                s_name.p_parse = p_parse_1;
                if 0 != resolve_attach_expr(&mut s_name, p_filename_1) ||
                            0 != resolve_attach_expr(&mut s_name, p_dbname_1) ||
                        0 != resolve_attach_expr(&mut s_name, p_key_1) {
                    break '__b2;
                }
                if !(p_auth_arg_1).is_null() {
                    let mut z_auth_arg: *const i8 = core::ptr::null();
                    if unsafe { (*p_auth_arg_1).op } as i32 == 118 {
                        { let _ = 0; };
                        z_auth_arg = unsafe { (*p_auth_arg_1).u.z_token };
                    } else { z_auth_arg = core::ptr::null_mut(); }
                    rc =
                        unsafe {
                            sqlite3_auth_check(p_parse_1, type__1,
                                z_auth_arg as *const i8, core::ptr::null(),
                                core::ptr::null())
                        };
                    if rc != 0 { break '__b2; }
                }
                ...
                unsafe {
                    sqlite3_expr_code(p_parse_1, p_dbname_1, reg_args + 1)
                };
                unsafe {
                    sqlite3_expr_code(p_parse_1, p_key_1, reg_args + 2)
                };
                { let _ = 0; };
                if !(v).is_null() {
                    unsafe {
                        sqlite3_vdbe_add_function_call(p_parse_1, 0,
                            reg_args + 3 - unsafe { (*p_func_1).n_arg } as i32,
...
extern "C" fn detach_func(context: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut z_name: *const i8 = core::ptr::null();
        let mut db: *mut sqlite3 = core::ptr::null_mut();
        ...
        loop {
            ...
            '__s4:
                ...
                match __state {
                    ...
                    2 => {
                        unsafe {
                            sqlite3_result_error(context,
                                &raw mut z_err[0 as usize] as *mut i8 as *const i8, -1)
                        };
                        __state = 1;
                    }
                    3 => {
                    ...
                    4 => { __state = 5; }
                    5 => { p_db = core::ptr::null_mut(); __state = 6; }
                    6 => { __state = 7; }
                    7 => { __state = 8; }
                    8 => { { let _ = not_used_1; }; __state = 9; }
                    9 => {
                        if z_name == core::ptr::null() {
                            __state = 11;
                        } else { __state = 10; }
                    ...
                    14 => {
                        p_db = unsafe { unsafe { (*db).a_db.offset(i as isize) } };
                        __state = 16;
                    }
                    15 => {
                        { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                    ...
                    18 => { __state = 15; }
                    19 => { __state = 12; }
                    20 => { if i < 2 { __state = 24; } else { __state = 23; } }
                    21 => {
                        unsafe {
                            sqlite3_snprintf(core::mem::size_of::<[i8; 128]>() as i32,
                                &raw mut z_err[0 as usize] as *mut i8,
                                c"no such database: %s".as_ptr() as *mut i8 as *const i8,
                                z_name)
                        };
                        __state = 22;
                    }
                    ...
                    23 => {
                        if unsafe {
                                ...
                                unsafe {
                                        sqlite3_btree_is_in_backup(unsafe { (*p_db).p_bt })
                                    } != 0 {
                            __state = 27;
                        } else { __state = 26; }
                    }
                    24 => {
                        unsafe {
                            sqlite3_snprintf(core::mem::size_of::<[i8; 128]>() as i32,
                                &raw mut z_err[0 as usize] as *mut i8,
                                c"cannot detach database %s".as_ptr() as *mut i8 as
                                    *const i8, z_name)
                        };
                        __state = 25;
                    }
                    25 => { __state = 2; }
                    26 => { { let _ = 0; }; __state = 29; }
                    27 => {
                        unsafe {
                            sqlite3_snprintf(core::mem::size_of::<[i8; 128]>() as i32,
                                &raw mut z_err[0 as usize] as *mut i8,
                                c"database %s is locked".as_ptr() as *mut i8 as *const i8,
                                z_name)
                        };
                        __state = 28;
                    }
                    ...
                    32 => {
                        p_trig = unsafe { (*p_entry).data } as *mut Trigger;
                        __state = 33;
                    }
                    33 => {
                        if unsafe { (*p_trig).p_tab_schema } ==
                                unsafe { (*p_db).p_schema } {
                            __state = 35;
                        } else { __state = 34; }
                    }
                    34 => {
                        p_entry = unsafe { (*p_entry).next };
                        __state = 30;
                    }
                    35 => {
                        unsafe {
                            (*p_trig).p_tab_schema = unsafe { (*p_trig).p_schema }
                        };
                        __state = 34;
                    }
                    36 => {
...
extern "C" fn fix_expr_cb(p: *mut Walker, p_expr_1: *mut Expr) -> i32 {
    unsafe {
        ...
        if (unsafe { (*p_fix).b_temp } == 0) as i32 != 0 {
            unsafe { (*p_expr_1).flags |= 1073741824 as u32 };
        }
        if unsafe { (*p_expr_1).op } as i32 == 157 {
            if unsafe {
                        (*unsafe { (*unsafe { (*p_fix).p_parse }).db }).init.busy
                    } != 0 {
                unsafe { (*p_expr_1).op = 122 as u8 };
            } else {
                unsafe {
                    sqlite3_error_msg(unsafe { (*p_fix).p_parse },
                        c"%s cannot use variables".as_ptr() as *mut i8 as *const i8,
                        unsafe { (*p_fix).z_type })
                };
                return 2;
            }
...
extern "C" fn fix_select_cb(p: *mut Walker, p_select_1: *mut Select) -> i32 {
    unsafe {
        ...
        let db: *mut sqlite3 = unsafe { (*unsafe { (*p_fix).p_parse }).db };
        let i_db: i32 =
            unsafe { sqlite3_find_db_name(db, unsafe { (*p_fix).z_db }) };
        let p_list: *mut SrcList = unsafe { (*p_select_1).p_src };
        if p_list == core::ptr::null_mut() { return 0; }
        {
            ...
            '__b5: loop {
                if !(i < unsafe { (*p_list).n_src }) { break '__b5; }
                '__c5: loop {
                    if unsafe { (*p_fix).b_temp } as i32 == 0 &&
                        ...
                        if unsafe { (*p_item).fg.fixed_schema() } as i32 == 0 &&
                            ...
                            if i_db !=
                                ...
                                unsafe {
                                    sqlite3_error_msg(unsafe { (*p_fix).p_parse },
                                        c"%s %T cannot reference objects in database %s".as_ptr() as
                                                *mut i8 as *const i8, unsafe { (*p_fix).z_type },
                                        unsafe { (*p_fix).p_name },
                                        unsafe { (*p_item).u4.z_database })
                                };
                                return 2;
                            }
                            unsafe {
                            ...
                            unsafe { (*p_item).fg.set_not_cte(1 as u32 as u32) };
                            unsafe { (*p_item).fg.set_had_schema(1 as u32 as u32) };
                        }
                        unsafe {
                            (*p_item).u4.p_schema = unsafe { (*p_fix).p_schema }
                        };
                        unsafe { (*p_item).fg.set_from_ddl(1 as u32 as u32) };
                    ...
                    if unsafe {
                            ...
                            unsafe {
                                    sqlite3_walk_expr(unsafe { &mut (*p_fix).w },
                                        unsafe {
                                            (*(unsafe { (*p_list).a.as_ptr() } as
        ...
        if !(unsafe { (*p_select_1).p_with }).is_null() {
            {
                i = 0;
                '__b6: loop {
                    if !(i <
                                    unsafe { (*unsafe { (*p_select_1).p_with }).n_cte }) {
                        break '__b6;
                    }
                    '__c6: loop {
                        if unsafe {
                                    sqlite3_walk_select(p,
                                        unsafe {
                                            (*(unsafe { (*unsafe { (*p_select_1).p_with }).a.as_ptr() }
                                                            as *mut Cte).offset(i as isize)).p_select
                                        })
                                } != 0 {
                            return 2;
                        }
...
pub extern "C" fn sqlite3_fix_init(p_fix: *mut DbFixer, p_parse: *mut Parse,
    ...
    unsafe {
        ...
        unsafe { (*p_fix).z_type = z_type };
        unsafe { (*p_fix).p_name = p_name };
        unsafe { (*p_fix).b_temp = (i_db == 1) as u8 };
        unsafe { (*p_fix).w.p_parse = p_parse };
        unsafe { (*p_fix).w.x_expr_callback = Some(fix_expr_cb) };
        unsafe { (*p_fix).w.x_select_callback = Some(fix_select_cb) };
        unsafe {
            (*p_fix).w.x_select_callback2 =
                Some(sqlite3_walk_win_defn_dummy_callback)
        };
        unsafe { (*p_fix).w.walker_depth = 0 };
        unsafe { (*p_fix).w.e_code = 0 as u16 };
        unsafe { (*p_fix).w.u.p_fix = p_fix };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_fix_src_list(p_fix: &mut DbFixer,
    ...
    let mut res: i32 = 0;
    if !(p_list).is_null() {
        let mut s: Select = unsafe { core::mem::zeroed() };
        unsafe {
            memset(&raw mut s as *mut (), 0,
                core::mem::size_of::<Select>() as u64)
        };
        s.p_src = p_list;
        res = unsafe { sqlite3_walk_select(&mut (*p_fix).w, &mut s) };
    }
    return res;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_fix_select(p_fix: &mut DbFixer,
    p_select: *mut Select) -> i32 {
    return unsafe { sqlite3_walk_select(&mut (*p_fix).w, p_select) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_fix_expr(p_fix: &mut DbFixer, p_expr: *mut Expr)
    -> i32 {
    return unsafe { sqlite3_walk_expr(&mut (*p_fix).w, p_expr) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_fix_trigger_step(p_fix: *mut DbFixer,
    mut p_step: *mut TriggerStep) -> i32 {
    unsafe {
        while !(p_step).is_null() {
            if unsafe {
                                    sqlite3_walk_select(unsafe { &mut (*p_fix).w },
                        ...
                        unsafe {
                                sqlite3_walk_expr_list(unsafe { &mut (*p_fix).w },
                                    unsafe { (*p_step).p_expr_list })
                            } != 0 ||
                    sqlite3_fix_src_list(unsafe { &mut *p_fix },
                            unsafe { (*p_step).p_src }) != 0 {
                return 1;
            }
            {
                let mut p_up: *const Upsert = core::ptr::null();
                {
                    p_up = unsafe { (*p_step).p_upsert };
                    '__b8: loop {
                        if !(!(p_up).is_null()) { break '__b8; }
                        '__c8: loop {
                            if unsafe {
                                                    sqlite3_walk_expr_list(unsafe { &mut (*p_fix).w },
                                                        unsafe { (*p_up).p_upsert_target })
                                                } != 0 ||
                                            unsafe {
                                                    sqlite3_walk_expr(unsafe { &mut (*p_fix).w },
                                                        unsafe { (*p_up).p_upsert_target_where })
                                                } != 0 ||
                                        unsafe {
                                                sqlite3_walk_expr_list(unsafe { &mut (*p_fix).w },
                                                    unsafe { (*p_up).p_upsert_set })
                                            } != 0 ||
                                    unsafe {
                                            sqlite3_walk_expr(unsafe { &mut (*p_fix).w },
                                                unsafe { (*p_up).p_upsert_where })
                                        } != 0 {
                                return 1;
                            }
                            break '__c8;
                        }
                        p_up = unsafe { (*p_up).p_next_upsert };
                    }
                }
            }
...
static mut attach_func_1: FuncDef =
    FuncDef {
        n_arg: 3 as i16,
        func_flags: 1 as u32,
        ...
        x_value: None,
        x_inverse: None,
        z_name: c"sqlite_attach".as_ptr() as *const i8,
        u: FuncDef_u0 { p_hash: core::ptr::null_mut() },
    };
static mut detach_func_1: FuncDef =
    FuncDef {
        n_arg: 1 as i16,
        func_flags: 1 as u32,
        p_user_data: core::ptr::null_mut(),
        ...
        x_value: None,
        x_inverse: None,
        z_name: c"sqlite_detach".as_ptr() as *const i8,
        u: FuncDef_u0 { p_hash: core::ptr::null_mut() },
    };
extern "C" {
