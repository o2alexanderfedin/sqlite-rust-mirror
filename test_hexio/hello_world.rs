...
pub extern "C" fn sqlite3_test_bin_to_hex(mut z_buf_1: &mut [u8]) -> () {
    let z_hex: [u8; 17] =
        [48 as u8, 49 as u8, 50 as u8, 51 as u8, 52 as u8, 53 as u8, 54 as u8,
                55 as u8, 56 as u8, 57 as u8, 65 as u8, 66 as u8, 67 as u8,
                68 as u8, 69 as u8, 70 as u8, 0 as u8];
    let mut i: i32 = 0;
    let mut j: i32 = 0;
    let mut c: u8 = 0 as u8;
    i = z_buf_1.len() as i32 * 2;
    z_buf_1[{ let __p = &mut i; let __t = *__p; *__p -= 1; __t } as usize] =
        0 as u8;
    {
        j = z_buf_1.len() as i32 - 1;
        '__b0: loop {
            if !(j >= 0) { break '__b0; }
            '__c0: loop {
                c = z_buf_1[j as usize];
                z_buf_1[{ let __p = &mut i; let __t = *__p; *__p -= 1; __t }
                            as usize] = z_hex[(c as i32 & 15) as usize] as u8;
                z_buf_1[{ let __p = &mut i; let __t = *__p; *__p -= 1; __t }
                            as usize] = z_hex[(c as i32 >> 4) as usize] as u8;
                break '__c0;
            }
...
pub extern "C" fn sqlite3_test_hex_to_bin(z_in_1: &[u8], a_out_1: *mut u8)
    ...
    let a_map: [u8; 256] =
        [0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                ...
                2 as u8, 3 as u8, 4 as u8, 5 as u8, 6 as u8, 7 as u8, 8 as u8,
                9 as u8, 10 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 11 as u8, 12 as u8, 13 as u8,
                14 as u8, 15 as u8, 16 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 11 as u8, 12 as u8, 13 as u8, 14 as u8,
                15 as u8, 16 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
                0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8, 0 as u8,
    ...
    let mut c: u8 = 0 as u8;
    {
        i = { j = 0; j };
        '__b1: loop {
            if !(i < z_in_1.len() as i32) { break '__b1; }
            '__c1: loop {
                c = a_map[z_in_1[i as usize] as usize] as u8;
                if c as i32 == 0 { break '__c1; }
                if hi != 0 {
                    unsafe {
                        *a_out_1.offset(j as isize) = (c as i32 - 1 << 4) as u8
                    };
                    hi = 0;
                } else {
                    unsafe {
...
extern "C" fn hexio_read(client_data_1: *mut (), interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut offset: i32 = 0;
    let mut amt: i32 = 0;
    let mut got: i32 = 0;
    let mut z_file: *const i8 = core::ptr::null();
    let mut z_buf: *mut u8 = core::ptr::null_mut();
    let mut in_: *mut FILE = core::ptr::null_mut();
    if objc != 4 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"FILENAME OFFSET AMT".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    if unsafe {
                Tcl_GetIntFromObj(interp, unsafe { *objv.offset(2 as isize) },
                    &mut offset)
            } != 0 {
        return 1;
    }
    if unsafe {
                Tcl_GetIntFromObj(interp, unsafe { *objv.offset(3 as isize) },
                    &mut amt)
            } != 0 {
        return 1;
    }
    z_file =
        unsafe { Tcl_GetString(unsafe { *objv.offset(1 as isize) }) } as
            *const i8;
    z_buf = unsafe { sqlite3_malloc(amt * 2 + 1) } as *mut u8;
    if z_buf == core::ptr::null_mut() { return 1; }
    in_ = unsafe { fopen(z_file, c"rb".as_ptr() as *mut i8 as *const i8) };
    if in_ == core::ptr::null_mut() {
        in_ = unsafe { fopen(z_file, c"r".as_ptr() as *mut i8 as *const i8) };
    }
    if in_ == core::ptr::null_mut() {
        unsafe {
            Tcl_AppendResult(interp,
                c"cannot open input file ".as_ptr() as *mut i8, z_file,
                0 as *mut ())
        };
        return 1;
    }
    unsafe { fseek(in_, offset as i64, 0) };
    got =
        unsafe { fread(z_buf as *mut (), 1 as u64, amt as u64, in_) } as i32;
    unsafe { fclose(in_) };
    if got < 0 { got = 0; }
    sqlite3_test_bin_to_hex(unsafe {
            let __p = z_buf as *mut u8;
            if __p.is_null() {
                &mut []
            } else { core::slice::from_raw_parts_mut(__p, got as usize) }
        });
    unsafe { Tcl_AppendResult(interp, z_buf, 0 as *mut ()) };
    unsafe { sqlite3_free(z_buf as *mut ()) };
    return 0;
}
extern "C" fn hexio_write(client_data_1: *mut (), interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut offset: i32 = 0;
    let mut n_in: i32 = 0;
    let mut n_out: i32 = 0;
    ...
    if objc != 4 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"FILENAME OFFSET HEXDATA".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    if unsafe {
    ...
    a_out =
        unsafe { sqlite3_malloc64((1 + n_in / 2) as sqlite3_uint64) } as
            *mut u8;
    if a_out == core::ptr::null_mut() { return 1; }
    n_out =
        sqlite3_test_hex_to_bin(unsafe {
                let __p = z_in as *const u8;
                if __p.is_null() {
                    &[]
                } else {
                    core::slice::from_raw_parts(__p, n_in as i32 as usize)
                }
            }, a_out);
    out = unsafe { fopen(z_file, c"r+b".as_ptr() as *mut i8 as *const i8) };
    if out == core::ptr::null_mut() {
        out =
            unsafe { fopen(z_file, c"r+".as_ptr() as *mut i8 as *const i8) };
    }
    if out == core::ptr::null_mut() {
        unsafe {
            Tcl_AppendResult(interp,
                c"cannot open output file ".as_ptr() as *mut i8, z_file,
                0 as *mut ())
        };
        return 1;
    }
    unsafe { fseek(out, offset as i64, 0) };
    written =
        unsafe { fwrite(a_out as *const (), 1 as u64, n_out as u64, out) } as
            i32;
...
extern "C" fn hexio_get_int(client_data_1: *mut (), interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut val: i32 = 0;
    let mut n_in: i32 = 0;
    let mut n_out: i32 = 0;
    let mut z_in: *const u8 = core::ptr::null();
    let mut a_out: *mut u8 = core::ptr::null_mut();
    let mut a_num: [u8; 4] = [0; 4];
    let mut b_little: i32 = 0;
    if objc == 3 {
        let mut n: i32 = 0;
        let z: *const i8 =
            unsafe {
                    Tcl_GetStringFromObj(unsafe { *objv.offset(1 as isize) },
                        &mut n)
                } as *const i8;
        if n >= 2 && n <= 13 &&
                unsafe {
                        memcmp(z as *const (),
                            c"-littleendian".as_ptr() as *mut i8 as *const (), n as u64)
                    } == 0 {
            b_little = 1;
        }
    }
    if objc - b_little != 2 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"[-littleendian] HEXDATA".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    z_in =
        unsafe {
                Tcl_GetStringFromObj(unsafe {
                        *objv.offset((1 + b_little) as isize)
                    }, &mut n_in)
            } as *const u8;
    a_out =
        unsafe { sqlite3_malloc64((1 + n_in / 2) as sqlite3_uint64) } as
    ...
    if n_out >= 4 {
        unsafe {
            memcpy(&raw mut a_num[0 as usize] as *mut u8 as *mut (),
                a_out as *const (), 4 as u64)
        };
    } else {
        unsafe {
            memset(&raw mut a_num[0 as usize] as *mut u8 as *mut (), 0,
                core::mem::size_of::<[u8; 4]>() as u64)
        };
        unsafe {
            memcpy(&raw mut a_num[(4 - n_out) as usize] as *mut (),
                a_out as *const (), n_out as u64)
        };
    }
    unsafe { sqlite3_free(a_out as *mut ()) };
    if b_little != 0 {
        val =
            ((a_num[3 as usize] as u32) << 24) as i32 |
                        (a_num[2 as usize] as i32) << 16 |
                    (a_num[1 as usize] as i32) << 8 | a_num[0 as usize] as i32;
    } else {
        val =
            ((a_num[0 as usize] as u32) << 24) as i32 |
                        (a_num[1 as usize] as i32) << 16 |
                    (a_num[2 as usize] as i32) << 8 | a_num[3 as usize] as i32;
    }
...
extern "C" fn hexio_render_int16(client_data_1: *mut (),
    ...
    let mut val: i32 = 0;
    let mut a_num: [u8; 10] = [0; 10];
    if objc != 2 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"INTEGER".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    if unsafe {
                Tcl_GetIntFromObj(interp, unsafe { *objv.offset(1 as isize) },
                    &mut val)
            } != 0 {
        return 1;
    }
    a_num[0 as usize] = (val >> 8) as u8;
    a_num[1 as usize] = val as u8;
    sqlite3_test_bin_to_hex(&mut a_num[..2 as usize]);
    unsafe {
        Tcl_SetObjResult(interp,
            unsafe {
                Tcl_NewStringObj(&raw mut a_num[0 as usize] as *mut i8 as
                        *const i8, 4)
            })
    };
    return 0;
...
extern "C" fn hexio_render_int32(client_data_1: *mut (),
    ...
    a_num[0 as usize] = (val >> 24) as u8;
    a_num[1 as usize] = (val >> 16) as u8;
    a_num[2 as usize] = (val >> 8) as u8;
    a_num[3 as usize] = val as u8;
    sqlite3_test_bin_to_hex(&mut a_num[..4 as usize]);
    unsafe {
        Tcl_SetObjResult(interp,
            unsafe {
                Tcl_NewStringObj(&raw mut a_num[0 as usize] as *mut i8 as
...
extern "C" fn utf8_to_utf8(client_data_1: *mut (), interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    unsafe {
        Tcl_AppendResult(interp,
            c"[utf8_to_utf8] unavailable - SQLITE_DEBUG not defined".as_ptr()
                as *mut i8, 0 as *mut ())
    };
    return 1;
}
extern "C" fn get_fts3_varint(p: *const i8, v: &mut sqlite_int64) -> i32 {
...
extern "C" fn put_fts3_varint(p: *mut i8, v: sqlite_int64) -> i32 {
        ...
        '__c3: loop {
            unsafe {
                *{
                            ...
                            *__p = unsafe { (*__p).offset(1) };
                            __t
                        } = (vu & 127 as sqlite_uint64 | 128 as sqlite_uint64) as u8
            };
            vu >>= 7 as sqlite_uint64;
            break '__c3;
        }
...
extern "C" fn read_fts3varint(client_data_1: *mut (), interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut n_blob: i32 = 0;
    let mut z_blob: *mut u8 = core::ptr::null_mut();
    let mut i_val: sqlite3_int64 = 0 as sqlite3_int64;
    let mut n_val: i32 = 0;
    if objc != 3 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"BLOB VARNAME".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    z_blob =
        unsafe {
            Tcl_GetByteArrayFromObj(unsafe { *objv.offset(1 as isize) },
                &mut n_blob)
        };
    n_val =
        get_fts3_varint(z_blob as *mut i8 as *const i8,
            unsafe { &mut *(&raw mut i_val as *mut sqlite3_int64) });
    unsafe {
        Tcl_ObjSetVar2(interp, unsafe { *objv.offset(2 as isize) },
            core::ptr::null_mut(), unsafe { Tcl_NewWideIntObj(i_val) }, 0)
    };
    unsafe { Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(n_val) }) };
    return 0;
}
extern "C" fn make_fts3record(client_data_1: *mut (), interp: *mut Tcl_Interp,
    objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut a_arg: *mut *mut Tcl_Obj = core::ptr::null_mut();
    let mut n_arg: i32 = 0;
    let mut a_out: *mut u8 = core::ptr::null_mut();
    let mut n_out: sqlite3_int64 = 0 as sqlite3_int64;
    let mut n_alloc: sqlite3_int64 = 0 as sqlite3_int64;
    let mut i: i32 = 0;
    if objc != 2 {
        unsafe {
            Tcl_WrongNumArgs(interp, 1, objv,
                c"LIST".as_ptr() as *mut i8 as *const i8)
        };
        return 1;
    }
    if unsafe {
                Tcl_ListObjGetElements(interp,
                    unsafe { *objv.offset(1 as isize) }, &mut n_arg, &mut a_arg)
            } != 0 {
        return 1;
    }
    {
        i = 0;
        '__b4: loop {
            if !(i < n_arg as i32) { break '__b4; }
            '__c4: loop {
                let mut i_val: Tcl_WideInt = 0 as Tcl_WideInt;
                if 0 ==
                        unsafe {
                            Tcl_GetWideIntFromObj(core::ptr::null_mut(),
                                unsafe { *a_arg.offset(i as isize) }, &mut i_val)
                        } {
                    if n_out + 10 as sqlite3_int64 > n_alloc {
                        let n_new: i32 =
                            if n_alloc != 0 {
                                    n_alloc * 2 as sqlite3_int64
                                } else { 128 as sqlite3_int64 } as i32;
                        let a_new: *mut u8 =
                            unsafe { sqlite3_realloc(a_out as *mut (), n_new) } as
                                *mut u8;
                        ...
                        a_out = a_new;
                        n_alloc = n_new as sqlite3_int64;
                    }
                    n_out +=
                        put_fts3_varint(unsafe {
                                        &raw mut *a_out.offset(n_out as isize)
                                    } as *mut i8, i_val) as sqlite3_int64;
                } else {
                    let mut n_val: i32 = 0;
                    let z_val: *const i8 =
                        unsafe {
                                Tcl_GetStringFromObj(unsafe { *a_arg.offset(i as isize) },
                                    &mut n_val)
                            } as *const i8;
                    while n_out + n_val as sqlite3_int64 > n_alloc {
                        let n_new_1: sqlite3_int64 =
                            if n_alloc != 0 {
                                n_alloc * 2 as sqlite3_int64
                            } else { 128 as sqlite3_int64 };
                        let a_new_1: *mut u8 =
                            unsafe {
                                    sqlite3_realloc64(a_out as *mut (),
                                        n_new_1 as sqlite3_uint64)
                                } as *mut u8;
                        if a_new_1 == core::ptr::null_mut() {
                            unsafe { sqlite3_free(a_out as *mut ()) };
                            return 1;
                        }
                        a_out = a_new_1;
                    ...
                    unsafe {
                        memcpy(unsafe { &raw mut *a_out.offset(n_out as isize) } as
                                *mut (), z_val as *const (), n_val as u64)
                    };
                    n_out += n_val as sqlite3_int64;
                }
                break '__c4;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
    ...
    unsafe {
        Tcl_SetObjResult(interp,
            unsafe { Tcl_NewByteArrayObj(a_out as *const u8, n_out as i32) })
    };
    unsafe { sqlite3_free(a_out as *mut ()) };
    return 0;
}
