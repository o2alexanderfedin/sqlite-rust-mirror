...
extern "C" fn fuzz_read_file(z_filename_1: *const i8, p_sz_1: &mut i32,
    ...
    unsafe {
        ...
        sz = unsafe { ftell(f) } as sqlite3_int64;
        unsafe { rewind(f) };
        p_buf =
            unsafe {
                sqlite3_malloc64(if sz != 0 { sz } else { 1 as sqlite3_int64 }
                        as sqlite3_uint64)
            };
...
extern "C" fn fuzz_malloc(n_byte_1: sqlite3_int64) -> *mut () {
    let p_ret: *mut () =
        unsafe { sqlite3_malloc64(n_byte_1 as sqlite3_uint64) };
...
extern "C" fn fuzz_get_varint(p: *const u8, pn_val_1: &mut i32) -> i32 {
    let mut i: i32 = 0;
    let mut n_val: sqlite3_uint64 = 0 as sqlite3_uint64;
    {
        i = 0;
        '__b2: loop {
            if !(i < 9) { break '__b2; }
...
extern "C" fn fuzz_parse_header(p_parse_1: &FuzzChangeset,
    ...
    p_grp =
        fuzz_malloc(core::mem::size_of::<FuzzChangesetGroup>() as
                    sqlite3_int64) as *mut FuzzChangesetGroup;
...
extern "C" fn __main_inner(argc: i32, argv: *const *mut i8)
    ...
    if rc == 0 {
        if argc == 2 {
            ...
            p_buf =
                fuzz_malloc(n_changeset as sqlite3_int64 * 2 as sqlite3_int64
                            + 1024 as sqlite3_int64) as *mut u8;
            if p_buf == core::ptr::null_mut() {
                rc = 7;
            } else {
                i_seed =
