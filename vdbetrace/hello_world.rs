    ...
    unsafe {
        ...
        if unsafe { (*db).n_vdbe_exec } > 1 {
            while unsafe { *z_raw_sql_1 } != 0 {
                ...
                unsafe {
                    sqlite3_str_append(&raw mut out as *mut sqlite3_str,
            ...
            while unsafe { *z_raw_sql_1.offset(0 as isize) } != 0 {
                ...
                if unsafe { (*p_var).flags } as i32 & 1 != 0 {
                    ...
                    unsafe {
                        sqlite3_str_appendf(&raw mut out as *mut sqlite3_str,
        ...
        if out.acc_error != 0 {
            unsafe { sqlite3_str_reset(&raw mut out as *mut sqlite3_str) };
        }
