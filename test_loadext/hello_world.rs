...
extern "C" fn half_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        unsafe {
            (unsafe {
                    (*sqlite3_api).result_double.unwrap()
                })(context,
                0.5 *
                    unsafe {
                        (unsafe {
                                (*sqlite3_api).value_double.unwrap()
                            })(unsafe { *argv.offset(0 as isize) })
                    })
        };
    }
}
extern "C" fn status_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut op: i32 = 0;
        let mut mx: i32 = 0;
        let mut cur: i32 = 0;
        let mut reset_flag: i32 = 0;
        let mut rc: i32 = 0;
        if unsafe {
                    (unsafe {
                            (*sqlite3_api).value_type.unwrap()
                        })(unsafe { *argv.offset(0 as isize) })
                } == 1 {
            op =
                unsafe {
            ...
            let n_op: i32 =
                (core::mem::size_of::<[status_func_s0_N14status_func_s0; 6]>()
                            as u64 / 16) as i32;
            z_name =
                unsafe {
                        (unsafe {
                    ...
                    } as *const i8;
            {
                i = 0;
                '__b0: loop {
                    if !(i < n_op) { break '__b0; }
                    '__c0: loop {
                        if unsafe { strcmp(a_op[i as usize].z_name, z_name) } == 0 {
                            op = a_op[i as usize].op as i32;
                            break '__b0;
                        }
                        break '__c0;
                    }
                ...
                let z_msg: *mut i8 =
                    unsafe {
                        (unsafe {
                            ...
                            })(c"unknown status property: %s".as_ptr() as *mut i8 as
                                *const i8, z_name)
                    };
                unsafe {
                    (unsafe {
                            (*sqlite3_api).result_error.unwrap()
                        })(context, z_msg as *const i8, -1)
                };
                unsafe {
                    (unsafe { (*sqlite3_api).free.unwrap() })(z_msg as *mut ())
                };
                return;
            }
        } else {
            unsafe {
                (unsafe {
                    ...
                    c"unknown status type".as_ptr() as *mut i8 as *const i8, -1)
            };
            return;
        }
        if argc == 2 {
        ...
        rc =
            unsafe {
                (unsafe {
                        (*sqlite3_api).status.unwrap()
                    })(op, &mut cur, &mut mx, reset_flag)
            };
        if rc != 0 {
            let z_msg_1: *mut i8 =
                unsafe {
                    (unsafe {
                            (*sqlite3_api).mprintf.unwrap()
                        })(c"sqlite3_status(%d,...) returns %d".as_ptr() as *mut i8
                            as *const i8, op, rc)
                };
            unsafe {
                (unsafe {
                        (*sqlite3_api).result_error.unwrap()
                    })(context, z_msg_1 as *const i8, -1)
            };
            unsafe {
                (unsafe { (*sqlite3_api).free.unwrap() })(z_msg_1 as *mut ())
            };
            return;
        }
        if argc == 2 {
            unsafe {
                (unsafe { (*sqlite3_api).result_int.unwrap() })(context, mx)
            };
        } else {
            unsafe {
                (unsafe { (*sqlite3_api).result_int.unwrap() })(context, cur)
            };
        }
    }
}
    ...
    unsafe {
        ...
        n_err |=
            unsafe {
                (unsafe {
                    ...
                    })(db, c"half".as_ptr() as *mut i8 as *const i8, 1, 5,
                    core::ptr::null_mut(), half_func,
                    unsafe {
        ...
        n_err |=
            unsafe {
                (unsafe {
                        (*sqlite3_api).create_function.unwrap()
                    })(db, c"sqlite3_status".as_ptr() as *mut i8 as *const i8,
                    1, 5, core::ptr::null_mut(), status_func,
                    unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn(*mut sqlite3_context, i32,
                                    *mut *mut sqlite3_value) -> ()>(0 as *const ())
        ...
        n_err |=
            unsafe {
                (unsafe {
                    ...
                    2, 5, core::ptr::null_mut(), status_func,
                    unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn(*mut sqlite3_context, i32,
                                    *mut *mut sqlite3_value) -> ()>(0 as *const ())
    ...
    unsafe {
        ...
        z_err =
            unsafe {
                (unsafe {
                        (*sqlite3_api).mprintf.unwrap()
                    })(c"broken!".as_ptr() as *mut i8 as *const i8)
            };
        *pz_err_msg_1 = z_err;
        return 1;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
struct status_func_s0_N14status_func_s0 {
    z_name: *const i8,
    op: i32,
}
static mut a_op: [status_func_s0_N14status_func_s0; 6] =
    [status_func_s0_N14status_func_s0 {
                z_name: c"MEMORY_USED".as_ptr() as *const i8,
                op: 0,
            },
            status_func_s0_N14status_func_s0 {
                z_name: c"PAGECACHE_USED".as_ptr() as *const i8,
                op: 1,
            },
            status_func_s0_N14status_func_s0 {
                z_name: c"PAGECACHE_OVERFLOW".as_ptr() as *const i8,
                op: 2,
            },
            status_func_s0_N14status_func_s0 {
                z_name: c"SCRATCH_USED".as_ptr() as *const i8,
                op: 3,
            },
            status_func_s0_N14status_func_s0 {
                z_name: c"SCRATCH_OVERFLOW".as_ptr() as *const i8,
                op: 4,
            },
            status_func_s0_N14status_func_s0 {
