...
extern "C" fn ieee754func(context: *mut sqlite3_context, argc: i32,
    ...
    if argc == 1 {
        ...
        let mut z_result: [i8; 100] = [0; 100];
        if !(core::mem::size_of::<sqlite3_int64>() as u64 ==
                                core::mem::size_of::<f64>() as u64) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"ieee754func".as_ptr() as *const i8,
                    c"ieee754.c".as_ptr() as *mut i8 as *const i8, 113,
                    c"sizeof(m)==sizeof(r)".as_ptr() as *mut i8 as *const i8)
            }
        } else { { let _ = 0; } };
        if unsafe { sqlite3_value_type(unsafe { *argv.offset(0 as isize) }) }
                ...
                unsafe {
                        ...
                        } as u64 == core::mem::size_of::<f64>() as u64 {
            let x: *const u8 =
                unsafe {
        ...
        if a == 0 as i64 {
        ...
        } else if a == 9223372036854775808u64 as sqlite3_int64 {
            e = -1996;
            ...
            while e < 1075 && m > 0 as i64 &&
                    m & 1 as sqlite3_int64 == 0 as i64 {
                m >>= 1 as sqlite3_int64;
        ...
        '__s2:
            {
            match unsafe {
                    *(unsafe { sqlite3_user_data(context) } as *mut i32)
                } {
                0 => {
                    unsafe {
                        sqlite3_snprintf(core::mem::size_of::<[i8; 100]>() as i32,
                            &raw mut z_result[0 as usize] as *mut i8,
                            c"ieee754(%lld,%d)".as_ptr() as *mut i8 as *const i8, m,
                            e - 1075)
                    };
                    unsafe {
                ...
                1 => { unsafe { sqlite3_result_int64(context, m) }; }
                2 => { unsafe { sqlite3_result_int(context, e - 1075) }; }
                _ => {}
            }
        }
    } else {
        let mut m: sqlite3_int64 = 0 as sqlite3_int64;
        let mut e: sqlite3_int64 = 0 as sqlite3_int64;
        let mut a: sqlite3_int64 = 0 as sqlite3_int64;
        let mut r: f64 = 0.0;
        let mut is_neg_1: i32 = 0;
        m =
            unsafe {
        ...
        if e > 10000 as i64 {
            e = 10000 as sqlite3_int64;
        } else if e < -10000 as i64 { e = -10000 as sqlite3_int64; }
        if m < 0 as i64 {
            if m < -9223372036854775807i64 { return; }
            is_neg_1 = 1;
            m = -m;
        } else if m == 0 as i64 && e > -1000 as i64 && e < 1000 as i64 {
            unsafe { sqlite3_result_double(context, 0.0) };
            return;
        }
        while m >> 32 & 4292870144u32 as sqlite3_int64 != 0 {
            m >>= 1 as sqlite3_int64;
            { let __p = &mut e; let __t = *__p; *__p += 1; __t };
        }
        while m != 0 as i64 &&
                m >> 32 & 4293918720u32 as sqlite3_int64 == 0 as i64 {
            m <<= 1 as sqlite3_int64;
            { let __p = &mut e; let __t = *__p; *__p -= 1; __t };
        }
        e += 1075 as sqlite3_int64;
        if e <= 0 as i64 {
            if 1 as sqlite3_int64 - e >= 64 as i64 {
                m = 0 as sqlite3_int64;
            } else { m >>= 1 as sqlite3_int64 - e; }
            e = 0 as sqlite3_int64;
        } else if e > 2047 as i64 { e = 2047 as sqlite3_int64; }
        a = m & ((1 as sqlite3_int64) << 52) - 1 as sqlite3_int64;
        a |= e << 52;
        if is_neg_1 != 0 {
            a |= ((1 as sqlite3_uint64) << 63) as sqlite3_int64;
        }
        unsafe {
            memcpy(&raw mut r as *mut (), &raw mut a as *const (),
                core::mem::size_of::<f64>() as u64)
        };
        unsafe { sqlite3_result_double(context, r) };
    }
}
extern "C" fn ieee754func_from_blob(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = argc; };
...
extern "C" fn ieee754func_to_blob(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = argc; };
    if unsafe { sqlite3_value_type(unsafe { *argv.offset(0 as isize) }) } == 2
            ||
        ...
        let mut i: u32 = 0 as u32;
        unsafe {
            memcpy(&raw mut v as *mut (), &raw mut r as *const (),
                core::mem::size_of::<f64>() as u64)
        };
        {
            i = 1 as u32;
            '__b6: loop {
                ...
                '__c6: loop {
                    a[(core::mem::size_of::<f64>() as u64 - i as u64) as usize]
                        = (v & 255 as sqlite3_uint64) as u8;
        ...
        unsafe {
            sqlite3_result_blob(context,
                &raw mut a[0 as usize] as *mut u8 as *const (),
...
extern "C" fn ieee754func_from_int(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = argc; };
...
extern "C" fn ieee754func_to_int(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    { let _ = argc; };
    if unsafe { sqlite3_value_type(unsafe { *argv.offset(0 as isize) }) } == 2
        {
        ...
        unsafe { sqlite3_result_int64(context, v as sqlite3_int64) };
    }
}
extern "C" fn ieee754inc(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let mut r: f64 = 0.0;
    let mut n: sqlite3_int64 = 0 as sqlite3_int64;
    let mut m1: sqlite3_uint64 = 0 as sqlite3_uint64;
    let mut m2: sqlite3_uint64 = 0 as sqlite3_uint64;
    let mut r2: f64 = 0.0;
    { let _ = argc; };
    r = unsafe { sqlite3_value_double(unsafe { *argv.offset(0 as isize) }) };
    n = unsafe { sqlite3_value_int64(unsafe { *argv.offset(1 as isize) }) };
    unsafe {
        memcpy(&raw mut m1 as *mut (), &raw mut r as *const (), 8 as u64)
    };
    m2 = m1 + n as sqlite3_uint64;
    unsafe {
        memcpy(&raw mut r2 as *mut (), &raw mut m2 as *const (), 8 as u64)
    };
...
pub extern "C" fn sqlite3_ieee_init(db: *mut sqlite3,
    ...
    unsafe {
        ...
        { let _ = pz_err_msg_1; };
        {
            ...
            '__b7: loop {
                if !((i as u64) <
                                    core::mem::size_of::<[sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0; 9]>()
                                            as u64 / 24 && rc == 0) {
                    break '__b7;
                }
                '__c7: loop {
                    rc =
                        unsafe {
                            sqlite3_create_function(db,
                                a_func[i as usize].z_f_name as *const i8,
                                a_func[i as usize].n_arg, 1 | 2097152,
                                &raw const a_func[i as usize].i_aux as *mut (),
...
#[repr(C)]
#[derive(Copy, Clone)]
struct sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
    z_f_name: *mut i8,
    n_arg: i32,
    i_aux: i32,
...
static mut a_func: [sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0; 9] =
    [sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 0,
                x_func: Some(ieee754func),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754".as_ptr() as *mut i8,
                n_arg: 2,
            ...
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_mantissa".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 1,
                x_func: Some(ieee754func),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_exponent".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 2,
                x_func: Some(ieee754func),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_to_blob".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 0,
                x_func: Some(ieee754func_to_blob),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_from_blob".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 0,
                x_func: Some(ieee754func_from_blob),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_to_int".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 0,
                x_func: Some(ieee754func_to_int),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_from_int".as_ptr() as *mut i8,
                n_arg: 1,
                i_aux: 0,
                x_func: Some(ieee754func_from_int),
            },
            sqlite3_ieee_init_s0_N20sqlite3_ieee_init_s0 {
                z_f_name: c"ieee754_inc".as_ptr() as *mut i8,
                n_arg: 2,
                i_aux: 0,
