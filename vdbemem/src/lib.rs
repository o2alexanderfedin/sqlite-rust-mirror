...
pub extern "C" fn sqlite3_vdbe_mem_finalize(p_mem_1: *mut Mem,
    ...
    unsafe {
        let mut ctx: Sqlite3Context = unsafe { core::mem::zeroed() };
        ...
        unsafe {
            memset(&raw mut ctx as *mut (), 0,
                core::mem::size_of::<Sqlite3Context>() as u64)
        };
        unsafe {
...
extern "C" fn vdbe_mem_render_num(sz: i32, z_buf_1: *mut i8, p: &mut Mem)
    ...
    unsafe {
        ...
        if (*p).flags as i32 & (4 | 32) != 0 {
            ...
            unsafe {
                sqlite3_str_appendf(&raw mut acc as *mut Sqlite3Str,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3ValueBytes(p_val_1: *mut Sqlite3Value, enc: u8)
    -> i32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_set_null(p: *mut Sqlite3Value) -> () {
...
pub extern "C" fn sqlite3_vdbe_mem_numerify(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        ...
        if unsafe { (*p_mem_1).flags } as i32 & (4 | 8 | 32 | 1) == 0 {
            let mut rc: i32 = 0;
            let mut ix: Sqlite3Int64 = 0 as Sqlite3Int64;
            { let _ = 0; };
            { let _ = 0; };
            rc =
                ...
                65 => {
                    {
                        if unsafe { (*p_mem_1).flags } as i32 & 16 == 0 {
                            unsafe {
                                sqlite3_value_apply_affinity(p_mem_1 as *mut Sqlite3Value,
                                    66 as u8, encoding)
                            };
                            { let _ = 0; };
...
pub extern "C" fn sqlite3_value_from_expr(db: *mut Sqlite3,
    ...
    pp_val_1: *mut *mut Sqlite3Value) -> i32 {
