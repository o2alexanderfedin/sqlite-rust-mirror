...
extern "C" fn sqlite3_prepare_2(db: *mut sqlite3, z_sql_1: *const i8,
    ...
    pp_stmt_1: &mut *mut sqlite3_stmt, pz_tail_1: *mut *const i8) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let mut i: i32 = 0;
            ...
            '__s3:
                ...
                match __state {
                    ...
                    14 => {
                        s_parse.explain =
                            unsafe {
                                    sqlite3_stmt_isexplain(p_reprepare_1 as *mut sqlite3_stmt)
                                } as u8;
                        __state = 11;
                    }
                    15 => {
                    ...
                    77 => {
                        *pp_stmt_1 = s_parse.p_vdbe as *mut sqlite3_stmt;
                        __state = 78;
                    }
                    78 => { rc = 0; __state = 79; }
...
pub extern "C" fn sqlite3_prepare(db: *mut sqlite3, z_sql_1: *const i8,
    n_bytes_1: i32, pp_stmt_1: *mut *mut sqlite3_stmt,
...
pub extern "C" fn sqlite3_prepare_v3(db: *mut sqlite3, z_sql_1: *const i8,
    n_bytes_1: i32, prep_flags_1: u32, pp_stmt_1: *mut *mut sqlite3_stmt,
    pz_tail_1: *mut *const i8) -> i32 {
    let mut rc: i32 = 0;
    rc =
...
extern "C" fn sqlite3_prepare16_2(db: *mut sqlite3, z_sql_1: *const (),
    mut n_bytes_1: i32, prep_flags_1: u32, pp_stmt_1: *mut *mut sqlite3_stmt,
...
pub extern "C" fn sqlite3_reprepare(p: *mut Vdbe) -> i32 {
    ...
    { let _ = 0; };
    z_sql = unsafe { sqlite3_sql(p as *mut sqlite3_stmt) };
    { let _ = 0; };
    ...
    unsafe { sqlite3TransferBindings(p_new, p as *mut sqlite3_stmt) };
