...
extern "C" fn keyword_code(z: *const i8, n: i64, p_type_1: &mut i32) -> i64 {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_is_id_char(c: u8) -> i32 {
    unsafe {
        return (unsafe {
...
static ai_class: [u8; 256] =
    [29 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8,
            28 as u8, 28 as u8, 7 as u8, 7 as u8, 28 as u8, 7 as u8, 7 as u8,
            28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8,
            28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8,
            28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8, 28 as u8,
            ...
            1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8,
            1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8,
            1 as u8, 0 as u8, 2 as u8, 2 as u8, 9 as u8, 28 as u8, 28 as u8,
            28 as u8, 2 as u8, 8 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8,
            1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8,
            1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8,
            1 as u8, 1 as u8, 1 as u8, 1 as u8, 1 as u8, 0 as u8, 2 as u8,
            2 as u8, 28 as u8, 10 as u8, 28 as u8, 25 as u8, 28 as u8,
            ...
            27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8,
            27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8,
            27 as u8, 27 as u8, 27 as u8, 30 as u8, 27 as u8, 27 as u8,
            27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8,
            27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8, 27 as u8,
            27 as u8, 27 as u8];
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_get_token(z: *const u8, token_type: *mut i32)
    -> i64 {
    unsafe {
        let mut i: i64 = 0 as i64;
        let mut c: i32 = 0;
        '__s2:
            ...
            match ai_class[unsafe { *z } as usize] {
                7 => {
                    ...
                    }
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 == '-' as i32 {
                            ...
                            return i;
                        } else if unsafe { *z.offset(1 as isize) } as i32 ==
                                '>' as i32 {
                            unsafe { *token_type = 113 };
                            return (2 +
                                        (unsafe { *z.offset(2 as isize) } as i32 == '>' as i32) as
                                            i32) as i64;
                        }
                        unsafe { *token_type = 108 };
                        return 1 as i64;
                    }
                    { unsafe { *token_type = 22 }; return 1 as i64; }
                    { unsafe { *token_type = 23 }; return 1 as i64; }
                    { unsafe { *token_type = 1 }; return 1 as i64; }
                    { unsafe { *token_type = 107 }; return 1 as i64; }
                    { unsafe { *token_type = 109 }; return 1 as i64; }
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 != '*' as i32 ||
                    ...
                    { unsafe { *token_type = 111 }; return 1 as i64; }
                    {
                    ...
                    }
                    {
                        if { c = unsafe { *z.offset(1 as isize) } as i32; c } ==
                            ...
                            return 2 as i64;
                        } else { unsafe { *token_type = 57 }; return 1 as i64; }
                    }
                    {
                        if { c = unsafe { *z.offset(1 as isize) } as i32; c } ==
                                '=' as i32 {
                            ...
                            return 2 as i64;
                        } else { unsafe { *token_type = 55 }; return 1 as i64; }
                    }
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 != '=' as i32 {
                            unsafe { *token_type = 186 };
                            return 1 as i64;
                        } else { unsafe { *token_type = 53 }; return 2 as i64; }
                    }
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 != '|' as i32 {
                            unsafe { *token_type = 104 };
                            return 1 as i64;
                        } else { unsafe { *token_type = 112 }; return 2 as i64; }
                    }
                    { unsafe { *token_type = 25 }; return 1 as i64; }
                    { unsafe { *token_type = 103 }; return 1 as i64; }
                    { unsafe { *token_type = 115 }; return 1 as i64; }
                    {
                        let delim: i32 = unsafe { *z.offset(0 as isize) } as i32;
                        {
                            ...
                            '__b6: loop {
                                ...
                                '__c6: loop {
                                    if c == delim {
                                        if unsafe { *z.offset((i + 1 as i64) as isize) } as i32 ==
                                                delim {
                                            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                                        } else { break '__b6; }
                                    }
                        ...
                        if c == '\'' as i32 {
                            ...
                            return i + 1 as i64;
                        } else { unsafe { *token_type = 186 }; return i; }
                    }
                    {
                        if (unsafe {
                                                    *(sqlite3_ctype_map.as_ptr() as
                    ...
                    }
                    {
                        ...
                        if unsafe { *z.offset(0 as isize) } as i32 == '0' as i32 &&
                                ...
                                '__b7: loop {
                                    ...
                                    '__c7: loop {
                                        if unsafe {
                                            ...
                                            if unsafe { *z.offset(i as isize) } as i32 == '_' as i32 {
                            ...
                            if (unsafe { *z.offset(i as isize) } as i32 == 'e' as i32 ||
                                    ...
                                    (unsafe {
                                                        *(sqlite3_ctype_map.as_ptr() as
                                                                    *const u8).add(unsafe { *z.offset((i + 1 as i64) as isize) }
                                                                        as u8 as usize)
                                                    } as i32 & 4 != 0 ||
                                        (unsafe { *z.offset((i + 1 as i64) as isize) } as i32 ==
                                                    '+' as i32 ||
                                                unsafe { *z.offset((i + 1 as i64) as isize) } as i32 ==
                                                    '-' as i32) &&
                                            unsafe {
                                                            *(sqlite3_ctype_map.as_ptr() as
                                                                        *const u8).add(unsafe { *z.offset((i + 2 as i64) as isize) }
                                                                            as u8 as usize)
                                                        } as i32 & 4 != 0) {
                                if unsafe { *token_type } == 156 {
                                    unsafe { *token_type = 154 };
                    ...
                    }
                    {
                        ...
                        unsafe {
                            *token_type = if c == ']' as i32 { 60 } else { 186 }
                        };
                        return i;
                    }
                    {
                    ...
                    }
                    {
                                        ...
                                        '__b15: loop {
                                            ...
                                            if !({ c = unsafe { *z.offset(i as isize) } as i32; c } != 0
                                                                ...
                                                                (unsafe {
                                                                                        *(sqlite3_ctype_map.as_ptr() as
                                                                                                    *const u8).add(c as u8 as usize)
                                                                                    } as i32 & 1 == 0) as i32 != 0 && c != ')' as i32) {
                                                break '__b15;
                                            }
                                        }
                                        if c == ')' as i32 {
                                            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
                                        } else { unsafe { *token_type = 186 }; }
                                        break '__b14;
                                    } else if c == ':' as i32 &&
                                            unsafe { *z.offset((i + 1 as i64) as isize) } as i32 ==
                                                ':' as i32 {
                        ...
                        if n == 0 as i64 { unsafe { *token_type = 186 }; }
                        return i;
                    }
                    {
                        if ai_class[unsafe { *z.offset(1 as isize) } as usize] as
                                    i32 > 2 {
                            i = 1 as i64;
                            break '__s2;
                        }
                        ...
                        unsafe { *token_type = 60 };
                        return keyword_code(z as *mut i8 as *const i8, i,
                                unsafe { &mut *token_type });
                    }
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 == '\'' as i32 {
                    ...
                    { i = 1 as i64; break '__s2; }
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 == 187 &&
                                unsafe { *z.offset(2 as isize) } as i32 == 191 {
                            unsafe { *token_type = 184 };
                            return 3 as i64;
                        }
                        i = 1 as i64;
                    ...
                    { unsafe { *token_type = 186 }; return 0 as i64; }
                    { unsafe { *token_type = 186 }; return 1 as i64; }
                }
                11 => {
                    {
                        if unsafe { *z.offset(1 as isize) } as i32 == '-' as i32 {
                ...
                _ => { { unsafe { *token_type = 186 }; return 1 as i64; } }
            }
        }
        while unsafe {
                            *(sqlite3_ctype_map.as_ptr() as
...
extern "C" fn get_token(pz: &mut *const u8) -> i32 {
    let mut z: *const u8 = *pz;
    let mut t: i32 = 0;
    '__b20: loop {
        '__c20: loop {
            {
                let __n = sqlite3_get_token(z, &mut t);
                let __p = &mut z;
                *__p = unsafe { (*__p).offset(__n as isize) };
            };
            break '__c20;
        }
        if !(t == 184 || t == 185) { break '__b20; }
    }
    if t == 60 || t == 118 || t == 119 || t == 165 || t == 166 ||
            unsafe { sqlite3_parser_fallback(t) } == 60 {
        t = 60;
    }
    *pz = z;
    return t;
}
extern "C" fn analyze_window_keyword(mut z: *const u8) -> i32 {
    let mut t: i32 = 0;
    t = get_token(&mut z);
    if t != 60 { return 60; }
    t = get_token(&mut z);
...
extern "C" fn analyze_over_keyword(mut z: *const u8, last_token_1: i32)
    -> i32 {
    if last_token_1 == 23 {
        let t: i32 = get_token(&mut z);
        if t == 22 || t == 60 { return 166; }
    }
    return 60;
}
extern "C" fn analyze_filter_keyword(mut z: *const u8, last_token_1: i32)
    -> i32 {
    if last_token_1 == 23 && get_token(&mut z) == 22 { return 167; }
    return 60;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_run_parser(p_parse: *mut Parse,
    mut z_sql: *const i8) -> i32 {
    unsafe {
        let mut n_err: i32 = 0;
        let mut p_engine: *mut () = core::ptr::null_mut();
        let mut n: i64 = 0 as i64;
        let mut token_type: i32 = 0;
        let mut last_token_parsed: i32 = -1;
        let db: *mut sqlite3 = unsafe { (*p_parse).db };
        let mut mx_sql_len: i64 = 0 as i64;
        let mut p_parent_parse: *mut Parse = core::ptr::null_mut();
        { let _ = 0; };
        mx_sql_len = unsafe { (*db).a_limit[1 as usize] } as i64;
        ...
        unsafe { (*p_parse).rc = 0 };
        unsafe { (*p_parse).z_tail = z_sql };
        p_engine =
            unsafe { sqlite3_parser_alloc(Some(sqlite3Malloc), p_parse) };
        if p_engine == core::ptr::null_mut() {
        ...
        { let _ = 0; };
        { let _ = 0; };
        p_parent_parse = unsafe { (*db).p_parse };
        unsafe { (*db).p_parse = p_parse };
        loop {
            n =
                sqlite3_get_token(z_sql as *mut u8 as *const u8,
                    &mut token_type);
            mx_sql_len -= n;
            if mx_sql_len < 0 as i64 {
            ...
            if token_type >= 165 {
                ...
                if unsafe { *z_sql.offset(0 as isize) } as i32 == 0 {
                    ...
                    { let _ = 0; };
                    token_type =
                        analyze_window_keyword(unsafe {
                                    &raw const *z_sql.offset(6 as isize)
                                } as *const u8);
                } else if token_type == 166 {
                    { let _ = 0; };
                    token_type =
                        analyze_over_keyword(unsafe {
                                    &raw const *z_sql.offset(4 as isize)
                                } as *const u8, last_token_parsed);
                } else if token_type == 167 {
                    { let _ = 0; };
                    token_type =
                        analyze_filter_keyword(unsafe {
                                    &raw const *z_sql.offset(6 as isize)
                                } as *const u8, last_token_parsed);
                } else if token_type == 185 &&
                        (unsafe { (*db).init.busy } != 0 ||
                            unsafe { (*db).flags } & (64 as u64) << 32 != 0 as u64) {
                    {
                        let __n = n;
                        let __p = &mut z_sql;
                        *__p = unsafe { (*__p).offset(__n as isize) };
                    ...
                    unsafe {
                        sqlite3_error_msg(p_parse,
                            c"unrecognized token: \"%T\"".as_ptr() as *mut i8 as
                                *const i8, &raw mut x as *mut Token)
                    };
                    break;
                }
            }
            unsafe { (*p_parse).s_last_token.z = z_sql };
            unsafe { (*p_parse).s_last_token.n = n as u32 };
            unsafe {
                sqlite3_parser(p_engine, token_type,
                    unsafe { (*p_parse).s_last_token })
            };
            ...
            { let _ = 0; };
            if unsafe { (*p_parse).rc } != 0 { break; }
        }
        { let _ = 0; };
        unsafe { sqlite3_parser_free(p_engine, Some(sqlite3_free)) };
        if unsafe { (*db).malloc_failed } != 0 {
            unsafe { (*p_parse).rc = 7 };
        }
        if !(unsafe { (*p_parse).z_err_msg }).is_null() ||
                unsafe { (*p_parse).rc } != 0 &&
                    unsafe { (*p_parse).rc } != 101 {
            if unsafe { (*p_parse).z_err_msg } == core::ptr::null_mut() {
                unsafe {
                    (*p_parse).z_err_msg =
                        unsafe {
                            sqlite3_db_str_dup(db,
                                unsafe { sqlite3_err_str(unsafe { (*p_parse).rc }) })
                        }
                };
            }
            if unsafe { (*p_parse).prep_flags } as i32 & 16 == 0 {
                unsafe {
                    sqlite3_log(unsafe { (*p_parse).rc },
                        c"%s in \"%s\"".as_ptr() as *mut i8 as *const i8,
                        unsafe { (*p_parse).z_err_msg },
                        unsafe { (*p_parse).z_tail })
                };
            }
        ...
        unsafe { (*p_parse).z_tail = z_sql };
        unsafe {
            sqlite3_free(unsafe { (*p_parse).ap_vtab_lock } as *mut ())
        };
        if !(unsafe { (*p_parse).p_new_table }).is_null() &&
                !(unsafe { (*p_parse).e_parse_mode } as i32 != 0) as i32 != 0
            {
            unsafe {
                sqlite3_delete_table(db, unsafe { (*p_parse).p_new_table })
            };
        }
        if !(unsafe { (*p_parse).p_new_trigger }).is_null() &&
            ...
            {
            unsafe {
                sqlite3_delete_trigger(db,
                    unsafe { (*p_parse).p_new_trigger })
            };
        }
        if !(unsafe { (*p_parse).p_v_list }).is_null() {
            unsafe {
                sqlite3_db_nn_free_nn(db,
                    unsafe { (*p_parse).p_v_list } as *mut ())
            };
        }
        unsafe { (*db).p_parse = p_parent_parse };
        { let _ = 0; };
        return n_err;
    }
}
