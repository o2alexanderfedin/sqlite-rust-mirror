...
extern "C" fn explain_connect(db: *mut Sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<ExplainVtab>() as
                            Sqlite3Uint64)
                } as *mut ExplainVtab;
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<ExplainVtab>() as u64)
        };
        unsafe { (*p_new).db = db };
    }
    return rc;
...
extern "C" fn explain_open(p: *mut Sqlite3Vtab,
    ...
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<ExplainCursor>() as
                        Sqlite3Uint64)
            } as *mut ExplainCursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<ExplainCursor>() as u64)
    };
    unsafe { (*p_cur).db = unsafe { (*(p as *mut ExplainVtab)).db } };
...
extern "C" fn explain_filter(p_vtab_cursor_1: *mut Sqlite3VtabCursor,
    ...
    let p_cur: *mut ExplainCursor = p_vtab_cursor_1 as *mut ExplainCursor;
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut explain_module as *const Sqlite3Module,
                    core::ptr::null_mut())
            };
        return rc;
    }
