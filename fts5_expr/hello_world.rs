...
extern "C" fn fts5_parse_alloc(t: u64) -> *mut () {
    return unsafe { sqlite3_malloc64(t as sqlite3_int64 as sqlite3_uint64) };
}
    ...
    *pz_err = core::ptr::null_mut();
    ...
    if s_parse.rc == 0 && i_col < unsafe { (*p_config).n_col } {
        ...
        let p_colset: *mut Fts5Colset =
            unsafe {
                    sqlite3_fts5_malloc_zero(&mut s_parse.rc,
                        n as sqlite3_int64)
                } as *mut Fts5Colset;
        if !(p_colset).is_null() {
                ...
                19 => {
                    n_byte =
                        (core::mem::size_of::<Fts5PoslistReader>() as u64 *
                                    n_alloc as u64 * 2 as u64) as sqlite3_int64;
                    __state = 20;
                }
                20 => {
                    a_new =
        ...
        '__s25:
            ...
            match __state {
                ...
                11 => {
                    n_byte =
                        (core::mem::size_of::<Fts5PoslistReader>() as u64 *
                                (*p_phrase_1).n_term as u64) as sqlite3_int64;
                    __state = 12;
                }
                12 => {
                    a_iter =
                ...
                11 => {
                    n_byte =
                        (core::mem::size_of::<Fts5NearTrimmer>() as u64 *
                                (*p_near_1).n_phrase as u64) as sqlite3_int64;
                    __state = 13;
                }
                12 => {
                    unsafe {
    ...
    if (*p_parse_1).n_phrase % 8 == 0 {
        let n_byte: sqlite3_int64 =
            (core::mem::size_of::<*mut Fts5ExprPhrase>() as u64 *
                    ((*p_parse_1).n_phrase + 8) as u64) as sqlite3_int64;
...
pub extern "C" fn sqlite3_fts5_parse_nearset(p_parse: *mut Fts5Parse,
    ...
    if unsafe { (*p_parse).rc } == 0 {
        if p_near == core::ptr::null_mut() {
            ...
            let mut n_byte_1: sqlite3_int64 = 0 as sqlite3_int64;
            n_byte_1 =
                (core::mem::offset_of!(Fts5ExprNearset, ap_phrase) as u64 +
                        (n_new + 1) as u64 *
                            core::mem::size_of::<*mut Fts5ExprPhrase>() as u64) as
        ...
        p_new =
            unsafe {
                    sqlite3_fts5_malloc_zero(&mut rc,
                        core::mem::size_of::<Fts5Expr>() as sqlite3_int64)
                } as *mut Fts5Expr;
    }
    if rc == 0 {
        unsafe {
            (*p_new).ap_expr_phrase =
                unsafe {
                        sqlite3_fts5_malloc_zero(&mut rc,
                            core::mem::size_of::<*mut Fts5ExprPhrase>() as
                                sqlite3_int64)
                    } as *mut *mut Fts5ExprPhrase
        };
    }
    ...
    p_ret =
        unsafe {
                sqlite3_fts5_malloc_zero(&mut (*p_parse).rc,
                    (core::mem::size_of::<i64>() as u64 *
                            ((n_col + 1 + 2) / 2) as u64) as sqlite3_int64)
            } as *mut Fts5Colset;
    if !(p_ret).is_null() {
        let mut i: i32 = 0;
        let mut i_old: i32 = 0;
