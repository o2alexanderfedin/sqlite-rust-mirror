...
extern "C" fn x_sql_callback(p_sql_arg_1: *mut (), z_sql_1: *const i8)
    ...
    let mut p_eval: *mut TclObj = core::ptr::null_mut();
    let mut res: i32 = 0;
            ...
            rc =
                unsafe {
                    Tcl_GetIndexFromObjStruct(interp,
                        ...
                        &raw mut a_sub[0 as usize] as *mut RecoverSubN10RecoverSub
                            as *const (),
                        core::mem::size_of::<RecoverSubN10RecoverSub>() as i32,
...
extern "C" {
    ...
    -> *mut TclObj;
    fn Tcl_GetCharLength(objPtr: *mut TclObj)
    -> i32;
