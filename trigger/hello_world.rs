                            ...
                            sqlite3_id_list_index(p_id_list_1,
                                unsafe {
                                        (*(unsafe { (*p_e_list_1).a.as_ptr() } as
                                                        *mut ExprList_item).offset(e as isize)).z_e_name
                                    } as *const i8)
                        } >= 0 {
                    return 1;
                }
...
extern "C" fn code_returning_trigger(p_parse_1: *mut Parse,
    ...
    unsafe {
        ...
        let mut u_src:
                code_returning_trigger_u0_N25code_returning_trigger_u0 =
...
#[repr(C)]
#[derive(Copy, Clone)]
union code_returning_trigger_u0_N25code_returning_trigger_u0 {
    s_src: SrcList,
    from_space: [u8; 80],
}
extern "C" {
