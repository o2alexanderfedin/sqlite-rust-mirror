...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_incomplete(mut z_sql: *const i8) -> sqlite3_int64 {
    unsafe {
        ...
        loop {
            ...
            '__s1:
                ...
                match __state {
                    ...
                    3 => { __state = 4; }
                    4 => { pending = 0 as u8; __state = 5; }
                    5 => { n_paren = 0; __state = 6; }
                    6 => { __state = 7; }
                    7 => { __state = 8; }
                    8 => {
                        if unsafe { *z_sql } != 0 {
                    ...
                    11 => {
                        state = trans[state as usize][token as usize] as u8;
                        __state = 119;
                    }
                    12 => { token = 0 as u8; __state = 29; }
                    13 => { __state = 14; }
                    14 => { __state = 15; }
                    15 => { __state = 16; }
                    16 => { __state = 17; }
                    17 => { token = 1 as u8; __state = 31; }
                    18 => {
                        if unsafe { *z_sql.offset(1 as isize) } as i32 != '*' as i32
                            {
                            __state = 35;
                        } else { __state = 34; }
                    }
                    ...
                    21 => { __state = 22; }
                    22 => { __state = 23; }
                    23 => { c = unsafe { *z_sql } as i32; __state = 65; }
                    24 => {
                    ...
                    26 => {
                        if unsafe {
                                            *(sqlite3_ctype_map.as_ptr() as
                                                        *const u8).add(unsafe { *z_sql } as u8 as u8 as usize)
                                        } as i32 & 70 != 0 {
                            __state = 81;
                        } else { __state = 82; }
                    }
                    ...
                    35 => { token = 2 as u8; __state = 36; }
                    36 => { __state = 11; }
                    37 => {
                        if unsafe { *z_sql.offset(0 as isize) } != 0 &&
                                (unsafe { *z_sql.offset(0 as isize) } as i32 != '*' as i32
                                    ||
                                    unsafe { *z_sql.offset(1 as isize) } as i32 != '/' as i32) {
                            __state = 39;
                        } else { __state = 38; }
                    }
                    38 => {
                    ...
                    41 => { pending = '/' as i32 as u8; __state = 42; }
                    42 => { __state = 2; }
                    43 => { token = 1 as u8; __state = 44; }
                    44 => { __state = 11; }
                    45 => { __state = 20; }
                    46 => {
                        if unsafe { *z_sql } != 0 &&
                    ...
                    47 => { token = 2 as u8; __state = 48; }
                    48 => { __state = 11; }
                    49 => {
                        if unsafe { *z_sql } as i32 == 0 {
                            __state = 52;
                        } else { __state = 51; }
                    }
                    50 => {
                    ...
                    53 => { __state = 2; }
                    54 => { pending = '-' as i32 as u8; __state = 53; }
                    55 => { __state = 11; }
                    56 => { __state = 21; }
                    57 => {
                        if unsafe { *z_sql } != 0 &&
                                unsafe { *z_sql } as i32 != ']' as i32 {
                            __state = 59;
                        } else { __state = 58; }
                    }
                    58 => {
                    ...
                    60 => { token = 2 as u8; __state = 63; }
                    61 => { pending = ']' as i32 as u8; __state = 62; }
                    62 => { __state = 2; }
                    63 => { __state = 11; }
                    64 => { __state = 73; }
                    65 => {
                    ...
                    66 => {
                        if unsafe { *z_sql } != 0 && unsafe { *z_sql } as i32 != c {
                            __state = 68;
                        } else { __state = 67; }
                    }
                    67 => {
                    ...
                    69 => { token = 2 as u8; __state = 72; }
                    70 => { pending = c as u8; __state = 71; }
                    71 => { __state = 2; }
                    72 => { __state = 11; }
                    73 => { __state = 24; }
                    74 => { __state = 25; }
                    75 => { token = 2 as u8; __state = 76; }
                    76 => { __state = 11; }
                    77 => { __state = 26; }
                    78 => { token = 2 as u8; __state = 79; }
                    79 => { __state = 11; }
                    80 => { __state = 11; }
                    81 => { __state = 83; }
                    82 => { token = 2 as u8; __state = 80; }
                    83 => { n_id = 1; __state = 85; }
                    84 => {
                        '__s3:
                            {
                            match unsafe { *z_sql } {
                    ...
                    85 => {
                        if unsafe {
                                            *(sqlite3_ctype_map.as_ptr() as
                                                        *const u8).add(unsafe { *z_sql.offset(n_id as isize) } as u8
                                                        as usize)
                                        } as i32 & 70 != 0 {
                            __state = 86;
                        } else { __state = 84; }
                    ...
                    86 => { __state = 87; }
                    87 => {
                        { let __p = &mut n_id; let __t = *__p; *__p += 1; __t };
                        __state = 85;
                    }
                    88 => {
                        {
                    ...
                    90 => {
                        if n_id == 6 &&
                                unsafe {
                                        sqlite3_strnicmp(z_sql,
                                            c"create".as_ptr() as *mut i8 as *const i8, 6)
                                    } == 0 {
                            __state = 99;
                        } else { __state = 100; }
                    }
                    ...
                    92 => {
                        if n_id == 7 &&
                                unsafe {
                                        sqlite3_strnicmp(z_sql,
                                            c"trigger".as_ptr() as *mut i8 as *const i8, 7)
                                    } == 0 {
                            __state = 104;
                        } else { __state = 105; }
                    }
                    ...
                    94 => {
                        if n_id == 3 &&
                                unsafe {
                                        sqlite3_strnicmp(z_sql,
                                            c"end".as_ptr() as *mut i8 as *const i8, 3)
                                    } == 0 {
                            __state = 113;
                        } else { __state = 114; }
                    }
                    95 => { token = 2 as u8; __state = 118; }
                    96 => { __state = 89; }
                    97 => { __state = 101; }
                    98 => { __state = 88; }
                    99 => { token = 4 as u8; __state = 98; }
                    100 => { token = 2 as u8; __state = 98; }
                    101 => { __state = 91; }
                    102 => { __state = 110; }
                    103 => { __state = 88; }
                    104 => { token = 6 as u8; __state = 103; }
                    105 => {
                        if n_id == 4 &&
                                unsafe {
                                        sqlite3_strnicmp(z_sql,
                                            c"temp".as_ptr() as *mut i8 as *const i8, 4)
                                    } == 0 {
                            __state = 106;
                        } else { __state = 107; }
                    }
                    106 => { token = 5 as u8; __state = 103; }
                    107 => {
                        if n_id == 9 &&
                                unsafe {
                                        sqlite3_strnicmp(z_sql,
                                            c"temporary".as_ptr() as *mut i8 as *const i8, 9)
                                    } == 0 {
                            __state = 108;
                        } else { __state = 109; }
                    }
                    108 => { token = 5 as u8; __state = 103; }
                    109 => { token = 2 as u8; __state = 103; }
                    110 => { __state = 93; }
                    111 => { __state = 117; }
                    112 => { __state = 88; }
                    113 => { token = 7 as u8; __state = 112; }
                    114 => {
                        if n_id == 7 &&
                                unsafe {
                                        sqlite3_strnicmp(z_sql,
                                            c"explain".as_ptr() as *mut i8 as *const i8, 7)
                                    } == 0 {
                            __state = 115;
                        } else { __state = 116; }
                    }
                    115 => { token = 3 as u8; __state = 112; }
                    116 => { token = 2 as u8; __state = 112; }
                    117 => { __state = 95; }
                    118 => { __state = 88; }
                    119 => {
                        {
                    ...
                    120 => {
                        return ((n_paren as u64) << 32 | (pending as u64) << 16 |
                                        (statemap[state as usize] as u64) << 8 |
                                    (state as i32 != 1) as u64) as i64;
                    }
                    121 => { n_paren = 0; __state = 120; }
                    _ => {}
                }
            }
        }
...
pub extern "C" fn sqlite3_complete16(z_sql: *const ()) -> i32 {
    ...
    let mut z_sql8: *const i8 = core::ptr::null();
    let mut rc: i32 = 0;
    rc = unsafe { sqlite3_initialize() };
    if rc != 0 { return rc; }
    p_val = unsafe { sqlite3_value_new(core::ptr::null_mut()) };
    unsafe { sqlite3_value_set_str(p_val, -1, z_sql, 2 as u8, None) };
    z_sql8 = unsafe { sqlite3ValueText(p_val, 1 as u8) } as *const i8;
    if !(z_sql8).is_null() {
        rc = (sqlite3_incomplete(z_sql8) == 0 as i64) as i32;
    } else { rc = 7; }
...
static trans: [[u8; 8]; 8] =
    [[1 as u8, 0 as u8, 2 as u8, 3 as u8, 4 as u8, 2 as u8, 2 as u8, 2 as u8],
            [1 as u8, 1 as u8, 2 as u8, 3 as u8, 4 as u8, 2 as u8, 2 as u8,
                    2 as u8],
            [1 as u8, 2 as u8, 2 as u8, 2 as u8, 2 as u8, 2 as u8, 2 as u8,
                    2 as u8],
            [1 as u8, 3 as u8, 3 as u8, 2 as u8, 4 as u8, 2 as u8, 2 as u8,
                    2 as u8],
            [1 as u8, 4 as u8, 2 as u8, 2 as u8, 2 as u8, 4 as u8, 5 as u8,
                    2 as u8],
            [6 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8,
                    5 as u8],
            [6 as u8, 6 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8,
                    7 as u8],
            [1 as u8, 7 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8, 5 as u8,
                    5 as u8]];
static statemap: [u8; 8] =
    [1 as u8, 0 as u8, 1 as u8, 1 as u8, 1 as u8, 3 as u8, 2 as u8, 1 as u8];
extern "C" {
