...
pub extern "C" fn sqlite3_fts5_malloc_zero(p_rc: &mut i32,
    n_byte: sqlite3_int64) -> *mut () {
    let mut p_ret: *mut () = core::ptr::null_mut();
    if *p_rc == 0 {
        p_ret = unsafe { sqlite3_malloc64(n_byte as sqlite3_uint64) };
...
pub extern "C" fn sqlite3_fts5_strndup(p_rc: &mut i32, p_in: *const i8,
    ...
    if *p_rc == 0 {
        ...
        z_ret =
            unsafe {
                    sqlite3_malloc64((n_in as i64 + 1 as i64) as sqlite3_uint64)
                } as *mut i8;
        if !(z_ret).is_null() {
            unsafe {
...
pub extern "C" fn sqlite3_fts5_termset_new(pp: &mut *mut Fts5Termset) -> i32 {
    ...
    *pp =
        sqlite3_fts5_malloc_zero(&mut rc,
                core::mem::size_of::<Fts5Termset>() as sqlite3_int64) as
            *mut Fts5Termset;
    return rc;
}
#[unsafe(no_mangle)]
            ...
            p_entry =
                sqlite3_fts5_malloc_zero(&mut rc,
                        (core::mem::size_of::<Fts5TermsetEntry>() as u64 +
                                n_term_1 as u64) as sqlite3_int64) as *mut Fts5TermsetEntry;
            if !(p_entry).is_null() {
                unsafe {
                    (*p_entry).p_term =
