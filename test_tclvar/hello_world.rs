...
extern "C" fn tclvar_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut p_vtab: *mut tclvar_vtab = core::ptr::null_mut();
    p_vtab =
        unsafe {
                sqlite3_malloc_zero(core::mem::size_of::<tclvar_vtab>() as
                        u64)
            } as *mut tclvar_vtab;
    if p_vtab == core::ptr::null_mut() { return 7; }
    unsafe { *pp_vtab_1 = unsafe { &mut (*p_vtab).base } };
    unsafe { (*p_vtab).interp = p_aux_1 as *mut Tcl_Interp };
    unsafe {
        sqlite3_declare_vtab(db, &raw const z_schema[0 as usize] as *const i8)
    };
    return 0;
}
extern "C" fn tclvar_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe { sqlite3_free(p_vtab_1 as *mut ()) };
    return 0;
}
extern "C" fn tclvar_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut tclvar_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc_zero(core::mem::size_of::<tclvar_cursor>() as
                        u64)
            } as *mut tclvar_cursor;
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn tclvar_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut tclvar_cursor = cur as *mut tclvar_cursor;
    if !(unsafe { (*p_cur).p_list1 }).is_null() {
        '__b0: loop {
            '__c0: loop {
                if {
                            let __p =
                                unsafe { &mut (*unsafe { (*p_cur).p_list1 }).refCount };
                            *__p -= 1;
                            *__p
                        } <= 0 {
                    unsafe { TclFreeObj(unsafe { (*p_cur).p_list1 }) };
                }
                break '__c0;
            }
            if !(0 != 0) { break '__b0; }
    ...
    if !(unsafe { (*p_cur).p_list2 }).is_null() {
        '__b1: loop {
            '__c1: loop {
                if {
                            let __p =
                                unsafe { &mut (*unsafe { (*p_cur).p_list2 }).refCount };
                            *__p -= 1;
                            *__p
                        } <= 0 {
                    unsafe { TclFreeObj(unsafe { (*p_cur).p_list2 }) };
                }
                break '__c1;
            }
            if !(0 != 0) { break '__b1; }
...
extern "C" fn next2(interp: *mut Tcl_Interp, p_cur_1: &mut tclvar_cursor,
    p_obj_1: *mut Tcl_Obj) -> i32 {
    let mut p: *mut Tcl_Obj = core::ptr::null_mut();
    if !(p_obj_1).is_null() {
        if ((*p_cur_1).p_list2).is_null() as i32 != 0 {
            p =
                unsafe {
                    Tcl_NewStringObj(c"array names".as_ptr() as *mut i8 as
                            *const i8, -1)
                };
            { let __p = unsafe { &mut (*p).refCount }; *__p += 1; *__p };
            unsafe {
                Tcl_ListObjAppendElement(core::ptr::null_mut(), p, p_obj_1)
            };
            unsafe { Tcl_EvalObjEx(interp, p, 131072) };
            '__b2: loop {
                '__c2: loop {
                    if {
                                let __p = unsafe { &mut (*p).refCount };
                                *__p -= 1;
                                *__p
                            } <= 0 {
                        unsafe { TclFreeObj(p) };
            ...
            (*p_cur_1).p_list2 = unsafe { Tcl_GetObjResult(interp) };
            {
                let __p = unsafe { &mut (*(*p_cur_1).p_list2).refCount };
                *__p += 1;
                *__p
            };
            { let _ = 0; };
            ...
            let mut n: i32 = 0;
            { let __p = &mut (*p_cur_1).i2; let __t = *__p; *__p += 1; __t };
            unsafe {
                Tcl_ListObjLength(core::ptr::null_mut(), (*p_cur_1).p_list2,
                    &mut n)
            };
            if (*p_cur_1).i2 >= n {
                '__b3: loop {
                    '__c3: loop {
                        if {
                            ...
                            unsafe { TclFreeObj((*p_cur_1).p_list2) };
                        }
                        break '__c3;
                    }
                    if !(0 != 0) { break '__b3; }
                }
                (*p_cur_1).p_list2 = core::ptr::null_mut();
                (*p_cur_1).i2 = 0;
                return 0;
            }
        }
...
extern "C" fn tclvar_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    unsafe {
        let mut p_obj: *mut Tcl_Obj = core::ptr::null_mut();
        let mut n: i32 = 0;
        let mut ok: i32 = 0;
        let p_cur: *mut tclvar_cursor = cur as *mut tclvar_cursor;
        let interp: *mut Tcl_Interp =
            unsafe {
                (*(unsafe { (*cur).p_vtab } as *mut tclvar_vtab)).interp
            };
        unsafe {
            Tcl_ListObjLength(core::ptr::null_mut(),
                unsafe { (*p_cur).p_list1 }, &mut n)
        };
        while (ok == 0) as i32 != 0 && unsafe { (*p_cur).i1 } < n {
            unsafe {
                Tcl_ListObjIndex(core::ptr::null_mut(),
                    unsafe { (*p_cur).p_list1 }, unsafe { (*p_cur).i1 },
                    &mut p_obj)
            };
            ok = next2(interp, unsafe { &mut *p_cur }, p_obj);
            if (ok == 0) as i32 != 0 {
                {
                    let __p = unsafe { &mut (*p_cur).i1 };
                    let __t = *__p;
                    *__p += 1;
                    __t
                };
...
extern "C" fn tclvar_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    unsafe {
        let p_cur: *mut tclvar_cursor = p_vtab_cursor_1 as *mut tclvar_cursor;
        let interp: *mut Tcl_Interp =
            unsafe {
                (*(unsafe { (*p_vtab_cursor_1).p_vtab } as
                                *mut tclvar_vtab)).interp
            };
        let p: *mut Tcl_Obj =
            unsafe {
                Tcl_NewStringObj(c"tclvar_filter_cmd".as_ptr() as *mut i8 as
                        *const i8, -1)
            };
        let mut z_eq: *const i8 = c"".as_ptr() as *mut i8 as *const i8;
        let mut z_match: *const i8 = c"".as_ptr() as *mut i8 as *const i8;
        let mut z_glob: *const i8 = c"".as_ptr() as *mut i8 as *const i8;
        let mut z_regexp: *const i8 = c"".as_ptr() as *mut i8 as *const i8;
        let mut z_like: *const i8 = c"".as_ptr() as *mut i8 as *const i8;
        let mut i: i32 = 0;
        {
            i = 0;
            '__b5: loop {
                if !(unsafe { *idx_str_1.offset(i as isize) } != 0) {
                    break '__b5;
                }
                '__c5: loop {
                    '__s6:
                        {
                        match unsafe { *idx_str_1.offset(i as isize) } {
                            101 => {
                                z_eq =
                                    unsafe {
        ...
        { let __p = unsafe { &mut (*p).refCount }; *__p += 1; *__p };
        unsafe {
            Tcl_ListObjAppendElement(core::ptr::null_mut(), p,
                unsafe { Tcl_NewStringObj(z_eq, -1) })
        };
        unsafe {
            Tcl_ListObjAppendElement(core::ptr::null_mut(), p,
                unsafe { Tcl_NewStringObj(z_match, -1) })
        };
        unsafe {
            Tcl_ListObjAppendElement(core::ptr::null_mut(), p,
                unsafe { Tcl_NewStringObj(z_glob, -1) })
        };
        unsafe {
            Tcl_ListObjAppendElement(core::ptr::null_mut(), p,
                unsafe { Tcl_NewStringObj(z_regexp, -1) })
        };
        unsafe {
            Tcl_ListObjAppendElement(core::ptr::null_mut(), p,
                unsafe { Tcl_NewStringObj(z_like, -1) })
        };
        unsafe { Tcl_EvalObjEx(interp, p, 131072) };
        if !(unsafe { (*p_cur).p_list1 }).is_null() {
            '__b7: loop {
        ...
        if !(unsafe { (*p_cur).p_list2 }).is_null() {
            ...
            unsafe { (*p_cur).p_list2 = core::ptr::null_mut() };
        }
        unsafe { (*p_cur).i1 = 0 };
        unsafe { (*p_cur).i2 = 0 };
        unsafe { (*p_cur).p_list1 = unsafe { Tcl_GetObjResult(interp) } };
        {
            let __p = unsafe { &mut (*unsafe { (*p_cur).p_list1 }).refCount };
            *__p += 1;
            *__p
        };
        '__b9: loop {
...
extern "C" fn tclvar_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    unsafe {
        let mut p1: *mut Tcl_Obj = core::ptr::null_mut();
        let mut p2: *mut Tcl_Obj = core::ptr::null_mut();
        let mut z1: *const i8 = core::ptr::null();
        let mut z2: *const i8 = c"".as_ptr() as *mut i8 as *const i8;
        let p_cur: *const tclvar_cursor =
            cur as *mut tclvar_cursor as *const tclvar_cursor;
        let interp: *mut Tcl_Interp =
            unsafe {
                (*(unsafe { (*cur).p_vtab } as *mut tclvar_vtab)).interp
            };
        unsafe {
            Tcl_ListObjIndex(interp, unsafe { (*p_cur).p_list1 },
                unsafe { (*p_cur).i1 }, &mut p1)
        };
        unsafe {
            Tcl_ListObjIndex(interp, unsafe { (*p_cur).p_list2 },
                unsafe { (*p_cur).i2 }, &mut p2)
        };
        z1 = unsafe { Tcl_GetString(p1) } as *const i8;
        if !(p2).is_null() { z2 = unsafe { Tcl_GetString(p2) } as *const i8; }
        '__s10:
            {
            match i {
                0 => {
                    ...
                    {
                        let p_val: *mut Tcl_Obj =
                            unsafe {
                                Tcl_GetVar2Ex(interp, z1,
                                    if unsafe { *z2 } != 0 { z2 } else { core::ptr::null() }, 1)
                            };
                        unsafe {
                            sqlite3_result_text(ctx,
                                unsafe { Tcl_GetString(p_val) } as *const i8, -1,
                                Some(unsafe {
                                        core::mem::transmute::<*const (),
                                                unsafe extern "C" fn(*mut ())
                                                    -> ()>(-1 as isize as *const ())
                    ...
                    {
                        let mut z3: *const i8 = core::ptr::null();
                        if !(p2).is_null() {
                            z3 =
                                unsafe {
                            ...
                            unsafe {
                                sqlite3_result_text(ctx, z3 as *const i8, -1,
                                    Some(sqlite3_free))
                            };
                        } else {
                            unsafe {
...
extern "C" fn tclvar_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid_1: *mut sqlite_int64) -> i32 {
    unsafe { *p_rowid_1 = 0 as sqlite_int64 };
    return 0;
}
extern "C" fn tclvar_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const tclvar_cursor =
        cur as *mut tclvar_cursor as *const tclvar_cursor;
...
extern "C" fn tclvar_add_to_idxstr(z_str_1: *mut i8, x: i8) -> i32 {
    let mut i: i32 = 0;
    {
        i = 0;
        '__b11: loop {
            if !(unsafe { *z_str_1.offset(i as isize) } != 0) {
                break '__b11;
            }
            '__c11: loop {
                if unsafe { *z_str_1.offset(i as isize) } as i32 == x as i32 {
                    return 1;
                }
                break '__c11;
            }
    ...
    unsafe { *z_str_1.offset(i as isize) = x };
    unsafe { *z_str_1.offset((i + 1) as isize) = '\u{0}' as i32 as i8 };
    return 0;
}
extern "C" fn tclvar_set_omit(interp: *mut Tcl_Interp) -> i32 {
    let mut rc: i32 = 0;
    let mut res: i32 = 0;
    let mut p_res: *mut Tcl_Obj = core::ptr::null_mut();
    rc =
        unsafe {
            Tcl_Eval(interp,
                c"expr {[info exists ::tclvar_set_omit] && $::tclvar_set_omit}".as_ptr()
                        as *mut i8 as *const i8)
        };
    if rc == 0 {
        p_res = unsafe { Tcl_GetObjResult(interp) };
        rc =
            unsafe {
                Tcl_GetBooleanFromObj(core::ptr::null_mut(), p_res, &mut res)
            };
    }
    return (rc == 0 && res != 0) as i32;
}
extern "C" fn tclvar_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    let p_tab: *const tclvar_vtab =
        tab as *mut tclvar_vtab as *const tclvar_vtab;
    let mut ii: i32 = 0;
    let z_str: *mut i8 = unsafe { sqlite3_malloc(32) } as *mut i8;
    let mut i_str: i32 = 0;
    if z_str == core::ptr::null_mut() { return 7; }
    unsafe { *z_str.offset(0 as isize) = '\u{0}' as i32 as i8 };
    {
        ii = 0;
        '__b12: loop {
            ...
            '__c12: loop {
                let p_cons: *const sqlite3_index_constraint =
                    unsafe {
                            &raw mut *unsafe {
                                        (*p_idx_info_1).a_constraint.offset(ii as isize)
                                    }
                ...
                if unsafe { (*p_cons).usable } != 0 {
                    if unsafe { (*p_cons).op } as i32 == 2 &&
                            unsafe { (*p_cons).i_column } as i32 == 0 {
                        if 0 == tclvar_add_to_idxstr(z_str, 'e' as i32 as i8) {
                            unsafe {
                                (*p_usage).argv_index =
                                    { let __p = &mut i_str; *__p += 1; *__p }
                            };
                            unsafe { (*p_usage).omit = 0 as u8 };
                        }
                    }
                    if unsafe { (*p_cons).op } as i32 == 64 &&
                            unsafe { (*p_cons).i_column } as i32 == 0 {
                        if 0 == tclvar_add_to_idxstr(z_str, 'm' as i32 as i8) {
                            unsafe {
                                (*p_usage).argv_index =
                                    { let __p = &mut i_str; *__p += 1; *__p }
                            };
                    ...
                    if unsafe { (*p_cons).op } as i32 == 66 &&
                            unsafe { (*p_cons).i_column } as i32 == 2 {
                        if 0 == tclvar_add_to_idxstr(z_str, 'g' as i32 as i8) {
                            unsafe {
                                (*p_usage).argv_index =
                                    { let __p = &mut i_str; *__p += 1; *__p }
                            };
                            unsafe {
                                (*p_usage).omit =
                                    tclvar_set_omit(unsafe { (*p_tab).interp }) as u8
                            };
                        }
                    }
                    if unsafe { (*p_cons).op } as i32 == 67 &&
                            unsafe { (*p_cons).i_column } as i32 == 2 {
                        if 0 == tclvar_add_to_idxstr(z_str, 'r' as i32 as i8) {
                            unsafe {
                                (*p_usage).argv_index =
                                    { let __p = &mut i_str; *__p += 1; *__p }
                            };
                    ...
                    if unsafe { (*p_cons).op } as i32 == 65 &&
                            unsafe { (*p_cons).i_column } as i32 == 2 {
                        if 0 == tclvar_add_to_idxstr(z_str, 'l' as i32 as i8) {
                            unsafe {
                                (*p_usage).argv_index =
                                    { let __p = &mut i_str; *__p += 1; *__p }
                            };
    ...
    unsafe { (*p_idx_info_1).idx_str = z_str };
    unsafe { (*p_idx_info_1).need_to_free_idx_str = 1 };
    return 0;
}
extern "C" fn tclvar_update(tab: *mut sqlite3_vtab, argc: i32,
    argv: *mut *mut sqlite3_value, p_rowid_1: *mut sqlite_int64) -> i32 {
    let p_tab: *const tclvar_vtab =
        tab as *mut tclvar_vtab as *const tclvar_vtab;
    if argc == 1 {
        let z_var: *const i8 =
            unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) }
                as *const i8;
        unsafe { Tcl_UnsetVar(unsafe { (*p_tab).interp }, z_var, 1) };
        return 0;
    }
    if unsafe { sqlite3_value_type(unsafe { *argv.offset(0 as isize) }) } == 5
        ...
        if unsafe { sqlite3_value_type(unsafe { *argv.offset(5 as isize) }) }
                != 3 {
            unsafe {
                (*tab).z_err_msg =
                    unsafe {
                        sqlite3_mprintf(c"the \'fullname\' column must be TEXT".as_ptr()
                                    as *mut i8 as *const i8)
                    }
            };
            return 1;
        ...
        if !(z_value).is_null() {
            unsafe {
                Tcl_SetVar(unsafe { (*p_tab).interp }, z_name, z_value, 1)
            };
        } else {
            unsafe { Tcl_UnsetVar(unsafe { (*p_tab).interp }, z_name, 1) };
        }
        return 0;
    }
    if unsafe { sqlite3_value_type(unsafe { *argv.offset(0 as isize) }) } == 3
            &&
        ...
        let z_old_name: *const i8 =
            unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) }
                as *const i8;
        let z_new_name: *const i8 =
            unsafe { sqlite3_value_text(unsafe { *argv.offset(1 as isize) }) }
                as *const i8;
        let z_value_1: *const i8 =
            unsafe { sqlite3_value_text(unsafe { *argv.offset(4 as isize) }) }
                as *const i8;
        if unsafe { strcmp(z_old_name, z_new_name) } != 0 ||
                z_value_1 == core::ptr::null() {
            unsafe {
                Tcl_UnsetVar(unsafe { (*p_tab).interp }, z_old_name, 1)
            };
        }
        if z_value_1 != core::ptr::null() {
            unsafe {
                Tcl_SetVar(unsafe { (*p_tab).interp }, z_new_name, z_value_1,
                    1)
            };
        }
        return 0;
    ...
    unsafe {
        (*tab).z_err_msg =
            unsafe {
                sqlite3_mprintf(c"prohibited TCL variable change".as_ptr() as
                            *mut i8 as *const i8)
            }
    };
    return 1;
}
static mut tclvar_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: Some(tclvar_connect),
        x_connect: Some(tclvar_connect),
        x_best_index: Some(tclvar_best_index),
        x_disconnect: Some(tclvar_disconnect),
        x_destroy: Some(tclvar_disconnect),
        x_open: Some(tclvar_open),
        x_close: Some(tclvar_close),
        x_filter: Some(tclvar_filter),
        x_next: Some(tclvar_next),
        x_eof: Some(tclvar_eof),
        x_column: Some(tclvar_column),
        x_rowid: Some(tclvar_rowid),
        x_update: Some(tclvar_update),
        x_begin: None,
        x_sync: None,
        x_commit: None,
        x_rollback: None,
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_create_module(db,
                c"tclvar".as_ptr() as *mut i8 as *const i8,
                &raw mut tclvar_module as *const sqlite3_module,
                interp as *mut ())
        };
        rc =
            unsafe {
                Tcl_Eval(interp,
                    c"proc like {pattern str} {\n  set p [string map {% * _ ?} $pattern]\n  string match $p $str\n}\nproc tclvar_filter_cmd {eq match glob regexp like} {\n  set res {}\n  set pattern $eq\n  if {$pattern=={}} { set pattern $match }\n  if {$pattern=={}} { set pattern * }\n  foreach v [uplevel #0 info vars $pattern] {\n    if {($glob=={} || [string match $glob [uplevel #0 set $v]])\n     && ($like=={} || [like $like [uplevel #0 set $v]])\n     && ($regexp=={} || [regexp $regexp [uplevel #0 set $v]])\n    } {\n      lappend res $v\n    }\n  }\n  set res\n}\n".as_ptr()
                            as *mut i8 as *const i8)
            };
        return rc;
    }
...
static z_schema: [i8; 100] =
    [67 as i8, 82 as i8, 69 as i8, 65 as i8, 84 as i8, 69 as i8, 32 as i8,
            ...
            120 as i8, 40 as i8, 32 as i8, 32 as i8, 110 as i8, 97 as i8,
            109 as i8, 101 as i8, 32 as i8, 84 as i8, 69 as i8, 88 as i8,
            84 as i8, 44 as i8, 32 as i8, 32 as i8, 97 as i8, 114 as i8,
            114 as i8, 97 as i8, 121 as i8, 110 as i8, 97 as i8, 109 as i8,
            101 as i8, 32 as i8, 84 as i8, 69 as i8, 88 as i8, 84 as i8,
            44 as i8, 32 as i8, 32 as i8, 118 as i8, 97 as i8, 108 as i8,
            117 as i8, 101 as i8, 32 as i8, 84 as i8, 69 as i8, 88 as i8,
            84 as i8, 44 as i8, 32 as i8, 32 as i8, 102 as i8, 117 as i8,
            108 as i8, 108 as i8, 110 as i8, 97 as i8, 109 as i8, 101 as i8,
            32 as i8, 84 as i8, 69 as i8, 88 as i8, 84 as i8, 32 as i8,
            80 as i8, 82 as i8, 73 as i8, 77 as i8, 65 as i8, 82 as i8,
            89 as i8, 32 as i8, 75 as i8, 69 as i8, 89 as i8, 41 as i8,
...
extern "C" {
    ...
    boolPtr: *mut i32)
    -> i32;
    fn Tcl_UnsetVar(interp: *mut Tcl_Interp, varName: *const i8, flags: i32)
    -> i32;
    fn Tcl_SetVar(interp: *mut Tcl_Interp, varName: *const i8,
    newValue: *const i8, flags: i32)
    -> *const i8;
    fn strcmp(__s1: *const i8, __s2: *const i8)
    -> i32;
    fn get_db_pointer(interp: *mut Tcl_Interp, z_a_1: *const i8,
