...
extern "C" fn func_db_filename(context: *mut sqlite3_context, argc: i32,
    ...
    let z_file: *const i8 = unsafe { sqlite3_db_filename(db, z_schema) };
    unsafe {
        sqlite3_result_text(context, z_file, -1,
            Some(unsafe {
...
extern "C" fn func_uri_parameter(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
    ...
    let z_name: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(1 as isize) }) } as
            *const i8;
    let z_file: *const i8 = unsafe { sqlite3_db_filename(db, z_schema) };
    let z_res: *const i8 = unsafe { sqlite3_uri_parameter(z_file, z_name) };
    unsafe {
        sqlite3_result_text(context, z_res, -1,
            Some(unsafe {
                    core::mem::transmute::<*const (),
                            unsafe extern "C" fn(*mut ())
                                -> ()>(-1 as isize as *const ())
...
extern "C" fn func_uri_boolean(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
...
extern "C" fn func_uri_key(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
    ...
    let z_file: *const i8 = unsafe { sqlite3_db_filename(db, z_schema) };
    let z_res: *const i8 = unsafe { sqlite3_uri_key(z_file, n) };
    unsafe {
        sqlite3_result_text(context, z_res, -1,
            Some(unsafe {
                    core::mem::transmute::<*const (),
...
extern "C" fn func_uri_int64(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
    ...
    let z_name: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(1 as isize) }) } as
            *const i8;
    let z_file: *const i8 = unsafe { sqlite3_db_filename(db, z_schema) };
    let i_dflt: sqlite3_int64 =
        unsafe { sqlite3_value_int64(unsafe { *argv.offset(2 as isize) }) };
    let i_res: sqlite3_int64 =
        unsafe { sqlite3_uri_int64(z_file, z_name, i_dflt) };
    unsafe { sqlite3_result_int64(context, i_res) };
}
extern "C" fn func_filename_database(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
    ...
    let z_res: *const i8 =
        if !(z_file).is_null() {
            unsafe { sqlite3_filename_database(z_file) }
        } else { core::ptr::null() };
    unsafe {
        sqlite3_result_text(context, z_res, -1,
            Some(unsafe {
...
extern "C" fn func_filename_journal(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
    ...
    let z_res: *const i8 =
        if !(z_file).is_null() {
            unsafe { sqlite3_filename_journal(z_file) }
        } else { core::ptr::null() };
    unsafe {
        sqlite3_result_text(context, z_res, -1,
            Some(unsafe {
...
extern "C" fn func_filename_wal(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_schema: *const i8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) } as
            *const i8;
    ...
    let z_res: *const i8 =
        if !(z_file).is_null() {
            unsafe { sqlite3_filename_wal(z_file) }
        } else { core::ptr::null() };
    unsafe {
        sqlite3_result_text(context, z_res, -1,
            Some(unsafe {
    ...
    unsafe {
        ...
        { let _ = pz_err_msg_1; };
        {
            ...
            '__b0: loop {
                if !(rc == 0 &&
                                (i as u64) <
                                    core::mem::size_of::<[sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0; 8]>()
                                            as u64 / 24) {
                    break '__b0;
                }
                '__c0: loop {
                    rc =
                        unsafe {
                            sqlite3_create_function(db, a_func[i as usize].z_func_name,
                                a_func[i as usize].n_arg, 1, core::ptr::null_mut(),
...
#[repr(C)]
#[derive(Copy, Clone)]
struct sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
    z_func_name: *const i8,
    n_arg: i32,
    x_func: Option<unsafe extern "C" fn(*mut sqlite3_context, i32,
        *mut *mut sqlite3_value) -> ()>,
}
static mut a_func: [sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0; 8] =
    [sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_db_filename".as_ptr() as *const i8,
                n_arg: 1,
                x_func: Some(func_db_filename),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_uri_parameter".as_ptr() as *const i8,
                n_arg: 2,
                x_func: Some(func_uri_parameter),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_uri_boolean".as_ptr() as *const i8,
                n_arg: 3,
                x_func: Some(func_uri_boolean),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_uri_int64".as_ptr() as *const i8,
                n_arg: 3,
                x_func: Some(func_uri_int64),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_uri_key".as_ptr() as *const i8,
                n_arg: 2,
                x_func: Some(func_uri_key),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_filename_database".as_ptr() as
                    *const i8,
                n_arg: 1,
                x_func: Some(func_filename_database),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_filename_journal".as_ptr() as
                    *const i8,
                n_arg: 1,
                x_func: Some(func_filename_journal),
            },
            sqlite3_urifuncs_init_s0_N24sqlite3_urifuncs_init_s0 {
                z_func_name: c"sqlite3_filename_wal".as_ptr() as *const i8,
                n_arg: 1,
