...
extern "C" fn open_stat_table(p_parse_1: *mut Parse, i_db_1: i32,
    ...
    unsafe {
        unsafe {
            ...
            let mut a_root: [u32; 3] = [0; 3];
            let mut a_create_tbl: [u8; 3] = [0; 3];
            let n_to_open: i32 = 1 as i32;
            if v == core::ptr::null_mut() { return; }
            { let _ = 0; };
            { let _ = 0; };
            p_db = unsafe { unsafe { (*db).a_db.offset(i_db_1 as isize) } };
            {
                i = 0;
                '__b0: loop {
                    if !(i <
                                    (core::mem::size_of::<[open_stat_table_s0_N18open_stat_table_s0; 3]>()
                                                as u64 / 16) as i32) {
                        break '__b0;
                    }
                    '__c0: loop {
                        let z_tab: *const i8 = a_table[i as usize].z_name;
                        let mut p_stat: *const Table = core::ptr::null();
                        a_create_tbl[i as usize] = 0 as u8;
                        if {
                                    p_stat =
                                        unsafe {
                                            sqlite3_find_table(db, z_tab,
                            ...
                            if i < n_to_open {
                                unsafe {
                                    sqlite3_nested_parse(p_parse_1,
                                        ...
                                        unsafe { (*p_db).z_db_s_name }, z_tab,
                                        a_table[i as usize].z_cols)
                                };
                                { let _ = 0; };
                                a_root[i as usize] =
                                    unsafe { (*p_parse_1).u1.cr.reg_root } as u32;
                            ...
                            if !(z_where_1).is_null() {
                                unsafe {
                                    sqlite3_nested_parse(p_parse_1,
                                        c"DELETE FROM %Q.%s WHERE %s=%Q".as_ptr() as *mut i8 as
                                            *const i8, unsafe { (*p_db).z_db_s_name }, z_tab,
            ...
            }
            {
                i = 0;
                '__b1: loop {
                    if !(i < n_to_open) { break '__b1; }
                    '__c1: loop {
                        { let _ = 0; };
                        unsafe {
                            sqlite3_vdbe_add_op4_int(v, 116, i_stat_cur_1 + i,
                                a_root[i as usize] as i32, i_db_1, 3)
                        };
                        unsafe {
                            sqlite3_vdbe_change_p5(v, a_create_tbl[i as usize] as u16)
                        };
                        break '__c1;
                    }
                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
...
extern "C" fn stat_init(context: *mut sqlite3_context, argc: i32,
    ...
    unsafe {
        ...
        unsafe { (*p).n_row = 0 as tRowcnt };
        unsafe {
            (*p).n_limit =
                unsafe {
                    sqlite3_value_int(unsafe { *argv.offset(3 as isize) })
                }
        };
        unsafe { (*p).n_col = n_col };
        unsafe { (*p).n_key_col = n_key_col };
        unsafe { (*p).n_skip_ahead = 0 as u8 };
        unsafe {
            (*p).current.an_d_lt =
...
extern "C" fn stat_push(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let mut i: i32 = 0;
        let p: *mut StatAccum =
        ...
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p).n_row } == 0 as u64
            {} else {
            {
                i = i_chng;
                '__b2: loop {
                    if !(i < unsafe { (*p).n_col }) { break '__b2; }
                    '__c2: loop {
                        {
                            let __p =
                                unsafe {
                                    &mut *unsafe { (*p).current.an_d_lt.offset(i as isize) }
                                };
                            let __t = *__p;
                            *__p += 1;
                            __t
        ...
        if unsafe { (*p).n_limit } != 0 &&
                unsafe { (*p).n_row } >
                    unsafe { (*p).n_limit } as tRowcnt *
                        (unsafe { (*p).n_skip_ahead } as i32 + 1) as tRowcnt {
            {
                let __p = unsafe { &mut (*p).n_skip_ahead };
                let __t = *__p;
                *__p += 1;
                __t
            };
            unsafe {
                sqlite3_result_int(context,
                    (unsafe {
                                *unsafe { (*p).current.an_d_lt.offset(0 as isize) }
                            } > 0 as u64) as i32)
            };
        }
    }
...
extern "C" fn stat_get(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let p: *const StatAccum =
            unsafe { sqlite3_value_blob(unsafe { *argv.offset(0 as isize) }) }
                    as *mut StatAccum as *const StatAccum;
        { let _ = 0; };
        {
            let mut s_stat: sqlite3_str = unsafe { core::mem::zeroed() };
            let mut i: i32 = 0;
            unsafe {
                sqlite3_str_accum_init(&raw mut s_stat as *mut StrAccum,
                    core::ptr::null_mut(), core::ptr::null_mut(), 0,
                    (unsafe { (*p).n_key_col } + 1) * 100)
            };
            unsafe {
                sqlite3_str_appendf(&mut s_stat,
                    c"%llu".as_ptr() as *mut i8 as *const i8,
                    if unsafe { (*p).n_skip_ahead } != 0 {
                        (unsafe { (*p).n_est }) as u64
                    } else { (unsafe { (*p).n_row }) as u64 })
            };
            {
                i = 0;
                '__b3: loop {
                    if !(i < unsafe { (*p).n_key_col }) { break '__b3; }
                    '__c3: loop {
                        let n_distinct: u64 =
                            unsafe {
                                    *unsafe { (*p).current.an_d_lt.offset(i as isize) }
                                } + 1 as tRowcnt;
                        let mut i_val: u64 =
                            (unsafe { (*p).n_row } + n_distinct - 1 as u64) /
                                n_distinct;
                        if i_val == 2 as u64 &&
                                unsafe { (*p).n_row } * 10 as tRowcnt <=
                                    n_distinct * 11 as u64 {
                            i_val = 1 as u64;
                        }
                        unsafe {
                            sqlite3_str_appendf(&mut s_stat,
                                c" %llu".as_ptr() as *mut i8 as *const i8, i_val)
                        };
                        break '__c3;
                    }
                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
...
extern "C" fn call_stat_get(p_parse_1: *mut Parse, reg_stat_1: i32,
    ...
    unsafe {
        ...
        { let _ = 0; };
        unsafe {
            sqlite3_vdbe_add_function_call(p_parse_1, 0, reg_stat_1,
                reg_out_1, 1 + 0, &stat_get_funcdef, 0)
        };
    }
}
extern "C" fn analyze_one_table(p_parse_1: *mut Parse, p_tab_1: *mut Table,
    ...
    unsafe {
        unsafe {
            ...
            if v == core::ptr::null_mut() || p_tab_1 == core::ptr::null_mut()
                {
                return;
            }
            ...
            if unsafe {
                        sqlite3_strlike(c"sqlite\\_%".as_ptr() as *mut i8 as
            ...
            { let _ = 0; };
            if unsafe {
                        sqlite3_auth_check(p_parse_1, 28,
            ...
            i_tab_cur =
                { let __p = &mut i_tab_1; let __t = *__p; *__p += 1; __t };
            i_idx_cur =
                { let __p = &mut i_tab_1; let __t = *__p; *__p += 1; __t };
            unsafe {
                (*p_parse_1).n_tab =
                    if unsafe { (*p_parse_1).n_tab } > i_tab_1 {
                        unsafe { (*p_parse_1).n_tab }
                    } else { i_tab_1 }
            };
            unsafe {
                sqlite3_open_table(p_parse_1, i_tab_cur, i_db, p_tab_1, 114)
            };
            unsafe {
                sqlite3_vdbe_load_string(v, reg_tabname,
                    unsafe { (*p_tab_1).z_name } as *const i8)
            };
            {
                ...
                '__b4: loop {
                    ...
                    '__c4: loop {
                        ...
                        if unsafe { (*p_idx).p_part_idx_where } ==
                                core::ptr::null_mut() {
                            need_table_cnt = 0 as u8;
                        }
                        if !(unsafe { (*p_tab_1).tab_flags } & 128 as u32 ==
                                                0 as u32) as i32 != 0 &&
                                unsafe { (*p_idx).idx_type() } as i32 == 2 {
                            n_col = unsafe { (*p_idx).n_key_col } as i32;
                            z_idx_name = unsafe { (*p_tab_1).z_name } as *const i8;
                            n_col_test = n_col - 1;
                        } else {
                            n_col = unsafe { (*p_idx).n_column } as i32;
                            z_idx_name = unsafe { (*p_idx).z_name } as *const i8;
                            n_col_test =
                        ...
                        unsafe {
                            sqlite3_vdbe_add_op2(v, 73,
                                unsafe { (*p_idx).n_key_col } as i32, reg_rowid)
                        };
                        unsafe {
                            sqlite3_vdbe_add_op3(v, 100, i_idx_cur, reg_temp,
                                (unsafe { (*db).db_opt_flags } & 2048 as u32 != 0 as u32) as
                                    i32)
                        };
                        unsafe {
                            sqlite3_vdbe_add_function_call(p_parse_1, 0, reg_stat + 1,
                                reg_stat, 4, &stat_init_funcdef, 0)
                        };
                        addr_goto_end =
                            unsafe { sqlite3_vdbe_add_op1(v, 36, i_idx_cur) };
                        unsafe { sqlite3_vdbe_add_op2(v, 73, 0, reg_chng) };
                        ...
                        if n_col_test > 0 {
                            ...
                            }
                            {
                                i = 0;
                                '__b5: loop {
                                    if !(i < n_col_test) { break '__b5; }
                                    '__c5: loop {
                                        let p_coll: *const i8 =
                                            unsafe {
                                                        sqlite3_locate_coll_seq(p_parse_1,
                                                            unsafe { *unsafe { (*p_idx).az_coll.offset(i as isize) } })
                                                    } as *mut i8 as *const i8;
                                        unsafe { sqlite3_vdbe_add_op2(v, 73, i, reg_chng) };
                                        unsafe {
                                            sqlite3_vdbe_add_op3(v, 96, i_idx_cur, i, reg_temp)
                                        };
                                        unsafe {
                                            *a_goto_chng.offset(i as isize) =
                                                unsafe {
                                                    sqlite3_vdbe_add_op4(v, 53, reg_temp, 0, reg_prev + i,
                                                        p_coll as *const i8, -2)
                                                }
                                        };
                            ...
                            unsafe { sqlite3_vdbe_jump_here(v, addr_next_row - 1) };
                            {
                                i = 0;
                                '__b6: loop {
                                    if !(i < n_col_test) { break '__b6; }
                                    '__c6: loop {
                                        unsafe {
                                            sqlite3_vdbe_jump_here(v,
                                                unsafe { *a_goto_chng.offset(i as isize) })
                                        };
                                        unsafe {
                        ...
                        {
                            unsafe {
                                sqlite3_vdbe_add_function_call(p_parse_1, 1, reg_stat,
                                    reg_temp, 2 + 0, &stat_push_funcdef, 0)
                            };
                            if unsafe { (*db).n_analysis_limit } != 0 {
                                let mut j1: i32 = 0;
                                let mut j2: i32 = 0;
                                let mut j3: i32 = 0;
                                j1 = unsafe { sqlite3_vdbe_add_op1(v, 51, reg_temp) };
                                j2 = unsafe { sqlite3_vdbe_add_op1(v, 16, reg_temp) };
                                j3 =
                                    unsafe {
                                        sqlite3_vdbe_add_op4_int(v, 24, i_idx_cur, 0, reg_prev, 1)
                                    };
                                unsafe { sqlite3_vdbe_jump_here(v, j1) };
                                unsafe {
                                    sqlite3_vdbe_add_op2(v, 40, i_idx_cur, addr_next_row)
                                };
                                unsafe { sqlite3_vdbe_jump_here(v, j2) };
                                unsafe { sqlite3_vdbe_jump_here(v, j3) };
                            } else {
                                unsafe {
                                    sqlite3_vdbe_add_op2(v, 40, i_idx_cur, addr_next_row)
                                };
                        ...
                        call_stat_get(p_parse_1, reg_stat, 0, reg_stat1);
                        { let _ = 0; };
                        unsafe {
                            sqlite3_vdbe_add_op4(v, 99, reg_tabname, 3, reg_temp,
                                c"BBB".as_ptr() as *mut i8 as *const i8, 0)
                        };
                        unsafe {
                            sqlite3_vdbe_add_op2(v, 129, i_stat_cur_1, reg_new_rowid)
                        };
                        unsafe {
                            sqlite3_vdbe_add_op3(v, 130, i_stat_cur_1, reg_temp,
                                reg_new_rowid)
                        };
            ...
            if p_only_idx_1 == core::ptr::null_mut() && need_table_cnt != 0 {
                unsafe { sqlite3_vdbe_add_op2(v, 100, i_tab_cur, reg_stat1) };
                j_zero_rows =
                    unsafe { sqlite3_vdbe_add_op1(v, 17, reg_stat1) };
                unsafe { sqlite3_vdbe_add_op2(v, 77, 0, reg_idxname) };
                { let _ = 0; };
                unsafe {
                    sqlite3_vdbe_add_op4(v, 99, reg_tabname, 3, reg_temp,
                        c"BBB".as_ptr() as *mut i8 as *const i8, 0)
                ...
                unsafe { sqlite3_vdbe_change_p5(v, 8 as u16) };
                unsafe { sqlite3_vdbe_jump_here(v, j_zero_rows) };
            }
        }
    }
}
...
extern "C" fn analyze_database(p_parse_1: *mut Parse, i_db_1: i32) -> () {
    unsafe {
        ...
        let mut i_mem: i32 = 0;
        let mut i_tab: i32 = 0;
        unsafe { sqlite3_begin_write_operation(p_parse_1, 0, i_db_1) };
        i_stat_cur = unsafe { (*p_parse_1).n_tab };
        unsafe { (*p_parse_1).n_tab += 3 };
        open_stat_table(p_parse_1, i_db_1, i_stat_cur, core::ptr::null(),
            core::ptr::null());
        i_mem = unsafe { (*p_parse_1).n_mem } + 1;
        i_tab = unsafe { (*p_parse_1).n_tab };
        { let _ = 0; };
        {
            k = unsafe { (*unsafe { &mut (*p_schema).tbl_hash }).first };
            '__b7: loop {
                if !(!(k).is_null()) { break '__b7; }
                '__c7: loop {
                    let p_tab: *mut Table = unsafe { (*k).data } as *mut Table;
                    analyze_one_table(p_parse_1, p_tab, core::ptr::null_mut(),
                        i_stat_cur, i_mem, i_tab);
                    { let _ = 0; };
                    break '__c7;
                }
                k = unsafe { (*k).next };
...
extern "C" fn analyze_table(p_parse_1: *mut Parse, p_tab_1: *mut Table,
    ...
    unsafe {
        ...
        unsafe { sqlite3_begin_write_operation(p_parse_1, 0, i_db) };
        i_stat_cur = unsafe { (*p_parse_1).n_tab };
        unsafe { (*p_parse_1).n_tab += 3 };
        if !(p_only_idx_1).is_null() {
            open_stat_table(p_parse_1, i_db, i_stat_cur,
                unsafe { (*p_only_idx_1).z_name } as *const i8,
        ...
        analyze_one_table(p_parse_1, p_tab_1, p_only_idx_1, i_stat_cur,
            unsafe { (*p_parse_1).n_mem } + 1, unsafe { (*p_parse_1).n_tab });
    ...
    unsafe {
        ...
        if p_name1 == core::ptr::null_mut() {
            ...
            if i_db >= 0 {
                ...
                z =
                    unsafe {
                        sqlite3_name_from_token(db, p_table_name as *const Token)
                    };
                if !(z).is_null() {
                    if {
                                p_idx =
                                    unsafe {
                                        sqlite3_find_index(db, z as *const i8, z_db as *const i8)
                                    };
                                p_idx
                            } != core::ptr::null_mut() {
                        analyze_table(p_parse, unsafe { (*p_idx).p_table }, p_idx);
                    } else if {
                                p_tab =
                                    unsafe {
                                        sqlite3_locate_table(p_parse, 0 as u32, z as *const i8,
                                            z_db as *const i8)
                                    };
                                p_tab
                            } != core::ptr::null_mut() {
                        analyze_table(p_parse, p_tab, core::ptr::null_mut());
                    }
                    unsafe { sqlite3_db_free(db, z as *mut ()) };
                }
            }
        }
        if unsafe { (*db).n_sql_exec } as i32 == 0 &&
...
extern "C" fn decode_int_array(z_int_array_1: *mut i8, n_out_1: i32,
    ...
    -> () {
    let mut z: *const i8 = z_int_array_1 as *const i8;
    let mut c: i32 = 0;
    let mut i: i32 = 0;
    let mut v: tRowcnt = 0 as tRowcnt;
    { let _ = 0; };
    {
        i = 0;
        '__b9: loop {
            if !(unsafe { *z } != 0 && i < n_out_1) { break '__b9; }
            '__c9: loop {
                v = 0 as tRowcnt;
                while { c = unsafe { *z.offset(0 as isize) } as i32; c } >=
                            '0' as i32 && c <= '9' as i32 {
                    v =
                        v * 10 as tRowcnt + c as tRowcnt - '0' as i32 as tRowcnt;
                    {
                        let __p = &mut z;
                        let __t = *__p;
                ...
                { let _ = 0; };
                unsafe {
                    *a_log_1.offset(i as isize) = unsafe { sqlite3_log_est(v) }
                };
    ...
    { let _ = 0; };
    {
        (*p_index_1).set_b_unordered(0 as u32 as u32);
        (*p_index_1).set_no_skip_scan(0 as u32 as u32);
        while unsafe { *z.offset(0 as isize) } != 0 {
            if unsafe {
                        sqlite3_strglob(c"unordered*".as_ptr() as *mut i8 as
                                *const i8, z as *const i8)
                    } == 0 {
                (*p_index_1).set_b_unordered(1 as u32 as u32);
            } else if unsafe {
                        sqlite3_strglob(c"sz=[0-9]*".as_ptr() as *mut i8 as
                                *const i8, z as *const i8)
                    } == 0 {
                let mut sz: i32 =
                    unsafe {
                        sqlite3_atoi(unsafe { z.offset(3 as isize) } as *const i8)
                    };
                if sz < 2 { sz = 2; }
                (*p_index_1).sz_idx_row =
                    unsafe { sqlite3_log_est(sz as u64) };
            } else if unsafe {
                        sqlite3_strglob(c"noskipscan*".as_ptr() as *mut i8 as
                                *const i8, z as *const i8)
                    } == 0 {
                (*p_index_1).set_no_skip_scan(1 as u32 as u32);
            }
            while unsafe { *z.offset(0 as isize) } as i32 != 0 &&
...
extern "C" fn analysis_loader(p_data_1: *mut (), argc: i32,
    ...
    unsafe {
        let p_info: *const analysisInfo =
            p_data_1 as *mut analysisInfo as *const analysisInfo;
        let mut p_index: *mut Index = core::ptr::null_mut();
        let mut p_table: *mut Table = core::ptr::null_mut();
        let mut z: *const i8 = core::ptr::null();
        { let _ = 0; };
        { { let _ = not_used_1; }; { let _ = argc; } };
        if argv == core::ptr::null_mut() ||
                    unsafe { *argv.offset(0 as isize) } == core::ptr::null_mut()
                ||
                unsafe { *argv.offset(2 as isize) } == core::ptr::null_mut() {
            return 0;
        }
        p_table =
            unsafe {
                sqlite3_find_table(unsafe { (*p_info).db },
                    unsafe { *argv.offset(0 as isize) } as *const i8,
                    unsafe { (*p_info).z_database })
            };
        if p_table == core::ptr::null_mut() { return 0; }
        if unsafe { *argv.offset(1 as isize) } == core::ptr::null_mut() {
            p_index = core::ptr::null_mut();
        } else if unsafe {
                    sqlite3_stricmp(unsafe { *argv.offset(0 as isize) } as
                            *const i8, unsafe { *argv.offset(1 as isize) } as *const i8)
                } == 0 {
            p_index = unsafe { sqlite3_primary_key_index(p_table) };
        } else {
            p_index =
                unsafe {
                    sqlite3_find_index(unsafe { (*p_info).db },
                        unsafe { *argv.offset(1 as isize) } as *const i8,
                        unsafe { (*p_info).z_database })
                };
        }
        z = unsafe { *argv.offset(2 as isize) } as *const i8;
        if !(p_index).is_null() {
            let ai_row_est: *mut tRowcnt = core::ptr::null_mut();
            let n_col: i32 = unsafe { (*p_index).n_key_col } as i32 + 1;
            unsafe { (*p_index).set_b_unordered(0 as u32 as u32) };
            decode_int_array(z as *mut i8, n_col,
                ai_row_est as *const tRowcnt,
                unsafe { (*p_index).ai_row_log_est },
                unsafe { &mut *p_index });
            unsafe { (*p_index).set_has_stat1(1 as u32 as u32) };
            if unsafe { (*p_index).p_part_idx_where } == core::ptr::null_mut()
                {
                unsafe {
                    (*p_table).n_row_log_est =
                        unsafe {
                            *unsafe { (*p_index).ai_row_log_est.offset(0 as isize) }
                        }
                };
                unsafe { (*p_table).tab_flags |= 16 as u32 };
            }
        } else {
            let mut fake_idx: Index = unsafe { core::mem::zeroed() };
            fake_idx.sz_idx_row = unsafe { (*p_table).sz_tab_row };
            decode_int_array(z as *mut i8, 1, core::ptr::null(),
                unsafe { &mut (*p_table).n_row_log_est }, &mut fake_idx);
            unsafe { (*p_table).sz_tab_row = fake_idx.sz_idx_row };
            unsafe { (*p_table).tab_flags |= 16 as u32 };
        }
        return 0;
    }
...
pub extern "C" fn sqlite3_analysis_load(db: *mut sqlite3, i_db: i32) -> i32 {
    unsafe {
        ...
        { let _ = 0; };
        {
            ...
            '__b14: loop {
                if !(!(i).is_null()) { break '__b14; }
                '__c14: loop {
                    let p_tab: *mut Table = unsafe { (*i).data } as *mut Table;
                    unsafe { (*p_tab).tab_flags &= !16 as u32 };
                    break '__c14;
                }
                i = unsafe { (*i).next };
            }
        }
        {
            ...
            '__b15: loop {
                if !(!(i).is_null()) { break '__b15; }
                '__c15: loop {
                    let p_idx: *mut Index = unsafe { (*i).data } as *mut Index;
                    unsafe { (*p_idx).set_has_stat1(0 as u32 as u32) };
                    break '__c15;
                }
                i = unsafe { (*i).next };
            }
        ...
        if !({
                                p_stat1 =
                                    unsafe {
                                            sqlite3_find_table(db,
                                                c"sqlite_stat1".as_ptr() as *mut i8 as *const i8,
                                                s_info.z_database)
                                        } as *const Table;
                                p_stat1
                            }).is_null() && unsafe { (*p_stat1).e_tab_type } as i32 == 0
            {
            z_sql =
                unsafe {
                    sqlite3_m_printf(db,
                        c"SELECT tbl,idx,stat FROM %Q.sqlite_stat1".as_ptr() as
                                *mut i8 as *const i8, s_info.z_database)
                };
            if z_sql == core::ptr::null_mut() {
                ...
                rc =
                    unsafe {
                        sqlite3_exec(db, z_sql as *const i8, Some(analysis_loader),
                            &raw mut s_info as *mut (), core::ptr::null_mut())
                    };
        ...
        { let _ = 0; };
        {
            i = unsafe { (*unsafe { &mut (*p_schema).idx_hash }).first };
            '__b16: loop {
                if !(!(i).is_null()) { break '__b16; }
                '__c16: loop {
                    let p_idx_1: *mut Index =
                        unsafe { (*i).data } as *mut Index;
                    if (unsafe { (*p_idx_1).has_stat1() } == 0) as i32 != 0 {
                        unsafe { sqlite3_default_row_est(p_idx_1) };
                    }
                    break '__c16;
                }
                i = unsafe { (*i).next };
...
#[repr(C)]
#[derive(Copy, Clone)]
struct open_stat_table_s0_N18open_stat_table_s0 {
    z_name: *const i8,
    z_cols: *const i8,
}
static mut a_table: [open_stat_table_s0_N18open_stat_table_s0; 3] =
    [open_stat_table_s0_N18open_stat_table_s0 {
                z_name: c"sqlite_stat1".as_ptr() as *const i8,
                z_cols: c"tbl,idx,stat".as_ptr() as *const i8,
            },
            open_stat_table_s0_N18open_stat_table_s0 {
                z_name: c"sqlite_stat4".as_ptr() as *const i8,
