...
pub extern "C" fn log_est_from_integer(mut x: Sqlite3Uint64) -> LogEst {
    unsafe {
        ...
        if x < 8 as u64 {
            ...
            while x < 8 as u64 {
                y -= 10 as LogEst;
                x <<= 1 as Sqlite3Uint64;
            }
        } else {
            while x > 255 as u64 {
                y += 40 as LogEst;
                x >>= 4 as Sqlite3Uint64;
            }
            while x > 15 as u64 {
                y += 10 as LogEst;
                x >>= 1 as Sqlite3Uint64;
        ...
        return (a_1[(x & 7 as Sqlite3Uint64) as usize] as i32 + y as i32 - 10)
                as LogEst;
    }
}
...
extern "C" fn log_est_to_int(mut x: LogEst) -> Sqlite3Uint64 {
    ...
    n = (x as i32 % 10) as Sqlite3Uint64;
    x /= 10 as LogEst;
    if n >= 5 as u64 {
        n -= 2 as Sqlite3Uint64;
    } else if n >= 1 as u64 { n -= 1 as Sqlite3Uint64; }
    if x as i32 > 60 {
        return ((4294967295u32 as Sqlite3Uint64) << 32) +
                4294967295u32 as Sqlite3Uint64;
    }
...
extern "C" fn log_est_from_double(mut x: f64) -> LogEst {
    ...
    if !(core::mem::size_of::<f64>() as u64 == 8 as u64 &&
                            core::mem::size_of::<Sqlite3Uint64>() as u64 == 8 as u64) as
                    i32 as i64 != 0 {
        unsafe {
    ...
    if x < 1024.0 {
        return (log_est_from_integer((1024.0 * x) as Sqlite3Uint64) as i32 -
                    100) as LogEst;
    }
    if x <= 2000000000.0 { return log_est_from_integer(x as Sqlite3Uint64); }
    unsafe {
        ...
        '__b5: loop {
            ...
            '__c5: loop {
                ...
                if unsafe { strcmp(z, c"+".as_ptr() as *mut i8 as *const i8) }
                    ...
                    if n > 0 {
                        a[(n - 1) as usize] =
                            (log_est_from_integer(a[(n - 1) as usize] as Sqlite3Uint64)
                                        as i32 - 33) as LogEst;
                    }
                } else if unsafe {
                    ...
                    a[{ let __p = &mut n; let __t = *__p; *__p += 1; __t } as
                                usize] =
                        log_est_from_integer(unsafe { atoll(z) } as Sqlite3Uint64);
                ...
                if (a[i as usize] as i32) < -40 {
                    ...
                    let x: Sqlite3Uint64 =
                        log_est_to_int((a[i as usize] as i32 + 100) as LogEst) *
                                100 as Sqlite3Uint64 / 1024 as Sqlite3Uint64;
                    unsafe {
                        printf(c"%5d (%lld.%02lld)\n".as_ptr() as *mut i8 as
                                *const i8, a[i as usize] as i32, x / 100 as Sqlite3Uint64,
                            x % 100 as Sqlite3Uint64)
                    };
                }
                break '__c6;
            }
