            ...
            '__s3:
                ...
                match __state {
                    ...
                    90 => {
                        if unsafe {
                                    (*(unsafe { (*p_e_list).a.as_ptr() } as
                                                        *mut ExprListItem).offset(j as isize)).fg.b_using_term()
                                } != 0 {
                            __state = 91;
                        } else { __state = 66; }
                    }
        ...
        {
            {
                i = 0;
                p_item =
                    unsafe { (*p_order_by_1).a.as_ptr() } as *mut ExprListItem
            };
            '__b13: loop {
        ...
        }
        {
            ...
            '__b21: loop {
                ...
                '__c21: loop {
                    if unsafe {
                                    (*(unsafe { (*p_order_by).a.as_ptr() } as
                                                        *mut ExprListItem).offset(i as isize)).fg.done()
                                } as i32 == 0 {
                        unsafe {
                            sqlite3_error_msg(p_parse_1,
    ...
    unsafe {
        ...
        while !(p).is_null() {
            ...
            if !(p_group_by).is_null() {
                let mut p_item_2: *const ExprListItem = core::ptr::null();
