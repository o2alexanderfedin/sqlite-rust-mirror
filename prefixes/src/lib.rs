...
extern "C" fn prefixes_connect(db: *mut Sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut p_new: *mut PrefixesVtab = core::ptr::null_mut();
    let mut rc: i32 = 0;
    rc =
        unsafe {
    ...
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<PrefixesVtab>() as
                            Sqlite3Uint64)
                } as *mut PrefixesVtab;
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<PrefixesVtab>() as u64)
        };
...
extern "C" fn prefixes_open(p: *mut Sqlite3Vtab,
    ...
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<PrefixesCursor>() as
                        Sqlite3Uint64)
            } as *mut PrefixesCursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<PrefixesCursor>() as u64)
    };
...
extern "C" fn prefixes_filter(p_vtab_cursor_1: *mut Sqlite3VtabCursor,
    ...
    let p_cur: *mut PrefixesCursor = p_vtab_cursor_1 as *mut PrefixesCursor;
    unsafe { sqlite3_free(unsafe { (*p_cur).z_str } as *mut ()) };
    if argc > 0 {
        unsafe {
            (*p_cur).z_str =
...
extern "C" fn prefixes_best_index(tab: *mut Sqlite3Vtab,
    ...
    unsafe { (*p_idx_info_1).estimated_rows = 1000000000 as Sqlite3Int64 };
    return 0;
}
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut prefixes_module as *const Sqlite3Module,
                    core::ptr::null_mut())
            };
        if rc == 0 {
            rc =
