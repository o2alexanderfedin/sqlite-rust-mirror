...
pub extern "C" fn sqlite3_src_list_lookup(p_parse: *mut Parse,
    ...
    let p_item: *mut SrcItem = (*p_src).a.as_ptr() as *mut SrcItem;
    let mut p_tab: *mut Table = core::ptr::null_mut();
    { let _ = 0; };
    p_tab = unsafe { sqlite3_locate_table_item(p_parse, 0 as u32, p_item) };
    if !(unsafe { (*p_item).p_s_tab }).is_null() {
        unsafe {
            sqlite3_delete_table(unsafe { (*p_parse).db },
                unsafe { (*p_item).p_s_tab })
        };
    }
    ...
    if !(p_tab).is_null() {
        ...
        if unsafe { (*p_item).fg.is_indexed_by() } != 0 &&
                unsafe { sqlite3_indexed_by_lookup(p_parse, p_item) } != 0 {
...
extern "C" fn vtab_is_read_only(p_parse_1: *mut Parse, p_tab_1: *mut Table)
    ...
    unsafe {
        ...
        if (unsafe { (*p_parse_1).p_toplevel } != core::ptr::null_mut() ||
                    unsafe { (*p_parse_1).prep_flags } as i32 & 32 != 0) &&
                unsafe { (*unsafe { (*p_tab_1).u.vtab.p }).e_vtab_risk } as
                        i32 >
                    (unsafe { (*unsafe { (*p_parse_1).db }).flags } & 128 as u64
                            != 0 as u64) as i32 {
            unsafe {
                sqlite3_error_msg(p_parse_1,
                    c"unsafe use of virtual table \"%s\"".as_ptr() as *mut i8 as
                        *const i8, unsafe { (*p_tab_1).z_name })
            };
        }
        return 0;
    }
...
extern "C" fn tab_is_read_only(p_parse_1: *mut Parse, p_tab_1: *mut Table)
    -> i32 {
    let mut db: *mut Sqlite3 = core::ptr::null_mut();
    if unsafe { (*p_tab_1).e_tab_type } as i32 == 1 {
        return vtab_is_read_only(p_parse_1, p_tab_1);
    }
    if unsafe { (*p_tab_1).tab_flags } & (1 | 4096) as u32 == 0 as u32 {
        return 0;
    }
    db = unsafe { (*p_parse_1).db };
    if unsafe { (*p_tab_1).tab_flags } & 1 as u32 != 0 as u32 {
        return (unsafe { sqlite3_writable_schema(db) } == 0 &&
                    unsafe { (*p_parse_1).nested } as i32 == 0) as i32;
    }
    { let _ = 0; };
    ...
    if tab_is_read_only(p_parse, p_tab) != 0 {
        unsafe {
            sqlite3_error_msg(p_parse,
                c"table %s may not be modified".as_ptr() as *mut i8 as
    ...
    if unsafe { (*p_tab).e_tab_type } as i32 == 2 &&
            (p_trigger == core::ptr::null_mut() ||
                unsafe { (*p_trigger).b_returning } != 0 &&
                    unsafe { (*p_trigger).p_next } == core::ptr::null_mut()) {
        unsafe {
            sqlite3_error_msg(p_parse,
                c"cannot modify %s because it is a view".as_ptr() as *mut i8
                    as *const i8, unsafe { (*p_tab).z_name })
        };
        return 1;
    }
    return 0;
...
pub extern "C" fn sqlite3_code_change_count(v: *mut Vdbe, reg_counter: i32,
    ...
    unsafe { sqlite3_vdbe_add_op2(v, 86, reg_counter, 1) };
...
pub extern "C" fn sqlite3_materialize_view(p_parse: *mut Parse,
    ...
    unsafe {
        ...
        let i_db: i32 =
            unsafe { sqlite3_schema_to_index(db, (*p_view).p_schema) };
        p_where = unsafe { sqlite3_expr_dup(db, p_where as *const Expr, 0) };
        p_from =
            unsafe {
        ...
        if !(p_from).is_null() {
            ...
            unsafe {
                (*(unsafe { (*p_from).a.as_ptr() } as
                    ...
                    unsafe {
                        sqlite3_db_str_dup(db, (*p_view).z_name as *const i8)
                    }
            };
            { let _ = 0; };
            unsafe {
        ...
        p_sel =
            unsafe {
                sqlite3_select_new(p_parse, core::ptr::null_mut(), p_from,
                    p_where, core::ptr::null_mut(), core::ptr::null_mut(),
                    p_order_by, 131072 as u32, p_limit)
            };
        unsafe { sqlite3_select_dest_init(&mut dest, 10, i_cur) };
        unsafe { sqlite3_select(p_parse, p_sel, &mut dest) };
...
pub extern "C" fn sqlite3_generate_index_key(p_parse: *mut Parse,
        ...
        if !(unsafe { (*p_idx).p_part_idx_where }).is_null() {
            ...
            unsafe {
                sqlite3_expr_if_false_dup(p_parse,
                    ...
                    unsafe { *pi_part_idx_label }, 16)
            };
            unsafe { (*p_parse).i_self_tab = 0 };
            p_prior = core::ptr::null_mut();
        } else { unsafe { *pi_part_idx_label = 0 }; }
    }
    n_col =
        if prefix_only != 0 && unsafe { (*p_idx).uniq_not_null() } != 0 {
            (unsafe { (*p_idx).n_key_col }) as i32
        } else { (unsafe { (*p_idx).n_column }) as i32 };
    reg_base = unsafe { sqlite3_get_temp_range(p_parse, n_col) };
    if !(p_prior).is_null() &&
            (reg_base != reg_prior ||
                !(unsafe { (*p_prior).p_part_idx_where }).is_null()) {
        p_prior = core::ptr::null_mut();
    }
    {
        j = 0;
        '__b0: loop {
            if !(j < n_col) { break '__b0; }
            '__c0: loop {
                if !(p_prior).is_null() &&
                            unsafe {
                                        *unsafe { (*p_prior).ai_column.offset(j as isize) }
                                    } as i32 ==
                                unsafe { *unsafe { (*p_idx).ai_column.offset(j as isize) } }
                                    as i32 &&
                        unsafe {
                                    *unsafe { (*p_prior).ai_column.offset(j as isize) }
                                } as i32 != -2 {
                ...
                unsafe {
                    sqlite3_expr_code_load_index_column(p_parse, p_idx,
                        i_data_cur, j, reg_base + j)
                };
                if unsafe {
    ...
    if reg_out != 0 {
        unsafe { sqlite3_vdbe_add_op3(v, 99, reg_base, n_col, reg_out) };
    }
    unsafe { sqlite3_release_temp_range(p_parse, reg_base, n_col) };
    return reg_base;
}
...
pub extern "C" fn sqlite3_resolve_part_idx_label(p_parse: &Parse,
    i_label: i32) -> () {
    if i_label != 0 {
        unsafe { sqlite3_vdbe_resolve_label((*p_parse).p_vdbe, i_label) };
    }
}
        ...
        '__b1: loop {
            ...
            '__c1: loop {
                ...
                if a_reg_idx != core::ptr::null_mut() &&
                        unsafe { *a_reg_idx.offset(i as isize) } == 0 {
                    break '__c1;
                }
                if p_idx == p_pk { break '__c1; }
                if i_idx_cur + i == i_idx_no_seek { break '__c1; }
                r1 =
                    sqlite3_generate_index_key(p_parse, p_idx, i_data_cur, 0, 1,
                        &mut i_part_idx_label, p_prior, r1);
                if unsafe { (*p_idx).b_has_expr() } != 0 &&
                        !(a_reg_idx).is_null() {
                    p3 = unsafe { *a_reg_idx.offset(i as isize) };
                }
                unsafe {
                    sqlite3_vdbe_add_op3(v, 142, i_idx_cur + i, r1, p3)
                };
                unsafe {
                    sqlite3_vdbe_change_p4(v, -1, p_idx as *const i8, -6)
                };
                unsafe {
                    sqlite3_vdbe_change_p5(v,
                        if unsafe { (*p_idx).uniq_not_null() } != 0 {
                                (unsafe { (*p_idx).n_key_col }) as i32
                            } else { (unsafe { (*p_idx).n_column }) as i32 } as u16)
                };
                sqlite3_resolve_part_idx_label(unsafe { &*p_parse },
                    i_part_idx_label);
                p_prior = p_idx;
                break '__c1;
            }
...
pub extern "C" fn sqlite3_generate_row_delete(p_parse: *mut Parse,
    ...
    if e_mode as i32 == 0 {
        unsafe {
            sqlite3_vdbe_add_op4_int(v, op_seek as i32, i_data_cur, i_label,
                i_pk, n_pk as i32)
        };
    }
    if unsafe {
        ...
        unsafe { sqlite3_vdbe_add_op2(v, 82, i_pk, i_old) };
        {
            ...
            '__b2: loop {
                ...
                '__c2: loop {
                    if mask == 4294967295u32 ||
                            i_col <= 31 && mask & (1 as u32) << i_col != 0 as u32 {
                        let kk: i32 =
                            unsafe {
        ...
        if addr_start < unsafe { sqlite3_vdbe_current_addr(v) } {
            unsafe {
                sqlite3_vdbe_add_op4_int(v, op_seek as i32, i_data_cur,
                    i_label, i_pk, n_pk as i32)
            };
            i_idx_no_seek = -1;
        }
        unsafe {
    ...
    if !(unsafe { (*p_tab).e_tab_type } as i32 == 2) as i32 != 0 {
        ...
        sqlite3_generate_row_index_delete(p_parse, p_tab, i_data_cur,
            i_idx_cur, core::ptr::null_mut(), i_idx_no_seek);
        unsafe {
            sqlite3_vdbe_add_op2(v, 132, i_data_cur,
                if count != 0 { 1 } else { 0 })
        };
        if unsafe { (*p_parse).nested } as i32 == 0 ||
            ...
            unsafe {
                sqlite3_vdbe_append_p4(v, p_tab as *mut i8 as *mut (), -5)
            };
        }
        if e_mode as i32 != 0 {
            unsafe { sqlite3_vdbe_change_p5(v, 4 as u16) };
        }
        if i_idx_no_seek >= 0 && i_idx_no_seek != i_data_cur {
            unsafe { sqlite3_vdbe_add_op1(v, 132, i_idx_no_seek) };
        }
    ...
    if !(p_trigger).is_null() {
        unsafe {
            sqlite3_code_row_trigger(p_parse, p_trigger, 129,
                core::ptr::null_mut(), 2, p_tab, i_old, onconf as i32,
                i_label)
        };
    }
        ...
        loop {
            ...
            '__s4:
                ...
                match __state {
                    ...
                    6 => { __state = 7; }
                    7 => { __state = 8; }
                    8 => { i_data_cur = 0; __state = 9; }
                    9 => { i_idx_cur = 0; __state = 10; }
                    10 => { __state = 11; }
                    11 => { __state = 12; }
                    12 => { __state = 13; }
                    13 => { __state = 14; }
                    14 => { __state = 15; }
                    15 => { mem_cnt = 0; __state = 16; }
                    16 => { __state = 17; }
                    17 => { __state = 18; }
                    18 => { __state = 19; }
                    19 => { a_to_open = core::ptr::null_mut(); __state = 20; }
                    20 => { __state = 21; }
                    21 => { i_pk = 0; __state = 22; }
                    22 => { n_pk = 1 as i16; __state = 23; }
                    23 => { __state = 24; }
                    24 => { __state = 25; }
                    25 => { i_eph_cur = 0; __state = 26; }
                    26 => { i_row_set = 0; __state = 27; }
                    27 => { addr_bypass = 0; __state = 28; }
                    28 => { addr_loop = 0; __state = 29; }
                    29 => { addr_eph_open = 0; __state = 30; }
                    30 => { __state = 31; }
                    31 => { __state = 32; }
                    32 => { __state = 33; }
                    33 => {
                    ...
                    34 => { db = unsafe { (*p_parse).db }; __state = 35; }
                    ...
                    37 => { { let _ = 0; }; __state = 39; }
                    38 => { __state = 2; }
                    39 => { { let _ = 0; }; __state = 40; }
                    40 => {
                        p_tab =
                            sqlite3_src_list_lookup(p_parse,
                                unsafe { &mut *p_tab_list });
                        __state = 41;
                    }
                    41 => {
                    ...
                    47 => {
                        if sqlite3_is_read_only(p_parse, p_tab, p_trigger) != 0 {
                            __state = 50;
                        } else { __state = 49; }
                    }
                    48 => { __state = 2; }
                    ...
                    54 => {
                        if rcauth == 1 { __state = 56; } else { __state = 55; }
                    }
                    ...
                    60 => {
                        if is_view != 0 { __state = 65; } else { __state = 64; }
                    }
                    61 => {
                        if !(p_idx).is_null() {
                            __state = 62;
                    ...
                    71 => {
                        if is_view != 0 { __state = 73; } else { __state = 72; }
                    }
                    72 => {
                        unsafe {
                    ...
                    73 => {
                        sqlite3_materialize_view(p_parse, unsafe { &*p_tab },
                            p_where, p_order_by, p_limit, i_tab_cur);
                        __state = 74;
                    }
                    74 => {
                        i_data_cur = { i_idx_cur = i_tab_cur; i_idx_cur };
                        __state = 75;
                    }
                    75 => { p_order_by = core::ptr::null_mut(); __state = 76; }
                    76 => { p_limit = core::ptr::null_mut(); __state = 72; }
                    77 => { s_nc.p_parse = p_parse; __state = 78; }
                    78 => { s_nc.p_src_list = p_tab_list; __state = 79; }
                    79 => {
                        if unsafe { sqlite3_resolve_expr_names(&mut s_nc, p_where) }
                                != 0 {
                            __state = 81;
                        } else { __state = 80; }
                    }
                    ...
                    81 => { __state = 2; }
                    82 => {
                        if rcauth == 0 && p_where == core::ptr::null_mut() &&
                                    (b_complex == 0) as i32 != 0 &&
                    ...
                    84 => {
                        unsafe { sqlite3_vdbe_add_op2(v, 73, 0, mem_cnt) };
                        __state = 82;
                    }
                    85 => {
                        if unsafe { (*p_parse).nested } as i32 == 0 &&
                    ...
                    86 => { { let _ = 0; }; __state = 88; }
                    87 => { wcf = (4 | 16) as u16; __state = 98; }
                    88 => {
                        unsafe {
                            sqlite3_table_lock(p_parse, i_db, unsafe { (*p_tab).tnum },
                                1 as u8, unsafe { (*p_tab).z_name } as *const i8)
                        };
                        __state = 89;
                    }
                    89 => {
                    ...
                    90 => { p_idx = unsafe { (*p_tab).p_index }; __state = 92; }
                    91 => {
                        unsafe {
                            sqlite3_vdbe_add_op4(v, 147,
                                unsafe { (*p_tab).tnum } as i32, i_db,
                                if mem_cnt != 0 { mem_cnt } else { -1 },
                                unsafe { (*p_tab).z_name } as *const i8, -1)
                        };
                        __state = 90;
                    }
                    92 => {
                    ...
                    93 => { { let _ = 0; }; __state = 95; }
                    94 => { p_idx = unsafe { (*p_idx).p_next }; __state = 92; }
                    95 => {
                    ...
                    97 => {
                        unsafe {
                            sqlite3_vdbe_add_op2(v, 147,
                                unsafe { (*p_idx).tnum } as i32, i_db)
                        };
                        __state = 94;
                    }
                    98 => {
                        if s_nc.nc_flags & 64 != 0 {
                            __state = 100;
                        } else { __state = 99; }
                    }
                    99 => {
                        wcf |= if b_complex != 0 { 0 } else { 8 } as u16;
                        __state = 101;
                    }
                    100 => { b_complex = 1; __state = 99; }
                    101 => {
                        if unsafe { (*p_tab).tab_flags } & 128 as u32 == 0 as u32 {
                            __state = 103;
                        } else { __state = 104; }
                        ...
                        p_w_info =
                            unsafe {
                                sqlite3_where_begin(p_parse, p_tab_list, p_where,
                                    core::ptr::null_mut(), core::ptr::null_mut(),
                                    core::ptr::null_mut(), wcf, i_tab_cur + 1)
                            };
                        __state = 115;
                    }
                    103 => { p_pk = core::ptr::null_mut(); __state = 105; }
                    104 => {
                    ...
                    107 => {
                        unsafe { sqlite3_vdbe_add_op2(v, 77, 0, i_row_set) };
                        __state = 102;
                    }
                    108 => { { let _ = 0; }; __state = 109; }
                    109 => {
                        n_pk = unsafe { (*p_pk).n_key_col } as i16;
                        __state = 110;
                    }
                    110 => {
                    ...
                    113 => {
                        addr_eph_open =
                            unsafe {
                                sqlite3_vdbe_add_op2(v, 120, i_eph_cur, n_pk as i32)
                            };
                        __state = 114;
                    }
                    114 => {
                    ...
                    121 => {
                        if unsafe { sqlite3_where_uses_deferred_seek(p_w_info) } !=
                                0 {
                            __state = 124;
                        } else { __state = 123; }
                    }
                    ...
                    123 => {
                        if mem_cnt != 0 { __state = 126; } else { __state = 125; }
                    }
                    124 => {
                        unsafe { sqlite3_vdbe_add_op1(v, 145, i_tab_cur) };
                        __state = 123;
                    }
                    125 => {
                        if !(p_pk).is_null() {
                    ...
                    126 => {
                        unsafe { sqlite3_vdbe_add_op2(v, 88, mem_cnt, 1) };
                        __state = 125;
                    }
                    127 => {
                        if e_one_pass != 0 {
                    ...
                    134 => {
                        unsafe {
                            sqlite3_expr_code_get_column_of_table(v, p_tab, i_tab_cur,
                    ...
                    139 => {
                        a_to_open =
                            unsafe { sqlite3_db_malloc_raw_nn(db, (n_idx + 2) as u64) }
                                as *mut u8;
                        __state = 140;
                    }
                    140 => {
                    ...
                    147 => {
                        unsafe {
                            *a_to_open.offset((ai_cur_one_pass[0 as usize] - i_tab_cur)
                                            as isize) = 0 as u8
                        };
                        __state = 146;
                    }
                    ...
                    149 => {
                        unsafe {
                            *a_to_open.offset((ai_cur_one_pass[1 as usize] - i_tab_cur)
                                            as isize) = 0 as u8
                        };
                        __state = 148;
                    }
                    150 => {
                        addr_bypass = unsafe { sqlite3_vdbe_make_label(p_parse) };
                        __state = 136;
                    }
                    151 => {
                        unsafe { sqlite3_vdbe_change_to_noop(v, addr_eph_open) };
                        __state = 150;
                    }
                    152 => {
                        unsafe { sqlite3_where_end(p_w_info) };
                    ...
                    154 => { n_key = 1 as i16; __state = 158; }
                    155 => { n_key = 0 as i16; __state = 156; }
                    156 => {
                        unsafe {
                            sqlite3_vdbe_add_op4(v, 99, i_pk, n_pk as i32, i_key,
                                unsafe {
                                    sqlite3_index_affinity_str(unsafe { (*p_parse).db }, p_pk)
                                }, n_pk as i32)
                        };
                        __state = 157;
                    }
                    157 => {
                        unsafe {
                            sqlite3_vdbe_add_op4_int(v, 140, i_eph_cur, i_key, i_pk,
                                n_pk as i32)
                        };
                        __state = 152;
                    }
                    158 => {
                        unsafe { sqlite3_vdbe_add_op2(v, 158, i_row_set, i_key) };
                        __state = 152;
                    }
                    159 => {
                        if e_one_pass != 0 {
                    ...
                    162 => { __state = 165; }
                    163 => {
                        i_addr_once = unsafe { sqlite3_vdbe_add_op0(v, 15) };
                        __state = 164;
                    }
                    164 => { __state = 162; }
                    165 => {
                        unsafe {
                            sqlite3_open_table_and_indices(p_parse, p_tab, 116, 8 as u8,
                                i_tab_cur, a_to_open, &mut i_data_cur, &mut i_idx_cur)
                        };
                        __state = 166;
                    }
                    ...
                    173 => {
                        if !(unsafe { (*p_tab).e_tab_type } as i32 == 1) as i32 != 0
                                &&
                                unsafe {
                                        *a_to_open.offset((i_data_cur - i_tab_cur) as isize)
                                    } != 0 {
                            __state = 174;
                        } else { __state = 170; }
                    }
                    ...
                    175 => {
                        unsafe {
                            sqlite3_vdbe_add_op4_int(v, 28, i_data_cur, addr_bypass,
                                i_key, n_key as i32)
                        };
                        __state = 176;
                    }
                    ...
                    177 => {
                        addr_loop =
                            unsafe { sqlite3_vdbe_add_op1(v, 36, i_eph_cur) };
                        __state = 179;
                    }
                    178 => {
                        addr_loop =
                            unsafe { sqlite3_vdbe_add_op3(v, 48, i_row_set, 0, i_key) };
                        __state = 184;
                    }
                    179 => { __state = 180; }
                    180 => {
                    ...
                    181 => { { let _ = 0; }; __state = 170; }
                    182 => {
                        unsafe { sqlite3_vdbe_add_op3(v, 96, i_eph_cur, 0, i_key) };
                        __state = 181;
                    }
                    183 => {
                        unsafe { sqlite3_vdbe_add_op2(v, 136, i_eph_cur, i_key) };
                        __state = 181;
                    }
                    184 => { __state = 185; }
                    185 => { { let _ = 0; }; __state = 170; }
                    186 => {
                        if e_one_pass != 0 {
                            __state = 199;
                        } else { __state = 200; }
                    ...
                    188 => {
                        count = (unsafe { (*p_parse).nested } as i32 == 0) as i32;
                        __state = 198;
                    }
                    189 => {
                    ...
                    193 => {
                        unsafe {
                            sqlite3_vdbe_add_op4(v, 7, 0, 1, i_key, p_v_tab, -12)
                        };
                        __state = 197;
                    }
                    194 => {
                        unsafe { sqlite3_vdbe_add_op1(v, 124, i_tab_cur) };
                        __state = 195;
                    }
                    195 => {
                    ...
                    196 => {
                        unsafe { (*p_parse).is_multi_write = 0 as u8 };
                        __state = 193;
                    }
                    197 => {
                    ...
                    198 => {
                        sqlite3_generate_row_delete(p_parse, p_tab, p_trigger,
                            i_data_cur, i_idx_cur, i_key, n_key, count as u8, 11 as u8,
                            e_one_pass as u8, ai_cur_one_pass[1 as usize]);
                        __state = 186;
                    }
                    199 => {
                        unsafe { sqlite3_vdbe_resolve_label(v, addr_bypass) };
                        __state = 201;
                    }
                    200 => {
                        if !(p_pk).is_null() {
                    ...
                    203 => {
                        unsafe { sqlite3_vdbe_goto(v, addr_loop) };
                        __state = 206;
                    }
                    204 => { __state = 205; }
                    205 => {
                        unsafe { sqlite3_vdbe_jump_here(v, addr_loop) };
                        __state = 85;
                    }
                    206 => {
                        unsafe { sqlite3_vdbe_jump_here(v, addr_loop) };
                    ...
                    207 => {
                        if mem_cnt != 0 { __state = 210; } else { __state = 209; }
                    }
                    208 => {
                    ...
                    209 => { __state = 2; }
                    210 => {
                        sqlite3_code_change_count(v, mem_cnt,
                            c"rows deleted".as_ptr() as *mut i8 as *const i8);
                        __state = 209;
                    }
                    211 => {
                    ...
                    213 => {
                        if !(a_to_open).is_null() {
                            __state = 215;
                        } else { __state = 214; }
                    }
                    214 => { return; }
                    215 => {
                        unsafe { sqlite3_db_nn_free_nn(db, a_to_open as *mut ()) };
                        __state = 214;
                    }
                    _ => {}
                }
