...
static stat_mutex: [i8; 10] =
    [0 as i8, 1 as i8, 1 as i8, 0 as i8, 0 as i8, 0 as i8, 0 as i8, 1 as i8,
            0 as i8, 0 as i8];
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_status64(op: i32, p_current: &mut sqlite3_int64,
    p_highwater: &mut sqlite3_int64, reset_flag: i32) -> i32 {
    unsafe {
        let mut p_mutex: *mut sqlite3_mutex = core::ptr::null_mut();
        if op < 0 ||
                op >=
                    (core::mem::size_of::<[i64; 10]>() as u64 /
                            core::mem::size_of::<sqlite3StatValueType>() as u64) as i32
            {
            return unsafe { sqlite3_misuse_error(143) };
        }
        p_mutex =
            if stat_mutex[op as usize] != 0 {
                unsafe { sqlite3_pcache1_mutex() }
            } else { unsafe { sqlite3_malloc_mutex() } };
        unsafe { sqlite3_mutex_enter(p_mutex) };
        *p_current = sqlite3_stat.now_value[op as usize];
        *p_highwater = sqlite3_stat.mx_value[op as usize];
        if reset_flag != 0 {
            sqlite3_stat.mx_value[op as usize] =
                sqlite3_stat.now_value[op as usize];
        }
...
pub extern "C" fn sqlite3_status(op: i32, p_current: &mut i32,
    ...
    let mut i_hwtr: sqlite3_int64 = 0 as sqlite3_int64;
    let mut rc: i32 = 0;
    rc = sqlite3_status64(op, &mut i_cur, &mut i_hwtr, reset_flag);
...
pub extern "C" fn sqlite3_lookaside_used(db: &sqlite3,
    ...
    let mut n_init: u32 =
        count_lookaside_slots((*db).lookaside.p_init as *const LookasideSlot);
    let mut n_free: u32 =
        count_lookaside_slots((*db).lookaside.p_free as *const LookasideSlot);
    n_init +=
        count_lookaside_slots((*db).lookaside.p_small_init as
                *const LookasideSlot);
    n_free +=
...
pub extern "C" fn sqlite3_db_status64(db: *mut sqlite3, mut op: i32,
    p_current_1: &mut sqlite3_int64, p_highwtr_1: &mut sqlite3_int64,
                    ...
                    0 => {
                        {
                            let mut h: i32 = 0;
                            *p_current_1 =
                                sqlite3_lookaside_used(unsafe { &*db }, &mut h) as
                                    sqlite3_int64;
                            *p_highwtr_1 = h as sqlite3_int64;
                            if reset_flag_1 != 0 {
                                let mut p: *mut LookasideSlot =
                                    unsafe { (*db).lookaside.p_free };
                                if !(p).is_null() {
                                    ...
                                    unsafe {
                                        (*db).lookaside.p_init = unsafe { (*db).lookaside.p_free }
                                    };
                                    unsafe { (*db).lookaside.p_free = core::ptr::null_mut() };
                                }
                                p = unsafe { (*db).lookaside.p_small_free };
                                if !(p).is_null() {
                                    while !(unsafe { (*p).p_next }).is_null() {
                                        p = unsafe { (*p).p_next };
                                    }
                                    ...
                                    unsafe {
                                        (*db).lookaside.p_small_init =
                                            unsafe { (*db).lookaside.p_small_free }
                                    };
                                    unsafe {
                                        (*db).lookaside.p_small_free = core::ptr::null_mut()
                                    };
                                }
                            }
                            break '__s1;
                        }
                        {
                            { let _ = 0; };
                            { let _ = 0; };
                            *p_current_1 = 0 as sqlite3_int64;
                            *p_highwtr_1 =
                                unsafe { (*db).lookaside.an_stat[(op - 4) as usize] } as
                                    sqlite3_int64;
                            if reset_flag_1 != 0 {
                                unsafe {
                                    (*db).lookaside.an_stat[(op - 4) as usize] = 0 as u32
                                };
                            }
                            break '__s1;
                        }
                        {
                            let mut total_used: sqlite3_int64 = 0 as sqlite3_int64;
                            let mut i: i32 = 0;
                            unsafe { sqlite3_btree_enter_all(db) };
                            {
                                i = 0;
                                '__b4: loop {
                                    if !(i < unsafe { (*db).n_db }) { break '__b4; }
                                    '__c4: loop {
                                        let p_bt: *mut Btree =
                                        ...
                                        if !(p_bt).is_null() {
                                            ...
                                            let mut n_byte: i32 =
                                                unsafe { sqlite3_pager_mem_used(p_pager) };
                                            if op == 11 {
                                                n_byte =
                                                    n_byte / unsafe { sqlite3_btree_connection_count(p_bt) };
                                            }
                                            total_used += n_byte as sqlite3_int64;
                                        }
                                        break '__c4;
                                    }
                            ...
                            *p_current_1 = total_used;
                            *p_highwtr_1 = 0 as sqlite3_int64;
                            break '__s1;
                        }
                        {
                            let mut i: i32 = 0;
                            ...
                            { let _ = 0; };
                            unsafe {
                                (*db).lookaside.p_end = unsafe { (*db).lookaside.p_start }
                            };
                            {
                                i = 0;
                                '__b5: loop {
                                    ...
                                    '__c5: loop {
                                        ...
                                        if p_schema != core::ptr::null_mut() {
                                            ...
                                            n_byte_1 +=
                                                (unsafe {
                                                                sqlite3Config.m.x_roundup.unwrap()(core::mem::size_of::<HashElem>()
                                                                        as i32)
                                                            } as u32 *
                                                        (unsafe { (*p_schema).tbl_hash.count } +
                                                                    unsafe { (*p_schema).trig_hash.count } +
                                                                unsafe { (*p_schema).idx_hash.count } +
                                                            unsafe { (*p_schema).fkey_hash.count })) as i32;
                                            n_byte_1 +=
                                                unsafe {
                                                        sqlite3_msize(unsafe { (*p_schema).tbl_hash.ht } as *mut ())
                                                    } as i32;
                                            n_byte_1 +=
                                                unsafe {
                                                        sqlite3_msize(unsafe { (*p_schema).trig_hash.ht } as
                                                                *mut ())
                                                    } as i32;
                                            n_byte_1 +=
                                                unsafe {
                                                        sqlite3_msize(unsafe { (*p_schema).idx_hash.ht } as *mut ())
                                                    } as i32;
                                            n_byte_1 +=
                                                unsafe {
                                                        sqlite3_msize(unsafe { (*p_schema).fkey_hash.ht } as
                                                                *mut ())
                                                    } as i32;
                                            {
                                                p =
                                                    unsafe { (*unsafe { &mut (*p_schema).trig_hash }).first };
                                                '__b6: loop {
                                                    if !(!(p).is_null()) { break '__b6; }
                                                    '__c6: loop {
                                                        unsafe {
                                                            sqlite3_delete_trigger(db,
                                                                unsafe { (*p).data } as *mut Trigger)
                                                        };
                                                        break '__c6;
                                                    }
                                                    p = unsafe { (*p).next };
                                            ...
                                            }
                                            {
                                                ...
                                                '__b7: loop {
                                                    ...
                                                    '__c7: loop {
                                                        unsafe {
                                                            sqlite3_delete_table(db, unsafe { (*p).data } as *mut Table)
                                                        };
                                                        break '__c7;
                                                    }
                                                    p = unsafe { (*p).next };
                            ...
                            unsafe {
                                (*db).lookaside.p_end =
                                    unsafe { (*db).lookaside.p_true_end }
                            };
                            unsafe { sqlite3_btree_leave_all(db) };
                            *p_highwtr_1 = 0 as sqlite3_int64;
                            *p_current_1 = n_byte_1 as sqlite3_int64;
                            break '__s1;
                        }
                        {
                            ...
                            {
                                p_vdbe = unsafe { (*db).p_vdbe };
                                '__b8: loop {
                                    if !(!(p_vdbe).is_null()) { break '__b8; }
                                    '__c8: loop {
                                        unsafe { sqlite3_vdbe_delete(p_vdbe) };
                                        break '__c8;
                                    }
                                    p_vdbe = unsafe { (*p_vdbe).p_v_next };
                                }
                            }
                            unsafe {
                                (*db).lookaside.p_end =
                            ...
                            unsafe { (*db).pn_bytes_freed = core::ptr::null_mut() };
                            *p_highwtr_1 = 0 as sqlite3_int64;
                            *p_current_1 = n_byte_2 as sqlite3_int64;
                            break '__s1;
                        }
                        op = 9 + 1;
                        {
                            let mut i: i32 = 0;
                            let mut n_ret: u64 = 0 as u64;
                            { let _ = 0; };
                            { let _ = 0; };
                            {
                                i = 0;
                                '__b9: loop {
                                    if !(i < unsafe { (*db).n_db }) { break '__b9; }
                                    '__c9: loop {
                                        if !(unsafe {
                                                            (*unsafe { (*db).a_db.offset(i as isize) }).p_bt
                                                        }).is_null() {
                                            let p_pager_1: *mut Pager =
                                                unsafe {
                                            ...
                                            unsafe {
                                                sqlite3_pager_cache_stat(p_pager_1, op, reset_flag_1,
                                                    &mut n_ret)
                                            };
                                        }
                                        break '__c9;
                            ...
                            *p_highwtr_1 = 0 as sqlite3_int64;
                            *p_current_1 = n_ret as sqlite3_int64;
                            break '__s1;
                        }
                        {
                            let mut n_ret_1: u64 = 0 as u64;
                            if !(unsafe {
                                                (*unsafe { (*db).a_db.offset(1 as isize) }).p_bt
                                            }).is_null() {
                                let p_pager_2: *mut Pager =
                                    unsafe {
                                        sqlite3_btree_pager(unsafe {
                                                (*unsafe { (*db).a_db.offset(1 as isize) }).p_bt
                                            })
                                ...
                                unsafe {
                                    sqlite3_pager_cache_stat(p_pager_2, 9, reset_flag_1,
                                        &mut n_ret_1)
                                };
                                n_ret_1 *=
                                    unsafe {
                                            sqlite3_btree_get_page_size(unsafe {
                                                    (*unsafe { (*db).a_db.offset(1 as isize) }).p_bt
                                                })
                                        } as u64;
                            }
                            n_ret_1 += unsafe { (*db).n_spill };
                            if reset_flag_1 != 0 {
                                unsafe { (*db).n_spill = 0 as u64 };
                            }
                            *p_highwtr_1 = 0 as sqlite3_int64;
                            *p_current_1 = n_ret_1 as sqlite3_int64;
                            break '__s1;
                        }
                        {
                            *p_highwtr_1 = 0 as sqlite3_int64;
...
pub extern "C" fn sqlite3_db_status(db: *mut sqlite3, op: i32,
    ...
    let mut rc: i32 = 0;
    rc = sqlite3_db_status64(db, op, &mut c, &mut h, reset_flag_1);
    if rc == 0 {
        *p_current_1 = (c & 2147483647 as sqlite3_int64) as i32;
        *p_highwtr_1 = (h & 2147483647 as sqlite3_int64) as i32;
    }
    return rc;
}
#[repr(C)]
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_status_value(op: i32) -> sqlite3_int64 {
    unsafe {
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
...
pub extern "C" fn sqlite3_status_up(op: i32, n: i32) -> () {
    unsafe {
        ...
        if sqlite3_stat.now_value[op as usize] >
                sqlite3_stat.mx_value[op as usize] {
            sqlite3_stat.mx_value[op as usize] =
                sqlite3_stat.now_value[op as usize];
        }
...
pub extern "C" fn sqlite3_status_highwater(op: i32, x: i32) -> () {
    unsafe {
        let mut new_value: sqlite3StatValueType = 0 as sqlite3StatValueType;
        { let _ = 0; };
        new_value = x as sqlite3StatValueType;
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        if new_value > sqlite3_stat.mx_value[op as usize] {
            sqlite3_stat.mx_value[op as usize] = new_value;
        }
    }
}
#[repr(C)]
