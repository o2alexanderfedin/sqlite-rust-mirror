...
extern "C" fn completion_connect(db: *mut sqlite3, p_aux_1: *mut (),
    ...
    let mut p_new: *mut completion_vtab = core::ptr::null_mut();
    let mut rc: i32 = 0;
    { let _ = p_aux_1; };
    { let _ = argc; };
    { let _ = argv; };
    ...
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<completion_vtab>() as
                            sqlite3_uint64)
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<completion_vtab>() as u64)
        };
        unsafe { (*p_new).db = db };
    }
    return rc;
}
extern "C" fn completion_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe { sqlite3_free(p_vtab_1 as *mut ()) };
    return 0;
}
extern "C" fn completion_open(p: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut completion_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<completion_cursor>() as
                        sqlite3_uint64)
            } as *mut completion_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<completion_cursor>() as u64)
    };
    unsafe { (*p_cur).db = unsafe { (*(p as *mut completion_vtab)).db } };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn completion_cursor_reset(p_cur_1: &mut completion_cursor) -> () {
...
extern "C" fn completion_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    completion_cursor_reset(unsafe { &mut *(cur as *mut completion_cursor) });
    unsafe { sqlite3_free(cur as *mut ()) };
    return 0;
}
extern "C" fn completion_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut completion_cursor = cur as *mut completion_cursor;
        ...
        '__s1:
            ...
            match unsafe { (*p_cur).e_phase } {
                1 => {
                    ...
                    {
                        if unsafe { (*p_cur).p_stmt } == core::ptr::null_mut() {
                            let mut p_s2_1: *mut sqlite3_stmt = core::ptr::null_mut();
...
extern "C" fn completion_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *const completion_cursor =
        cur as *mut completion_cursor as *const completion_cursor;
    '__s4:
        {
        match i {
            0 => {
...
extern "C" fn completion_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn completion_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const completion_cursor =
        cur as *mut completion_cursor as *const completion_cursor;
    return (unsafe { (*p_cur).e_phase } >= 11) as i32;
}
extern "C" fn completion_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_cur: *mut completion_cursor =
        p_vtab_cursor_1 as *mut completion_cursor;
    let mut i_arg: i32 = 0;
    { let _ = idx_str_1; };
    { let _ = argc; };
...
extern "C" fn completion_best_index(tab: *mut sqlite3_vtab,
    ...
    unsafe {
        (*p_idx_info_1).estimated_rows = (500 - 100 * n_arg) as sqlite3_int64
    };
    return 0;
}
static mut completion_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: None,
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut completion_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
        return rc;
    }
