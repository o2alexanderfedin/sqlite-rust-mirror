...
extern "C" fn noop_step_func(p: *mut sqlite3_context, n: i32,
    a: *mut *mut sqlite3_value) -> () {
    { let _ = p; };
    { let _ = n; };
    { let _ = a; };
    { let _ = 0; };
                        ...
                        if !(p_list_1).is_null() {
                            unsafe {
                                (*(unsafe { (*p_list_1).a.as_ptr() } as
                                                        *mut ExprList_item).offset((n_init + i) as
                                                        isize)).fg.sort_flags =
                                    unsafe {
                                        (*(unsafe { (*p_append_1).a.as_ptr() } as
...
pub extern "C" fn sqlite3_window_update(p_parse: *mut Parse,
    ...
    if unsafe { (*p_win).e_frm_type } as i32 == 90 &&
        ...
        if !(unsafe { (*p_win).p_filter }).is_null() {
            ...
            let a_up: [WindowUpdate_N12WindowUpdate; 8] =
                [WindowUpdate_N12WindowUpdate {
            ...
            let mut i: i32 = 0;
            {
                ...
                '__b24: loop {
                    if !(i <
                                    (core::mem::size_of::<[WindowUpdate_N12WindowUpdate; 8]>()
                                                as u64 /
                                            core::mem::size_of::<WindowUpdate_N12WindowUpdate>() as u64)
                                        as i32) {
                        break '__b24;
                    }
                    '__c24: loop {
...
extern "C" fn row_number_step_func(p_ctx_1: *mut sqlite3_context,
...
extern "C" fn row_number_value_func(p_ctx_1: *mut sqlite3_context) -> () {
    let p: *const i64 =
        unsafe {
                    sqlite3_aggregate_context(p_ctx_1,
                        core::mem::size_of::<i64>() as i32)
...
extern "C" fn dense_rank_step_func(p_ctx_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
...
extern "C" fn dense_rank_value_func(p_ctx_1: *mut sqlite3_context) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    p =
        unsafe {
                sqlite3_aggregate_context(p_ctx_1,
...
extern "C" fn rank_step_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
...
extern "C" fn rank_value_func(p_ctx_1: *mut sqlite3_context) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    p =
        unsafe {
                sqlite3_aggregate_context(p_ctx_1,
...
extern "C" fn percent_rank_step_func(p_ctx_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    { let _ = n_arg_1; };
    { let _ = 0; };
...
extern "C" fn percent_rank_value_func(p_ctx_1: *mut sqlite3_context) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    p =
        unsafe {
                sqlite3_aggregate_context(p_ctx_1,
...
extern "C" fn percent_rank_inv_func(p_ctx_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    { let _ = n_arg_1; };
    { let _ = 0; };
...
extern "C" fn cume_dist_step_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    { let _ = n_arg_1; };
    { let _ = 0; };
...
extern "C" fn cume_dist_value_func(p_ctx_1: *mut sqlite3_context) -> () {
...
extern "C" fn cume_dist_inv_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut CallCount = core::ptr::null_mut();
    { let _ = n_arg_1; };
    { let _ = 0; };
...
extern "C" fn ntile_step_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
...
extern "C" fn ntile_value_func(p_ctx_1: *mut sqlite3_context) -> () {
...
extern "C" fn ntile_inv_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut NtileCtx = core::ptr::null_mut();
    { let _ = 0; };
    { let _ = n_arg_1; };
...
extern "C" fn last_value_step_func(p_ctx_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
...
extern "C" fn last_value_finalize_func(p_ctx_1: *mut sqlite3_context) -> () {
    let mut p: *mut LastValueCtx = core::ptr::null_mut();
    p =
        unsafe {
                sqlite3_aggregate_context(p_ctx_1,
...
extern "C" fn last_value_value_func(p_ctx_1: *mut sqlite3_context) -> () {
...
extern "C" fn last_value_inv_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut LastValueCtx = core::ptr::null_mut();
    { let _ = n_arg_1; };
    { let _ = ap_arg_1; };
...
extern "C" fn nth_value_step_func(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
...
extern "C" fn nth_value_finalize_func(p_ctx_1: *mut sqlite3_context) -> () {
    let mut p: *mut NthValueCtx = core::ptr::null_mut();
...
extern "C" fn noop_value_func(p: *mut sqlite3_context) -> () {
    { let _ = p; };
}
extern "C" fn first_value_step_func(p_ctx_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
    let mut p: *mut NthValueCtx = core::ptr::null_mut();
    p =
        unsafe {
...
extern "C" fn first_value_finalize_func(p_ctx_1: *mut sqlite3_context) -> () {
    let mut p: *mut NthValueCtx = core::ptr::null_mut();
    p =
        unsafe {
                sqlite3_aggregate_context(p_ctx_1,
...
#[repr(C)]
#[derive(Copy, Clone)]
struct WindowUpdate_N12WindowUpdate {
    z_func: *const i8,
    e_frm_type: i32,
    e_start: i32,
    e_end: i32,
