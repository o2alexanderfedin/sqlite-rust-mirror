...
extern "C" fn c_collation_test(client_data_1: ClientData,
    ...
    let mut z_err_function: *const i8 =
        c"N/A".as_ptr() as *mut i8 as *const i8;
    '__b0: loop {
        '__c0: loop {
            ...
            rc =
                unsafe {
                    sqlite3_create_collation(db,
                        c"collate".as_ptr() as *mut i8 as *const i8, 456,
                        core::ptr::null_mut(), None)
                };
            if rc != 21 {
                unsafe { sqlite3_close(db) };
                z_err_function =
                    c"sqlite3_create_collation".as_ptr() as *mut i8 as
                        *const i8;
                break '__b0;
            }
            unsafe { sqlite3_close(db) };
    ...
    unsafe {
        Tcl_AppendResult(interp,
            c"Error testing function: ".as_ptr() as *mut i8, z_err_function,
            0 as *mut ())
    };
    return 1;
}
...
extern "C" fn c_misuse_test(client_data_1: ClientData,
    interp: *mut Tcl_Interp, objc: i32, objv: *const *mut Tcl_Obj) -> i32 {
    let mut z_err_function: *const i8 =
        c"N/A".as_ptr() as *mut i8 as *const i8;
    '__b2: loop {
        '__c2: loop {
            ...
            if rc != 21 {
                z_err_function =
                    c"sqlite3_errcode".as_ptr() as *mut i8 as *const i8;
                break '__b2;
            }
            p_stmt = 1234 as *mut sqlite3_stmt;
            rc =
                unsafe {
                    sqlite3_prepare(db, core::ptr::null(), 0, &mut p_stmt,
                        core::ptr::null_mut())
                };
            if rc != 21 {
                z_err_function =
                    c"sqlite3_prepare".as_ptr() as *mut i8 as *const i8;
                break '__b2;
            }
            { let _ = 0; };
            p_stmt = 1234 as *mut sqlite3_stmt;
            ...
            rc =
                unsafe {
                    sqlite3_prepare16(db, core::ptr::null(), 0, &mut p_stmt,
                        core::ptr::null_mut())
                };
            if rc != 21 {
                z_err_function =
                    c"sqlite3_prepare16".as_ptr() as *mut i8 as *const i8;
                break '__b2;
            }
            { let _ = 0; };
            p_stmt = 1234 as *mut sqlite3_stmt;
            rc =
                unsafe {
                    sqlite3_prepare16_v2(db, core::ptr::null(), 0, &mut p_stmt,
                        core::ptr::null_mut())
                };
            if rc != 21 {
                z_err_function =
                    c"sqlite3_prepare16_v2".as_ptr() as *mut i8 as *const i8;
                break '__b2;
            }
            { let _ = 0; };
            return 0;
