...
extern "C" fn binfo_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe { sqlite3_free(p_vtab_1 as *mut ()) };
    return 0;
}
extern "C" fn binfo_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    let mut i: i32 = 0;
    unsafe { (*p_idx_info_1).estimated_cost = 10000.0 };
    unsafe { (*p_idx_info_1).estimated_rows = 100 as sqlite3_int64 };
    {
        i = 0;
        '__b0: loop {
...
extern "C" fn binfo_open(p_v_tab_1: *mut sqlite3_vtab,
...
extern "C" fn binfo_close(p_cursor_1: *mut sqlite3_vtab_cursor) -> i32 {
...
extern "C" fn binfo_next(p_cursor_1: *mut sqlite3_vtab_cursor) -> i32 {
    let p_csr: *mut BinfoCursor = p_cursor_1 as *mut BinfoCursor;
    unsafe {
...
extern "C" fn binfo_eof(p_cursor_1: *mut sqlite3_vtab_cursor) -> i32 {
    let p_csr: *const BinfoCursor =
        p_cursor_1 as *mut BinfoCursor as *const BinfoCursor;
    return (unsafe { (*p_csr).rc } != 100) as i32;
}
extern "C" fn binfo_filter(p_cursor_1: *mut sqlite3_vtab_cursor,
...
extern "C" fn binfo_compute(db: *mut sqlite3, mut pgno: i32,
    ...
    let mut n_entry: sqlite3_int64 = 1 as sqlite3_int64;
    ...
    loop {
        ...
        n_cell =
            get_uint16(unsafe { a_data.offset(3 as isize) } as *const u8) as
                i32;
        n_entry *= (n_cell + 1) as sqlite3_int64;
...
extern "C" fn binfo_column(p_cursor_1: *mut sqlite3_vtab_cursor,
...
extern "C" fn binfo_rowid(p_cursor_1: *mut sqlite3_vtab_cursor,
    ...
    unsafe {
        return unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut binfo_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
    }
}
...
static mut binfo_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: None,
