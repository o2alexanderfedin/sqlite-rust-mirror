...
extern "C" fn read_file(z_filename_1: *const i8, sz: &mut i64) -> *mut i8 {
    ...
    *sz = { n_in = unsafe { ftell(in_) }; n_in };
    unsafe { rewind(in_) };
    p_buf =
        unsafe { sqlite3_malloc64((n_in + 1 as i64) as sqlite3_uint64) } as
            *mut u8;
    if !(p_buf).is_null() &&
            1 as u64 ==
...
extern "C" fn readtextfile_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn writefile_func(context: *mut sqlite3_context, argc: i32,
    ...
    let mut rc: sqlite3_int64 = 0 as sqlite3_int64;
...
extern "C" fn blob_list_load_from_db(db: *mut sqlite3, z_sql_1: *const i8,
    ...
    unsafe {
        ...
        let mut u_blob:
                blob_list_load_from_db_u0_N25blob_list_load_from_db_u0 =
...
struct FuzzCtx {
    db: *mut sqlite3,
    i_cutoff_time: sqlite3_int64,
    i_last_cb: sqlite3_int64,
    mx_interval: sqlite3_int64,
    n_cb: u32,
    mx_cb: u32,
    exec_cnt: u32,
    timeout_hit: i32,
...
static mut heap_limit: sqlite3_int64 = 100000000 as sqlite3_int64;
static mut vdbe_op_limit: i32 = 25000;
static mut max_db_size: sqlite3_int64 = 104857600 as sqlite3_int64;
...
extern "C" fn register_oom_simulator() -> () {
    unsafe {
        let mut mem: sqlite3_mem_methods = unsafe { core::mem::zeroed() };
        unsafe { sqlite3_shutdown() };
        unsafe {
            sqlite3_config(5, &raw mut mem as *mut sqlite3_mem_methods)
        };
        default_malloc = mem.x_malloc;
        mem.x_malloc = Some(oom_malloc);
        unsafe {
            sqlite3_config(4, &raw mut mem as *mut sqlite3_mem_methods)
        };
    }
}
...
extern "C" fn decode_database(z_in_1: *const u8, n_in_1: i32,
    ...
    unsafe {
        ...
        let mut mx: i32 = 0;
        let mut n_alloc: sqlite3_uint64 = 4096 as sqlite3_uint64;
                ...
                '__c13: loop {
                    ...
                    if unsafe { isxdigit(c as i32) } != 0 {
                        ...
                        if k & 1 as u32 != 0 {
                            ...
                            if j as sqlite3_uint64 >= n_alloc {
                                let mut new_size: sqlite3_uint64 = 0 as sqlite3_uint64;
                                ...
                                new_size = n_alloc * 2 as sqlite3_uint64;
                                if new_size <= j as u64 {
                                    new_size =
                                        (j + 4096 as u32 & !4095 as u32) as sqlite3_uint64;
                                }
                                if new_size > 10000000 as u64 {
                                    ...
                                    new_size = 10000000 as sqlite3_uint64;
                                }
                                a_new =
                            ...
                            if !((j as sqlite3_uint64) < n_alloc) as i32 as i64 != 0 {
                                unsafe {
                                    __assert_rtn(c"decodeDatabase".as_ptr() as *const i8,
...
extern "C" fn progress_handler(p_client_data_1: *mut ()) -> i32 {
    unsafe {
        ...
        let i_now: sqlite3_int64 = time_of_day();
        let mut rc: i32 = (i_now >= unsafe { (*p).i_cutoff_time }) as i32;
        let i_diff: sqlite3_int64 = i_now - unsafe { (*p).i_last_cb };
...
extern "C" fn recover_database(db: *mut sqlite3) -> i32 {
    unsafe {
        ...
        let mut p: *mut sqlite3_recover = core::ptr::null_mut();
        p =
            unsafe {
...
static mut a_db_config_settings: [anon_s0; 13] =
    [anon_s0 {
                mask: 1 as u32,
                i_setting: 1002,
        ...
        loop {
            ...
            '__s26:
                ...
                match __state {
                    ...
                    49 => {
                        if (i as u64) <
                                core::mem::size_of::<[anon_s0; 13]>() as u64 / 16 {
                            __state = 50;
                        } else { __state = 48; }
                    }
                    50 => {
                        ...
                        cx.i_cutoff_time =
                            cx.i_last_cb +
                                if i_timeout_1 < gi_timeout {
                                        i_timeout_1
                                    } else { gi_timeout } as sqlite3_int64;
                        __state = 56;
                    }
                        ...
                        rc =
                            unsafe {
                                sqlite3_deserialize(cx.db,
                                    ...
                                    n_db as sqlite3_int64, n_db as sqlite3_int64,
                                    (2 | 1) as u32)
                            };
                        __state = 71;
                    }
                    ...
                    124 => {
                        unsafe { sqlite3_hard_heap_limit64(0 as sqlite3_int64) };
                        __state = 130;
                    }
                    ...
                    130 => {
                        unsafe { sqlite3_soft_heap_limit64(0 as sqlite3_int64) };
                        __state = 131;
                    }
                    131 => { return 0; }
                    _ => {}
...
extern "C" fn is_db_sql_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let n: i32 =
...
extern "C" fn inmem_close(p_file_1: *mut sqlite3_file) -> i32 {
...
extern "C" fn inmem_read(p_file_1: *mut sqlite3_file, p_data_1: *mut (),
    mut i_amt_1: i32, i_ofst_1: sqlite3_int64) -> i32 {
    ...
    if i_ofst_1 + i_amt_1 as sqlite3_int64 > unsafe { (*p_v_file).sz } as i64
        {
        unsafe { memset(p_data_1, 0, i_amt_1 as u64) };
        i_amt_1 =
            (unsafe { (*p_v_file).sz } as sqlite3_int64 - i_ofst_1) as i32;
        unsafe {
            memcpy(p_data_1,
...
extern "C" fn inmem_write(p_file_1: *mut sqlite3_file, p_data_1: *const (),
    i_amt_1: i32, i_ofst_1: sqlite3_int64) -> i32 {
    let p_handle: *const VHandle = p_file_1 as *mut VHandle as *const VHandle;
    let p_v_file: *mut VFile = unsafe { (*p_handle).p_v_file };
    if i_ofst_1 + i_amt_1 as sqlite3_int64 > unsafe { (*p_v_file).sz } as i64
        {
        if i_ofst_1 + i_amt_1 as sqlite3_int64 >= 10000000 as i64 {
            return 13;
        }
        unsafe {
            (*p_v_file).a =
                safe_realloc(unsafe { (*p_v_file).a } as *mut (),
                        (i_ofst_1 + i_amt_1 as sqlite3_int64) as i32) as *mut u8
        };
        if i_ofst_1 > unsafe { (*p_v_file).sz } as i64 {
            unsafe {
                memset(unsafe {
                    ...
                    (i_ofst_1 - unsafe { (*p_v_file).sz } as sqlite3_int64) as
                            i32 as u64)
            };
        }
        unsafe {
            (*p_v_file).sz = (i_ofst_1 + i_amt_1 as sqlite3_int64) as i32
        };
    }
    unsafe {
...
extern "C" fn inmem_truncate(p_file_1: *mut sqlite3_file,
    i_size_1: sqlite3_int64) -> i32 {
    let p_handle: *const VHandle = p_file_1 as *mut VHandle as *const VHandle;
    let p_v_file: *mut VFile = unsafe { (*p_handle).p_v_file };
    if unsafe { (*p_v_file).sz } as sqlite3_int64 > i_size_1 &&
            i_size_1 >= 0 as i64 {
        unsafe { (*p_v_file).sz = i_size_1 as i32 };
    }
    return 0;
}
extern "C" fn inmem_sync(p_file_1: *mut sqlite3_file, flags: i32) -> i32 {
    return 0;
}
extern "C" fn inmem_file_size(p_file_1: *mut sqlite3_file,
...
extern "C" fn inmem_lock(p_file_1: *mut sqlite3_file, type__1: i32) -> i32 {
    return 0;
}
extern "C" fn inmem_unlock(p_file_1: *mut sqlite3_file, type__1: i32) -> i32 {
    return 0;
}
extern "C" fn inmem_check_reserved_lock(p_file_1: *mut sqlite3_file,
    p_out_1: *mut i32) -> i32 {
    unsafe { *p_out_1 = 0 };
    return 0;
}
extern "C" fn inmem_file_control(p_file_1: *mut sqlite3_file, op: i32,
    p_arg_1: *mut ()) -> i32 {
    return 12;
}
extern "C" fn inmem_sector_size(p_file_1: *mut sqlite3_file) -> i32 {
    return 512;
}
extern "C" fn inmem_device_characteristics(p_file_1: *mut sqlite3_file)
    -> i32 {
    return 512 | 2048 | 4096;
}
static mut v_handle_methods: sqlite3_io_methods =
    sqlite3_io_methods {
        i_version: 1,
...
extern "C" fn inmem_open(p_vfs_1: *mut sqlite3_vfs, z_filename_1: *const i8,
    p_file_1: *mut sqlite3_file, open_flags_1: i32, p_out_flags_1: *mut i32)
    -> i32 {
    unsafe {
        ...
        unsafe {
            (*p_file_1).p_methods =
                &raw mut v_handle_methods as *const sqlite3_io_methods
        };
...
extern "C" fn inmem_delete(p_vfs_1: *mut sqlite3_vfs, z_filename_1: *const i8,
    syncdir: i32) -> i32 {
...
extern "C" fn inmem_access(p_vfs_1: *mut sqlite3_vfs, z_filename_1: *const i8,
...
extern "C" fn inmem_full_pathname(p_vfs_1: *mut sqlite3_vfs,
...
extern "C" fn inmem_randomness(not_used_1: *mut sqlite3_vfs, n_buf_1: i32,
    z_buf_1: *mut i8) -> i32 {
    unsafe {
...
extern "C" fn inmem_vfs_register(make_default_1: i32) -> () {
    unsafe {
        let p_default: *const sqlite3_vfs =
...
extern "C" fn __main_inner(argc: i32, argv: *const *mut i8)
    ...
    unsafe {
        ...
        let mut p_dflt_vfs: *const sqlite3_vfs = core::ptr::null();
        ...
        let mut tm_end_1: sqlite3_int64 = 0 as sqlite3_int64;
        let mut i_elapse: sqlite3_int64 = 0 as sqlite3_int64;
        let mut n_total_2: i32 = 0;
        let mut i_elapse_1: sqlite3_int64 = 0 as sqlite3_int64;
        let mut __state: i32 = 0;
        loop {
            if __state == 1 { break; }
            '__s41:
                ...
                match __state {
                    ...
                    452 => {
                        unsafe {
                            sqlite3_hard_heap_limit64(n_mem_this_db as sqlite3_int64)
                        };
                        __state = 448;
                    }
                    453 => {
                    ...
                    481 => {
                        i_to_go =
                            ((time_of_day() - i_begin) *
                                        (n_total - idx) as sqlite3_int64 /
                                    (idx * 1000) as sqlite3_int64) as i32;
                        __state = 483;
                    }
                    482 => {
                        unsafe {
                    ...
                    594 => {
                        unsafe {
                            printf(c"%s %s: 0 errors out of %d tests, slice %d/%d, %d.%03d seconds\n".as_ptr()
                                ...
                                i_slice_sz, (i_elapse / 1000 as sqlite3_int64) as i32,
                    ...
                    607 => {
                        unsafe {
                            printf(c"fuzzcheck: 0 errors out of %d tests in %d.%03d seconds\nSQLite %s %s (%d-bit)\n".as_ptr()
                                ...
                                (i_elapse_1 / 1000 as sqlite3_int64) as i32,
                                (i_elapse_1 % 1000 as sqlite3_int64) as i32,
...
#[repr(C)]
#[derive(Copy, Clone)]
union blob_list_load_from_db_u0_N25blob_list_load_from_db_u0 {
    s_blob: Blob,
    tmp: [u8; 28],
}
#[repr(C)]
...
static mut inmem_vfs: sqlite3_vfs = unsafe { core::mem::zeroed() };
...
extern "C" {
    ...
    fn atoi(_: *const i8)
    -> i32;
    fn fuzz_invariant(db: *mut sqlite3, p_stmt_1: *mut sqlite3_stmt,
