...
extern "C" fn init_api_ptr(p_api_1: *const sqlite3_api_routines) -> () {
    { let _ = p_api_1; };
}
...
extern "C" fn base64(context: *mut sqlite3_context, na: i32,
    av: *mut *mut sqlite3_value) -> () {
    let mut nb: sqlite3_int64 = 0 as sqlite3_int64;
    let mut nv: sqlite3_int64 = 0 as sqlite3_int64;
    let mut nc: sqlite3_int64 = 0 as sqlite3_int64;
        ...
        '__s9:
            ...
            match __state {
                ...
                15 => {
                    nc =
                        4 as sqlite3_int64 *
                            ((nv + 2 as sqlite3_int64) / 3 as sqlite3_int64);
                    __state = 16;
                }
                16 => {
                    nc +=
                        (nc + (72 - 1) as sqlite3_int64) / 72 as sqlite3_int64 +
                            1 as sqlite3_int64;
                    __state = 17;
                }
                17 => {
                    if (nv_max as sqlite3_int64) < nc {
                        __state = 19;
                    } else { __state = 18; }
                }
                18 => {
                ...
                22 => {
                    c_buf =
                        unsafe { sqlite3_malloc64(nc as sqlite3_uint64) } as
                            *mut i8;
                    __state = 27;
                }
                23 => {
                ...
                28 => {
                    nc =
                        unsafe {
                                    ...
                                    } as i64 as i32 as sqlite3_int64;
                    __state = 30;
                }
                29 => { __state = 2; }
                30 => {
                ...
                33 => {
                    nb =
                        3 as sqlite3_int64 *
                            ((nv + 3 as sqlite3_int64) / 4 as sqlite3_int64);
                    __state = 34;
                }
                34 => {
                    if (nv_max as sqlite3_int64) < nb {
                        __state = 36;
                    } else { __state = 37; }
                }
                35 => {
                ...
                38 => { return; }
                39 => { nb = 1 as sqlite3_int64; __state = 35; }
                40 => {
                    if (c_buf).is_null() as i32 != 0 {
                        __state = 42;
                    } else { __state = 41; }
                ...
                41 => {
                    b_buf =
                        unsafe { sqlite3_malloc64(nb as sqlite3_uint64) } as
                            *mut u8;
                    __state = 46;
                }
                42 => {
...
pub extern "C" fn sqlite3_base64_init(db: *mut sqlite3,
    pz_err_1: *const *mut i8, p_api_1: *const sqlite3_api_routines) -> i32 {
    { let _ = p_api_1; };
    { let _ = pz_err_1; };
    return unsafe {
...
extern "C" fn is_base85(context: *mut sqlite3_context, na: i32,
    av: *mut *mut sqlite3_value) -> () {
    if !(na == 1) as i32 as i64 != 0 {
        unsafe {
...
extern "C" fn base85(context: *mut sqlite3_context, na: i32,
    av: *mut *mut sqlite3_value) -> () {
    let mut nb: sqlite3_int64 = 0 as sqlite3_int64;
    let mut nc: sqlite3_int64 = 0 as sqlite3_int64;
    let mut nv: sqlite3_int64 = 0 as sqlite3_int64;
    ...
    loop {
        ...
        '__s23:
            ...
            match __state {
                ...
                13 => {
                    nc =
                        5 as sqlite3_int64 * (nv / 4 as sqlite3_int64) +
                                        nv % 4 as sqlite3_int64 + nv / 64 as sqlite3_int64 +
                                1 as sqlite3_int64 + 2 as sqlite3_int64;
                    __state = 14;
                }
                14 => {
                    if (nv_max as sqlite3_int64) < nc {
                ...
                30 => {
                    nb =
                        4 as sqlite3_int64 * (nv / 5 as sqlite3_int64) +
                            nv % 5 as sqlite3_int64;
                    __state = 31;
                }
                31 => {
                    if (nv_max as sqlite3_int64) < nb {
                ...
                35 => { return; }
                36 => { nb = 1 as sqlite3_int64; __state = 32; }
                37 => {
                    if (c_buf).is_null() as i32 != 0 {
                        __state = 39;
                    } else { __state = 38; }
