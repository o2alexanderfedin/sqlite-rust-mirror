...
extern "C" fn demo_close(p_file_1: *mut sqlite3_file) -> i32 {
    let mut rc: i32 = 0;
...
extern "C" fn demo_read(p_file_1: *mut sqlite3_file, z_buf_1: *mut (),
    i_amt_1: i32, i_ofst_1: sqlite_int64) -> i32 {
    let p: *mut DemoFile = p_file_1 as *mut DemoFile;
    let mut ofst: off_t = 0 as off_t;
...
extern "C" fn demo_write(p_file_1: *mut sqlite3_file, z_buf_1: *const (),
    ...
    if !(unsafe { (*p).a_buffer }).is_null() {
        ...
        while n > 0 {
            ...
            unsafe {
                (*p).i_buffer_ofst =
                    i - unsafe { (*p).n_buffer } as sqlite3_int64
            };
...
extern "C" fn demo_truncate(p_file_1: *mut sqlite3_file, size: sqlite_int64)
    -> i32 {
    return 0;
}
extern "C" fn demo_sync(p_file_1: *mut sqlite3_file, flags: i32) -> i32 {
    let p: *mut DemoFile = p_file_1 as *mut DemoFile;
    let mut rc: i32 = 0;
    rc = demo_flush_buffer(p);
    if rc != 0 { return rc; }
...
extern "C" fn demo_file_size(p_file_1: *mut sqlite3_file,
...
extern "C" fn demo_lock(p_file_1: *mut sqlite3_file, e_lock_1: i32) -> i32 {
    return 0;
}
extern "C" fn demo_unlock(p_file_1: *mut sqlite3_file, e_lock_1: i32) -> i32 {
    return 0;
}
extern "C" fn demo_check_reserved_lock(p_file_1: *mut sqlite3_file,
    p_res_out_1: *mut i32) -> i32 {
    unsafe { *p_res_out_1 = 0 };
    return 0;
}
extern "C" fn demo_file_control(p_file_1: *mut sqlite3_file, op: i32,
    p_arg_1: *mut ()) -> i32 {
    return 12;
}
extern "C" fn demo_sector_size(p_file_1: *mut sqlite3_file) -> i32 {
    return 0;
}
extern "C" fn demo_device_characteristics(p_file_1: *mut sqlite3_file)
    -> i32 {
    return 0;
}
extern "C" fn demo_open(p_vfs_1: *mut sqlite3_vfs, z_name_1: *const i8,
    p_file_1: *mut sqlite3_file, flags: i32, p_out_flags_1: *mut i32) -> i32 {
    let p: *mut DemoFile = p_file_1 as *mut DemoFile;
...
extern "C" fn demo_delete(p_vfs_1: *mut sqlite3_vfs, z_path_1: *const i8,
    dir_sync_1: i32) -> i32 {
    let mut rc: i32 = 0;
...
extern "C" fn demo_access(p_vfs_1: *mut sqlite3_vfs, z_path_1: *const i8,
...
extern "C" fn demo_full_pathname(p_vfs_1: *mut sqlite3_vfs,
...
extern "C" fn demo_dl_open(p_vfs_1: *mut sqlite3_vfs, z_path_1: *const i8)
    -> *mut () {
    return core::ptr::null_mut();
}
extern "C" fn demo_dl_error(p_vfs_1: *mut sqlite3_vfs, n_byte_1: i32,
    z_err_msg_1: *mut i8) -> () {
    unsafe {
...
extern "C" fn demo_dl_sym(p_vfs_1: *mut sqlite3_vfs, p_h_1: *mut (),
...
extern "C" fn demo_dl_close(p_vfs_1: *mut sqlite3_vfs, p_handle_1: *mut ())
    -> () {
    return;
}
extern "C" fn demo_randomness(p_vfs_1: *mut sqlite3_vfs, n_byte_1: i32,
    z_byte_1: *mut i8) -> i32 {
    return 0;
}
extern "C" fn demo_sleep(p_vfs_1: *mut sqlite3_vfs, n_micro_1: i32) -> i32 {
    unsafe { sleep((n_micro_1 / 1000000) as u32) };
    unsafe { usleep((n_micro_1 % 1000000) as useconds_t) };
    return n_micro_1;
}
extern "C" fn demo_current_time(p_vfs_1: *mut sqlite3_vfs, p_time_1: *mut f64)
    -> i32 {
    let t: time_t = unsafe { time(core::ptr::null_mut()) };
    unsafe { *p_time_1 = t as f64 / 86400.0 + 2440587.5 };
    return 0;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_demovfs() -> *mut sqlite3_vfs {
    unsafe { return &mut demovfs; }
}
static demoio: sqlite3_io_methods =
    sqlite3_io_methods {
        i_version: 1,
...
static mut demovfs: sqlite3_vfs =
    sqlite3_vfs {
        i_version: 1,
