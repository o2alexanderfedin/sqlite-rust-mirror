...
struct Sqlite3Config {
    ...
    x_log: unsafe extern "C" fn(*mut (), i32, *const i8) -> (),
    p_log_arg: *mut (),
        ...
        '__s14:
            ...
            match op {
                1 => {
                        ...
                        sqlite3Config.mutex =
                            unsafe {
                                core::ptr::read(unsafe {
                                        ...
                                        let __va_p = *__ap;
                                        *__ap =
                                            (*__ap).add((core::mem::size_of::<*mut sqlite3_mutex_methods>()
                                                            + 7) & !7);
                                        *(__va_p as *const *mut sqlite3_mutex_methods)
                                    })
                            };
                        break '__s14;
                    }
                        ...
                        sqlite3Config.m =
                            unsafe {
                                core::ptr::read(unsafe {
                                        ...
                                        let __va_p = *__ap;
                                        *__ap =
                                            (*__ap).add((core::mem::size_of::<*mut sqlite3_mem_methods>()
                                                            + 7) & !7);
                                        *(__va_p as *const *mut sqlite3_mem_methods)
                                    })
                            };
                        break '__s14;
                    }
                        ...
                        sqlite3Config.pcache2 =
                            unsafe {
                                core::ptr::read(unsafe {
                                        ...
                                        let __va_p = *__ap;
                                        *__ap =
                                            (*__ap).add((core::mem::size_of::<*mut sqlite3_pcache_methods2>()
                                                            + 7) & !7);
                                        *(__va_p as *const *mut sqlite3_pcache_methods2)
                                    })
                            };
                        break '__s14;
                    }
                    ...
                    {
                        let mut sz_mmap: sqlite3_int64 =
                            unsafe {
                                let __ap = &mut ap;
                                let __va_p = *__ap;
                                *__ap =
                                    (*__ap).add((core::mem::size_of::<sqlite3_int64>() + 7) &
                                            !7);
                                *(__va_p as *const sqlite3_int64)
                            };
                        let mut mx_mmap: sqlite3_int64 =
                            unsafe {
                                let __ap = &mut ap;
                                let __va_p = *__ap;
                                *__ap =
                        ...
                        if mx_mmap < 0 as i64 || mx_mmap > 2147418112 as i64 {
                            mx_mmap = 2147418112 as sqlite3_int64;
                        }
                        if sz_mmap < 0 as i64 { sz_mmap = 0 as sqlite3_int64; }
...
extern "C" fn setup_lookaside(db: *mut sqlite3, p_buf_1: *mut (), mut sz: i32,
    ...
    unsafe {
        ...
        let mut sz_alloc: sqlite3_int64 = 0 as sqlite3_int64;
        let mut n_big: i32 = 0;
        let mut n_sm: i32 = 0;
        ...
        if sz >= 128 * 3 {
            n_big = (sz_alloc / (3 * 128 + sz) as sqlite3_int64) as i32;
            n_sm =
                ((sz_alloc - sz as i64 * n_big as i64) / 128 as sqlite_int64)
                    as i32;
        } else if sz >= 128 * 2 {
            n_big = (sz_alloc / (128 + sz) as sqlite3_int64) as i32;
            n_sm =
                ((sz_alloc - sz as i64 * n_big as i64) / 128 as sqlite_int64)
                    as i32;
        } else if sz > 0 {
            n_big = (sz_alloc / sz as sqlite3_int64) as i32;
            n_sm = 0;
            ...
            1000 => {
                ...
                }
                {
                    ...
                    rc = 1;
                    {
                        ...
                        '__b18: loop {
                            if !(i <
                                            (core::mem::size_of::<[sqlite3_db_config_s0_N20sqlite3_db_config_s0; 21]>()
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_last_insert_rowid(db: &sqlite3) -> sqlite3_int64 {
...
pub extern "C" fn sqlite3_set_last_insert_rowid(db: &mut sqlite3,
    i_rowid_1: sqlite3_int64) -> () {
    unsafe { sqlite3_mutex_enter((*db).mutex) };
    (*db).last_rowid = i_rowid_1;
    unsafe { sqlite3_mutex_leave((*db).mutex) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_changes64(db: &sqlite3) -> sqlite3_int64 {
    let mut i_ret: i64 = 0 as i64;
    unsafe { sqlite3_mutex_enter((*db).mutex) };
    i_ret = (*db).n_change;
    unsafe { sqlite3_mutex_leave((*db).mutex) };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_total_changes64(db: &sqlite3) -> sqlite3_int64 {
    let mut i_ret: i64 = 0 as i64;
    unsafe { sqlite3_mutex_enter((*db).mutex) };
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_free_filename(mut p: sqlite3_filename) -> () {
...
pub extern "C" fn sqlite3_parse_uri(z_default_vfs_1: *const i8,
    z_uri_1: *const i8, p_flags_1: &mut u32, pp_vfs_1: &mut *mut sqlite3_vfs,
    ...
    unsafe {
        unsafe {
            ...
            let mut a_mode: *const OpenMode_N8OpenMode = core::ptr::null();
                ...
                '__s24:
                    ...
                    match __state {
                        ...
                        12 => {
                            z_file =
                                unsafe {
                                        sqlite3_malloc64((n_uri + 8 as i64) as sqlite3_uint64)
                                    } as *mut i8;
                            __state = 107;
                        }
                        13 => { __state = 14; }
                        ...
                        86 => {
                            a_mode =
                                &raw mut a_open_mode[0 as usize] as
                                    *mut OpenMode_N8OpenMode;
                            __state = 87;
                        }
                        87 => {
                        ...
                        120 => {
                            sqlite3_free_filename(z_file as sqlite3_filename);
                            __state = 121;
                        }
            ...
            loop {
                ...
                '__s27:
                    ...
                    match __state {
                        ...
                        126 => {
                            sqlite3_free_filename(z_open as sqlite3_filename);
                            __state = 127;
                        }
                        127 => { return rc; }
                        _ => {}
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_uri_parameter(mut z_filename: sqlite3_filename,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_uri_boolean(z_filename: sqlite3_filename,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_uri_int64(z_filename: sqlite3_filename,
    z_param: *const i8, mut b_dflt: sqlite3_int64) -> sqlite3_int64 {
    let z: *const i8 = sqlite3_uri_parameter(z_filename, z_param);
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_uri_key(mut z_filename: sqlite3_filename,
    mut n: i32) -> *const i8 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_filename_database(z_filename: sqlite3_filename)
    -> *const i8 {
    if z_filename == core::ptr::null() { return core::ptr::null(); }
    return database_name(z_filename);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_filename_journal(mut z_filename: sqlite3_filename)
    -> *const i8 {
    if z_filename == core::ptr::null() { return core::ptr::null(); }
    z_filename = database_name(z_filename);
    {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_filename_wal(mut z_filename: sqlite3_filename)
    -> *const i8 {
...
pub extern "C" fn sqlite3_create_filename(z_database: *const i8,
    ...
    az_param: *mut *const i8) -> sqlite3_filename {
    ...
    n_byte =
        (unsafe { strlen(z_database) } + unsafe { strlen(z_journal) } +
                    unsafe { strlen(z_wal) } + 10 as u64) as sqlite3_int64;
    {
        i = 0;
        '__b31: loop {
            ...
            '__c31: loop {
                n_byte +=
                    (unsafe { strlen(unsafe { *az_param.offset(i as isize) }) }
                                + 1 as u64) as u64 as sqlite3_int64;
                break '__c31;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
        }
    ...
    if p == core::ptr::null_mut() { return 0 as sqlite3_filename; }
    ...
    { let _ = 0; };
    return unsafe { p_result.offset(4 as isize) } as sqlite3_filename;
}
#[unsafe(no_mangle)]
...
pub extern "C" fn sqlite3_db_filename(db: *mut sqlite3,
    z_db_name_1: *const i8) -> sqlite3_filename {
...
extern "C" fn sqlite3_invalid_function(context: *mut sqlite3_context,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_db_mutex(db: &sqlite3) -> *mut sqlite3_mutex {
    return (*db).mutex;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_file_control(db: *mut sqlite3,
    ...
    if !(p_btree).is_null() {
        ...
        { let _ = 0; };
        if op == 7 {
            unsafe { *(p_arg_1 as *mut *mut sqlite3_file) = fd };
            rc = 0;
        } else if op == 27 {
            unsafe {
                *(p_arg_1 as *mut *mut sqlite3_vfs) =
                    unsafe { sqlite3_pager_vfs(p_pager) }
            };
            rc = 0;
        } else if op == 28 {
            unsafe {
                *(p_arg_1 as *mut *mut sqlite3_file) =
            ...
            '__s41:
                ...
                match op {
                    5 => {
                        ...
                        {
                            let p_ctx: *mut sqlite3_context =
                                unsafe {
                                    let __ap = &mut ap;
                                    let __va_p = *__ap;
                                    *__ap =
                                        (*__ap).add((core::mem::size_of::<*mut sqlite3_context>() +
                                                        7) & !7);
                                    *(__va_p as *const *mut sqlite3_context)
                                };
                        ...
                        }
                        {
                            ...
                            let pn: *mut u64 =
                                unsafe {
                                    ...
                                    let __va_p = *__ap;
                                    *__ap =
                                        (*__ap).add((core::mem::size_of::<*mut sqlite3_uint64>() +
                                                        7) & !7);
                                    *(__va_p as *const *mut sqlite3_uint64)
                                };
                            unsafe { *pn = 0 as u64 };
                            { let _ = db; };
                            break '__s41;
...
type LOGFUNC_t = unsafe extern "C" fn(*mut (), i32, *const i8) -> ();
#[repr(C)]
#[derive(Copy, Clone)]
struct sqlite3_db_config_s0_N20sqlite3_db_config_s0 {
    op: i32,
    mask: u64,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct OpenMode_N8OpenMode {
    z: *const i8,
    mode: i32,
}
type sqlite3FaultFuncType = unsafe extern "C" fn(i32) -> i32;
type void_function = unsafe extern "C" fn() -> ();
...
static a_flag_op: [sqlite3_db_config_s0_N20sqlite3_db_config_s0; 21] =
    [sqlite3_db_config_s0_N20sqlite3_db_config_s0 {
                op: 1002,
                mask: 16384 as u64,
            },
            sqlite3_db_config_s0_N20sqlite3_db_config_s0 {
...
static mut a_cache_mode: [OpenMode_N8OpenMode; 3] =
    [OpenMode_N8OpenMode { z: c"shared".as_ptr() as *const i8, mode: 131072 },
            OpenMode_N8OpenMode {
                z: c"private".as_ptr() as *const i8,
                mode: 262144,
            }, OpenMode_N8OpenMode { z: core::ptr::null(), mode: 0 }];
static mut a_open_mode: [OpenMode_N8OpenMode; 5] =
    [OpenMode_N8OpenMode { z: c"ro".as_ptr() as *const i8, mode: 1 },
            OpenMode_N8OpenMode { z: c"rw".as_ptr() as *const i8, mode: 2 },
            OpenMode_N8OpenMode {
