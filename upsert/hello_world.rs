...
extern "C" fn upsert_delete(db: *mut sqlite3, mut p: *mut Upsert) -> () {
    '__b0: loop {
        '__c0: loop {
            let p_next: *mut Upsert = unsafe { (*p).p_next_upsert };
            unsafe {
                sqlite3_expr_list_delete(db, unsafe { (*p).p_upsert_target })
            };
            unsafe {
                sqlite3_expr_delete(db, unsafe { (*p).p_upsert_target_where })
            };
            unsafe {
                sqlite3_expr_list_delete(db, unsafe { (*p).p_upsert_set })
            };
            unsafe {
                sqlite3_expr_delete(db, unsafe { (*p).p_upsert_where })
            };
            unsafe { sqlite3_db_free(db, unsafe { (*p).p_to_free }) };
...
pub extern "C" fn sqlite3_upsert_new(db: *mut sqlite3,
    ...
    p_where: *mut Expr, p_next: *mut Upsert) -> *mut Upsert {
    let mut p_new: *mut Upsert = core::ptr::null_mut();
    p_new =
        unsafe {
                sqlite3_db_malloc_zero(db,
                    core::mem::size_of::<Upsert>() as u64)
            } as *mut Upsert;
    if p_new == core::ptr::null_mut() {
        unsafe { sqlite3_expr_list_delete(db, p_target) };
        unsafe { sqlite3_expr_delete(db, p_target_where) };
        unsafe { sqlite3_expr_list_delete(db, p_set) };
        unsafe { sqlite3_expr_delete(db, p_where) };
        sqlite3_upsert_delete(db, p_next);
        return core::ptr::null_mut();
    } else {
        unsafe { (*p_new).p_upsert_target = p_target };
        unsafe { (*p_new).p_upsert_target_where = p_target_where };
        unsafe { (*p_new).p_upsert_set = p_set };
        unsafe { (*p_new).p_upsert_where = p_where };
        unsafe {
            (*p_new).is_do_update = (p_set != core::ptr::null_mut()) as u8
        };
        unsafe { (*p_new).p_next_upsert = p_next };
    }
    return p_new;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_upsert_dup(db: *mut sqlite3, p: *mut Upsert)
    ...
    return sqlite3_upsert_new(db,
            unsafe {
                sqlite3_expr_list_dup(db,
                    unsafe { (*p).p_upsert_target } as *const ExprList, 0)
            },
            unsafe {
                sqlite3_expr_dup(db,
                    unsafe { (*p).p_upsert_target_where } as *const Expr, 0)
            },
            unsafe {
                sqlite3_expr_list_dup(db,
                    unsafe { (*p).p_upsert_set } as *const ExprList, 0)
            },
            unsafe {
                sqlite3_expr_dup(db,
...
pub extern "C" fn sqlite3_upsert_analyze_target(p_parse: *mut Parse,
    ...
    unsafe {
        ...
        s_nc.p_src_list = p_tab_list;
        {
            '__b2: loop {
                if !(!(p_upsert).is_null() &&
                                !(unsafe { (*p_upsert).p_upsert_target }).is_null()) {
                    break '__b2;
                }
                '__c2: loop {
                    rc =
                    ...
                    if unsafe { (*p_tab).tab_flags } & 128 as u32 == 0 as u32 &&
                                    unsafe { (*p_target).n_expr } == 1 &&
                                unsafe {
                                            (*{
                                                            p_term =
                                                                unsafe {
                                                                    (*(unsafe { (*p_target).a.as_ptr() } as
                    ...
                    s_col[0 as usize].op = 114 as u8;
                    s_col[0 as usize].p_left = &mut s_col[1 as usize];
                    s_col[1 as usize].op = 168 as u8;
                    s_col[1 as usize].i_table =
                        unsafe {
                            (*(unsafe { (*p_tab_list).a.as_ptr() } as
                                            *mut SrcItem).offset(0 as isize)).i_cursor
                        };
                    {
                        ...
                        '__b3: loop {
                            ...
                            '__c3: loop {
                                ...
                                if unsafe { (*p_target).n_expr } !=
                                        unsafe { (*p_idx).n_key_col } as i32 {
                                    break '__c3;
                                }
                                if !(unsafe { (*p_idx).p_part_idx_where }).is_null() {
                                    if unsafe { (*p_upsert).p_upsert_target_where } ==
                                            core::ptr::null_mut() {
                                        break '__c3;
                                    }
                                    if unsafe {
                                                sqlite3_expr_compare(p_parse as *const Parse,
                                                    unsafe { (*p_upsert).p_upsert_target_where } as *const Expr,
                                                    unsafe { (*p_idx).p_part_idx_where } as *const Expr,
                                                    i_cursor)
                                            } != 0 {
                                        break '__c3;
                                    }
                                }
                                nn = unsafe { (*p_idx).n_key_col } as i32;
                                {
                                    ii = 0;
                                    '__b4: loop {
                                        if !(ii < nn) { break '__b4; }
                                        '__c4: loop {
                                            ...
                                            s_col[0 as usize].u.z_token =
                                                unsafe { *unsafe { (*p_idx).az_coll.offset(ii as isize) } }
                                                    as *mut i8;
                                            if unsafe {
                                                            *unsafe { (*p_idx).ai_column.offset(ii as isize) }
                                                        } as i32 == -2 {
                                                { let _ = 0; };
                                                { let _ = 0; };
                                                { let _ = 0; };
                                                p_expr =
                                                    unsafe {
                                                        (*(unsafe { (*unsafe { (*p_idx).a_col_expr }).a.as_ptr() }
                                                                        as *mut ExprList_item).offset(ii as isize)).p_expr
                                                    };
                                                if unsafe { (*p_expr).op } as i32 != 114 {
                                                    s_col[0 as usize].p_left = p_expr;
                                                    p_expr = &mut s_col[0 as usize];
                                                }
                                            } else {
                                                s_col[0 as usize].p_left = &mut s_col[1 as usize];
                                                s_col[1 as usize].i_column =
                                                    unsafe {
                                                        *unsafe { (*p_idx).ai_column.offset(ii as isize) }
                                                    };
                                                p_expr = &mut s_col[0 as usize];
                                                        ...
                                                        if unsafe {
                                                                    sqlite3_expr_compare(core::ptr::null(),
                                                                        unsafe {
                                                                            ...
                                                                            } as *const Expr, p_expr as *const Expr, i_cursor)
                                                                } < 2 {
                                                            break '__b5;
                                                        }
                                                        break '__c5;
                    ...
                    if unsafe { (*p_upsert).p_upsert_idx } ==
                            core::ptr::null_mut() {
                        let mut z_which: [i8; 16] = [0; 16];
                        if n_clause == 0 &&
                                unsafe { (*p_upsert).p_next_upsert } ==
                                    core::ptr::null_mut() {
                            z_which[0 as usize] = 0 as i8;
                        } else {
                            unsafe {
                                sqlite3_snprintf(core::mem::size_of::<[i8; 16]>() as i32,
                                    &raw mut z_which[0 as usize] as *mut i8,
                                    c"%r ".as_ptr() as *mut i8 as *const i8, n_clause + 1)
                            };
                        }
                        unsafe {
                            sqlite3_error_msg(p_parse,
                                c"%sON CONFLICT clause does not match any PRIMARY KEY or UNIQUE constraint".as_ptr()
                ...
                {
                    p_upsert = unsafe { (*p_upsert).p_next_upsert };
                    { let __p = &mut n_clause; let __t = *__p; *__p += 1; __t }
                };
            }
        }
        return 0;
...
pub extern "C" fn sqlite3_upsert_do_update(p_parse: *mut Parse,
    ...
    if !(p_idx).is_null() && i_cur != i_data_cur {
        if unsafe { (*p_tab).tab_flags } & 128 as u32 == 0 as u32 {
            let reg_rowid: i32 = unsafe { sqlite3_get_temp_reg(p_parse) };
            unsafe { sqlite3_vdbe_add_op2(v, 144, i_cur, reg_rowid) };
            unsafe { sqlite3_vdbe_add_op3(v, 30, i_data_cur, 0, reg_rowid) };
            ...
            let n_pk: i32 = unsafe { (*p_pk).n_key_col } as i32;
            let i_pk: i32 = unsafe { (*p_parse).n_mem } + 1;
            unsafe { (*p_parse).n_mem += n_pk };
            {
                i = 0;
                '__b6: loop {
                    if !(i < n_pk) { break '__b6; }
                    '__c6: loop {
                        let mut k: i32 = 0;
                        { let _ = 0; };
                        k =
                        ...
                        unsafe { sqlite3_vdbe_add_op3(v, 96, i_cur, k, i_pk + i) };
                        break '__c6;
                    }
            ...
            i =
                unsafe {
                    sqlite3_vdbe_add_op4_int(v, 29, i_data_cur, 0, i_pk, n_pk)
                };
            unsafe {
                sqlite3_vdbe_add_op4(v, 72, 11, 2, 0,
                    c"corrupt database".as_ptr() as *mut i8 as *const i8, -1)
            };
        ...
        };
    {
        i = 0;
        '__b7: loop {
            if !(i < unsafe { (*p_tab).n_col } as i32) { break '__b7; }
            '__c7: loop {
                if unsafe {
                                (*unsafe { (*p_tab).a_col.offset(i as isize) }).affinity
                            } as i32 == 69 {
                    let i_storage: i32 =
                        unsafe { (*p_top).reg_data } +
                            unsafe { sqlite3_table_column_to_storage(p_tab, i as i16) }
                                as i32;
                    unsafe { sqlite3_vdbe_add_op1(v, 89, i_storage) };
                }
                break '__c7;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
    ...
    unsafe {
        sqlite3_update(p_parse, p_src,
            unsafe {
                sqlite3_expr_list_dup(db,
                    unsafe { (*p_upsert).p_upsert_set } as *const ExprList, 0)
            },
            unsafe {
                sqlite3_expr_dup(db,
                    unsafe { (*p_upsert).p_upsert_where } as *const Expr, 0)
...
pub extern "C" fn sqlite3_upsert_next_is_ipk(p_upsert: *mut Upsert) -> i32 {
    ...
    if p_upsert == core::ptr::null_mut() { return 0; }
    p_next = unsafe { (*p_upsert).p_next_upsert };
    loop {
        if p_next == core::ptr::null_mut() { return 1; }
        if unsafe { (*p_next).p_upsert_target } == core::ptr::null_mut() {
            return 1;
        }
        if unsafe { (*p_next).p_upsert_idx } == core::ptr::null_mut() {
            return 1;
        }
        if (unsafe { (*p_next).is_dup } == 0) as i32 != 0 { return 0; }
        p_next = unsafe { (*p_next).p_next_upsert };
    }
    return 0;
}
extern "C" {
