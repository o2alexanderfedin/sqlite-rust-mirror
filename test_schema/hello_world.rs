...
struct schema_cursor {
    ...
    p_db_list: *mut sqlite3_stmt,
    p_table_list: *mut sqlite3_stmt,
    p_column_list: *mut sqlite3_stmt,
    rowid: i32,
}
extern "C" fn schema_destroy(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe {
        unsafe {
            (unsafe { (*sqlite3_api).free.unwrap() })(p_vtab_1 as *mut ())
        };
        return 0;
    }
}
extern "C" fn schema_create(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    unsafe {
        let mut rc: i32 = 7;
        let p_vtab: *mut schema_vtab =
            unsafe {
                    (unsafe {
                            (*sqlite3_api).malloc.unwrap()
                        })(core::mem::size_of::<schema_vtab>() as i32)
                } as *mut schema_vtab;
        if !(p_vtab).is_null() {
            unsafe {
                memset(p_vtab as *mut (), 0,
                    core::mem::size_of::<schema_vtab>() as u64)
            };
            unsafe { (*p_vtab).db = db };
            rc =
                unsafe {
                    (unsafe {
                        ...
                        c"CREATE TABLE x(database,tablename,cid,name,type,not_null,dflt_value,pk)".as_ptr()
...
extern "C" fn schema_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    unsafe {
        let mut rc: i32 = 7;
        let mut p_cur: *mut schema_cursor = core::ptr::null_mut();
        p_cur =
            unsafe {
                    (unsafe {
                            (*sqlite3_api).malloc.unwrap()
                        })(core::mem::size_of::<schema_cursor>() as i32)
                } as *mut schema_cursor;
        if !(p_cur).is_null() {
            unsafe {
                memset(p_cur as *mut (), 0,
                    core::mem::size_of::<schema_cursor>() as u64)
            };
...
extern "C" fn schema_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    unsafe {
        let p_cur: *mut schema_cursor = cur as *mut schema_cursor;
        unsafe {
            (unsafe {
                    (*sqlite3_api).finalize.unwrap()
                })(unsafe { (*p_cur).p_db_list })
        };
        unsafe {
            (unsafe {
                    (*sqlite3_api).finalize.unwrap()
                })(unsafe { (*p_cur).p_table_list })
        };
        unsafe {
            (unsafe {
                    (*sqlite3_api).finalize.unwrap()
                })(unsafe { (*p_cur).p_column_list })
        };
        unsafe {
...
extern "C" fn schema_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    unsafe {
        let p_cur: *const schema_cursor =
            cur as *mut schema_cursor as *const schema_cursor;
        '__s0:
            {
            match i {
                0 => {
                    unsafe {
                        (unsafe {
                                (*sqlite3_api).result_value.unwrap()
                            })(ctx,
                            unsafe {
                                (unsafe {
                                        (*sqlite3_api).column_value.unwrap()
                                    })(unsafe { (*p_cur).p_db_list }, 1)
                            })
                    };
                }
                1 => {
                    ...
                    unsafe {
                        (unsafe {
                            ...
                            unsafe {
                                (unsafe {
                                        (*sqlite3_api).column_value.unwrap()
                                    })(unsafe { (*p_cur).p_column_list }, i - 2)
                            })
                    };
                }
            }
...
extern "C" fn schema_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid_1: *mut sqlite_int64) -> i32 {
    let p_cur: *const schema_cursor =
        cur as *mut schema_cursor as *const schema_cursor;
    unsafe { *p_rowid_1 = unsafe { (*p_cur).rowid } as sqlite_int64 };
    return 0;
}
extern "C" fn finalize(pp_stmt_1: &mut *mut sqlite3_stmt) -> i32 {
    unsafe {
        let rc: i32 =
            unsafe {
                (unsafe { (*sqlite3_api).finalize.unwrap() })(*pp_stmt_1)
            };
        *pp_stmt_1 = core::ptr::null_mut();
        return rc;
    }
}
extern "C" fn schema_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const schema_cursor =
        cur as *mut schema_cursor as *const schema_cursor;
    return if !(unsafe { (*p_cur).p_db_list }).is_null() { 0 } else { 1 };
}
extern "C" fn schema_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let mut p_cur: *mut schema_cursor = core::ptr::null_mut();
        let mut p_vtab: *const schema_vtab = core::ptr::null();
        let mut z_sql: *mut i8 = core::ptr::null_mut();
        let mut p_db_list: *mut sqlite3_stmt = core::ptr::null_mut();
        ...
        loop {
            ...
            '__s2:
                ...
                match __state {
                    0 => { rc = 0; __state = 3; }
                    2 => { return rc; }
                    3 => { p_cur = cur as *mut schema_cursor; __state = 4; }
                    4 => {
                        p_vtab =
                            unsafe { (*cur).p_vtab } as *mut schema_vtab as
                                *const schema_vtab;
                        __state = 5;
                    }
                    5 => { z_sql = core::ptr::null_mut(); __state = 6; }
                    6 => {
                        if (unsafe { (*p_cur).p_column_list }).is_null() as i32 != 0
                                ||
                                100 !=
                                    unsafe {
                                        (unsafe {
                                                (*sqlite3_api).step.unwrap()
                                            })(unsafe { (*p_cur).p_column_list })
                                    } {
                            __state = 8;
                        } else { __state = 7; }
                    ...
                    7 => {
                        {
                            let __p = unsafe { &mut (*p_cur).rowid };
                            let __t = *__p;
                            *__p += 1;
                            __t
                        };
                    ...
                    8 => {
                        if 0 !=
                                {
                                    rc = finalize(unsafe { &mut (*p_cur).p_column_list });
                                    rc
                                } {
                            __state = 10;
                        } else { __state = 9; }
                    ...
                    9 => {
                        if (unsafe { (*p_cur).p_table_list }).is_null() as i32 != 0
                                ||
                                100 !=
                                    unsafe {
                                        (unsafe {
                        ...
                        z_sql =
                            unsafe {
                                (unsafe {
                                    ...
                                    })(c"PRAGMA %Q.table_info(%Q)".as_ptr() as *mut i8 as
                                        *const i8,
                                    unsafe {
                                        (unsafe {
                                                (*sqlite3_api).column_text.unwrap()
                                            })(unsafe { (*p_cur).p_db_list }, 1)
                                    },
                                    unsafe {
                                        (unsafe {
                    ...
                    12 => {
                        if 0 !=
                                { rc = finalize(unsafe { &mut (*p_cur).p_table_list }); rc }
                            {
                            __state = 14;
                        } else { __state = 13; }
                    }
                    13 => {
                        if (unsafe { (*p_cur).p_db_list }).is_null() as i32 as i64
                                != 0 {
                            unsafe {
                                __assert_rtn(c"schemaNext".as_ptr() as *const i8,
                                    c"test_schema.c".as_ptr() as *mut i8 as *const i8, 184,
                                    c"pCur->pDbList".as_ptr() as *mut i8 as *const i8)
                            }
                        } else { { let _ = 0; } };
                        __state = 15;
                    }
                    ...
                    16 => {
                        if unsafe {
                                    (unsafe {
                                            (*sqlite3_api).column_int.unwrap()
                                        })(unsafe { (*p_cur).p_db_list }, 0)
                                } == 1 {
                            __state = 20;
                        } else { __state = 21; }
                    }
                    17 => {
                        rc = finalize(unsafe { &mut (*p_cur).p_db_list });
                        __state = 18;
                    }
                    18 => { __state = 2; }
                    19 => {
                    ...
                    20 => {
                        z_sql =
                            unsafe {
                                (unsafe {
                                        (*sqlite3_api).mprintf.unwrap()
                                    })(c"SELECT name FROM sqlite_temp_schema WHERE type=\'table\'".as_ptr()
                                            as *mut i8 as *const i8)
                            };
                        __state = 19;
                    }
                    21 => {
                        p_db_list = unsafe { (*p_cur).p_db_list };
                        __state = 22;
                    }
                    22 => {
                        z_sql =
                            unsafe {
                                (unsafe {
                                        (*sqlite3_api).mprintf.unwrap()
                                    })(c"SELECT name FROM %Q.sqlite_schema WHERE type=\'table\'".as_ptr()
                                            as *mut i8 as *const i8,
                                    unsafe {
                                        (unsafe {
                                                (*sqlite3_api).column_text.unwrap()
                    ...
                    23 => {
                        rc =
                            unsafe {
                                (unsafe {
                                        (*sqlite3_api).prepare.unwrap()
                                    })(unsafe { (*p_vtab).db }, z_sql as *const i8, -1,
                                    unsafe { &mut (*p_cur).p_table_list },
                                    core::ptr::null_mut())
                            };
                        __state = 26;
                    }
                    ...
                    27 => { if rc != 0 { __state = 28; } else { __state = 9; } }
                    28 => { __state = 2; }
                    29 => {
                        if (z_sql).is_null() as i32 != 0 {
                            __state = 31;
                        ...
                        rc =
                            unsafe {
                                (unsafe {
                                    ...
                                    unsafe { &mut (*p_cur).p_column_list },
                                    core::ptr::null_mut())
                            };
                        __state = 33;
                    }
                    ...
                    34 => { if rc != 0 { __state = 35; } else { __state = 6; } }
                    35 => { __state = 2; }
                    36 => { __state = 2; }
                    _ => {}
                }
...
extern "C" fn schema_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let p_vtab: *const schema_vtab =
            unsafe { (*p_vtab_cursor_1).p_vtab } as *mut schema_vtab as
                *const schema_vtab;
        let p_cur: *mut schema_cursor = p_vtab_cursor_1 as *mut schema_cursor;
        unsafe { (*p_cur).rowid = 0 };
        finalize(unsafe { &mut (*p_cur).p_table_list });
        finalize(unsafe { &mut (*p_cur).p_column_list });
        finalize(unsafe { &mut (*p_cur).p_db_list });
        rc =
            unsafe {
                (unsafe {
                        (*sqlite3_api).prepare.unwrap()
                    ...
                    -1, unsafe { &mut (*p_cur).p_db_list },
                    core::ptr::null_mut())
            };
        return if rc == 0 { schema_next(p_vtab_cursor_1) } else { rc };
    }
}
extern "C" fn schema_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    return 0;
}
static mut schema_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: Some(schema_create),
        x_connect: Some(schema_create),
        x_best_index: Some(schema_best_index),
        x_disconnect: Some(schema_destroy),
        x_destroy: Some(schema_destroy),
        x_open: Some(schema_open),
        x_close: Some(schema_close),
        x_filter: Some(schema_filter),
        x_next: Some(schema_next),
        x_eof: Some(schema_eof),
        x_column: Some(schema_column),
        x_rowid: Some(schema_rowid),
        x_update: None,
        x_begin: None,
        x_sync: None,
        x_commit: None,
    ...
    unsafe {
        ...
        unsafe {
            (unsafe {
                ...
                })(db, c"schema".as_ptr() as *mut i8 as *const i8,
                &raw mut schema_module as *const sqlite3_module,
                core::ptr::null_mut())
        };
        return 0;
    }
