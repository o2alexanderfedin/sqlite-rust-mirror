...
struct sqlite3_recover {
    ...
    laf: RecoverStateLAF,
    db_out: *mut sqlite3,
    p_get_page: *mut sqlite3_stmt,
    p_tbl_list: *mut RecoverTable,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct RecoverStateW1 {
    p_tbls: *mut sqlite3_stmt,
    p_sel: *mut sqlite3_stmt,
    p_insert: *mut sqlite3_stmt,
    n_insert: i32,
    p_tab: *mut RecoverTable,
    n_max: i32,
    ap_val: *mut *mut sqlite3_value,
    n_val: i32,
    b_have_rowid: i32,
    i_rowid: i64,
    i_prev_page: i64,
...
struct RecoverStateLAF {
    ...
    n_pg: i64,
    p_all_and_parent: *mut sqlite3_stmt,
    p_map_insert: *mut sqlite3_stmt,
    p_max_field: *mut sqlite3_stmt,
    p_used_pages: *mut sqlite3_stmt,
    p_find_root: *mut sqlite3_stmt,
    p_insert: *mut sqlite3_stmt,
    p_all_page: *mut sqlite3_stmt,
    p_page_data: *mut sqlite3_stmt,
    ap_val: *mut *mut sqlite3_value,
    n_max_field: i32,
}
#[repr(C)]
...
pub extern "C" fn recover_init(db: *mut sqlite3, mut z_db_1: *const i8,
    ...
    p_sql_ctx_1: *mut ()) -> *mut sqlite3_recover {
    let mut p_ret: *mut sqlite3_recover = core::ptr::null_mut();
    let mut n_db: i32 = 0;
    let mut n_uri: i32 = 0;
    ...
    n_byte =
        (core::mem::size_of::<sqlite3_recover>() as u64 + n_db as u64 +
                        1 as u64 + n_uri as u64 + 1 as u64) as i32;
    p_ret = unsafe { sqlite3_malloc(n_byte) } as *mut sqlite3_recover;
    if !(p_ret).is_null() {
...
pub extern "C" fn sqlite3_recover_init(db: *mut sqlite3, z_db_1: *const i8,
    z_uri_1: *const i8) -> *mut sqlite3_recover {
...
unsafe extern "C" fn recover_m_printf(p: &mut sqlite3_recover,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_recover_config(p: *mut sqlite3_recover, op: i32,
    p_arg_1: *mut ()) -> i32 {
    let mut rc: i32 = 0;
...
unsafe extern "C" fn recover_error(p: &mut sqlite3_recover, err_code_1: i32,
...
extern "C" fn recover_sql_callback(p: *mut sqlite3_recover,
    z_sql_1: *const i8) -> () {
...
extern "C" fn recover_db_error(p: *mut sqlite3_recover, db: *mut sqlite3)
    -> i32 {
    return unsafe {
...
extern "C" fn recover_prepare(p: *mut sqlite3_recover, db: *mut sqlite3,
    z_sql_1: *const i8) -> *mut sqlite3_stmt {
...
unsafe extern "C" fn recover_prepare_printf(p: *mut sqlite3_recover,
...
extern "C" fn recover_finalize(p: *mut sqlite3_recover,
    p_stmt_1: *mut sqlite3_stmt) -> () {
...
extern "C" fn recover_page_count(p: *mut sqlite3_recover) -> i64 {
...
extern "C" fn recover_reset(p: *mut sqlite3_recover,
...
extern "C" fn recover_get_page(p_ctx_1: *mut sqlite3_context, n_arg_1: i32,
    ap_arg_1: *mut *mut sqlite3_value) -> () {
    let p: *mut sqlite3_recover =
        unsafe { sqlite3_user_data(p_ctx_1) } as *mut sqlite3_recover;
    let pgno: i64 =
        unsafe {
...
extern "C" fn recover_page_is_used(p_ctx_1: *mut sqlite3_context,
    n_arg_1: i32, ap_arg_1: *mut *mut sqlite3_value) -> () {
    let p: *const sqlite3_recover =
        unsafe { sqlite3_user_data(p_ctx_1) } as *mut sqlite3_recover as
            *const sqlite3_recover;
    let pgno: i64 =
        unsafe {
            sqlite3_value_int64(unsafe { *ap_arg_1.offset(0 as isize) })
        };
...
extern "C" fn recover_read_i32(context: *mut sqlite3_context, argc: i32,
...
extern "C" fn recover_escape_crlf(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_text: *const i8 =
...
extern "C" fn recover_open_output(p: *mut sqlite3_recover) -> i32 {
    let a_func: [Func_N4Func; 4] =
        [Func_N4Func {
    ...
    }
    {
        ...
        '__b4: loop {
            if !(unsafe { (*p).err_code } == 0 &&
                            ii <
                                (core::mem::size_of::<[Func_N4Func; 4]>() as u64 /
                                        core::mem::size_of::<Func_N4Func>() as u64) as i32) {
                break '__b4;
            }
            '__c4: loop {
                unsafe {
...
extern "C" fn recover_vfs_close(p_fd: *mut sqlite3_file) -> i32 {
    unsafe {
        if !(unsafe { (*p_fd).p_methods } !=
                                &raw mut recover_methods as *const sqlite3_io_methods) as
                        i32 as i64 != 0 {
            unsafe {
...
extern "C" fn recover_get_varint(a: *const u8, p_val_1: &mut i64) -> i32 {
    ...
    u =
        (u << 8) +
            (unsafe { *a.offset(i as isize) } as i32 & 255) as sqlite3_uint64;
    *p_val_1 = u as sqlite3_int64;
    return 9;
}
...
extern "C" fn recover_vfs_detect_pagesize(p: &mut sqlite3_recover,
    p_fd_1: *mut sqlite3_file, mut n_reserve_1: u32, n_sz_1: i64) -> i32 {
    let mut rc: i32 = 0;
...
extern "C" fn recover_malloc(p: &mut sqlite3_recover, n_byte_1: i64)
    -> *mut () {
...
extern "C" fn recover_vfs_read(p_fd: *mut sqlite3_file, a_buf: *mut (),
    n_byte: i32, i_off: sqlite3_int64) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
                &raw mut recover_methods as *const sqlite3_io_methods {
...
extern "C" fn recover_vfs_write(p_fd: *mut sqlite3_file, a_buf: *const (),
    n_byte: i32, i_off: sqlite3_int64) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
...
extern "C" fn recover_vfs_truncate(p_fd: *mut sqlite3_file,
...
extern "C" fn recover_vfs_sync(p_fd: *mut sqlite3_file, flags: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
                &raw mut recover_methods as *const sqlite3_io_methods {
...
extern "C" fn recover_vfs_file_size(p_fd: *mut sqlite3_file,
...
extern "C" fn recover_vfs_lock(p_fd: *mut sqlite3_file, e_lock: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
                &raw mut recover_methods as *const sqlite3_io_methods {
...
extern "C" fn recover_vfs_unlock(p_fd: *mut sqlite3_file, e_lock: i32)
    -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
...
extern "C" fn recover_vfs_check_reserved_lock(p_fd: *mut sqlite3_file,
...
extern "C" fn recover_vfs_file_control(p_fd: *mut sqlite3_file, op: i32,
    p_arg: *mut ()) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
...
extern "C" fn recover_vfs_sector_size(p_fd: *mut sqlite3_file) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
                &raw mut recover_methods as *const sqlite3_io_methods {
...
extern "C" fn recover_vfs_device_characteristics(p_fd: *mut sqlite3_file)
    -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
...
extern "C" fn recover_vfs_shm_map(p_fd: *mut sqlite3_file, i_pg: i32,
...
extern "C" fn recover_vfs_shm_lock(p_fd: *mut sqlite3_file, offset: i32,
    n: i32, flags: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
...
extern "C" fn recover_vfs_shm_barrier(p_fd: *mut sqlite3_file) -> () {
    unsafe {
        if unsafe { (*p_fd).p_methods } ==
                &raw mut recover_methods as *const sqlite3_io_methods {
            unsafe { (*p_fd).p_methods = recover_g.p_methods };
...
extern "C" fn recover_vfs_shm_unmap(p_fd: *mut sqlite3_file, delete_flag: i32)
    -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        if unsafe { (*p_fd).p_methods } ==
...
extern "C" fn recover_vfs_fetch(p_fd: *mut sqlite3_file, i_off: sqlite3_int64,
...
extern "C" fn recover_vfs_unfetch(p_fd: *mut sqlite3_file,
    i_off: sqlite3_int64, p: *mut ()) -> i32 {
    { let _ = p_fd; };
    { let _ = i_off; };
    { let _ = p; };
    return 0;
}
static mut recover_methods: sqlite3_io_methods =
    sqlite3_io_methods {
        i_version: 2,
...
extern "C" fn recover_install_wrapper(p: *mut sqlite3_recover) -> () {
    unsafe {
        let mut p_fd: *mut sqlite3_file = core::ptr::null_mut();
...
extern "C" fn recover_exec(p: *mut sqlite3_recover, db: *mut sqlite3,
...
extern "C" fn recover_transfer_settings(p: *mut sqlite3_recover) -> () {
    ...
    if unsafe { (*p).err_code } == 0 {
        ...
        if rc != 0 { recover_db_error(p, db2); return; }
        {
            ...
            '__b16: loop {
                ...
                '__c16: loop {
                    ...
                    let mut p1: *mut sqlite3_stmt = core::ptr::null_mut();
                    p1 =
                        unsafe {
                            recover_prepare_printf(p, unsafe { (*p).db_in },
        ...
        if unsafe { (*p).err_code } == 0 {
            ...
            let p_backup: *mut sqlite3_backup =
                unsafe {
...
extern "C" fn recover_open_recovery(p: *mut sqlite3_recover) -> () {
    let z_sql: *mut i8 =
        unsafe {
            recover_m_printf(unsafe { &mut *p },
...
extern "C" fn recover_cache_schema(p: *mut sqlite3_recover) -> i32 {
...
extern "C" fn recover_uninstall_wrapper(p: &sqlite3_recover) -> () {
    unsafe {
        let mut p_fd: *mut sqlite3_file = core::ptr::null_mut();
        unsafe {
...
extern "C" fn recover_add_table(p: *mut sqlite3_recover, z_name_1: *const i8,
    i_root_1: i64) -> () {
    let mut p_stmt: *mut sqlite3_stmt =
        unsafe {
...
extern "C" fn recover_write_schema1(p: *mut sqlite3_recover) -> i32 {
    let mut p_select: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut p_tblname: *mut sqlite3_stmt = core::ptr::null_mut();
    p_select =
...
extern "C" fn recover_write_data_init(p: *mut sqlite3_recover) -> i32 {
...
extern "C" fn recover_find_table(p: &sqlite3_recover, i_root_1: u32)
    -> *mut RecoverTable {
...
extern "C" fn recover_insert_stmt(p: *mut sqlite3_recover,
    p_tab_1: &RecoverTable, n_field_1: i32) -> *mut sqlite3_stmt {
...
extern "C" fn recover_bind_value(p: *mut sqlite3_recover,
    p_stmt_1: *mut sqlite3_stmt, i_bind_1: i32, p_val_1: *const sqlite3_value)
    -> () {
    if unsafe { (*p).err_code } == 0 {
        let rc: i32 =
            unsafe {
                sqlite3_bind_value(p_stmt_1, i_bind_1,
                    p_val_1 as *const sqlite3_value)
            };
        if rc != 0 {
            unsafe {
...
extern "C" fn recover_write_data_step(p: *mut sqlite3_recover) -> i32 {
    let p1: *mut RecoverStateW1 = unsafe { &mut (*p).w1 };
    let p_sel: *mut sqlite3_stmt = unsafe { (*p1).p_sel };
    let ap_val: *mut *mut sqlite3_value = unsafe { (*p1).ap_val };
    if unsafe { (*p).err_code } == 0 &&
    ...
    if unsafe { (*p).err_code } == 0 && unsafe { sqlite3_step(p_sel) } == 100
        ...
        let p_val: *const sqlite3_value =
            unsafe { sqlite3_column_value(p_sel, 3) } as *const sqlite3_value;
        let b_new_cell: i32 =
        ...
        if b_new_cell != 0 {
            ...
            if unsafe { (*p1).n_val } >= 0 {
                ...
                if unsafe { (*p1).n_val } > 0 {
                    let p_insert: *mut sqlite3_stmt = unsafe { (*p1).p_insert };
                    {
                        ii = 0;
                        '__b24: loop {
            ...
            if i_field < 0 {
                ...
                unsafe {
                    *ap_val.offset(i_field as isize) =
                        unsafe { sqlite3_value_dup(p_val as *const sqlite3_value) }
                };
                if unsafe { *ap_val.offset(i_field as isize) } ==
                        core::ptr::null_mut() {
                    unsafe {
...
extern "C" fn recover_write_data_cleanup(p: *mut sqlite3_recover) -> () {
    let p1: *mut RecoverStateW1 = unsafe { &mut (*p).w1 };
    let mut ii: i32 = 0;
    {
        ii = 0;
...
extern "C" fn recover_bitmap_alloc(p: *mut sqlite3_recover, n_pg_1: i64)
    -> *mut RecoverBitmap {
...
extern "C" fn recover_lost_and_found1_init(p: *mut sqlite3_recover) -> () {
...
extern "C" fn recover_lost_and_found1_step(p: *mut sqlite3_recover) -> i32 {
    let p_laf: *mut RecoverStateLAF = unsafe { &mut (*p).laf };
...
extern "C" fn recover_lost_and_found2_init(p: *mut sqlite3_recover) -> () {
    let p_laf: *mut RecoverStateLAF = unsafe { &mut (*p).laf };
...
extern "C" fn recover_lost_and_found2_step(p: *mut sqlite3_recover) -> i32 {
    let p_laf: *mut RecoverStateLAF = unsafe { &mut (*p).laf };
    if unsafe { (*p).err_code } == 0 {
        let res: i32 =
...
extern "C" fn recover_lost_and_found_create(p: *mut sqlite3_recover,
    n_field_1: i32) -> *mut i8 {
    let mut z_tbl: *mut i8 = core::ptr::null_mut();
    let mut p_probe: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut ii: i32 = 0;
    p_probe =
        recover_prepare(p, unsafe { (*p).db_out },
...
extern "C" fn recover_lost_and_found_insert(p: *mut sqlite3_recover,
    z_tab_1: *const i8, n_field_1: i32) -> *mut sqlite3_stmt {
...
extern "C" fn recover_lost_and_found3_init(p: *mut sqlite3_recover) -> () {
    let p_laf: *mut RecoverStateLAF = unsafe { &mut (*p).laf };
            ...
            (*p_laf).ap_val =
                recover_malloc(unsafe { &mut *p },
                        (unsafe { (*p_laf).n_max_field } as u64 *
                                core::mem::size_of::<*mut sqlite3_value>() as u64) as i64)
                    as *mut *mut sqlite3_value
        };
    }
}
extern "C" fn recover_lost_and_found_find_root(p: *mut sqlite3_recover,
...
extern "C" fn recover_lost_and_found_one_page(p: *mut sqlite3_recover,
    i_page_1: i64) -> () {
    let p_laf: *const RecoverStateLAF =
        unsafe { &raw mut (*p).laf } as *const RecoverStateLAF;
    let ap_val: *mut *mut sqlite3_value = unsafe { (*p_laf).ap_val };
    let p_page_data: *mut sqlite3_stmt = unsafe { (*p_laf).p_page_data };
    let p_insert: *mut sqlite3_stmt = unsafe { (*p_laf).p_insert };
    let mut n_val: i32 = -1;
...
extern "C" fn recover_lost_and_found3_step(p: *mut sqlite3_recover) -> i32 {
    let p_laf: *const RecoverStateLAF =
        unsafe { &raw mut (*p).laf } as *const RecoverStateLAF;
    if unsafe { (*p).err_code } == 0 {
...
extern "C" fn recover_write_schema2(p: *mut sqlite3_recover) -> i32 {
    let mut p_select: *mut sqlite3_stmt = core::ptr::null_mut();
    p_select =
        recover_prepare(p, unsafe { (*p).db_out },
...
extern "C" fn recover_lost_and_found_cleanup(p: &mut sqlite3_recover) -> () {
...
extern "C" fn recover_final_cleanup(p: *mut sqlite3_recover) -> () {
...
extern "C" fn recover_step(p: *mut sqlite3_recover) -> () {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_recover_step(p: *mut sqlite3_recover) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_recover_errcode(p: *const sqlite3_recover) -> i32 {
    return if !(p).is_null() { unsafe { (*p).err_code } } else { 7 };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_recover_run(p: *mut sqlite3_recover) -> i32 {
    while 0 == sqlite3_recover_step(p) {}
    return sqlite3_recover_errcode(p as *const sqlite3_recover);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_recover_errmsg(p: *const sqlite3_recover)
    -> *const i8 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_recover_finish(p: *mut sqlite3_recover) -> i32 {
    let mut rc: i32 = 0;
    if p == core::ptr::null_mut() {
        rc = 7;
    } else {
