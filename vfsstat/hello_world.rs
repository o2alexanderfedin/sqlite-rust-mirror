...
extern "C" fn vstat_close(p_file: *mut sqlite3_file) -> i32 {
...
extern "C" fn vstat_read(p_file: *mut sqlite3_file, z_buf: *mut (),
    ...
    unsafe {
        ...
        if rc == 0 {
            a_vfs_cnt[(unsafe { (*p).e_filetype } as i32 * 7 + 0) as usize] +=
                i_amt as sqlite3_uint64;
        }
        return rc;
    }
}
extern "C" fn vstat_write(p_file: *mut sqlite3_file, z: *const (), i_amt: i32,
...
extern "C" fn vstat_truncate(p_file: *mut sqlite3_file, size: sqlite3_int64)
    -> i32 {
    let mut rc: i32 = 0;
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    rc =
...
extern "C" fn vstat_sync(p_file: *mut sqlite3_file, flags: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let p: *const VStatFile =
            p_file as *mut VStatFile as *const VStatFile;
...
extern "C" fn vstat_file_size(p_file: *mut sqlite3_file,
...
extern "C" fn vstat_lock(p_file: *mut sqlite3_file, e_lock: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let p: *const VStatFile =
            p_file as *mut VStatFile as *const VStatFile;
...
extern "C" fn vstat_unlock(p_file: *mut sqlite3_file, e_lock: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let p: *const VStatFile =
            p_file as *mut VStatFile as *const VStatFile;
...
extern "C" fn vstat_check_reserved_lock(p_file: *mut sqlite3_file,
...
extern "C" fn vstat_file_control(p_file: *mut sqlite3_file, op: i32,
    p_arg: *mut ()) -> i32 {
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    let mut rc: i32 = 0;
    rc =
...
extern "C" fn vstat_sector_size(p_file: *mut sqlite3_file) -> i32 {
    let mut rc: i32 = 0;
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    rc =
        unsafe {
...
extern "C" fn vstat_device_characteristics(p_file: *mut sqlite3_file) -> i32 {
    let mut rc: i32 = 0;
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    rc =
        unsafe {
...
extern "C" fn vstat_shm_map(p_file: *mut sqlite3_file, i_pg: i32, pgsz: i32,
...
extern "C" fn vstat_shm_lock(p_file: *mut sqlite3_file, offset: i32, n: i32,
    flags: i32) -> i32 {
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    return unsafe {
            (unsafe {
...
extern "C" fn vstat_shm_barrier(p_file: *mut sqlite3_file) -> () {
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    unsafe {
        (unsafe {
                (*unsafe {
...
extern "C" fn vstat_shm_unmap(p_file: *mut sqlite3_file, delete_flag: i32)
    -> i32 {
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    return unsafe {
            (unsafe {
...
extern "C" fn vstat_fetch(p_file: *mut sqlite3_file, i_ofst: sqlite3_int64,
...
extern "C" fn vstat_unfetch(p_file: *mut sqlite3_file, i_ofst: sqlite3_int64,
    p_page: *mut ()) -> i32 {
    let p: *const VStatFile = p_file as *mut VStatFile as *const VStatFile;
    return unsafe {
            (unsafe {
...
static vstat_io_methods: sqlite3_io_methods =
    sqlite3_io_methods {
        i_version: 3,
...
extern "C" fn vstat_open(p_vfs: *mut sqlite3_vfs, z_name: *const i8,
...
extern "C" fn vstat_delete(p_vfs: *mut sqlite3_vfs, z_path: *const i8,
    dir_sync: i32) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        rc =
...
extern "C" fn vstat_access(p_vfs: *mut sqlite3_vfs, z_path: *const i8,
...
extern "C" fn vstat_full_pathname(p_vfs: *mut sqlite3_vfs, z_path: *const i8,
...
extern "C" fn vstat_dl_open(p_vfs: *mut sqlite3_vfs, z_path: *const i8)
    -> *mut () {
    return unsafe {
            (unsafe {
                    (*unsafe {
...
extern "C" fn vstat_dl_error(p_vfs: *mut sqlite3_vfs, n_byte: i32,
    z_err_msg: *mut i8) -> () {
    unsafe {
        (unsafe {
                (*unsafe {
...
extern "C" fn vstat_dl_sym(p_vfs: *mut sqlite3_vfs, p: *mut (),
...
extern "C" fn vstat_dl_close(p_vfs: *mut sqlite3_vfs, p_handle: *mut ())
    -> () {
    unsafe {
        (unsafe {
                (*unsafe {
...
extern "C" fn vstat_randomness(p_vfs: *mut sqlite3_vfs, n_byte: i32,
...
extern "C" fn vstat_sleep(p_vfs: *mut sqlite3_vfs, n_micro: i32) -> i32 {
    unsafe {
        {
...
extern "C" fn vstat_current_time(p_vfs: *mut sqlite3_vfs,
...
extern "C" fn vstat_get_last_error(p_vfs: *mut sqlite3_vfs, a: i32,
    b: *mut i8) -> i32 {
    return unsafe {
            (unsafe {
                    (*unsafe {
...
extern "C" fn vstat_current_time_int64(p_vfs: *mut sqlite3_vfs,
...
extern "C" fn vstattab_best_index(tab: *mut sqlite3_vtab,
    p_idx_info: *mut sqlite3_index_info) -> i32 {
    return 0;
}
extern "C" fn vstattab_disconnect(p_vtab: *mut sqlite3_vtab) -> i32 {
...
extern "C" fn vstattab_open(p: *mut sqlite3_vtab,
...
extern "C" fn vstattab_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    unsafe { sqlite3_free(cur as *mut ()) };
    return 0;
}
extern "C" fn vstattab_filter(p_vtab_cursor: *mut sqlite3_vtab_cursor,
...
extern "C" fn vstattab_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    {
...
extern "C" fn vstattab_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const VfsStatCursor =
        cur as *mut VfsStatCursor as *const VfsStatCursor;
    return (unsafe { (*p_cur).i } >= 7 * 9) as i32;
}
extern "C" fn vstattab_column(cur: *mut sqlite3_vtab_cursor,
                    ...
                    }
                    {
                        unsafe {
                            sqlite3_result_int64(ctx,
                                a_vfs_cnt[unsafe { (*p_cur).i } as usize] as sqlite3_int64)
                        };
                        break '__s0;
                    }
                }
...
extern "C" fn vstattab_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid: *mut sqlite3_int64) -> i32 {
    let p_cur: *const VfsStatCursor =
        cur as *mut VfsStatCursor as *const VfsStatCursor;
    unsafe { *p_rowid = unsafe { (*p_cur).i } as sqlite_int64 };
    return 0;
}
extern "C" fn vstattab_update(tab: *mut sqlite3_vtab, argc: i32,
    argv: *mut *mut sqlite3_value, p_rowid: *mut sqlite3_int64) -> i32 {
    unsafe {
        let mut i_rowid: sqlite3_int64 = 0 as sqlite3_int64;
        ...
        a_vfs_cnt[i_rowid as usize] = x as sqlite3_uint64;
        return 0;
    }
}
static mut vfs_stat_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: None,
    ...
    unsafe {
        return unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut vfs_stat_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
    }
}
