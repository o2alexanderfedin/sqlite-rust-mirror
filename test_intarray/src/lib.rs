...
extern "C" fn intarray_create(db: *mut Sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut rc: i32 = 7;
    let p_vtab: *mut IntarrayVtab =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<IntarrayVtab>() as
                        Sqlite3Uint64)
            } as *mut IntarrayVtab;
    if !(p_vtab).is_null() {
        unsafe {
            memset(p_vtab as *mut (), 0,
                core::mem::size_of::<IntarrayVtab>() as u64)
        };
        unsafe { (*p_vtab).p_content = p_aux_1 as *mut Sqlite3Intarray };
        rc =
            unsafe {
...
extern "C" fn intarray_open(p_v_tab_1: *mut Sqlite3Vtab,
    ...
    let mut rc: i32 = 7;
    let mut p_cur: *mut IntarrayCursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<IntarrayCursor>() as
                        Sqlite3Uint64)
            } as *mut IntarrayCursor;
    if !(p_cur).is_null() {
        unsafe {
            memset(p_cur as *mut (), 0,
                core::mem::size_of::<IntarrayCursor>() as u64)
        };
...
extern "C" fn intarray_filter(p_vtab_cursor_1: *mut Sqlite3VtabCursor,
    ...
    let p_cur: *mut IntarrayCursor = p_vtab_cursor_1 as *mut IntarrayCursor;
    unsafe { (*p_cur).i = 0 };
    return 0;
}
...
extern "C" fn intarray_eof(cur: *mut Sqlite3VtabCursor) -> i32 {
    ...
    let p_vtab: *const IntarrayVtab =
        unsafe { (*cur).p_vtab } as *mut IntarrayVtab as *const IntarrayVtab;
...
pub extern "C" fn sqlite3_intarray_create(db: *mut Sqlite3, z_name: *const i8,
    ...
    unsafe {
        let mut rc: i32 = 0;
        let mut p: *mut Sqlite3Intarray = core::ptr::null_mut();
        *pp_return =
            {
                p =
                    unsafe {
                            sqlite3_malloc64(core::mem::size_of::<Sqlite3Intarray>() as
                                    Sqlite3Uint64)
                        } as *mut Sqlite3Intarray;
                p
            };
        if p == core::ptr::null_mut() { return 7; }
        unsafe {
            memset(p as *mut (), 0,
                core::mem::size_of::<Sqlite3Intarray>() as u64)
        };
        rc =
            unsafe {
                sqlite3_create_module_v2(db, z_name,
                    &raw mut intarray_module as *const Sqlite3Module,
                    p as *mut (),
                    Some(unsafe {
