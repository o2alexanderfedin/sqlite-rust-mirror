...
static mut a_limit: [anon_s0; 12] =
    [anon_s0 { e_code: 0, z_name: c"SQLITE_MAX_LENGTH".as_ptr() as *mut i8 },
            anon_s0 {
                e_code: 1,
                z_name: c"SQLITE_MAX_SQL_LENGTH".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 2,
                z_name: c"SQLITE_MAX_COLUMN".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 3,
                z_name: c"SQLITE_MAX_EXPR_DEPTH".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 4,
                z_name: c"SQLITE_MAX_COMPOUND_SELECT".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 5,
                z_name: c"SQLITE_MAX_VDBE_OP".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 6,
                z_name: c"SQLITE_MAX_FUNCTION_ARG".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 7,
                z_name: c"SQLITE_MAX_ATTACHED".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 8,
                z_name: c"SQLITE_MAX_LIKE_PATTERN_LENGTH".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 9,
                z_name: c"SQLITE_MAX_VARIABLE_NUMBER".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 10,
                z_name: c"SQLITE_MAX_TRIGGER_DEPTH".as_ptr() as *mut i8,
            },
            anon_s0 {
                e_code: 11,
        ...
        if rc == 0 {
            {
                ...
                '__b0: loop {
                    if !((j as u64) <
                                    core::mem::size_of::<[anon_s0; 12]>() as u64 / 16) {
                        break '__b0;
                    }
                    '__c0: loop {
                        unsafe {
                            printf(c"%-35s %10d\n".as_ptr() as *mut i8 as *const i8,
                                a_limit[j as usize].z_name,
                                max_limit(db, a_limit[j as usize].e_code))
                        };
                        break '__c0;
                    }
