...
extern "C" fn fsdir_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut p_tab: *mut FsdirVtab = core::ptr::null_mut();
    if argc != 3 {
        unsafe {
            *pz_err_1 =
                unsafe {
                    sqlite3_mprintf(c"wrong number of arguments".as_ptr() as
                                *mut i8 as *const i8)
                }
        };
        return 1;
    ...
    p_tab =
        unsafe { sqlite3_malloc(core::mem::size_of::<FsdirVtab>() as i32) } as
            *mut FsdirVtab;
    if (p_tab).is_null() as i32 != 0 { return 7; }
    unsafe {
        memset(p_tab as *mut (), 0, core::mem::size_of::<FsdirVtab>() as u64)
    };
    unsafe { *pp_vtab_1 = unsafe { &mut (*p_tab).base } };
    unsafe {
        sqlite3_declare_vtab(db,
            c"CREATE TABLE xyz(dir, name);".as_ptr() as *mut i8 as *const i8)
    };
    return 0;
}
...
extern "C" fn fsdir_open(p_v_tab_1: *mut sqlite3_vtab,
...
extern "C" fn fsdir_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    ...
    if !(unsafe { (*p_cur).p_dir }).is_null() {
        unsafe { closedir(unsafe { (*p_cur).p_dir }) };
    }
    unsafe { sqlite3_free(unsafe { (*p_cur).z_dir } as *mut ()) };
...
extern "C" fn fsdir_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    ...
    if !(unsafe { (*p_csr).p_dir }).is_null() {
        unsafe {
            (*p_csr).p_entry = unsafe { readdir(unsafe { (*p_csr).p_dir }) }
        };
        if unsafe { (*p_csr).p_entry } == core::ptr::null_mut() {
            unsafe { closedir(unsafe { (*p_csr).p_dir }) };
            unsafe { (*p_csr).p_dir = core::ptr::null_mut() };
        }
        {
...
extern "C" fn fsdir_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_csr: *mut FsdirCsr = p_vtab_cursor_1 as *mut FsdirCsr;
    let mut z_dir: *const i8 = core::ptr::null();
    let mut n_dir: i32 = 0;
    if idx_num_1 != 1 || argc != 1 { return 1; }
    unsafe { (*p_csr).i_rowid = 0 as sqlite3_int64 };
    unsafe { sqlite3_free(unsafe { (*p_csr).z_dir } as *mut ()) };
    if !(unsafe { (*p_csr).p_dir }).is_null() {
        unsafe { closedir(unsafe { (*p_csr).p_dir }) };
        unsafe { (*p_csr).p_dir = core::ptr::null_mut() };
    }
    ...
    unsafe {
        (*p_csr).z_dir = unsafe { sqlite3_malloc(n_dir + 1) } as *mut i8
    };
    if unsafe { (*p_csr).z_dir } == core::ptr::null_mut() { return 7; }
    unsafe {
        memcpy(unsafe { (*p_csr).z_dir } as *mut (), z_dir as *const (),
            (n_dir + 1) as u64)
    };
    unsafe {
        (*p_csr).p_dir =
            unsafe { opendir(unsafe { (*p_csr).z_dir } as *const i8) }
    };
            ...
            0 => {
                unsafe {
                    sqlite3_result_text(ctx,
                        unsafe { (*p_csr).z_dir } as *const i8, -1, None)
                };
            }
            1 => {
                unsafe {
                    sqlite3_result_text(ctx,
                        unsafe {
                                    &raw mut (*unsafe { (*p_csr).p_entry }).d_name[0 as usize]
...
extern "C" fn fstree_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    argv: *const *const i8, pp_vtab_1: *mut *mut sqlite3_vtab,
    pz_err_1: *mut *mut i8) -> i32 {
    let mut p_tab: *mut FstreeVtab = core::ptr::null_mut();
    if argc != 3 {
        unsafe {
            *pz_err_1 =
                unsafe {
    ...
    p_tab =
        unsafe { sqlite3_malloc(core::mem::size_of::<FstreeVtab>() as i32) }
            as *mut FstreeVtab;
    if (p_tab).is_null() as i32 != 0 { return 7; }
    unsafe {
        memset(p_tab as *mut (), 0, core::mem::size_of::<FstreeVtab>() as u64)
    };
    unsafe { (*p_tab).db = db };
    unsafe { *pp_vtab_1 = unsafe { &mut (*p_tab).base } };
    unsafe {
        sqlite3_declare_vtab(db,
            c"CREATE TABLE xyz(path, size, data);".as_ptr() as *mut i8 as
                *const i8)
    };
    return 0;
}
extern "C" fn fstree_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe { sqlite3_free(p_vtab_1 as *mut ()) };
    return 0;
}
extern "C" fn fstree_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    let mut ii: i32 = 0;
    {
        ii = 0;
        '__b2: loop {
            ...
            '__c2: loop {
                ...
                if unsafe { (*p).i_column } as i32 == 0 &&
                            unsafe { (*p).usable } != 0 &&
                        (unsafe { (*p).op } as i32 == 66 ||
                                unsafe { (*p).op } as i32 == 65 ||
                            unsafe { (*p).op } as i32 == 2) {
                    let mut p_usage: *mut sqlite3_index_constraint_usage =
                        core::ptr::null_mut();
                    p_usage =
                    ...
                    unsafe {
                        (*p_idx_info_1).idx_num = unsafe { (*p).op } as i32
                    };
                    unsafe { (*p_usage).argv_index = 1 };
...
extern "C" fn fstree_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut FstreeCsr = core::ptr::null_mut();
    p_cur =
        unsafe { sqlite3_malloc(core::mem::size_of::<FstreeCsr>() as i32) } as
            *mut FstreeCsr;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0, core::mem::size_of::<FstreeCsr>() as u64)
    };
    unsafe { (*p_cur).fd = -1 };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
...
extern "C" fn fstree_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_csr: *mut FstreeCsr = cur as *mut FstreeCsr;
    unsafe { sqlite3_finalize(unsafe { (*p_csr).p_stmt }) };
    fstree_close_fd(unsafe { &mut *p_csr });
    unsafe { sqlite3_free(p_csr as *mut ()) };
    return 0;
}
extern "C" fn fstree_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_csr: *mut FstreeCsr = cur as *mut FstreeCsr;
    let mut rc: i32 = 0;
    fstree_close_fd(unsafe { &mut *p_csr });
    rc = unsafe { sqlite3_step(unsafe { (*p_csr).p_stmt }) };
    if rc != 100 {
        rc = unsafe { sqlite3_finalize(unsafe { (*p_csr).p_stmt }) };
        ...
        unsafe {
            (*p_csr).fd =
                unsafe {
                    open(unsafe {
                                sqlite3_column_text(unsafe { (*p_csr).p_stmt }, 0)
                            } as *const i8, 0)
                }
        };
    }
...
extern "C" fn fstree_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    unsafe {
        let p_csr: *mut FstreeCsr = p_vtab_cursor_1 as *mut FstreeCsr;
        let p_tab: *const FstreeVtab =
            unsafe { (*p_csr).base.p_vtab } as *mut FstreeVtab as
                *const FstreeVtab;
        let mut rc: i32 = 0;
        let z_sql: *const i8 =
            c"WITH r(d) AS (  SELECT CASE WHEN dir=?2 THEN ?3 ELSE dir END || \'/\' || name     FROM fsdir WHERE dir=?1 AND name NOT LIKE \'.%\'  UNION ALL  SELECT dir || \'/\' || name FROM r, fsdir WHERE dir=d AND name NOT LIKE \'.%\') SELECT d FROM r;".as_ptr()
        ...
        let mut n_dir: i32 = 0;
        let mut a_wild: [i8; 2] =
            ['\u{0}' as i32 as i8, '\u{0}' as i32 as i8];
        z_root = c"/".as_ptr() as *mut i8;
        n_root = 1;
        z_prefix = c"".as_ptr() as *mut i8;
        n_prefix = 0;
        z_dir = z_root as *const i8;
        n_dir = n_root;
        fstree_close_fd(unsafe { &mut *p_csr });
        unsafe { sqlite3_finalize(unsafe { (*p_csr).p_stmt }) };
        unsafe { (*p_csr).p_stmt = core::ptr::null_mut() };
        rc =
            unsafe {
                sqlite3_prepare_v2(unsafe { (*p_tab).db }, z_sql, -1,
        ...
        if idx_num_1 != 0 {
            ...
            '__s3:
                ...
                match idx_num_1 {
                    66 => {
                        a_wild[0 as usize] = '*' as i32 as i8;
                        a_wild[1 as usize] = '?' as i32 as i8;
                    }
                    65 => {
                        a_wild[0 as usize] = '_' as i32 as i8;
                        a_wild[1 as usize] = '%' as i32 as i8;
                    }
                    _ => {}
                }
            ...
            if unsafe {
                        sqlite3_strnicmp(z_query, z_prefix as *const i8, n_prefix)
                    } == 0 {
                let mut i: i32 = 0;
                {
                    i = n_prefix;
                    '__b4: loop {
                        if !(unsafe { *z_query.offset(i as isize) } != 0) {
                            break '__b4;
                        }
                        '__c4: loop {
                            if unsafe { *z_query.offset(i as isize) } as i32 ==
                                        a_wild[0 as usize] as i32 ||
                                    unsafe { *z_query.offset(i as isize) } as i32 ==
                                        a_wild[1 as usize] as i32 {
                                break '__b4;
                            }
                            if unsafe { *z_query.offset(i as isize) } as i32 ==
                                    '/' as i32 {
        ...
        if n_dir == 0 { n_dir = 1; }
        unsafe {
            sqlite3_bind_text(unsafe { (*p_csr).p_stmt }, 1, z_dir, n_dir,
                Some(unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn(*mut ())
                                    -> ()>(-1 as isize as *const ())
        ...
        unsafe {
            sqlite3_bind_text(unsafe { (*p_csr).p_stmt }, 2,
                z_root as *const i8, n_root,
                Some(unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn(*mut ())
                                    -> ()>(-1 as isize as *const ())
        ...
        unsafe {
            sqlite3_bind_text(unsafe { (*p_csr).p_stmt }, 3,
                z_prefix as *const i8, n_prefix,
                Some(unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn(*mut ())
                                    -> ()>(-1 as isize as *const ())
    ...
    if i == 0 {
        unsafe {
            sqlite3_result_value(ctx,
                unsafe {
                    sqlite3_column_value(unsafe { (*p_csr).p_stmt }, 0)
                })
        };
    } else {
        let mut s_buf: stat = unsafe { core::mem::zeroed() };
        unsafe { fstat(unsafe { (*p_csr).fd }, &mut s_buf) };
        if s_buf.st_mode as i32 & 61440 == 32768 {
            if i == 1 {
                unsafe { sqlite3_result_int64(ctx, s_buf.st_size) };
            } else {
                let mut n_read: i32 = 0;
                let a_buf: *mut i8 =
                    unsafe { sqlite3_malloc(s_buf.st_mode as i32 + 1) } as
                        *mut i8;
                if (a_buf).is_null() as i32 != 0 { return 7; }
                n_read =
                    unsafe {
                            read(unsafe { (*p_csr).fd }, a_buf as *mut (),
                                s_buf.st_mode as u64)
                        } as i32;
                if n_read != s_buf.st_mode as i32 { return 10; }
                unsafe {
                    sqlite3_result_blob(ctx, a_buf as *const (), n_read,
                        Some(unsafe {
                                core::mem::transmute::<*const (),
                                        unsafe extern "C" fn(*mut ())
                                            -> ()>(-1 as isize as *const ())
...
extern "C" fn fstree_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid_1: *mut sqlite_int64) -> i32 {
...
extern "C" fn fs_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    argv: *const *const i8, pp_vtab_1: *mut *mut sqlite3_vtab,
    pz_err_1: *mut *mut i8) -> i32 {
    let mut p_vtab: *mut fs_vtab = core::ptr::null_mut();
    let mut n_byte: i32 = 0;
    let mut z_tbl: *const i8 = core::ptr::null();
    ...
    z_tbl = unsafe { *argv.offset(3 as isize) };
    n_byte =
        (core::mem::size_of::<fs_vtab>() as u64 +
                            unsafe { strlen(z_tbl) } as i32 as u64 + 1 as u64 +
                    unsafe { strlen(z_db) } as i32 as u64 + 1 as u64) as i32;
    p_vtab = unsafe { sqlite3_malloc_zero(n_byte as u64) } as *mut fs_vtab;
    if (p_vtab).is_null() as i32 != 0 { return 7; }
    unsafe {
        (*p_vtab).z_tbl =
            unsafe { &raw mut *p_vtab.offset(1 as isize) } as *mut i8
    };
    unsafe {
        (*p_vtab).z_db =
            unsafe {
                unsafe {
                    (*p_vtab).z_tbl.add((unsafe { strlen(z_tbl) } + 1 as u64) as
                            usize)
                }
            }
    };
    unsafe { (*p_vtab).db = db };
    unsafe {
        memcpy(unsafe { (*p_vtab).z_tbl } as *mut (), z_tbl as *const (),
            unsafe { strlen(z_tbl) })
    };
    unsafe {
        memcpy(unsafe { (*p_vtab).z_db } as *mut (), z_db as *const (),
            unsafe { strlen(z_db) })
    };
    unsafe { *pp_vtab_1 = unsafe { &mut (*p_vtab).base } };
    unsafe {
        sqlite3_declare_vtab(db,
            c"CREATE TABLE x(path TEXT, data TEXT)".as_ptr() as *mut i8 as
                *const i8)
    };
    return 0;
}
extern "C" fn fs_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe { sqlite3_free(p_vtab_1 as *mut ()) };
    return 0;
}
extern "C" fn fs_open(p_v_tab_1: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut fs_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc_zero(core::mem::size_of::<fs_cursor>() as u64)
            } as *mut fs_cursor;
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn fs_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut fs_cursor = cur as *mut fs_cursor;
    unsafe { sqlite3_finalize(unsafe { (*p_cur).p_stmt }) };
    unsafe { sqlite3_free(unsafe { (*p_cur).z_buf } as *mut ()) };
    unsafe { sqlite3_free(p_cur as *mut ()) };
    return 0;
}
extern "C" fn fs_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const fs_cursor = cur as *mut fs_cursor as *const fs_cursor;
    let mut rc: i32 = 0;
    rc = unsafe { sqlite3_step(unsafe { (*p_cur).p_stmt }) };
    if rc == 100 || rc == 101 { rc = 0; }
    return rc;
}
extern "C" fn fs_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        let p_cur: *mut fs_cursor = p_vtab_cursor_1 as *mut fs_cursor;
        let p: *const fs_vtab =
            unsafe { (*p_vtab_cursor_1).p_vtab } as *mut fs_vtab as
                *const fs_vtab;
        { let _ = 0; };
        if idx_num_1 == 1 {
            let z_stmt: *mut i8 =
                unsafe {
                    sqlite3_mprintf(c"SELECT * FROM %Q.%Q WHERE rowid=?".as_ptr()
                                as *mut i8 as *const i8, unsafe { (*p).z_db },
                        unsafe { (*p).z_tbl })
                };
            if (z_stmt).is_null() as i32 != 0 { return 7; }
            rc =
                unsafe {
                    sqlite3_prepare_v2(unsafe { (*p).db }, z_stmt as *const i8,
                        -1, unsafe { &mut (*p_cur).p_stmt }, core::ptr::null_mut())
                };
            unsafe { sqlite3_free(z_stmt as *mut ()) };
            if rc == 0 {
                unsafe {
                    sqlite3_bind_value(unsafe { (*p_cur).p_stmt }, 1,
                        unsafe { *argv.offset(0 as isize) } as *const sqlite3_value)
                };
            }
        } else {
            let z_stmt_1: *mut i8 =
                unsafe {
                    sqlite3_mprintf(c"SELECT * FROM %Q.%Q".as_ptr() as *mut i8
                            as *const i8, unsafe { (*p).z_db }, unsafe { (*p).z_tbl })
                };
            if (z_stmt_1).is_null() as i32 != 0 { return 7; }
            rc =
                unsafe {
                    sqlite3_prepare_v2(unsafe { (*p).db },
                        z_stmt_1 as *const i8, -1, unsafe { &mut (*p_cur).p_stmt },
                        core::ptr::null_mut())
                };
            unsafe { sqlite3_free(z_stmt_1 as *mut ()) };
        }
        if rc == 0 { rc = fs_next(p_vtab_cursor_1); }
        return rc;
    }
}
extern "C" fn fs_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *mut fs_cursor = cur as *mut fs_cursor;
    { let _ = 0; };
    if i == 0 {
        unsafe {
            sqlite3_result_value(ctx,
                unsafe {
                    sqlite3_column_value(unsafe { (*p_cur).p_stmt }, 0)
                })
        };
    } else {
        let z_file: *const i8 =
            unsafe { sqlite3_column_text(unsafe { (*p_cur).p_stmt }, 1) } as
                *const i8;
        let mut sbuf: stat = unsafe { core::mem::zeroed() };
        let mut fd: i32 = 0;
        let mut n: i32 = 0;
        fd = unsafe { open(z_file, 0) };
        if fd < 0 { return 10; }
        unsafe { fstat(fd, &mut sbuf) };
        if sbuf.st_size >= unsafe { (*p_cur).n_alloc } as i64 {
            let mut n_new: sqlite3_int64 = sbuf.st_size * 2 as off_t;
            let mut z_new: *mut i8 = core::ptr::null_mut();
            if n_new < 1024 as i64 { n_new = 1024 as sqlite3_int64; }
            z_new =
                unsafe {
                        sqlite3Realloc(unsafe { (*p_cur).z_buf } as *mut (),
                            n_new as u64)
                    } as *mut i8;
            ...
            unsafe { (*p_cur).z_buf = z_new };
            unsafe { (*p_cur).n_alloc = n_new as i32 };
        }
        n =
            unsafe {
                    read(fd, unsafe { (*p_cur).z_buf } as *mut (),
                        sbuf.st_size as u64)
                } as i32;
        unsafe { close(fd) };
        if n as off_t != sbuf.st_size { return 1; }
        unsafe { (*p_cur).n_buf = sbuf.st_size as i32 };
        unsafe {
            *unsafe {
                        (*p_cur).z_buf.offset(unsafe { (*p_cur).n_buf } as isize)
                    } = '\u{0}' as i32 as i8
        };
        unsafe {
...
extern "C" fn fs_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid_1: *mut sqlite_int64) -> i32 {
    let p_cur: *const fs_cursor = cur as *mut fs_cursor as *const fs_cursor;
    unsafe {
        *p_rowid_1 =
            unsafe { sqlite3_column_int64(unsafe { (*p_cur).p_stmt }, 0) }
    };
    return 0;
}
extern "C" fn fs_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const fs_cursor = cur as *mut fs_cursor as *const fs_cursor;
    return (unsafe { sqlite3_data_count(unsafe { (*p_cur).p_stmt }) } == 0) as
            i32;
}
extern "C" fn fs_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    let mut ii: i32 = 0;
    {
        ii = 0;
        '__b5: loop {
            ...
            '__c5: loop {
                ...
                if (unsafe { (*p_cons).i_column } as i32) < 0 &&
                            unsafe { (*p_cons).usable } != 0 &&
                        unsafe { (*p_cons).op } as i32 == 2 {
                    let mut p_usage: *mut sqlite3_index_constraint_usage =
                        core::ptr::null_mut();
                    p_usage =
                        unsafe {
...
static mut fs_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: Some(fs_connect),
        x_connect: Some(fs_connect),
        x_best_index: Some(fs_best_index),
        x_disconnect: Some(fs_disconnect),
        x_destroy: Some(fs_disconnect),
        x_open: Some(fs_open),
        x_close: Some(fs_close),
        x_filter: Some(fs_filter),
        x_next: Some(fs_next),
        x_eof: Some(fs_eof),
        x_column: Some(fs_column),
        x_rowid: Some(fs_rowid),
        x_update: None,
        x_begin: None,
        x_sync: None,
        x_commit: None,
...
static mut fstree_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: Some(fstree_connect),
        x_connect: Some(fstree_connect),
        x_best_index: Some(fstree_best_index),
        x_disconnect: Some(fstree_disconnect),
        x_destroy: Some(fstree_disconnect),
        x_open: Some(fstree_open),
        x_close: Some(fstree_close),
        x_filter: Some(fstree_filter),
        x_next: Some(fstree_next),
        x_eof: Some(fstree_eof),
        x_column: Some(fstree_column),
        x_rowid: Some(fstree_rowid),
        x_update: None,
        x_begin: None,
        x_sync: None,
        x_commit: None,
...
extern "C" fn register_fs_module(client_data_1: ClientData,
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_create_module(db, c"fs".as_ptr() as *mut i8 as *const i8,
                &raw mut fs_module as *const sqlite3_module,
                interp as *mut ())
        };
        unsafe {
        ...
        unsafe {
            sqlite3_create_module(db,
                c"fstree".as_ptr() as *mut i8 as *const i8,
                &raw mut fstree_module as *const sqlite3_module,
                core::ptr::null_mut())
        };
        return 0;
    }
