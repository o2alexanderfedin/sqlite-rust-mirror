...
pub extern "C" fn sqlite3_auto_extension(x_init: unsafe extern "C" fn() -> ())
    ...
    unsafe {
        ...
        if rc != 0 {
            ...
            let mutex: *mut Sqlite3Mutex = unsafe { sqlite3MutexAlloc(2) };
...
static sqlite3_apis: Sqlite3ApiRoutines =
    Sqlite3ApiRoutines {
        ...
        value_dup: Some(unsafe {
                core::mem::transmute::<*const (),
                        unsafe extern "C" fn(*const Sqlite3Value)
                            -> *mut Sqlite3Value>(sqlite3_value_dup as *const ())
            }),
        ...
        loop {
            ...
            '__s3:
                ...
                match __state {
                    ...
                    42 => {
                        z_alt_entry =
                            unsafe { sqlite3_malloc64((nc_file + 30) as Sqlite3Uint64) }
                                as *mut i8;
                        __state = 43;
                    }
                    43 => {
    ...
    unsafe {
        ...
        if sqlite3_autoext.n_ext == 0 as u32 { return; }
        {
            ...
            '__b4: loop {
                ...
                '__c4: loop {
                    let mut z_errmsg: *mut i8 = core::ptr::null_mut();
                    let mutex: *mut Sqlite3Mutex =
                        unsafe { sqlite3MutexAlloc(2) };
                    let p_thunk: *const Sqlite3ApiRoutines = &sqlite3_apis;
                    unsafe { sqlite3_mutex_enter(mutex) };
                    if i >= sqlite3_autoext.n_ext {
                        x_init = None;
                        go = 0;
...
extern "C" {
    ...
    _: Sqlite3Uint64, _: unsafe extern "C" fn(*mut ()) -> ())
    -> i32;
    ...
    _: Sqlite3Uint64, _: unsafe extern "C" fn(*mut ()) -> (), encoding: u8)
    -> i32;
    ...
    x_step_1:
        unsafe extern "C" fn(*mut Sqlite3Context, i32, *mut *mut Sqlite3Value)
            -> (), x_final_1: unsafe extern "C" fn(*mut Sqlite3Context) -> ())
    -> i32;
    ...
    x_step_1:
        unsafe extern "C" fn(*mut Sqlite3Context, i32, *mut *mut Sqlite3Value)
            -> (), x_final_1: unsafe extern "C" fn(*mut Sqlite3Context) -> (),
    x_value_1: unsafe extern "C" fn(*mut Sqlite3Context) -> (),
    x_inverse_1:
        unsafe extern "C" fn(*mut Sqlite3Context, i32, *mut *mut Sqlite3Value)
            -> (), x_destroy_1: unsafe extern "C" fn(*mut ()) -> ())
    -> i32;
    ...
    n: Sqlite3Uint64, _: unsafe extern "C" fn(*mut ()) -> (), encoding: u8)
    -> ();
