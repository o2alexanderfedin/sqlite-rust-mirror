...
struct sqlite3_io_methods {
    ...
    x_shm_map: Option<unsafe extern "C" fn(*mut sqlite3_file, i32, i32, i32,
        *mut *mut ()) -> i32>,
    x_shm_lock: unsafe extern "C" fn(*mut sqlite3_file, i32, i32, i32) -> i32,
...
extern "C" fn superlock_shm_lock(fd: *mut sqlite3_file, idx: i32,
    n_byte_1: i32, p_busy_1: *mut SuperlockBusy) -> i32 {
    let mut rc: i32 = 0;
    let x_shm_lock:
            Option<unsafe extern "C" fn(*mut sqlite3_file, i32, i32, i32)
                -> i32> =
