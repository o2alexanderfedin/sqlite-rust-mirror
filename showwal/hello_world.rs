...
extern "C" fn __main_inner(argc: i32, argv: *const *mut i8)
    ...
    unsafe {
        ...
        if unsafe { lseek(fd, 8 as off_t, 0) } != 8 as i64 {
            unsafe {
        ...
        mx_frame =
            ((sbuf.st_size - 32 as off_t) / (pagesize + 24) as off_t) as i32;
        unsafe {
                ...
                '__b14: loop {
                    ...
                    '__c14: loop {
                        ...
                        if !(z_left).is_null() &&
                            ...
                            let new_size: off_t =
                                (32 + i_start * (pagesize + 24)) as off_t;
                            unsafe {
...
extern "C" {
    ...
    -> i64;
    fn truncate(_: *const i8, _: off_t)
    -> i32;
    fn close(_: i32)
    -> i32;
