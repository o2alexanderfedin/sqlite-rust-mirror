...
#[unsafe(no_mangle)]
pub extern "C" fn dummy_udf(up1: *mut sqlite3_context, up2: i32,
    up3: *mut *mut sqlite3_value) -> () {
    { let _ = up1; };
    { let _ = up2; };
    { let _ = up3; };
    if (0 == 0) as i32 as i64 != 0 {
...
#[unsafe(no_mangle)]
pub extern "C" fn dummy_ud_fvalue(up1: *mut sqlite3_context) -> () {
    { let _ = up1; };
    if (0 == 0) as i32 as i64 != 0 {
        unsafe {
...
extern "C" fn idx_prepare_stmt(db: *mut sqlite3,
    pp_stmt_1: *mut *mut sqlite3_stmt, pz_errmsg_1: *mut *mut i8,
...
extern "C" fn expert_db_contains_object(db: *mut sqlite3, z_tab_1: *const i8,
    ...
    let z_sql: *const i8 =
        c"SELECT 1 FROM sqlite_schema WHERE name = ?".as_ptr() as *mut i8 as
            *const i8;
    let mut p_sql: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut rc: i32 = 0;
    let mut ret: i32 = 0;
    rc =
        unsafe {
...
extern "C" fn idx_finalize(p_rc_1: &mut i32, p_stmt_1: *mut sqlite3_stmt)
    -> () {
...
extern "C" fn expert_dequote(z_in_1: *const i8) -> *mut i8 {
    ...
    let z_ret: *mut i8 =
        unsafe { sqlite3_malloc64(n as sqlite3_uint64) } as *mut i8;
...
extern "C" fn expert_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    unsafe { *pp_vtab_1 = p as *mut sqlite3_vtab };
    return rc;
}
...
extern "C" fn expert_best_index(p_vtab_1: *mut sqlite3_vtab,
...
extern "C" fn expert_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
...
struct ExpertCsr {
    ...
    p_data: *mut sqlite3_stmt,
}
extern "C" fn expert_open(p_v_tab_1: *mut sqlite3_vtab,
...
extern "C" fn expert_filter(cur: *mut sqlite3_vtab_cursor, idx_num_1: i32,
...
extern "C" fn expert_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid_1: *mut sqlite_int64) -> i32 {
    { let _ = cur; };
    unsafe { *p_rowid_1 = 0 as sqlite_int64 };
    return 0;
}
extern "C" fn expert_update(p_vtab_1: *mut sqlite3_vtab, n_data_1: i32,
    az_data_1: *mut *mut sqlite3_value, p_rowid_1: *mut sqlite_int64) -> i32 {
    { let _ = p_vtab_1; };
    { let _ = n_data_1; };
    { let _ = az_data_1; };
    { let _ = p_rowid_1; };
    ...
    unsafe {
        return unsafe {
                sqlite3_create_module(unsafe { (*p).dbv },
                    ...
                    &raw mut expert_module as *const sqlite3_module,
                    p as *mut ())
            };
    }
}
...
extern "C" fn idx_create_vtab_schema(p: *mut sqlite3expert,
    ...
    let mut p_schema: *mut sqlite3_stmt = core::ptr::null_mut();
    rc =
...
extern "C" fn idx_process_one_trigger(p: &sqlite3expert, p_write_1: &IdxWrite,
    ...
    unsafe {
        ...
        if rc == 0 {
            let mut p_x: *mut sqlite3_stmt = core::ptr::null_mut();
            rc =
                unsafe {
...
extern "C" fn idx_find_compatible(p_rc_1: &mut i32, dbm: *mut sqlite3,
    ...
    let mut p_idx_list: *mut sqlite3_stmt = core::ptr::null_mut();
    ...
    while rc == 0 && unsafe { sqlite3_step(p_idx_list) } == 100 {
        ...
        let mut p_info: *mut sqlite3_stmt = core::ptr::null_mut();
        let z_idx: *const i8 =
...
extern "C" fn idx_largest_index(db: *mut sqlite3, pn_max_1: &mut i32,
    ...
    let z_max: *const i8 =
        c"SELECT max(i.seqno) FROM   sqlite_schema AS s,   pragma_index_list(s.name) AS l,   pragma_index_info(l.name) AS i WHERE s.type = \'table\'".as_ptr()
                as *mut i8 as *const i8;
    let mut p_max: *mut sqlite3_stmt = core::ptr::null_mut();
    *pn_max_1 = 0;
...
extern "C" fn idx_rem_func(p_ctx_1: *mut sqlite3_context, argc: i32,
                        ...
                        let z_new: *mut i8 =
                            unsafe {
                                    sqlite3_realloc64(unsafe { (*p_slot).z } as *mut (),
                                        (n_byte * 2 as i64) as sqlite3_uint64)
                                } as *mut i8;
...
extern "C" fn idx_sample_func(p_ctx_1: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
...
extern "C" fn idx_populate_one_stat1(p: &mut sqlite3expert,
    p_index_x_info_1: *mut sqlite3_stmt, p_write_stat_1: *mut sqlite3_stmt,
    ...
    let mut n_col: i32 = 0;
    let mut i: i32 = 0;
    let mut p_query: *mut sqlite3_stmt = core::ptr::null_mut();
...
extern "C" fn idx_populate_stat1(p: *mut sqlite3expert,
    ...
    let mut p_all_index: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut p_index_x_info: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut p_write: *mut sqlite3_stmt = core::ptr::null_mut();
...
static mut expert_module: sqlite3_module =
    sqlite3_module {
        i_version: 2,
