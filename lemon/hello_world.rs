...
struct s_x4node {
    data: *mut config,
    next: *mut s_x4node,
    from: *mut *mut s_x4node,
}
static mut x4a: *mut s_x4 = unsafe { core::mem::zeroed() };
type x4node = s_x4node;
#[unsafe(no_mangle)]
pub extern "C" fn configtable_init() -> () {
    unsafe {
        if !(x4a).is_null() { return; }
        x4a = lemon_malloc(core::mem::size_of::<s_x4>() as u64) as *mut s_x4;
        if !(x4a).is_null() {
            unsafe { (*x4a).size = 64 };
            unsafe { (*x4a).count = 0 };
            unsafe {
                ...
                unsafe {
                    (*x4a).ht =
                        unsafe {
                                ...
                                } as *mut *mut x4node as *mut *mut s_x4node
                };
                {
                    i = 0;
                    '__b15: loop {
...
static mut op: *mut s_options = unsafe { core::mem::zeroed() };
...
#[unsafe(no_mangle)]
pub extern "C" fn opt_init(a: *mut *mut i8, o: *mut s_options, err: *mut FILE)
    -> i32 {
    unsafe {
        let mut errcnt: i32 = 0;
        g_argv = a;
...
struct s_x1node {
    data: *const i8,
    next: *mut s_x1node,
    from: *mut *mut s_x1node,
}
type x1node = s_x1node;
#[repr(C)]
#[derive(Copy, Clone)]
struct s_x1 {
    size: i32,
...
static mut x1a: *mut s_x1 = unsafe { core::mem::zeroed() };
#[unsafe(no_mangle)]
...
struct s_x2node {
    ...
    key: *const i8,
    next: *mut s_x2node,
    from: *mut *mut s_x2node,
}
type x2node = s_x2node;
#[repr(C)]
#[derive(Copy, Clone)]
struct s_x2 {
    size: i32,
...
static mut x2a: *mut s_x2 = unsafe { core::mem::zeroed() };
#[unsafe(no_mangle)]
...
struct s_x3node {
    ...
    key: *mut config,
    next: *mut s_x3node,
    from: *mut *mut s_x3node,
}
static mut x3a: *mut s_x3 = unsafe { core::mem::zeroed() };
type x3node = s_x3node;
#[unsafe(no_mangle)]
pub extern "C" fn state_init() -> () {
    unsafe {
        if !(x3a).is_null() { return; }
        x3a = lemon_malloc(core::mem::size_of::<s_x3>() as u64) as *mut s_x3;
        if !(x3a).is_null() {
            unsafe { (*x3a).size = 128 };
            unsafe { (*x3a).count = 0 };
            unsafe {
                ...
                unsafe {
                    (*x3a).ht =
                        unsafe {
                                ...
                                } as *mut *mut x3node as *mut *mut s_x3node
                };
                {
                    i = 0;
                    '__b36: loop {
...
pub extern "C" fn state_insert(data: *mut state, key: *mut config) -> i32 {
    unsafe {
        ...
        if unsafe { (*x3a).count } >= unsafe { (*x3a).size } {
            ...
            let mut array: s_x3 = unsafe { core::mem::zeroed() };
            ...
            array.ht =
                unsafe { &raw mut *array.tbl.offset(arr_size as isize) } as
                        *mut *mut x3node as *mut *mut s_x3node;
            {
                i = 0;
                '__b40: loop {
            ...
            }
            {
                ...
                '__b41: loop {
                    ...
                    '__c41: loop {
                        ...
                        unsafe {
                            *array.ht.add(h as usize) = newnp as *mut s_x3node
                        };
                        break '__c41;
                    }
                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
        ...
        unsafe {
            *unsafe { (*x3a).ht.add(h as usize) } = np as *mut s_x3node
        };
        unsafe {
...
pub extern "C" fn configtable_insert(data: *mut config) -> i32 {
    unsafe {
        ...
        if unsafe { (*x4a).count } >= unsafe { (*x4a).size } {
            let mut i: i32 = 0;
            let mut arr_size: i32 = 0;
            let mut array: s_x4 = unsafe { core::mem::zeroed() };
            ...
            array.ht =
                unsafe { &raw mut *array.tbl.offset(arr_size as isize) } as
                        *mut *mut x4node as *mut *mut s_x4node;
            {
                i = 0;
                '__b45: loop {
            ...
            }
            {
                ...
                '__b46: loop {
                    ...
                    '__c46: loop {
                        ...
                        unsafe {
                            *array.ht.add(h as usize) = newnp as *mut s_x4node
                        };
                        break '__c46;
                    }
                    { let __p = &mut i; let __t = *__p; *__p += 1; __t };
        ...
        unsafe {
            *unsafe { (*x4a).ht.add(h as usize) } = np as *mut s_x4node
        };
        unsafe {
...
struct acttab {
    n_action: i32,
    n_action_alloc: i32,
    a_action: *mut lookahead_action,
    a_lookahead: *mut lookahead_action,
    mn_lookahead: i32,
    mn_action: i32,
    mx_lookahead: i32,
    n_lookahead: i32,
    ...
    if (*p).n_lookahead >= (*p).n_lookahead_alloc {
        ...
        (*p).a_lookahead =
            lemon_realloc((*p).a_lookahead as *mut (),
                    core::mem::size_of::<lookahead_action>() as u64 *
                        (*p).n_lookahead_alloc as u64) as *mut lookahead_action;
    ...
    if (*p).n_action + n >= (*p).n_action_alloc {
        ...
        (*p).a_action =
            lemon_realloc((*p).a_action as *mut (),
                    core::mem::size_of::<lookahead_action>() as u64 *
                        (*p).n_action_alloc as u64) as *mut lookahead_action;
