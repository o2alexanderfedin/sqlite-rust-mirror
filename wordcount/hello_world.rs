...
extern "C" fn real_time() -> sqlite3_int64 {
    unsafe {
...
extern "C" fn checksum_step(context: *mut sqlite3_context, argc: i32,
...
extern "C" fn checksum_finalize(context: *mut sqlite3_context) -> () {
    let mut a: *mut u32 = core::ptr::null_mut();
...
extern "C" fn __main_inner(argc: i32, argv: *const *mut i8)
    ...
    unsafe {
        ...
        let mut p_update: *mut sqlite3_stmt = core::ptr::null_mut();
        let mut p_select: *mut sqlite3_stmt = core::ptr::null_mut();
        let mut p_delete: *mut sqlite3_stmt = core::ptr::null_mut();
        let mut in_: *mut FILE = core::ptr::null_mut();
        let mut rc: i32 = 0;
        let mut i_cur: i32 = 0;
        let mut i_hiwtr: i32 = 0;
        let mut p_timer: *mut FILE = __stderrp;
        let mut sum_cnt: sqlite3_int64 = 0 as sqlite3_int64;
        let mut start_time: sqlite3_int64 = 0 as sqlite3_int64;
        let mut total_time: sqlite3_int64 = 0 as sqlite3_int64;
        ...
        while all_loop(i_mode, &mut i_loop_cnt, &mut i_mode2,
            ...
            if show_timer != 0 {
                let elapse_time: sqlite3_int64 = real_time() - start_time;
                total_time += elapse_time;
                unsafe {
                    fprintf(p_timer,
                        c"%3d.%03d wordcount".as_ptr() as *mut i8 as *const i8,
                        (elapse_time / 1000 as sqlite3_int64) as i32,
                        (elapse_time % 1000 as sqlite3_int64) as i32)
                };
                if i_mode == -1 {
                    unsafe {
            ...
            unsafe {
                fprintf(p_timer,
                    c"%3d.%03d wordcount --all\n".as_ptr() as *mut i8 as
                        *const i8, (total_time / 1000 as sqlite3_int64) as i32,
                    (total_time % 1000 as sqlite3_int64) as i32)
            };
        }
        if show_stats != 0 {
