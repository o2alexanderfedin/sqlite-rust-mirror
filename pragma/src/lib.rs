            ...
            loop {
                ...
                '__s7:
                    ...
                    match __state {
                        ...
                        279 => { sz = -1 as Sqlite3Int64; __state = 291; }
                        280 => { __state = 281; }
                        281 => {
                            unsafe {
                        ...
                        943 => {
                            unsafe {
                                sqlite3_expr_if_false(p_parse,
                                    unsafe {
                                        (*(unsafe { (*p_check).a.as_ptr() } as
                                                        *mut ExprListItem).offset(k__3 as isize)).p_expr
                                    }, addr_ck_fault, 0)
                            };
                            __state = 944;
                        }
                        ...
                        1254 => {
                            return_single_int(v,
                                unsafe { sqlite3_soft_heap_limit64(-1 as Sqlite3Int64) });
                            __state = 1256;
                        }
                        1255 => {
                        ...
                        1259 => {
                            return_single_int(v,
                                unsafe { sqlite3_hard_heap_limit64(-1 as Sqlite3Int64) });
                            __state = 1263;
                        }
                        1260 => {
                            i_prior =
                        ...
                        1267 => {
                            unsafe {
                                sqlite3_limit(db, 11,
                                    (n_2 & 2147483647 as Sqlite3Int64) as i32)
                            };
                            __state = 1266;
                        }
                        1268 => { __state = 61; }
                        ...
                        1271 => {
                            unsafe {
                                (*db).n_analysis_limit =
                                    (n_3 & 2147483647 as Sqlite3Int64) as i32
                            };
                            __state = 1270;
                        }
                        1272 => { __state = 61; }
...
extern "C" fn pragma_vtab_connect(db: *mut Sqlite3, p_aux_1: *mut (),
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_str_appendall(&raw mut acc as *mut Sqlite3Str,
        ...
        unsafe {
            sqlite3_str_append(&raw mut acc as *mut Sqlite3Str,
...
extern "C" fn pragma_vtab_best_index(tab: *mut Sqlite3Vtab,
    ...
    unsafe { (*p_idx_info_1).estimated_rows = 20 as Sqlite3Int64 };
...
extern "C" fn pragma_vtab_cursor_clear(p_csr_1: &mut PragmaVtabCursor) -> () {
    ...
    (*p_csr_1).i_rowid = 0 as SqliteInt64;
    {
        i = 0;
        '__b11: loop {
            if !(i <
