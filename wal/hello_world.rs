...
struct Wal {
    p_vfs: *mut sqlite3_vfs,
    p_db_fd: *mut sqlite3_file,
    p_wal_fd: *mut sqlite3_file,
    i_callback: u32,
    mx_wal_size: i64,
    n_wi_data: i32,
    sz_first_block: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_wal_open(p_vfs: *mut sqlite3_vfs,
    p_db_fd: *mut sqlite3_file, z_wal_name: *const i8, b_no_shm: i32,
    ...
    *pp_wal = core::ptr::null_mut();
    ...
    unsafe {
        (*p_ret).p_wal_fd =
            unsafe { &raw mut *p_ret.offset(1 as isize) } as *mut sqlite3_file
    };
    ...
    if (*p_wal_1).n_wi_data <= i_page_1 {
        let n_byte: sqlite3_int64 =
            (core::mem::size_of::<*mut u32>() as u64 *
                    (1 as i64 + i_page_1 as i64) as u64) as sqlite3_int64;
    ...
    if (*p_wal_1).exclusive_mode as i32 == 2 {
        unsafe {
            *(*p_wal_1).ap_wi_data.offset(i_page_1 as isize) =
                unsafe {
                        sqlite3_malloc_zero(core::mem::size_of::<ht_slot>() as u64 *
                                    (4096 * 2) as u64 +
        ...
        rc =
            unsafe {
                sqlite3_os_shm_map((*p_wal_1).p_db_fd, i_page_1,
                    (core::mem::size_of::<ht_slot>() as u64 * (4096 * 2) as u64
        ...
        '__b5: loop {
            ...
            '__c5: loop {
                if unsafe { *s_loc.a_hash.offset(i as isize) } as i32 >
                        i_limit {
                    unsafe { *s_loc.a_hash.offset(i as isize) = 0 as ht_slot };
                }
                break '__c5;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
    ...
    if rc == 0 {
        ...
        unsafe {
            std::sync::atomic::AtomicU16::from_ptr(unsafe {
                        ...
                        *mut u16).store(idx as ht_slot as u16,
...
extern "C" fn wal_merge(a_content_1: *const u32, a_left_1: *mut ht_slot,
    n_left_1: i32, pa_right_1: &mut *mut ht_slot, pn_right_1: &mut i32,
    a_tmp_1: *mut ht_slot) -> () {
    let mut i_left: i32 = 0;
    let mut i_right: i32 = 0;
    let mut i_out: i32 = 0;
    let n_right: i32 = *pn_right_1;
    let a_right: *const ht_slot = *pa_right_1 as *const ht_slot;
    { let _ = 0; };
    while i_right < n_right || i_left < n_left_1 {
        let mut logpage: ht_slot = 0 as ht_slot;
    ...
    *pn_right_1 = i_out;
    unsafe {
        memcpy(a_left_1 as *mut (), a_tmp_1 as *const (),
            core::mem::size_of::<ht_slot>() as u64 * i_out as u64)
    };
}
extern "C" fn wal_mergesort(a_content_1: *const u32, a_buffer_1: *mut ht_slot,
    a_list_1: *mut ht_slot, pn_list_1: &mut i32) -> () {
    let n_list: i32 = *pn_list_1 as i32;
    let mut n_merge: i32 = 0;
    let mut a_merge: *mut ht_slot = core::ptr::null_mut();
    let mut i_list: i32 = 0;
    let mut i_sub: u32 = 0 as u32;
    let mut a_sub: [Sublist_N7Sublist; 13] = unsafe { core::mem::zeroed() };
    unsafe {
        memset(&raw mut a_sub[0 as usize] as *mut Sublist_N7Sublist as
                *mut (), 0,
            core::mem::size_of::<[Sublist_N7Sublist; 13]>() as u64)
    };
    { let _ = 0; };
    { let _ = 0; };
    {
            ...
            '__c10: loop {
                ...
                a_merge = unsafe { a_list_1.offset(i_list as isize) };
                {
                    ...
                    '__b11: loop {
                        ...
                        '__c11: loop {
                            let mut p: *const Sublist_N7Sublist = core::ptr::null();
                            { let _ = 0; };
    ...
    }
    {
        ...
        '__b12: loop {
            if !(i_sub <
                            (core::mem::size_of::<[Sublist_N7Sublist; 13]>() as u64 /
                                        core::mem::size_of::<Sublist_N7Sublist>() as u64) as i32 as
                                u32) {
                break '__b12;
            }
            '__c12: loop {
...
extern "C" fn wal_iterator_init(p_wal_1: *mut Wal, n_backfill_1: u32,
    ...
    let mut i: i32 = 0;
    let mut a_tmp: *mut ht_slot = core::ptr::null_mut();
    let mut rc: i32 = 0;
    { let _ = 0; };
    ...
    n_byte =
        (core::mem::offset_of!(WalIterator, a_segment) as u64 +
                ...
                + i_last as u64 * core::mem::size_of::<ht_slot>() as u64) as
            sqlite3_int64;
    p =
        unsafe {
                sqlite3_malloc64(n_byte as u64 +
                        (core::mem::size_of::<ht_slot>() as u64 *
        ...
        '__b13: loop {
            ...
            '__c13: loop {
                ...
                if rc == 0 {
                    ...
                    let mut a_index: *mut ht_slot = core::ptr::null_mut();
                    if i + 1 == n_segment {
                    ...
                    a_index =
                        unsafe {
                            (unsafe {
                                    ...
                                    } as *mut ht_slot).add(s_loc.i_zero as usize)
                        };
                    {
                    ...
                    };
                    {
                        ...
                        '__b14: loop {
                            ...
                            '__c14: loop {
                                unsafe { *a_index.offset(j as isize) = j as ht_slot };
                                break '__c14;
                            }
    ...
    loop {
        ...
        '__s21:
            ...
            match __state {
                ...
                42 => {
                    a_frame =
                        unsafe { sqlite3_malloc64(sz_frame as sqlite3_uint64) } as
                            *mut u8;
                    __state = 43;
                }
                43 => {
...
extern "C" fn wal_write_to_log(p: &WalWriter, mut p_content_1: *mut (),
    mut i_amt_1: i32, mut i_offset_1: sqlite3_int64) -> i32 {
    let mut rc: i32 = 0;
    if i_offset_1 < (*p).i_sync_point &&
            i_offset_1 + i_amt_1 as sqlite3_int64 >= (*p).i_sync_point {
        ...
        if rc != 0 { return rc; }
        i_offset_1 += i_first_amt as sqlite3_int64;
        i_amt_1 -= i_first_amt;
        p_content_1 =
...
extern "C" fn wal_write_one_frame(p: *mut WalWriter, p_page_1: &PgHdr,
    n_truncate_1: i32, i_offset_1: sqlite3_int64) -> i32 {
    let mut rc: i32 = 0;
...
extern "C" fn wal_frames(p_wal_1: *mut Wal, sz_page_1: i32,
    ...
    w.i_sync_point = 0 as sqlite3_int64;
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_wal_file(p_wal: &Wal) -> *mut sqlite3_file {
    return (*p_wal).p_wal_fd;
}
#[repr(C)]
#[derive(Copy, Clone)]
struct Sublist_N7Sublist {
    n_list: i32,
    a_list: *mut ht_slot,
}
extern "C" {
