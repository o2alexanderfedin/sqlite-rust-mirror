...
extern "C" fn sqr_func(context: *mut sqlite3_context, argc: i32,
    ...
    unsafe {
        ...
        unsafe {
            (unsafe { (*sqlite3_api).result_double.unwrap() })(context, r * r)
        };
    }
}
    ...
    unsafe {
        ...
        unsafe {
            (unsafe {
                ...
                })(db, c"sqr".as_ptr() as *mut i8 as *const i8, 1, 5,
                core::ptr::null_mut(), sqr_func,
                unsafe {
...
extern "C" fn cube_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let r: f64 =
            unsafe {
...
extern "C" fn cube_init(db: *mut sqlite3, pz_err_msg_1: *mut *mut i8,
    ...
    unsafe {
        ...
        unsafe {
            (unsafe {
                    (*sqlite3_api).create_function.unwrap()
                })(db, c"cube".as_ptr() as *mut i8 as *const i8, 1, 5,
                core::ptr::null_mut(), cube_func,
                unsafe {
                    core::mem::transmute::<*const (),
                            unsafe extern "C" fn(*mut sqlite3_context, i32,
                                *mut *mut sqlite3_value) -> ()>(0 as *const ())
        ...
        z_err =
            unsafe {
                (unsafe {
                    ...
                    })(c"broken autoext!".as_ptr() as *mut i8 as *const i8)
            };
        unsafe { *pz_err_msg_1 = z_err };
        return 1;
    }
}
extern "C" fn auto_ext_sqr_obj_cmd(client_data_1: *mut (),
    ...
    unsafe {
        let rc: i32 =
            unsafe {
                (unsafe {
                        (*sqlite3_api).auto_extension.unwrap()
                    })(unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn() -> ()>(sqr_init as *const ())
                    })
            };
        unsafe { Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(rc) }) };
        return 0;
    }
}
extern "C" fn cancel_auto_ext_sqr_obj_cmd(client_data_1: *mut (),
    ...
    unsafe {
        let rc: i32 =
            unsafe {
                (unsafe {
                        (*sqlite3_api).cancel_auto_extension.unwrap()
                    })(unsafe {
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn() -> ()>(sqr_init as *const ())
                    })
        ...
        let rc: i32 =
            unsafe {
                (unsafe {
                        ...
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn() -> ()>(cube_init as *const ())
                    })
            };
        unsafe { Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(rc) }) };
        return 0;
        ...
        let rc: i32 =
            unsafe {
                (unsafe {
                        ...
                        core::mem::transmute::<*const (),
                                unsafe extern "C" fn() -> ()>(broken_init as *const ())
                    })
            };
        unsafe { Tcl_SetObjResult(interp, unsafe { Tcl_NewIntObj(rc) }) };
        return 0;
...
extern "C" fn reset_auto_ext_obj_cmd(client_data_1: *mut (),
    ...
    unsafe {
        unsafe {
            (unsafe { (*sqlite3_api).reset_auto_extension.unwrap() })()
        };
        return 0;
    }
}
