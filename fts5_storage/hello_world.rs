...
struct Fts5Storage {
    ...
    p_saved_row: *mut sqlite3_stmt,
    a_stmt: [*mut sqlite3_stmt; 12],
}
...
extern "C" fn fts5_storage_get_stmt(p: &mut Fts5Storage, e_stmt_1: i32,
    pp_stmt_1: &mut *mut sqlite3_stmt, pz_err_msg_1: *mut *mut i8) -> i32 {
    let mut rc: i32 = 0;
    ...
    if !(e_stmt_1 >= 0 &&
                            e_stmt_1 <
                                (core::mem::size_of::<[*mut sqlite3_stmt; 12]>() as u64 /
                                        core::mem::size_of::<*mut sqlite3_stmt>() as u64) as i32) as
                    i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"fts5StorageGetStmt".as_ptr() as *const i8,
...
pub extern "C" fn sqlite3_fts5_storage_config_value(p: *mut Fts5Storage,
    z: *const i8, p_val: *mut sqlite3_value, i_val: i32) -> i32 {
    let mut p_replace: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut rc: i32 =
    ...
    if rc == 0 {
        ...
        if !(p_val).is_null() {
            unsafe {
                sqlite3_bind_value(p_replace, 2,
                    p_val as *const sqlite3_value)
            };
    ...
    if !(p).is_null() {
        let mut i: i32 = 0;
        {
            ...
            '__b3: loop {
                if !(i <
                                (core::mem::size_of::<[*mut sqlite3_stmt; 12]>() as u64 /
                                        core::mem::size_of::<*mut sqlite3_stmt>() as u64) as i32) {
                    break '__b3;
                }
                '__c3: loop {
                    unsafe {
    ...
    n_byte =
        (core::mem::size_of::<Fts5Storage>() as u64 +
                unsafe { (*p_config).n_col } as u64 *
                    core::mem::size_of::<i64>() as u64) as sqlite3_int64;
    *pp =
        {
            p =
...
extern "C" fn fts5_storage_contentless_delete(p: *mut Fts5Storage,
    ...
    let mut p_lookup: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut rc: i32 = 0;
...
pub extern "C" fn sqlite3_fts5_storage_find_delete_row(p: *mut Fts5Storage,
    i_del: i64) -> i32 {
    let mut rc: i32 = 0;
    let mut p_seek: *mut sqlite3_stmt = core::ptr::null_mut();
...
extern "C" fn fts5_storage_delete_from_index(p: *mut Fts5Storage,
    i_del_1: i64, ap_val_1: *const *mut sqlite3_value, b_save_row_1: i32)
    -> i32 {
        ...
        '__b7: loop {
            ...
            '__c7: loop {
                if unsafe {
                    ...
                    let mut p_free: *mut sqlite3_value = core::ptr::null_mut();
...
pub extern "C" fn sqlite3_fts5_storage_delete(p: *mut Fts5Storage, i_del: i64,
    ap_val: *mut *mut sqlite3_value, b_save_row: i32) -> i32 {
    let p_config: *const Fts5Config =
        unsafe { (*p).p_config } as *const Fts5Config;
    let mut rc: i32 = 0;
    let mut p_del: *mut sqlite3_stmt = core::ptr::null_mut();
    if !(unsafe { (*p_config).e_content } != 0 ||
        ...
        if unsafe { (*unsafe { (*p).p_config }).b_contentless_delete } != 0 {
            ...
            rc =
                fts5_storage_delete_from_index(p, i_del,
                    ap_val as *const *mut sqlite3_value, b_save_row);
        }
    }
    if rc == 0 && unsafe { (*p_config).b_columnsize } != 0 {
        rc =
...
pub extern "C" fn sqlite3_fts5_storage_content_insert(p: *mut Fts5Storage,
    b_replace: i32, ap_val: *mut *mut sqlite3_value, pi_rowid: *mut i64)
    -> i32 {
    let p_config: *mut Fts5Config = unsafe { (*p).p_config };
    let mut rc: i32 = 0;
    if unsafe { (*p_config).e_content } != 0 &&
        ...
        let mut p_insert: *mut sqlite3_stmt = core::ptr::null_mut();
        let mut i: i32 = 0;
        ...
        unsafe {
            sqlite3_bind_value(p_insert, 1,
                unsafe { *ap_val.offset(1 as isize) } as *const sqlite3_value)
        };
        {
            i = 2;
            '__b8: loop {
                ...
                '__c8: loop {
                    ...
                    if unsafe { (*p_config).e_content } == 0 || b_unindexed != 0
                        {
                        let mut p_val: *mut sqlite3_value =
...
pub extern "C" fn sqlite3_fts5_storage_index_insert(p: *mut Fts5Storage,
    ap_val: *mut *mut sqlite3_value, i_rowid: i64) -> i32 {
    let p_config: *mut Fts5Config = unsafe { (*p).p_config };
    let mut rc: i32 = 0;
    let mut ctx: Fts5InsertCtx = unsafe { core::mem::zeroed() };
    let mut buf: Fts5Buffer = unsafe { core::mem::zeroed() };
...
extern "C" fn fts5_storage_count(p: &Fts5Storage, z_suffix_1: *const i8,
    ...
    if z_sql == core::ptr::null_mut() {
        ...
        let mut p_cnt: *mut sqlite3_stmt = core::ptr::null_mut();
        rc =
            unsafe {
...
pub extern "C" fn sqlite3_fts5_storage_integrity(p: *mut Fts5Storage,
    ...
    let mut p_scan: *mut sqlite3_stmt = core::ptr::null_mut();
...
pub extern "C" fn sqlite3_fts5_storage_stmt(p: *mut Fts5Storage, e_stmt: i32,
    pp: *mut *mut sqlite3_stmt, pz_err_msg: *mut *mut i8) -> i32 {
    let mut rc: i32 = 0;
...
pub extern "C" fn sqlite3_fts5_storage_stmt_release(p: &mut Fts5Storage,
    e_stmt: i32, p_stmt: *mut sqlite3_stmt) -> () {
    if !(e_stmt == 0 || e_stmt == 1 || e_stmt == 2) as i32 as i64 != 0 {
        unsafe {
