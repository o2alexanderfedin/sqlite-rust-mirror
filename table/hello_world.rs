    ...
    unsafe {
        ...
        loop {
            ...
            '__s1:
                {
                match __state {
                    0 => { p = p_arg_1 as *mut TabResult; __state = 3; }
                    2 => { unsafe { (*p).rc = 7 }; __state = 45; }
                    3 => { __state = 4; }
                    4 => { __state = 5; }
                    5 => { __state = 6; }
                    6 => {
                        if unsafe { (*p).n_row } == 0 as u32 &&
                                argv != core::ptr::null_mut() {
                            __state = 8;
                        } else { __state = 9; }
                    }
                    7 => {
                        if unsafe { (*p).n_data } + need as u32 >
                                unsafe { (*p).n_alloc } {
                            __state = 11;
                        } else { __state = 10; }
                    }
                    8 => { need = n_col_1 * 2; __state = 7; }
                    9 => { need = n_col_1; __state = 7; }
                    10 => {
                        if unsafe { (*p).n_row } == 0 as u32 {
                            __state = 18;
                        } else { __state = 19; }
                    ...
                    12 => {
                        unsafe {
                            (*p).n_alloc =
                                unsafe { (*p).n_alloc } * 2 as u32 + need as u32
                        };
                        __state = 13;
                    }
                    13 => {
                        az_new =
                            unsafe {
                                    sqlite3Realloc(unsafe { (*p).az_result } as *mut (),
                    ...
                    15 => { unsafe { (*p).az_result = az_new }; __state = 10; }
                    16 => { __state = 2; }
                    17 => {
                    ...
                    18 => {
                        unsafe { (*p).n_column = n_col_1 as u32 };
                        __state = 20;
                    }
                    19 => {
                        if unsafe { (*p).n_column } as i32 != n_col_1 {
                            __state = 27;
                        } else { __state = 17; }
                    }
                    20 => { i = 0; __state = 21; }
                    21 => {
                        if i < n_col_1 { __state = 22; } else { __state = 17; }
                    }
                    22 => {
                        z =
                            unsafe {
                    ...
                    27 => {
                        unsafe {
                            sqlite3_free(unsafe { (*p).z_err_msg } as *mut ())
                        };
                        __state = 28;
                    }
                    28 => {
                        unsafe {
                            (*p).z_err_msg =
                                unsafe {
                                    sqlite3_mprintf(c"sqlite3_get_table() called with two or more incompatible queries".as_ptr()
                                                as *mut i8 as *const i8)
                                }
                        };
                        __state = 29;
                    }
                    29 => { unsafe { (*p).rc = 1 }; __state = 30; }
                    30 => { return 1; }
                    31 => { return 0; }
                    32 => { i = 0; __state = 34; }
                    33 => {
                    ...
                    34 => {
                        if i < n_col_1 { __state = 35; } else { __state = 33; }
                    }
                    35 => {
                        if unsafe { *argv.offset(i as isize) } ==
                                core::ptr::null_mut() {
                            __state = 38;
                        } else { __state = 39; }
                    }
                    ...
                    38 => { z = core::ptr::null_mut(); __state = 37; }
                    39 => {
                        n =
                            unsafe {
                                    sqlite3_strlen30(unsafe { *argv.offset(i as isize) } as
                                            *const i8)
                                } + 1;
                        __state = 40;
                    }
                    ...
                    42 => {
                        unsafe {
                            memcpy(z as *mut (),
                                unsafe { *argv.offset(i as isize) } as *const (), n as u64)
                        };
                        __state = 37;
                    }
                    43 => { __state = 2; }
...
pub extern "C" fn sqlite3_free_table(mut az_result: *mut *mut i8) -> () {
    if !(az_result).is_null() {
        ...
        let mut n: i32 = 0;
        {
            let __p = &mut az_result;
            let __t = *__p;
            *__p = unsafe { (*__p).offset(-1) };
            __t
        };
        { let _ = 0; };
        n = unsafe { *az_result.offset(0 as isize) } as i64 as i32;
        {
            i = 1;
            '__b2: loop {
                if !(i < n) { break '__b2; }
                '__c2: loop {
                    if !(unsafe { *az_result.offset(i as isize) }).is_null() {
                        unsafe {
                            sqlite3_free(unsafe { *az_result.offset(i as isize) } as
                                    *mut ())
                        };
                    }
                    break '__c2;
        ...
        unsafe { sqlite3_free(az_result as *mut ()) };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_get_table(db: *mut sqlite3, z_sql_1: *const i8,
    ...
    unsafe {
        ...
        *paz_result_1 = core::ptr::null_mut();
        if !(pn_column_1).is_null() { unsafe { *pn_column_1 = 0 }; }
        if !(pn_row_1).is_null() { unsafe { *pn_row_1 = 0 }; }
        if !(pz_err_msg_1).is_null() {
            unsafe { *pz_err_msg_1 = core::ptr::null_mut() };
        }
        res.z_err_msg = core::ptr::null_mut();
        res.n_row = 0 as u32;
        res.n_column = 0 as u32;
        res.n_data = 1 as u32;
        res.n_alloc = 20 as u32;
        res.rc = 0;
        res.az_result =
            unsafe {
        ...
        if res.az_result == core::ptr::null_mut() {
            unsafe { (*db).err_code = 7 };
            return 7;
        }
        unsafe { *res.az_result.offset(0 as isize) = core::ptr::null_mut() };
        rc =
            unsafe {
                sqlite3_exec(db, z_sql_1, Some(sqlite3_get_table_cb),
                    &raw mut res as *mut (), pz_err_msg_1)
            };
        { let _ = 0; };
        unsafe {
            *res.az_result.offset(0 as isize) =
                res.n_data as i64 as *mut () as *mut i8
        };
        if rc & 255 == 4 {
            sqlite3_free_table(unsafe {
                    &mut *res.az_result.offset(1 as isize)
                });
            if !(res.z_err_msg).is_null() {
                if !(pz_err_msg_1).is_null() {
                    unsafe {
                        sqlite3_free(unsafe { *pz_err_msg_1 } as *mut ())
                    };
                    unsafe {
                        *pz_err_msg_1 =
                            unsafe {
        ...
        if res.n_alloc > res.n_data {
            ...
            az_new =
                unsafe {
                        sqlite3Realloc(res.az_result as *mut (),
                            core::mem::size_of::<*mut i8>() as u64 * res.n_data as u64)
                    } as *mut *mut i8;
            if az_new == core::ptr::null_mut() {
                sqlite3_free_table(unsafe {
                        &mut *res.az_result.offset(1 as isize)
            ...
            res.az_result = az_new;
        }
        *paz_result_1 = unsafe { res.az_result.offset(1 as isize) };
        if !(pn_column_1).is_null() {
            unsafe { *pn_column_1 = res.n_column as i32 };
        }
        if !(pn_row_1).is_null() { unsafe { *pn_row_1 = res.n_row as i32 }; }
        return rc;
    }
}
#[repr(C)]
