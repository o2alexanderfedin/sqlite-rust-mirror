...
extern "C" fn vdbe_mem_type_name(p_mem_1: *mut Mem) -> *const i8 {
    unsafe {
        return az_types[(unsafe {
                            sqlite3_value_type(p_mem_1 as *mut Sqlite3Value)
                        } - 1) as usize];
    }
}
...
pub extern "C" fn sqlite3_vdbe_exec(p: *mut Vdbe) -> i32 {
    unsafe {
        unsafe {
            ...
            let mut i__4: i32 = 0;
            let mut p_ctx_1: *mut Sqlite3Context = core::ptr::null_mut();
            ...
            let mut p_v_cur: *mut Sqlite3VtabCursor = core::ptr::null_mut();
            let mut p_vtab_1: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_module_1: *const Sqlite3Module = core::ptr::null();
            let mut p_tab_3: *const Table = core::ptr::null();
            let mut p_vtab_2: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_module_2: *const Sqlite3Module = core::ptr::null();
            ...
            let mut p_module_3: *const Sqlite3Module = core::ptr::null();
            let mut p_query: *mut Mem = core::ptr::null_mut();
            let mut p_argc: *mut Mem = core::ptr::null_mut();
            let mut p_v_cur_1: *mut Sqlite3VtabCursor = core::ptr::null_mut();
            let mut p_vtab_3: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_cur_4: *mut VdbeCursor = core::ptr::null_mut();
            let mut res__13: i32 = 0;
            let mut i__6: i32 = 0;
            let mut ap_arg: *mut *mut Mem = core::ptr::null_mut();
            let mut p_vtab_4: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_module_4: *const Sqlite3Module = core::ptr::null();
            let mut p_dest_2: *mut Mem = core::ptr::null_mut();
            let mut s_context: Sqlite3Context =
                unsafe { core::mem::zeroed() };
            let mut null_func: FuncDef = unsafe { core::mem::zeroed() };
            let mut p_cur_5: *const VdbeCursor = core::ptr::null();
            let mut p_vtab_5: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_module_5: *const Sqlite3Module = core::ptr::null();
            let mut res__14: i32 = 0;
            let mut p_cur_6: *const VdbeCursor = core::ptr::null();
            let mut p_vtab_6: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_name: *mut Mem = core::ptr::null_mut();
            let mut is_legacy: i32 = 0;
            let mut p_vtab_7: *mut Sqlite3Vtab = core::ptr::null_mut();
            let mut p_module_6: *const Sqlite3Module = core::ptr::null();
            let mut n_arg_1: i32 = 0;
            let mut i__7: i32 = 0;
            let mut rowid__1: SqliteInt64 = 0 as SqliteInt64;
            ...
            let mut i__8: i32 = 0;
            let mut p_ctx_2: *mut Sqlite3Context = core::ptr::null_mut();
            let mut h: u64 = 0 as u64;
            ...
            loop {
                ...
                '__s2:
                    ...
                    match __state {
                        ...
                        2634 => {
                            x__2.n_key = unsafe { (*p_in2).n } as Sqlite3Int64;
                            __state = 2636;
                        }
                        2635 => { __state = 17; }
                        2636 => {
                        ...
                        3199 => {
                            n_alloc =
                                (core::mem::offset_of!(Sqlite3Context, argv) as u64 +
                                        n__4 as u64 *
                                            core::mem::size_of::<*mut Sqlite3Value>() as u64) as u64;
                            __state = 3200;
                        }
                        3200 => {
                            p_ctx =
                        ...
                        3231 => {
                            unsafe {
                                *(unsafe { (*p_ctx_1).argv.as_ptr() } as
                                                *mut *mut Sqlite3Value).offset(i__4 as isize) =
                                    unsafe {
                        ...
                        3269 => {
                            unsafe {
                                sqlite3_vdbe_error(p,
                                    c"%s".as_ptr() as *mut i8 as *const i8,
                                    unsafe { sqlite3_value_text(p_mem_3 as *mut Sqlite3Value) })
                            };
                            __state = 3270;
                        }
                        3270 => { __state = 17; }
                                ...
                                unsafe {
                                    sqlite3_run_vacuum(unsafe { &mut (*p).z_err_msg }, db,
                                        ...
                                        if unsafe { (*p_op).p2 } != 0 {
                                            ...
                                            } else { core::ptr::null_mut() } as *mut Sqlite3Value)
                                };
                            __state = 3343;
                        }
                        3343 => {
                        ...
                        3407 => {
                            z_tab =
                                unsafe {
                                        sqlite3_value_text(&raw mut s_mem_1 as *mut Sqlite3Value)
                                    } as *const i8;
                            __state = 3408;
                        }
                            ...
                            rc =
                                unsafe {
                                    (unsafe {
                                        ...
                                        n_arg, ap_arg as *mut *mut Sqlite3Value)
                                };
                            __state = 3521;
                        }
                        3518 => {
                        ...
                        3563 => {
                            unsafe {
                                sqlite3_vdbe_error(p,
                                    c"%s".as_ptr() as *mut i8 as *const i8,
                                    unsafe {
                                        sqlite3_value_text(p_dest_2 as *mut Sqlite3Value)
                                    })
                            };
                            __state = 3564;
                        }
                        ...
                        3619 => { __state = 3620; }
                        3620 => { __state = 3621; }
                        3621 => { rowid__1 = 0 as SqliteInt64; __state = 3622; }
                        3622 => { __state = 3623; }
                        3623 => { __state = 3624; }
                            ...
                            rc =
                                unsafe {
                                    (unsafe {
                                        ...
                                        })(p_vtab_7, n_arg_1, ap_arg_1 as *mut *mut Sqlite3Value,
                                        &mut rowid__1)
                                };
                            __state = 3651;
                        }
                        ...
                        3689 => {
                            unsafe {
                                *(unsafe { (*p_ctx_2).argv.as_ptr() } as
                                                *mut *mut Sqlite3Value).offset(i__8 as isize) =
                                    unsafe {
                        ...
                        3699 => {
                            unsafe {
                                sqlite3_vdbe_error(p,
                                    c"%s".as_ptr() as *mut i8 as *const i8,
                                    unsafe { sqlite3_value_text(p_out as *mut Sqlite3Value) })
                            };
                            __state = 3700;
                        }
                        3700 => {
