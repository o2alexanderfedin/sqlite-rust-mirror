...
static mut az_colname: [*const i8; 13] =
    [c"vn".as_ptr() as *const i8, c"ix".as_ptr() as *const i8,
            ...
            c"ux".as_ptr() as *const i8, c"rhs".as_ptr() as *const i8,
            c"a".as_ptr() as *const i8, c"b".as_ptr() as *const i8,
            c"c".as_ptr() as *const i8, c"d".as_ptr() as *const i8,
...
extern "C" fn qpvtab_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    let mut p_new: *mut qpvtab_vtab = core::ptr::null_mut();
    let mut rc: i32 = 0;
    rc =
        unsafe {
            sqlite3_declare_vtab(db,
                c"CREATE TABLE x( vn TEXT, ix INT, cn TEXT, op INT, ux BOOLEAN, rhs TEXT, a, b, c, d, e, flags INT HIDDEN)".as_ptr()
                        as *mut i8 as *const i8)
        };
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<qpvtab_vtab>() as
                            sqlite3_uint64)
                } as *mut qpvtab_vtab;
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<qpvtab_vtab>() as u64)
        };
    }
    return rc;
}
extern "C" fn qpvtab_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    let p: *mut qpvtab_vtab = p_vtab_1 as *mut qpvtab_vtab;
    unsafe { sqlite3_free(p as *mut ()) };
    return 0;
}
extern "C" fn qpvtab_open(p: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut qpvtab_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<qpvtab_cursor>() as
                        sqlite3_uint64)
            } as *mut qpvtab_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<qpvtab_cursor>() as u64)
    };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn qpvtab_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut qpvtab_cursor = cur as *mut qpvtab_cursor;
    unsafe { sqlite3_free(p_cur as *mut ()) };
    return 0;
}
extern "C" fn qpvtab_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut qpvtab_cursor = cur as *mut qpvtab_cursor;
    if unsafe { (*p_cur).i_rowid } < unsafe { (*p_cur).n_data } as i64 {
        let z: *const i8 =
            unsafe {
                &*unsafe {
                            (*p_cur).z_data.offset(unsafe { (*p_cur).i_rowid } as isize)
                        }
            };
        let mut z_end: *const i8 =
            unsafe { strchr(z, '\n' as i32) } as *const i8;
        if !(z_end).is_null() {
            {
                let __p = &mut z_end;
        ...
        unsafe {
            (*p_cur).i_rowid =
                unsafe { z_end.offset_from(unsafe { (*p_cur).z_data }) } as
                            i64 as i32 as sqlite3_int64
        };
    }
    return 0;
}
extern "C" fn qpvtab_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *const qpvtab_cursor =
        cur as *mut qpvtab_cursor as *const qpvtab_cursor;
    if i >= 0 && i <= 5 &&
            unsafe { (*p_cur).i_rowid } < unsafe { (*p_cur).n_data } as i64 {
        let mut z: *const i8 =
            unsafe {
                &*unsafe {
                            (*p_cur).z_data.offset(unsafe { (*p_cur).i_rowid } as isize)
        ...
        loop {
            ...
            if j == i || z_end == core::ptr::null() { break; }
            z = unsafe { z_end.offset(1 as isize) };
            { let __p = &mut j; let __t = *__p; *__p += 1; __t };
        }
        if z_end == z {
            unsafe { sqlite3_result_null(ctx) };
        } else if i == 1 || i == 3 || i == 4 {
            unsafe { sqlite3_result_int(ctx, unsafe { atoi(z) }) };
        } else {
            unsafe {
                sqlite3_result_text64(ctx, z,
                    unsafe { z_end.offset_from(z) } as i64 as sqlite3_uint64,
                    Some(unsafe {
        ...
        if unsafe { (*p_cur).flags } & 1 != 0 {
            unsafe { sqlite3_result_int(ctx, i - 6 + 1) };
        } else {
            let mut x: i8 = ('a' as i32 + i - 6) as i8;
            unsafe {
                sqlite3_result_text64(ctx, &raw mut x as *const i8,
                    1 as sqlite3_uint64,
                    Some(unsafe {
                            core::mem::transmute::<*const (),
                                    unsafe extern "C" fn(*mut ())
        ...
        unsafe { sqlite3_result_int(ctx, unsafe { (*p_cur).flags }) };
    }
    return 0;
}
extern "C" fn qpvtab_rowid(cur: *mut sqlite3_vtab_cursor,
...
extern "C" fn qpvtab_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const qpvtab_cursor =
        cur as *mut qpvtab_cursor as *const qpvtab_cursor;
    return (unsafe { (*p_cur).i_rowid } >= unsafe { (*p_cur).n_data } as i64)
            as i32;
}
extern "C" fn qpvtab_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_cur: *mut qpvtab_cursor = p_vtab_cursor_1 as *mut qpvtab_cursor;
    unsafe { (*p_cur).i_rowid = 0 as sqlite3_int64 };
    unsafe { (*p_cur).z_data = idx_str_1 };
    unsafe { (*p_cur).n_data = unsafe { strlen(idx_str_1) } as i32 };
    unsafe { (*p_cur).flags = idx_num_1 };
    return 0;
}
extern "C" fn qpvtab_str_append_value(p_str_1: *mut sqlite3_str,
    p_val_1: *mut sqlite3_value) -> () {
    '__s1:
        {
        match unsafe { sqlite3_value_type(p_val_1) } {
            5 => {
                unsafe {
            ...
            1 => {
                unsafe {
                    sqlite3_str_appendf(p_str_1,
                        ...
                        unsafe { sqlite3_value_int64(p_val_1) })
                };
            }
            2 => {
                unsafe {
                    sqlite3_str_appendf(p_str_1,
                        ...
                        unsafe { sqlite3_value_double(p_val_1) })
                };
            }
            3 => {
                {
                    ...
                    let n: i32 = unsafe { sqlite3_value_bytes(p_val_1) };
                    unsafe {
                        sqlite3_str_append(p_str_1,
                    ...
                    };
                    {
                        ...
                        '__b2: loop {
                            if !(i < n) { break '__b2; }
                            '__c2: loop {
                                let mut c: i8 = unsafe { *a.offset(i as isize) } as i8;
                                if c as i32 == '\n' as i32 { c = ' ' as i32 as i8; }
                                unsafe {
                                    sqlite3_str_append(p_str_1, &raw mut c as *const i8, 1)
                                };
                                if c as i32 == '\'' as i32 {
                                    unsafe {
                                        sqlite3_str_append(p_str_1, &raw mut c as *const i8, 1)
                ...
                }
                {
                    let mut i: i32 = 0;
                    let a: *const u8 =
                        unsafe { sqlite3_value_blob(p_val_1) } as *const u8;
                    let n: i32 = unsafe { sqlite3_value_bytes(p_val_1) };
                    unsafe {
                        sqlite3_str_append(p_str_1,
...
extern "C" fn qpvtab_best_index(tab: *mut sqlite3_vtab,
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_str_appendf(p_str,
                ...
                unsafe { (*p_idx_info_1).n_constraint })
        };
        {
            i = 0;
            '__b4: loop {
                ...
                '__c4: loop {
                    ...
                    if i_col == 11 &&
                        ...
                        rc =
                            unsafe {
                                sqlite3_vtab_rhs_value(p_idx_info_1, i, &mut p_val)
                            };
                        if !(rc == 0 || p_val == core::ptr::null_mut()) as i32 as
                                    i64 != 0 {
                            unsafe {
                                __assert_rtn(c"qpvtabBestIndex".as_ptr() as *const i8,
                                    c"qpvtab.c".as_ptr() as *mut i8 as *const i8, 353,
                                    c"rc==SQLITE_OK || pVal==0".as_ptr() as *mut i8 as
                                        *const i8)
                            }
                        } else { { let _ = 0; } };
                        if !(p_val).is_null() {
                            unsafe {
                                (*p_idx_info_1).idx_num =
                                    unsafe { sqlite3_value_int(p_val) }
                            };
                            if unsafe { (*p_idx_info_1).idx_num } & 2 != 0 {
                                unsafe { (*p_idx_info_1).order_by_consumed = 1 };
                            }
                        }
                    }
                    if op == 73 || op == 74 { i_col = 12; }
                    unsafe {
                        sqlite3_str_appendf(p_str,
                            c"aConstraint,%d,%s,%d,%d,".as_ptr() as *mut i8 as
                                *const i8, i,
                            if i_col >= 0 {
                                az_colname[i_col as usize]
                            } else { c"rowid".as_ptr() as *mut i8 as *const i8 }, op,
                            unsafe {
                                    (*unsafe {
                                                (*p_idx_info_1).a_constraint.offset(i as isize)
                                            }).usable
                    ...
                    if !(rc == 0 || p_val == core::ptr::null_mut()) as i32 as
                        ...
                        unsafe {
                            __assert_rtn(c"qpvtabBestIndex".as_ptr() as *const i8,
                                c"qpvtab.c".as_ptr() as *mut i8 as *const i8, 371,
                                c"rc==SQLITE_OK || pVal==0".as_ptr() as *mut i8 as
                                    *const i8)
                        }
                    } else { { let _ = 0; } };
                    if !(p_val).is_null() {
                        qpvtab_str_append_value(p_str, p_val);
                    }
                    unsafe {
                        sqlite3_str_append(p_str,
                    ...
                    if i_col_1 >= 6 &&
                        ...
                        unsafe {
                            (*unsafe {
                                        ...
                                        }).argv_index = { let __p = &mut k; *__p += 1; *__p }
                        };
                        if i_col_1 <= 11 ||
                                unsafe { (*p_idx_info_1).idx_num } & 4 != 0 {
                            unsafe {
                                (*unsafe {
                                                (*p_idx_info_1).a_constraint_usage.offset(i as isize)
                                            }).omit = 1 as u8
        ...
        };
        {
            i = 0;
            '__b6: loop {
                if !(i < unsafe { (*p_idx_info_1).n_order_by }) {
                    break '__b6;
                }
                '__c6: loop {
                    let i_col_2: i32 =
        ...
        unsafe {
            sqlite3_str_appendf(p_str,
                c"sqlite3_vtab_distinct,%d,,,,\n".as_ptr() as *mut i8 as
                    *const i8, unsafe { sqlite3_vtab_distinct(p_idx_info_1) })
        };
        unsafe {
            sqlite3_str_appendf(p_str,
                c"idxFlags,%d,,,,\n".as_ptr() as *mut i8 as *const i8,
                unsafe { (*p_idx_info_1).idx_flags })
        };
        unsafe {
            sqlite3_str_appendf(p_str,
                c"colUsed,%d,,,,\n".as_ptr() as *mut i8 as *const i8,
                unsafe { (*p_idx_info_1).col_used } as i32)
        };
        unsafe { (*p_idx_info_1).estimated_cost = 10 as f64 };
        unsafe { (*p_idx_info_1).estimated_rows = 10 as sqlite3_int64 };
        unsafe {
            sqlite3_str_appendf(p_str,
                c"idxNum,%d,,,,\n".as_ptr() as *mut i8 as *const i8,
                unsafe { (*p_idx_info_1).idx_num })
        };
        unsafe {
            sqlite3_str_appendf(p_str,
                c"orderByConsumed,%d,,,,\n".as_ptr() as *mut i8 as *const i8,
                unsafe { (*p_idx_info_1).order_by_consumed })
        };
        unsafe {
            (*p_idx_info_1).idx_str = unsafe { sqlite3_str_finish(p_str) }
        };
        unsafe { (*p_idx_info_1).need_to_free_idx_str = 1 };
        return 0;
    }
}
static mut qpvtab_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: None,
        x_connect: Some(qpvtab_connect),
        x_best_index: Some(qpvtab_best_index),
        x_disconnect: Some(qpvtab_disconnect),
        x_destroy: None,
        x_open: Some(qpvtab_open),
        x_close: Some(qpvtab_close),
        x_filter: Some(qpvtab_filter),
        x_next: Some(qpvtab_next),
        x_eof: Some(qpvtab_eof),
        x_column: Some(qpvtab_column),
        x_rowid: Some(qpvtab_rowid),
        x_update: None,
        x_begin: None,
        x_sync: None,
        x_commit: None,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_qpvtab_init(db: *mut sqlite3,
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    c"qpvtab".as_ptr() as *mut i8 as *const i8,
                    &raw mut qpvtab_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
        return rc;
    }
