...
static mut sqlite3_prng: sqlite3PrngType = unsafe { core::mem::zeroed() };
extern "C" fn chacha_block(out: *mut u32, in__1: *const u32) -> () {
    let mut i: i32 = 0;
    let mut x: [u32; 16] = [0; 16];
    unsafe {
        memcpy(&raw mut x[0 as usize] as *mut u32 as *mut (),
            in__1 as *const (), 64 as u64)
    };
    {
        i = 0;
        '__b0: loop {
                        ...
                        {
                            {
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[0 as usize] += x[4 as usize];
                                                            x[12 as usize] ^= x[0 as usize]
                                                        };
                                                        x[12 as usize] =
                                                            x[12 as usize] << 16 | x[12 as usize] >> 32 - 16
                                                    };
                                                    x[8 as usize] += x[12 as usize]
                                                };
                                                x[4 as usize] ^= x[8 as usize]
                                            };
                                            x[4 as usize] =
                                                x[4 as usize] << 12 | x[4 as usize] >> 32 - 12
                                        };
                                        x[0 as usize] += x[4 as usize]
                                    };
                                    x[12 as usize] ^= x[0 as usize]
                                ...
                                x[12 as usize] =
                                    x[12 as usize] << 8 | x[12 as usize] >> 32 - 8
                            };
                            x[8 as usize] += x[12 as usize]
                        };
                        x[4 as usize] ^= x[8 as usize]
                    };
                    x[4 as usize] = x[4 as usize] << 7 | x[4 as usize] >> 32 - 7
                };
                {
                    {
                        {
                            {
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[1 as usize] += x[5 as usize];
                                                            x[13 as usize] ^= x[1 as usize]
                                                        };
                                                        x[13 as usize] =
                                                            x[13 as usize] << 16 | x[13 as usize] >> 32 - 16
                                                    };
                                                    x[9 as usize] += x[13 as usize]
                                                };
                                                x[5 as usize] ^= x[9 as usize]
                                            };
                                            x[5 as usize] =
                                                x[5 as usize] << 12 | x[5 as usize] >> 32 - 12
                                        };
                                        x[1 as usize] += x[5 as usize]
                                    };
                                    x[13 as usize] ^= x[1 as usize]
                                ...
                                x[13 as usize] =
                                    x[13 as usize] << 8 | x[13 as usize] >> 32 - 8
                            };
                            x[9 as usize] += x[13 as usize]
                        };
                        x[5 as usize] ^= x[9 as usize]
                    };
                    x[5 as usize] = x[5 as usize] << 7 | x[5 as usize] >> 32 - 7
                };
                {
                    {
                        {
                            {
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[2 as usize] += x[6 as usize];
                                                            x[14 as usize] ^= x[2 as usize]
                                                        };
                                                        x[14 as usize] =
                                                            x[14 as usize] << 16 | x[14 as usize] >> 32 - 16
                                                    };
                                                    x[10 as usize] += x[14 as usize]
                                                };
                                                x[6 as usize] ^= x[10 as usize]
                                            };
                                            x[6 as usize] =
                                                x[6 as usize] << 12 | x[6 as usize] >> 32 - 12
                                        };
                                        x[2 as usize] += x[6 as usize]
                                    };
                                    x[14 as usize] ^= x[2 as usize]
                                ...
                                x[14 as usize] =
                                    x[14 as usize] << 8 | x[14 as usize] >> 32 - 8
                            };
                            x[10 as usize] += x[14 as usize]
                        };
                        x[6 as usize] ^= x[10 as usize]
                    };
                    x[6 as usize] = x[6 as usize] << 7 | x[6 as usize] >> 32 - 7
                };
                {
                    {
                        {
                            {
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[3 as usize] += x[7 as usize];
                                                            x[15 as usize] ^= x[3 as usize]
                                                        };
                                                        x[15 as usize] =
                                                            x[15 as usize] << 16 | x[15 as usize] >> 32 - 16
                                                    };
                                                    x[11 as usize] += x[15 as usize]
                                                };
                                                x[7 as usize] ^= x[11 as usize]
                                            };
                                            x[7 as usize] =
                                                x[7 as usize] << 12 | x[7 as usize] >> 32 - 12
                                        };
                                        x[3 as usize] += x[7 as usize]
                                    };
                                    x[15 as usize] ^= x[3 as usize]
                                ...
                                x[15 as usize] =
                                    x[15 as usize] << 8 | x[15 as usize] >> 32 - 8
                            };
                            x[11 as usize] += x[15 as usize]
                        };
                        x[7 as usize] ^= x[11 as usize]
                    };
                    x[7 as usize] = x[7 as usize] << 7 | x[7 as usize] >> 32 - 7
                };
                {
                    {
                        {
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[0 as usize] += x[5 as usize];
                                                            x[15 as usize] ^= x[0 as usize]
                                                        };
                                                        x[15 as usize] =
                                                            x[15 as usize] << 16 | x[15 as usize] >> 32 - 16
                                                    };
                                                    x[10 as usize] += x[15 as usize]
                                                };
                                                x[5 as usize] ^= x[10 as usize]
                                            };
                                            x[5 as usize] =
                                                x[5 as usize] << 12 | x[5 as usize] >> 32 - 12
                                        };
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[1 as usize] += x[6 as usize];
                                                            x[12 as usize] ^= x[1 as usize]
                                                        };
                                                        x[12 as usize] =
                                                            x[12 as usize] << 16 | x[12 as usize] >> 32 - 16
                                                    };
                                                    x[11 as usize] += x[12 as usize]
                                                };
                                                x[6 as usize] ^= x[11 as usize]
                                            };
                                            x[6 as usize] =
                                                x[6 as usize] << 12 | x[6 as usize] >> 32 - 12
                                        };
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[2 as usize] += x[7 as usize];
                                                            x[13 as usize] ^= x[2 as usize]
                                                        };
                                                        x[13 as usize] =
                                                            x[13 as usize] << 16 | x[13 as usize] >> 32 - 16
                                                    };
                                                    x[8 as usize] += x[13 as usize]
                                                };
                                                x[7 as usize] ^= x[8 as usize]
                                            };
                                            x[7 as usize] =
                                                x[7 as usize] << 12 | x[7 as usize] >> 32 - 12
                                        };
                                            ...
                                            {
                                                {
                                                    {
                                                        {
                                                            x[3 as usize] += x[4 as usize];
                                                            x[14 as usize] ^= x[3 as usize]
                                                        };
                                                        x[14 as usize] =
                                                            x[14 as usize] << 16 | x[14 as usize] >> 32 - 16
                                                    };
                                                    x[9 as usize] += x[14 as usize]
                                                };
                                                x[4 as usize] ^= x[9 as usize]
                                            };
                                            x[4 as usize] =
                                                x[4 as usize] << 12 | x[4 as usize] >> 32 - 12
                                        };
            ...
            '__c1: loop {
                unsafe {
                    *out.offset(i as isize) =
                        x[i as usize] + unsafe { *in__1.offset(i as isize) } as u32
                };
                break '__c1;
            }
            { let __p = &mut i; let __t = *__p; *__p += 1; __t };
...
pub extern "C" fn sqlite3_randomness(mut n: i32, p_buf: *mut ()) -> () {
    unsafe {
        unsafe {
            ...
            if n <= 0 || p_buf == core::ptr::null_mut() {
                sqlite3_prng.s[0 as usize] = 0 as u32;
                unsafe { sqlite3_mutex_leave(mutex) };
                return;
            }
            if sqlite3_prng.s[0 as usize] == 0 as u32 {
                let p_vfs: *mut sqlite3_vfs =
                    unsafe { sqlite3_vfs_find(core::ptr::null()) };
                unsafe {
                    memcpy(&raw mut sqlite3_prng.s[0 as usize] as *mut (),
                        &raw const chacha20_init[0 as usize] as *const u32 as
                            *const (), 16 as u64)
                };
                if p_vfs == core::ptr::null_mut() {
                    unsafe {
                        memset(&raw mut sqlite3_prng.s[4 as usize] as *mut (), 0,
                            44 as u64)
                    };
                } else {
                    unsafe {
                        sqlite3_os_randomness(p_vfs, 44,
                            &raw mut sqlite3_prng.s[4 as usize] as *mut i8)
                    };
                }
                sqlite3_prng.s[15 as usize] = sqlite3_prng.s[12 as usize];
                sqlite3_prng.s[12 as usize] = 0 as u32;
                sqlite3_prng.n = 0 as u8;
            }
            { let _ = 0; };
            loop {
                if n <= sqlite3_prng.n as i32 {
                    unsafe {
                        memcpy(z_buf as *mut (),
                            &raw mut sqlite3_prng.out[(sqlite3_prng.n as i32 - n) as
                                            usize] as *const (), n as u64)
                    };
                    sqlite3_prng.n -= n as u8;
                    break;
                }
                if sqlite3_prng.n as i32 > 0 {
                    unsafe {
                        memcpy(z_buf as *mut (),
                            &raw mut sqlite3_prng.out[0 as usize] as *mut u8 as
                                *const (), sqlite3_prng.n as u64)
                    };
                    n -= sqlite3_prng.n as i32;
                    {
                        let __n = sqlite3_prng.n;
                        let __p = &mut z_buf;
                        *__p = unsafe { (*__p).add(__n as usize) };
                    };
                }
                {
                    let __p = &mut sqlite3_prng.s[12 as usize];
                    let __t = *__p;
                    *__p += 1;
                    __t
                };
                chacha_block(&raw mut sqlite3_prng.out[0 as usize] as
                        *mut u32,
                    &raw mut sqlite3_prng.s[0 as usize] as *mut u32 as
                        *const u32);
                sqlite3_prng.n = 64 as u8;
            }
            unsafe { sqlite3_mutex_leave(mutex) };
        }
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_prng_save_state() -> () {
    unsafe {
        unsafe {
            memcpy(&raw mut sqlite3_saved_prng as *mut (),
                &raw mut sqlite3_prng as *const (),
                core::mem::size_of::<sqlite3PrngType>() as u64)
        };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_prng_restore_state() -> () {
    unsafe {
        unsafe {
            memcpy(&raw mut sqlite3_prng as *mut (),
                &raw mut sqlite3_saved_prng as *const (),
                core::mem::size_of::<sqlite3PrngType>() as u64)
        };
    }
}
static chacha20_init: [u32; 4] =
    [1634760805 as u32, 857760878 as u32, 2036477234 as u32,
            1797285236 as u32];
extern "C" {
