...
pub extern "C" fn sqlite3_delete_database(z_file_1: *const i8) -> i32 {
    ...
    let mut a_m_file: [MFileN5MFile; 6] =
        [MFileN5MFile {
    ...
    if z_buf == core::ptr::null_mut() { return 7; }
    {
        ...
        '__b1: loop {
            ...
            '__c1: loop {
                ...
                rc =
                    sqlite3_delete_unlink_if_exists(p_vfs as *const Sqlite3Vfs,
    ...
    }
    {
        ...
        '__b2: loop {
            if !(rc == 0 &&
                            (i as u64) <
                                core::mem::size_of::<[MFileN5MFile; 6]>() as u64 /
                                    core::mem::size_of::<MFileN5MFile>() as u64) {
                break '__b2;
            }
            '__c2: loop {
                let p: *const MFileN5MFile =
                    &raw mut a_m_file[i as usize] as *const MFileN5MFile;
