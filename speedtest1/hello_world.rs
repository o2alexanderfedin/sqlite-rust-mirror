...
struct Global {
    ...
    i_start: sqlite3_int64,
    i_total: sqlite3_int64,
    b_without_rowid: i32,
    b_reprepare: i32,
    b_sql_only: i32,
    b_explain: i32,
...
#[unsafe(no_mangle)]
pub extern "C" fn speedtest1_timestamp() -> sqlite3_int64 {
    unsafe {
...
pub extern "C" fn speedtest1_end_test() -> () {
    unsafe {
        let i_elapse_time: sqlite3_int64 = speedtest1_timestamp() - g.i_start;
        ...
        if (g.b_sql_only == 0) as i32 != 0 {
            ...
            unsafe {
                printf(c"%4d.%03ds\n".as_ptr() as *mut i8 as *const i8,
                    (i_elapse_time / 1000 as sqlite3_int64) as i32,
                    (i_elapse_time % 1000 as sqlite3_int64) as i32)
            };
        }
        if !(g.p_stmt).is_null() {
        ...
        if (g.b_sql_only == 0) as i32 != 0 {
            unsafe {
                printf(c"       TOTAL%.*s %4d.%03ds\n".as_ptr() as *mut i8 as
                        *const i8, 60 - 5,
                    &raw const z_dots[0 as usize] as *const i8,
                    (g.i_total / 1000 as sqlite3_int64) as i32,
                    (g.i_total % 1000 as sqlite3_int64) as i32)
            };
        }
        if g.b_verify != 0 {
...
pub extern "C" fn speedtest1_run() -> () {
    unsafe {
        ...
        if g.b_reprepare != 0 {
            let mut p_new: *mut sqlite3_stmt = core::ptr::null_mut();
            unsafe {
        ...
        };
        {
            ...
            '__b15: loop {
                ...
                '__c15: loop {
                    ...
                    unsafe {
                        sqlite3_bind_int64(g.p_stmt, 1, x1 as sqlite3_int64)
                    };
        ...
        };
        {
            ...
            '__b16: loop {
                ...
                '__c16: loop {
                    ...
                    unsafe {
                        sqlite3_bind_int64(g.p_stmt, 2, x1 as sqlite3_int64)
                    };
                    unsafe {
                        sqlite3_bind_text(g.p_stmt, 3,
                            &raw mut z_num[0 as usize] as *mut i8 as *const i8, -1,
            ...
            '__b30: loop {
                ...
                '__c30: loop {
                    ...
                    speedtest1_numbername(i as u32,
                        ...
                        core::mem::size_of::<[i8; 2000]>() as i32);
                    unsafe {
                        sqlite3_bind_int(g.p_stmt, 1, x1 as sqlite3_int64 as i32)
                    };
                    unsafe {
                                        ...
                                        86 => {
                                            unsafe {
                                                sqlite3_bind_text64(g.p_stmt, (j + 2 as u32) as i32,
                                                    ...
                                                    len as sqlite3_uint64, None, 1 as u8)
                                            };
                                        }
                                        66 => {
                                            unsafe {
    ...
    unsafe {
        ...
        if g.z_db_name != core::ptr::null() {
            let p_vfs: *mut sqlite3_vfs =
                unsafe { sqlite3_vfs_find(g.z_vfs) };
