...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_sector_size(p_file: *mut sqlite3_file) -> i32 {
...
pub extern "C" fn sqlite3_pager_lookup(p_pager_1: &Pager, pgno: Pgno)
    -> *mut DbPage {
    let mut p_page: *mut sqlite3_pcache_page = core::ptr::null_mut();
    { let _ = 0; };
    { let _ = 0; };
    { let _ = 0; };
...
extern "C" fn read32bits(fd: *mut sqlite3_file, offset: i64,
    p_res_1: &mut u32) -> i32 {
    let mut ac: [u8; 4] = [0; 4];
    let rc: i32 =
        unsafe {
...
extern "C" fn pager_playback_one_page(p_pager_1: *mut Pager,
    ...
    let mut jfd: *mut sqlite3_file = core::ptr::null_mut();
...
extern "C" fn read_super_journal(p_jrnl_1: *mut sqlite3_file, n_super_1: u64,
...
extern "C" fn pager_delsuper(p_pager_1: &Pager, z_super_1: *const i8) -> i32 {
    ...
    let mut rc: i32 = 0;
    let mut p_super: *mut sqlite3_file = core::ptr::null_mut();
    let mut p_journal: *mut sqlite3_file = core::ptr::null_mut();
...
extern "C" fn get_page_normal(p_pager_1: *mut Pager, pgno: Pgno,
    ...
    '__b16: loop {
        '__c16: loop {
            ...
            let mut p_base: *mut sqlite3_pcache_page = core::ptr::null_mut();
            { let _ = 0; };
            { let _ = 0; };
            { let _ = 0; };
            { let _ = 0; };
...
extern "C" fn pager_fix_maplimit(p_pager_1: *mut Pager) -> () {
    let fd: *const sqlite3_file =
        unsafe { (*p_pager_1).fd } as *const sqlite3_file;
...
extern "C" fn write32bits(fd: *mut sqlite3_file, offset: i64, val: u32)
    -> i32 {
    let mut ac: [i8; 4] = [0; 4];
...
extern "C" fn pager_opentemp(p_pager_1: &Pager, p_file_1: *mut sqlite3_file,
    ...
    if rc == 0 &&
            ...
            (!(unsafe { (*p_list_1).p_dirty }).is_null() ||
                unsafe { (*p_list_1).pgno } >
                    unsafe { (*p_pager_1).db_hint_size }) {
        let mut sz_file: sqlite3_int64 =
            unsafe { (*p_pager_1).page_size } *
                unsafe { (*p_pager_1).db_size } as sqlite3_int64;
        unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_pager_open(p_vfs_1: *mut sqlite3_vfs,
    ...
    loop {
        ...
        '__s26:
            ...
            match __state {
                ...
                62 => {
                    unsafe { (*p_pager).fd = p_ptr as *mut sqlite3_file };
                    __state = 63;
                }
                63 => {
                    {
                ...
                64 => {
                    unsafe { (*p_pager).sjfd = p_ptr as *mut sqlite3_file };
                    __state = 65;
                }
                65 => {
                    {
                ...
                66 => {
                    unsafe { (*p_pager).jfd = p_ptr as *mut sqlite3_file };
                    __state = 67;
                }
                67 => {
                    {
                        ...
                        (*p_pager).no_lock =
                            unsafe {
                                    sqlite3_uri_boolean(unsafe { (*p_pager).z_filename } as
                                            sqlite3_filename,
                                        c"nolock".as_ptr() as *mut i8 as *const i8, 0)
                                } as u8
                    };
                    __state = 117;
                }
...
extern "C" fn has_hot_journal(p_pager_1: *mut Pager, p_exists_1: &mut i32)
    -> i32 {
    let p_vfs: *mut sqlite3_vfs = unsafe { (*p_pager_1).p_vfs };
    let mut rc: i32 = 0;
...
pub extern "C" fn sqlite3_pager_wal_supported(p_pager_1: &Pager) -> i32 {
    let p_methods: *const sqlite3_io_methods =
...
pub extern "C" fn sqlite3_pager_filename(p_pager_1: &Pager,
    ...
    if null_if_mem_db_1 != 0 &&
            ((*p_pager_1).mem_db != 0 ||
                unsafe {
                        sqlite3_is_memdb((*p_pager_1).p_vfs as *const sqlite3_vfs)
                    } != 0) {
        return &z_fake[4 as usize];
    } else { return (*p_pager_1).z_filename as *const i8; }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_pager_vfs(p_pager_1: &Pager) -> *mut sqlite3_vfs {
    return (*p_pager_1).p_vfs;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_pager_file(p_pager_1: &Pager) -> *mut sqlite3_file {
    return (*p_pager_1).fd;
}
#[unsafe(no_mangle)]
...
extern "C" {
    ...
    -> Pgno;
    fn sqlite3_wal_open(_: *mut sqlite3_vfs, _: *mut sqlite3_file,
    _: *const i8, _: i32, _: i64, _: *mut *mut Wal)
    -> i32;
