...
struct BenignMallocHooks {
    x_benign_begin: Option<unsafe extern "C" fn() -> ()>,
    x_benign_end: Option<unsafe extern "C" fn() -> ()>,
}
...
pub extern "C" fn sqlite3_benign_malloc_hooks(x_benign_begin:
    ...
    x_benign_end: Option<unsafe extern "C" fn() -> ()>) -> () {
    unsafe {
        sqlite3_hooks.x_benign_begin = x_benign_begin;
        sqlite3_hooks.x_benign_end = x_benign_end;
    }
}
...
pub extern "C" fn sqlite3_begin_benign_malloc() -> () {
    unsafe {
        if sqlite3_hooks.x_benign_begin.is_some() {
            unsafe { sqlite3_hooks.x_benign_begin.unwrap()() };
        }
    }
}

#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_end_benign_malloc() -> () {
    unsafe {
        if sqlite3_hooks.x_benign_end.is_some() {
            unsafe { sqlite3_hooks.x_benign_end.unwrap()() };
        }
    }
}
