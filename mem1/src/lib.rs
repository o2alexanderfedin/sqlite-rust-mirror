...
struct MallocZoneT {
    reserved1: *mut (),
    reserved2: *mut (),
    size: Option<unsafe extern "C" fn(*mut MallocZoneT, *const ()) -> u64>,
    malloc: Option<unsafe extern "C" fn(*mut MallocZoneT, u64) -> *mut ()>,
    calloc: Option<unsafe extern "C" fn(*mut MallocZoneT, u64, u64)
        -> *mut ()>,
    valloc: Option<unsafe extern "C" fn(*mut MallocZoneT, u64) -> *mut ()>,
    free: Option<unsafe extern "C" fn(*mut MallocZoneT, *mut ()) -> ()>,
    realloc: Option<unsafe extern "C" fn(*mut MallocZoneT, *mut (), u64)
        -> *mut ()>,
    destroy: Option<unsafe extern "C" fn(*mut MallocZoneT) -> ()>,
    zone_name: *const i8,
    batch_malloc: Option<unsafe extern "C" fn(*mut MallocZoneT, u64,
        *mut *mut (), u32) -> u32>,
    batch_free: Option<unsafe extern "C" fn(*mut MallocZoneT, *mut *mut (),
        u32) -> ()>,
    introspect: *mut MallocIntrospectionT,
    version: u32,
    memalign: Option<unsafe extern "C" fn(*mut MallocZoneT, u64, u64)
        -> *mut ()>,
    free_definite_size: Option<unsafe extern "C" fn(*mut MallocZoneT, *mut (),
        u64) -> ()>,
    pressure_relief: Option<unsafe extern "C" fn(*mut MallocZoneT, u64)
        -> u64>,
    claimed_address: Option<unsafe extern "C" fn(*mut MallocZoneT, *mut ())
        -> i32>,
    try_free_default: Option<unsafe extern "C" fn(*mut MallocZoneT, *mut ())
        -> ()>,
    malloc_with_options: Option<unsafe extern "C" fn(*mut MallocZoneT, u64,
        u64, u64) -> *mut ()>,
    malloc_type_malloc: Option<unsafe extern "C" fn(*mut MallocZoneT, u64,
        u64) -> *mut ()>,
    malloc_type_calloc: Option<unsafe extern "C" fn(*mut MallocZoneT, u64,
        u64, u64) -> *mut ()>,
    malloc_type_realloc: Option<unsafe extern "C" fn(*mut MallocZoneT,
        *mut (), u64, u64) -> *mut ()>,
    malloc_type_memalign: Option<unsafe extern "C" fn(*mut MallocZoneT, u64,
        u64, u64) -> *mut ()>,
                    ...
                    if !(_sqlite_zone_).is_null() {
                        unsafe {
                            (unsafe {
                                ...
                                })(_sqlite_zone_ as *mut MallocZoneT,
                                p_prior_1 as *const ())
                        }
...
pub extern "C" fn sqlite3_mem_set_default() -> () {
    unsafe {
        unsafe {
            sqlite3_config(4,
                &raw const default_methods as *const Sqlite3MemMethods)
        };
    }
}
...
extern "C" {
    ...
    -> *mut malloc_zone_t;
    fn malloc_create_zone(start_size: VmSizeT, flags: u32)
    -> *mut malloc_zone_t;
