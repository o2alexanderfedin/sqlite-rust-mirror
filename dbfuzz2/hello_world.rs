...
static mut sz_max: sqlite3_int64 = 104857600 as sqlite3_int64;
static mut n_cb: i32 = 0;
static mut mx_cb: i32 = 250000;
static mut memtrace_base: sqlite3_mem_methods =
...
static mut ersazt_methods: sqlite3_mem_methods =
    sqlite3_mem_methods {
    ...
    unsafe {
        ...
        if !memtrace_base.x_malloc.is_some() as i32 != 0 {
            rc =
                unsafe {
                    sqlite3_config(5,
                        &raw mut memtrace_base as *mut sqlite3_mem_methods)
                };
            if rc == 0 {
                rc =
                    unsafe {
                        sqlite3_config(4,
                            &raw mut ersazt_methods as *mut sqlite3_mem_methods)
                    };
            }
        }
        memtrace_out = out;
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_deserialize(db, c"main".as_ptr() as *mut i8 as *const i8,
                a, n_byte_1 as sqlite3_int64, n_byte_1 as sqlite3_int64,
                (2 | 1) as u32)
        };
        x = sz_max;
        unsafe {
