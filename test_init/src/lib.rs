...
use crate::sqlite3_h::{
    ...
    Sqlite3Mutex, Sqlite3MutexMethods, Sqlite3Pcache, Sqlite3PcacheMethods2,
...
#[derive(Copy, Clone)]
struct Wrapped {
    pcache: Sqlite3PcacheMethods2,
    mem: Sqlite3MemMethods,
...
extern "C" fn install_init_wrappers() -> () {
    unsafe {
        ...
        let mut pcachemethods: Sqlite3PcacheMethods2 =
        ...
        let mut memmethods: Sqlite3MemMethods =
            Sqlite3MemMethods {
        ...
        unsafe {
            sqlite3_config(11,
                &raw mut wrapped.mutex as *mut Sqlite3MutexMethods)
        };
        unsafe {
            sqlite3_config(5, &raw mut wrapped.mem as *mut Sqlite3MemMethods)
        };
        unsafe {
            sqlite3_config(19,
                &raw mut wrapped.pcache as *mut Sqlite3PcacheMethods2)
        };
        unsafe {
            sqlite3_config(10,
                &raw mut mutexmethods as *mut Sqlite3MutexMethods)
        };
        unsafe {
            sqlite3_config(4, &raw mut memmethods as *mut Sqlite3MemMethods)
        };
        unsafe {
            sqlite3_config(18,
                &raw mut pcachemethods as *mut Sqlite3PcacheMethods2)
        };
    }
}
...
extern "C" fn init_wrapper_uninstall(client_data_1: ClientData,
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_config(4, &raw mut wrapped.mem as *mut Sqlite3MemMethods)
        };
        unsafe {
            sqlite3_config(18,
                &raw mut wrapped.pcache as *mut Sqlite3PcacheMethods2)
