...
extern "C" fn intck_parse_create_index_func(p_ctx_1: *mut sqlite3_context,
    n_val_1: i32, ap_val_1: *mut *mut sqlite3_value) -> () {
    let z_sql: *const i8 =
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_intck_close(p: *mut sqlite3_intck) -> () {
    if !(p).is_null() {
...
pub extern "C" fn sqlite3_intck_open(db: *mut sqlite3, z_db_arg: *const i8,
    pp_out: &mut *mut sqlite3_intck) -> i32 {
    let mut p_new: *mut sqlite3_intck = core::ptr::null_mut();
    let mut rc: i32 = 0;
    let z_db: *const i8 =
        if !(z_db_arg).is_null() {
            z_db_arg
    ...
    p_new =
        unsafe {
                sqlite3_malloc((core::mem::size_of::<sqlite3_intck>() as u64 +
    ...
    if p_new == core::ptr::null_mut() {
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<sqlite3_intck>() as u64)
        };
        unsafe { (*p_new).db = db };
        unsafe {
            (*p_new).z_db =
...
extern "C" fn intck_save_errmsg(p: &mut sqlite3_intck) -> () {
...
extern "C" fn intck_prepare(p: *mut sqlite3_intck, z_sql_1: *const i8)
    -> *mut sqlite3_stmt {
...
unsafe extern "C" fn intck_prepare_fmt(p: *mut sqlite3_intck,
    z_fmt_1: *const i8, mut __va0: ...) -> *mut sqlite3_stmt {
    let mut p_ret: *mut sqlite3_stmt = core::ptr::null_mut();
...
unsafe extern "C" fn intck_mprintf(p: &mut sqlite3_intck, z_fmt_1: *const i8,
    mut __va0: ...) -> *mut i8 {
    let mut ap: *mut i8 = core::ptr::null_mut();
...
extern "C" fn intck_finalize(p: *mut sqlite3_intck,
...
extern "C" fn intck_find_object(p: *mut sqlite3_intck) -> () {
...
extern "C" fn intck_step(p: &sqlite3_intck, p_stmt_1: *mut sqlite3_stmt)
    -> i32 {
    if (*p).rc != 0 { return (*p).rc; }
    return unsafe { sqlite3_step(p_stmt_1) };
}
extern "C" fn intck_get_auto_index(p: *mut sqlite3_intck) -> i32 {
    let mut b_ret: i32 = 0;
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
    p_stmt =
        intck_prepare(p,
...
extern "C" fn intck_exec(p: *mut sqlite3_intck, z_sql_1: *const i8) -> () {
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
    p_stmt = intck_prepare(p, z_sql_1);
    intck_step(unsafe { &*p }, p_stmt);
    intck_finalize(p, p_stmt);
}
extern "C" fn intck_is_index(p: *mut sqlite3_intck, z_obj_1: *const i8)
    -> i32 {
    let mut b_ret: i32 = 0;
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
    p_stmt =
...
extern "C" fn intck_check_object_sql(p: *mut sqlite3_intck,
    z_obj_1: *const i8, z_prev_1: *const i8, pn_key_val_1: *mut i32)
    -> *mut i8 {
    let mut z_ret: *mut i8 = core::ptr::null_mut();
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_intck_step(p: *mut sqlite3_intck) -> i32 {
    if unsafe { (*p).rc } == 0 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_intck_message(p: &sqlite3_intck) -> *const i8 {
...
extern "C" fn intck_save_key(p: *mut sqlite3_intck) -> () {
    let mut ii: i32 = 0;
    let mut z_sql: *mut i8 = core::ptr::null_mut();
    let mut p_stmt: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut p_xinfo: *mut sqlite3_stmt = core::ptr::null_mut();
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_intck_unlock(p: *mut sqlite3_intck) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_intck_error(p: &sqlite3_intck,
    pz_err: *mut *const i8) -> i32 {
    if !(pz_err).is_null() { unsafe { *pz_err = (*p).z_err as *const i8 }; }
    return if (*p).rc == 101 { 0 } else { (*p).rc };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_intck_test_sql(p: *mut sqlite3_intck,
