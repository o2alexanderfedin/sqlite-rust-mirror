...
type Tcl_Channel = *mut Tcl_Channel_;
type ClientData = *mut ();
type Tcl_ChannelTypeVersion = *mut Tcl_ChannelTypeVersion_;
...
struct Tcl_ChannelType {
    ...
    closeProc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp) -> i32>,
    ...
    seekProc: Option<unsafe extern "C" fn(*mut (), i64, i32, *mut i32)
        -> i32>,
    setOptionProc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp,
        *const i8, *const i8) -> i32>,
    getOptionProc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp,
        *const i8, *mut Tcl_DString) -> i32>,
    watchProc: Option<unsafe extern "C" fn(*mut (), i32) -> ()>,
    getHandleProc: Option<unsafe extern "C" fn(*mut (), i32, *mut *mut ())
        -> i32>,
    close2Proc: Option<unsafe extern "C" fn(*mut (), *mut Tcl_Interp, i32)
        -> i32>,
...
struct SqliteDb {
    ...
    z_null: *mut i8,
    p_func: *mut SqlFunc,
    p_update_hook: *mut Tcl_Obj,
    p_pre_update_hook: *mut Tcl_Obj,
    p_rollback_hook: *mut Tcl_Obj,
    p_wal_hook: *mut Tcl_Obj,
    p_unlock_notify: *mut Tcl_Obj,
    p_collate: *mut SqlCollate,
    rc: i32,
    p_collate_needed: *mut Tcl_Obj,
...
struct SqlPreparedStmt {
    ...
    z_sql: *const i8,
    n_parm: i32,
    ap_parm: *mut *mut Tcl_Obj,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct IncrblobChannel {
    p_blob: *mut sqlite3_blob,
    p_db: *mut SqliteDb,
    i_seek: sqlite3_int64,
    is_closed: u32,
    channel: Tcl_Channel,
...
extern "C" fn incrblob_close2(instance_data_1: ClientData,
    interp: *mut Tcl_Interp, flags: i32) -> i32 {
...
extern "C" fn incrblob_input(instance_data_1: ClientData, buf: *mut i8,
    ...
    let p: *mut IncrblobChannel = instance_data_1 as *mut IncrblobChannel;
    let mut n_read: sqlite3_int64 = buf_size_1 as sqlite3_int64;
    let mut n_blob: sqlite3_int64 = 0 as sqlite3_int64;
    let mut rc: i32 = 0;
    n_blob =
...
extern "C" fn incrblob_output(instance_data_1: ClientData, buf: *const i8,
    ...
    let p: *mut IncrblobChannel = instance_data_1 as *mut IncrblobChannel;
    let n_write: sqlite3_int64 = to_write_1 as sqlite3_int64;
    let mut n_blob: sqlite3_int64 = 0 as sqlite3_int64;
    let mut rc: i32 = 0;
    n_blob =
        unsafe { sqlite3_blob_bytes(unsafe { (*p).p_blob }) } as
...
extern "C" fn incrblob_wide_seek(instance_data_1: ClientData,
    offset: Tcl_WideInt, seek_mode_1: i32, error_code_ptr_1: *mut i32)
    -> Tcl_WideInt {
    let p: *mut IncrblobChannel = instance_data_1 as *mut IncrblobChannel;
    '__s2:
        {
        match seek_mode_1 {
            0 => { unsafe { (*p).i_seek = offset as sqlite3_int64 }; }
            1 => { unsafe { (*p).i_seek += offset as sqlite3_int64 }; }
            2 => {
                unsafe {
                    (*p).i_seek =
                        (unsafe { sqlite3_blob_bytes(unsafe { (*p).p_blob }) } as
                                    Tcl_WideInt + offset) as sqlite3_int64
                };
            }
            _ => {
    ...
    return unsafe { (*p).i_seek } as Tcl_WideInt;
}
...
static mut incrblob_channel_type: Tcl_ChannelType =
    Tcl_ChannelType {
        typeName: c"incrblob".as_ptr() as *mut i8,
        version: 5 as Tcl_ChannelTypeVersion,
...
extern "C" fn create_incrblob_channel(interp: *mut Tcl_Interp,
    p_db_1: *mut SqliteDb, z_db_1: *const i8, z_table_1: *const i8,
    z_column_1: *const i8, i_row_1: sqlite_int64, is_readonly_1: i32) -> i32 {
    unsafe {
...
extern "C" fn safe_to_use_eval_objv(p_cmd_1: *mut Tcl_Obj) -> i32 {
...
extern "C" fn db_trace_handler(cd: *mut (), z_sql_1: *const i8) -> () {
    let p_db: *const SqliteDb = cd as *mut SqliteDb as *const SqliteDb;
    let mut str: Tcl_DString = unsafe { core::mem::zeroed() };
...
extern "C" fn db_trace_v2_handler(type__1: u32, cd: *mut (), pd: *mut (),
    xd: *mut ()) -> i32 {
    let p_db: *const SqliteDb = cd as *mut SqliteDb as *const SqliteDb;
    let mut p_cmd: *mut Tcl_Obj = core::ptr::null_mut();
    '__s14:
        {
        match type__1 {
            1 => {
                {
                    let p_stmt: *const sqlite3_stmt =
                        pd as *mut sqlite3_stmt as *const sqlite3_stmt;
                    ...
                    unsafe {
                        Tcl_ListObjAppendElement(unsafe { (*p_db).interp }, p_cmd,
                            unsafe { Tcl_NewWideIntObj(p_stmt as uptr as Tcl_WideInt) })
                    };
                    unsafe {
                        Tcl_ListObjAppendElement(unsafe { (*p_db).interp }, p_cmd,
                ...
                {
                    let p_stmt_1: *const sqlite3_stmt =
                        pd as *mut sqlite3_stmt as *const sqlite3_stmt;
                    let ns: sqlite3_int64 =
                        unsafe { core::ptr::read(xd as *mut sqlite3_int64) };
                    p_cmd =
                        unsafe {
                            Tcl_NewStringObj(unsafe { (*p_db).z_trace_v2 } as *const i8,
                                -1)
                    ...
                    unsafe {
                        Tcl_ListObjAppendElement(unsafe { (*p_db).interp }, p_cmd,
                            unsafe {
                                Tcl_NewWideIntObj(p_stmt_1 as uptr as Tcl_WideInt)
                            })
                    };
                    unsafe {
                        Tcl_ListObjAppendElement(unsafe { (*p_db).interp }, p_cmd,
                            unsafe { Tcl_NewWideIntObj(ns as Tcl_WideInt) })
                    };
                    unsafe {
                        Tcl_EvalObjEx(unsafe { (*p_db).interp }, p_cmd, 262144)
                    };
                ...
                {
                    let p_stmt_2: *const sqlite3_stmt =
                        pd as *mut sqlite3_stmt as *const sqlite3_stmt;
                    p_cmd =
                        unsafe {
                            Tcl_NewStringObj(unsafe { (*p_db).z_trace_v2 } as *const i8,
                    ...
                    unsafe {
                        Tcl_ListObjAppendElement(unsafe { (*p_db).interp }, p_cmd,
                            unsafe {
                                Tcl_NewWideIntObj(p_stmt_2 as uptr as Tcl_WideInt)
                            })
                    };
                    unsafe {
                        Tcl_EvalObjEx(unsafe { (*p_db).interp }, p_cmd, 262144)
                ...
                }
                {
                    ...
                    unsafe {
                        Tcl_ListObjAppendElement(unsafe { (*p_db).interp }, p_cmd,
                            unsafe { Tcl_NewWideIntObj(db as uptr as Tcl_WideInt) })
                    };
                    unsafe {
                        Tcl_EvalObjEx(unsafe { (*p_db).interp }, p_cmd, 262144)
                    };
...
extern "C" fn db_wal_handler(client_data_1: *mut (), db: *mut sqlite3,
    ...
    let mut ret: i32 = 0;
    let mut p: *mut Tcl_Obj = core::ptr::null_mut();
    let p_db: *const SqliteDb =
        client_data_1 as *mut SqliteDb as *const SqliteDb;
    let interp: *mut Tcl_Interp = unsafe { (*p_db).interp };
...
extern "C" fn db_update_handler(p: *mut (), op: i32, z_db_1: *const i8,
    z_tbl_1: *const i8, rowid: sqlite_int64) -> () {
    unsafe {
...
extern "C" fn tcl_sql_func(context: *mut sqlite3_context, argc: i32,
    ...
    if argc == 0 {
        ...
        let mut a_arg: *mut *mut Tcl_Obj = core::ptr::null_mut();
        let mut n_arg: Tcl_Size = 0;
        if unsafe {
        ...
        p_cmd =
            unsafe { Tcl_NewListObj(n_arg, a_arg as *const *mut Tcl_Obj) };
        { let __p = unsafe { &mut (*p_cmd).refCount }; *__p += 1; *__p };
        {
            i = 0;
            '__b24: loop {
        ...
        '__s28:
            ...
            match e_type {
                4 => {
                    ...
                    {
                        let mut v: Tcl_WideInt = 0 as Tcl_WideInt;
                        if 0 ==
                                unsafe {
...
extern "C" fn db_trans_post_cmd(data: *mut ClientData,
    interp: *mut Tcl_Interp, result: i32) -> i32 {
    unsafe {
...
extern "C" fn db_prepare(p_db_1: &SqliteDb, z_sql_1: *const i8,
    pp_stmt_1: *mut *mut sqlite3_stmt, pz_out_1: *mut *const i8) -> i32 {
...
extern "C" fn db_prepare_and_bind(p_db_1: *mut SqliteDb, z_in_1: *const i8,
    ...
    let mut rc: i32 = 0;
    let interp: *mut Tcl_Interp = unsafe { (*p_db_1).interp };
    ...
    if p_pre_stmt == core::ptr::null_mut() {
        ...
        n_byte =
            (core::mem::size_of::<SqlPreparedStmt>() as u64 +
                    n_var as u64 * core::mem::size_of::<*mut Tcl_Obj>() as u64)
                as i32;
        p_pre_stmt =
                        ...
                        if unsafe { *z_var.offset(0 as isize) } as i32 == '@' as i32
                            ...
                            unsafe {
                                sqlite3_bind_text64(p_stmt, i, data as *mut i8 as *const i8,
                                    n as sqlite3_uint64, None, 1 as u8)
                            };
                            {
                                let __p = unsafe { &mut (*p_var).refCount };
                                *__p += 1;
...
struct DbEvalContext {
    ...
    n_col: i32,
    eval_flags: i32,
    p_var_name: *mut Tcl_Obj,
    ap_col_name: *mut *mut Tcl_Obj,
}
...
extern "C" fn db_eval_init(p: *mut DbEvalContext, p_db_1: *mut SqliteDb,
    p_sql_1: *mut Tcl_Obj, p_var_name_1: *mut Tcl_Obj, eval_flags_1: i32)
    -> () {
    unsafe {
...
extern "C" fn db_eval_row_info(p: &mut DbEvalContext, pn_col_1: *mut i32,
    pap_col_name_1: *mut *mut *mut Tcl_Obj) -> () {
    if core::ptr::null_mut() == (*p).ap_col_name {
        let p_stmt: *mut sqlite3_stmt = unsafe { (*(*p).p_pre_stmt).p_stmt };
        let mut i: i32 = 0;
        let mut n_col: i32 = 0;
        let mut ap_col_name: *mut *mut Tcl_Obj = core::ptr::null_mut();
        (*p).n_col =
        ...
        if n_col > 0 &&
            ...
            ap_col_name =
                unsafe {
                        Tcl_Alloc((core::mem::size_of::<*mut Tcl_Obj>() as u64 *
                                    n_col as u64) as u32)
                    } as *mut *mut Tcl_Obj;
            {
                i = 0;
        ...
        if !((*p).p_var_name).is_null() {
            let interp: *mut Tcl_Interp = unsafe { (*(*p).p_db).interp };
            let p_col_list: *mut Tcl_Obj = unsafe { Tcl_NewObj() };
            let p_star: *mut Tcl_Obj =
                unsafe {
            ...
            if 0 == 2 & (*p).eval_flags {
                ...
                let mut p_dict: *mut Tcl_Obj =
                    unsafe {
                        Tcl_ObjGetVar2(interp, (*p).p_var_name,
                            0 as *mut () as *mut Tcl_Obj, 0)
                    };
                ...
                if unsafe {
                    ...
                    unsafe {
                        Tcl_ObjSetVar2(interp, (*p).p_var_name,
                            0 as *mut () as *mut Tcl_Obj, p_dict, 0)
                    };
                }
                {
...
extern "C" fn db_eval_step(p: *mut DbEvalContext) -> i32 {
    ...
    while unsafe { *unsafe { (*p).z_sql.offset(0 as isize) } } != 0 ||
        ...
        if unsafe { (*p).p_pre_stmt } == core::ptr::null_mut() {
            ...
            let p_stmt: *mut sqlite3_stmt = unsafe { (*p_pre_stmt).p_stmt };
...
extern "C" fn db_eval_next_cmd(data: *mut ClientData, interp: *mut Tcl_Interp,
    result: i32) -> i32 {
    let mut rc: i32 = result;
    let p: *mut DbEvalContext =
        unsafe { *data.offset(0 as isize) } as *mut DbEvalContext;
    let p_script: *mut Tcl_Obj =
        unsafe { *data.offset(1 as isize) } as *mut Tcl_Obj;
    let p_var_name: *mut Tcl_Obj = unsafe { (*p).p_var_name };
                ...
                '__c49: loop {
                    if p_var_name == core::ptr::null_mut() {
                        ...
                        if unsafe {
                            ...
                            unsafe {
                                Tcl_ObjSetVar2(interp, p_var_name,
                                    0 as *mut () as *mut Tcl_Obj, p_dict_1, 0)
                            };
                        }
                        {
...
extern "C" fn db_hook_cmd(interp: *mut Tcl_Interp, p_db_1: *mut SqliteDb,
    p_arg_1: *mut Tcl_Obj, pp_hook_1: &mut *mut Tcl_Obj) -> () {
    let db: *mut sqlite3 = unsafe { (*p_db_1).db };
...
extern "C" fn db_qrf(p_db_1: &SqliteDb, objc: i32, objv: *const *mut Tcl_Obj)
    -> i32 {
    unsafe {
...
extern "C" fn db_obj_cmd(mut cd: *mut (), interp: *mut Tcl_Interp,
    mut objc: i32, mut objv: *const *mut Tcl_Obj) -> i32 {
    unsafe {
        ...
        let mut p_backup: *mut sqlite3_backup = core::ptr::null_mut();
        let mut z_callback: *const i8 = core::ptr::null();
        let mut len__1: Tcl_Size = 0;
        let mut z_busy: *const i8 = core::ptr::null();
        let mut len__2: Tcl_Size = 0;
        let mut sub_cmd: *const i8 = core::ptr::null();
        let mut n: i32 = 0;
        let mut p_result: *mut Tcl_Obj = core::ptr::null_mut();
        ...
        let mut n_script: Tcl_Size = 0;
        let mut z_commit: *const i8 = core::ptr::null();
        let mut len__3: Tcl_Size = 0;
        let mut p_result_1: *mut Tcl_Obj = core::ptr::null_mut();
        let mut is_complete: i32 = 0;
        let mut p_result_2: *mut Tcl_Obj = core::ptr::null_mut();
        let mut ii: i32 = 0;
        let mut v: i32 = 0;
        ...
        let mut p_result_4: *mut Tcl_Obj = core::ptr::null_mut();
        ...
        let mut p_var_name: *mut Tcl_Obj = core::ptr::null_mut();
        let mut p_script: *mut Tcl_Obj = core::ptr::null_mut();
        let mut flags__1: i32 = 0;
        let mut p_func: *mut SqlFunc = core::ptr::null_mut();
        let mut p_script_1: *mut Tcl_Obj = core::ptr::null_mut();
        ...
        let mut i_row: Tcl_WideInt = 0 as Tcl_WideInt;
        let mut len__5: Tcl_Size = 0;
        let mut z_null_1: *const i8 = core::ptr::null();
        let mut p_result_5: *mut Tcl_Obj = core::ptr::null_mut();
        let mut rowid: Tcl_WideInt = 0 as Tcl_WideInt;
        let mut z_progress: *const i8 = core::ptr::null();
        let mut len__6: Tcl_Size = 0;
        let mut n__2: i32 = 0;
        let mut z_profile: *const i8 = core::ptr::null();
        let mut len__7: Tcl_Size = 0;
        ...
        let mut p_backup_1: *mut sqlite3_backup = core::ptr::null_mut();
        ...
        let mut ms: i32 = 0;
        let mut p_result_6: *mut Tcl_Obj = core::ptr::null_mut();
        let mut z_trace: *const i8 = core::ptr::null();
        let mut len__8: Tcl_Size = 0;
        let mut z_trace_v2: *const i8 = core::ptr::null();
        let mut len__9: Tcl_Size = 0;
        let mut w_mask: Tcl_WideInt = 0 as Tcl_WideInt;
        let mut i__4: Tcl_Size = 0;
        let mut p_obj: *mut Tcl_Obj = core::ptr::null_mut();
        let mut ttype: i32 = 0;
        let mut w_type: Tcl_WideInt = 0 as Tcl_WideInt;
        let mut p_error: *mut Tcl_Obj = core::ptr::null_mut();
        let mut p_script_2: *mut Tcl_Obj = core::ptr::null_mut();
        let mut z_begin: *const i8 = core::ptr::null();
        let mut ttype__1: i32 = 0;
        let mut pp_hook: *mut *mut Tcl_Obj = core::ptr::null_mut();
        let mut i__5: i32 = 0;
        ...
        loop {
            ...
            '__s55:
                ...
                match __state {
                    ...
                    254 => {
                        if (ii as u64) <
                                core::mem::size_of::<[DbConfigChoices_N15DbConfigChoices; 16]>()
                                        as u64 /
                                    core::mem::size_of::<DbConfigChoices_N15DbConfigChoices>()
                                        as u64 {
                            __state = 255;
                        } else { __state = 250; }
                    }
                    ...
                    353 => {
                        unsafe {
                            Tcl_SetChannelOption(0 as *mut () as *mut Tcl_Interp, in_,
                    ...
                    422 => { __state = 423; }
                    423 => { __state = 424; }
                    424 => { mx_size = 0 as sqlite3_int64; __state = 425; }
                    425 => { __state = 426; }
                    ...
                    441 => { mx_size = x as sqlite3_int64; __state = 443; }
                    442 => { __state = 2; }
                    443 => { __state = 435; }
                    444 => {
                    ...
                    455 => {
                        p_data =
                            unsafe { sqlite3_malloc64(len__4 as sqlite3_uint64) } as
                                *mut u8;
                        __state = 456;
                    }
                    456 => {
                        ...
                        xrc =
                            unsafe {
                                sqlite3_deserialize(unsafe { (*p_db).db }, z_schema, p_data,
                                    len__4 as sqlite3_int64, len__4 as sqlite3_int64,
                                    flags as u32)
                            };
                        __state = 467;
                    }
                    ...
                    635 => {
                        rc =
                            create_incrblob_channel(interp, p_db, z_db, z_table_1,
                                z_column, i_row as sqlite3_int64, is_readonly_1);
                        __state = 634;
                    }
                    636 => { __state = 38; }
                    637 => { __state = 13; }
                    ...
                    748 => { __state = 13; }
                    749 => { __state = 45; }
                    750 => { sz = 0 as sqlite3_int64; __state = 751; }
                    751 => { __state = 752; }
                    752 => {
                        if objc != 2 && objc != 3 {
                            __state = 754;
                    ...
                    826 => { __state = 827; }
                    827 => { w_mask = 0 as Tcl_WideInt; __state = 828; }
                    828 => {
                    ...
                    830 => { __state = 832; }
                    831 => { w_mask = 1 as Tcl_WideInt; __state = 829; }
                    832 => { __state = 833; }
                    833 => { __state = 834; }
                    834 => {
                        if 0 !=
                    ...
                    858 => { w_mask |= 1 as Tcl_WideInt; __state = 863; }
                    859 => { w_mask |= 2 as Tcl_WideInt; __state = 865; }
                    860 => { w_mask |= 4 as Tcl_WideInt; __state = 867; }
                    861 => { w_mask |= 8 as Tcl_WideInt; __state = 869; }
                    862 => { __state = 858; }
                    863 => { __state = 839; }
                    864 => { __state = 859; }
                    865 => { __state = 839; }
...
extern "C" fn sqlite_cmd_usage(interp: *mut Tcl_Interp,
    objv: *const *mut Tcl_Obj) -> i32 {
    unsafe {
        Tcl_WrongNumArgs(interp, 1, objv,
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_unload(interp: *const Tcl_Interp, flags: i32)
    -> i32 {
    return 0;
}
#[unsafe(no_mangle)]
pub extern "C" fn tclsqlite3_unload(interp: *const Tcl_Interp, flags: i32)
    -> i32 {
    return 0;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_safe_init(interp: *const Tcl_Interp) -> i32 {
    return 1;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_safe_unload(interp: *const Tcl_Interp, flags: i32)
    -> i32 {
    return 1;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite_unload(interp: *const Tcl_Interp, flags: i32)
    -> i32 {
    return 0;
}
#[unsafe(no_mangle)]
pub extern "C" fn tclsqlite_unload(interp: *const Tcl_Interp, flags: i32)
    -> i32 {
    return 0;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite_safe_init(interp: *const Tcl_Interp) -> i32 {
    return 1;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite_safe_unload(interp: *const Tcl_Interp, flags: i32)
    -> i32 {
    return 1;
}
...
type sqlite3_auth_cb =
    unsafe extern "C" fn(*mut (), i32, *const i8, *const i8, *const i8,
        *const i8) -> i32;
#[repr(C)]
#[derive(Copy, Clone)]
struct DbConfigChoices_N15DbConfigChoices {
    z_name: *const i8,
    op: i32,
}
...
static mut a_db_config: [DbConfigChoices_N15DbConfigChoices; 16] =
    [DbConfigChoices_N15DbConfigChoices {
...
extern "C" {
    ...
    -> i32;
    fn Tcl_UnregisterChannel(interp: *mut Tcl_Interp, chan: Tcl_Channel)
    -> i32;
    fn Tcl_Free(ptr: *mut i8)
    -> ();
    fn Tcl_SetResult(interp: *mut Tcl_Interp, result: *mut i8,
    ...
    -> *mut ();
    fn Tcl_CreateChannel(typePtr: *mut Tcl_ChannelType, chanName: *const i8,
    instanceData: ClientData, mask: i32)
    -> Tcl_Channel;
    fn Tcl_RegisterChannel(interp: *mut Tcl_Interp, chan: Tcl_Channel)
    -> ();
    fn Tcl_GetChannelName(chan: Tcl_Channel)
    -> *const i8;
    fn Tcl_GetStringFromObj(objPtr: *mut Tcl_Obj, lengthPtr: *mut i32)
    -> *mut i8;
    fn memcpy(__dst: *mut (), __src: *const (), __n: u64)
    -> *mut ();
    fn TclFreeObj(objPtr: *mut Tcl_Obj)
    -> ();
    fn Tcl_VarEval(interp: *mut Tcl_Interp, ...)
    -> i32;
    fn Tcl_GetStringResult(interp: *mut Tcl_Interp)
    -> *const i8;
    fn atoi(_: *const i8)
    -> i32;
    fn Tcl_Eval(interp: *mut Tcl_Interp, script: *const i8)
    -> i32;
    fn Tcl_DStringInit(dsPtr: *mut Tcl_DString)
    -> ();
    fn Tcl_DStringAppend(dsPtr: *mut Tcl_DString, bytes: *const i8,
    length: i32)
    -> *mut i8;
    fn Tcl_DStringAppendElement(dsPtr: *mut Tcl_DString, element: *const i8)
    -> *mut i8;
    ...
    -> i32;
    fn Tcl_EvalObjEx(interp: *mut Tcl_Interp, objPtr: *mut Tcl_Obj,
    flags: i32)
    -> i32;
    fn Tcl_BackgroundError(interp: *mut Tcl_Interp)
    -> ();
    fn Tcl_DuplicateObj(objPtr: *mut Tcl_Obj)
    -> *mut Tcl_Obj;
    fn Tcl_NewIntObj(intValue: i32)
    -> *mut Tcl_Obj;
    fn Tcl_GetObjResult(interp: *mut Tcl_Interp)
    -> *mut Tcl_Obj;
    fn Tcl_GetIntFromObj(interp: *mut Tcl_Interp, objPtr: *mut Tcl_Obj,
    intPtr: *mut i32)
    -> i32;
    fn Tcl_ListObjGetElements(interp: *mut Tcl_Interp, listPtr: *mut Tcl_Obj,
    objcPtr: *mut i32, objvPtr: *mut *mut *mut Tcl_Obj)
    -> i32;
    fn Tcl_NewListObj(objc: i32, objv: *const *mut Tcl_Obj)
    -> *mut Tcl_Obj;
    ...
    -> i32;
    fn Tcl_GetByteArrayFromObj(objPtr: *mut Tcl_Obj, lengthPtr: *mut i32)
    -> *mut u8;
    fn Tcl_GetWideIntFromObj(interp: *mut Tcl_Interp, objPtr: *mut Tcl_Obj,
    widePtr: *mut Tcl_WideInt)
    -> i32;
    fn Tcl_GetDoubleFromObj(interp: *mut Tcl_Interp, objPtr: *mut Tcl_Obj,
    doublePtr: *mut f64)
    -> i32;
    fn Tcl_GlobalEval(interp: *mut Tcl_Interp, command: *const i8)
    -> i32;
    ...
    -> ();
    fn Tcl_GetVar2Ex(interp: *mut Tcl_Interp, part1: *const i8,
    part2: *const i8, flags: i32)
    -> *mut Tcl_Obj;
    fn Tcl_GetBooleanFromObj(interp: *mut Tcl_Interp, objPtr: *mut Tcl_Obj,
    boolPtr: *mut i32)
    -> i32;
    fn Tcl_NewObj()
    -> *mut Tcl_Obj;
    fn Tcl_ObjSetVar2(interp: *mut Tcl_Interp, part1Ptr: *mut Tcl_Obj,
    part2Ptr: *mut Tcl_Obj, newValuePtr: *mut Tcl_Obj, flags: i32)
    -> *mut Tcl_Obj;
    fn Tcl_ObjGetVar2(interp: *mut Tcl_Interp, part1Ptr: *mut Tcl_Obj,
    part2Ptr: *mut Tcl_Obj, flags: i32)
    -> *mut Tcl_Obj;
    fn Tcl_NewDictObj()
    -> *mut Tcl_Obj;
    fn Tcl_DictObjPut(interp: *mut Tcl_Interp, dictPtr: *mut Tcl_Obj,
    keyPtr: *mut Tcl_Obj, valuePtr: *mut Tcl_Obj)
    -> i32;
    fn Tcl_UnsetVar2(interp: *mut Tcl_Interp, part1: *const i8,
    part2: *const i8, flags: i32)
    -> i32;
    fn Tcl_DictObjRemove(interp: *mut Tcl_Interp, dictPtr: *mut Tcl_Obj,
    keyPtr: *mut Tcl_Obj)
    -> i32;
    fn Tcl_GetIndexFromObj(interp: *mut Tcl_Interp, objPtr: *mut Tcl_Obj,
    ...
    -> ();
    fn Tcl_DeleteCommand(interp: *mut Tcl_Interp, cmdName: *const i8)
    -> i32;
    fn Tcl_SetWideIntObj(objPtr: *mut Tcl_Obj, wideValue: Tcl_WideInt)
    -> ();
    fn Tcl_SetBooleanObj(objPtr: *mut Tcl_Obj, boolValue: i32)
    -> ();
    fn malloc(__size: u64)
    -> *mut ();
    fn free(_: *mut ())
    -> ();
    fn Tcl_OpenFileChannel(interp: *mut Tcl_Interp, fileName: *const i8,
    modeString: *const i8, permissions: i32)
    -> Tcl_Channel;
    fn Tcl_SetChannelOption(interp: *mut Tcl_Interp, chan: Tcl_Channel,
    optionName: *const i8, newValue: *const i8)
    -> i32;
    fn Tcl_Close(interp: *mut Tcl_Interp, chan: Tcl_Channel)
    -> i32;
    fn Tcl_GetsObj(chan: Tcl_Channel, objPtr: *mut Tcl_Obj)
    -> i32;
    fn strncmp(__s1: *const i8, __s2: *const i8, __n: u64)
    -> i32;
    fn Tcl_SetObjLength(objPtr: *mut Tcl_Obj, length: i32)
    -> ();
    fn Tcl_SetIntObj(objPtr: *mut Tcl_Obj, intValue: i32)
    -> ();
    fn Tcl_NewBooleanObj(boolValue: i32)
    -> *mut Tcl_Obj;
    fn Tcl_ListObjLength(interp: *mut Tcl_Interp, listPtr: *mut Tcl_Obj,
    lengthPtr: *mut i32)
    -> i32;
    fn Tcl_ListObjIndex(interp: *mut Tcl_Interp, listPtr: *mut Tcl_Obj,
    index: i32, objPtrPtr: *mut *mut Tcl_Obj)
    -> i32;
