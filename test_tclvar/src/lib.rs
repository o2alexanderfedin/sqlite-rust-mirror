...
extern "C" fn tclvar_open(p_v_tab_1: *mut Sqlite3Vtab,
    ...
    p_cur =
        unsafe {
                sqlite3_malloc_zero(core::mem::size_of::<TclvarCursor>() as
                        u64)
            } as *mut TclvarCursor;
...
extern "C" fn tclvar_next(cur: *mut Sqlite3VtabCursor) -> i32 {
    unsafe {
        ...
        let interp: *mut TclInterp =
            unsafe {
                (*(unsafe { (*cur).p_vtab } as *mut TclvarVtab)).interp
            };
        unsafe {
...
extern "C" fn tclvar_filter(p_vtab_cursor_1: *mut Sqlite3VtabCursor,
    ...
    unsafe {
        let p_cur: *mut TclvarCursor = p_vtab_cursor_1 as *mut TclvarCursor;
        let interp: *mut TclInterp =
            unsafe {
                (*(unsafe { (*p_vtab_cursor_1).p_vtab } as
                                *mut TclvarVtab)).interp
            };
        let p: *mut TclObj =
            unsafe {
...
extern "C" fn tclvar_column(cur: *mut Sqlite3VtabCursor,
    ...
    unsafe {
        let mut p1: *mut TclObj = core::ptr::null_mut();
        let mut p2: *mut TclObj = core::ptr::null_mut();
    ...
    unsafe {
        ...
        unsafe {
            sqlite3_create_module(db,
                ...
                &raw mut tclvar_module as *const Sqlite3Module,
                interp as *mut ())
        };
        rc =
            unsafe {
...
extern "C" {
    ...
    boolPtr: *mut i32)
    -> i32;
    fn Tcl_UnsetVar(interp: *mut TclInterp, varName: *const i8, flags: i32)
    -> i32;
