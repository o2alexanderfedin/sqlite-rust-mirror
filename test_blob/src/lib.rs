...
extern "C" fn blob_handle_from_obj(interp: *mut TclInterp,
    ...
    if n == 0 {
        *pp_blob_1 = core::ptr::null_mut();
        ...
        let mut channel: TclChannel = core::ptr::null_mut();
        ...
        unsafe { Tcl_Seek(channel, 0 as TclWideInt, 0) };
        instance_data = unsafe { Tcl_GetChannelInstanceData(channel) };
        *pp_blob_1 = unsafe { *(instance_data as *mut *mut Sqlite3Blob) };
    } else {
        *pp_blob_1 =
...
extern "C" fn test_blob_open(client_data_1: ClientData,
    ...
    let mut i_rowid: TclWideInt = 0 as TclWideInt;
    let mut flags: i32 = 0;
...
extern "C" {
    ...
    -> i32;
    fn Tcl_GetChannel(interp: *mut TclInterp, chanName: *const i8,
    modePtr: *mut i32)
    -> TclChannel;
    fn Tcl_Flush(chan: TclChannel)
    -> i32;
    fn Tcl_Seek(chan: TclChannel, offset: TclWideInt, mode: i32)
    -> TclWideInt;
    fn Tcl_GetChannelInstanceData(chan: TclChannel)
    -> ClientData;
