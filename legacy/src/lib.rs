        ...
        loop {
            ...
            '__s1:
                ...
                match __state {
                    ...
                    5 => { az_cols = core::ptr::null_mut(); __state = 6; }
                    6 => { __state = 7; }
                    7 => {
                    ...
                    8 => {
                        if z_sql_1 == core::ptr::null() {
                            __state = 11;
                        } else { __state = 10; }
                    }
                    9 => { return unsafe { sqlite3_misuse_error(43) }; }
                    10 => {
                        unsafe { sqlite3_mutex_enter(unsafe { (*db).mutex }) };
                        __state = 12;
                    }
                    11 => {
                        z_sql_1 = c"".as_ptr() as *mut i8 as *const i8;
                        __state = 10;
                    }
                    12 => { unsafe { sqlite3_error(db, 0) }; __state = 13; }
                    13 => {
                        if rc == 0 && unsafe { *z_sql_1.offset(0 as isize) } != 0 {
                            __state = 15;
                        } else { __state = 14; }
                    }
                    14 => { __state = 2; }
                    15 => { n_col = 0; __state = 16; }
                    16 => { az_vals = core::ptr::null_mut(); __state = 17; }
                    17 => { p_stmt = core::ptr::null_mut(); __state = 18; }
                    18 => {
                        rc =
                            unsafe {
                    ...
                    22 => { __state = 13; }
                    23 => { callback_is_init = 0; __state = 26; }
                    24 => { z_sql_1 = z_leftover; __state = 25; }
                    25 => { __state = 13; }
                    26 => { if 1 != 0 { __state = 28; } else { __state = 27; } }
                    27 => {
                        unsafe { sqlite3_db_free(db, az_cols as *mut ()) };
                        __state = 65;
                    }
                    28 => { __state = 29; }
                    29 => {
                    ...
                    30 => {
                        if x_callback_1.is_some() &&
                                (100 == rc ||
                                    101 == rc && (callback_is_init == 0) as i32 != 0 &&
                                        unsafe { (*db).flags } & 256 as u64 != 0) {
                            __state = 32;
                        } else { __state = 31; }
                    }
                    31 => {
                        if rc != 100 { __state = 59; } else { __state = 26; }
                    }
                    32 => {
                        if (callback_is_init == 0) as i32 != 0 {
                            __state = 34;
                        } else { __state = 33; }
                    }
                    33 => {
                        if rc == 100 { __state = 45; } else { __state = 44; }
                    }
                    34 => {
                    ...
                    36 => {
                        if az_cols == core::ptr::null_mut() {
                            __state = 38;
                        } else { __state = 37; }
                    }
                    37 => { i = 0; __state = 40; }
                    38 => { __state = 2; }
                    39 => { callback_is_init = 1; __state = 33; }
                    40 => {
                        if i < n_col { __state = 41; } else { __state = 39; }
                    }
                    41 => {
                        unsafe {
                            *az_cols.offset(i as isize) =
                                unsafe { sqlite3_column_name(p_stmt, i) } as *mut i8
                        };
                        __state = 43;
                    }
                    42 => {
                    ...
                    44 => {
                        if unsafe {
                                    x_callback_1.unwrap()(p_arg_1, n_col, az_vals, az_cols)
                                } != 0 {
                            __state = 54;
                        } else { __state = 31; }
                    }
                    45 => {
                        az_vals = unsafe { az_cols.offset(n_col as isize) };
                        __state = 46;
                    }
                    46 => { i = 0; __state = 48; }
                    47 => {
                        unsafe {
                            *az_vals.offset(i as isize) = core::ptr::null_mut()
                        };
                        __state = 44;
                    }
                    48 => {
                        if i < n_col { __state = 49; } else { __state = 47; }
                    }
                    49 => {
                        unsafe {
                            *az_vals.offset(i as isize) =
                                unsafe { sqlite3_column_text(p_stmt, i) } as *mut i8
                        };
                        __state = 51;
                    }
                    50 => {
                    ...
                    51 => {
                        if (unsafe { *az_vals.offset(i as isize) }).is_null() as i32
                                    != 0 && unsafe { sqlite3_column_type(p_stmt, i) } != 5 {
                            __state = 52;
                        } else { __state = 50; }
                    }
                    52 => { unsafe { sqlite3_oom_fault(db) }; __state = 53; }
                    53 => { __state = 2; }
                    54 => { rc = 4; __state = 55; }
                    55 => {
                        unsafe { sqlite3_vdbe_finalize(p_stmt as *mut Vdbe) };
                        __state = 56;
                    }
                    56 => { p_stmt = core::ptr::null_mut(); __state = 57; }
                    57 => { unsafe { sqlite3_error(db, 4) }; __state = 58; }
                    58 => { __state = 2; }
                    59 => {
                        rc = unsafe { sqlite3_vdbe_finalize(p_stmt as *mut Vdbe) };
                        __state = 60;
                    }
                    60 => { p_stmt = core::ptr::null_mut(); __state = 61; }
                    61 => { z_sql_1 = z_leftover; __state = 62; }
                    62 => {
                        if unsafe {
                                            *(sqlite3_ctype_map.as_ptr() as
                                                        *const u8).add(unsafe { *z_sql_1.offset(0 as isize) } as u8
                                                        as usize)
                                        } as i32 & 1 != 0 {
                            __state = 64;
                        } else { __state = 63; }
                    ...
                    65 => { az_cols = core::ptr::null_mut(); __state = 13; }
                    66 => {
                        unsafe { sqlite3_db_free(db, az_cols as *mut ()) };
                        __state = 68;
                    }
                    ...
                    73 => {
                        if unsafe { *pz_err_msg_1 } == core::ptr::null_mut() {
                            __state = 74;
                        } else { __state = 70; }
                    }
                    74 => { rc = 7; __state = 75; }
                    75 => { unsafe { sqlite3_error(db, 7) }; __state = 70; }
                    76 => {
