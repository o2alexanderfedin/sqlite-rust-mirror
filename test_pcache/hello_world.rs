...
extern "C" fn testpcache_init(p_arg_1: *mut ()) -> i32 {
    unsafe {
        if !(p_arg_1 == &raw mut testpcache_global as *mut ()) as i32 as i64
                != 0 {
            unsafe {
                __assert_rtn(c"testpcacheInit".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 54,
                    c"pArg==(void*)&testpcacheGlobal".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy == core::ptr::null_mut()) as i32 as i64
                != 0 {
            unsafe {
                __assert_rtn(c"testpcacheInit".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 55,
                    c"testpcacheGlobal.pDummy==0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance == 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheInit".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 56,
                    c"testpcacheGlobal.nInstance==0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        testpcache_global.p_dummy = unsafe { sqlite3_malloc(10) };
        return if testpcache_global.p_dummy == core::ptr::null_mut() {
                7
            } else { 0 };
    }
}
extern "C" fn testpcache_shutdown(p_arg_1: *mut ()) -> () {
    unsafe {
        if !(p_arg_1 == &raw mut testpcache_global as *mut ()) as i32 as i64
                != 0 {
            unsafe {
                __assert_rtn(c"testpcacheShutdown".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 68,
                    c"pArg==(void*)&testpcacheGlobal".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheShutdown".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 69,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance == 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheShutdown".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 70,
                    c"testpcacheGlobal.nInstance==0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        unsafe { sqlite3_free(testpcache_global.p_dummy) };
...
extern "C" fn testpcache_random(p: &mut testpcache) -> u32 {
    ...
    let mut i: i32 = 0;
    {
        ...
        '__b0: loop {
            if !(i < 4) { break '__b0; }
            '__c0: loop {
                (*p).i_rand = (*p).i_rand * 69069 as u32 + 5 as u32;
                x = x << 8 | (*p).i_rand >> 16 & 255 as u32;
                break '__c0;
            }
...
extern "C" fn testpcache_create(mut sz_page_1: i32, mut sz_extra_1: i32,
    ...
    unsafe {
        let mut n_mem: i32 = 0;
        let mut x: *mut i8 = core::ptr::null_mut();
        let mut p: *mut testpcache = core::ptr::null_mut();
        let mut i: i32 = 0;
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
                != 0 {
            unsafe {
                __assert_rtn(c"testpcacheCreate".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 142,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        sz_page_1 = sz_page_1 + 7 & !7;
        sz_extra_1 = sz_page_1 + 7 & !7;
        n_mem =
            (core::mem::size_of::<testpcache>() as u64 +
                    (217 * (sz_page_1 + sz_extra_1)) as u64) as i32;
        p = unsafe { sqlite3_malloc(n_mem) } as *mut testpcache;
        if p == core::ptr::null_mut() { return core::ptr::null_mut(); }
        x = unsafe { &raw mut *p.offset(1 as isize) } as *mut i8;
        unsafe { (*p).sz_page = sz_page_1 as sqlite3_int64 };
        unsafe { (*p).sz_extra = sz_extra_1 };
        unsafe { (*p).n_free = 217 };
        unsafe { (*p).n_pinned = 0 };
        unsafe { (*p).i_rand = testpcache_global.prng_seed };
        unsafe { (*p).b_purgeable = b_purgeable_1 };
        unsafe { (*p).i_magic = 910525949 as u32 };
        {
            i = 0;
            '__b1: loop {
                if !(i < 217) { break '__b1; }
                '__c1: loop {
                    unsafe { (*p).a[i as usize].key = 0 as u32 };
                    unsafe { (*p).a[i as usize].is_pinned = 0 };
                    unsafe { (*p).a[i as usize].page.p_buf = x as *mut () };
                    unsafe {
                        (*p).a[i as usize].page.p_extra =
                            unsafe { &raw mut *x.offset(sz_page_1 as isize) } as *mut ()
                    };
                    break '__c1;
                }
                {
        ...
        {
            let __p = &mut testpcache_global.n_instance;
            let __t = *__p;
            *__p += 1;
            __t
        };
...
extern "C" fn testpcache_cachesize(p_cache_1: *mut sqlite3_pcache,
    new_size_1: i32) -> () {
    unsafe {
        let p: *const testpcache =
            p_cache_1 as *mut testpcache as *const testpcache;
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheCachesize".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 171,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheCachesize".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 172,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheCachesize".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 173,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
...
extern "C" fn testpcache_pagecount(p_cache_1: *mut sqlite3_pcache) -> i32 {
    unsafe {
        let p: *const testpcache =
            p_cache_1 as *mut testpcache as *const testpcache;
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcachePagecount".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 182,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcachePagecount".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 183,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcachePagecount".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 184,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
...
extern "C" fn testpcache_fetch(p_cache_1: *mut sqlite3_pcache, key: u32,
    ...
    unsafe {
        ...
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 198,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 199,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 200,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        {
            ...
            '__b2: loop {
                if !(i < 217) { break '__b2; }
                '__c2: loop {
                    if unsafe { (*p).a[i as usize].key } == key {
                        if (unsafe { (*p).a[i as usize].is_pinned } == 0) as i32 !=
                                0 {
                            {
                                let __p = unsafe { &mut (*p).n_pinned };
                                let __t = *__p;
                                *__p += 1;
                                __t
                            };
                            if !(unsafe { (*p).n_pinned } <=
                                                    217 - unsafe { (*p).n_free }) as i32 as i64 != 0 {
                                unsafe {
                                    __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                                        c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 207,
                                        c"p->nPinned <= TESTPCACHE_NPAGE - p->nFree".as_ptr() as
                                                *mut i8 as *const i8)
                                }
                            } else { { let _ = 0; } };
                            unsafe { (*p).a[i as usize].is_pinned = 1 };
                        }
                        return unsafe { &mut (*p).a[i as usize].page };
                    }
                    break '__c2;
                }
                { let __p = &mut i; let __t = *__p; *__p += 1; __t };
        ...
        if create_flag_1 == 0 { return core::ptr::null_mut(); }
        if unsafe { (*p).n_pinned } == 217 { return core::ptr::null_mut(); }
        if unsafe { (*p).n_pinned } >= 217 - 17 && create_flag_1 < 2 {
            return core::ptr::null_mut();
        }
        if testpcache_global.high_stress != 0 && create_flag_1 < 2 {
            return core::ptr::null_mut();
        }
        if unsafe { (*p).n_free } > 17 ||
                create_flag_1 == 2 && unsafe { (*p).n_free } > 0 {
            j = (testpcache_random(unsafe { &mut *p }) % 217 as u32) as i32;
            {
                ...
                '__b3: loop {
                    if !(i < 217) { break '__b3; }
                    '__c3: loop {
                        if unsafe { (*p).a[j as usize].key } == 0 as u32 {
                            unsafe { (*p).a[j as usize].key = key };
                            unsafe { (*p).a[j as usize].is_pinned = 1 };
                            unsafe {
                                memset(unsafe { (*p).a[j as usize].page.p_buf }, 0,
                                    unsafe { (*p).sz_page } as u64)
                            };
                            unsafe {
                                memset(unsafe { (*p).a[j as usize].page.p_extra }, 0,
                                    unsafe { (*p).sz_extra } as u64)
                            };
                            {
                                let __p = unsafe { &mut (*p).n_pinned };
                                let __t = *__p;
                            ...
                            if !(unsafe { (*p).n_pinned } <=
                                ...
                                unsafe {
                                    __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                                        c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 251,
                                        c"p->nPinned <= TESTPCACHE_NPAGE - p->nFree".as_ptr() as
                                                *mut i8 as *const i8)
                                }
                            } else { { let _ = 0; } };
                            return unsafe { &mut (*p).a[j as usize].page };
                        }
                        break '__c3;
                    }
                    {
            ...
            if (0 == 0) as i32 as i64 != 0 {
                unsafe {
                    __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                        c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 257,
        ...
        j = (testpcache_random(unsafe { &mut *p }) % 217 as u32) as i32;
        {
            ...
            '__b4: loop {
                ...
                '__c4: loop {
                    if unsafe { (*p).a[j as usize].key } > 0 as u32 &&
                            unsafe { (*p).a[j as usize].is_pinned } == 0 {
                        unsafe { (*p).a[j as usize].key = key };
                        unsafe { (*p).a[j as usize].is_pinned = 1 };
                        unsafe {
                            memset(unsafe { (*p).a[j as usize].page.p_buf }, 0,
                        ...
                        if !(unsafe { (*p).n_pinned } <=
                            ...
                            unsafe {
                                __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 277,
                                    c"p->nPinned <= TESTPCACHE_NPAGE - p->nFree".as_ptr() as
                                            *mut i8 as *const i8)
                            }
                        } else { { let _ = 0; } };
        ...
        if (0 == 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheFetch".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 283,
                    c"0".as_ptr() as *mut i8 as *const i8)
            }
        } else { { let _ = 0; } };
        return core::ptr::null_mut();
...
extern "C" fn testpcache_unpin(p_cache_1: *mut sqlite3_pcache,
    p_old_page_1: *mut sqlite3_pcache_page, mut discard: i32) -> () {
    unsafe {
        let p: *mut testpcache = p_cache_1 as *mut testpcache;
        let mut i: i32 = 0;
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 297,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 298,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 299,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if unsafe { (*p).b_purgeable } != 0 &&
                100 as u32 - testpcache_global.discard_chance <=
                    testpcache_random(unsafe { &mut *p }) % 100 as u32 {
            discard = 1;
        }
        {
            i = 0;
            '__b5: loop {
                ...
                '__c5: loop {
                    if unsafe { &raw mut (*p).a[i as usize].page } as
                                *mut sqlite3_pcache_page == p_old_page_1 {
                        if (unsafe { (*p).a[i as usize].is_pinned } == 0) as i32 as
                                    i64 != 0 {
                            unsafe {
                                __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 314,
                                    c"p->a[i].isPinned".as_ptr() as *mut i8 as *const i8)
                            }
                        } else { { let _ = 0; } };
                        unsafe { (*p).a[i as usize].is_pinned = 0 };
                        {
                        ...
                        if !(unsafe { (*p).n_pinned } >= 0) as i32 as i64 != 0 {
                            unsafe {
                                __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 317,
                                    c"p->nPinned>=0".as_ptr() as *mut i8 as *const i8)
                            }
                        } else { { let _ = 0; } };
                        if discard != 0 {
                            unsafe { (*p).a[i as usize].key = 0 as u32 };
                            ...
                            if !(unsafe { (*p).n_free } <= 217) as i32 as i64 != 0 {
                                unsafe {
                                    __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                                        c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 321,
                                        c"p->nFree<=TESTPCACHE_NPAGE".as_ptr() as *mut i8 as
                                            *const i8)
                                }
                            } else { { let _ = 0; } };
                        }
        ...
        if (0 == 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheUnpin".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 328,
                    c"0".as_ptr() as *mut i8 as *const i8)
            }
        } else { { let _ = 0; } };
    }
}
extern "C" fn testpcache_rekey(p_cache_1: *mut sqlite3_pcache,
    p_old_page_1: *mut sqlite3_pcache_page, old_key_1: u32, new_key_1: u32)
    -> () {
    unsafe {
        let p: *mut testpcache = p_cache_1 as *mut testpcache;
        let mut i: i32 = 0;
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 343,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 344,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 345,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
                ...
                '__c6: loop {
                    if unsafe { (*p).a[i as usize].key } == new_key_1 {
                        if !(unsafe { (*p).a[i as usize].is_pinned } == 0) as i32 as
                            ...
                            unsafe {
                                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 353,
                                    c"p->a[i].isPinned==0".as_ptr() as *mut i8 as *const i8)
                            }
                        } else { { let _ = 0; } };
                        unsafe { (*p).a[i as usize].key = 0 as u32 };
                        {
                        ...
                        if !(unsafe { (*p).n_free } <= 217) as i32 as i64 != 0 {
                            unsafe {
                                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 356,
                                    c"p->nFree<=TESTPCACHE_NPAGE".as_ptr() as *mut i8 as
                                        *const i8)
                            }
                        } else { { let _ = 0; } };
            ...
            '__b7: loop {
                ...
                '__c7: loop {
                    if unsafe { (*p).a[i as usize].key } == old_key_1 {
                        if !(unsafe { &raw mut (*p).a[i as usize].page } as
                                                    *mut sqlite3_pcache_page == p_old_page_1) as i32 as i64 != 0
                            {
                            unsafe {
                                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 366,
                        ...
                        if (unsafe { (*p).a[i as usize].is_pinned } == 0) as i32 as
                            ...
                            unsafe {
                                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 368,
                                    c"p->a[i].isPinned".as_ptr() as *mut i8 as *const i8)
                            }
                        } else { { let _ = 0; } };
                        unsafe { (*p).a[i as usize].key = new_key_1 };
                        return;
                    }
                    break '__c7;
                }
        ...
        if (0 == 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheRekey".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 375,
                    c"0".as_ptr() as *mut i8 as *const i8)
            }
        } else { { let _ = 0; } };
    }
}
extern "C" fn testpcache_truncate(p_cache_1: *mut sqlite3_pcache,
    i_limit_1: u32) -> () {
    unsafe {
        let p: *mut testpcache = p_cache_1 as *mut testpcache;
        ...
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheTruncate".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 386,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheTruncate".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 387,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheTruncate".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 388,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        {
            i = 0 as u32;
            '__b8: loop {
                if !(i < 217 as u32) { break '__b8; }
                '__c8: loop {
                    if unsafe { (*p).a[i as usize].key } >= i_limit_1 {
                        unsafe { (*p).a[i as usize].key = 0 as u32 };
                        if unsafe { (*p).a[i as usize].is_pinned } != 0 {
                            {
                                let __p = unsafe { &mut (*p).n_pinned };
                                let __t = *__p;
                                *__p -= 1;
                            ...
                            if !(unsafe { (*p).n_pinned } >= 0) as i32 as i64 != 0 {
                                unsafe {
                                    __assert_rtn(c"testpcacheTruncate".as_ptr() as *const i8,
                                        c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 394,
                                        c"p->nPinned>=0".as_ptr() as *mut i8 as *const i8)
                                }
                            } else { { let _ = 0; } };
                        }
                        ...
                        if !(unsafe { (*p).n_free } <= 217) as i32 as i64 != 0 {
                            unsafe {
                                __assert_rtn(c"testpcacheTruncate".as_ptr() as *const i8,
                                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 397,
                                    c"p->nFree<=TESTPCACHE_NPAGE".as_ptr() as *mut i8 as
                                        *const i8)
                            }
                        } else { { let _ = 0; } };
...
extern "C" fn testpcache_destroy(p_cache_1: *mut sqlite3_pcache) -> () {
    unsafe {
        let p: *mut testpcache = p_cache_1 as *mut testpcache;
        if !(unsafe { (*p).i_magic } == 910525949 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheDestroy".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 407,
                    c"p->iMagic==TESTPCACHE_VALID".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy != core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"testpcacheDestroy".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 408,
                    c"testpcacheGlobal.pDummy!=0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.n_instance > 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"testpcacheDestroy".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 409,
                    c"testpcacheGlobal.nInstance>0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        unsafe { (*p).i_magic = 3559289044u32 };
...
pub extern "C" fn install_test_p_cache(install_flag_1: i32,
    ...
    unsafe {
        if !(testpcache_global.n_instance == 0) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"installTestPCache".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 451,
                    c"testpcacheGlobal.nInstance==0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(testpcache_global.p_dummy == core::ptr::null_mut()) as i32 as i64
            ...
            unsafe {
                __assert_rtn(c"installTestPCache".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 452,
                    c"testpcacheGlobal.pDummy==0".as_ptr() as *mut i8 as
                        *const i8)
            }
        } else { { let _ = 0; } };
        if !(discard_chance_1 <= 100 as u32) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"installTestPCache".as_ptr() as *const i8,
                    c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 453,
                    c"discardChance<=100".as_ptr() as *mut i8 as *const i8)
            }
        } else { { let _ = 0; } };
        testpcache_global.discard_chance = discard_chance_1;
        testpcache_global.prng_seed = prng_seed_1 ^ prng_seed_1 << 16;
        testpcache_global.high_stress = high_stress_1;
        if install_flag_1 != is_installed {
            if install_flag_1 != 0 {
                unsafe {
                    sqlite3_config(19,
                        &raw mut default_pcache as *mut sqlite3_pcache_methods2)
                };
                if !(default_pcache.x_create != Some(testpcache_create)) as
                                i32 as i64 != 0 {
                    unsafe {
                        __assert_rtn(c"installTestPCache".as_ptr() as *const i8,
                            c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 460,
                            c"defaultPcache.xCreate!=testpcacheCreate".as_ptr() as
                                    *mut i8 as *const i8)
                    }
                } else { { let _ = 0; } };
                unsafe {
                    sqlite3_config(18,
                        &raw const test_pcache as *const sqlite3_pcache_methods2)
                };
            } else {
                if !default_pcache.x_create.is_some() as i32 as i64 != 0 {
                    unsafe {
                        __assert_rtn(c"installTestPCache".as_ptr() as *const i8,
                            c"test_pcache.c".as_ptr() as *mut i8 as *const i8, 463,
                            c"defaultPcache.xCreate!=0".as_ptr() as *mut i8 as
                                *const i8)
                    }
                } else { { let _ = 0; } };
                unsafe {
            ...
            is_installed = install_flag_1;
        }
    }
}
static mut test_pcache: sqlite3_pcache_methods2 =
    sqlite3_pcache_methods2 {
        i_version: 1,
        p_arg: &raw mut testpcache_global as *mut (),
        x_init: Some(testpcache_init),
        x_shutdown: Some(testpcache_shutdown),
        x_create: Some(testpcache_create),
        x_cachesize: Some(testpcache_cachesize),
        x_pagecount: Some(testpcache_pagecount),
        x_fetch: Some(testpcache_fetch),
        x_unpin: Some(testpcache_unpin),
        x_rekey: Some(testpcache_rekey),
        x_truncate: Some(testpcache_truncate),
        x_destroy: Some(testpcache_destroy),
        x_shrink: None,
    };
static mut default_pcache: sqlite3_pcache_methods2 =
    unsafe { core::mem::zeroed() };
