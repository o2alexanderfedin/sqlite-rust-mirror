...
extern "C" fn fts5_config_gobble_word(p_rc_1: &mut i32, z_in_1: *const i8,
    ...
    let n_in: sqlite3_int64 = unsafe { strlen(z_in_1) } as sqlite3_int64;
    let z_out: *mut i8 =
        unsafe {
...
extern "C" fn fts5_config_parse_special(p_config_1: &mut Fts5Config,
    ...
    if unsafe {
        ...
        if (*p_config_1).a_prefix == core::ptr::null_mut() {
            (*p_config_1).a_prefix =
                unsafe {
                        sqlite3_fts5_malloc_zero(&mut rc, n_byte as sqlite3_int64)
                    } as *mut i32;
            if rc != 0 { return rc; }
        }
        p = z_arg_1;
    ...
    if unsafe {
        ...
        let mut n_arg: sqlite3_int64 =
            (unsafe { strlen(z_arg_1) } + 1 as u64) as sqlite3_int64;
        let mut az_arg: *mut *mut i8 =
            unsafe {
                    sqlite3_fts5_malloc_zero(&mut rc,
                        ((core::mem::size_of::<*mut i8>() as u64 + 2 as u64) *
                                n_arg as u64) as sqlite3_int64)
                } as *mut *mut i8;
        if !(az_arg).is_null() {
    ...
    n_byte =
        (n_arg as u64 *
                (core::mem::size_of::<*mut i8>() as u64 +
                    core::mem::size_of::<u8>() as u64)) as sqlite3_int64;
    unsafe {
        (*p_ret).az_col =
...
pub extern "C" fn sqlite3_fts5_config_set_value(p_config: &mut Fts5Config,
    z_key: *const i8, p_val: *mut sqlite3_value, pb_badkey: &mut i32) -> i32 {
    let mut rc: i32 = 0;
    if 0 ==
            unsafe {
...
pub extern "C" fn sqlite3_fts5_config_load(p_config: *mut Fts5Config,
    ...
    let mut z_sql: *mut i8 = core::ptr::null_mut();
    let mut p: *mut sqlite3_stmt = core::ptr::null_mut();
    let mut rc: i32 = 0;
