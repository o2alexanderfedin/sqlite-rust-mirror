...
extern "C" fn file_read(ofst: sqlite3_int64, n_byte_1: i32) -> *mut u8 {
    unsafe {
...
extern "C" fn file_getsize() -> i64 {
    unsafe {
        ...
        if g.b_raw == 0 {
            ...
            res = sbuf.st_size as sqlite3_int64;
        }
        return res;
    }
}
extern "C" fn print_byte_range(ofst: sqlite3_int64, n_byte_1: i32,
...
extern "C" fn print_db_header() -> () {
    let mut a_data: *mut u8 = core::ptr::null_mut();
    a_data = print_byte_range(0 as sqlite3_int64, 100, 0);
    ...
    unsafe {
        ...
        if n_local < n_payload {
            ...
            while ovfl != 0 &&
                ...
                a =
                    file_read((ovfl - 1 as u32) as sqlite3_int64 *
                            g.pagesize as sqlite3_int64, g.pagesize as i32);
...
extern "C" fn page_usage_report(z_prg_1: *const i8, z_db_name_1: *const i8)
    ...
    unsafe {
        ...
        a = file_read(0 as sqlite3_int64, 100);
                        ...
                        if g.b_tmstmp != 0 {
                            ...
                            let mut k: i32 = 0;
                            {
                                ...
                                '__b35: loop {
                                    ...
                                    '__c35: loop {
                                        tm =
                                            (tm << 8) +
                                                unsafe { *a.offset(k as isize) } as sqlite3_uint64;
                                        break '__c35;
                                    }
                                    { let __p = &mut k; let __t = *__p; *__p += 1; __t };
                                }
                            ...
                            unsafe {
                                printf(c"%llu.%03u,".as_ptr() as *mut i8 as *const i8,
                                    tm / 1000 as sqlite3_uint64,
                                    (tm % 1000 as sqlite3_uint64) as u32)
                            };
                            {
...
extern "C" fn ptrmap_coverage_report(z_db_name_1: *const i8) -> () {
    unsafe {
        ...
        a_hdr = file_read(0 as sqlite3_int64, 100);
                ...
                '__c39: loop {
                    ...
                    a =
                        file_read(((pgno - 1 as u64) * g.pagesize as u64) as
                                sqlite3_int64, g.pagesize as i32);
                    {
                        i = 0;
                        '__b40: loop {
...
extern "C" fn __main_inner(argc: i32, argv: *mut *mut i8) -> Result<(), i32> {
    unsafe {
        let mut sz_file: sqlite3_int64 = 0 as sqlite3_int64;
        ...
        z_pg_sz = file_read(0 as sqlite3_int64, 24);
        g.pagesize =
        ...
        g.mx_page =
            ((sz_file + g.pagesize - 1 as sqlite3_int64) / g.pagesize) as u32;
