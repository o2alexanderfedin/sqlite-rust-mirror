...
extern "C" fn wholenumber_open(p: *mut Sqlite3Vtab,
    ...
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<WholenumberCursor>() as
                        Sqlite3Uint64)
            } as *mut WholenumberCursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<WholenumberCursor>() as u64)
    };
...
extern "C" fn wholenumber_filter(p_vtab_cursor_1: *mut Sqlite3VtabCursor,
    ...
    let p_cur: *mut WholenumberCursor =
        p_vtab_cursor_1 as *mut WholenumberCursor;
    let mut v: Sqlite3Int64 = 0 as Sqlite3Int64;
    let mut i: i32 = 0;
    unsafe { (*p_cur).i_value = 1 as Sqlite3Int64 };
    unsafe { (*p_cur).mx_value = 4294967295u32 as Sqlite3Int64 };
    if idx_num_1 & 3 != 0 {
        v =
            unsafe {
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut wholenumber_module as *const Sqlite3Module,
                    core::ptr::null_mut())
            };
        return rc;
    }
