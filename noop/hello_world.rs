...
extern "C" fn noopfunc(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    if !(argc == 1) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"noopfunc".as_ptr() as *const i8,
                c"noop.c".as_ptr() as *mut i8 as *const i8, 37,
...
extern "C" fn multitype_text_func(context: *mut sqlite3_context, argc: i32,
    argv: *mut *mut sqlite3_value) -> () {
    if !(argc == 1) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"multitypeTextFunc".as_ptr() as *const i8,
                c"noop.c".as_ptr() as *mut i8 as *const i8, 53,
                c"argc==1".as_ptr() as *mut i8 as *const i8)
        }
    } else { { let _ = 0; } };
    { let _ = argc; };
...
pub extern "C" fn sqlite3_noop_init(db: *mut sqlite3,
    ...
    rc =
        unsafe {
            sqlite3_create_function(db,
                c"noop_i".as_ptr() as *mut i8 as *const i8, 1,
                1 | 2048 | 2097152, core::ptr::null_mut(), Some(noopfunc),
                None, None)
        };
    if rc != 0 { return rc; }
    rc =
        unsafe {
            sqlite3_create_function(db,
                c"noop_do".as_ptr() as *mut i8 as *const i8, 1,
                1 | 2048 | 524288, core::ptr::null_mut(), Some(noopfunc),
                None, None)
        };
    if rc != 0 { return rc; }
    rc =
        unsafe {
            sqlite3_create_function(db,
                c"noop_nd".as_ptr() as *mut i8 as *const i8, 1, 1,
                core::ptr::null_mut(), Some(noopfunc), None, None)
        };
    if rc != 0 { return rc; }
    rc =
        unsafe {
            sqlite3_create_function(db,
                c"multitype_text".as_ptr() as *mut i8 as *const i8, 1, 1,
                core::ptr::null_mut(), Some(multitype_text_func), None, None)
        };
    return rc;
}
extern "C" {
