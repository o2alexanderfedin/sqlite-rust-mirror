...
pub extern "C" fn sqlite3_vdbe_mem_finalize(p_mem_1: *mut Mem,
    ...
    unsafe {
        let mut ctx: sqlite3_context = unsafe { core::mem::zeroed() };
        let mut t: Mem = unsafe { core::mem::zeroed() };
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        ...
        if unsafe { (*p_mem_1).sz_malloc } > 0 {
            unsafe {
                sqlite3_db_free_nn(unsafe { (*p_mem_1).db },
                    unsafe { (*p_mem_1).z_malloc } as *mut ())
            };
        }
        unsafe {
            memcpy(p_mem_1 as *mut (), &raw mut t as *const (),
                core::mem::size_of::<Mem>() as u64)
        };
        return ctx.is_error;
    }
...
extern "C" fn vdbe_mem_clear_extern_and_set_null(p: *mut Mem) -> () {
    unsafe {
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p).flags } as i32 & 32768 != 0 {
            sqlite3_vdbe_mem_finalize(p, unsafe { (*p).u.p_def });
            { let _ = 0; };
        }
        if unsafe { (*p).flags } as i32 & 4096 != 0 {
            { let _ = 0; };
            unsafe {
                (unsafe { (*p).x_del.unwrap() })(unsafe { (*p).z } as *mut ())
            };
        }
        unsafe { (*p).flags = 1 as u16 };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_set_null(p_mem_1: *mut Mem) -> () {
    if unsafe { (*p_mem_1).flags } as i32 & (32768 | 4096) != 0 {
        vdbe_mem_clear_extern_and_set_null(p_mem_1);
...
pub extern "C" fn sqlite3_vdbe_mem_set_int64(p_mem_1: *mut Mem, val: i64)
    ...
    unsafe {
        if unsafe { (*p_mem_1).flags } as i32 & (32768 | 4096) != 0 {
            vdbe_release_and_set_int64(p_mem_1, val);
        } else {
            unsafe { (*p_mem_1).u.i = val };
            unsafe { (*p_mem_1).flags = 4 as u16 };
        }
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_mem_set_array_int64(a_mem_1: *mut sqlite3_value,
    i_idx_1: i32, val: i64) -> () {
    sqlite3_vdbe_mem_set_int64(unsafe {
                &raw mut *a_mem_1.offset(i_idx_1 as isize)
            } as *mut Mem, val);
}
#[repr(C)]
#[derive(Copy, Clone)]
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_real_same_as_int(mut r1: f64, i: sqlite3_int64)
    -> i32 {
    let mut r2: f64 = i as f64;
    return (r1 == 0.0 ||
                unsafe {
                                memcmp(&raw mut r1 as *const (), &raw mut r2 as *const (),
                                    core::mem::size_of::<f64>() as u64)
                            } == 0 && i >= -2251799813685248i64 &&
                    i < 2251799813685248i64) as i32;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_real_to_i64(r: f64) -> i64 {
    if r < -9.223372036854775e18 {
        return -1 as i64 - (4294967295u32 as i64 | (2147483647 as i64) << 32);
    }
    if r > 9.223372036854775e18 {
        return 4294967295u32 as i64 | (2147483647 as i64) << 32;
    }
    return r as i64;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_grow(p_mem_1: *mut Mem, n: i32,
    ...
    unsafe {
        ...
        if unsafe { (*p_mem_1).sz_malloc } > 0 && b_preserve_1 != 0 &&
                unsafe { (*p_mem_1).z } == unsafe { (*p_mem_1).z_malloc } {
            if !(unsafe { (*p_mem_1).db }).is_null() {
                unsafe {
                    (*p_mem_1).z =
                        {
                            unsafe {
                                (*p_mem_1).z_malloc =
                                    unsafe {
                                            sqlite3_db_realloc_or_free(unsafe { (*p_mem_1).db },
                                                unsafe { (*p_mem_1).z } as *mut (), n as u64)
                                        } as *mut i8
                            };
                ...
                unsafe {
                    (*p_mem_1).z_malloc =
                        unsafe {
                                sqlite3Realloc(unsafe { (*p_mem_1).z } as *mut (), n as u64)
                            } as *mut i8
                };
                if unsafe { (*p_mem_1).z_malloc } == core::ptr::null_mut() {
                    unsafe { sqlite3_free(unsafe { (*p_mem_1).z } as *mut ()) };
                }
                unsafe { (*p_mem_1).z = unsafe { (*p_mem_1).z_malloc } };
            }
            b_preserve_1 = 0;
            ...
            unsafe {
                (*p_mem_1).z_malloc =
                    unsafe {
                            sqlite3_db_malloc_raw(unsafe { (*p_mem_1).db }, n as u64)
                        } as *mut i8
            };
        }
        if unsafe { (*p_mem_1).z_malloc } == core::ptr::null_mut() {
            unsafe { sqlite3_vdbe_mem_set_null(p_mem_1) };
            unsafe { (*p_mem_1).z = core::ptr::null_mut() };
            unsafe { (*p_mem_1).sz_malloc = 0 };
            return 7;
        } else {
            unsafe {
                (*p_mem_1).sz_malloc =
                    unsafe {
                        sqlite3_db_malloc_size(unsafe { (*p_mem_1).db },
                            unsafe { (*p_mem_1).z_malloc } as *const ())
                    }
            };
        }
        if b_preserve_1 != 0 && !(unsafe { (*p_mem_1).z }).is_null() {
            { let _ = 0; };
            unsafe {
                memcpy(unsafe { (*p_mem_1).z_malloc } as *mut (),
                    unsafe { (*p_mem_1).z } as *const (),
                    unsafe { (*p_mem_1).n } as u64)
            };
        }
        if unsafe { (*p_mem_1).flags } as i32 & 4096 != 0 {
            { let _ = 0; };
            unsafe {
                (unsafe {
                        (*p_mem_1).x_del.unwrap()
                    })(unsafe { (*p_mem_1).z } as *mut ())
            };
        }
        unsafe { (*p_mem_1).z = unsafe { (*p_mem_1).z_malloc } };
        unsafe { (*p_mem_1).flags &= !(4096 | 16384 | 8192) as u16 };
        return 0;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_expand_blob(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        ...
        if sqlite3_vdbe_mem_grow(p_mem_1, n_byte, 1) != 0 { return 7; }
        { let _ = 0; };
        { let _ = 0; };
        unsafe {
            memset(unsafe {
                        &raw mut *unsafe {
                                    (*p_mem_1).z.offset(unsafe { (*p_mem_1).n } as isize)
                                }
                    } as *mut (), 0, unsafe { (*p_mem_1).u.n_zero } as u64)
        };
        unsafe { (*p_mem_1).n += unsafe { (*p_mem_1).u.n_zero } };
        unsafe { (*p_mem_1).flags &= !(1024 | 512) as u16 };
        return 0;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_change_encoding(p_mem_1: *mut Mem,
    ...
    { let _ = 0; };
    { let _ = 0; };
    if (unsafe { (*p_mem_1).flags } as i32 & 2 == 0) as i32 != 0 {
        unsafe { (*p_mem_1).enc = desired_enc_1 as u8 };
        return 0;
    }
...
extern "C" fn vdbe_mem_add_terminator(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        ...
        unsafe {
            *unsafe { (*p_mem_1).z.offset(unsafe { (*p_mem_1).n } as isize) }
                = 0 as i8
        };
        unsafe {
            *unsafe {
                        (*p_mem_1).z.offset((unsafe { (*p_mem_1).n } + 1) as isize)
                    } = 0 as i8
        };
        unsafe {
            *unsafe {
                        (*p_mem_1).z.offset((unsafe { (*p_mem_1).n } + 2) as isize)
                    } = 0 as i8
        };
        unsafe { (*p_mem_1).flags |= 512 as u16 };
        return 0;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_make_writeable(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p_mem_1).flags } as i32 & (2 | 16) != 0 {
            ...
            if unsafe { (*p_mem_1).sz_malloc } == 0 ||
                    unsafe { (*p_mem_1).z } != unsafe { (*p_mem_1).z_malloc } {
                let rc: i32 = vdbe_mem_add_terminator(p_mem_1);
                if rc != 0 { return rc; }
            }
        }
        unsafe { (*p_mem_1).flags &= !16384 as u16 };
        return 0;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_nul_terminate(p_mem_1: *mut Mem) -> i32 {
    { let _ = 0; };
    { let _ = 0; };
    if unsafe { (*p_mem_1).flags } as i32 & (512 | 2) != 2 {
        return 0;
...
pub extern "C" fn sqlite3_vdbe_mem_clear_and_resize(p_mem_1: *mut Mem,
    ...
    unsafe {
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p_mem_1).sz_malloc } < sz_new_1 {
            return sqlite3_vdbe_mem_grow(p_mem_1, sz_new_1, 0);
        }
        { let _ = 0; };
        unsafe { (*p_mem_1).z = unsafe { (*p_mem_1).z_malloc } };
        unsafe { (*p_mem_1).flags &= (1 | 4 | 8 | 32) as u16 };
        return 0;
    }
}
extern "C" fn vdbe_mem_render_num(sz: i32, z_buf_1: *mut i8, p: &mut Mem)
    ...
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        if (*p).flags as i32 & (4 | 32) != 0 {
            (*p).n = unsafe { sqlite3_int64_to_text((*p).u.i, z_buf_1) };
            if (*p).flags as i32 & 32 != 0 {
                unsafe {
                    memcpy(unsafe { z_buf_1.offset((*p).n as isize) } as
                            *mut (), c".0".as_ptr() as *mut i8 as *const (), 3 as u64)
                };
                (*p).n += 2;
            }
        } else {
            ...
            unsafe {
                sqlite3_str_appendf(&raw mut acc as *mut sqlite3_str,
                    c"%!.*g".as_ptr() as *mut i8 as *const i8,
                    if !((*p).db).is_null() {
                        (unsafe { (*(*p).db).n_fp_digit }) as i32
                    } else { 17 }, (*p).u.r)
            };
            { let _ = 0; };
...
pub extern "C" fn sqlite3_vdbe_mem_stringify(p_mem_1: *mut Mem, enc: u8,
    ...
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        if sqlite3_vdbe_mem_clear_and_resize(p_mem_1, n_byte) != 0 {
            unsafe { (*p_mem_1).enc = 0 as u8 };
            return 7;
        }
        vdbe_mem_render_num(n_byte, unsafe { (*p_mem_1).z },
            unsafe { &mut *p_mem_1 });
        { let _ = 0; };
        { let _ = 0; };
        unsafe { (*p_mem_1).enc = 1 as u8 };
        unsafe { (*p_mem_1).flags |= (2 | 512) as u16 };
        if b_force_1 != 0 {
            unsafe { (*p_mem_1).flags &= !(4 | 8 | 32) as u16 };
        }
        sqlite3_vdbe_change_encoding(p_mem_1, enc as i32);
        return 0;
    }
}
extern "C" fn value_to_text(p_val_1: *mut sqlite3_value, enc: u8)
    -> *const () {
    unsafe {
        { let _ = 0; };
        { let _ = 0; };
        ...
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p_val_1).flags } as i32 & (16 | 2) != 0 {
            if if unsafe { (*p_val_1).flags } as i32 & 1024 != 0 {
                        sqlite3_vdbe_mem_expand_blob(p_val_1 as *mut Mem)
                    } else { 0 } != 0 {
                return core::ptr::null();
            }
            unsafe { (*p_val_1).flags |= 2 as u16 };
            if unsafe { (*p_val_1).enc } as i32 != enc as i32 & !8 {
                sqlite3_vdbe_change_encoding(p_val_1 as *mut Mem,
                    enc as i32 & !8);
            }
            if enc as i32 & 8 != 0 &&
                    1 == 1 & unsafe { (*p_val_1).z } as i64 as i32 {
                { let _ = 0; };
                if sqlite3_vdbe_mem_make_writeable(p_val_1 as *mut Mem) != 0 {
                    return core::ptr::null();
                }
            }
            sqlite3_vdbe_mem_nul_terminate(p_val_1 as *mut Mem);
        } else {
            sqlite3_vdbe_mem_stringify(p_val_1 as *mut Mem, enc, 0 as u8);
            { let _ = 0; };
        }
        { let _ = 0; };
        if unsafe { (*p_val_1).enc } as i32 == enc as i32 & !8 {
            { let _ = 0; };
            return unsafe { (*p_val_1).z } as *const ();
        } else { return core::ptr::null(); }
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3ValueText(p_val_1: *mut sqlite3_value, enc: u8)
    -> *const () {
    unsafe {
        if (p_val_1).is_null() as i32 != 0 { return core::ptr::null(); }
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p_val_1).flags } as i32 & (2 | 512) == 2 | 512 &&
                unsafe { (*p_val_1).enc } as i32 == enc as i32 {
            { let _ = 0; };
            return unsafe { (*p_val_1).z } as *const ();
        }
        if unsafe { (*p_val_1).flags } as i32 & 1 != 0 {
            return core::ptr::null();
        }
        return value_to_text(p_val_1, enc);
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_is_of_class(p_val_1: *const sqlite3_value,
    x_free_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> i32 {
    if p_val_1 != core::ptr::null() &&
                    unsafe { (*p_val_1).flags } as i32 & (2 | 16) != 0 &&
                unsafe { (*p_val_1).flags } as i32 & 4096 != 0 &&
            unsafe { (*p_val_1).x_del } == x_free_1 {
        return 1;
    } else { return 0; }
}
extern "C" fn value_bytes(p_val_1: *mut sqlite3_value, enc: u8) -> i32 {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3ValueBytes(p_val_1: *mut sqlite3_value, enc: u8)
    -> i32 {
    unsafe {
        let p: *const Mem = p_val_1 as *mut Mem as *const Mem;
        { let _ = 0; };
        if unsafe { (*p).flags } as i32 & 2 != 0 &&
                unsafe { (*p_val_1).enc } as i32 == enc as i32 {
            return unsafe { (*p).n };
        }
        if unsafe { (*p).flags } as i32 & 2 != 0 && enc as i32 != 1 &&
                unsafe { (*p_val_1).enc } as i32 != 1 {
            return unsafe { (*p).n };
        }
        if unsafe { (*p).flags } as i32 & 16 != 0 {
            if unsafe { (*p).flags } as i32 & 1024 != 0 {
                return unsafe { (*p).n } + unsafe { (*p).u.n_zero };
            } else { return unsafe { (*p).n }; }
        }
        if unsafe { (*p).flags } as i32 & 1 != 0 { return 0; }
        return value_bytes(p_val_1, enc);
    }
}
extern "C" fn vdbe_mem_clear(p: *mut Mem) -> () {
    unsafe {
        ...
        if unsafe { (*p).sz_malloc } != 0 {
            unsafe {
                sqlite3_db_free_nn(unsafe { (*p).db },
                    unsafe { (*p).z_malloc } as *mut ())
            };
            unsafe { (*p).sz_malloc = 0 };
        }
        unsafe { (*p).z = core::ptr::null_mut() };
    }
}
#[unsafe(no_mangle)]
...
pub extern "C" fn sqlite3_vdbe_mem_set_str(p_mem_1: *mut Mem, z: *const i8,
    ...
    unsafe {
        ...
        if !(unsafe { (*p_mem_1).db }).is_null() {
            i_limit =
                unsafe { (*unsafe { (*p_mem_1).db }).a_limit[0 as usize] };
        } else { i_limit = 1000000000; }
        if n_byte < 0 as i64 {
            { let _ = 0; };
            if enc as i32 == 1 {
                n_byte = unsafe { strlen(z) } as i64;
            } else {
                {
                    n_byte = 0 as i64;
                    '__b0: loop {
                        if !(n_byte <= i_limit as i64 &&
                                        unsafe { *z.offset(n_byte as isize) } as i32 |
                                                unsafe { *z.offset((n_byte + 1 as i64) as isize) } as i32 !=
                                            0) {
                            break '__b0;
                        }
        ...
        if n_byte > i_limit as i64 {
            if x_del_1.is_some() &&
                ...
                if x_del_1 ==
                    ...
                    unsafe {
                        sqlite3_db_free(unsafe { (*p_mem_1).db }, z as *mut ())
                    };
                } else { unsafe { x_del_1.unwrap()(z as *mut ()) }; }
            }
            sqlite3_vdbe_mem_set_null(p_mem_1);
            return unsafe {
                    sqlite3_error_to_parser(unsafe { (*p_mem_1).db }, 18)
                };
        }
        if x_del_1 ==
                Some(unsafe {
            ...
            if flags as i32 & 512 != 0 {
                n_alloc += if enc as i32 == 1 { 1 } else { 2 } as i64;
            }
            if sqlite3_vdbe_mem_clear_and_resize(p_mem_1,
                        if n_alloc > 32 as i64 { n_alloc } else { 32 as i64 } as
                            i32) != 0 {
                return 7;
            }
            { let _ = 0; };
            unsafe {
                memcpy(unsafe { (*p_mem_1).z } as *mut (), z as *const (),
                    n_alloc as u64)
            };
        } else {
            sqlite3_vdbe_mem_release(p_mem_1);
            unsafe { (*p_mem_1).z = z as *mut i8 };
            if x_del_1 ==
                    Some(unsafe {
                            core::mem::transmute::<*const (),
                                    unsafe extern "C" fn(*mut ())
                ...
                unsafe { (*p_mem_1).z_malloc = unsafe { (*p_mem_1).z } };
                unsafe {
                    (*p_mem_1).sz_malloc =
                        unsafe {
                            sqlite3_db_malloc_size(unsafe { (*p_mem_1).db },
                ...
                unsafe { (*p_mem_1).x_del = x_del_1 };
                flags |=
                    if !x_del_1.is_some() as i32 != 0 { 8192 } else { 4096 } as
                        u16;
            }
        }
        unsafe { (*p_mem_1).n = (n_byte & 2147483647 as i64) as i32 };
        unsafe { (*p_mem_1).flags = flags };
        unsafe { (*p_mem_1).enc = enc };
        if enc as i32 > 1 &&
                unsafe { sqlite3_vdbe_mem_handle_bom(p_mem_1) } != 0 {
            return 7;
        }
        return 0;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_set_str(v: *mut sqlite3_value, n: i32,
    z: *const (), enc: u8,
    x_del_1: Option<unsafe extern "C" fn(*mut ()) -> ()>) -> () {
    if !(v).is_null() {
        sqlite3_vdbe_mem_set_str(v as *mut Mem, z as *const i8, n as i64, enc,
            x_del_1);
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_set_null(p: *mut sqlite3_value) -> () {
    sqlite3_vdbe_mem_set_null(p as *mut Mem);
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3ValueFree(v: *mut sqlite3_value) -> () {
    if (v).is_null() as i32 != 0 { return; }
    sqlite3_vdbe_mem_release(v as *mut Mem);
    unsafe {
        sqlite3_db_free_nn(unsafe { (*(v as *mut Mem)).db }, v as *mut ())
    };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_value_new(db: *mut sqlite3) -> *mut sqlite3_value {
    let p: *mut Mem =
        unsafe {
                sqlite3_db_malloc_zero(db, core::mem::size_of::<Mem>() as u64)
            } as *mut Mem;
    if !(p).is_null() {
        unsafe { (*p).flags = 1 as u16 };
        unsafe { (*p).db = db };
...
pub extern "C" fn sqlite3_vdbe_mem_zero_terminate_if_able(p_mem_1: &mut Mem)
    ...
    unsafe {
        ...
        { let _ = 0; };
        if (*p_mem_1).flags as i32 & 4096 != 0 {
            if (*p_mem_1).x_del == Some(sqlite3_free) &&
                    unsafe { sqlite3_msize((*p_mem_1).z as *mut ()) } >=
                        ((*p_mem_1).n + 1) as u64 {
                unsafe {
                    *(*p_mem_1).z.offset((*p_mem_1).n as isize) = 0 as i8
                };
            ...
            unsafe { *(*p_mem_1).z.offset((*p_mem_1).n as isize) = 0 as i8 };
            (*p_mem_1).flags |= 512 as u16;
            return 1;
        }
        return 0;
...
extern "C" fn sqlite3_mem_real_value_rc_slow_path(p_mem_1: &Mem,
    ...
    unsafe {
        let mut rc: i32 = 0;
        unsafe { *p_value_1 = 0.0 };
        if (*p_mem_1).enc as i32 == 1 {
            let z_copy: *mut i8 =
                unsafe {
                    sqlite3_db_str_n_dup((*p_mem_1).db,
                        (*p_mem_1).z as *const i8, (*p_mem_1).n as u64)
                };
            if !(z_copy).is_null() {
                rc = unsafe { sqlite3_ato_f(z_copy as *const i8, p_value_1) };
                unsafe { sqlite3_db_free((*p_mem_1).db, z_copy as *mut ()) };
            }
            return rc;
        } else {
            let mut n: i32 = 0;
            let mut i: i32 = 0;
            let mut j: i32 = 0;
            let mut z_copy_1: *mut i8 = core::ptr::null_mut();
            let mut z: *const i8 = core::ptr::null();
            n = (*p_mem_1).n & !1;
            z_copy_1 =
                unsafe {
                        sqlite3_db_malloc_raw((*p_mem_1).db, (n / 2 + 2) as u64)
                    } as *mut i8;
            if !(z_copy_1).is_null() {
                z = (*p_mem_1).z as *const i8;
                if (*p_mem_1).enc as i32 == 2 {
                    {
                        i = { j = 0; j };
                        '__b1: loop {
                            if !(i < n - 1) { break '__b1; }
                            '__c1: loop {
                                unsafe {
                                    *z_copy_1.offset(j as isize) =
                                        unsafe { *z.offset(i as isize) } as i8
                                };
                                if unsafe { *z.offset((i + 1) as isize) } as i32 != 0 {
                                    break '__b1;
                                }
                                break '__c1;
                            }
                ...
                } else {
                    {
                        ...
                        '__b2: loop {
                            ...
                            '__c2: loop {
                                ...
                                unsafe {
                                    *z_copy_1.offset(j as isize) =
                                        unsafe { *z.offset((i + 1) as isize) } as i8
                                };
                                break '__c2;
                            }
                            {
                ...
                { let _ = 0; };
                unsafe { *z_copy_1.offset(j as isize) = 0 as i8 };
                rc =
                    unsafe { sqlite3_ato_f(z_copy_1 as *const i8, p_value_1) };
                if i < n { rc = -100; }
                unsafe {
                    sqlite3_db_free((*p_mem_1).db, z_copy_1 as *mut ())
                };
            }
            return rc;
        }
...
pub extern "C" fn sqlite3_mem_real_value_rc(p_mem_1: *mut Mem,
    ...
    unsafe {
        { let _ = 0; };
        if unsafe { (*p_mem_1).z } == core::ptr::null_mut() {
            unsafe { *p_value_1 = 0.0 };
            return 0;
        } else if unsafe { (*p_mem_1).enc } as i32 == 1 &&
                (unsafe { (*p_mem_1).flags } as i32 & 512 != 0 ||
                    sqlite3_vdbe_mem_zero_terminate_if_able(unsafe {
                                &mut *p_mem_1
                            }) != 0) {
            return unsafe {
                    sqlite3_ato_f(unsafe { (*p_mem_1).z } as *const i8,
                        p_value_1)
                };
        } else if unsafe { (*p_mem_1).n } == 0 {
            unsafe { *p_value_1 = 0.0 };
            return 0;
        } else {
            return sqlite3_mem_real_value_rc_slow_path(unsafe { &*p_mem_1 },
                    p_value_1);
        }
    }
}
    ...
    unsafe {
        ...
        if unsafe { (*p_mem_1).flags } as i32 & (4 | 8 | 32 | 1) == 0 {
            ...
            if rc & 2 == 0 &&
                    ...
                    sqlite3_real_same_as_int(unsafe { (*p_mem_1).u.r },
                            { ix = sqlite3_real_to_i64(unsafe { (*p_mem_1).u.r }); ix })
                        != 0 {
                unsafe { (*p_mem_1).u.i = ix };
                unsafe {
                    (*p_mem_1).flags =
                        (unsafe { (*p_mem_1).flags } as i32 & !(3519 | 1024) | 4) as
                            u16
                };
            } else {
                unsafe {
                    (*p_mem_1).flags =
                        (unsafe { (*p_mem_1).flags } as i32 & !(3519 | 1024) | 8) as
                            u16
                };
            }
        }
        { let _ = 0; };
        unsafe { (*p_mem_1).flags &= !(2 | 16 | 1024) as u16 };
        return 0;
    }
}
extern "C" fn mem_int_value(p_mem_1: &Mem) -> i64 {
    unsafe {
        ...
        unsafe {
            sqlite3_atoi64((*p_mem_1).z as *const i8, &mut value,
                (*p_mem_1).n, (*p_mem_1).enc)
        };
        return value;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_int_value(p_mem_1: *const Mem) -> i64 {
    unsafe {
        let mut flags: i32 = 0;
        { let _ = 0; };
        { let _ = 0; };
        { let _ = 0; };
        flags = unsafe { (*p_mem_1).flags } as i32;
        if flags & (4 | 32) != 0 {
            return unsafe { (*p_mem_1).u.i } as i64;
        } else if flags & 8 != 0 {
            return sqlite3_real_to_i64(unsafe { (*p_mem_1).u.r });
        } else if flags & (2 | 16) != 0 &&
                unsafe { (*p_mem_1).z } != core::ptr::null_mut() {
            return mem_int_value(unsafe { &*p_mem_1 });
...
pub extern "C" fn sqlite3_vdbe_mem_integerify(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        ...
        { let _ = 0; };
        unsafe {
            (*p_mem_1).u.i = sqlite3_vdbe_int_value(p_mem_1 as *const Mem)
        };
        unsafe {
            (*p_mem_1).flags =
                (unsafe { (*p_mem_1).flags } as i32 & !(3519 | 1024) | 4) as
...
pub extern "C" fn sqlite3_vdbe_real_value(p_mem_1: *mut Mem) -> f64 {
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        if unsafe { (*p_mem_1).flags } as i32 & 8 != 0 {
            return unsafe { (*p_mem_1).u.r };
        } else if unsafe { (*p_mem_1).flags } as i32 & (4 | 32) != 0 {
...
pub extern "C" fn sqlite3_vdbe_mem_realify(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        unsafe { (*p_mem_1).u.r = sqlite3_vdbe_real_value(p_mem_1) };
        unsafe {
            (*p_mem_1).flags =
                (unsafe { (*p_mem_1).flags } as i32 & !(3519 | 1024) | 8) as
                    u16
...
pub extern "C" fn sqlite3_vdbe_mem_cast(p_mem_1: *mut Mem, aff: u8,
    encoding: u8) -> i32 {
    unsafe {
        if unsafe { (*p_mem_1).flags } as i32 & 1 != 0 { return 0; }
        '__s3:
            {
            match aff {
                65 => {
                    {
                        if unsafe { (*p_mem_1).flags } as i32 & 16 == 0 {
                            unsafe {
                                sqlite3_value_apply_affinity(p_mem_1 as *mut sqlite3_value,
                                    66 as u8, encoding)
                            };
                            { let _ = 0; };
                            if unsafe { (*p_mem_1).flags } as i32 & 2 != 0 {
                                unsafe {
                                    (*p_mem_1).flags =
                                        (unsafe { (*p_mem_1).flags } as i32 & !(3519 | 1024) | 16)
                                            as u16
                                };
                            }
                        } else {
                            unsafe { (*p_mem_1).flags &= !(3519 & !16) as u16 };
                        }
                        break '__s3;
                    }
                    { sqlite3_vdbe_mem_numerify(p_mem_1); break '__s3; }
                    { sqlite3_vdbe_mem_integerify(p_mem_1); break '__s3; }
                    { sqlite3_vdbe_mem_realify(p_mem_1); break '__s3; }
                    {
                        let mut rc: i32 = 0;
                        { let _ = 0; };
                        { let _ = 0; };
                        unsafe {
                            (*p_mem_1).flags |=
                                ((unsafe { (*p_mem_1).flags } as i32 & 16) >> 3) as u16
                        };
                        unsafe {
                            sqlite3_value_apply_affinity(p_mem_1 as *mut sqlite3_value,
                                66 as u8, encoding)
                        ...
                        { let _ = 0; };
                        unsafe {
                            (*p_mem_1).flags &= !(4 | 8 | 32 | 16 | 1024) as u16
                        };
                        if encoding as i32 != 1 { unsafe { (*p_mem_1).n &= !1 }; }
                        rc = sqlite3_vdbe_change_encoding(p_mem_1, encoding as i32);
                        if rc != 0 { return rc; }
                        sqlite3_vdbe_mem_zero_terminate_if_able(unsafe {
                                &mut *p_mem_1
                            });
...
extern "C" fn value_from_expr(db: *mut sqlite3, mut p_expr_1: *const Expr,
    enc: u8, affinity: u8, pp_val_1: *mut *mut sqlite3_value,
    ...
    unsafe {
        ...
        loop {
            ...
            '__s5:
                ...
                match __state {
                    0 => { __state = 3; }
                    2 => { unsafe { sqlite3_oom_fault(db) }; __state = 98; }
                    3 => { z_val = core::ptr::null_mut(); __state = 4; }
                    4 => { p_val = core::ptr::null_mut(); __state = 5; }
                    5 => { neg_int = 1; __state = 6; }
                    6 => {
                        z_neg = c"".as_ptr() as *mut i8 as *const i8;
                        __state = 7;
                    }
                    7 => { rc = 0; __state = 8; }
                    8 => { { let _ = 0; }; __state = 9; }
                    9 => {
                        if { op = unsafe { (*p_expr_1).op } as i32; op } == 173 ||
                                op == 181 {
                            __state = 11;
                        } else { __state = 10; }
                    }
                    10 => {
                        if op == 176 { __state = 13; } else { __state = 12; }
                    }
                    11 => {
                        p_expr_1 = unsafe { (*p_expr_1).p_left } as *const Expr;
                        __state = 9;
                    }
                    12 => { { let _ = 0; }; __state = 14; }
                    13 => {
                        op = unsafe { (*p_expr_1).op2 } as i32;
                        __state = 12;
                    }
                    14 => {
                        if op == 36 { __state = 16; } else { __state = 15; }
                    }
                    15 => {
                        if op == 174 { __state = 27; } else { __state = 26; }
                    }
                    16 => { __state = 17; }
                    ...
                    18 => {
                        aff =
                            unsafe {
                                    sqlite3_affinity_type(unsafe { (*p_expr_1).u.z_token } as
                    ...
                    19 => {
                        rc =
                            value_from_expr(db,
                                unsafe { (*p_expr_1).p_left } as *const Expr, enc, aff,
                                pp_val_1, p_ctx_1);
                        __state = 20;
                    }
                    20 => { __state = 21; }
                    21 => {
                        if !(unsafe { *pp_val_1 }).is_null() {
                            __state = 23;
                        } else { __state = 22; }
                    }
                    22 => { return rc; }
                    ...
                    24 => {
                        sqlite3_vdbe_mem_cast(unsafe { *pp_val_1 } as *mut Mem, aff,
                            enc);
                        __state = 25;
                    }
                    25 => {
                        unsafe {
                            sqlite3_value_apply_affinity(unsafe { *pp_val_1 }, affinity,
                                enc)
                        };
                        __state = 22;
                    }
                    ...
                    27 => {
                        p_left = unsafe { (*p_expr_1).p_left } as *const Expr;
                        __state = 28;
                    }
                    28 => {
                        if unsafe { (*p_left).op } as i32 == 156 ||
                                unsafe { (*p_left).op } as i32 == 154 {
                            __state = 29;
                        } else { __state = 26; }
                    }
                    29 => {
                        if unsafe { (*p_left).flags } & 2048 as u32 != 0 as u32 ||
                                    unsafe {
                                                *unsafe { (*p_left).u.z_token.offset(0 as isize) }
                                            } as i32 != '0' as i32 ||
                                unsafe {
                                                *unsafe { (*p_left).u.z_token.offset(1 as isize) }
                                            } as i32 & !32 != 'X' as i32 {
                            __state = 30;
                        } else { __state = 26; }
                    }
                    30 => { p_expr_1 = p_left as *const Expr; __state = 31; }
                    31 => {
                        op = unsafe { (*p_expr_1).op } as i32;
                        __state = 32;
                    }
                    32 => { neg_int = -1; __state = 33; }
                    33 => {
                        z_neg = c"-".as_ptr() as *mut i8 as *const i8;
                        __state = 26;
                    }
                    34 => { unsafe { *pp_val_1 = p_val }; __state = 96; }
                    35 => {
                        p_val = value_new(db, p_ctx_1 as *const ValueNewStat4Ctx);
                        __state = 37;
                    }
                    36 => {
                        if op == 174 { __state = 63; } else { __state = 64; }
                    }
                    37 => {
                        if p_val == core::ptr::null_mut() {
                            __state = 39;
                        } else { __state = 38; }
                    }
                    38 => {
                        if unsafe { (*p_expr_1).flags } & 2048 as u32 != 0 as u32 {
                            __state = 41;
                        } else { __state = 42; }
                    }
                    39 => { __state = 2; }
                    40 => {
                        if affinity as i32 == 65 {
                            __state = 50;
                        } else { __state = 51; }
                    }
                    41 => {
                        sqlite3_vdbe_mem_set_int64(p_val as *mut Mem,
                            unsafe { (*p_expr_1).u.i_value } as i64 * neg_int as i64);
                        __state = 40;
                    }
                    42 => { __state = 43; }
                    43 => {
                        if op == 156 &&
                                0 ==
                                    unsafe {
                                        sqlite3_dec_or_hex_to_i64(unsafe { (*p_expr_1).u.z_token }
                                                as *const i8, &mut i_val)
                                    } {
                            __state = 44;
                        } else { __state = 45; }
                    }
                    ...
                    45 => {
                        z_val =
                            unsafe {
                                sqlite3_m_printf(db,
                                    c"%s%s".as_ptr() as *mut i8 as *const i8, z_neg,
                                    unsafe { (*p_expr_1).u.z_token })
                            };
                        __state = 46;
                    }
                    46 => {
                        if z_val == core::ptr::null_mut() {
                            __state = 48;
                        } else { __state = 47; }
                    }
                    47 => {
                        unsafe {
                            sqlite3_value_set_str(p_val, -1, z_val as *const (),
                                1 as u8,
                                Some(unsafe {
                                        core::mem::transmute::<*const (),
                                                unsafe extern "C" fn(*mut ())
                    ...
                    48 => { __state = 2; }
                    49 => { { let _ = 0; }; __state = 57; }
                    50 => {
                        if op == 154 { __state = 52; } else { __state = 53; }
                    }
                    51 => {
                        unsafe {
                            sqlite3_value_apply_affinity(p_val, affinity, 1 as u8)
                        };
                        __state = 49;
                    }
                    52 => { { let _ = 0; }; __state = 54; }
                    53 => {
                        if op == 156 { __state = 56; } else { __state = 49; }
                    }
                    54 => {
                        unsafe {
                            sqlite3_ato_f(unsafe { (*p_val).z } as *const i8,
                                unsafe { &mut (*p_val).u.r })
                        };
                        __state = 55;
                    }
                    55 => {
                        unsafe { (*p_val).flags = 8 as u16 };
                        __state = 49;
                    }
                    56 => {
                        unsafe {
                            sqlite3_value_apply_affinity(p_val, 67 as u8, 1 as u8)
                        };
                        __state = 49;
                    }
                    57 => {
                        if unsafe { (*p_val).flags } as i32 & (4 | 32 | 8) != 0 {
                            __state = 59;
                        } else { __state = 58; }
                    }
                    58 => {
                        if enc as i32 != 1 { __state = 62; } else { __state = 34; }
                    }
                    59 => { __state = 60; }
                    60 => { __state = 61; }
                    61 => {
                        unsafe { (*p_val).flags &= !2 as u16 };
                        __state = 58;
                    }
                    62 => {
                        rc =
                            sqlite3_vdbe_change_encoding(p_val as *mut Mem, enc as i32);
                        __state = 34;
                    }
                    63 => {
                        if 0 ==
                                    value_from_expr(db,
                                        unsafe { (*p_expr_1).p_left } as *const Expr, enc, affinity,
                                        &mut p_val, p_ctx_1) && p_val != core::ptr::null_mut() {
                            __state = 65;
                        } else { __state = 34; }
                    }
                    64 => {
                        if op == 122 { __state = 73; } else { __state = 74; }
                    }
                    65 => {
                        sqlite3_vdbe_mem_numerify(p_val as *mut Mem);
                        __state = 66;
                    }
                    66 => {
                        if unsafe { (*p_val).flags } as i32 & 8 != 0 {
                            __state = 68;
                        } else { __state = 69; }
                    }
                    67 => {
                    ...
                    68 => {
                        unsafe { (*p_val).u.r = -unsafe { (*p_val).u.r } };
                        __state = 67;
                    }
                    69 => {
                        if unsafe { (*p_val).u.i } ==
                    ...
                    70 => {
                        unsafe {
                            (*p_val).u.r =
                                -((-1 as i64 -
                                            (4294967295u32 as i64 | (2147483647 as i64) << 32)) as f64)
                        };
                        __state = 72;
                    }
                    71 => {
                        unsafe { (*p_val).u.i = -unsafe { (*p_val).u.i } };
                        __state = 67;
                    }
                    72 => {
                        unsafe {
                            (*p_val).flags =
                                (unsafe { (*p_val).flags } as i32 & !(3519 | 1024) | 8) as
                                    u16
                        };
                        __state = 67;
                    }
                    ...
                    74 => {
                        if op == 155 { __state = 78; } else { __state = 79; }
                    }
                    75 => {
                        if p_val == core::ptr::null_mut() {
                            __state = 77;
                    ...
                    76 => {
                        sqlite3_vdbe_mem_set_null(p_val as *mut Mem);
                        __state = 34;
                    }
                    77 => { __state = 2; }
                    78 => { __state = 80; }
                    79 => {
                        if op == 171 { __state = 90; } else { __state = 34; }
                    }
                    80 => { { let _ = 0; }; __state = 81; }
                    81 => { { let _ = 0; }; __state = 82; }
                    ...
                    85 => {
                        z_val =
                            unsafe {
                                unsafe { (*p_expr_1).u.z_token.offset(2 as isize) }
                            };
                        __state = 87;
                    }
                    86 => { __state = 2; }
                    87 => {
                        n_val = unsafe { sqlite3_strlen30(z_val as *const i8) } - 1;
                        __state = 88;
                    }
                    88 => { { let _ = 0; }; __state = 89; }
                    89 => {
                        sqlite3_vdbe_mem_set_str(p_val as *mut Mem,
                            unsafe {
                                    sqlite3_hex_to_blob(db, z_val as *const i8, n_val)
                                } as *const i8, (n_val / 2) as i64, 0 as u8,
                            Some(unsafe {
                                    core::mem::transmute::<*const (),
                                            unsafe extern "C" fn(*mut ())
                                                -> ()>(sqlite3_row_set_clear as *const ())
                    ...
                    94 => {
                        unsafe {
                            (*p_val).u.i =
                                (unsafe {
                                                *unsafe { (*p_expr_1).u.z_token.offset(4 as isize) }
                                            } as i32 == 0) as i64
                        };
                        __state = 95;
                    }
                    ...
                    97 => { __state = 2; }
                    98 => {
                        unsafe { sqlite3_db_free(db, z_val as *mut ()) };
                        __state = 99;
                    }
                    99 => { { let _ = 0; }; __state = 100; }
                    100 => { { let _ = 0; }; __state = 101; }
                    101 => {
...
pub extern "C" fn sqlite3_value_from_expr(db: *mut sqlite3,
    ...
    pp_val_1: *mut *mut sqlite3_value) -> i32 {
    return if !(p_expr_1).is_null() {
            value_from_expr(db, p_expr_1, enc, affinity, pp_val_1,
                core::ptr::null_mut())
        } else { 0 };
}
#[unsafe(no_mangle)]
...
pub extern "C" fn sqlite3_vdbe_mem_too_big(p: &Mem) -> i32 {
    unsafe {
        { let _ = 0; };
        if (*p).flags as i32 & (2 | 16) != 0 {
            let mut n: i32 = (*p).n;
            if (*p).flags as i32 & 1024 != 0 { n += (*p).u.n_zero; }
            return (n > unsafe { (*(*p).db).a_limit[0 as usize] }) as i32;
        }
        return 0;
    }
}
...
pub extern "C" fn sqlite3_vdbe_mem_copy(p_to_1: *mut Mem,
    ...
    let mut rc: i32 = 0;
    { let _ = 0; };
    if unsafe { (*p_to_1).flags } as i32 & (32768 | 4096) != 0 {
    ...
    unsafe { (*p_to_1).flags &= !4096 as u16 };
    if unsafe { (*p_to_1).flags } as i32 & (2 | 16) != 0 {
        if 0 == unsafe { (*p_from_1).flags } as i32 & 8192 {
            unsafe { (*p_to_1).flags |= 16384 as u16 };
            rc = sqlite3_vdbe_mem_make_writeable(p_to_1);
        }
    }
    return rc;
}
extern "C" fn vdbe_clr_copy(p_to_1: *mut Mem, p_from_1: *const Mem,
    ...
    vdbe_mem_clear_extern_and_set_null(p_to_1);
    { let _ = 0; };
    unsafe { sqlite3_vdbe_mem_shallow_copy(p_to_1, p_from_1, e_type_1) };
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_shallow_copy(p_to_1: *mut Mem,
    p_from_1: *const Mem, src_type_1: i32) -> () {
    { let _ = 0; };
    { let _ = 0; };
    if unsafe { (*p_to_1).flags } as i32 & (32768 | 4096) != 0 {
        vdbe_clr_copy(p_to_1, p_from_1, src_type_1);
        return;
    }
    unsafe {
        memcpy(p_to_1 as *mut (), p_from_1 as *const (),
    ...
    if unsafe { (*p_from_1).flags } as i32 & 8192 == 0 {
        unsafe { (*p_to_1).flags &= !(4096 | 8192 | 16384) as u16 };
        { let _ = 0; };
        unsafe { (*p_to_1).flags |= src_type_1 as u16 };
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_move(p_to_1: *mut Mem, p_from_1: *mut Mem)
    ...
    { let _ = 0; };
    { let _ = 0; };
    sqlite3_vdbe_mem_release(p_to_1);
    unsafe {
        memcpy(p_to_1 as *mut (), p_from_1 as *const (),
            core::mem::size_of::<Mem>() as u64)
    };
    unsafe { (*p_from_1).flags = 1 as u16 };
...
pub extern "C" fn sqlite3_vdbe_mem_set_text(p_mem_1: *mut Mem, z: *const i8,
    ...
    unsafe {
        ...
        if n_byte >
                unsafe { (*unsafe { (*p_mem_1).db }).a_limit[0 as usize] } as
                    i64 {
            if x_del_1.is_some() &&
                    x_del_1 !=
                        Some(unsafe {
        ...
        if x_del_1 ==
            ...
            let n_alloc: i64 = n_byte + 1 as i64;
            if sqlite3_vdbe_mem_clear_and_resize(p_mem_1,
                        if n_alloc > 32 as i64 { n_alloc } else { 32 as i64 } as
                            i32) != 0 {
                return 7;
            ...
            unsafe {
                *unsafe { (*p_mem_1).z.offset(n_byte as isize) } = 0 as i8
            };
        } else {
            sqlite3_vdbe_mem_release(p_mem_1);
            unsafe { (*p_mem_1).z = z as *mut i8 };
            if x_del_1 ==
                ...
                unsafe { (*p_mem_1).x_del = None };
            } else if !x_del_1.is_some() as i32 != 0 {
                unsafe { (*p_mem_1).x_del = x_del_1 };
                flags |= 8192 as u16;
            } else {
                unsafe { (*p_mem_1).x_del = x_del_1 };
...
pub extern "C" fn sqlite3_vdbe_mem_set_double(p_mem_1: *mut Mem, val: f64)
    ...
    unsafe {
        sqlite3_vdbe_mem_set_null(p_mem_1);
        if (unsafe { sqlite3_is_na_n(val) } == 0) as i32 != 0 {
            unsafe { (*p_mem_1).u.r = val };
            unsafe { (*p_mem_1).flags = 8 as u16 };
        }
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_set_pointer(p_mem_1: *mut Mem,
    ...
    unsafe {
        { let _ = 0; };
        vdbe_mem_clear(p_mem_1);
        unsafe {
            (*p_mem_1).u.z_p_type =
                if !(z_p_type_1).is_null() {
                    z_p_type_1
                } else { c"".as_ptr() as *mut i8 as *const i8 }
        };
        unsafe { (*p_mem_1).z = p_ptr_1 as *mut i8 };
        unsafe { (*p_mem_1).flags = (1 | 4096 | 2048 | 512) as u16 };
        unsafe { (*p_mem_1).e_subtype = 'p' as i32 as u8 };
        unsafe {
            (*p_mem_1).x_del =
                if x_destructor_1.is_some() {
                    x_destructor_1
                } else { Some(sqlite3_noop_destructor) }
        };
    }
}
#[unsafe(no_mangle)]
...
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_set_zero_blob(p_mem_1: *mut Mem,
    mut n: i32) -> () {
    unsafe {
        sqlite3_vdbe_mem_release(p_mem_1);
        unsafe { (*p_mem_1).flags = (16 | 1024) as u16 };
        unsafe { (*p_mem_1).n = 0 };
        if n < 0 { n = 0; }
        unsafe { (*p_mem_1).u.n_zero = n };
        unsafe { (*p_mem_1).enc = 1 as u8 };
        unsafe { (*p_mem_1).z = core::ptr::null_mut() };
    }
}
...
pub extern "C" fn sqlite3_vdbe_mem_set_row_set(p_mem_1: *mut Mem) -> i32 {
    unsafe {
        let db: *mut sqlite3 = unsafe { (*p_mem_1).db };
        let mut p: *mut RowSet = core::ptr::null_mut();
        { let _ = 0; };
        { let _ = 0; };
        sqlite3_vdbe_mem_release(p_mem_1);
        p = unsafe { sqlite3_row_set_init(db) };
        if p == core::ptr::null_mut() { return 7; }
        unsafe { (*p_mem_1).z = p as *mut i8 };
        unsafe { (*p_mem_1).flags = (16 | 4096) as u16 };
        unsafe { (*p_mem_1).x_del = Some(sqlite3_row_set_delete) };
        return 0;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_boolean_value(p_mem_1: *mut Mem,
    if_null_1: i32) -> i32 {
    unsafe {
        if unsafe { (*p_mem_1).flags } as i32 & (4 | 32) != 0 {
            return (unsafe { (*p_mem_1).u.i } != 0 as i64) as i32;
        }
        if unsafe { (*p_mem_1).flags } as i32 & 1 != 0 { return if_null_1; }
        return (sqlite3_vdbe_real_value(p_mem_1) != 0.0) as i32;
    }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_integer_affinity(p_mem_1: &mut Mem) -> () {
    unsafe {
        ...
        { let _ = 0; };
        { let _ = 0; };
        if (*p_mem_1).flags as i32 & 32 != 0 {
            (*p_mem_1).flags =
                ((*p_mem_1).flags as i32 & !(3519 | 1024) | 4) as u16;
        } else {
            let ix: i64 = sqlite3_real_to_i64((*p_mem_1).u.r);
            if (*p_mem_1).u.r == ix as f64 &&
                        ix >
                            -1 as i64 -
                                (4294967295u32 as i64 | (2147483647 as i64) << 32) &&
                    ix < 4294967295u32 as i64 | (2147483647 as i64) << 32 {
                (*p_mem_1).u.i = ix;
                (*p_mem_1).flags =
                    ((*p_mem_1).flags as i32 & !(3519 | 1024) | 4) as u16;
            }
...
pub extern "C" fn sqlite3_vdbe_mem_from_btree(p_cur_1: *mut BtCursor,
    ...
    unsafe {
        ...
        if amt >= 2147483391 as u32 { return 7; }
        if amt as u64 + offset as u64 >
                unsafe { sqlite3_btree_max_record_size(p_cur_1) } as u64 {
            return unsafe { sqlite3_corrupt_error(1476) };
        }
        if 0 ==
                {
                    rc =
                        sqlite3_vdbe_mem_clear_and_resize(p_mem_1,
                            (amt + 1 as u32) as i32);
                    rc
                } {
            rc =
                unsafe {
                    sqlite3_btree_payload(p_cur_1, offset, amt,
                        unsafe { (*p_mem_1).z } as *mut ())
                };
            if rc == 0 {
                unsafe {
...
pub extern "C" fn sqlite3_vdbe_mem_from_btree_zero_offset(p_cur_1:
    ...
    unsafe {
        ...
        unsafe {
            (*p_mem_1).z =
                unsafe {
                        sqlite3_btree_payload_fetch(p_cur_1, &mut available)
                    } as *mut i8
        };
        { let _ = 0; };
        if amt <= available {
            unsafe { (*p_mem_1).flags = (16 | 16384) as u16 };
            unsafe { (*p_mem_1).n = amt as i32 };
        } else {
            rc = sqlite3_vdbe_mem_from_btree(p_cur_1, 0 as u32, amt, p_mem_1);
        }
        return rc;
    }
}
...
pub extern "C" fn sqlite3_vdbe_mem_release_malloc(p: *mut Mem) -> () {
    { let _ = 0; };
    if unsafe { (*p).sz_malloc } != 0 { vdbe_mem_clear(p); }
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_vdbe_mem_agg_value(p_accum_1: *mut Mem,
    p_out_1: *mut Mem, p_func_1: *mut FuncDef) -> i32 {
    unsafe {
        let mut ctx: sqlite3_context = unsafe { core::mem::zeroed() };
        { let _ = 0; };
        { let _ = 0; };
        ...
        ctx.p_mem = p_accum_1;
        ctx.p_func = p_func_1;
        ctx.enc = unsafe { (*unsafe { (*p_accum_1).db }).enc };
        unsafe { (unsafe { (*p_func_1).x_value.unwrap() })(&mut ctx) };
        return ctx.is_error;
    }
}
extern "C" {
