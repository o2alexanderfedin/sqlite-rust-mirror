    ...
    '__b0: loop {
        '__c0: loop {
            ...
            if i_db != 1 {
                ...
                if !(p_into_1).is_null() &&
                        unsafe {
                                sqlite3_resolve_self_reference(p_parse_1,
                                    core::ptr::null_mut(), 0, p_into_1, core::ptr::null_mut())
                            } == 0 {
                    i_into_reg =
                        {
                    ...
                    unsafe {
                        sqlite3_expr_code(p_parse_1, p_into_1, i_into_reg)
                    };
                }
                unsafe { sqlite3_vdbe_add_op2(v, 5, i_db, i_into_reg) };
...
extern "C" fn exec_sql(db: *mut sqlite3, pz_err_msg_1: *mut *mut i8,
    ...
    while 100 == { rc = unsafe { sqlite3_step(p_stmt) }; rc } {
        ...
        { let _ = 0; };
        if !(z_sub_sql).is_null() &&
                (unsafe {
                            strncmp(z_sub_sql, c"CRE".as_ptr() as *mut i8 as *const i8,
                                3 as u64)
                        } == 0 ||
                    unsafe {
                            strncmp(z_sub_sql, c"INS".as_ptr() as *mut i8 as *const i8,
                                3 as u64)
                        } == 0) {
            rc = exec_sql(db, pz_err_msg_1, z_sub_sql);
            if rc != 0 { break; }
        }
    }
    { let _ = 0; };
    ...
    { let _ = unsafe { sqlite3_finalize(p_stmt) }; };
    return rc;
}
unsafe extern "C" fn exec_sql_f(db: *mut sqlite3, pz_err_msg_1: *mut *mut i8,
    z_sql_1: *const i8, mut __va0: ...) -> i32 {
    let mut z: *mut i8 = core::ptr::null_mut();
    let mut ap: *mut i8 = core::ptr::null_mut();
    let mut rc: i32 = 0;
    unsafe { ap = core::mem::transmute_copy(&__va0) };
    z = unsafe { sqlite3_vm_printf(db, z_sql_1, ap) };
    ();
    if z == core::ptr::null_mut() { return 7; }
    rc = exec_sql(db, pz_err_msg_1, z as *const i8);
    unsafe { sqlite3_db_free(db, z as *mut ()) };
    return rc;
}
#[unsafe(no_mangle)]
pub extern "C" fn sqlite3_run_vacuum(pz_err_msg_1: *mut *mut i8,
    db: *mut sqlite3, i_db_1: i32, p_out_1: *mut sqlite3_value) -> i32 {
    unsafe {
        let mut rc: i32 = 0;
        ...
        let mut id: *mut sqlite3_file = core::ptr::null_mut();
        ...
        loop {
            ...
            '__s3:
                ...
                match __state {
                    ...
                    9 => { __state = 10; }
                    10 => { __state = 11; }
                    11 => { p_db = core::ptr::null_mut(); __state = 12; }
                    12 => { __state = 13; }
                    13 => { __state = 14; }
                    14 => { __state = 15; }
                    15 => { __state = 16; }
                    16 => { __state = 17; }
                    17 => { pgflags = 1 as u32; __state = 18; }
                    18 => { __state = 19; }
                    19 => { __state = 20; }
                    20 => {
                    ...
                    22 => {
                        unsafe {
                            sqlite3_set_string(pz_err_msg_1, db,
                                c"cannot VACUUM from within a transaction".as_ptr() as
                                        *mut i8 as *const i8)
                        };
                        __state = 23;
                    }
                    23 => { return 1; }
                    24 => {
                        saved_open_flags = unsafe { (*db).open_flags };
                        __state = 27;
                    }
                    25 => {
                        unsafe {
                            sqlite3_set_string(pz_err_msg_1, db,
                                c"cannot VACUUM - SQL statements in progress".as_ptr() as
                                        *mut i8 as *const i8)
                        };
                        __state = 26;
                    }
                    ...
                    29 => {
                        if unsafe { sqlite3_value_type(p_out_1) } != 3 {
                            __state = 32;
                        } else { __state = 31; }
                    }
                    30 => {
                        z_out = c"".as_ptr() as *mut i8 as *const i8;
                        __state = 28;
                    }
                    31 => {
                        z_out = unsafe { sqlite3_value_text(p_out_1) } as *const i8;
                        __state = 34;
                    }
                    32 => {
                        unsafe {
                            sqlite3_set_string(pz_err_msg_1, db,
                                c"non-text filename".as_ptr() as *mut i8 as *const i8)
                        };
                        __state = 33;
                    }
                    33 => { return 1; }
                    34 => {
                        unsafe { (*db).open_flags &= !1 as u32 };
                        __state = 35;
                    }
                    35 => {
                        unsafe { (*db).open_flags |= (4 | 2) as u32 };
                        __state = 28;
                    }
                    36 => {
                        saved_m_db_flags = unsafe { (*db).m_db_flags };
                        __state = 37;
                    }
                    37 => {
                        saved_n_change = unsafe { (*db).n_change };
                        __state = 38;
                    }
                    38 => {
                        saved_n_total_change = unsafe { (*db).n_total_change };
                        __state = 39;
                    }
                    39 => {
                        saved_m_trace = unsafe { (*db).m_trace };
                        __state = 40;
                    }
                    40 => {
                        unsafe {
                            (*db).flags |=
                                (1 | 512) as u64 | (64 as u64) << 32 | (16 as u64) << 32 |
                                    (32 as u64) << 32
                        };
                        __state = 41;
                    }
                    41 => {
                        unsafe { (*db).m_db_flags |= (2 | 4) as u32 };
                        __state = 42;
                    }
                    42 => {
                        unsafe {
                            (*db).flags &=
                                !(((16384 | 4096 | 268435456) as u64 | (1 as u64) << 32) as
                                        u64)
                        };
                        __state = 43;
                    }
                    43 => { unsafe { (*db).m_trace = 0 as u8 }; __state = 44; }
                    44 => {
                        z_db_main =
                            unsafe {
                    ...
                    45 => {
                        p_main =
                            unsafe {
                                (*unsafe { (*db).a_db.offset(i_db_1 as isize) }).p_bt
                            };
                        __state = 46;
                    }
                    46 => {
                        is_mem_db =
                            unsafe {
                                sqlite3_pager_is_memdb(unsafe {
                                        sqlite3_btree_pager(p_main)
                                    })
                            };
                        __state = 47;
                    }
                    ...
                    48 => {
                        unsafe {
                            sqlite3_snprintf(core::mem::size_of::<[i8; 42]>() as i32,
                                &raw mut z_db_vacuum[0 as usize] as *mut i8,
                                c"vacuum_%016llx".as_ptr() as *mut i8 as *const i8,
                                i_random)
                        };
                        __state = 49;
                    }
                    49 => { n_db = unsafe { (*db).n_db }; __state = 50; }
                    50 => {
                        rc =
                            unsafe {
                                exec_sql_f(db, pz_err_msg_1,
                                    c"ATTACH %Q AS %s".as_ptr() as *mut i8 as *const i8, z_out,
                                    &raw mut z_db_vacuum[0 as usize] as *mut i8)
                            };
                        __state = 51;
                    }
                    51 => {
                        unsafe { (*db).open_flags = saved_open_flags };
                        __state = 52;
                    }
                    52 => {
                        if rc != 0 { __state = 54; } else { __state = 53; }
                    }
                    53 => { { let _ = 0; }; __state = 55; }
                    54 => { __state = 2; }
                    55 => {
                        p_db =
                            unsafe { unsafe { (*db).a_db.offset(n_db as isize) } };
                        __state = 56;
                    }
                    56 => { { let _ = 0; }; __state = 57; }
                    57 => { p_temp = unsafe { (*p_db).p_bt }; __state = 58; }
                    58 => {
                        n_res =
                            unsafe { sqlite3_btree_get_requested_reserve(p_main) };
                        __state = 59;
                    }
                    59 => {
                        if !(p_out_1).is_null() {
                    ...
                    60 => {
                        unsafe {
                            sqlite3_btree_set_cache_size(p_temp,
                                unsafe {
                                    (*unsafe {
                    ...
                    61 => {
                        id =
                            unsafe {
                                sqlite3_pager_file(unsafe { sqlite3_btree_pager(p_temp) })
                            };
                        __state = 62;
                    }
                    62 => { sz = 0 as i64; __state = 63; }
                    63 => { __state = 64; }
                    64 => {
                        if unsafe { (*id).p_methods } != core::ptr::null() &&
                                (unsafe { sqlite3_os_file_size(id, &mut sz) } != 0 ||
                                    sz > 0 as i64) {
                            __state = 66;
                        } else { __state = 65; }
                    }
                    65 => {
                        unsafe { (*db).m_db_flags |= 8 as u32 };
                        __state = 69;
                    }
                    66 => { rc = 1; __state = 67; }
                    67 => {
                        unsafe {
                            sqlite3_set_string(pz_err_msg_1, db,
                                c"output file already exists".as_ptr() as *mut i8 as
                                    *const i8)
                        };
                        __state = 68;
                    }
                    ...
                    69 => {
                        pgflags =
                            (unsafe {
                                            (*unsafe {
                                                        (*db).a_db.offset(i_db_1 as isize)
                                                    }).safety_level
                                        } as u64 | unsafe { (*db).flags } & 56 as u64) as u32;
                        __state = 70;
                    }
                    70 => {
                        z_filename = unsafe { sqlite3_btree_get_filename(p_temp) };
                        __state = 71;
                    }
                    71 => {
                    ...
                    72 => {
                        n_new =
                            unsafe {
                                    sqlite3_uri_int64(z_filename,
                                        c"reserve".as_ptr() as *mut i8 as *const i8,
                                        n_res as sqlite3_int64)
                                } as i32;
                        __state = 73;
                    }
                    73 => {
                    ...
                    74 => { n_res = n_new; __state = 60; }
                    75 => {
                        unsafe {
                            sqlite3_btree_set_spill_size(p_temp,
                                unsafe { sqlite3_btree_set_spill_size(p_main, 0) })
                        };
                        __state = 76;
                    }
                    76 => {
                        unsafe {
                            sqlite3_btree_set_pager_flags(p_temp, pgflags | 32 as u32)
                        };
                        __state = 77;
                    }
                    77 => {
                        rc =
                            exec_sql(db, pz_err_msg_1,
                                c"BEGIN".as_ptr() as *mut i8 as *const i8);
                        __state = 78;
                    }
                    78 => {
                        if rc != 0 { __state = 80; } else { __state = 79; }
                    }
                    79 => {
                        rc =
                            unsafe {
                                sqlite3_btree_begin_trans(p_main,
                                    if p_out_1 == core::ptr::null_mut() { 2 } else { 0 },
                                    core::ptr::null_mut())
                            };
                        __state = 81;
                    }
                    ...
                    84 => {
                        if unsafe {
                                            sqlite3_btree_set_page_size(p_temp,
                                                unsafe { sqlite3_btree_get_page_size(p_main) }, n_res, 0)
                                        } != 0 ||
                                    (is_mem_db == 0) as i32 != 0 &&
                                        unsafe {
                                                sqlite3_btree_set_page_size(p_temp,
                                                    unsafe { (*db).next_pagesize }, n_res, 0)
                                            } != 0 || unsafe { (*db).malloc_failed } != 0 {
                            __state = 87;
                        } else { __state = 86; }
                    }
                    85 => { unsafe { (*db).next_pagesize = 0 }; __state = 84; }
                    86 => {
                        unsafe {
                            sqlite3_btree_set_auto_vacuum(p_temp,
                                if unsafe { (*db).next_autovac } as i32 >= 0 {
                                    (unsafe { (*db).next_autovac }) as i32
                                } else { unsafe { sqlite3_btree_get_auto_vacuum(p_main) } })
                        };
                        __state = 89;
                    }
                    87 => { rc = 7; __state = 88; }
                    88 => { __state = 2; }
                    89 => {
                        unsafe { (*db).init.i_db = n_db as u8 };
                        __state = 90;
                    }
                    90 => {
                        rc =
                            unsafe {
                                exec_sql_f(db, pz_err_msg_1,
                                    c"SELECT sql FROM \"%w\".sqlite_schema WHERE type=\'table\'AND name<>\'sqlite_sequence\' AND coalesce(rootpage,1)>0".as_ptr()
                                            as *mut i8 as *const i8, z_db_main)
                            };
                        __state = 91;
                    }
                    91 => {
                    ...
                    92 => {
                        rc =
                            unsafe {
                                exec_sql_f(db, pz_err_msg_1,
                                    c"SELECT sql FROM \"%w\".sqlite_schema WHERE type=\'index\'".as_ptr()
                                            as *mut i8 as *const i8, z_db_main)
                            };
                        __state = 94;
                    }
                    ...
                    97 => {
                        rc =
                            unsafe {
                                exec_sql_f(db, pz_err_msg_1,
                                    c"SELECT\'INSERT INTO %s.\'||quote(name)||\' SELECT*FROM\"%w\".\'||quote(name)FROM %s.sqlite_schema WHERE type=\'table\'AND coalesce(rootpage,1)>0".as_ptr()
                                            as *mut i8 as *const i8,
                                    &raw mut z_db_vacuum[0 as usize] as *mut i8, z_db_main,
                                    &raw mut z_db_vacuum[0 as usize] as *mut i8)
                            };
                        __state = 98;
                    }
                    ...
                    101 => {
                        rc =
                            unsafe {
                                exec_sql_f(db, pz_err_msg_1,
                                    c"INSERT INTO %s.sqlite_schema SELECT*FROM \"%w\".sqlite_schema WHERE type IN(\'view\',\'trigger\') OR(type=\'table\'AND rootpage=0)".as_ptr()
                                            as *mut i8 as *const i8,
                                    &raw mut z_db_vacuum[0 as usize] as *mut i8, z_db_main)
                            };
                        __state = 103;
                    ...
                    104 => { __state = 107; }
                    105 => { __state = 2; }
                    106 => { { let _ = 0; }; __state = 127; }
                    107 => { __state = 108; }
                    108 => { __state = 109; }
                    109 => { { let _ = 0; }; __state = 110; }
                    110 => { { let _ = 0; }; __state = 111; }
                    111 => { i = 0; __state = 113; }
                    112 => {
                        if p_out_1 == core::ptr::null_mut() {
                            __state = 120;
                        } else { __state = 119; }
                    }
                    113 => {
                    ...
                    114 => {
                        unsafe {
                            sqlite3_btree_get_meta(p_main, a_copy[i as usize] as i32,
                                &mut meta)
                        };
                        __state = 116;
                    }
                    ...
                    116 => {
                        rc =
                            unsafe {
                                sqlite3_btree_update_meta(p_temp, a_copy[i as usize] as i32,
                                    meta + a_copy[(i + 1) as usize] as u32)
                            };
                        __state = 117;
                    }
                    117 => {
                        if rc != 0 { __state = 118; } else { __state = 115; }
                    }
                    118 => { __state = 2; }
                    119 => {
                        if rc != 0 { __state = 122; } else { __state = 121; }
                    }
                    120 => {
                        rc = unsafe { sqlite3_btree_copy_file(p_main, p_temp) };
                        __state = 119;
                    }
                    121 => {
                        rc = unsafe { sqlite3_btree_commit(p_temp) };
                        __state = 123;
                    }
                    122 => { __state = 2; }
                    123 => {
                    ...
                    126 => {
                        unsafe {
                            sqlite3_btree_set_auto_vacuum(p_main,
                                unsafe { sqlite3_btree_get_auto_vacuum(p_temp) })
                        };
                        __state = 106;
                    }
                    127 => {
                    ...
                    129 => {
                        n_res =
                            unsafe { sqlite3_btree_get_requested_reserve(p_temp) };
                        __state = 130;
                    }
                    130 => {
                        rc =
                            unsafe {
                                sqlite3_btree_set_page_size(p_main,
                                    unsafe { sqlite3_btree_get_page_size(p_temp) }, n_res, 1)
                            };
                        __state = 128;
                    }
                    131 => {
                        unsafe { (*db).m_db_flags = saved_m_db_flags };
                        __state = 132;
                    }
                    132 => {
                    ...
                    133 => {
                        unsafe { (*db).n_change = saved_n_change };
                        __state = 134;
                    }
                    134 => {
                        unsafe { (*db).n_total_change = saved_n_total_change };
                        __state = 135;
                    }
                    135 => {
                        unsafe { (*db).m_trace = saved_m_trace };
                        __state = 136;
                    }
                    136 => {
                        unsafe { sqlite3_btree_set_page_size(p_main, -1, 0, 1) };
                        __state = 137;
                    }
                    137 => {
...
static a_copy: [u8; 10] =
    [1 as u8, 1 as u8, 3 as u8, 0 as u8, 5 as u8, 0 as u8, 6 as u8, 0 as u8,
            8 as u8, 0 as u8];
extern "C" {
