...
pub extern "C" fn sqlite3_fts5_get_varint(mut p: *const u8, v: &mut u64)
    ...
    a = unsafe { *p } as u32;
    if (a & 128 as u32 == 0) as i32 != 0 { *v = a as u64; return 1 as u8; }
    {
        let __p = &mut p;
        let __t = *__p;
    ...
    if !(2080895 == 127 << 14 | 127) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"sqlite3Fts5GetVarint".as_ptr() as *const i8,
                c"fts5_varint.c".as_ptr() as *mut i8 as *const i8, 126,
                c"SLOT_2_0 == ((0x7f<<14) | (0x7f))".as_ptr() as *mut i8 as
                    *const i8)
        }
    } else { { let _ = 0; } };
    if !(4028612735u32 == 15 << 28 | (127 << 14) as u32 | 127 as u32) as i32
                as i64 != 0 {
        unsafe {
            __assert_rtn(c"sqlite3Fts5GetVarint".as_ptr() as *const i8,
                c"fts5_varint.c".as_ptr() as *mut i8 as *const i8, 127,
                c"SLOT_4_2_0 == ((0xfU<<28) | (0x7f<<14) | (0x7f))".as_ptr()
...
pub extern "C" fn sqlite3_fts5_get_varint32(mut p: *const u8, v: &mut u32)
    ...
    }
    {
        ...
        n = sqlite3_fts5_get_varint(p, &mut v64);
        *v = v64 as u32 & 2147483647 as u32;
        if !(n as i32 > 3 && n as i32 <= 9) as i32 as i64 != 0 {
            unsafe {
                __assert_rtn(c"sqlite3Fts5GetVarint32".as_ptr() as *const i8,
                    c"fts5_varint.c".as_ptr() as *mut i8 as *const i8, 80,
                    c"n>3 && n<=9".as_ptr() as *mut i8 as *const i8)
            }
        } else { { let _ = 0; } };
        return n as i32;
    }
...
pub extern "C" fn sqlite3_fts5_get_varint_len(i_val: u32) -> i32 {
    if !(i_val >= (1 << 7) as u32) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"sqlite3Fts5GetVarintLen".as_ptr() as *const i8,
                c"fts5_varint.c".as_ptr() as *mut i8 as *const i8, 339,
                c"iVal>=(1 << 7)".as_ptr() as *mut i8 as *const i8)
        }
    } else { { let _ = 0; } };
    if i_val < (1 << 14) as u32 { return 2; }
    if i_val < (1 << 21) as u32 { return 3; }
...
extern "C" fn fts5_put_varint64(p: *mut u8, mut v: u64) -> i32 {
    ...
    if !(n <= 9) as i32 as i64 != 0 {
        unsafe {
            __assert_rtn(c"fts5PutVarint64".as_ptr() as *const i8,
                c"fts5_varint.c".as_ptr() as *mut i8 as *const i8, 314,
                c"n<=9".as_ptr() as *mut i8 as *const i8)
        }
    } else { { let _ = 0; } };
    {
        { i = 0; j = n - 1 };
