...
extern "C" fn tmstmp_put_ts(p: &TmstmpFile, a_out_1: *mut u8) -> () {
    let mut tm: sqlite3_uint64 = 0 as sqlite3_uint64;
    unsafe {
        (unsafe {
                (*(*p).p_sub_vfs).x_current_time_int64.unwrap()
            })((*p).p_sub_vfs, &raw mut tm as *mut sqlite3_int64)
    };
    tm -= 210866760000000i64 as sqlite3_uint64;
    unsafe {
        *a_out_1.offset(0 as isize) = (tm >> 40 & 255 as sqlite3_uint64) as u8
    };
    unsafe {
        *a_out_1.offset(1 as isize) = (tm >> 32 & 255 as sqlite3_uint64) as u8
    };
    unsafe {
        *a_out_1.offset(2 as isize) = (tm >> 24 & 255 as sqlite3_uint64) as u8
    };
    unsafe {
        *a_out_1.offset(3 as isize) = (tm >> 16 & 255 as sqlite3_uint64) as u8
    };
    unsafe {
        *a_out_1.offset(4 as isize) = (tm >> 8 & 255 as sqlite3_uint64) as u8
    };
    unsafe {
        *a_out_1.offset(5 as isize) = (tm & 255 as sqlite3_uint64) as u8
    };
}
...
extern "C" fn tmstmp_close(mut p_file: *mut sqlite3_file) -> i32 {
...
extern "C" fn tmstmp_read(mut p_file: *mut sqlite3_file, z_buf: *mut (),
    ...
    if unsafe { (*p).is_wal } != 0 && unsafe { (*p).in_ckpt } != 0 &&
        ...
        unsafe {
            (*unsafe { (*p).p_partner }).i_frame =
                ((i_ofst - 56 as sqlite_int64) /
                            (unsafe { (*p).pgsz } + 24 as u32) as sqlite_int64 +
                        1 as sqlite_int64) as u32
        };
    }
    return rc;
}
...
extern "C" fn tmstmp_write(p_file: *mut sqlite3_file, z_buf: *const (),
    i_amt: i32, i_ofst: sqlite3_int64) -> i32 {
    let p: *mut TmstmpFile = p_file as *mut TmstmpFile;
    let p_sub: *mut sqlite3_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
    if (unsafe { (*p).has_correct_reserve } == 0) as i32 != 0
        ...
        if i_amt == 24 {
            ...
            unsafe { (*p).i_ofst = i_ofst };
                ...
                i_ofst == unsafe { (*p).i_ofst } + 24 as sqlite3_int64 {
        ...
        tmstmp_event(p, 6 as u8, 0 as u8,
            (i_ofst / unsafe { (*p).pgsz } as sqlite_int64 +
                    1 as sqlite_int64) as u32, unsafe { (*p).i_frame },
            core::ptr::null());
        ...
        tmstmp_event(p, 4 as u8, 0 as u8,
            (i_ofst / unsafe { (*p).pgsz } as sqlite_int64) as u32 + 1 as u32,
...
extern "C" fn tmstmp_truncate(mut p_file: *mut sqlite3_file,
...
extern "C" fn tmstmp_sync(mut p_file: *mut sqlite3_file, flags: i32) -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
    return unsafe {
...
extern "C" fn tmstmp_file_size(mut p_file: *mut sqlite3_file,
...
extern "C" fn tmstmp_lock(mut p_file: *mut sqlite3_file, e_lock: i32) -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
    return unsafe {
...
extern "C" fn tmstmp_unlock(mut p_file: *mut sqlite3_file, e_lock: i32)
    -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
...
extern "C" fn tmstmp_check_reserved_lock(mut p_file: *mut sqlite3_file,
...
extern "C" fn tmstmp_file_control(mut p_file: *mut sqlite3_file, op: i32,
    p_arg: *mut ()) -> i32 {
    let mut rc: i32 = 0;
    let p: *mut TmstmpFile = p_file as *mut TmstmpFile;
    p_file =
...
extern "C" fn tmstmp_sector_size(mut p_file: *mut sqlite3_file) -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
    return unsafe {
...
extern "C" fn tmstmp_device_characteristics(mut p_file: *mut sqlite3_file)
    -> i32 {
...
extern "C" fn tmstmp_shm_map(mut p_file: *mut sqlite3_file, i_pg: i32,
...
extern "C" fn tmstmp_shm_lock(mut p_file: *mut sqlite3_file, offset: i32,
    n: i32, flags: i32) -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
...
extern "C" fn tmstmp_shm_barrier(mut p_file: *mut sqlite3_file) -> () {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
    unsafe {
...
extern "C" fn tmstmp_shm_unmap(mut p_file: *mut sqlite3_file,
    delete_flag: i32) -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
...
extern "C" fn tmstmp_fetch(mut p_file: *mut sqlite3_file,
    i_ofst: sqlite3_int64, i_amt: i32, pp: *mut *mut ()) -> i32 {
    p_file =
        unsafe { (p_file as *mut TmstmpFile).offset(1 as isize) } as
            *mut sqlite3_file;
    return unsafe {
...
extern "C" fn tmstmp_unfetch(mut p_file: *mut sqlite3_file,
...
static tmstmp_io_methods: sqlite3_io_methods =
    sqlite3_io_methods {
        i_version: 3,
...
extern "C" fn tmstmp_open(p_vfs: *mut sqlite3_vfs, z_name: *const i8,
    ...
    '__b1: loop {
        '__c1: loop {
            ...
            if p_db != core::ptr::null_mut() {
                ...
                let mut p_log: *mut TmstmpLog = core::ptr::null_mut();
                let mut r1: sqlite3_uint64 = 0 as sqlite3_uint64;
                let mut days: sqlite3_uint64 = 0 as sqlite3_uint64;
                let mut sod: sqlite3_uint64 = 0 as sqlite3_uint64;
                let mut z: sqlite3_uint64 = 0 as sqlite3_uint64;
                let mut era: sqlite3_uint64 = 0 as sqlite3_uint64;
                let mut h: i32 = 0;
                let mut m: i32 = 0;
                let mut s: i32 = 0;
                let mut f: i32 = 0;
                ...
                unsafe {
                    (unsafe {
                        ...
                        &raw mut r1 as *mut sqlite3_int64)
                };
                r1 -= 210866760000000i64 as sqlite3_uint64;
                days = r1 / 86400000 as sqlite3_uint64;
                sod =
                    r1 % 86400000 as sqlite3_uint64 / 1000 as sqlite3_uint64;
                f = (r1 % 1000 as sqlite3_uint64) as i32;
                h = (sod / 3600 as sqlite3_uint64) as i32;
                m =
                    (sod % 3600 as sqlite3_uint64 / 60 as sqlite3_uint64) as
                        i32;
                s = (sod % 60 as sqlite3_uint64) as i32;
                z = days + 719468 as sqlite3_uint64;
                era = z / 146097 as sqlite3_uint64;
                doe = (z - era * 146097 as sqlite3_uint64) as u32;
                yoe =
                    (doe - doe / 1460 as u32 + doe / 36524 as u32 -
                            doe / 146096 as u32) / 365 as u32;
                y =
                    (yoe as i32 as sqlite3_uint64 + era * 400 as sqlite3_uint64)
                        as i32;
                doy =
                    doe -
...
extern "C" fn tmstmp_delete(p: *mut sqlite3_vfs, z_name: *const i8,
    sync_dir: i32) -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
            (unsafe { (*p_sub).x_delete.unwrap() })(p_sub, z_name, sync_dir)
        };
}
extern "C" fn tmstmp_access(p: *mut sqlite3_vfs, z_name: *const i8,
    flags: i32, p_r: *mut i32) -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_full_pathname(p: *mut sqlite3_vfs, z_name: *const i8,
...
extern "C" fn tmstmp_dl_open(p: *mut sqlite3_vfs, z_filename: *const i8)
    -> *mut () {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_dl_error(p: *mut sqlite3_vfs, n_byte: i32,
    z_err_msg: *mut i8) -> () {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_dl_sym(p: *mut sqlite3_vfs, p_dl: *mut (),
...
extern "C" fn tmstmp_dl_close(p: *mut sqlite3_vfs, p_dl: *mut ()) -> () {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe { (unsafe { (*p_sub).x_dl_close.unwrap() })(p_sub, p_dl) };
}
extern "C" fn tmstmp_randomness(p: *mut sqlite3_vfs, n_byte: i32,
    z_out: *mut i8) -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_sleep(p: *mut sqlite3_vfs, microseconds: i32) -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_current_time(p: *mut sqlite3_vfs, pr_now: *mut f64)
    -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_get_last_error(p: *mut sqlite3_vfs, a: i32, b: *mut i8)
    -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_current_time_int64(p: *mut sqlite3_vfs,
    pi_now: *mut sqlite3_int64) -> i32 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_set_system_call(p: *mut sqlite3_vfs, z_name: *const i8,
...
extern "C" fn tmstmp_get_system_call(p: *mut sqlite3_vfs, z: *const i8)
    -> unsafe extern "C" fn() -> () {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
extern "C" fn tmstmp_next_system_call(p: *mut sqlite3_vfs, z_name: *const i8)
    -> *const i8 {
    let p_sub: *mut sqlite3_vfs =
        unsafe { (*p).p_app_data } as *mut sqlite3_vfs;
    return unsafe {
...
static mut tmstmp_vfs: sqlite3_vfs =
    sqlite3_vfs {
        i_version: 3,
        sz_os_file: 0,
        mx_pathname: 1024,
...
extern "C" fn tmstmp_register_vfs() -> i32 {
    unsafe {
        ...
        if p_orig == &raw mut tmstmp_vfs as *mut sqlite3_vfs { return 0; }
