...
struct sqlite3 {
    ...
    u1: sqlite3_u1,
    lookaside: Lookaside,
    x_auth: unsafe extern "C" fn(*mut (), i32, *const i8, *const i8,
...
extern "C" fn rename_column_parse_error(p_ctx_1: *mut sqlite3_context,
    z_when_1: *const i8, p_type_1: *mut sqlite3_value,
    p_object_1: *mut sqlite3_value, p_parse_1: &Parse) -> () {
            ...
            '__b7: loop {
                ...
                '__c7: loop {
                    let z_name: *const i8 =
                        unsafe {
                                (*(unsafe { (*p_e_list_1).a.as_ptr() } as
                                                *const ExprList_item).offset(i as isize)).z_e_name
                            } as *const i8;
                    if unsafe {
                                            (*(unsafe { (*p_e_list_1).a.as_ptr() } as
                                                                *const ExprList_item).offset(i as isize)).fg.e_e_name()
                    ...
                    let z_name: *const i8 =
                        unsafe {
                                (*(unsafe { (*p_id_list_1).a.as_ptr() } as
                                                *const IdList_item).offset(i as isize)).z_name
                            } as *const i8;
...
extern "C" fn rename_edit_sql(p_ctx_1: *mut sqlite3_context,
...
extern "C" fn rename_column_func(context: *mut sqlite3_context,
    not_used_1: i32, argv: *mut *mut sqlite3_value) -> () {
    unsafe {
...
extern "C" fn rename_table_func(context: *mut sqlite3_context,
    not_used_1: i32, argv: *mut *mut sqlite3_value) -> () {
    unsafe {
...
extern "C" fn rename_table_test(context: *mut sqlite3_context,
    not_used_1: i32, argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let db: *mut sqlite3 = unsafe { sqlite3_context_db_handle(context) };
        let z_db: *const i8 =
...
extern "C" fn drop_column_func(context: *mut sqlite3_context, not_used_1: i32,
...
extern "C" fn rename_quotefix_func(context: *mut sqlite3_context,
    not_used_1: i32, argv: *mut *mut sqlite3_value) -> () {
    unsafe {
        let db: *mut sqlite3 = unsafe { sqlite3_context_db_handle(context) };
        let z_db: *const i8 =
...
extern "C" fn skip_create_table(ctx: *mut sqlite3_context, z_sql_1: *const u8,
...
extern "C" fn quoted_compare(ctx: *mut sqlite3_context, t: i32,
...
unsafe extern "C" fn error_m_printf(p_ctx_1: *mut sqlite3_context,
...
extern "C" fn drop_constraint_func(ctx: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_sql: *const u8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) };
...
extern "C" fn fail_constraint_func(ctx: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_text: *const i8 =
...
extern "C" fn add_constraint_func(ctx: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
    let z_sql: *const u8 =
        unsafe { sqlite3_value_text(unsafe { *argv.offset(0 as isize) }) };
    let z_cons: *const i8 =
    ...
    let mut i_off: i32 = 0;
    let mut ii: i32 = 0;
    let mut p_new: *mut sqlite3_str = core::ptr::null_mut();
    let mut t: i32 = 0;
    { let _ = not_used_1; };
    if skip_create_table(ctx, z_sql, &mut i_off) != 0 { return; }
    {
...
extern "C" fn find_constraint_func(ctx: *mut sqlite3_context, not_used_1: i32,
    argv: *mut *mut sqlite3_value) -> () {
                ...
                sqlite3_rename_token_remap(unsafe { &*p_parse_1 },
                    ...
                    unsafe {
                            (*((*p_id_list_1).a.as_ptr() as
                                            *const IdList_item).offset(ii as isize)).z_name
                        } as *const ());
                break '__c44;
            }
            { let __p = &mut ii; let __t = *__p; *__p += 1; __t };
