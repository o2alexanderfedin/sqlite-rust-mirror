...
#[repr(C)]
#[derive(Copy, Clone)]
union IndexIterator_u0 {
    lx: IndexIterator_u0_s0,
    ax: IndexIterator_u0_s1,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct IndexIterator_u0_s0 {
    p_idx: *mut Index,
}
#[repr(C)]
#[derive(Copy, Clone)]
struct IndexIterator_u0_s1 {
    n_idx: i32,
                    ...
                    300 => {
                        unsafe {
                            sqlite3_expr_code(p_parse,
                                unsafe {
                                    (*(unsafe { (*p_list).a.as_ptr() } as
                                                    *mut ExprList_item).offset(ipk_column as isize)).p_expr
                                }, reg_cols)
                        };
                        __state = 297;
                    }
                        ...
                        unsafe {
                            sqlite3_expr_affinity(unsafe {
                                        (*(unsafe { (*(*p_idx_1).a_col_expr).a.as_ptr() } as
                                                        *mut ExprList_item).offset(n as isize)).p_expr
                                    } as *const Expr)
                        };
                }
