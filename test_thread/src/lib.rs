...
extern "C" fn sqlthread_parent(client_data_1: ClientData,
    ...
    unsafe {
        Tcl_ThreadQueueEvent(unsafe { (*p).parent }, p_event as *mut TclEvent,
            TCL_QUEUE_TAIL)
    };
...
extern "C" fn post_to_parent(p: &SqlThread, p_script_1: *mut TclObj) -> () {
    ...
    unsafe {
        Tcl_ThreadQueueEvent((*p).parent, p_event as *mut TclEvent,
            TCL_QUEUE_TAIL)
    };
...
extern "C" fn tcl_script_thread(p_sql_thread_1: ClientData) -> () {
    ...
    let mut p_list: *mut TclObj = core::ptr::null_mut();
    let mut rc: i32 = 0;
...
extern "C" fn sqlthread_proc(client_data_1: ClientData,
    ...
    let mut p_sub: *const SubCommandN10SubCommand = core::ptr::null();
    let mut rc: i32 = 0;
    ...
    rc =
        unsafe {
            Tcl_GetIndexFromObjStruct(interp,
                ...
                &raw mut a_sub[0 as usize] as *mut SubCommandN10SubCommand as
                    *const (),
                core::mem::size_of::<SubCommandN10SubCommand>() as i32,
...
extern "C" fn clock_milliseconds_proc(client_data_1: ClientData,
    ...
    unsafe {
        Tcl_SetObjResult(interp,
            unsafe {
                Tcl_NewWideIntObj(now.sec as TclWideInt * 1000 as TclWideInt +
...
pub extern "C" fn sqlitetest_thread_init(interp: *mut TclInterp) -> i32 {
    ...
    let mut ii: i32 = 0;
    {
        ...
        '__b4: loop {
            if !((ii as u64) <
                            core::mem::size_of::<[TclCmdN6TclCmd; 3]>() as u64 /
                                core::mem::size_of::<TclCmdN6TclCmd>() as u64) {
                break '__b4;
            }
            '__c4: loop {
...
extern "C" {
    ...
    -> *mut ();
    fn Tcl_ThreadQueueEvent(threadId: TclThreadId, evPtr: *mut TclEvent,
    position: TclQueuePosition)
    -> ();
    fn Tcl_ThreadAlert(threadId: TclThreadId)
    -> ();
    fn Tcl_GetTime(timeBuf: *mut TclTime)
    -> ();
    fn Tcl_NewIntObj(intValue: i32)
    -> *mut TclObj;
    fn Tcl_SetObjResult(interp: *mut TclInterp, resultObjPtr: *mut TclObj)
    -> ();
    fn sqlitetest1_init(_: *mut TclInterp)
    -> i32;
    fn Sqlite3_Init(_: *mut TclInterp)
    -> i32;
    fn Tcl_CreateInterp()
    -> *mut TclInterp;
    ...
    -> TclCommand;
    fn sqlitetest_mutex_init(_: *mut TclInterp)
    -> i32;
    ...
    -> ();
    fn Tcl_DeleteInterp(interp: *mut TclInterp)
    -> ();
    ...
    -> TclThreadId;
    fn Tcl_CreateThread(idPtr: *mut TclThreadId,
    proc: unsafe extern "C" fn(*mut ()) -> (), clientData: ClientData,
    stackSize: i32, flags: i32)
    -> i32;
    fn sqlite3_test_make_pointer_str(_: *mut TclInterp, _: *mut i8,
    _: *mut ())
    -> i32;
    ...
    -> ();
    fn Tcl_GetIndexFromObjStruct(interp: *mut TclInterp, objPtr: *mut TclObj,
    tablePtr: *const (), offset: i32, msg: *const i8, flags: i32,
    indexPtr: *mut i32)
    -> i32;
    ...
    -> i32;
    fn sqlite3_test_err_code(_: *mut TclInterp, _: *mut Sqlite3, _: i32)
    -> i32;
