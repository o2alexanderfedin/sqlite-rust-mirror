...
struct VfslogFile {
    ...
    p_vfslog: *mut sqlite3_vfs,
    i_file_id: i32,
}
extern "C" fn vfslog_time() -> sqlite3_uint64 {
    let mut s_time: timeval = unsafe { core::mem::zeroed() };
    unsafe { gettimeofday(&mut s_time, core::ptr::null_mut()) };
    return s_time.tv_usec as sqlite3_uint64 +
            s_time.tv_sec as sqlite3_uint64 * 1000000 as sqlite3_uint64;
}
extern "C" fn vfslog_flush(p: &mut VfslogVfs) -> () {
    if (*p).n_buf != 0 {
        ...
        (*p).i_offset += (*p).n_buf as sqlite3_int64;
        (*p).n_buf = 0;
    }
}
...
extern "C" fn vfslog_call(p_vfs: *mut sqlite3_vfs, e_event: i32,
    i_fileid: i32, n_click: sqlite3_int64, return_code: i32, size: i32,
    offset: i32) -> () {
    ...
    put32bits(unsafe { &mut *z_rec.offset(8 as isize) },
        (n_click & 65535 as sqlite3_int64) as u32);
...
extern "C" fn vfslog_close(p_file: *mut sqlite3_file) -> i32 {
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let mut rc: i32 = 0;
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 3, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, 0, 0);
    return rc;
}
extern "C" fn vfslog_read(p_file: *mut sqlite3_file, z_buf: *mut (),
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 14, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, i_amt, i_ofst as i32);
    return rc;
}
extern "C" fn vfslog_write(p_file: *mut sqlite3_file, z: *const (),
    i_amt: i32, i_ofst: sqlite3_int64) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
...
extern "C" fn vfslog_truncate(p_file: *mut sqlite3_file, size: sqlite3_int64)
    -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 18, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, 0, size as i32);
    return rc;
}
extern "C" fn vfslog_sync(p_file: *mut sqlite3_file, flags: i32) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    t = vfslog_time();
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 17, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, flags, 0);
    return rc;
}
extern "C" fn vfslog_file_size(p_file: *mut sqlite3_file,
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 8, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, 0, unsafe { *p_size } as i32);
    return rc;
}
extern "C" fn vfslog_lock(p_file: *mut sqlite3_file, e_lock: i32) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    t = vfslog_time();
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 11, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, e_lock, 0);
    return rc;
}
extern "C" fn vfslog_unlock(p_file: *mut sqlite3_file, e_lock: i32) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    t = vfslog_time();
...
extern "C" fn vfslog_check_reserved_lock(p_file: *mut sqlite3_file,
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 2, unsafe { (*p).i_file_id },
        t as sqlite3_int64, rc, unsafe { *p_res_out }, 0);
    return rc;
}
extern "C" fn vfslog_file_control(p_file: *mut sqlite3_file, op: i32,
    p_arg: *mut ()) -> i32 {
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    let rc: i32 =
        unsafe {
...
extern "C" fn vfslog_sector_size(p_file: *mut sqlite3_file) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    t = vfslog_time();
...
extern "C" fn vfslog_device_characteristics(p_file: *mut sqlite3_file)
    -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
...
extern "C" fn vfslog_shm_lock(p_file: *mut sqlite3_file, ofst: i32, n: i32,
    flags: i32) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
...
extern "C" fn vfslog_shm_map(p_file: *mut sqlite3_file, i_region: i32,
...
extern "C" fn vfslog_shm_barrier(p_file: *mut sqlite3_file) -> () {
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
    t = vfslog_time();
    unsafe {
    ...
    vfslog_call(unsafe { (*p).p_vfslog }, 26, unsafe { (*p).i_file_id },
        t as sqlite3_int64, 0, 0, 0);
}
extern "C" fn vfslog_shm_unmap(p_file: *mut sqlite3_file, delete_flag: i32)
    -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    let p: *const VfslogFile = p_file as *mut VfslogFile as *const VfslogFile;
...
static mut vfslog_io_methods: sqlite3_io_methods =
    sqlite3_io_methods {
        i_version: 2,
...
extern "C" fn vfslog_string(p_vfs: *mut sqlite3_vfs, z_str: *const i8) -> () {
    let p: *mut VfslogVfs = p_vfs as *mut VfslogVfs;
    let mut z_rec: *mut u8 = core::ptr::null_mut();
    let n_str: i32 =
        if !(z_str).is_null() {
...
extern "C" fn vfslog_open(p_vfs: *mut sqlite3_vfs, z_name: *const i8,
    ...
    unsafe {
        ...
        unsafe {
            (*p_file).p_methods =
                &raw mut vfslog_io_methods as *const sqlite3_io_methods
        };
        unsafe {
            (*p).p_real =
        ...
        t = vfslog_time() - t;
        vfslog_call(p_vfs, 12, unsafe { (*p).i_file_id }, t as sqlite3_int64,
            rc, 0, 0);
        vfslog_string(p_vfs, z_name);
        return rc;
    }
}
extern "C" fn vfslog_delete(p_vfs: *mut sqlite3_vfs, z_path: *const i8,
    dir_sync: i32) -> i32 {
    let mut rc: i32 = 0;
    let mut t: sqlite3_uint64 = 0 as sqlite3_uint64;
    t = vfslog_time();
    ...
    t = vfslog_time() - t;
    vfslog_call(p_vfs, 5, 0, t as sqlite3_int64, rc, dir_sync, 0);
    vfslog_string(p_vfs, z_path);
    return rc;
}
extern "C" fn vfslog_access(p_vfs: *mut sqlite3_vfs, z_path: *const i8,
    ...
    t = vfslog_time() - t;
    vfslog_call(p_vfs, 1, 0, t as sqlite3_int64, rc, flags,
        unsafe { *p_res_out });
    vfslog_string(p_vfs, z_path);
    return rc;
}
extern "C" fn vfslog_full_pathname(p_vfs: *mut sqlite3_vfs, z_path: *const i8,
...
extern "C" fn vfslog_dl_open(p_vfs: *mut sqlite3_vfs, z_path: *const i8)
    -> *mut () {
    return unsafe {
            (unsafe {
                    (*unsafe {
...
extern "C" fn vfslog_dl_error(p_vfs: *mut sqlite3_vfs, n_byte: i32,
    z_err_msg: *mut i8) -> () {
    unsafe {
        (unsafe {
                (*unsafe {
...
extern "C" fn vfslog_dl_sym(p_vfs: *mut sqlite3_vfs, p: *mut (),
...
extern "C" fn vfslog_dl_close(p_vfs: *mut sqlite3_vfs, p_handle: *mut ())
    -> () {
    unsafe {
        (unsafe {
                (*unsafe {
...
extern "C" fn vfslog_randomness(p_vfs: *mut sqlite3_vfs, n_byte: i32,
...
extern "C" fn vfslog_sleep(p_vfs: *mut sqlite3_vfs, n_micro: i32) -> i32 {
    return unsafe {
            (unsafe {
                    (*unsafe {
                                        (*(p_vfs as *mut VfslogVfs)).p_vfs
...
extern "C" fn vfslog_current_time(p_vfs: *mut sqlite3_vfs,
...
extern "C" fn vfslog_get_last_error(p_vfs: *mut sqlite3_vfs, a: i32,
    b: *mut i8) -> i32 {
    return unsafe {
            (unsafe {
                    (*unsafe {
...
extern "C" fn vfslog_current_time_int64(p_vfs: *mut sqlite3_vfs,
...
static mut vfslog_vfs: sqlite3_vfs =
    sqlite3_vfs {
        i_version: 1,
...
pub extern "C" fn sqlite3_vfslog_new(z_vfs_1: *const i8,
    ...
    unsafe {
        ...
        if rc == 0 {
            ...
            unsafe { (*p).i_offset = 0 as sqlite3_int64 };
            unsafe { (*p).n_buf = 20 };
            rc = unsafe { sqlite3_vfs_register(p as *mut sqlite3_vfs, 1) };
        }
...
pub extern "C" fn sqlite3_vfslog_annotate(z_vfs_1: *const i8,
    ...
    vfslog_call(p_vfs, 28, 0, 0 as sqlite3_int64, 0, 0, 0);
...
extern "C" fn vlog_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    unsafe { (*p_idx_info_1).estimated_cost = 10.0 };
    return 0;
}
extern "C" fn vlog_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
...
extern "C" fn vlog_open(p_v_tab_1: *mut sqlite3_vtab,
...
extern "C" fn vlog_close(p_cursor_1: *mut sqlite3_vtab_cursor) -> i32 {
...
extern "C" fn vlog_next(p_cursor_1: *mut sqlite3_vtab_cursor) -> i32 {
    ...
    n_read = 24;
    if unsafe { (*p_csr).i_offset } + n_read as sqlite3_int64 <=
            unsafe { (*p).n_byte } {
            ...
            rc =
                unsafe {
                    (unsafe {
                        ...
                        unsafe { (*p_csr).i_offset } + n_read as sqlite3_int64)
                };
            n_read += 4;
            if rc == 0 {
                let n_str: i32 =
    ...
    unsafe { (*p_csr).i_rowid += 1 as sqlite3_int64 };
    unsafe { (*p_csr).i_offset += n_read as sqlite3_int64 };
    return rc;
}
extern "C" fn vlog_eof(p_cursor_1: *mut sqlite3_vtab_cursor) -> i32 {
...
extern "C" fn vlog_filter(p_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_csr: *mut VfslogCsr = p_cursor_1 as *mut VfslogCsr;
    unsafe { (*p_csr).i_rowid = 0 as sqlite3_int64 };
    unsafe { (*p_csr).i_offset = 20 as sqlite3_int64 };
    return vlog_next(p_cursor_1);
}
extern "C" fn vlog_column(p_cursor_1: *mut sqlite3_vtab_cursor,
...
extern "C" fn vlog_rowid(p_cursor_1: *mut sqlite3_vtab_cursor,
    ...
    unsafe {
        unsafe {
            sqlite3_create_module(db,
                ...
                &raw mut vfslog_module as *const sqlite3_module,
                core::ptr::null_mut())
        };
        return 0;
    }
}
static mut vfslog_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
