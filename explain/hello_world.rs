...
extern "C" fn explain_connect(db: *mut sqlite3, p_aux_1: *mut (), argc: i32,
    ...
    if rc == 0 {
        p_new =
            unsafe {
                    sqlite3_malloc64(core::mem::size_of::<explain_vtab>() as
                            sqlite3_uint64)
                } as *mut explain_vtab;
        ...
        unsafe {
            memset(p_new as *mut (), 0,
                core::mem::size_of::<explain_vtab>() as u64)
        };
        unsafe { (*p_new).db = db };
    }
    return rc;
}
extern "C" fn explain_disconnect(p_vtab_1: *mut sqlite3_vtab) -> i32 {
    unsafe { sqlite3_free(p_vtab_1 as *mut ()) };
    return 0;
}
extern "C" fn explain_open(p: *mut sqlite3_vtab,
    pp_cursor_1: *mut *mut sqlite3_vtab_cursor) -> i32 {
    let mut p_cur: *mut explain_cursor = core::ptr::null_mut();
    p_cur =
        unsafe {
                sqlite3_malloc64(core::mem::size_of::<explain_cursor>() as
                        sqlite3_uint64)
            } as *mut explain_cursor;
    if p_cur == core::ptr::null_mut() { return 7; }
    unsafe {
        memset(p_cur as *mut (), 0,
            core::mem::size_of::<explain_cursor>() as u64)
    };
    unsafe { (*p_cur).db = unsafe { (*(p as *mut explain_vtab)).db } };
    unsafe { *pp_cursor_1 = unsafe { &mut (*p_cur).base } };
    return 0;
}
extern "C" fn explain_close(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut explain_cursor = cur as *mut explain_cursor;
    unsafe { sqlite3_finalize(unsafe { (*p_cur).p_explain }) };
    unsafe { sqlite3_free(unsafe { (*p_cur).z_sql } as *mut ()) };
    unsafe { sqlite3_free(p_cur as *mut ()) };
    return 0;
}
extern "C" fn explain_next(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *mut explain_cursor = cur as *mut explain_cursor;
    unsafe {
        (*p_cur).rc = unsafe { sqlite3_step(unsafe { (*p_cur).p_explain }) }
    };
    if unsafe { (*p_cur).rc } != 101 && unsafe { (*p_cur).rc } != 100 {
        return unsafe { (*p_cur).rc };
    }
    return 0;
}
extern "C" fn explain_column(cur: *mut sqlite3_vtab_cursor,
    ctx: *mut sqlite3_context, i: i32) -> i32 {
    let p_cur: *const explain_cursor =
        cur as *mut explain_cursor as *const explain_cursor;
    if i == 8 {
        unsafe {
            sqlite3_result_text(ctx, unsafe { (*p_cur).z_sql } as *const i8,
                -1,
                Some(unsafe {
        ...
        unsafe {
            sqlite3_result_value(ctx,
                unsafe {
                    sqlite3_column_value(unsafe { (*p_cur).p_explain }, i)
                })
        };
    }
    return 0;
}
extern "C" fn explain_rowid(cur: *mut sqlite3_vtab_cursor,
    p_rowid_1: *mut sqlite_int64) -> i32 {
    let p_cur: *const explain_cursor =
        cur as *mut explain_cursor as *const explain_cursor;
    unsafe {
        *p_rowid_1 =
            unsafe { sqlite3_column_int64(unsafe { (*p_cur).p_explain }, 0) }
    };
    return 0;
}
extern "C" fn explain_eof(cur: *mut sqlite3_vtab_cursor) -> i32 {
    let p_cur: *const explain_cursor =
        cur as *mut explain_cursor as *const explain_cursor;
    return (unsafe { (*p_cur).rc } != 100) as i32;
}
extern "C" fn explain_filter(p_vtab_cursor_1: *mut sqlite3_vtab_cursor,
    idx_num_1: i32, idx_str_1: *const i8, argc: i32,
    argv: *mut *mut sqlite3_value) -> i32 {
    let p_cur: *mut explain_cursor = p_vtab_cursor_1 as *mut explain_cursor;
    let mut z_sql: *mut i8 = core::ptr::null_mut();
    let mut rc: i32 = 0;
    unsafe { sqlite3_finalize(unsafe { (*p_cur).p_explain }) };
    unsafe { (*p_cur).p_explain = core::ptr::null_mut() };
    if argc <= 0 ||
    ...
    if !(unsafe { (*p_cur).z_sql }).is_null() {
        z_sql =
            unsafe {
                sqlite3_mprintf(c"EXPLAIN %s".as_ptr() as *mut i8 as
                        *const i8, unsafe { (*p_cur).z_sql })
            };
    }
    if z_sql == core::ptr::null_mut() {
        ...
        rc =
            unsafe {
                sqlite3_prepare_v2(unsafe { (*p_cur).db }, z_sql as *const i8,
                    -1, unsafe { &mut (*p_cur).p_explain },
                    core::ptr::null_mut())
            };
    ...
    if rc != 0 {
        ...
        unsafe { (*p_cur).p_explain = core::ptr::null_mut() };
        unsafe { sqlite3_free(unsafe { (*p_cur).z_sql } as *mut ()) };
        unsafe { (*p_cur).z_sql = core::ptr::null_mut() };
    } else {
        unsafe {
            (*p_cur).rc =
                unsafe { sqlite3_step(unsafe { (*p_cur).p_explain }) }
        };
        rc =
            if unsafe { (*p_cur).rc } == 101 || unsafe { (*p_cur).rc } == 100
                {
                0
            } else { unsafe { (*p_cur).rc } };
    }
    return rc;
}
extern "C" fn explain_best_index(tab: *mut sqlite3_vtab,
    p_idx_info_1: *mut sqlite3_index_info) -> i32 {
    let mut i: i32 = 0;
    let mut idx: i32 = -1;
    let mut unusable: i32 = 0;
    unsafe { (*p_idx_info_1).estimated_rows = 500 as sqlite3_int64 };
    {
        i = 0;
        '__b0: loop {
            ...
            '__c0: loop {
                ...
                if unsafe { (*p).i_column } != 8 { break '__c0; }
                if (unsafe { (*p).usable } == 0) as i32 != 0 {
                    unusable = 1;
                } else if unsafe { (*p).op } as i32 == 2 { idx = i; }
                break '__c0;
            }
...
static mut explain_module: sqlite3_module =
    sqlite3_module {
        i_version: 0,
        x_create: None,
        x_connect: Some(explain_connect),
        x_best_index: Some(explain_best_index),
        x_disconnect: Some(explain_disconnect),
        x_destroy: None,
        x_open: Some(explain_open),
        x_close: Some(explain_close),
        x_filter: Some(explain_filter),
        x_next: Some(explain_next),
        x_eof: Some(explain_eof),
        x_column: Some(explain_column),
        x_rowid: Some(explain_rowid),
        x_update: None,
        x_begin: None,
        x_sync: None,
        x_commit: None,
        ...
        rc =
            unsafe {
                sqlite3_create_module(db,
                    ...
                    &raw mut explain_module as *const sqlite3_module,
                    core::ptr::null_mut())
            };
        return rc;
    }
